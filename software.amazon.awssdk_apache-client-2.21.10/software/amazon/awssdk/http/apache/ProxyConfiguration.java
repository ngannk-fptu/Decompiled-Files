...
implements ToCopyableBuilder<Builder, ProxyConfiguration> {
    ...
    private ProxyConfiguration(DefaultClientProxyConfigurationBuilder builder) {
        ...
        ProxyConfigProvider proxyConfiguration = ProxyConfigProvider.fromSystemEnvironmentSettings((Boolean)builder.useSystemPropertyValues, (Boolean)builder.useEnvironmentVariableValues, (String)resolvedScheme);
    ...
    private static String resolvePassword(DefaultClientProxyConfigurationBuilder builder, ProxyConfigProvider proxyConfiguration) {
        return !StringUtils.isEmpty((CharSequence)builder.password) || proxyConfiguration == null ? builder.password : proxyConfiguration.password().orElseGet(() -> builder.password);
    }
    ...
    private static String resolveUsername(DefaultClientProxyConfigurationBuilder builder, ProxyConfigProvider proxyConfiguration) {
        return !StringUtils.isEmpty((CharSequence)builder.username) || proxyConfiguration == null ? builder.username : proxyConfiguration.userName().orElseGet(() -> builder.username);
    }
    ...
    public String toString() {
        return ToString.builder((String)"ProxyConfiguration").add("endpoint", (Object)this.endpoint).add("username", (Object)this.username).add("ntlmDomain", (Object)this.ntlmDomain).add("ntlmWorkstation", (Object)this.ntlmWorkstation).add("nonProxyHosts", this.nonProxyHosts).add("preemptiveBasicAuthenticationEnabled", (Object)this.preemptiveBasicAuthenticationEnabled).add("useSystemPropertyValues", (Object)this.useSystemPropertyValues).add("useEnvironmentVariablesValues", (Object)this.useEnvironmentVariablesValues).add("scheme", (Object)this.scheme).build();
    }
