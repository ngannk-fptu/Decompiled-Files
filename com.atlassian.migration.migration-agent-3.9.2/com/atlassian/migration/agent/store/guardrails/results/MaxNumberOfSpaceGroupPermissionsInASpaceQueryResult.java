...
public final class MaxNumberOfSpaceGroupPermissionsInASpaceQueryResult
implements GrResult,
L1AssessmentResult {
    @JsonProperty
    private Tuple counts;

    public MaxNumberOfSpaceGroupPermissionsInASpaceQueryResult(Optional<Tuple> result) {
        this.counts = result.orElseGet(() -> GuardrailsUtil.getTuple(new GuardrailsTupleElement<Long>("space_id", 0L, Long.class), new GuardrailsTupleElement<Long>("permission_count", 0L, Long.class)));
    }
