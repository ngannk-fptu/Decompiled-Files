...
@JsonType(value="space-attachments")
public class SpaceAttachmentsTaskDto
extends TaskDto
implements SpaceTaskDto {
    ...
    @JsonCreator
    public SpaceAttachmentsTaskDto(@JsonProperty(value="id") String id, @JsonProperty(value="name") String name, @JsonProperty(value="spaceKey") String spaceKey, @JsonProperty(value="spaceName") String spaceName, @JsonProperty(value="migrationEstimateSeconds") long migrationEstimateSeconds, @JsonProperty(value="progress") ProgressDto progress) {
    ...
    public Task toInternalType() {
        SpaceAttachmentsOnlyTask task = new SpaceAttachmentsOnlyTask();
