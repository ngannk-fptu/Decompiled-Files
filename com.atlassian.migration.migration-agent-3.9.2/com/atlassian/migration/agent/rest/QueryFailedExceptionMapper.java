...
@Provider
@Component
public class QueryFailedExceptionMapper
implements ExceptionMapper<QueryFailedException> {
    private static final Logger log = LoggerFactory.getLogger(QueryFailedExceptionMapper.class);

    public Response toResponse(QueryFailedException ex) {
