...
implements ResourcePatternResolver {
    ...
    protected Resource[] findAllClassPathResources(String location) throws IOException {
        ...
        if (logger.isTraceEnabled()) {
            logger.trace((Object)("Resolved classpath location [" + location + "] to resources " + result));
        }
    ...
    protected Set<Resource> doFindPathMatchingFileResources(Resource rootDirResource, String subPattern) throws IOException {
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug((Object)("Cannot search for matching files underneath " + rootDirResource + " in the file system: " + ex.getMessage()));
            }
            return Collections.emptySet();
        }
        catch (Exception ex) {
            if (logger.isInfoEnabled()) {
                logger.info((Object)("Failed to resolve " + rootDirResource + " in the file system: " + ex));
            }
            return Collections.emptySet();
        }
    ...
    protected Set<Resource> doFindMatchingFileSystemResources(File rootDir, String subPattern) throws IOException {
        if (logger.isTraceEnabled()) {
            logger.trace((Object)("Looking for matching resources in directory tree [" + rootDir.getPath() + "]"));
        }
    ...
    protected Set<File> retrieveMatchingFiles(File rootDir, String pattern) throws IOException {
        ...
        if (!rootDir.isDirectory()) {
            if (logger.isInfoEnabled()) {
                logger.info((Object)("Skipping [" + rootDir.getAbsolutePath() + "] because it does not denote a directory"));
            }
            return Collections.emptySet();
        }
        if (!rootDir.canRead()) {
            if (logger.isInfoEnabled()) {
                logger.info((Object)("Skipping search for matching files underneath directory [" + rootDir.getAbsolutePath() + "] because the application is not allowed to read the directory"));
            }
            return Collections.emptySet();
        }
    ...
    protected void doRetrieveMatchingFiles(String fullPattern, File dir, Set<File> result) throws IOException {
        if (logger.isTraceEnabled()) {
            logger.trace((Object)("Searching directory [" + dir.getAbsolutePath() + "] for files matching pattern [" + fullPattern + "]"));
        }
    ...
    protected File[] listDirectory(File dir) {
        ...
        if (files == null) {
            if (logger.isInfoEnabled()) {
                logger.info((Object)("Could not retrieve contents of directory [" + dir.getAbsolutePath() + "]"));
            }
            return new File[0];
        }
