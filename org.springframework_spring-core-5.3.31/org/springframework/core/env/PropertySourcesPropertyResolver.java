...
extends AbstractPropertyResolver {
    ...
    protected <T> T getProperty(String key, Class<T> targetValueType, boolean resolveNestedPlaceholders) {
        if (this.propertySources != null) {
            for (PropertySource propertySource : this.propertySources) {
                ...
                if (this.logger.isTraceEnabled()) {
                    this.logger.trace((Object)("Searching for key '" + key + "' in PropertySource '" + propertySource.getName() + "'"));
                }
        ...
        if (this.logger.isTraceEnabled()) {
            this.logger.trace((Object)("Could not find key '" + key + "' in any property source"));
        }
        return null;
    }
    ...
    protected void logKeyFound(String key, PropertySource<?> propertySource, Object value) {
        if (this.logger.isDebugEnabled()) {
            this.logger.debug((Object)("Found key '" + key + "' in PropertySource '" + propertySource.getName() + "' with value of type " + value.getClass().getSimpleName()));
        }
    }
}
