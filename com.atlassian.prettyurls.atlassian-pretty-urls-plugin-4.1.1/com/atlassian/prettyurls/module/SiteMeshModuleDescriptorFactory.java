...
@Component
public class SiteMeshModuleDescriptorFactory
extends SingleModuleDescriptorFactory<SiteMeshModuleDescriptor> {
    @Autowired
    public SiteMeshModuleDescriptorFactory(HostContainer hostContainer) {
