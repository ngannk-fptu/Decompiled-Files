...
extends ObjectError {
    ...
    public String toString() {
        return "Field error in object '" + this.getObjectName() + "' on field '" + this.field + "': rejected value [" + ObjectUtils.nullSafeToString((Object)this.rejectedValue) + "]; " + this.resolvableToString();
    }
}
