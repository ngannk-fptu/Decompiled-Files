...
extends AbstractAsyncConfiguration {
    ...
    public AsyncAnnotationBeanPostProcessor asyncAdvisor() {
        Assert.notNull((Object)this.enableAsync, (String)"@EnableAsync annotation metadata was not injected");
        AsyncAnnotationBeanPostProcessor bpp = new AsyncAnnotationBeanPostProcessor();
        bpp.configure(this.executor, this.exceptionHandler);
        Class customAsyncAnnotation = this.enableAsync.getClass("annotation");
        if (customAsyncAnnotation != AnnotationUtils.getDefaultValue(EnableAsync.class, (String)"annotation")) {
