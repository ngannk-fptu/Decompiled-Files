...
DisposableBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.servletInstance = (Servlet)ReflectionUtils.accessibleConstructor(this.servletClass, (Class[])new Class[0]).newInstance(new Object[0]);
        this.servletInstance.init((ServletConfig)new DelegatingServletConfig());
    }

    @Override
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        Assert.state((this.servletInstance != null ? 1 : 0) != 0, (String)"No Servlet instance");
