...
Ordered {
    ...
    public void setWarnLogCategory(String loggerName) {
        this.warnLogger = StringUtils.hasLength((String)loggerName) ? LogFactory.getLog((String)loggerName) : null;
    }
    ...
    protected String buildLogMessage(Exception ex, HttpServletRequest request) {
        return "Resolved [" + LogFormatUtils.formatValue((Object)ex, (int)-1, (boolean)true) + "]";
    }
