...
implements ParamAware {
    ...
    String createUrl() throws JspException {
        Assert.state((this.value != null ? 1 : 0) != 0, (String)"No value set");
        ...
        urlStr = this.javaScriptEscape ? JavaScriptUtils.javaScriptEscape((String)urlStr) : urlStr;
        return urlStr;
    }
    ...
    protected String createQueryString(List<Param> params, Set<String> usedParams, boolean includeQueryStringDelimiter) throws JspException {
        ...
        for (Param param : params) {
            if (usedParams.contains(param.getName()) || !StringUtils.hasLength((String)param.getName())) continue;
            ...
            try {
                qs.append(UriUtils.encodeQueryParam((String)param.getName(), (String)encoding));
                if (param.getValue() == null) continue;
                qs.append('=');
                qs.append(UriUtils.encodeQueryParam((String)param.getValue(), (String)encoding));
            }
    ...
    protected String replaceUriTemplateParams(String uri, List<Param> params, Set<String> usedParams) throws JspException {
        ...
        for (Param param : params) {
            ...
            if (uri.contains(template)) {
                ...
                try {
                    uri = StringUtils.replace((String)uri, (String)template, (String)(value != null ? UriUtils.encodePath((String)value, (String)encoding) : ""));
                    continue;
                }
                catch (UnsupportedCharsetException ex) {
                    throw new JspException((Throwable)ex);
            ...
            value = param.getValue();
            try {
                uri = StringUtils.replace((String)uri, (String)template, (String)(value != null ? UriUtils.encodePathSegment((String)value, (String)encoding) : ""));
            }
            catch (UnsupportedCharsetException ex) {
                throw new JspException((Throwable)ex);
            }
