...
implements DynamicAttributes {
    ...
    protected void writeOptionalAttributes(TagWriter tagWriter) throws JspException {
        ...
        tagWriter.writeOptionalAttributeValue(STYLE_ATTRIBUTE, ObjectUtils.getDisplayString((Object)this.evaluate("cssStyle", this.getCssStyle())));
    ...
    protected String resolveCssClass() throws JspException {
        if (this.getBindStatus().isError() && StringUtils.hasText((String)this.getCssErrorClass())) {
            return ObjectUtils.getDisplayString((Object)this.evaluate("cssErrorClass", this.getCssErrorClass()));
        }
