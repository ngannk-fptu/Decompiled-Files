...
extends DeserializerFactory {
    ...
    protected <T extends JavaType> T modifyTypeByAnnotation(DeserializationConfig config, Annotated a, T type, String propName) throws JsonMappingException {
        ...
        if (type.isContainerType()) {
            ...
            if ((keyType = type.getKeyType()) != null && keyType.getValueHandler() == null && (kdClass = intr.findKeyDeserializer(a)) != null && kdClass != KeyDeserializer.None.class) {
            ...
            if ((contentType = type.getContentType()).getValueHandler() == null && (cdClass = intr.findContentDeserializer(a)) != null && cdClass != JsonDeserializer.None.class) {
