...
public class JSONObject {
    ...
    private static boolean potentialNumber(String value) {
        ...
        return JSONObject.potentialPositiveNumberStartingAtIndex(value, value.charAt(0) == '-' ? 1 : 0);
    }
    ...
    private static boolean potentialPositiveNumberStartingAtIndex(String value, int index) {
        ...
        return JSONObject.digitAtIndex(value, value.charAt(index) == '.' ? index + 1 : index);
    }
