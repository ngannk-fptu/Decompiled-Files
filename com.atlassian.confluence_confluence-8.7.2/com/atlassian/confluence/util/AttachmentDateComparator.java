...
public class AttachmentDateComparator
implements Comparator {
    ...
    public int compare(Object o1, Object o2) {
        ...
        Date d1 = a1.getLastModificationDate();
        Date d2 = a2.getLastModificationDate();
        if (d1 == null) {
            log.error("Null lastmodificationdate on attachment " + a1.getFileName());
            d1 = new java.sql.Date(0L);
        }
        if (d2 == null) {
            log.error("Null lastmodificationdate on attachment " + a2.getFileName());
