...
implements ReferenceInsertionPolicy {
    ...
    private static final Set<String> HTML_MIME_TYPES = Collections.unmodifiableSet(new HashSet<String>(Arrays.asList("text/html", "application/xhtml+xml")));

    public ConfluenceHtmlEntityEncodingPolicy(TemplateHtmlEntityEncodingPolicy templateEncodingPolicy) {
        this.templateEncodingPolicy = templateEncodingPolicy;
    }
