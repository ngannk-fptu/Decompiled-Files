...
DefaultConfluenceAccessManager.AccessManagerPermissionChecker {
    ...
    public Set<SpacePermission> getDefaultGlobalPermissions() {
        String defaultUsersGroup = this.getUserAccessor().getNewUserDefaultGroupName();
    ...
    public boolean isPermittedInReadOnlyAccessMode(String permissionType) {
        return SpacePermission.READ_ONLY_SPACE_PERMISSIONS.contains(permissionType) || !this.getAccessModeManager().shouldEnforceReadOnlyAccess();
    }
