...
@LuceneIndependent
@Internal
public class UnIndexSpaceChangeIndexTask
implements ConfluenceIndexTask,
HandleAware {
    private static final JournalEntryType journalEntryType = JournalEntryType.UNINDEX_SPACE_CHANGE;
    private final Handle handle;
    private final String spaceKey;

    public UnIndexSpaceChangeIndexTask(String spaceKey) {
    ...
    public String getDescription() {
        return "index.task.unindex.space.change";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnIndexSpaceChangeIndexTask)) {
            return false;
        }
        UnIndexSpaceChangeIndexTask that = (UnIndexSpaceChangeIndexTask)o;
        return this.handle.equals(that.handle);
    }

    public int hashCode() {
        return new HashCodeBuilder().append((Object)UnIndexSpaceChangeIndexTask.class.getName()).append((Object)this.handle).toHashCode();
    }
