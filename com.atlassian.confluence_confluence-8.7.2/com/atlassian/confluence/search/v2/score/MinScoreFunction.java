...
public final class MinScoreFunction
implements ScoreFunction {
    private List<ComposableScoreFunction> functions;

    public MinScoreFunction(ComposableScoreFunction function1, ComposableScoreFunction function2, ComposableScoreFunction ... functions) {
