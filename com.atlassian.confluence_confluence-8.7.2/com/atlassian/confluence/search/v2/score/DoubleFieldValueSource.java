...
public final class DoubleFieldValueSource
implements FieldValueSource {
    private final String fieldName;

    public DoubleFieldValueSource(String fieldName) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DoubleFieldValueSource)) {
            return false;
        }
        DoubleFieldValueSource that = (DoubleFieldValueSource)o;
