...
SpaceAware {
    ...
    private RemoveLabelCommand getCommand() {
        if (this.command == null) {
            ...
            String labelString = favouriteLabel.toStringWithOwnerPrefix();
            this.command = this.labelsService.newRemoveLabelCommand(labelString, (User)this.getAuthenticatedUser(), this.getEntityId());
        }
        return this.command;
    }
    ...
    private RemoveLabelCommand getAmercianCommand() {
        if (this.americanCommand == null) {
            Label americanSpelling = new Label("favorite", Namespace.PERSONAL, this.getAuthenticatedUser().getName());
            String labelString = americanSpelling.toStringWithOwnerPrefix();
            this.americanCommand = this.labelsService.newRemoveLabelCommand(labelString, (User)this.getAuthenticatedUser(), this.getEntityId());
        }
