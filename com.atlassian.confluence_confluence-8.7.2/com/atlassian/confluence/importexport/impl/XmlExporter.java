...
import com.atlassian.confluence.importexport.impl.XmlExporterObjectHandleCollector;
...
extends FileXmlExporter {
    ...
    public void setContext(ExportContext context) {
        ...
        this.includedSpace = XmlExporter.getIncludedSpaceFromWorkingEntity(this.getMainWorkingEntity());
    }
