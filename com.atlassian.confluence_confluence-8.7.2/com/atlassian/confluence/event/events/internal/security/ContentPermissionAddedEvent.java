...
@Internal
public class ContentPermissionAddedEvent {
    private final ContentEntityObject content;
    private final ContentPermission permission;

    public ContentPermissionAddedEvent(ContentEntityObject content, ContentPermission permission) {
    ...
    public boolean equals(Object o) {
        ...
        ContentPermissionAddedEvent that = (ContentPermissionAddedEvent)o;
