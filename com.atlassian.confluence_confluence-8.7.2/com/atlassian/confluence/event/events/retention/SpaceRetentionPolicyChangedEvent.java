...
public class SpaceRetentionPolicyChangedEvent
extends SpaceRetentionPolicyEvent {
    public SpaceRetentionPolicyChangedEvent(SpaceRetentionPolicy oldPolicy, SpaceRetentionPolicy newPolicy, Space space) {
        super((RetentionPolicy)oldPolicy, (RetentionPolicy)newPolicy, space);
    }
}
