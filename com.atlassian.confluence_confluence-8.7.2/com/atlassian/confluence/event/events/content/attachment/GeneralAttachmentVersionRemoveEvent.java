...
public class GeneralAttachmentVersionRemoveEvent
extends AttachmentEvent
implements Removed,
UserDriven {
    private static final long serialVersionUID = 8632002369825939500L;
    private final @Nullable User remover;

    public GeneralAttachmentVersionRemoveEvent(Object src, Attachment attachment, @Nullable User remover) {
        this(src, attachment, remover, false);
    }

    public GeneralAttachmentVersionRemoveEvent(Object src, Attachment attachment, @Nullable User remover, boolean suppressNotifications) {
    ...
    public boolean equals(@Nullable Object o) {
        ...
        GeneralAttachmentVersionRemoveEvent that = (GeneralAttachmentVersionRemoveEvent)o;
