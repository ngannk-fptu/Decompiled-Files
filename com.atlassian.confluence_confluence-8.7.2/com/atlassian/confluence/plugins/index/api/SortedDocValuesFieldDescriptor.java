...
@Deprecated
public final class SortedDocValuesFieldDescriptor
extends FieldDescriptor {
    private final byte[] bytesValue;

    public SortedDocValuesFieldDescriptor(BinaryFieldMapping mapping, byte[] value) {
        super(mapping, null);
    ...
    public FieldDescriptor.Store getStore() {
        return FieldDescriptor.Store.SORTED_DOC_VALUES;
    }
