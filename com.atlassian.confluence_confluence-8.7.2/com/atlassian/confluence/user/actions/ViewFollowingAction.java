...
public class ViewFollowingAction
...
implements UserAware {
    ...
    public String execute() throws Exception {
        ...
        PagingIterator<String> usernames = this.followManager.getFollowing(this.getUser(), PaginationQueryImpl.createNewQuery(Principal::getName)).pagingIterator();
