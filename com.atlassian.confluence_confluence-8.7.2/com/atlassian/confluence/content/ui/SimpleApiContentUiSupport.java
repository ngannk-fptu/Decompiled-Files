...
public class SimpleApiContentUiSupport<T extends Content>
implements ApiContentUiSupport<T> {
    ...
    public SimpleApiContentUiSupport(WebResourceUrlProvider webResourceUrlProvider, String iconPath, String iconCssClass, String contentCssClass, String i18NKey) {
    ...
    public String getIconPath(T content, int size) {
        return this.getLegacyIconPath(content.getType().getValue(), size);
    }
    ...
    public static ApiContentUiSupport getUnknown(WebResourceUrlProvider webResourceUrlProvider) {
        return new SimpleApiContentUiSupport(webResourceUrlProvider, "/images/icons/attachments/generic_16.png", "", "custom", "");
    }
}
