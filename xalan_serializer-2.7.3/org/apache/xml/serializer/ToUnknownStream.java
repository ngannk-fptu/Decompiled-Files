...
extends SerializerBase {
    ...
    public void namespaceAfterStartElement(String prefix, String uri) throws SAXException {
        String prefix1;
        if (this.m_firstTagNotEmitted && this.m_firstElementURI == null && this.m_firstElementName != null && (prefix1 = ToUnknownStream.getPrefixPart(this.m_firstElementName)) == null && EMPTYSTRING.equals(prefix)) {
    ...
    private boolean isFirstElemHTML() {
        ...
        if (isHTML && this.m_firstElementURI != null && !EMPTYSTRING.equals(this.m_firstElementURI)) {
            isHTML = false;
        }
        if (isHTML && this.m_namespacePrefix != null) {
            ...
            for (int i = 0; i < max; ++i) {
                String prefix = (String)this.m_namespacePrefix.elementAt(i);
                String uri = (String)this.m_namespaceURI.elementAt(i);
                if (this.m_firstElementPrefix == null || !this.m_firstElementPrefix.equals(prefix) || EMPTYSTRING.equals(uri)) continue;
                isHTML = false;
                break;
            }
        }
    ...
    public void setTransformer(Transformer t) {
        ...
        this.m_tracer = t instanceof SerializerTrace && ((SerializerTrace)((Object)t)).hasTraceListeners() ? (SerializerTrace)((Object)t) : null;
    }
