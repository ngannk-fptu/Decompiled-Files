...
extends ExtensibleElement {
    ...
    public Workspace getWorkspace(String var1);

    public Service addWorkspace(Workspace var1);

    public Workspace addWorkspace(String var1);

    public Collection getCollection(String var1, String var2);
