                    ...
                    public void completed(final PoolEntry<HttpRoute, ManagedAsyncClientConnection> poolEntry) {
                        ...
                        if (connection != null) {
                            if (connection.isOpen()) {
                                ...
                                if (protocolVersion != null && protocolVersion.greaterEquals(HttpVersion.HTTP_2_0) && TimeValue.isNonNegative(timeValue = PoolingAsyncClientConnectionManager.this.validateAfterInactivity) && poolEntry.getUpdated() + timeValue.toMilliseconds() <= System.currentTimeMillis()) {
