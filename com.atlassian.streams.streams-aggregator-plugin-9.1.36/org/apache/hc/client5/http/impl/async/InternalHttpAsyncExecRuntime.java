...
implements AsyncExecRuntime {
    ...
    public Cancellable connectEndpoint(HttpClientContext context, final FutureCallback<AsyncExecRuntime> callback) {
        ...
        return Operations.cancellable(this.manager.connect(endpoint, this.connectionInitiator, connectTimeout, (Object)this.versionPolicy, context, new FutureCallback<AsyncConnectionEndpoint>(){
    ...
    public void upgradeTls(HttpClientContext context) {
        ...
        this.manager.upgrade(endpoint, (Object)this.versionPolicy, context);
    }
