...
extends AbstractHttpAsyncClientBase {
    private static final ThreadFactory SCHEDULER_THREAD_FACTORY = new DefaultThreadFactory("Scheduled-executor");
    ...
    abstract AsyncExecRuntime createAsyncExecRuntime(HandlerFactory<AsyncPushConsumer> var1, HttpRoute var2);
        ...
        try {
            ...
            requestProducer.sendRequest(new RequestChannel(){
                ...
                public void sendRequest(HttpRequest request, final EntityDetails entityDetails, final HttpContext context) throws HttpException, IOException {
                    ...
                    final AsyncExecRuntime execRuntime = InternalAbstractHttpAsyncClient.this.createAsyncExecRuntime(pushHandlerFactory, route);
                    InternalAbstractHttpAsyncClient.this.setupContext(clientContext);
                    AsyncExecChain.Scheduler scheduler = new AsyncExecChain.Scheduler(){
                        ...
                        public void scheduleExecution(HttpRequest request, AsyncEntityProducer entityProducer, AsyncExecChain.Scope scope, AsyncExecCallback asyncExecCallback, TimeValue delay) {
                            InternalAbstractHttpAsyncClient.this.executeScheduled(request, entityProducer, scope, asyncExecCallback, delay);
                        }
                    };
                    ...
                    InternalAbstractHttpAsyncClient.this.executeImmediate(BasicRequestBuilder.copy(request).build(), entityDetails != null ? new AsyncEntityProducer(){
