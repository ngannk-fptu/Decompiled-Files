...
extends BaseNCodec {
    ...
    void decode(byte[] input, int inPos, int inAvail, BaseNCodec.Context context) {
        ...
        if (context.eof && context.modulus >= 2) {
            ...
            switch (context.modulus) {
                case 2: {
                    Base32.validateCharacter(3L, context);
                    buffer[context.pos++] = (byte)(context.lbitWorkArea >> 2 & 0xFFL);
                    break;
                }
                case 3: {
                    Base32.validateCharacter(127L, context);
                    buffer[context.pos++] = (byte)(context.lbitWorkArea >> 7 & 0xFFL);
                    break;
                }
                case 4: {
                    Base32.validateCharacter(15L, context);
                ...
                case 5: {
                    Base32.validateCharacter(1L, context);
                ...
                case 6: {
                    Base32.validateCharacter(63L, context);
                ...
                case 7: {
                    Base32.validateCharacter(7L, context);
    ...
    private static void validateCharacter(long emptyBitsMask, BaseNCodec.Context context) {
        if ((context.lbitWorkArea & emptyBitsMask) != 0L) {
