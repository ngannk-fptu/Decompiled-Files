...
ParsingErrorMsgs {
    ...
    protected StreamScanner(WstxInputSource input, ReaderConfig cfg, XMLResolver res) {
        ...
        this.mCachedEntities = this.mCfgTreatCharRefsAsEntities ? new HashMap() : Collections.EMPTY_MAP;
    }
    ...
    protected void initInputSource(WstxInputSource newInput, boolean isExt, String entityId) throws XMLStreamException {
        ...
        this.mInput.initInputLocation(this, this.mCurrDepth);
    ...
    protected boolean loadMore() throws XMLStreamException {
        ...
        do {
            ...
            if (this.mCurrInputProcessed > this.mConfig.getMaxCharacters()) {
                throw new XMLStreamException("Character limit (" + this.mConfig.getMaxCharacters() + ") exceeded");
            }
    ...
    protected EntityDecl getIntEntity(int ch, char[] originalChars) {
        ...
        IntEntity entity = (IntEntity)this.mCachedEntities.get(cacheKey);
        if (entity == null) {
            String repl;
            if (ch <= 65535) {
