...
public interface XmlConsts {
    ...
    public static final String ELEM_NO_NS_URI = "";
    public static final String ATTR_NO_NS_URI = "";
    public static final String ELEM_NO_PREFIX = "";
    public static final String ATTR_NO_PREFIX = "";
