...
extends ASN1Object {
    ...
    private Point384(ASN1Sequence seq) {
        ...
        this.x = ASN1OctetString.getInstance((Object)seq.getObjectAt(0));
        this.y = ASN1OctetString.getInstance((Object)seq.getObjectAt(1));
    ...
    public static Point384 getInstance(Object o) {
        if (o instanceof Point384) {
            return (Point384)((Object)o);
        }
        if (o != null) {
            return new Point384(ASN1Sequence.getInstance((Object)o));
        }
        return null;
    }
    ...
    public static class Builder {
        ...
        public Builder setX(BigInteger x) {
            this.x = new DEROctetString(BigIntegers.asUnsignedByteArray((int)48, (BigInteger)x));
            return this;
        }
        ...
        public Builder setY(BigInteger y) {
            this.y = new DEROctetString(BigIntegers.asUnsignedByteArray((int)48, (BigInteger)y));
            return this;
        }
