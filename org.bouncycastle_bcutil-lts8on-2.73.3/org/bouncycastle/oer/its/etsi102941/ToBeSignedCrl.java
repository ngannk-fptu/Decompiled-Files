...
extends ASN1Object {
    ...
    private ToBeSignedCrl(ASN1Sequence sequence) {
        ...
        this.thisUpdate = Time32.getInstance(sequence.getObjectAt(1));
        this.nextUpdate = Time32.getInstance(sequence.getObjectAt(2));
        this.entries = SequenceOfCrlEntry.getInstance(sequence.getObjectAt(3));
    }

    public static ToBeSignedCrl getInstance(Object o) {
        if (o instanceof ToBeSignedCrl) {
            return (ToBeSignedCrl)((Object)o);
        }
        if (o != null) {
            return new ToBeSignedCrl(ASN1Sequence.getInstance((Object)o));
        }
        return null;
    }
