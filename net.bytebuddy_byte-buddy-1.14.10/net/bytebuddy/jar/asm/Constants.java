...
final class Constants {
    ...
    static boolean isWhitelisted(String internalName) {
        ...
        return internalName.contains("Test$") || Pattern.matches("net/bytebuddy/jar/asm/util/Trace" + member + "Visitor(\\$.*)?", internalName) || Pattern.matches("net/bytebuddy/jar/asm/util/Check" + member + "Adapter(\\$.*)?", internalName);
    }
