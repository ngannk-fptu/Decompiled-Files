...
import net.bytebuddy.jar.asm.MethodWriter;
...
class Frame {
    ...
    private static final int FORWARD_UNINITIALIZED_KIND = 0x1000000;
    private static final int LOCAL_KIND = 0x1400000;
    private static final int STACK_KIND = 0x1800000;
    ...
    static int getAbstractTypeFromApiFormat(SymbolTable symbolTable, Object type) {
        ...
        if ((label.flags & 4) != 0) {
            return 0xC00000 | symbolTable.addUninitializedType("", label.bytecodeOffset);
        }
        return 0x1000000 | symbolTable.addForwardUninitializedType("", label);
    }
    ...
    private int getLocal(int localIndex) {
        if (this.outputLocals == null || localIndex >= this.outputLocals.length) {
            return 0x1400000 | localIndex;
        }
        int abstractType = this.outputLocals[localIndex];
        if (abstractType == 0) {
            abstractType = this.outputLocals[localIndex] = 0x1400000 | localIndex;
        }
        return abstractType;
    }
    ...
    private int pop() {
        ...
        return 0x1800000 | -this.outputStackStart;
    }
    ...
    private int getInitializedType(SymbolTable symbolTable, int abstractType) {
        if (abstractType == 0x400006 || (abstractType & 0xFFC00000) == 0xC00000 || (abstractType & 0xFFC00000) == 0x1000000) {
    ...
    void execute(int opcode, int arg, Symbol argSymbol, SymbolTable symbolTable) {
        block0 : switch (opcode) {
            ...
            case 58: {
                ...
                if ((previousLocalType & 0x3C00000) != 0x1400000 && (previousLocalType & 0x3C00000) != 0x1800000) break;
