...
public class PropertyBuilder {
    ...
    public PropertyBuilder(SerializationConfig config, BeanDescription beanDesc) {
        ...
        JsonInclude.Value inclPerType = JsonInclude.Value.merge((JsonInclude.Value)beanDesc.findPropertyInclusion(JsonInclude.Value.empty()), (JsonInclude.Value)config.getDefaultPropertyInclusion(beanDesc.getBeanClass(), JsonInclude.Value.empty()));
        this._defaultInclusion = JsonInclude.Value.merge((JsonInclude.Value)config.getDefaultPropertyInclusion(), (JsonInclude.Value)inclPerType);
    ...
    protected BeanPropertyWriter buildWriter(SerializerProvider prov, BeanPropertyDefinition propDef, JavaType declaredType, JsonSerializer<?> ser, TypeSerializer typeSer, TypeSerializer contentTypeSer, AnnotatedMember am, boolean defaultUseStaticTyping) throws JsonMappingException {
        ...
        try {
            ...
            if (propDef == null) {
                return (BeanPropertyWriter)prov.reportBadDefinition(declaredType, ClassUtil.exceptionMessage((Throwable)((Object)e)));
            }
            return (BeanPropertyWriter)prov.reportBadPropertyDefinition(this._beanDesc, propDef, ClassUtil.exceptionMessage((Throwable)((Object)e)), new Object[0]);
        }
