...
Serializable {
    ...
    public ObjectMapper setSerializationInclusion(JsonInclude.Include incl) {
        this.setPropertyInclusion(JsonInclude.Value.construct((JsonInclude.Include)incl, (JsonInclude.Include)incl));
        return this;
    }
    ...
    public ObjectMapper setDefaultPropertyInclusion(JsonInclude.Include incl) {
        this._configOverrides.setDefaultInclusion(JsonInclude.Value.construct((JsonInclude.Include)incl, (JsonInclude.Include)incl));
        return this;
    }
    ...
    public ObjectMapper activateDefaultTyping(PolymorphicTypeValidator ptv, DefaultTyping applicability, JsonTypeInfo.As includeAs) {
        ...
        JsonTypeInfo.Value typeInfo = JsonTypeInfo.Value.construct((JsonTypeInfo.Id)JsonTypeInfo.Id.CLASS, (JsonTypeInfo.As)includeAs, null, null, (boolean)false, null);
    ...
    public ObjectMapper activateDefaultTypingAsProperty(PolymorphicTypeValidator ptv, DefaultTyping applicability, String propertyName) {
        TypeResolverBuilder<?> typer = this._constructDefaultTypeResolverBuilder(applicability, ptv);
        JsonTypeInfo.Value typeInfo = JsonTypeInfo.Value.construct((JsonTypeInfo.Id)JsonTypeInfo.Id.CLASS, (JsonTypeInfo.As)JsonTypeInfo.As.PROPERTY, (String)propertyName, null, (boolean)false, null);
        typer = typer.withSettings(typeInfo);
        return this.setDefaultTyping(typer);
    }
    ...
    public <T> T treeToValue(TreeNode n, JavaType valueType) throws IllegalArgumentException, JsonProcessingException {
        ...
        try {
            ...
            JsonToken tt = n.asToken();
            if (tt == JsonToken.VALUE_EMBEDDED_OBJECT && n instanceof POJONode && ((ob = ((POJONode)n).getPojo()) == null || valueType.isTypeOrSuperTypeOf(ob.getClass()))) {
                return (T)ob;
            }
            return this.readValue(this.treeAsTokens(n), valueType);
        }
    ...
    public <T extends JsonNode> T valueToTree(Object fromValue) throws IllegalArgumentException {
        ...
        try {
            ...
            try (JsonParser p = buf.asParser();){
                JsonNode jsonNode = (JsonNode)this.readTree(p);
                return (T)jsonNode;
            }
        }
        catch (IOException e) {
    ...
    public ObjectReader readerFor(Class<?> type) {
        ...
        return this._newReader(this.getDeserializationConfig(), t, null, null, this._injectableValues);
    }

    public ObjectReader readerFor(TypeReference<?> typeRef) {
        this._assertNotNull("type", typeRef);
        return this._newReader(this.getDeserializationConfig(), this._typeFactory.constructType(typeRef), null, null, this._injectableValues);
    }
