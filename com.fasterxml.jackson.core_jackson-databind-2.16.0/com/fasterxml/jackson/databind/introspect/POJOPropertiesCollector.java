...
public class POJOPropertiesCollector {
    ...
    protected void _addCreators(Map<String, POJOPropertyBuilder> props) {
        ArrayList<String> recordComponentNames;
        ...
        if (this.isRecordType() && (canonicalCtor = JDK14Util.findRecordConstructor(this._classDef, this._annotationIntrospector, this._config, recordComponentNames = new ArrayList<String>())) != null) {
            if (this._creatorProperties == null) {
                this._creatorProperties = new LinkedList();
            }
            HashSet<AnnotatedParameter> registeredParams = new HashSet<AnnotatedParameter>();
            ...
            if (this._creatorProperties.isEmpty() || !registeredParams.isEmpty()) {
                for (int i = 0; i < canonicalCtor.getParameterCount(); ++i) {
                    ...
                    if (registeredParams.contains(param)) continue;
