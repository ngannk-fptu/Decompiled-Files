...
extends DatabindException {
    ...
    public static JsonMappingException from(DeserializationContext ctxt, String msg) {
        return new JsonMappingException((Closeable)JsonMappingException._parser(ctxt), msg);
    }

    public static JsonMappingException from(DeserializationContext ctxt, String msg, Throwable t) {
        return new JsonMappingException((Closeable)JsonMappingException._parser(ctxt), msg, t);
    }
    ...
    public static JsonMappingException from(SerializerProvider ctxt, String msg) {
        return new JsonMappingException((Closeable)JsonMappingException._generator(ctxt), msg);
    }

    public static JsonMappingException from(SerializerProvider ctxt, String msg, Throwable problem) {
        return new JsonMappingException((Closeable)JsonMappingException._generator(ctxt), msg, problem);
    }
    ...
    public static JsonMappingException wrapWithPath(Throwable src, Reference ref) {
        ...
        if (src instanceof JsonMappingException) {
            jme = (JsonMappingException)((Object)src);
        } else {
            Object proc0;
            ...
            Closeable proc = null;
            if (src instanceof JacksonException && (proc0 = ((JacksonException)src).getProcessor()) instanceof Closeable) {
