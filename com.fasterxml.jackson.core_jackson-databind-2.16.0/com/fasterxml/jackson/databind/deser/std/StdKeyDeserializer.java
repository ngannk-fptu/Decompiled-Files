...
implements Serializable {
    ...
    public static StdKeyDeserializer forType(Class<?> raw) {
        ...
        if (raw == UUID.class) {
            ...
            if (raw == Locale.class) {
                FromStringDeserializer<Locale> deser = FromStringDeserializer.findDeserializer(Locale.class);
                return new StdKeyDeserializer(9, raw, deser);
            }
            if (raw == Currency.class) {
                FromStringDeserializer<Currency> deser = FromStringDeserializer.findDeserializer(Currency.class);
    ...
    protected int _parseInt(String key) throws IllegalArgumentException {
        return NumberInput.parseInt((String)key);
    }

    protected long _parseLong(String key) throws IllegalArgumentException {
        return NumberInput.parseLong((String)key);
    }
    ...
    extends StdKeyDeserializer {
        ...
        public Object _parse(String key, DeserializationContext ctxt) throws IOException {
            ...
            if ((e = (res = this._resolveCurrentResolver(ctxt)).findEnum(key)) == null && ctxt.isEnabled(EnumFeature.READ_ENUM_KEYS_USING_INDEX)) {
        ...
        private EnumResolver _getToStringResolver(DeserializationContext ctxt) {
            ...
            if (res == null) {
                ...
                synchronized (enumKD) {
                    ...
                    if (res == null) {
                        this._byToStringResolver = res = EnumResolver.constructUsingToString(ctxt.getConfig(), this._byNameResolver.getEnumClass());
                    }
                }
            }
            return res;
        ...
        private EnumResolver _getIndexResolver(DeserializationContext ctxt) {
            ...
            if (res == null) {
                ...
                synchronized (enumKD) {
                    ...
                    if (res == null) {
                        this._byIndexResolver = res = EnumResolver.constructUsingIndex(ctxt.getConfig(), this._byNameResolver.getEnumClass());
                    }
                }
            }
            return res;
