...
public class NumberDeserializers {
    ...
    extends StdScalarDeserializer<BigDecimal> {
        ...
        public BigDecimal deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            try {
                return NumberInput.parseBigDecimal((String)text, (boolean)p.isEnabled(StreamReadFeature.USE_FAST_BIG_NUMBER_PARSER));
            }
    ...
    extends StdScalarDeserializer<BigInteger> {
        ...
        public BigInteger deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            try {
                return NumberInput.parseBigInteger((String)text, (boolean)p.isEnabled(StreamReadFeature.USE_FAST_BIG_NUMBER_PARSER));
            }
            catch (IllegalArgumentException illegalArgumentException) {
        ...
        public Object deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            try {
                if (!this._isIntNumber(text)) {
                    ...
                    return NumberInput.parseDouble((String)text, (boolean)p.isEnabled(StreamReadFeature.USE_FAST_DOUBLE_PARSER));
                }
                p.streamReadConstraints().validateIntegerLength(text.length());
                if (ctxt.isEnabled(DeserializationFeature.USE_BIG_INTEGER_FOR_INTS)) {
                    return NumberInput.parseBigInteger((String)text, (boolean)p.isEnabled(StreamReadFeature.USE_FAST_BIG_NUMBER_PARSER));
                }
                long value = NumberInput.parseLong((String)text);
    ...
    extends PrimitiveOrWrapperDeserializer<Double> {
        ...
        protected final Double _parseDouble(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            p.streamReadConstraints().validateFPLength(text.length());
            try {
                return DoubleDeserializer._parseDouble(text, p.isEnabled(StreamReadFeature.USE_FAST_DOUBLE_PARSER));
            }
            catch (IllegalArgumentException illegalArgumentException) {
    ...
    extends PrimitiveOrWrapperDeserializer<Float> {
        ...
        protected final Float _parseFloat(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            try {
                return Float.valueOf(NumberInput.parseFloat((String)text, (boolean)p.isEnabled(StreamReadFeature.USE_FAST_DOUBLE_PARSER)));
            }
            catch (IllegalArgumentException illegalArgumentException) {
