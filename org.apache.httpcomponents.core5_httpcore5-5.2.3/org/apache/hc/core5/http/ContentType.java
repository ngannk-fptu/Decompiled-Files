...
implements Serializable {
    ...
    public static ContentType create(String mimeType, Charset charset) {
        String normalizedMimeType = TextUtils.toLowerCase(Args.notBlank(mimeType, "MIME type"));
    ...
    public static ContentType create(String mimeType, NameValuePair ... params) throws UnsupportedCharsetException {
        String type = TextUtils.toLowerCase(Args.notBlank(mimeType, "MIME type"));
        Args.check(ContentType.valid(type), "MIME type may not contain reserved characters");
        return ContentType.create(mimeType, params != null ? (NameValuePair[])params.clone() : null, true);
    }
