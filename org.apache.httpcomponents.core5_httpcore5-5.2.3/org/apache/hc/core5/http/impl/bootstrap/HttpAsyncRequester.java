...
implements ConnPoolControl<HttpHost> {
    ...
    public HttpAsyncRequester(IOReactorConfig ioReactorConfig, IOEventHandlerFactory eventHandlerFactory, Decorator<IOSession> ioSessionDecorator, Callback<Exception> exceptionCallback, IOSessionListener sessionListener, ManagedConnPool<HttpHost, IOSession> connPool) {
        this(ioReactorConfig, eventHandlerFactory, ioSessionDecorator, exceptionCallback, sessionListener, connPool, null, null);
    }
        ...
        Future<PoolEntry<HttpHost, IOSession>> leaseFuture = this.connPool.lease(host, null, timeout, new FutureCallback<PoolEntry<HttpHost, IOSession>>(){
            ...
            public void completed(final PoolEntry<HttpHost, IOSession> poolEntry) {
                ...
                if (poolEntry.hasConnection()) {
                    ...
                    Future<IOSession> future = HttpAsyncRequester.this.requestSession(host, timeout, new EndpointParameters(host, attachment), new FutureCallback<IOSession>(){
    ...
    public void execute(final AsyncClientExchangeHandler exchangeHandler, final HandlerFactory<AsyncPushConsumer> pushHandlerFactory, Timeout timeout, final HttpContext executeContext) {
        ...
        try {
            exchangeHandler.produceRequest((request, entityDetails, requestContext) -> {
                ...
                this.connect(target, timeout, null, new FutureCallback<AsyncClientEndpoint>(){
    ...
    protected void doTlsUpgrade(final ProtocolIOSession ioSession, NamedEndpoint endpoint, final FutureCallback<ProtocolIOSession> callback) {
        ...
        this.tlsStrategy.upgrade(ioSession, endpoint, null, this.handshakeTimeout, (FutureCallback<TransportSecurityLayer>)new CallbackContribution<TransportSecurityLayer>(callback){
    ...
    implements TlsUpgradeCapable {
        ...
        public boolean isConnected() {
            ...
            if (poolEntry != null) {
                ...
                return handler instanceof HttpConnection && ((HttpConnection)((Object)handler)).isOpen();
            }
            return false;
        }
        ...
        public void tlsUpgrade(NamedEndpoint endpoint, FutureCallback<ProtocolIOSession> callback) {
            ...
            HttpAsyncRequester.this.doTlsUpgrade((ProtocolIOSession)ioSession, endpoint, callback);
        }
    }
}
