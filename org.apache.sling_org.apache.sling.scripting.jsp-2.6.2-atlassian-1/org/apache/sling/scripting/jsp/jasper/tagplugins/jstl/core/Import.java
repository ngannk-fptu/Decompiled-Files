...
implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        boolean hasVarReader = ctxt.isAttributeSpecified("varReader");
        boolean hasCharEncoding = ctxt.isAttributeSpecified("charEncoding");
        ...
        ctxt.generateJavaSource("}");
        ctxt.generateJavaSource(iauName + " = org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.isAbsoluteUrl(" + urlName + ");");
        if (hasContext) {
        ...
        if (hasVarReader) {
            ...
            ctxt.generateJavaSource("            " + charSetName + " = org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.getContentTypeAttribute(" + contentTypeName + ", \"charset\");");
            ctxt.generateJavaSource("            if(" + charSetName + " == null) " + charSetName + " = org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("        }else{");
            ctxt.generateJavaSource("            " + charSetName + " = org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("        }");
            ctxt.generateJavaSource("    }");
            if (!hasCharEncoding) {
                ctxt.generateJavaSource("    String " + contentTypeName + " = " + ucName + ".getContentType();");
            ...
            ctxt.generateJavaSource("        " + tempReaderName + " = new java.io.InputStreamReader(" + inputStreamName + ", org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING);");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("    }");
            ctxt.generateJavaSource("    RequestDispatcher " + requestDispatcherName + " = " + servletContextName + ".getRequestDispatcher(org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.stripSession(" + urlName + "));");
            ctxt.generateJavaSource("    if(" + requestDispatcherName + " == null) throw new JspTagException(org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.stripSession(" + urlName + "));");
            ctxt.generateJavaSource("    org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.ImportResponseWrapper " + irwName + " = new org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.ImportResponseWrapper((HttpServletResponse) pageContext.getResponse());");
            ctxt.generateJavaSource("    if(" + charSetName + " == null){");
            ctxt.generateJavaSource("        " + charSetName + " = org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("        throw new JspTagException(" + irwName + ".getStatus()+\" \" + org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.stripSession(" + urlName + "));");
            ctxt.generateJavaSource("    }");
