...
extends BodyContent {
    ...
    private static final boolean LIMIT_BUFFER = Boolean.valueOf(System.getProperty("org.apache.sling.scripting.jsp.jasper.runtime.BodyContentImpl.LIMIT_BUFFER", "false"));
    private char[] cb;
    ...
    public void clear() throws IOException {
        ...
        this.nextChar = 0;
        if (LIMIT_BUFFER && this.cb.length > 512) {
            this.bufferSize = 512;
            this.cb = new char[this.bufferSize];
        }
    }
