    ...
    extends RGBComposite.RGBCompositeContext {
        ...
        public void composeRGB(int[] src, int[] dst, float alpha) {
            ...
            for (int i = 0; i < w; i += 4) {
                ...
                int sa = src[i + 3];
                int dia = dst[i + 3];
                int d = Context.multiply255(sr, dir);
                int dor = d + Context.multiply255(dir, 255 - Context.multiply255(255 - dir, 255 - sr) - d);
                d = Context.multiply255(sg, dig);
                int dog = d + Context.multiply255(dig, 255 - Context.multiply255(255 - dig, 255 - sg) - d);
                d = Context.multiply255(sb, dib);
                int dob = d + Context.multiply255(dib, 255 - Context.multiply255(255 - dib, 255 - sb) - d);
