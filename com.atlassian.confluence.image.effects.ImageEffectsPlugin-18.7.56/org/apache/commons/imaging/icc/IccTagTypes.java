...
public enum IccTagTypes implements IccTagType
{
    ...
    DEVICE_MODEL_DESC_TAG("deviceModelDescTag", "multiLocalizedUnicodeType", 0x646D6464),
    ...
    MEDIA_WHITE_POINT_TAG("mediaWhitePointTag", "XYZType", 0x77747074),
    ...
    private IccTagTypes(String name, String typeDescription, int signature) {
        this.name = name;
