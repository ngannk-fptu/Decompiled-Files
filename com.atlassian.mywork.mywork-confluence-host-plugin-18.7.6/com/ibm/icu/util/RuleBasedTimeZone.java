...
extends BasicTimeZone {
    ...
    public void getOffsetFromLocal(long date, BasicTimeZone.LocalOption nonExistingTimeOpt, BasicTimeZone.LocalOption duplicatedTimeOpt, int[] offsets) {
        int nonExistingTimeOptVal = RuleBasedTimeZone.getLocalOptionValue(nonExistingTimeOpt);
        int duplicatedTimeOptVal = RuleBasedTimeZone.getLocalOptionValue(duplicatedTimeOpt);
        this.getOffset(date, true, nonExistingTimeOptVal, duplicatedTimeOptVal, offsets);
    }
