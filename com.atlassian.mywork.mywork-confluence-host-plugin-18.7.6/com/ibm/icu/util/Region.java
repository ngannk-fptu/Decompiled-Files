...
implements Comparable<Region> {
    ...
    private static synchronized void loadRegionData() {
        ...
        UResourceBundle supplementalData = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", "supplementalData", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
