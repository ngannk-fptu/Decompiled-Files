...
public final class ZoneMeta {
    ...
    private static synchronized String[] getZoneIDs() {
        if (ZONEIDS == null) {
            try {
                UResourceBundle top = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", ZONEINFORESNAME, ICUResourceBundle.ICU_DATA_CLASS_LOADER);
    ...
    private static String findCLDRCanonicalID(String tzid) {
        ...
        try {
            UResourceBundle keyTypeData = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", "keyTypeData", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
    ...
    public static UResourceBundle openOlsonResource(UResourceBundle top, String id) {
        ...
        if (zoneIdx >= 0) {
            try {
                ...
                if (top == null) {
                    top = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", ZONEINFORESNAME, ICUResourceBundle.ICU_DATA_CLASS_LOADER);
                }
    ...
    extends SoftCache<String, OlsonTimeZone, String> {
        ...
        protected OlsonTimeZone createInstance(String key, String data) {
            ...
            try {
                UResourceBundle top = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", ZoneMeta.ZONEINFORESNAME, ICUResourceBundle.ICU_DATA_CLASS_LOADER);
