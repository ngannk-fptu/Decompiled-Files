...
public final class CollationLoader {
    ...
    private static void loadRootRules() {
        ...
        synchronized (CollationLoader.class) {
            if (rootRules == null) {
                UResourceBundle rootBundle = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b/coll", ULocale.ROOT);
    ...
    static String loadRules(ULocale locale, String collationType) {
        UResourceBundle bundle = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b/coll", locale);
    ...
    public static CollationTailoring loadTailoring(ULocale locale, Output<ULocale> outValidLocale) {
        ...
        try {
            bundle = ICUResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b/coll", locale, ICUResourceBundle.OpenType.LOCALE_ROOT);
        }
        ...
        if (!actualLocale.equals(validLocale) && (defT = ((ICUResourceBundle)(actualBundle = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b/coll", actualLocale))).findStringWithFallback("collations/default")) != null) {
            defaultType = defT;
        }
        if (!type.equals(defaultType)) {
