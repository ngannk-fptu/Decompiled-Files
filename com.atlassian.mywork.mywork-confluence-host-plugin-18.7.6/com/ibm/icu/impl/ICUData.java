...
public final class ICUData {
    ...
    static final String PACKAGE_NAME = "icudt73b";
    public static final String ICU_BUNDLE = "data/icudt73b";
    public static final String ICU_BASE_NAME = "com/ibm/icu/impl/data/icudt73b";
    public static final String ICU_COLLATION_BASE_NAME = "com/ibm/icu/impl/data/icudt73b/coll";
    public static final String ICU_BRKITR_NAME = "brkitr";
    public static final String ICU_BRKITR_BASE_NAME = "com/ibm/icu/impl/data/icudt73b/brkitr";
    public static final String ICU_RBNF_BASE_NAME = "com/ibm/icu/impl/data/icudt73b/rbnf";
    public static final String ICU_TRANSLIT_BASE_NAME = "com/ibm/icu/impl/data/icudt73b/translit";
    public static final String ICU_LANG_BASE_NAME = "com/ibm/icu/impl/data/icudt73b/lang";
    public static final String ICU_CURR_BASE_NAME = "com/ibm/icu/impl/data/icudt73b/curr";
    public static final String ICU_REGION_BASE_NAME = "com/ibm/icu/impl/data/icudt73b/region";
    public static final String ICU_ZONE_BASE_NAME = "com/ibm/icu/impl/data/icudt73b/zone";
    public static final String ICU_UNIT_BASE_NAME = "com/ibm/icu/impl/data/icudt73b/unit";
