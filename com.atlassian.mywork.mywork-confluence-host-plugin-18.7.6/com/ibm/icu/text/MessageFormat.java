...
extends UFormat {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.ulocale, other.ulocale) && Objects.equals(this.msgPattern, other.msgPattern) && Objects.equals(this.cachedFormatters, other.cachedFormatters) && Objects.equals(this.customFormatArgStarts, other.customFormatArgStarts);
    }
    ...
    Format dateTimeFormatForPatternOrSkeleton(String style) {
        ...
        if (style.regionMatches(i, "::", 0, 2)) {
            return DateFormat.getInstanceForSkeleton(style.substring(i + 2), this.ulocale);
        }
    ...
    private Format createAppropriateFormat(String type, String style) {
        ...
        block3 : switch (subformatType) {
            case 0: {
                ...
                int i = PatternProps.skipWhiteSpace(style, 0);
                if (style.regionMatches(i, "::", 0, 2)) {
                    newFormat = NumberFormatter.forSkeleton(style.substring(i + 2)).locale(this.ulocale).toFormat();
                    break;
                }
            ...
            case 1: {
                ...
                newFormat = this.dateTimeFormatForPatternOrSkeleton(style);
                break;
            }
            case 2: {
                switch (MessageFormat.findKeyword(style, dateModifierList)) {
