...
public abstract class $FastClass {
    ...
    extends $AbstractClassGenerator {
        private static final $AbstractClassGenerator.Source SOURCE = new $AbstractClassGenerator.Source((class$net$sf$cglib$reflect$FastClass == null ? (class$net$sf$cglib$reflect$FastClass = $FastClass.class$("com.google.inject.internal.cglib.reflect.$FastClass")) : class$net$sf$cglib$reflect$FastClass).getName());
        private Class type;
