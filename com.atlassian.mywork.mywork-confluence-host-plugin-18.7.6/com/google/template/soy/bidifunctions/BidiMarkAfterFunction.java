...
SoyJsSrcFunction {
    ...
    public SoyValue computeForJava(List<SoyValue> args) {
        ...
        int bidiGlobalDir = this.bidiGlobalDirProvider.get().getStaticValue();
    ...
    public JsExpr computeForJsSrc(List<JsExpr> args) {
        ...
        String callText = "soy.$$bidiMarkAfter(" + this.bidiGlobalDirProvider.get().getCodeSnippet() + ", " + value.getText() + (isHtml != null ? ", " + isHtml.getText() : "") + ")";
