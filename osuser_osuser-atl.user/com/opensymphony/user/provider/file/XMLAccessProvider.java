...
import com.opensymphony.user.provider.file.XMLGroupsCache;
...
extends FileAccessProvider {
    ...
    public boolean init(Properties properties) {
        ...
        if (retVal) {
            this.groupCache = new XMLGroupsCache(properties.getProperty("storeFile"), properties.getProperty("storeFileType"));
            return true;
        }
        return false;
    }
