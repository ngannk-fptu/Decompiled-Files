...
@EventName(value="zdu.upgrade-state.retry")
public class ZduRetryEvent
implements Serializable {
    private static final long serialVersionUID = 8370149280205089849L;
    private final long nodeCount;
    private final BuildInfo nodeBuild;

    public ZduRetryEvent(long nodeCount, @Nonnull BuildInfo nodeBuild) {
