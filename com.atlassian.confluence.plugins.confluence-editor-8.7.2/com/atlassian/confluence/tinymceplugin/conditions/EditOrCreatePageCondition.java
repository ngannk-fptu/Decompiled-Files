...
public class EditOrCreatePageCondition
extends BaseConfluenceCondition {
    public boolean shouldDisplay(WebInterfaceContext context) {
        HttpServletRequest req = ServletActionContext.getRequest();
        String uri = req.getServletPath();
        if (UrlUtils.isPageCreationUrl((String)uri) || UrlUtils.isPageEditUrl((String)uri)) {
            return true;
        }
        return UrlUtils.isEditorLoaderUrl((String)uri) && context.getPage() instanceof Page;
    }
}
