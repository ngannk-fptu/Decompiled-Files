...
public class CssScanner {
    protected static final Timeout DEFAULT_TIMEOUT = Timeout.ofMilliseconds((long)1000L);
    ...
    public CleanResults scanStyleSheet(String taintedCss, int sizeLimit) throws ScanException {
        ...
        try {
            ...
            throw new ScanException((Exception)e);
        }
    ...
    private void parseImportedStylesheets(LinkedList<URI> stylesheets, List<String> errorMessages, int sizeLimit) throws ScanException {
        if (!stylesheets.isEmpty()) {
            ...
            try {
                timeout = Timeout.ofMilliseconds((long)Long.parseLong(this.policy.getDirective("connectionTimeout")));
            }
            ...
            while (!stylesheets.isEmpty()) {
                ...
                try {
                    String responseBody = (String)httpClient.execute((ClassicHttpRequest)new HttpGet(stylesheetUri), (HttpClientResponseHandler)responseHandler);
