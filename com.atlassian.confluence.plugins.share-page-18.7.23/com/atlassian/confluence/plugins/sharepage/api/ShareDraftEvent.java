...
@EventName(value="confluence.share-page.edit.success")
public class ShareDraftEvent
extends ShareEvent
implements NotificationEnabledEvent {
    public ShareDraftEvent(String senderUsername, Set<String> users, Set<String> originalRequestEmails, Map<String, Set<String>> emails, Set<String> groupNames, Long entityId, ContentType contentType, String note) {
