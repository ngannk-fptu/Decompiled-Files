...
implements BeanInfo {
    ...
    public ExtendedBeanInfo(BeanInfo delegate) {
        ...
        for (PropertyDescriptor pd : delegate.getPropertyDescriptors()) {
            try {
                ...
                logger.debug((Object)("Ignoring invalid bean property '" + pd.getName() + "': " + ex.getMessage()));
            }
        }
        ...
        if (methodDescriptors != null) {
            for (Method method : this.findCandidateWriteMethods(methodDescriptors)) {
                try {
                    ...
                    if (!logger.isDebugEnabled()) continue;
                    logger.debug((Object)("Ignoring candidate write method [" + method + "]: " + ex.getMessage()));
                }
            }
        }
    }
    ...
    extends IndexedPropertyDescriptor {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return ObjectUtils.nullSafeEquals((Object)this.getIndexedReadMethod(), (Object)otherPd.getIndexedReadMethod()) && ObjectUtils.nullSafeEquals((Object)this.getIndexedWriteMethod(), (Object)otherPd.getIndexedWriteMethod()) && ObjectUtils.nullSafeEquals(this.getIndexedPropertyType(), otherPd.getIndexedPropertyType()) && PropertyDescriptorUtils.equals(this, otherPd);
        }
