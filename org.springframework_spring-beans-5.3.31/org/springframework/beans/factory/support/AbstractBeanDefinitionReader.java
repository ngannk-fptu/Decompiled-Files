...
EnvironmentCapable {
    ...
    protected AbstractBeanDefinitionReader(BeanDefinitionRegistry registry) {
        ...
        this.resourceLoader = this.registry instanceof ResourceLoader ? (ResourceLoader)this.registry : new PathMatchingResourcePatternResolver();
        this.environment = this.registry instanceof EnvironmentCapable ? ((EnvironmentCapable)this.registry).getEnvironment() : new StandardEnvironment();
    }
    ...
    public int loadBeanDefinitions(String location, @Nullable Set<Resource> actualResources) throws BeanDefinitionStoreException {
        ...
        if (resourceLoader instanceof ResourcePatternResolver) {
            try {
                ...
                if (this.logger.isTraceEnabled()) {
                    this.logger.trace((Object)("Loaded " + count + " bean definitions from location pattern [" + location + "]"));
                }
                return count;
            }
        ...
        if (this.logger.isTraceEnabled()) {
            this.logger.trace((Object)("Loaded " + count + " bean definitions from location [" + location + "]"));
        }
        return count;
    }
    ...
    public int loadBeanDefinitions(String ... locations) throws BeanDefinitionStoreException {
        Assert.notNull((Object)locations, (String)"Location array must not be null");
        int count = 0;
