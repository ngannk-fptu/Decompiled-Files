...
extends GenericTypeAwareAutowireCandidateResolver {
    ...
    protected boolean checkQualifiers(BeanDefinitionHolder bdHolder, Annotation[] annotationsToSearch) {
        ...
        for (Annotation annotation : annotationsToSearch) {
            ...
            for (Annotation metaAnn : type.getAnnotations()) {
                ...
                foundMeta = true;
                if ((!fallbackToMeta || !ObjectUtils.isEmpty((Object)AnnotationUtils.getValue((Annotation)metaAnn))) && this.checkQualifier(bdHolder, metaAnn, typeConverter)) continue;
                return false;
            }
    ...
    protected Annotation getQualifiedElementAnnotation(RootBeanDefinition bd, Class<? extends Annotation> type) {
        ...
        return qualifiedElement != null ? AnnotationUtils.getAnnotation((AnnotatedElement)qualifiedElement, type) : null;
    }
    ...
    protected Object findValue(Annotation[] annotationsToSearch) {
        ...
        if (annotationsToSearch.length > 0 && (attr = AnnotatedElementUtils.getMergedAnnotationAttributes((AnnotatedElement)AnnotatedElementUtils.forAnnotations((Annotation[])annotationsToSearch), this.valueAnnotationType)) != null) {
    ...
    protected Object extractValue(AnnotationAttributes attr) {
        Object value = attr.get((Object)"value");
        if (value == null) {
