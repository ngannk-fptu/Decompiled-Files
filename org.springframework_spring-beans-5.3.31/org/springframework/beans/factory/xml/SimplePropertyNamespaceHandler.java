    ...
    public BeanDefinitionHolder decorate(Node node, BeanDefinitionHolder definition, ParserContext parserContext) {
        if (node instanceof Attr) {
            ...
            if (propertyName.endsWith(REF_SUFFIX)) {
                ...
                pvs.add(Conventions.attributeNameToPropertyName((String)propertyName), new RuntimeBeanReference(propertyValue));
            } else {
                pvs.add(Conventions.attributeNameToPropertyName((String)propertyName), propertyValue);
            }
        }
        return definition;
    }
