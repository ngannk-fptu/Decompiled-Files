...
extends NamespaceHandlerSupport {
    ...
    extends AbstractSingleBeanDefinitionParser {
        ...
        protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
            ...
            if (StringUtils.hasText((String)mapClass)) {
                builder.addPropertyValue("targetMapClass", mapClass);
            }
            if (StringUtils.hasLength((String)(scope = element.getAttribute(UtilNamespaceHandler.SCOPE_ATTRIBUTE)))) {
                builder.setScope(scope);
            }
        }
    }
    ...
    extends AbstractSingleBeanDefinitionParser {
        ...
        protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
            ...
            if (StringUtils.hasText((String)setClass)) {
    ...
    extends AbstractSingleBeanDefinitionParser {
        ...
        protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
            ...
            if (StringUtils.hasText((String)listClass)) {
