...
implements BeanDefinitionDocumentReader {
    ...
    protected final XmlReaderContext getReaderContext() {
        Assert.state((this.readerContext != null ? 1 : 0) != 0, (String)"No XmlReaderContext available");
    ...
    protected void doRegisterBeanDefinitions(Element root) {
        ...
        if (this.delegate.isDefaultNamespace(root) && StringUtils.hasText((String)(profileSpec = root.getAttribute(PROFILE_ATTRIBUTE)))) {
            String[] specifiedProfiles = StringUtils.tokenizeToStringArray((String)profileSpec, (String)",; ");
    ...
    protected void importBeanDefinitionResource(Element ele) {
        ...
        try {
            absoluteLocation = ResourcePatternUtils.isUrl((String)location) || ResourceUtils.toURI((String)location).isAbsolute();
        }
        ...
        if (absoluteLocation) {
            ...
            try {
                ...
                if (relativeResource.exists()) {
                    ...
                    importCount = this.getReaderContext().getReader().loadBeanDefinitions(StringUtils.applyRelativePath((String)baseLocation, (String)location), actualResources);
                }
                if (this.logger.isTraceEnabled()) {
