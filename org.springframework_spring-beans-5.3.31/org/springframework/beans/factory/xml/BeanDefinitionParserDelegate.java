...
public class BeanDefinitionParserDelegate {
    ...
    public BeanDefinitionParserDelegate(XmlReaderContext readerContext) {
        Assert.notNull((Object)readerContext, (String)"XmlReaderContext must not be null");
    ...
    public String[] getAutowireCandidatePatterns() {
        ...
        return candidatePattern != null ? StringUtils.commaDelimitedListToStringArray((String)candidatePattern) : null;
    }
    ...
    public BeanDefinitionHolder parseBeanDefinitionElement(Element ele, @Nullable BeanDefinition containingBean) {
        ...
        if (StringUtils.hasLength((String)nameAttr)) {
            String[] nameArr = StringUtils.tokenizeToStringArray((String)nameAttr, (String)MULTI_VALUE_ATTRIBUTE_DELIMITERS);
            aliases.addAll(Arrays.asList(nameArr));
        }
        if (!StringUtils.hasText((String)(beanName = id)) && !aliases.isEmpty()) {
            beanName = (String)aliases.remove(0);
            if (this.logger.isTraceEnabled()) {
                this.logger.trace((Object)("No XML 'id' specified - using '" + beanName + "' as bean name and " + aliases + " as aliases"));
            }
        }
        ...
        if ((beanDefinition = this.parseBeanDefinitionElement(ele, beanName, containingBean)) != null) {
            if (!StringUtils.hasText((String)beanName)) {
                try {
                    ...
                    if (this.logger.isTraceEnabled()) {
                        this.logger.trace((Object)("Neither XML 'id' nor 'name' specified - using generated bean name [" + beanName + "]"));
                    }
                }
                catch (Exception ex) {
    ...
    public AbstractBeanDefinition parseBeanDefinitionElement(Element ele, String beanName, @Nullable BeanDefinition containingBean) {
        ...
        try {
            ...
            bd.setDescription(DomUtils.getChildElementValueByTagName((Element)ele, (String)DESCRIPTION_ELEMENT));
    ...
    public AbstractBeanDefinition parseBeanDefinitionAttributes(Element ele, String beanName, @Nullable BeanDefinition containingBean, AbstractBeanDefinition bd) {
        ...
        if (ele.hasAttribute(DEPENDS_ON_ATTRIBUTE)) {
            ...
            bd.setDependsOn(StringUtils.tokenizeToStringArray((String)dependsOn, (String)MULTI_VALUE_ATTRIBUTE_DELIMITERS));
        }
        if (this.isDefaultValue(autowireCandidate = ele.getAttribute(AUTOWIRE_CANDIDATE_ATTRIBUTE))) {
            String candidatePattern = this.defaults.getAutowireCandidates();
            if (candidatePattern != null) {
                String[] patterns = StringUtils.commaDelimitedListToStringArray((String)candidatePattern);
                bd.setAutowireCandidate(PatternMatchUtils.simpleMatch((String[])patterns, (String)beanName));
            }
        } else {
    ...
    public void parseReplacedMethodSubElements(Element beanEle, MethodOverrides overrides) {
        ...
        for (int i = 0; i < nl.getLength(); ++i) {
            ...
            List argTypeEles = DomUtils.getChildElementsByTagName((Element)replacedMethodEle, (String)ARG_TYPE_ELEMENT);
            for (Element argTypeEle : argTypeEles) {
                String match = argTypeEle.getAttribute(ARG_TYPE_MATCH_ATTRIBUTE);
                match = StringUtils.hasText((String)match) ? match : DomUtils.getTextValue((Element)argTypeEle);
                if (!StringUtils.hasText((String)match)) continue;
    ...
    public Map<Object, Object> parseMapElement(Element mapEle, @Nullable BeanDefinition bd) {
        ...
        List entryEles = DomUtils.getChildElementsByTagName((Element)mapEle, (String)ENTRY_ELEMENT);
        ...
        for (Element entryEle : entryEles) {
            ...
            if (hasValueAttribute) {
                ...
                if (!StringUtils.hasText((String)valueType)) {
    ...
    public Properties parsePropsElement(Element propsEle) {
        ...
        List propEles = DomUtils.getChildElementsByTagName((Element)propsEle, (String)PROP_ELEMENT);
    ...
    public BeanDefinitionHolder decorateIfRequired(Node node, BeanDefinitionHolder originalDef, @Nullable BeanDefinition containingBd) {
        ...
        if (namespaceUri != null && !this.isDefaultNamespace(namespaceUri)) {
            ...
            if (handler != null) {
                ...
                this.logger.debug((Object)("No Spring NamespaceHandler found for XML schema namespace [" + namespaceUri + "]"));
            }
        }
        return originalDef;
    }
    ...
    private BeanDefinitionHolder parseNestedCustomElement(Element ele, @Nullable BeanDefinition containingBd) {
        ...
        String id = ele.getNodeName() + "#" + ObjectUtils.getIdentityHexString((Object)innerDefinition);
        if (this.logger.isTraceEnabled()) {
            this.logger.trace((Object)("Using generated bean name [" + id + "] for nested custom element '" + ele.getNodeName() + "'"));
        }
    ...
    public boolean isDefaultNamespace(@Nullable String namespaceUri) {
        return !StringUtils.hasLength((String)namespaceUri) || BEANS_NAMESPACE_URI.equals(namespaceUri);
    }
    ...
    private boolean isDefaultValue(String value) {
        return !StringUtils.hasLength((String)value) || DEFAULT_VALUE.equals(value);
    }
