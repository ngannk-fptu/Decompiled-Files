        ...
        if (this.scopes != null) {
            this.scopes.forEach((scopeKey, value) -> {
                if (value instanceof Scope) {
                    ...
                    Assert.isAssignable(Scope.class, (Class)scopeClass, (String)"Invalid scope class");
                    beanFactory.registerScope((String)scopeKey, (Scope)BeanUtils.instantiateClass(scopeClass));
                } else if (value instanceof String) {
                    Class scopeClass = ClassUtils.resolveClassName((String)((String)value), (ClassLoader)this.beanClassLoader);
                    Assert.isAssignable(Scope.class, (Class)scopeClass, (String)"Invalid scope class");
                    beanFactory.registerScope((String)scopeKey, (Scope)BeanUtils.instantiateClass(scopeClass));
                } else {
