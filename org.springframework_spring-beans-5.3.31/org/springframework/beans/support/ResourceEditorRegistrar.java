...
implements PropertyEditorRegistrar {
    ...
    public void registerCustomEditors(PropertyEditorRegistry registry) {
        ...
        this.doRegisterEditor(registry, Resource.class, (PropertyEditor)baseEditor);
        this.doRegisterEditor(registry, ContextResource.class, (PropertyEditor)baseEditor);
        this.doRegisterEditor(registry, WritableResource.class, (PropertyEditor)baseEditor);
        ...
        if (this.resourceLoader instanceof ResourcePatternResolver) {
            this.doRegisterEditor(registry, Resource[].class, (PropertyEditor)new ResourceArrayPropertyEditor((ResourcePatternResolver)this.resourceLoader, this.propertyResolver));
        }
    }
