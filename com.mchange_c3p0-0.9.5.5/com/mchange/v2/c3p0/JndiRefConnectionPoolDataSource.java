...
Referenceable {
    ...
    JndiRefForwardingDataSource jrfds = new JndiRefForwardingDataSource();
    ...
    public String toString() {
        ...
        sb.append(" [");
        try {
            BeansUtils.appendPropNamesAndValues((StringBuffer)sb, (Object)this, (Collection)IGNORE_PROPS);
        }
        catch (Exception e) {
