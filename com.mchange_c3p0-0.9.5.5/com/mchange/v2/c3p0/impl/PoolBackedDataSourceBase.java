...
Serializable {
    ...
    private void writeObject(ObjectOutputStream oos) throws IOException {
        ...
        oos.writeShort(1);
        try {
            SerializableUtils.toByteArray((Object)this.connectionPoolDataSource);
            ...
            try {
                ...
                oos.writeObject(indirector.indirectForm((Object)this.connectionPoolDataSource));
            }
        ...
        try {
            SerializableUtils.toByteArray((Object)this.extensions);
            ...
            try {
                indirector = new ReferenceIndirector();
                oos.writeObject(indirector.indirectForm((Object)this.extensions));
            }
            catch (IOException indirectionIOException) {
                throw indirectionIOException;
            }
