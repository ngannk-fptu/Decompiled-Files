...
Serializable {
    ...
    public synchronized void setForceSynchronousCheckins(boolean forceSynchronousCheckins) {
    ...
    private void writeObject(ObjectOutputStream oos) throws IOException {
        ...
        try {
            SerializableUtils.toByteArray((Object)this.nestedDataSource);
            ...
            try {
                ...
                oos.writeObject(indirector.indirectForm((Object)this.nestedDataSource));
            }
    ...
    protected abstract PooledConnection getPooledConnection(ConnectionCustomizer var1, String var2) throws SQLException;

    protected abstract PooledConnection getPooledConnection(String var1, String var2, ConnectionCustomizer var3, String var4) throws SQLException;
