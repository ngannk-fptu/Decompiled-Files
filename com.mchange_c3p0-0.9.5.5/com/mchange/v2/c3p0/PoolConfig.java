...
public final class PoolConfig {
    ...
    private static void extractConfig(PoolConfig pcfg, Properties props, PoolConfig defaults) throws NumberFormatException {
        ...
        if (breakAfterAcquireFailureStr != null) {
            pcfg.setBreakAfterAcquireFailure(Boolean.valueOf(breakAfterAcquireFailureStr.trim()));
        } else if (defaults != null) {
        ...
        if (usesTraditionalReflectiveProxiesStr != null) {
            pcfg.setUsesTraditionalReflectiveProxies(Boolean.valueOf(usesTraditionalReflectiveProxiesStr.trim()));
        } else if (defaults != null) {
        ...
        if (testConnectionOnCheckoutStr != null) {
            pcfg.setTestConnectionOnCheckout(Boolean.valueOf(testConnectionOnCheckoutStr.trim()));
        } else if (defaults != null) {
        ...
        if (testConnectionOnCheckinStr != null) {
            pcfg.setTestConnectionOnCheckin(Boolean.valueOf(testConnectionOnCheckinStr.trim()));
        } else if (defaults != null) {
        ...
        if (forceIgnoreUnresolvedTransactionsStr != null) {
            pcfg.setForceIgnoreUnresolvedTransactions(Boolean.valueOf(forceIgnoreUnresolvedTransactionsStr.trim()));
        } else if (defaults != null) {
    ...
    static {
        ...
        DEFAULTS = PoolConfig.extractConfig(sysProps, rsrcDefaults);
    }
}
