...
extends ASN1Object {
    ...
    public TimeStampTokenEvidence(TimeStampAndCRL[] timeStampAndCRLArray) {
        this.timeStampAndCRLs = this.copy(timeStampAndCRLArray);
    }
    ...
    private TimeStampAndCRL[] copy(TimeStampAndCRL[] timeStampAndCRLArray) {
        TimeStampAndCRL[] timeStampAndCRLArray2 = new TimeStampAndCRL[timeStampAndCRLArray.length];
        System.arraycopy(timeStampAndCRLArray, 0, timeStampAndCRLArray2, 0, timeStampAndCRLArray2.length);
        return timeStampAndCRLArray2;
    }
