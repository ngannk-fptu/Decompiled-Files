...
extends ASN1Private {
    BERPrivate(boolean bl, int n, byte[] byArray) {
        super(bl, n, byArray);
    }

    public BERPrivate(int n, ASN1Encodable aSN1Encodable) throws IOException {
        this(true, n, aSN1Encodable);
    }

    public BERPrivate(boolean bl, int n, ASN1Encodable aSN1Encodable) throws IOException {
        super(bl || aSN1Encodable.toASN1Primitive().isConstructed(), n, BERPrivate.getEncoding(bl, aSN1Encodable));
    }
    ...
    private static byte[] getEncoding(boolean bl, ASN1Encodable aSN1Encodable) throws IOException {
        ...
        int n = BERPrivate.getLengthOfHeader(byArray);
