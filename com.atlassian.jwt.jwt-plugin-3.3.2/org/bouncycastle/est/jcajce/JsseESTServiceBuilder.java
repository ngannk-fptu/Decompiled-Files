...
extends ESTServiceBuilder {
    ...
    public JsseESTServiceBuilder(String string, int n, SSLSocketFactoryCreator sSLSocketFactoryCreator) {
        super(string + ":" + n);
    ...
    public JsseESTServiceBuilder(String string, int n, X509TrustManager x509TrustManager) {
        super(string + ":" + n);
    ...
    public JsseESTServiceBuilder(String string, int n, X509TrustManager[] x509TrustManagerArray) {
        this(string + ":" + n, x509TrustManagerArray);
    }
