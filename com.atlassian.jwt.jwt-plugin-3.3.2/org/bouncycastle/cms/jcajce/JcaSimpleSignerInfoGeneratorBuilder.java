...
public class JcaSimpleSignerInfoGeneratorBuilder {
    ...
    public SignerInfoGenerator build(String string, PrivateKey privateKey, X509CertificateHolder x509CertificateHolder) throws OperatorCreationException {
    ...
    public SignerInfoGenerator build(String string, PrivateKey privateKey, byte[] byArray) throws OperatorCreationException {
        privateKey = CMSUtils.cleanPrivateKey(privateKey);
        ContentSigner contentSigner = this.helper.createContentSigner(string, privateKey);
