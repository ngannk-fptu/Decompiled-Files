...
implements CMSSignatureAlgorithmNameGenerator {
    ...
    public String getSignatureName(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2) {
        if (EdECObjectIdentifiers.id_Ed25519.equals(algorithmIdentifier2.getAlgorithm())) {
            return "Ed25519";
        }
        if (EdECObjectIdentifiers.id_Ed448.equals(algorithmIdentifier2.getAlgorithm())) {
            return "Ed448";
        }
