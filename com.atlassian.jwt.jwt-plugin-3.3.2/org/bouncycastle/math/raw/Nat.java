...
public abstract class Nat {
    ...
    public static int addToEachOther(int n, int[] nArray, int n2, int[] nArray2, int n3) {
        long l = 0L;
        for (int i = 0; i < n; ++i) {
            nArray[n2 + i] = (int)(l += ((long)nArray[n2 + i] & 0xFFFFFFFFL) + ((long)nArray2[n3 + i] & 0xFFFFFFFFL));
            nArray2[n3 + i] = (int)l;
            l >>>= 32;
        }
        return (int)l;
    ...
    public static void cmov(int n, int n2, int[] nArray, int n3, int[] nArray2, int n4) {
        ...
        for (int i = 0; i < n; ++i) {
            int n5 = nArray2[n4 + i];
            int n6 = n5 ^ nArray[n3 + i];
            nArray2[n4 + i] = n5 ^= n6 & n2;
        }
    }
    ...
    public static int compare(int n, int[] nArray, int n2, int[] nArray2, int n3) {
        for (int i = n - 1; i >= 0; --i) {
            int n4 = nArray[n2 + i] ^ Integer.MIN_VALUE;
            int n5 = nArray2[n3 + i] ^ Integer.MIN_VALUE;
            if (n4 < n5) {
                return -1;
            }
            if (n4 <= n5) continue;
    ...
    public static int csub(int n, int n2, int[] nArray, int n3, int[] nArray2, int n4, int[] nArray3, int n5) {
        ...
        long l2 = 0L;
        for (int i = 0; i < n; ++i) {
            nArray3[n5 + i] = (int)(l2 += ((long)nArray[n3 + i] & 0xFFFFFFFFL) - ((long)nArray2[n4 + i] & l));
            l2 >>= 32;
        }
        return (int)l2;
    }
    ...
    public static int lessThan(int n, int[] nArray, int n2, int[] nArray2, int n3) {
        long l = 0L;
        for (int i = 0; i < n; ++i) {
            l += ((long)nArray[n2 + i] & 0xFFFFFFFFL) - ((long)nArray2[n3 + i] & 0xFFFFFFFFL);
            l >>= 32;
        }
        return (int)l;
    }
    ...
    public static void mul(int[] nArray, int n, int n2, int[] nArray2, int n3, int n4, int[] nArray3, int n5) {
        nArray3[n5 + n4] = Nat.mulWord(n4, nArray[n], nArray2, n3, nArray3, n5);
        for (int i = 1; i < n2; ++i) {
            nArray3[n5 + i + n4] = Nat.mulWordAddTo(n4, nArray[n + i], nArray2, n3, nArray3, n5 + i);
        }
    }
    ...
    public static int mulAddTo(int n, int[] nArray, int[] nArray2, int[] nArray3) {
        long l = 0L;
        for (int i = 0; i < n; ++i) {
            l += (long)Nat.mulWordAddTo(n, nArray[i], nArray2, 0, nArray3, i) & 0xFFFFFFFFL;
            nArray3[i + n] = (int)(l += (long)nArray3[i + n] & 0xFFFFFFFFL);
            l >>>= 32;
        }
        return (int)l;
    }
    ...
    public static int mulAddTo(int n, int[] nArray, int n2, int[] nArray2, int n3, int[] nArray3, int n4) {
        long l = 0L;
        for (int i = 0; i < n; ++i) {
            l += (long)Nat.mulWordAddTo(n, nArray[n2 + i], nArray2, n3, nArray3, n4) & 0xFFFFFFFFL;
            nArray3[n4 + n] = (int)(l += (long)nArray3[n4 + n] & 0xFFFFFFFFL);
            l >>>= 32;
            ++n4;
        }
        return (int)l;
    ...
    public static void square(int n, int[] nArray, int[] nArray2) {
        ...
        int n6 = 2;
        for (int i = 1; i < n; ++i) {
            l += (long)Nat.squareWordAddTo(nArray, i, nArray2) & 0xFFFFFFFFL;
            l += (long)nArray2[n6] & 0xFFFFFFFFL;
            nArray2[n6++] = (int)l;
            l >>>= 32;
            l += (long)nArray2[n6] & 0xFFFFFFFFL;
            nArray2[n6++] = (int)l;
    ...
    public static void square(int n, int[] nArray, int n2, int[] nArray2, int n3) {
        ...
        int n7 = n4;
        do {
            l = (long)nArray[n2 + --n6] & 0xFFFFFFFFL;
            long l2 = l * l;
        ...
        int n8 = n3 + 2;
        for (int i = 1; i < n; ++i) {
            l += (long)Nat.squareWordAddTo(nArray, n2, i, nArray2, n3) & 0xFFFFFFFFL;
            l += (long)nArray2[n8] & 0xFFFFFFFFL;
            nArray2[n8++] = (int)l;
            l >>>= 32;
            l += (long)nArray2[n8] & 0xFFFFFFFFL;
            nArray2[n8++] = (int)l;
