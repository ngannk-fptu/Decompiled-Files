...
public abstract class Nat128 {
    ...
    public static boolean diff(int[] nArray, int n, int[] nArray2, int n2, int[] nArray3, int n3) {
        boolean bl = Nat128.gte(nArray, n, nArray2, n2);
        if (bl) {
            Nat128.sub(nArray, n, nArray2, n2, nArray3, n3);
        } else {
            Nat128.sub(nArray2, n2, nArray, n, nArray3, n3);
        }
        return bl;
    }
    ...
    public static void mul(int[] nArray, int n, int[] nArray2, int n2, int[] nArray3, int n3) {
        ...
        long l5 = 0L;
        long l6 = (long)nArray[n + 0] & 0xFFFFFFFFL;
        nArray3[n3 + 0] = (int)(l5 += l6 * l);
        l5 >>>= 32;
        nArray3[n3 + 1] = (int)(l5 += l6 * l2);
        l5 >>>= 32;
        nArray3[n3 + 2] = (int)(l5 += l6 * l3);
        l5 >>>= 32;
        nArray3[n3 + 3] = (int)(l5 += l6 * l4);
        nArray3[n3 + 4] = (int)(l5 >>>= 32);
        for (int i = 1; i < 4; ++i) {
            long l7 = 0L;
    ...
    public static int mulAddTo(int[] nArray, int[] nArray2, int[] nArray3) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            nArray3[i + 4] = (int)(l5 += (l6 >>>= 32) + ((long)nArray3[i + 4] & 0xFFFFFFFFL));
            l5 >>>= 32;
        }
        return (int)l5;
    }
    ...
    public static int mulAddTo(int[] nArray, int n, int[] nArray2, int n2, int[] nArray3, int n3) {
        ...
        for (int i = 0; i < 4; ++i) {
            long l6 = 0L;
            long l7 = (long)nArray[n + i] & 0xFFFFFFFFL;
            nArray3[n3 + 0] = (int)(l6 += l7 * l + ((long)nArray3[n3 + 0] & 0xFFFFFFFFL));
            l6 >>>= 32;
            nArray3[n3 + 1] = (int)(l6 += l7 * l2 + ((long)nArray3[n3 + 1] & 0xFFFFFFFFL));
            l6 >>>= 32;
            nArray3[n3 + 2] = (int)(l6 += l7 * l3 + ((long)nArray3[n3 + 2] & 0xFFFFFFFFL));
            l6 >>>= 32;
            nArray3[n3 + 3] = (int)(l6 += l7 * l4 + ((long)nArray3[n3 + 3] & 0xFFFFFFFFL));
            nArray3[n3 + 4] = (int)(l5 += (l6 >>>= 32) + ((long)nArray3[n3 + 4] & 0xFFFFFFFFL));
            l5 >>>= 32;
            ++n3;
        }
        return (int)l5;
    ...
    public static int mul33WordAdd(int n, int n2, int[] nArray, int n3) {
        ...
        return (l >>>= 32) == 0L ? 0 : Nat.incAt(4, nArray, n3, 3);
    }
    ...
    public static int mulWordDwordAdd(int n, long l, int[] nArray, int n2) {
        ...
        return (l2 >>>= 32) == 0L ? 0 : Nat.incAt(4, nArray, n2, 3);
    }
    ...
    public static int mulWordsAdd(int n, int n2, int[] nArray, int n3) {
        ...
        return (l >>>= 32) == 0L ? 0 : Nat.incAt(4, nArray, n3, 2);
    }
