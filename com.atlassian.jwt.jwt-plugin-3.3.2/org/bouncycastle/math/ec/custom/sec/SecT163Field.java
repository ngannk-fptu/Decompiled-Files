...
public class SecT163Field {
    ...
    protected static void implMultiply(long[] lArray, long[] lArray2, long[] lArray3) {
        ...
        SecT163Field.implMulw(lArray4, l, l4 &= 0x7FFFFFFFFFFFFFL, lArray5, 0);
        SecT163Field.implMulw(lArray4, l3, l6, lArray5, 2);
        long l7 = l ^ l2 ^ l3;
        long l8 = l4 ^ l5 ^ l6;
        SecT163Field.implMulw(lArray4, l7, l8, lArray5, 4);
        long l9 = l2 << 1 ^ l3 << 2;
        long l10 = l5 << 1 ^ l6 << 2;
        SecT163Field.implMulw(lArray4, l ^ l9, l4 ^ l10, lArray5, 6);
        SecT163Field.implMulw(lArray4, l7 ^ l9, l8 ^ l10, lArray5, 8);
