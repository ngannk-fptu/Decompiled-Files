...
extends ECPoint.AbstractF2m {
    SecT233K1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
        super(eCCurve, eCFieldElement, eCFieldElement2);
    }

    SecT233K1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArray) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (eCFieldElement5.isZero()) {
            ...
            if (eCFieldElement3.isZero()) {
                return new SecT233K1Point(eCCurve, eCFieldElement3, eCCurve.getB());
            }
        ...
        return new SecT233K1Point(eCCurve, eCFieldElement3, eCFieldElement2, new ECFieldElement[]{eCFieldElement});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement5.isZero()) {
            return new SecT233K1Point(eCCurve, eCFieldElement5, eCCurve.getB());
        }
        ...
        return new SecT233K1Point(eCCurve, eCFieldElement6, eCFieldElement10, new ECFieldElement[]{eCFieldElement7});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElement13.isZero()) {
            return new SecT233K1Point(eCCurve, eCFieldElement13, eCCurve.getB());
        }
        ...
        return new SecT233K1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[]{eCFieldElement17});
    }
