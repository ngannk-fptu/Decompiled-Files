...
extends ECPoint.AbstractF2m {
    ...
    SecT283R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArray) {
        super(eCCurve, eCFieldElement, eCFieldElement2, eCFieldElementArray);
    }

    protected ECPoint detach() {
        return new SecT283R1Point(null, this.getAffineXCoord(), this.getAffineYCoord());
    }
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (eCFieldElement5.isZero()) {
            ...
            if (eCFieldElement3.isZero()) {
                return new SecT283R1Point(eCCurve, eCFieldElement3, eCCurve.getB().sqrt());
            }
        ...
        return new SecT283R1Point(eCCurve, eCFieldElement3, eCFieldElement2, new ECFieldElement[]{eCFieldElement});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement6.isZero()) {
            return new SecT283R1Point(eCCurve, eCFieldElement6, eCCurve.getB().sqrt());
        }
        ...
        return new SecT283R1Point(eCCurve, eCFieldElement7, eCFieldElement10, new ECFieldElement[]{eCFieldElement8});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElement12.isZero()) {
            return new SecT283R1Point(eCCurve, eCFieldElement12, eCCurve.getB().sqrt());
        }
        ...
        return new SecT283R1Point(eCCurve, eCFieldElement15, eCFieldElement17, new ECFieldElement[]{eCFieldElement16});
    }
