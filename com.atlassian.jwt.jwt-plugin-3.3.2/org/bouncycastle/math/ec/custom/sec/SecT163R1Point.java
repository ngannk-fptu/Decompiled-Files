...
extends ECPoint.AbstractF2m {
    ...
    SecT163R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArray) {
        super(eCCurve, eCFieldElement, eCFieldElement2, eCFieldElementArray);
    }

    @Override
    protected ECPoint detach() {
        return new SecT163R1Point(null, this.getAffineXCoord(), this.getAffineYCoord());
    }
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (eCFieldElement5.isZero()) {
            ...
            if (eCFieldElement3.isZero()) {
                return new SecT163R1Point(eCCurve, eCFieldElement3, eCCurve.getB().sqrt());
            }
        ...
        return new SecT163R1Point(eCCurve, eCFieldElement3, eCFieldElement2, new ECFieldElement[]{eCFieldElement});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement8.isZero()) {
            return new SecT163R1Point(eCCurve, eCFieldElement8, eCCurve.getB().sqrt());
        }
        ...
        return new SecT163R1Point(eCCurve, eCFieldElement9, eCFieldElement12, new ECFieldElement[]{eCFieldElement10});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElement13.isZero()) {
            return new SecT163R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt());
        }
        ...
        return new SecT163R1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[]{eCFieldElement17});
    }
