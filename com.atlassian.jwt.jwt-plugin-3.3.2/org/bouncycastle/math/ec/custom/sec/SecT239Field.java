...
public class SecT239Field {
    ...
    protected static void implMultiply(long[] lArray, long[] lArray2, long[] lArray3) {
        ...
        SecT239Field.implMulwAcc(lArray6, l ^ l2, l3 ^ l4, lArray3, 3);
        long[] lArray7 = new long[3];
        SecT239Field.implMulwAcc(lArray6, l, l3, lArray7, 0);
        SecT239Field.implMulwAcc(lArray6, l2, l4, lArray7, 1);
        long l5 = lArray7[0];
        long l6 = lArray7[1];
        long l7 = lArray7[2];
    ...
    protected static void implMulwAcc(long[] lArray, long l, long l2, long[] lArray2, int n) {
        ...
        int n4 = n;
        lArray2[n4] = lArray2[n4] ^ l4 & 0xFFFFFFFFFFFFFFFL;
        int n5 = n + 1;
        lArray2[n5] = lArray2[n5] ^ (l4 >>> 60 ^ (l3 ^= (l & 0x820820820820820L & l2 << 4 >> 63) >>> 5) << 4);
    }
