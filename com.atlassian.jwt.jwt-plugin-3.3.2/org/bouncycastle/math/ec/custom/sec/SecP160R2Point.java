...
extends ECPoint.AbstractFp {
    ...
    SecP160R2Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArray) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        return new SecP160R2Point(eCCurve, secP160R2FieldElement7, secP160R2FieldElement8, eCFieldElementArray);
    }
    ...
    public ECPoint twice() {
        ...
        SecP160R2Field.square(secP160R2FieldElement.x, nArray3);
        int[] nArray4 = Nat160.create();
        SecP160R2Field.square(nArray3, nArray4);
        boolean bl = secP160R2FieldElement3.isOne();
        int[] nArray5 = secP160R2FieldElement3.x;
        if (!bl) {
            nArray5 = nArray2;
            SecP160R2Field.square(secP160R2FieldElement3.x, nArray5);
        }
        SecP160R2Field.subtract(secP160R2FieldElement2.x, nArray5, nArray);
        int[] nArray6 = nArray2;
        SecP160R2Field.add(secP160R2FieldElement2.x, nArray5, nArray6);
        SecP160R2Field.multiply(nArray6, nArray, nArray6);
        int n = Nat160.addBothTo(nArray6, nArray6, nArray6);
        SecP160R2Field.reduce32(n, nArray6);
        int[] nArray7 = nArray3;
        SecP160R2Field.multiply(nArray3, secP160R2FieldElement2.x, nArray7);
        n = Nat.shiftUpBits(5, nArray7, 2, 0);
        SecP160R2Field.reduce32(n, nArray7);
        n = Nat.shiftUpBits(5, nArray4, 3, 0, nArray);
        SecP160R2Field.reduce32(n, nArray);
        SecP160R2FieldElement secP160R2FieldElement4 = new SecP160R2FieldElement(nArray4);
        SecP160R2Field.square(nArray6, secP160R2FieldElement4.x);
        SecP160R2Field.subtract(secP160R2FieldElement4.x, nArray7, secP160R2FieldElement4.x);
        SecP160R2Field.subtract(secP160R2FieldElement4.x, nArray7, secP160R2FieldElement4.x);
        SecP160R2FieldElement secP160R2FieldElement5 = new SecP160R2FieldElement(nArray7);
        SecP160R2Field.subtract(nArray7, secP160R2FieldElement4.x, secP160R2FieldElement5.x);
        SecP160R2Field.multiply(secP160R2FieldElement5.x, nArray6, secP160R2FieldElement5.x);
        SecP160R2Field.subtract(secP160R2FieldElement5.x, nArray, secP160R2FieldElement5.x);
        SecP160R2FieldElement secP160R2FieldElement6 = new SecP160R2FieldElement(nArray6);
