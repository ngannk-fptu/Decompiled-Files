...
public class SecT283Field {
    ...
    protected static void implMultiply(long[] lArray, long[] lArray2, long[] lArray3) {
        ...
        SecT283Field.implMulw(lArray6, l11 ^ lArray4[3], l12 ^ lArray5[3], lArray7, 18);
        SecT283Field.implMulw(lArray6, l13 ^ lArray4[1], l14 ^ lArray5[1], lArray7, 20);
        long l17 = l9 ^ l15;
        long l18 = l10 ^ l16;
        long l19 = l17 ^ lArray4[2];
        long l20 = l18 ^ lArray5[2];
        SecT283Field.implMulw(lArray6, l17, l18, lArray7, 22);
        SecT283Field.implMulw(lArray6, l19, l20, lArray7, 24);
        SecT283Field.implMulw(lArray6, l9, l10, lArray7, 10);
        SecT283Field.implMulw(lArray6, l11, l12, lArray7, 12);
        SecT283Field.implMulw(lArray6, l13, l14, lArray7, 14);
        SecT283Field.implMulw(lArray6, l15, l16, lArray7, 16);
        lArray3[0] = lArray7[0];
        lArray3[9] = lArray7[9];
        long l21 = lArray7[0] ^ lArray7[1];
        long l22 = l21 ^ lArray7[2];
        lArray3[1] = l8 = l22 ^ lArray7[10];
        ...
        long l28 = l26 ^ l27;
        long l29 = l28 ^ lArray7[8];
        long l30 = lArray7[13] ^ lArray7[14];
        long l31 = l29 ^ l30;
        long l32 = lArray7[18] ^ lArray7[22];
        long l33 = l32 ^ lArray7[24];
        lArray3[3] = l6 = l31 ^ l33;
        long l34 = lArray7[7] ^ lArray7[8];
        long l35 = l34 ^ lArray7[9];
        lArray3[8] = l5 = l35 ^ lArray7[17];
        long l36 = l35 ^ l27;
        long l37 = lArray7[15] ^ lArray7[16];
        lArray3[7] = l4 = l36 ^ l37;
        long l38 = l4 ^ l8;
        long l39 = lArray7[19] ^ lArray7[20];
        long l40 = lArray7[25] ^ lArray7[24];
        long l41 = lArray7[18] ^ lArray7[23];
        long l42 = l39 ^ l40;
        long l43 = l42 ^ l41;
        lArray3[4] = l3 = l43 ^ l38;
        long l44 = l7 ^ l5;
        long l45 = l42 ^ l44;
        long l46 = lArray7[21] ^ lArray7[22];
        lArray3[5] = l2 = l45 ^ l46;
        long l47 = l29 ^ lArray7[0];
        long l48 = l47 ^ lArray7[9];
        long l49 = l48 ^ l30;
        long l50 = l49 ^ lArray7[21];
        long l51 = l50 ^ lArray7[23];
        lArray3[6] = l = l51 ^ lArray7[25];
