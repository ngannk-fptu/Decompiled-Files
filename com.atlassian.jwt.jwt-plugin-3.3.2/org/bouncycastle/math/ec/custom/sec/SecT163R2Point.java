...
extends ECPoint.AbstractF2m {
    SecT163R2Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
        super(eCCurve, eCFieldElement, eCFieldElement2);
    }

    SecT163R2Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArray) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (eCFieldElement5.isZero()) {
            ...
            if (eCFieldElement3.isZero()) {
                return new SecT163R2Point(eCCurve, eCFieldElement3, eCCurve.getB().sqrt());
            }
        ...
        return new SecT163R2Point(eCCurve, eCFieldElement3, eCFieldElement2, new ECFieldElement[]{eCFieldElement});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement6.isZero()) {
            return new SecT163R2Point(eCCurve, eCFieldElement6, eCCurve.getB().sqrt());
        }
        ...
        return new SecT163R2Point(eCCurve, eCFieldElement7, eCFieldElement10, new ECFieldElement[]{eCFieldElement8});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElement12.isZero()) {
            return new SecT163R2Point(eCCurve, eCFieldElement12, eCCurve.getB().sqrt());
        }
        ...
        return new SecT163R2Point(eCCurve, eCFieldElement15, eCFieldElement17, new ECFieldElement[]{eCFieldElement16});
    }
