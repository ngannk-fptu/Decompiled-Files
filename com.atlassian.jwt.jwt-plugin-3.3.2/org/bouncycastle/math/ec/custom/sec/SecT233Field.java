...
public class SecT233Field {
    ...
    protected static void implMultiply(long[] lArray, long[] lArray2, long[] lArray3) {
        ...
        SecT233Field.implMulwAcc(lArray6, lArray4[0], lArray5[0], lArray3, 0);
        SecT233Field.implMulwAcc(lArray6, lArray4[1], lArray5[1], lArray3, 1);
        SecT233Field.implMulwAcc(lArray6, lArray4[2], lArray5[2], lArray3, 2);
        SecT233Field.implMulwAcc(lArray6, lArray4[3], lArray5[3], lArray3, 3);
        for (n = 5; n > 0; --n) {
            int n2 = n;
            lArray3[n2] = lArray3[n2] ^ lArray3[n - 1];
        }
        SecT233Field.implMulwAcc(lArray6, lArray4[0] ^ lArray4[1], lArray5[0] ^ lArray5[1], lArray3, 1);
        SecT233Field.implMulwAcc(lArray6, lArray4[2] ^ lArray4[3], lArray5[2] ^ lArray5[3], lArray3, 3);
        for (n = 7; n > 1; --n) {
            int n3 = n;
        ...
        SecT233Field.implMulwAcc(lArray6, l ^ l2, l3 ^ l4, lArray3, 3);
        long[] lArray7 = new long[3];
        SecT233Field.implMulwAcc(lArray6, l, l3, lArray7, 0);
        SecT233Field.implMulwAcc(lArray6, l2, l4, lArray7, 1);
        long l5 = lArray7[0];
        long l6 = lArray7[1];
        long l7 = lArray7[2];
