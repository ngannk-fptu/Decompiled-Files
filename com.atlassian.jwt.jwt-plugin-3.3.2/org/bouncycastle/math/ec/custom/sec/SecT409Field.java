...
public class SecT409Field {
    ...
    protected static void implMultiply(long[] lArray, long[] lArray2, long[] lArray3) {
        ...
        for (int i = 0; i < 7; ++i) {
            SecT409Field.implMulwAcc(lArray6, lArray4[i], lArray5[i], lArray3, i << 1);
        }
        long l = lArray3[0];
        long l2 = lArray3[1];
        ...
        long l3 = l ^ (l2 ^= lArray3[13]);
        lArray3[7] = lArray3[0] ^ l3;
        lArray3[8] = lArray3[1] ^ l3;
        lArray3[9] = lArray3[2] ^ l3;
        lArray3[10] = lArray3[3] ^ l3;
        lArray3[11] = lArray3[4] ^ l3;
        lArray3[12] = lArray3[5] ^ l3;
        lArray3[13] = lArray3[6] ^ l3;
