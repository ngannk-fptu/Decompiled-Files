...
extends ECPoint.AbstractFp {
    ...
    SM2P256V1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArray) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        return new SM2P256V1Point(eCCurve, sM2P256V1FieldElement7, sM2P256V1FieldElement8, eCFieldElementArray);
    }
