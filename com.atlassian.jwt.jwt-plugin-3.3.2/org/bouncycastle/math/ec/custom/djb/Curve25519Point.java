...
extends ECPoint.AbstractFp {
    ...
    Curve25519Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArray) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        return new Curve25519Point(eCCurve, curve25519FieldElement7, curve25519FieldElement8, eCFieldElementArray);
    }
    ...
    protected Curve25519Point twiceJacobianModified(boolean bl) {
        ...
        return new Curve25519Point(this.getCurve(), curve25519FieldElement5, curve25519FieldElement6, new ECFieldElement[]{curve25519FieldElement7, curve25519FieldElement8});
    }
}
