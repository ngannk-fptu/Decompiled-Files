...
public class JcaPublicKeyConverter {
    ...
    public PublicKeyDataObject getPublicKeyDataObject(ASN1ObjectIdentifier aSN1ObjectIdentifier, PublicKey publicKey) {
        ...
        org.bouncycastle.math.ec.ECPoint eCPoint = JcaPublicKeyConverter.convertPoint(eCCurve, eCParameterSpec.getGenerator());
        org.bouncycastle.math.ec.ECPoint eCPoint2 = JcaPublicKeyConverter.convertPoint(eCCurve, eCPublicKey.getW());
