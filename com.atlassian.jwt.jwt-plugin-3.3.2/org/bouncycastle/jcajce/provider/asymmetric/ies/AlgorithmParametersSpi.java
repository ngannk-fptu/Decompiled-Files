    ...
    protected void engineInit(byte[] byArray) throws IOException {
        try {
            ...
            if (aSN1Sequence.size() == 1) {
                ...
                this.currentSpec = new IESParameterSpec(ASN1OctetString.getInstance(aSN1TaggedObject, false).getOctets(), ASN1OctetString.getInstance(aSN1TaggedObject2, false).getOctets(), ASN1Integer.getInstance(aSN1Sequence.getObjectAt(2)).intValueExact());
                ...
                this.currentSpec = new IESParameterSpec(ASN1OctetString.getInstance(aSN1TaggedObject, false).getOctets(), ASN1OctetString.getInstance(aSN1TaggedObject3, false).getOctets(), ASN1Integer.getInstance(aSN1Sequence.getObjectAt(2)).intValueExact(), ASN1Integer.getInstance(aSN1Sequence2.getObjectAt(0)).intValueExact(), ASN1OctetString.getInstance(aSN1Sequence2.getObjectAt(1)).getOctets());
            }
        }
