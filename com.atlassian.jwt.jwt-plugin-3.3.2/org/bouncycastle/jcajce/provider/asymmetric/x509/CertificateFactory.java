...
extends CertificateFactorySpi {
    ...
    private java.security.cert.Certificate readPEMCertificate(InputStream inputStream, boolean bl) throws IOException, CertificateParsingException {
        return this.getCertificate(PEM_CERT_PARSER.readPEMObject(inputStream, bl));
    }
    ...
    private CRL readPEMCRL(InputStream inputStream, boolean bl) throws IOException, CRLException {
        return this.getCRL(PEM_CRL_PARSER.readPEMObject(inputStream, bl));
    }
    ...
    public java.security.cert.Certificate engineGenerateCertificate(InputStream inputStream) throws CertificateException {
        return this.doGenerateCertificate(inputStream, true);
    }

    private java.security.cert.Certificate doGenerateCertificate(InputStream inputStream, boolean bl) throws CertificateException {
        ...
        try {
            ...
            inputStream2.reset();
            if (n != 48) {
                return this.readPEMCertificate(inputStream2, bl);
            }
    ...
    public CRL engineGenerateCRL(InputStream inputStream) throws CRLException {
        return this.doGenerateCRL(inputStream, true);
    }

    private CRL doGenerateCRL(InputStream inputStream, boolean bl) throws CRLException {
        ...
        try {
            ...
            inputStream2.reset();
            if (n != 48) {
                return this.readPEMCRL(inputStream2, bl);
            }
