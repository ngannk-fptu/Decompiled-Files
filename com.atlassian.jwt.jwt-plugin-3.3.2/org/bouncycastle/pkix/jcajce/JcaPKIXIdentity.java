...
extends PKIXIdentity {
    ...
    public X509Certificate[] getX509CertificateChain() {
        X509Certificate[] x509CertificateArray = new X509Certificate[this.certs.length];
        System.arraycopy(this.certs, 0, x509CertificateArray, 0, x509CertificateArray.length);
