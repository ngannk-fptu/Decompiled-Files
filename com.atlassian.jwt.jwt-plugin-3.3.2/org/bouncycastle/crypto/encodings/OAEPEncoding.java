...
implements AsymmetricBlockCipher {
    ...
    public byte[] decodeBlock(byte[] byArray, int n, int n2) throws InvalidCipherTextException {
        ...
        int n7 = n6 = byArray3.length < 2 * this.defHash.length + 1 ? 1 : 0;
        ...
        for (n5 = 0; n5 != this.defHash.length; ++n5) {
            int n8 = n5;
            byArray3[n8] = (byte)(byArray3[n8] ^ byArray4[n5]);
        }
        ...
        for (n5 = this.defHash.length; n5 != byArray3.length; ++n5) {
            int n9 = n5;
            byArray3[n9] = (byte)(byArray3[n9] ^ byArray4[n5 - this.defHash.length]);
        }
        n5 = 0;
