...
implements SkippingStreamCipher {
    ...
    public static void salsaCore(int n, int[] nArray, int[] nArray2) {
        ...
        int n17 = nArray[15];
        for (int i = n; i > 0; i -= 2) {
            n10 ^= Integers.rotateLeft((n6 ^= Integers.rotateLeft(n2 + n14, 7)) + n2, 9);
            n2 ^= Integers.rotateLeft((n14 ^= Integers.rotateLeft(n10 + n6, 13)) + n10, 18);
            n15 ^= Integers.rotateLeft((n11 ^= Integers.rotateLeft(n7 + n3, 7)) + n7, 9);
            n7 ^= Integers.rotateLeft((n3 ^= Integers.rotateLeft(n15 + n11, 13)) + n15, 18);
            n4 ^= Integers.rotateLeft((n16 ^= Integers.rotateLeft(n12 + n8, 7)) + n12, 9);
            n12 ^= Integers.rotateLeft((n8 ^= Integers.rotateLeft(n4 + n16, 13)) + n4, 18);
            n9 ^= Integers.rotateLeft((n5 ^= Integers.rotateLeft(n17 + n13, 7)) + n17, 9);
            n17 ^= Integers.rotateLeft((n13 ^= Integers.rotateLeft(n9 + n5, 13)) + n9, 18);
            n4 ^= Integers.rotateLeft((n3 ^= Integers.rotateLeft(n2 + n5, 7)) + n2, 9);
            n2 ^= Integers.rotateLeft((n5 ^= Integers.rotateLeft(n4 + n3, 13)) + n4, 18);
            n9 ^= Integers.rotateLeft((n8 ^= Integers.rotateLeft(n7 + n6, 7)) + n7, 9);
            n7 ^= Integers.rotateLeft((n6 ^= Integers.rotateLeft(n9 + n8, 13)) + n9, 18);
            n10 ^= Integers.rotateLeft((n13 ^= Integers.rotateLeft(n12 + n11, 7)) + n12, 9);
            n12 ^= Integers.rotateLeft((n11 ^= Integers.rotateLeft(n10 + n13, 13)) + n10, 18);
            n15 ^= Integers.rotateLeft((n14 ^= Integers.rotateLeft(n17 + n16, 7)) + n17, 9);
            n17 ^= Integers.rotateLeft((n16 ^= Integers.rotateLeft(n15 + n14, 13)) + n15, 18);
        }
