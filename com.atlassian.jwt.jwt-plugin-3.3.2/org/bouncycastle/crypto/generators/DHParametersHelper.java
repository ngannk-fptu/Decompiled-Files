...
class DHParametersHelper {
    ...
    static BigInteger[] generateSafePrimes(int n, int n2, SecureRandom secureRandom) {
        ...
        int n3 = n - 1;
        int n4 = n >>> 2;
        while (!(bigInteger2 = (bigInteger = BigIntegers.createRandomPrime(n3, 2, secureRandom)).shiftLeft(1).add(ONE)).isProbablePrime(n2) || n2 > 2 && !bigInteger.isProbablePrime(n2 - 2) || WNafUtil.getNafWeight(bigInteger2) < n4) {
        }
