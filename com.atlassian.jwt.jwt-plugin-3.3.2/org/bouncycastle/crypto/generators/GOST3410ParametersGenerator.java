...
public class GOST3410ParametersGenerator {
    ...
    private BigInteger procedure_C(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        while ((bigInteger4 = BigIntegers.createRandomBigInteger(n, this.init_random)).compareTo(ONE) <= 0 || bigInteger4.compareTo(bigInteger5) >= 0 || (bigInteger3 = bigInteger4.modPow(bigInteger6, bigInteger)).compareTo(ONE) == 0) {
        }
        return bigInteger3;
    }
