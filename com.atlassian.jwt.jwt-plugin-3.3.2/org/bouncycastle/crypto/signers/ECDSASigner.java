...
DSAExt {
    ...
    public BigInteger[] generateSignature(byte[] byArray) {
        ...
        } while ((bigInteger3 = (eCPoint = eCMultiplier.multiply(eCDomainParameters.getG(), bigInteger2).normalize()).getAffineXCoord().toBigInteger().mod(bigInteger4)).equals(ZERO) || (bigInteger = BigIntegers.modOddInverse(bigInteger4, bigInteger2).multiply(bigInteger5.add(bigInteger6.multiply(bigInteger3))).mod(bigInteger4)).equals(ZERO));
    ...
    public boolean verifySignature(byte[] byArray, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigInteger6 = BigIntegers.modOddInverseVar(bigInteger4, bigInteger2);
