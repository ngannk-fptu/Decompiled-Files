...
implements Signer {
    ...
    public byte[] generateSignature() throws CryptoException, DataLengthException {
        ...
        n = 255 >>> this.block.length * 8 - this.emBits;
        this.block[0] = (byte)(this.block[0] & n);
    ...
    public boolean verifySignature(byte[] byArray) {
        ...
        int n2 = 255 >>> this.block.length * 8 - this.emBits;
        if ((this.block[0] & 0xFF) != (this.block[0] & n2) || this.block[this.block.length - 1] != this.trailer) {
            this.clearBlock(this.block);
            return false;
        }
        ...
        for (n = 0; n != byArray3.length; ++n) {
            int n3 = n;
            this.block[n3] = (byte)(this.block[n3] ^ byArray3[n]);
        }
    ...
    private byte[] maskGenerator(byte[] byArray, int n, int n2, int n3) {
        ...
        return this.maskGeneratorFunction1(byArray, n, n2, n3);
    }
