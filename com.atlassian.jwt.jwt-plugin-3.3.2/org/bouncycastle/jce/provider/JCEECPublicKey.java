...
ECPointEncoder {
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (algorithmIdentifier.getAlgorithm().equals(CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            this.gostParams = GOST3410PublicKeyAlgParameters.getInstance(algorithmIdentifier.getParameters());
            ...
            this.q = eCCurve.decodePoint(byArray2);
            ...
            if (x962Parameters.isNamedCurve()) {
                ...
                this.ecSpec = new ECNamedCurveSpec(ECUtil.getCurveName((ASN1ObjectIdentifier)aSN1Object), ellipticCurve, EC5Util.convertPoint(((X9ECParameters)object).getG()), ((X9ECParameters)object).getN(), ((X9ECParameters)object).getH());
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            object = this.getQ().getEncoded(this.withCompression);
            subjectPublicKeyInfo = new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, x962Parameters), (byte[])object);
        }
