...
implements MessageEncryptor {
    ...
    public byte[] messageDecrypt(byte[] byArray) throws InvalidCipherTextException {
        ...
        if (byArray6.length > n3) {
            byArray6 = ByteUtils.subArray(byArray6, 0, n3);
        }
        if ((byArray3 = Conversions.decode(this.n, this.t, gF2Vector)).length < n4) {
        ...
        int n6 = byArray2.length - n2;
        byte[][] byArray7 = ByteUtils.split(byArray2, n2);
        ...
        for (int i = n2 - 1; i >= 0; --i) {
            int n7 = i;
            byArray10[n7] = (byte)(byArray10[n7] ^ byArray8[i]);
        }
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        ...
        for (int i = n6 - 1; i >= 0; --i) {
            int n8 = i;
            byArray11[n8] = (byte)(byArray11[n8] ^ byArray9[i]);
        }
