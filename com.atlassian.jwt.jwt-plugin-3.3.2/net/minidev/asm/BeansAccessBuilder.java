    ...
    public Class<?> bulid() {
        ...
        if (this.accs.length == 0) {
            ...
            for (int acc2 = 0; acc2 < n; ++acc2) {
                ...
                if (acc.isPublic() || acc.getter == null) {
                    ...
                    String sig2 = Type.getMethodDescriptor(acc.getter);
            ...
            for (n = 0; n < n3; ++n) {
                ...
                if (acc3.isPublic() || acc3.getter == null) {
                    ...
                    sig = Type.getMethodDescriptor(acc3.getter);
        ...
        if (!USE_HASH) {
            ...
            for (n = 0; n < n4; ++n) {
                ...
                mv.visitLdcInsn(acc4.fieldName);
        ...
        if (!USE_HASH) {
            ...
            for (Accessor acc5 : this.accs) {
                mv.visitVarInsn(25, 2);
                mv.visitLdcInsn(acc5.fieldName);
                mv.visitMethodInsn(182, "java/lang/String", "equals", "(Ljava/lang/Object;)Z", false);
                ...
                if (acc5.isPublic() || acc5.getter == null) {
                    ...
                    sig = Type.getMethodDescriptor(acc5.getter);
