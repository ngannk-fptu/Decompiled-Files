...
extends DeserializationContext {
    ...
    public JsonMappingException mappingException(Class<?> targetClass, JsonToken token) {
        ...
        return JsonMappingException.from(this._parser, "Can not deserialize instance of " + clsName + " out of " + (Object)((Object)token) + " token");
    }
    ...
    public JsonMappingException wrongTokenException(JsonParser jp, JsonToken expToken, String msg) {
        return JsonMappingException.from(jp, "Unexpected token (" + (Object)((Object)jp.getCurrentToken()) + "), expected " + (Object)((Object)expToken) + ": " + msg);
    }
