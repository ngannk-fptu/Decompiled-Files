...
extends DefaultHandler {
    ...
    public String findNamespaceURI(String prefix) {
        ArrayStack nsStack = (ArrayStack)this.namespaces.get(prefix);
        if (nsStack == null) {
            return null;
        }
        try {
    ...
    public Map getCurrentNamespaces() {
        ...
        HashMap currentNamespaces = new HashMap();
        Iterator nsIterator = this.namespaces.entrySet().iterator();
        while (nsIterator.hasNext()) {
            Map.Entry nsEntry = nsIterator.next();
            try {
                currentNamespaces.put(nsEntry.getKey(), ((ArrayStack)nsEntry.getValue()).peek());
            }
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
        ...
        if ((rules = (List)this.matches.pop()) != null && rules.size() > 0) {
    ...
    public InputSource resolveEntity(String publicId, String systemId) throws SAXException {
        ...
        URL entityURL = null;
        if (publicId != null) {
            entityURL = (URL)this.entityValidator.get(publicId);
        }
        if (this.schemaLocation != null && entityURL == null && systemId != null) {
            entityURL = (URL)this.entityValidator.get(systemId);
        }
        if (entityURL == null) {
            if (systemId == null) {
    ...
    public void push(String stackName, Object value) {
        ArrayStack namedStack;
        if (this.stackAction != null) {
            value = this.stackAction.onPush(this, stackName, value);
        }
        if ((namedStack = (ArrayStack)this.stacksByName.get(stackName)) == null) {
    ...
    protected void cleanup() {
        Iterator sources = this.inputSources.iterator();
