    ...
    protected Resource getResource(String resourcePath, Resource location) throws IOException {
        ...
        if (resource.isReadable()) {
            ...
            if (this.logger.isWarnEnabled()) {
                ...
                this.logger.warn((Object)LogFormatUtils.formatValue((Object)("Resource path \"" + resourcePath + "\" was successfully resolved but resource \"" + resource.getURL() + "\" is neither under the current location \"" + location.getURL() + "\" nor under any of the allowed locations " + (allowed != null ? Arrays.asList(allowed) : "[]")), (int)-1, (boolean)true));
            }
        }
        return null;
    }
        ...
        if (request != null) {
            ...
            if (this.shouldEncodeRelativePath(location, usesPathPattern)) {
                ...
                while (tokenizer.hasMoreTokens()) {
                    String value = UriUtils.encode((String)tokenizer.nextToken(), (Charset)charset);
                    sb.append(value);
                    sb.append('/');
                }
                if (!path.endsWith("/")) {
