...
extends AbstractHtmlElementTag {
    ...
    public static final String MODEL_ATTRIBUTE_VARIABLE_NAME = Conventions.getQualifiedAttributeName(AbstractFormTag.class, (String)"modelAttribute");
    ...
    protected String resolveAction() throws JspException {
        ...
        if (StringUtils.hasText((String)servletRelativeAction)) {
        ...
        try {
            requestUri = UriUtils.encodePath((String)requestUri, (String)encoding);
        }
