...
implements AsyncServerResponse {
    static final boolean reactiveStreamsPresent = ClassUtils.isPresent((String)"org.reactivestreams.Publisher", (ClassLoader)DefaultAsyncServerResponse.class.getClassLoader());
