...
extends AbstractUrlBasedView {
    ...
    protected TransformerFactory newTransformerFactory(@Nullable Class<? extends TransformerFactory> transformerFactoryClass) {
        if (transformerFactoryClass != null) {
            try {
                return (TransformerFactory)ReflectionUtils.accessibleConstructor(transformerFactoryClass, (Class[])new Class[0]).newInstance(new Object[0]);
            }
            catch (Exception ex) {
    ...
    protected final TransformerFactory getTransformerFactory() {
        Assert.state((this.transformerFactory != null ? 1 : 0) != 0, (String)"No TransformerFactory available");
    ...
    protected Source locateSource(Map<String, Object> model) throws Exception {
        ...
        Object source = CollectionUtils.findValueOfType(model.values(), (Class[])this.getSourceTypes());
    ...
    protected final void configureIndentation(Transformer transformer) {
        if (this.indent) {
            TransformerUtils.enableIndenting((Transformer)transformer);
        } else {
            TransformerUtils.disableIndenting((Transformer)transformer);
        }
    }
    ...
    protected void configureResponse(Map<String, Object> model, HttpServletResponse response, Transformer transformer) {
        ...
        if (StringUtils.hasText((String)mediaType)) {
            contentType = mediaType;
        }
        if (StringUtils.hasText((String)encoding) && contentType != null && !contentType.toLowerCase().contains(";charset=")) {
    ...
    private Templates loadTemplates() throws ApplicationContextException {
        ...
        try {
            ...
            throw new ApplicationContextException("Can't load stylesheet from '" + this.getUrl() + "'", (Throwable)ex);
        }
        finally {
    ...
    protected Source getStylesheetSource() {
        ...
        try {
            ...
            throw new ApplicationContextException("Can't load XSLT stylesheet from '" + url + "'", (Throwable)ex);
        }
    }
