...
public class BindStatus {
    ...
    public BindStatus(RequestContext requestContext, String path, boolean htmlEscape) throws IllegalStateException {
        ...
        if (this.errors != null) {
            ...
            if (this.expression != null && !"*".equals(this.expression) && !this.expression.endsWith("*")) {
                BeanWrapper bw = PropertyAccessorFactory.forBeanPropertyAccess((Object)target);
    ...
    public String getErrorMessagesAsString(String delimiter) {
        return StringUtils.arrayToDelimitedString((Object[])this.initErrorMessages(), (String)delimiter);
    }
        ...
        if (this.errorMessages == null) {
            if (this.objectErrors != null) {
                ...
                for (int i2 = 0; i2 < this.objectErrors.size(); ++i2) {
                    ...
                    this.errorMessages[i2] = this.requestContext.getMessage((MessageSourceResolvable)error, this.htmlEscape);
                }
            } else {
                this.errorMessages = new String[0];
            }
