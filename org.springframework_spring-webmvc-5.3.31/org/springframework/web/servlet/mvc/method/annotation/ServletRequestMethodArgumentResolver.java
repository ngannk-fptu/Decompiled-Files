...
implements HandlerMethodArgumentResolver {
    ...
    private <T> T resolveNativeRequest(NativeWebRequest webRequest, Class<T> requiredType) {
        Object nativeRequest = webRequest.getNativeRequest(requiredType);
    ...
    static {
        try {
            pushBuilder = ClassUtils.forName((String)"javax.servlet.http.PushBuilder", (ClassLoader)ServletRequestMethodArgumentResolver.class.getClassLoader());
        }
