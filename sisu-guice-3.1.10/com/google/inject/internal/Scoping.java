...
public abstract class Scoping {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Scoping) {
            ...
            return Objects.equal(this.getScopeAnnotation(), o.getScopeAnnotation()) && Objects.equal((Object)this.getScopeInstance(), (Object)o.getScopeInstance());
        }
        return false;
    }

    public int hashCode() {
        return Objects.hashCode((Object[])new Object[]{this.getScopeAnnotation(), this.getScopeInstance()});
    }
    ...
    static Scoping makeInjectable(Scoping scoping, InjectorImpl injector, Errors errors) {
        ...
        if (scope != null) {
            return Scoping.forInstance(scope.getScope());
        }
