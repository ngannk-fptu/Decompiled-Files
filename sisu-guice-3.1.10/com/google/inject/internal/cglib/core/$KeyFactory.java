...
public abstract class $KeyFactory {
    ...
    extends $AbstractClassGenerator {
        private static final $AbstractClassGenerator.Source SOURCE = new $AbstractClassGenerator.Source((class$net$sf$cglib$core$KeyFactory == null ? (class$net$sf$cglib$core$KeyFactory = $KeyFactory.class$("com.google.inject.internal.cglib.core.$KeyFactory")) : class$net$sf$cglib$core$KeyFactory).getName());
