...
public class TypeLiteral<T> {
    ...
    private List<TypeLiteral<?>> resolveAll(Type[] types) {
        Object[] result = new TypeLiteral[types.length];
    ...
    public TypeLiteral<?> getSupertype(Class<?> supertype) {
        Preconditions.checkArgument((boolean)supertype.isAssignableFrom(this.rawType), (String)"%s is not a supertype of %s", (Object[])new Object[]{supertype, this.type});
        return this.resolve(MoreTypes.getGenericSupertype(this.type, this.rawType, supertype));
    }

    public TypeLiteral<?> getFieldType(Field field) {
        Preconditions.checkArgument((boolean)field.getDeclaringClass().isAssignableFrom(this.rawType), (String)"%s is not defined by a supertype of %s", (Object[])new Object[]{field, this.type});
    ...
    public List<TypeLiteral<?>> getParameterTypes(Member methodOrConstructor) {
        ...
        if (methodOrConstructor instanceof Method) {
            ...
            Preconditions.checkArgument((boolean)method.getDeclaringClass().isAssignableFrom(this.rawType), (String)"%s is not defined by a supertype of %s", (Object[])new Object[]{method, this.type});
            genericParameterTypes = method.getGenericParameterTypes();
        } else if (methodOrConstructor instanceof Constructor) {
            Constructor constructor = (Constructor)methodOrConstructor;
            Preconditions.checkArgument((boolean)constructor.getDeclaringClass().isAssignableFrom(this.rawType), (String)"%s does not construct a supertype of %s", (Object[])new Object[]{constructor, this.type});
