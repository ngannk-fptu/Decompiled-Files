...
public interface DirectoryCacheChangeOperations {
    ...
    public AddUpdateSets<UserTemplateWithCredentialAndAttributes, UserTemplate> getUsersToAddAndUpdate(Collection<? extends User> var1, Date var2) throws OperationFailedException;

    public void addUsers(Set<UserTemplateWithCredentialAndAttributes> var1) throws OperationFailedException;

    public void updateUsers(Collection<UserTemplate> var1) throws OperationFailedException;

    public GroupsToAddUpdateReplace findGroupsToUpdate(Collection<? extends Group> var1, Date var2) throws OperationFailedException;
    ...
    public GroupShadowingType isGroupShadowed(Group var1) throws OperationFailedException;

    public AddRemoveSets<String> findUserMembershipForGroupChanges(Group var1, Collection<String> var2) throws OperationFailedException;
    ...
    public AddRemoveSets<String> findGroupMembershipForGroupChanges(Group var1, Collection<String> var2) throws OperationFailedException;
    ...
    public static enum GroupShadowingType {
        SHADOWED_BY_ROLE,
    ...
    public static class GroupsToAddUpdateReplace {
        ...
        public GroupsToAddUpdateReplace(Set<GroupTemplate> groupsToAdd, Set<GroupTemplate> groupsToUpdate, Map<String, GroupTemplate> groupsToReplace) {
