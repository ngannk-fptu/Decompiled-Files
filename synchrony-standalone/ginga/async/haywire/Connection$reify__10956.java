...
public final class Connection$reify__10956
...
IObj {
    ...
    public Connection$reify__10956(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public Connection$reify__10956(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new Connection$reify__10956(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical(((IFn)const__1.getRawRoot()).invoke(gtarget), this.gclass)) {
            ...
            gtarget = null;
            object = ((Connection)object2).upstream;
        } else {
            object = this;
        }
        return object;
