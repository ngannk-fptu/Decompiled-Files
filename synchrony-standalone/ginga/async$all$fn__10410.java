...
public final class async$all$fn__10410
extends AFunction {
    Object i;
    Object result;
    Object result_ch;
    ...
    public async$all$fn__10410(Object object, Object object2, Object object3, Object object4) {
        this.i = object;
        this.result = object2;
        this.result_ch = object3;
        this.cnt = object4;
    }
    ...
    public Object invoke(Object p1__10402_SHARP_) {
        ...
        if (Numbers.isZero(((IFn)const__0.getRawRoot()).invoke(this_.cnt, const__3.getRawRoot()))) {
            async$all$fn__10410 this_;
            Object object3;
            Object map__10411 = ((IFn)const__4.getRawRoot()).invoke(const__5.getRawRoot(), ((IFn)const__6.getRawRoot()).invoke(this_.result));
            Object object4 = ((IFn)const__7.getRawRoot()).invoke(map__10411);
            if (object4 != null && object4 != Boolean.FALSE) {
                Object object5 = ((IFn)const__8.getRawRoot()).invoke(map__10411);
                if (object5 != null && object5 != Boolean.FALSE) {
                    Object object6 = map__10411;
                    map__10411 = null;
                    object3 = PersistentArrayMap.createAsIfByAssoc((Object[])((IFn)const__9.getRawRoot()).invoke(object6));
                } else {
                    Object object7 = ((IFn)const__10.getRawRoot()).invoke(map__10411);
                    if (object7 != null && object7 != Boolean.FALSE) {
                        Object object8 = map__10411;
                        map__10411 = null;
            ...
            Object map__104112 = object3;
            Object errors2 = RT.get(map__104112, Boolean.TRUE);
            Object object9 = map__104112;
            map__104112 = null;
