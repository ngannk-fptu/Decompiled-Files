...
public final class utils$de_nil__26283
extends AFunction {
    ...
    public static final AFn const__6 = Symbol.intern(null, "x__26276__auto__");
    public static final AFn const__7 = Symbol.intern(null, "if");
    public static final AFn const__8 = Symbol.intern("clojure.core", "nil?");
    public static final Keyword const__9 = RT.keyword("potemkin.utils", "nil");

    public static Object invokeStatic(Object x) {
        Object object = x;
        x = null;
        return ((IFn)const__0.getRawRoot()).invoke(((IFn)const__1.getRawRoot()).invoke(((IFn)const__2.getRawRoot()).invoke(const__3), ((IFn)const__2.getRawRoot()).invoke(((IFn)const__4.getRawRoot()).invoke(const__5.getRawRoot(), ((IFn)const__0.getRawRoot()).invoke(((IFn)const__1.getRawRoot()).invoke(((IFn)const__2.getRawRoot()).invoke(const__6), ((IFn)const__2.getRawRoot()).invoke(object))))), ((IFn)const__2.getRawRoot()).invoke(((IFn)const__0.getRawRoot()).invoke(((IFn)const__1.getRawRoot()).invoke(((IFn)const__2.getRawRoot()).invoke(const__7), ((IFn)const__2.getRawRoot()).invoke(((IFn)const__0.getRawRoot()).invoke(((IFn)const__1.getRawRoot()).invoke(((IFn)const__2.getRawRoot()).invoke(const__8), ((IFn)const__2.getRawRoot()).invoke(const__6)))), ((IFn)const__2.getRawRoot()).invoke(const__9), ((IFn)const__2.getRawRoot()).invoke(const__6))))));
    }
    ...
    public Object invoke(Object object) {
        ...
        object = null;
        return utils$de_nil__26283.invokeStatic(object2);
    }
}
