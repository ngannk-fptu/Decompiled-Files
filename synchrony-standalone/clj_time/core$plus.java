...
extends RestFn {
    ...
    public static Object invokeStatic(Object dt, Object p, ISeq ps) {
        v0 = (IFn)core$plus.const__1.getRawRoot();
        v1 = core$plus.const__0.getRawRoot();
        v2 = dt;
        dt = null;
        v3 = v2;
        if (Util.classOf(v2) == core$plus.__cached_class__1) ** GOTO lbl10
        if (!(v3 instanceof DateTimeProtocol)) {
            v3 = v3;
            core$plus.__cached_class__1 = Util.classOf(v3);
lbl10:
            // 2 sources

            v4 = p;
            p = null;
            v5 = core$plus.const__0.getRawRoot().invoke(v3, v4);
        } else {
            v6 = p;
            p = null;
            v5 = ((DateTimeProtocol)v3).plus_(v6);
        }
        v7 = ps;
        ps = null;
    ...
    public Object doInvoke(Object object, Object object2, Object object3) {
        ...
        object3 = null;
        return core$plus.invokeStatic(object4, object5, iSeq);
    }
    ...
    public static Object invokeStatic(Object dt2, Object p) {
        ...
        if (Util.classOf(object2) != __cached_class__0) {
            if (object3 instanceof DateTimeProtocol) {
                Object object4 = p;
                p = null;
                object = ((DateTimeProtocol)object3).plus_(object4);
                return object;
            }
            object3 = object3;
    ...
    public Object invoke(Object object, Object object2) {
        ...
        object2 = null;
        return core$plus.invokeStatic(object3, object4);
    }
    ...
    static {
        const__0 = RT.var("clj-time.core", "plus-");
