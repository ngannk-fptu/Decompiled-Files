...
public final class core$last_day_of_the_month
extends AFunction
implements IFn.LLO {
    ...
    public static Object invokeStatic(long year, long l) {
        ...
        if (Util.classOf(object2) != __cached_class__0) {
            if (object2 instanceof DateTimeProtocol) {
                object = ((DateTimeProtocol)object2).last_day_of_the_month_();
                return object;
            }
            object2 = object2;
    ...
    public Object invoke(Object object, Object object2) {
        return core$last_day_of_the_month.invokeStatic(RT.longCast((Number)object), RT.longCast((Number)object2));
    }

    @Override
    public final Object invokePrim(long l, long l2) {
        return core$last_day_of_the_month.invokeStatic(l, l2);
    }
    ...
    public static Object invokeStatic(Object dt2) {
        ...
        if (Util.classOf(object2) != __cached_class__1) {
            if (object3 instanceof DateTimeProtocol) {
                object = ((DateTimeProtocol)object3).last_day_of_the_month_();
                return object;
            }
            object3 = object3;
    ...
    public Object invoke(Object object) {
        ...
        object = null;
        return core$last_day_of_the_month.invokeStatic(object2);
    }

    static {
        const__0 = RT.var("clj-time.core", "last-day-of-the-month-");
