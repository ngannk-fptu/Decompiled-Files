...
public final class core$in_msecs
extends AFunction {
    ...
    public static Object invokeStatic(Object in2) {
        Object object;
        ((IFn)const__0.getRawRoot()).invoke("in-msecs has been deprecated in favor of in-millis");
        Object object2 = in2;
        in2 = null;
        Object object3 = object2;
        if (Util.classOf(object2) != __cached_class__0) {
            if (object3 instanceof InTimeUnitProtocol) {
                object = ((InTimeUnitProtocol)object3).in_millis();
                return object;
            }
            object3 = object3;
    ...
    public Object invoke(Object object) {
        ...
        object = null;
        return core$in_msecs.invokeStatic(object2);
    }

    static {
        const__0 = RT.var("clj-time.core", "deprecated");
        const__1 = RT.var("clj-time.core", "in-millis");
    }
}
