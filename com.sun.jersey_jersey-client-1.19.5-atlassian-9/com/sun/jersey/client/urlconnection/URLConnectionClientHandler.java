...
extends TerminatingClientHandler {
    ...
    private ClientResponse _invoke(final ClientRequest ro) throws IOException {
        ...
        if (entity != null) {
            Logger logger;
            uc.setDoOutput(true);
            if (ro.getMethod().equalsIgnoreCase("GET") && (logger = Logger.getLogger(URLConnectionClientHandler.class.getName())).isLoggable(Level.INFO)) {
                ...
                public OutputStream onGetOutputStream() throws IOException {
                    return new CommittingOutputStream(){
                        ...
                        public void commit() throws IOException {
                            URLConnectionClientHandler.this.writeOutBoundHeaders((MultivaluedMap<String, Object>)ro.getHeaders(), uc);
                        }
                    };
                }
            });
    ...
    extends ClientResponse {
        ...
        public String toString() {
            return this.uc.getRequestMethod() + " " + this.uc.getURL() + " returned a response status of " + this.getStatus() + " " + (Object)((Object)this.getClientResponseStatus());
        }
    }
}
