...
public class FileCommentCreateEvent
extends ConfluenceEvent {
    private final Attachment parentFile;
    private final FileComment fileComment;
    private final ConfluenceUser originatingUser;

    public FileCommentCreateEvent(@Nonnull Object src, @Nonnull Attachment file, @Nonnull FileComment fileComment, ConfluenceUser originatingUser) {
        super(src);
