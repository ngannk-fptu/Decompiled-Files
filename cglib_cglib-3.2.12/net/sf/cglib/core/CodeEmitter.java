...
import net.sf.cglib.core.LocalVariablesSorter;
...
extends LocalVariablesSorter {
    ...
    public void push(int i) {
        if (i < -1) {
            this.mv.visitLdcInsn((Object)new Integer(i));
        } else if (i <= 5) {
    ...
    public void push(long value) {
        if (value == 0L || value == 1L) {
            ...
            this.mv.visitLdcInsn((Object)new Long(value));
        }
    }
    ...
    public void push(float value) {
        if (value == 0.0f || value == 1.0f || value == 2.0f) {
            ...
            this.mv.visitLdcInsn((Object)new Float(value));
        }
    }
    ...
    public void push(double value) {
        if (value == 0.0 || value == 1.0) {
            ...
            this.mv.visitLdcInsn((Object)new Double(value));
        }
    }
    ...
    public void checkcast(Type type) {
        if (!type.equals((Object)Constants.TYPE_OBJECT)) {
