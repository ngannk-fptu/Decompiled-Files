...
implements HttpMessage {
    ...
    protected DefaultHttpMessage(HttpVersion version, HttpHeaders headers) {
        this.version = (HttpVersion)ObjectUtil.checkNotNull((Object)version, (String)"version");
        this.headers = (HttpHeaders)ObjectUtil.checkNotNull((Object)headers, (String)"headers");
    }
