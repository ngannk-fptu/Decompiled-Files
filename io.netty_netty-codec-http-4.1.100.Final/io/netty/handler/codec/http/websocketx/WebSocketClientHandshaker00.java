...
extends WebSocketClientHandshaker {
    ...
    protected FullHttpRequest newHandshakeRequest() {
        ...
        this.expectedChallengeResponseBytes = Unpooled.wrappedBuffer((byte[])WebSocketUtil.md5(challenge));
        URI wsURL = this.uri();
        DefaultFullHttpRequest request = new DefaultFullHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.GET, this.upgradeUrl(wsURL), Unpooled.wrappedBuffer((byte[])key3));
    ...
    protected void verify(FullHttpResponse response) {
        ...
        if (!challenge.equals((Object)this.expectedChallengeResponseBytes)) {
