...
public final class HttpHeaderValidationUtil {
    ...
    public static boolean isConnectionHeader(CharSequence name, boolean ignoreTeHeader) {
        ...
        switch (len) {
            case 2: {
                return ignoreTeHeader ? false : AsciiString.contentEqualsIgnoreCase((CharSequence)name, (CharSequence)HttpHeaderNames.TE);
            }
            case 7: {
            ...
            case 17: {
                return AsciiString.contentEqualsIgnoreCase((CharSequence)name, (CharSequence)HttpHeaderNames.TRANSFER_ENCODING);
            }
        }
        return false;
    }
    ...
    public static boolean isTeNotTrailers(CharSequence name, CharSequence value) {
        if (name.length() == 2) {
            return AsciiString.contentEqualsIgnoreCase((CharSequence)name, (CharSequence)HttpHeaderNames.TE) && !AsciiString.contentEqualsIgnoreCase((CharSequence)value, (CharSequence)HttpHeaderValues.TRAILERS);
        }
        return false;
    }
