...
public class SpdyFrameDecoder {
    ...
    public SpdyFrameDecoder(SpdyVersion spdyVersion, SpdyFrameDecoderDelegate delegate, int maxChunkSize) {
        this.spdyVersion = ((SpdyVersion)((Object)ObjectUtil.checkNotNull((Object)((Object)spdyVersion), (String)"spdyVersion"))).getVersion();
        this.delegate = (SpdyFrameDecoderDelegate)ObjectUtil.checkNotNull((Object)delegate, (String)"delegate");
