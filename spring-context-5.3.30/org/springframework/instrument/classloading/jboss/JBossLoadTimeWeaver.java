...
implements LoadTimeWeaver {
    ...
    public JBossLoadTimeWeaver(@Nullable ClassLoader classLoader) {
        ...
        try {
            Field transformer = ReflectionUtils.findField(classLoader.getClass(), (String)"transformer");
            if (transformer == null) {
            ...
            if (suggestedTransformer.getClass().getName().equals(WRAPPER_TRANSFORMER_CLASS_NAME)) {
                Field wrappedTransformer = ReflectionUtils.findField(suggestedTransformer.getClass(), (String)"transformer");
            ...
            Method addTransformer = ReflectionUtils.findMethod(this.delegatingTransformer.getClass(), (String)"addTransformer", (Class[])new Class[]{ClassFileTransformer.class});
