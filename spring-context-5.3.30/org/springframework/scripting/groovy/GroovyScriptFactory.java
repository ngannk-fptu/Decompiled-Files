...
BeanClassLoaderAware {
    ...
    public void setBeanClassLoader(ClassLoader classLoader) {
        this.groovyClassLoader = classLoader instanceof GroovyClassLoader && (this.compilerConfiguration == null || ((GroovyClassLoader)classLoader).hasCompatibleConfiguration(this.compilerConfiguration)) ? (GroovyClassLoader)classLoader : this.buildGroovyClassLoader(classLoader);
    }
    ...
    protected Object executeScript(ScriptSource scriptSource, Class<?> scriptClass) throws ScriptCompilationException {
        try {
            GroovyObject goo = (GroovyObject)ReflectionUtils.accessibleConstructor(scriptClass, (Class[])new Class[0]).newInstance(new Object[0]);
