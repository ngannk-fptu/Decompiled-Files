...
BeanClassLoaderAware {
    ...
    protected ScriptEngine retrieveScriptEngine(ScriptSource scriptSource) {
        ...
        if (scriptSource instanceof ResourceScriptSource && (filename = ((ResourceScriptSource)scriptSource).getResource().getFilename()) != null && (extension = StringUtils.getFilenameExtension((String)filename)) != null && (engine = scriptEngineManager.getEngineByExtension(extension)) != null) {
            return engine;
        }
        return null;
    }
