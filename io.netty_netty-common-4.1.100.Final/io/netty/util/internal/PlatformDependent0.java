...
final class PlatformDependent0 {
    ...
    static ByteBuffer alignSlice(ByteBuffer buffer, int alignment) {
        try {
            return (ByteBuffer)ALIGN_SLICE.invoke((Object)buffer, alignment);
        }
            ...
            if (unsafe != null) {
                ...
                if (maybeException == null) {
                    ...
                    if (logger.isTraceEnabled()) {
                        ...
                        logger.debug("sun.misc.Unsafe.copyMemory: unavailable: {}", (Object)((Throwable)maybeException).getMessage());
                    }
                }
            }
            if (unsafe != null) {
