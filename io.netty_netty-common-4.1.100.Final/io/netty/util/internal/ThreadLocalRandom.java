            ...
            if (secureRandom) {
                ...
                seedGeneratorThread = new Thread("initialSeedUniquifierGenerator"){
                    ...
                    public void run() {
                        ...
                        seedGeneratorEndTime = System.nanoTime();
                        long s = ((long)seed[0] & 0xFFL) << 56 | ((long)seed[1] & 0xFFL) << 48 | ((long)seed[2] & 0xFFL) << 40 | ((long)seed[3] & 0xFFL) << 32 | ((long)seed[4] & 0xFFL) << 24 | ((long)seed[5] & 0xFFL) << 16 | ((long)seed[6] & 0xFFL) << 8 | (long)seed[7] & 0xFFL;
                        seedQueue.add(s);
                    }
                };
