...
public class LinkToPageCondition
implements Condition {
    private final List<FileContentEventType> SUPPORTED_EVENTS = Arrays.asList(FileContentEventType.CREATE, FileContentEventType.UPDATE, FileContentEventType.DELETE, FileContentEventType.DELETE_VERSION);
