...
public class CommentOnFileCondition
implements Condition {
    private final List<FileContentEventType> SUPPORTED_EVENTS = Arrays.asList(FileContentEventType.CREATE, FileContentEventType.UPDATE);
