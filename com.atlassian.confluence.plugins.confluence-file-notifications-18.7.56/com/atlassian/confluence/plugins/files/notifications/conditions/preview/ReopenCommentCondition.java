...
public class ReopenCommentCondition
implements Condition {
    private final List<FileContentEventType> SUPPORTED_EVENTS = Collections.singletonList(FileContentEventType.RESOLVE_COMMENT);
