...
public class TrafficCounter {
    ...
    public TrafficCounter(AbstractTrafficShapingHandler trafficShapingHandler, ScheduledExecutorService executor, String name, long checkInterval) {
        this.name = (String)ObjectUtil.checkNotNull((Object)name, (String)"name");
        this.trafficShapingHandler = (AbstractTrafficShapingHandler)((Object)ObjectUtil.checkNotNullWithIAE((Object)((Object)trafficShapingHandler), (String)"trafficShapingHandler"));
        this.executor = executor;
        this.init(checkInterval);
    }
