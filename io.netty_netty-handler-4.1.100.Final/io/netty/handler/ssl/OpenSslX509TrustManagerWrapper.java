                ...
                Object maybeWrapper = AccessController.doPrivileged(new PrivilegedAction<Object>(){
                    ...
                    public Object run() {
                        try {
                            ...
                            long spiOffset = PlatformDependent.objectFieldOffset((Field)contextSpiField);
                            Object spi = PlatformDependent.getObject((Object)finalContext, (long)spiOffset);
                            if (spi != null) {
                                Class<?> clazz = spi.getClass();
                                do {
                                    try {
                                        Field trustManagerField = clazz.getDeclaredField("trustManager");
                                        long tmOffset = PlatformDependent.objectFieldOffset((Field)trustManagerField);
