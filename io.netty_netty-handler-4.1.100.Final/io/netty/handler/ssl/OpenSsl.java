...
public final class OpenSsl {
    ...
    private static void loadTcNative() throws Exception {
        ...
        NativeLibraryLoader.loadFirstAvailable((ClassLoader)PlatformDependent.getClassLoader(SSLContext.class), (String[])libNames.toArray(EmptyArrays.EMPTY_STRINGS));
    }
    ...
    private static Set<String> protocols(String property) {
        String protocolsString = SystemPropertyUtil.get((String)property, null);
