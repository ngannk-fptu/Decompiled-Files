...
public interface OutputConfigFlags {
    ...
    public static final int CFG_ADD_SPACE_AFTER_EMPTY_ELEM = 64;
    ...
    public static final int CFG_AUTO_CLOSE_OUTPUT = 8192;
    public static final int CFG_USE_DOUBLE_QUOTES_IN_XML_DECL = 16384;
}
