...
implements LocaleMacro {
    private static Log log = LogFactory.getLog((Class)(class$org$radeox$macro$LocalePreserved == null ? (class$org$radeox$macro$LocalePreserved = LocalePreserved.class$("org.radeox.macro.LocalePreserved")) : class$org$radeox$macro$LocalePreserved));
    private String name;
    static /* synthetic */ Class class$org$radeox$macro$LocalePreserved;
