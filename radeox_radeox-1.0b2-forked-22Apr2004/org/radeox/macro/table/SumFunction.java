...
implements Function {
    private static Log log = LogFactory.getLog((Class)(class$org$radeox$macro$table$SumFunction == null ? (class$org$radeox$macro$table$SumFunction = SumFunction.class$("org.radeox.macro.table.SumFunction")) : class$org$radeox$macro$table$SumFunction));
    static /* synthetic */ Class class$org$radeox$macro$table$SumFunction;
