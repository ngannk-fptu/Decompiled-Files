...
implements XMLStreamWriter {
    ...
    static class DeferredElement {
        ...
        public void addNamespaceDeclaration(String prefix, String namespaceUri) {
            if (null == this.namespaceUri && null != namespaceUri && DeferredElement.emptyIfNull(this.prefix).equals(prefix)) {
                this.namespaceUri = namespaceUri;
            }
            this.namespaceDeclarations.put(DeferredElement.emptyIfNull(namespaceUri), prefix);
        }
        ...
        public void addAttribute(String prefix, String ns, String ln, String value) {
            if (ns == null && prefix == null && SaajStaxWriter.xmlns.equals(ln)) {
                ...
                this.attributeDeclarations.add(new AttributeDeclaration(DeferredElement.emptyIfNull(prefix), ns, ln, value));
            }
        }
            ...
            try {
                if (this.localName != null) {
                    ...
                    for (AttributeDeclaration attribute : this.attributeDeclarations) {
                        ...
                        if ("".equals(DeferredElement.emptyIfNull(pfx)) && (p = this.namespaceDeclarations.get(attribute.namespaceUri)) != null) {
                            pfx = p;
                        }
                        SaajStaxWriter.addAttibuteToElement(newElement, pfx, attribute.namespaceUri, attribute.localName, attribute.value);
                    }
                    this.reset();
                    return newElement;
                }
