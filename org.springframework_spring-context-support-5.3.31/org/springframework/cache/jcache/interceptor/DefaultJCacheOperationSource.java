...
SmartInitializingSingleton {
    ...
    public void setCacheManager(@Nullable CacheManager cacheManager) {
        this.cacheManager = SingletonSupplier.ofNullable((Object)cacheManager);
    }
    ...
    public void setExceptionCacheResolver(@Nullable CacheResolver exceptionCacheResolver) {
        this.exceptionCacheResolver = SingletonSupplier.ofNullable((Object)exceptionCacheResolver);
    }
    ...
    protected <T> T getBean(Class<T> type) {
        Assert.state((this.beanFactory != null ? 1 : 0) != 0, () -> "BeanFactory required for resolution of [" + type + "]");
        try {
    ...
    protected CacheManager getDefaultCacheManager() {
        if (this.getCacheManager() == null) {
            ...
            try {
                this.cacheManager = SingletonSupplier.of((Object)this.beanFactory.getBean(CacheManager.class));
            }
            catch (NoUniqueBeanDefinitionException ex) {
    ...
    protected CacheResolver getDefaultCacheResolver() {
        if (this.getCacheResolver() == null) {
            this.cacheResolver = SingletonSupplier.of((Object)new SimpleCacheResolver(this.getDefaultCacheManager()));
        }
    ...
    protected CacheResolver getDefaultExceptionCacheResolver() {
        if (this.getExceptionCacheResolver() == null) {
            this.exceptionCacheResolver = SingletonSupplier.of((Object)new LazyCacheResolver());
        }
    ...
    protected KeyGenerator getDefaultKeyGenerator() {
        return (KeyGenerator)this.adaptedKeyGenerator.obtain();
    }
    ...
    implements CacheResolver {
        ...
        public Collection<? extends Cache> resolveCaches(CacheOperationInvocationContext<?> context) {
            return ((CacheResolver)this.cacheResolver.obtain()).resolveCaches(context);
        }
    }
}
