...
public enum ResourceErrorType {
    ...
    PERMISSION_USER_SET_PAGE_RESTRICTIONS(Component.PERMISSION, Component.USER, Component.PAGE),
    ...
    INVALID_SPACE(Component.INVALID, Component.SPACE),
    ...
    INVALID_ID_BLUEPRINT(Component.INVALID, Component.ID, Component.BLUEPRINT),
    INVALID_CREATE_RESULT_BLUEPRINT(Component.INVALID, Component.CREATE_RESULT, Component.BLUEPRINT),
    ACCESS_MODE(Component.READ_ONLY);
    ...
    @JsonCreator
    private static ResourceErrorType forValue(String value) {
        for (ResourceErrorType resourceErrorType : ResourceErrorType.values()) {
            if (!resourceErrorType.getValue().equals(value)) continue;
