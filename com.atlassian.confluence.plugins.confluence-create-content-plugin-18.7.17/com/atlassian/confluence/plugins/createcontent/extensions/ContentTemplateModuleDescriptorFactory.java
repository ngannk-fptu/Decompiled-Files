...
@Component
public class ContentTemplateModuleDescriptorFactory
extends SingleModuleDescriptorFactory<ContentTemplateModuleDescriptor> {
    @Autowired
    public ContentTemplateModuleDescriptorFactory(HostContainer hostContainer) {
        super(hostContainer, "content-template", ContentTemplateModuleDescriptor.class);
    }
}
