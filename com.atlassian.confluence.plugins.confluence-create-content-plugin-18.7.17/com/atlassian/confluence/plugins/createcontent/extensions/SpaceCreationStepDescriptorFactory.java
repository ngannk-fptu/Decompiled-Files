...
import com.atlassian.confluence.plugins.createcontent.extensions.SpaceCreationStepDescriptor;
...
@Component
public class SpaceCreationStepDescriptorFactory
extends SingleModuleDescriptorFactory<SpaceCreationStepDescriptor> {
    @Autowired
    public SpaceCreationStepDescriptorFactory(HostContainer hostContainer) {
        super(hostContainer, "space-creation-step", SpaceCreationStepDescriptor.class);
    }
}
