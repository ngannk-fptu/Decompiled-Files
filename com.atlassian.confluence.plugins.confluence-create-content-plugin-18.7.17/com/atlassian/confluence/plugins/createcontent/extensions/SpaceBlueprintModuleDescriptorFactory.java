...
@Component
public class SpaceBlueprintModuleDescriptorFactory
extends SingleModuleDescriptorFactory<SpaceBlueprintModuleDescriptor> {
    @Autowired
    public SpaceBlueprintModuleDescriptorFactory(HostContainer hostContainer) {
        super(hostContainer, "space-blueprint", SpaceBlueprintModuleDescriptor.class);
    }
}
