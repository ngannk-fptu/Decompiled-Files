...
extends AbstractConstant<ChannelOption<T>> {
    ...
    public static final ChannelOption<Integer> MAX_MESSAGES_PER_WRITE = ChannelOption.valueOf("MAX_MESSAGES_PER_WRITE");
    ...
    public static final ChannelOption<Boolean> TCP_FASTOPEN_CONNECT = ChannelOption.valueOf("TCP_FASTOPEN_CONNECT");
    public static final ChannelOption<Integer> TCP_FASTOPEN = ChannelOption.valueOf(ChannelOption.class, "TCP_FASTOPEN");
    @Deprecated
