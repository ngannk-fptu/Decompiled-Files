...
implements ByteBufAllocatorMetric {
    ...
    public String toString() {
        ...
        sb.append(StringUtil.simpleClassName(this)).append("(usedHeapMemory: ").append(this.usedHeapMemory()).append("; usedDirectMemory: ").append(this.usedDirectMemory()).append("; numHeapArenas: ").append(this.numHeapArenas()).append("; numDirectArenas: ").append(this.numDirectArenas()).append("; smallCacheSize: ").append(this.smallCacheSize()).append("; normalCacheSize: ").append(this.normalCacheSize()).append("; numThreadLocalCaches: ").append(this.numThreadLocalCaches()).append("; chunkSize: ").append(this.chunkSize()).append(')');
        return sb.toString();
    }
}
