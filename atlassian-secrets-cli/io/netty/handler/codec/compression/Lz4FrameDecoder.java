                    ...
                    try {
                        switch (blockType) {
                            ...
                            case 32: {
                                ...
                                this.decompressor.decompress(CompressionUtil.safeReadableNioBuffer(in), ((ByteBuf)uncompressed).internalNioBuffer(((ByteBuf)uncompressed).writerIndex(), decompressedLength));
