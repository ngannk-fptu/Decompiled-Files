...
extends AbstractHttp2ConnectionHandlerBuilder<Http2MultiplexCodec, Http2MultiplexCodecBuilder> {
    ...
    @Override
    public Http2MultiplexCodecBuilder decoderEnforceMaxRstFramesPerWindow(int maxConsecutiveEmptyFrames, int secondsPerWindow) {
        return (Http2MultiplexCodecBuilder)super.decoderEnforceMaxRstFramesPerWindow(maxConsecutiveEmptyFrames, secondsPerWindow);
    }
