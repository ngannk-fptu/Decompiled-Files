...
public class AnyGetterWriter {
    ...
    public void getAndSerialize(Object bean2, JsonGenerator gen, SerializerProvider provider) throws Exception {
        Object value = this._accessor.getValue(bean2);
        if (value == null) {
            return;
        }
    ...
    public void getAndFilter(Object bean2, JsonGenerator gen, SerializerProvider provider, PropertyFilter filter) throws Exception {
        Object value = this._accessor.getValue(bean2);
        if (value == null) {
            return;
        }
        ...
        if (this._mapSerializer != null) {
            this._mapSerializer.serializeFilteredAnyProperties(provider, gen, bean2, (Map)value, filter, null);
            return;
        }
        this._serializer.serialize(value, gen, provider);
    }
