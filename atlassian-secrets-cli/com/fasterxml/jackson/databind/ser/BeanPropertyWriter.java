...
implements Serializable {
    ...
    @Override
    public void serializeAsField(Object bean2, JsonGenerator gen, SerializerProvider prov) throws Exception {
        Class<?> cls;
        PropertySerializerMap m;
        Object value;
        Object object = value = this._accessorMethod == null ? this._field.get(bean2) : this._accessorMethod.invoke(bean2, (Object[])null);
        if (value == null) {
        ...
        if (value == bean2 && this._handleSelfReference(bean2, gen, prov, ser)) {
            return;
        }
        gen.writeFieldName(this._name);
    ...
    @Override
    public void serializeAsOmittedField(Object bean2, JsonGenerator gen, SerializerProvider prov) throws Exception {
    ...
    @Override
    public void serializeAsElement(Object bean2, JsonGenerator gen, SerializerProvider prov) throws Exception {
        Class<?> cls;
    ...
    @Override
    public void serializeAsPlaceholder(Object bean2, JsonGenerator gen, SerializerProvider prov) throws Exception {
        if (this._nullSerializer != null) {
            this._nullSerializer.serialize(null, gen, prov);
        } else {
            gen.writeNull();
    ...
    public final Object get(Object bean2) throws Exception {
        return this._accessorMethod == null ? this._field.get(bean2) : this._accessorMethod.invoke(bean2, (Object[])null);
    }

    protected boolean _handleSelfReference(Object bean2, JsonGenerator gen, SerializerProvider prov, JsonSerializer<?> ser) throws IOException {
        if (!ser.usesObjectId()) {
