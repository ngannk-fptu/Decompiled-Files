...
SchemaAware {
    ...
    @Override
    public boolean isEmpty(SerializerProvider ctxt, Object bean2) {
        Object referenced = this._accessor.getValue(bean2);
        if (referenced == null) {
            return true;
        }
    ...
    @Override
    public void serialize(Object bean2, JsonGenerator gen, SerializerProvider ctxt) throws IOException {
        Object value;
        try {
            value = this._accessor.getValue(bean2);
        }
        catch (Exception e) {
            value = null;
            this.wrapAndThrow(ctxt, (Throwable)e, bean2, this._accessor.getName() + "()");
        }
        if (value == null) {
    ...
    @Override
    public void serializeWithType(Object bean2, JsonGenerator gen, SerializerProvider ctxt, TypeSerializer typeSer0) throws IOException {
        Object value;
        try {
            value = this._accessor.getValue(bean2);
        }
        ...
        if (ser == null) {
            ...
            WritableTypeId typeIdDef = typeSer0.writeTypePrefix(gen, typeSer0.typeId(bean2, JsonToken.VALUE_STRING));
            ser.serialize(value, gen, ctxt);
            typeSer0.writeTypeSuffix(gen, typeIdDef);
            return;
        }
        TypeSerializerRerouter rr = new TypeSerializerRerouter(typeSer0, bean2);
