    ...
    implements Serializable {
        ...
        public void serializeAsField(Object bean2, JsonGenerator gen, SerializerProvider prov) throws Exception {
            if (this._inView(prov.getActiveView())) {
                this._delegate.serializeAsField(bean2, gen, prov);
                return;
            }
            this._delegate.serializeAsOmittedField(bean2, gen, prov);
        }

        @Override
        public void serializeAsElement(Object bean2, JsonGenerator gen, SerializerProvider prov) throws Exception {
            if (this._inView(prov.getActiveView())) {
                this._delegate.serializeAsElement(bean2, gen, prov);
                return;
            }
            this._delegate.serializeAsPlaceholder(bean2, gen, prov);
        }
