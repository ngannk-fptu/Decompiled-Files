...
PropertyFilter {
    ...
    @Override
    @Deprecated
    public void serializeAsField(Object bean2, JsonGenerator jgen, SerializerProvider provider, BeanPropertyWriter writer) throws Exception {
        if (this.include(writer)) {
            writer.serializeAsField(bean2, jgen, provider);
        } else if (!jgen.canOmitFields()) {
            writer.serializeAsOmittedField(bean2, jgen, provider);
        }
    }
