...
implements Serializable {
    ...
    public Object handleUnexpectedToken(JavaType targetType, JsonToken t, JsonParser p, String msg, Object ... msgArgs) throws IOException {
        ...
        if (msg == null) {
            ...
            msg = t == null ? String.format("Unexpected end-of-input when trying read value of type %s", targetDesc) : String.format("Cannot deserialize value of type %s from %s (token `JsonToken.%s`)", new Object[]{targetDesc, this._shapeForToken(t), t});
        }
    ...
    public <T> T reportUnresolvedObjectId(ObjectIdReader oidReader, Object bean2) throws JsonMappingException {
        String msg = String.format("No Object Id found for an instance of %s, to assign to property '%s'", ClassUtil.classNameOf(bean2), oidReader.propertyName);
    ...
    public <T> T reportBadTypeDefinition(BeanDescription bean2, String msg, Object ... msgArgs) throws JsonMappingException {
        msg = this._format(msg, msgArgs);
        String beanDesc = ClassUtil.nameOf(bean2.getBeanClass());
        msg = String.format("Invalid type definition for type %s: %s", beanDesc, msg);
        throw InvalidDefinitionException.from(this._parser, msg, bean2, null);
    }

    public <T> T reportBadPropertyDefinition(BeanDescription bean2, BeanPropertyDefinition prop, String msg, Object ... msgArgs) throws JsonMappingException {
        msg = this._format(msg, msgArgs);
        ...
        throw InvalidDefinitionException.from(this._parser, msg, bean2, prop);
    }
    ...
    public JsonMappingException wrongTokenException(JsonParser p, JavaType targetType, JsonToken expToken, String extra) {
        String msg = String.format("Unexpected token (%s), expected %s", new Object[]{p.currentToken(), expToken});
