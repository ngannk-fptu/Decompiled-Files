    ...
    public Object createFromInt(DeserializationContext ctxt, int value) throws IOException {
        ...
        if (this._fromBigIntegerCreator != null) {
            ...
            try {
                ...
                return ctxt.handleInstantiationProblem(this._fromBigIntegerCreator.getDeclaringClass(), arg, this.rewrapCtorProblem(ctxt, t0));
            }
        }
    ...
    public Object createFromBigInteger(DeserializationContext ctxt, BigInteger value) throws IOException {
        if (this._fromBigIntegerCreator != null) {
            try {
                ...
                return ctxt.handleInstantiationProblem(this._fromBigIntegerCreator.getDeclaringClass(), value, this.rewrapCtorProblem(ctxt, t));
            }
        }
    ...
    public Object createFromDouble(DeserializationContext ctxt, double value) throws IOException {
        ...
        if (this._fromBigDecimalCreator != null) {
            ...
            try {
                ...
                return ctxt.handleInstantiationProblem(this._fromBigDecimalCreator.getDeclaringClass(), arg, this.rewrapCtorProblem(ctxt, t0));
            }
        }
    ...
    public Object createFromBigDecimal(DeserializationContext ctxt, BigDecimal value) throws IOException {
        ...
        if (this._fromBigDecimalCreator != null) {
            try {
                ...
                return ctxt.handleInstantiationProblem(this._fromBigDecimalCreator.getDeclaringClass(), value, this.rewrapCtorProblem(ctxt, t));
            }
        }
        if (this._fromDoubleCreator != null && (dbl = StdValueInstantiator.tryConvertToDouble(value)) != null) {
            try {
                ...
                return ctxt.handleInstantiationProblem(this._fromDoubleCreator.getDeclaringClass(), dbl, this.rewrapCtorProblem(ctxt, t0));
            }
        }
