...
public abstract class PropertyValue {
    ...
    extends PropertyValue {
        ...
        @Override
        public void assign(Object bean2) throws IOException, JsonProcessingException {
            ((java.util.Map)bean2).put(this._key, this.value);
        }
    }
    ...
    extends PropertyValue {
        ...
        @Override
        public void assign(Object bean2) throws IOException, JsonProcessingException {
            this._property.set(bean2, this._propertyName, this.value);
        }
    }
    ...
    extends PropertyValue {
        ...
        @Override
        public void assign(Object bean2) throws IOException, JsonProcessingException {
            this._property.set(bean2, this.value);
        }
    }
}
