...
public class PropertyValueBuffer {
    ...
    public Object handleIdValue(DeserializationContext ctxt, Object bean2) throws IOException {
        if (this._objectIdReader != null) {
            if (this._idValue != null) {
                ...
                if (idProp != null) {
                    return idProp.setAndReturn(bean2, this._idValue);
                }
            } else {
                ctxt.reportUnresolvedObjectId(this._objectIdReader, bean2);
            }
        }
        return bean2;
    }
