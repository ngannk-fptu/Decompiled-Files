...
Serializable {
    ...
    public BeanPropertyMap withoutProperties(Collection<String> toExclude, Collection<String> toInclude) {
        ...
        for (int i = 0; i < len; ++i) {
            SettableBeanProperty prop = this._propsInOrder[i];
            if (prop == null || IgnorePropertiesUtil.shouldIgnore(prop.getName(), toExclude, toInclude)) continue;
            newProps.add(prop);
        }
        return new BeanPropertyMap(this._caseInsensitive, newProps, this._aliasDefs, this._locale);
    }
    ...
    public boolean findDeserializeAndSet(JsonParser p, DeserializationContext ctxt, Object bean2, String key) throws IOException {
        ...
        try {
            ...
            this.wrapAndThrow(e, bean2, key, ctxt);
        }
        return true;
    }
    ...
    protected void wrapAndThrow(Throwable t, Object bean2, String fieldName, DeserializationContext ctxt) throws IOException {
        boolean wrap;
        ...
        throw JsonMappingException.wrapWithPath(t, bean2, fieldName);
    }
