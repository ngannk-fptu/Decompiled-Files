...
extends DatabindContext {
    ...
    public <T> T reportBadTypeDefinition(BeanDescription bean2, String msg, Object ... msgArgs) throws JsonMappingException {
        String beanDesc = "N/A";
        if (bean2 != null) {
            beanDesc = ClassUtil.nameOf(bean2.getBeanClass());
        }
        msg = String.format("Invalid type definition for type %s: %s", beanDesc, this._format(msg, msgArgs));
        throw InvalidDefinitionException.from(this.getGenerator(), msg, bean2, null);
    }

    public <T> T reportBadPropertyDefinition(BeanDescription bean2, BeanPropertyDefinition prop, String message, Object ... msgArgs) throws JsonMappingException {
        ...
        throw InvalidDefinitionException.from(this.getGenerator(), message, bean2, prop);
    }
