        ...
        block6: while (true) {
            ...
            switch (t.id()) {
                case 3: {
                    ...
                    this._headContext = this._headContext.createChildArrayContext(f, false);
                    if (this._inclusion != TokenFilter.Inclusion.INCLUDE_ALL_AND_PATH || (t = this._nextTokenWithBuffering(this._headContext)) == null) continue block6;
                    this._currToken = t;
                    return t;
                }
                case 1: {
                ...
                case 5: {
                    ...
                    this._itemFilter = f;
                    if (f == TokenFilter.INCLUDE_ALL) {
                        if (!this._verifyAllowedMatches() || this._inclusion != TokenFilter.Inclusion.INCLUDE_ALL_AND_PATH) continue block6;
                        this._currToken = t;
                        return this._currToken;
                    }
                    if (this._inclusion == TokenFilter.Inclusion.ONLY_INCLUDE_ALL || (t = this._nextTokenWithBuffering(this._headContext)) == null) continue block6;
                    this._currToken = t;
                    return t;
                }
            }
