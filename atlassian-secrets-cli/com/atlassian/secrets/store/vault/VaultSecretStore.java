...
implements SecretStore {
    ...
    public String get(String jsonParams) {
        try {
            VaultParams vaultParams = this.objectMapper.readValue(jsonParams, VaultParams.class);
            ...
            Object readResponse = vaultTemplate.opsForVersionedKeyValue(vaultParams.getMount()).get(vaultParams.getPath());
