...
implements ServiceMetadata {
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put(ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), "waf.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("aws-global")).tags(EndpointTag.of("fips")).build(), "waf-fips.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("aws-global-fips")).build(), "waf-fips.amazonaws.com").build();
