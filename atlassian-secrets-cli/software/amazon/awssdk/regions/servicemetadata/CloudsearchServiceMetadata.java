...
@SdkPublicApi
public final class CloudsearchServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "cloudsearch";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-northeast-1"), Region.of("ap-northeast-2"), Region.of("ap-southeast-1"), Region.of("ap-southeast-2"), Region.of("eu-central-1"), Region.of("eu-west-1"), Region.of("sa-east-1"), Region.of("us-east-1"), Region.of("us-west-1"), Region.of("us-west-2")));
