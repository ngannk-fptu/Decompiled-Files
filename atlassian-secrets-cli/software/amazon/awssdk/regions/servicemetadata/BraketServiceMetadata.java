...
@SdkPublicApi
public final class BraketServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "braket";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("eu-west-2"), Region.of("us-east-1"), Region.of("us-west-1"), Region.of("us-west-2")));
