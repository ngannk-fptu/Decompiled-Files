...
@SdkPublicApi
public final class ApiPricingServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "api.pricing";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-south-1"), Region.of("eu-central-1"), Region.of("us-east-1"), Region.of("cn-northwest-1")));
