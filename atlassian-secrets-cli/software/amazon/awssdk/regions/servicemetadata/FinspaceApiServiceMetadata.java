...
@SdkPublicApi
public final class FinspaceApiServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "finspace-api";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ca-central-1"), Region.of("eu-west-1"), Region.of("us-east-1"), Region.of("us-east-2"), Region.of("us-west-2")));
