...
implements ServiceMetadata {
    ...
    private static final Map<ServiceEndpointKey, String> SIGNING_REGIONS_BY_REGION = ImmutableMap.builder().put(ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), "us-east-1").put(ServiceEndpointKey.builder().region(Region.of("aws-global")).tags(EndpointTag.of("fips")).build(), "us-east-1").put(ServiceEndpointKey.builder().region(Region.of("fips-aws-global")).build(), "us-east-1").put(ServiceEndpointKey.builder().region(Region.of("aws-cn-global")).build(), "cn-northwest-1").put(ServiceEndpointKey.builder().region(Region.of("aws-iso-global")).build(), "us-iso-east-1").put(ServiceEndpointKey.builder().region(Region.of("aws-iso-b-global")).build(), "us-isob-east-1").put(ServiceEndpointKey.builder().region(Region.of("aws-us-gov-global")).build(), "us-gov-west-1").put(ServiceEndpointKey.builder().region(Region.of("aws-us-gov-global")).tags(EndpointTag.of("fips")).build(), "us-gov-west-1").put(ServiceEndpointKey.builder().region(Region.of("fips-aws-us-gov-global")).build(), "us-gov-west-1").build();
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put(ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), "route53.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("aws-global")).tags(EndpointTag.of("fips")).build(), "route53-fips.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("fips-aws-global")).build(), "route53-fips.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("aws-cn-global")).build(), "route53.amazonaws.com.cn").put(ServiceEndpointKey.builder().region(Region.of("aws-iso-global")).build(), "route53.c2s.ic.gov").put(ServiceEndpointKey.builder().region(Region.of("aws-iso-b-global")).build(), "route53.sc2s.sgov.gov").put(ServiceEndpointKey.builder().region(Region.of("aws-us-gov-global")).build(), "route53.us-gov.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("aws-us-gov-global")).tags(EndpointTag.of("fips")).build(), "route53.us-gov.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("fips-aws-us-gov-global")).build(), "route53.us-gov.amazonaws.com").build();
