...
@SdkPublicApi
public final class SupportappServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "supportapp";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("eu-west-1"), Region.of("us-east-1"), Region.of("us-west-2")));
