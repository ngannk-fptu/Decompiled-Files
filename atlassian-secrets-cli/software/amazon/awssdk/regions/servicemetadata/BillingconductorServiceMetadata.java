...
implements ServiceMetadata {
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put(ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), "billingconductor.us-east-1.amazonaws.com").build();
