...
@SdkPublicApi
public final class MacieServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "macie";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("fips-us-east-1"), Region.of("fips-us-west-2"), Region.of("us-east-1"), Region.of("us-west-2")));
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put(ServiceEndpointKey.builder().region(Region.of("fips-us-east-1")).build(), "macie-fips.us-east-1.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("fips-us-west-2")).build(), "macie-fips.us-west-2.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("us-east-1")).tags(EndpointTag.of("fips")).build(), "macie-fips.us-east-1.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("us-west-2")).tags(EndpointTag.of("fips")).build(), "macie-fips.us-west-2.amazonaws.com").build();
