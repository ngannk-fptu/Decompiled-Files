...
@SdkPublicApi
public final class LookoutequipmentServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "lookoutequipment";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-northeast-2"), Region.of("eu-west-1"), Region.of("us-east-1")));
