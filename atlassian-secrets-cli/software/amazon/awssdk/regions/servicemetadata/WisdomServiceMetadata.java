...
@SdkPublicApi
public final class WisdomServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "wisdom";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-northeast-1"), Region.of("ap-southeast-2"), Region.of("eu-central-1"), Region.of("eu-west-2"), Region.of("fips-us-east-1"), Region.of("fips-us-west-2"), Region.of("us-east-1"), Region.of("us-west-2")));
