...
@SdkPublicApi
public final class CloudhsmServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "cloudhsm";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("us-east-1"), Region.of("us-gov-west-1")));
