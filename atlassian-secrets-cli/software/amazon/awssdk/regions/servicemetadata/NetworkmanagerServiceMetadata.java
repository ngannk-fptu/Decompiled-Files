...
implements ServiceMetadata {
    ...
    private static final Map<ServiceEndpointKey, String> SIGNING_REGIONS_BY_REGION = ImmutableMap.builder().put(ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), "us-west-2").put(ServiceEndpointKey.builder().region(Region.of("aws-global")).tags(EndpointTag.of("fips")).build(), "us-west-2").put(ServiceEndpointKey.builder().region(Region.of("fips-aws-global")).build(), "us-west-2").put(ServiceEndpointKey.builder().region(Region.of("aws-us-gov-global")).build(), "us-gov-west-1").put(ServiceEndpointKey.builder().region(Region.of("aws-us-gov-global")).tags(EndpointTag.of("fips")).build(), "us-gov-west-1").put(ServiceEndpointKey.builder().region(Region.of("fips-aws-us-gov-global")).build(), "us-gov-west-1").build();
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put(ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), "networkmanager.us-west-2.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("aws-global")).tags(EndpointTag.of("fips")).build(), "networkmanager-fips.us-west-2.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("fips-aws-global")).build(), "networkmanager-fips.us-west-2.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("aws-us-gov-global")).build(), "networkmanager.us-gov-west-1.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("aws-us-gov-global")).tags(EndpointTag.of("fips")).build(), "networkmanager.us-gov-west-1.amazonaws.com").put(ServiceEndpointKey.builder().region(Region.of("fips-aws-us-gov-global")).build(), "networkmanager.us-gov-west-1.amazonaws.com").build();
