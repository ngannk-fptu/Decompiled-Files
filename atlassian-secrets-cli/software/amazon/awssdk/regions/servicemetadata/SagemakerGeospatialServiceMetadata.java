...
@SdkPublicApi
public final class SagemakerGeospatialServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "sagemaker-geospatial";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("us-west-2")));
