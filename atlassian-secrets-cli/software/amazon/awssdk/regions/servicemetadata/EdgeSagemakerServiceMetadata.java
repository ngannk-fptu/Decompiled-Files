...
@SdkPublicApi
public final class EdgeSagemakerServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "edge.sagemaker";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-northeast-1"), Region.of("eu-central-1"), Region.of("eu-west-1"), Region.of("us-east-1"), Region.of("us-east-2"), Region.of("us-west-2")));
