...
@SdkPublicApi
public final class MarketplacecommerceanalyticsServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "marketplacecommerceanalytics";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("us-east-1")));
