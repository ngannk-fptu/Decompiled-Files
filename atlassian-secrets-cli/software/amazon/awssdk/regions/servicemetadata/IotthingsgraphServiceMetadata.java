...
@SdkPublicApi
public final class IotthingsgraphServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "iotthingsgraph";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-northeast-1"), Region.of("ap-northeast-2"), Region.of("ap-southeast-2"), Region.of("eu-west-1"), Region.of("us-east-1"), Region.of("us-west-2")));
