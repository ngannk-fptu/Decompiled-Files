...
@SdkPublicApi
public final class ProjectsIot1clickServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "projects.iot1click";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-northeast-1"), Region.of("eu-central-1"), Region.of("eu-west-1"), Region.of("eu-west-2"), Region.of("us-east-1"), Region.of("us-east-2"), Region.of("us-west-2")));
