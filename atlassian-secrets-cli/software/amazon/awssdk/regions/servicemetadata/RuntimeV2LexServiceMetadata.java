...
@SdkPublicApi
public final class RuntimeV2LexServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "runtime-v2-lex";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("af-south-1"), Region.of("ap-northeast-1"), Region.of("ap-northeast-2"), Region.of("ap-southeast-1"), Region.of("ap-southeast-2"), Region.of("ca-central-1"), Region.of("eu-central-1"), Region.of("eu-west-1"), Region.of("eu-west-2"), Region.of("us-east-1"), Region.of("us-west-2")));
