...
implements SdkHttpFullRequest {
    ...
    public String toString() {
        return ToString.builder("DefaultSdkHttpFullRequest").add("httpMethod", (Object)this.httpMethod).add("protocol", this.protocol).add("host", this.host).add("port", this.port).add("encodedPath", this.path).add("headers", this.headers.forInternalRead().keySet()).add("queryParameters", this.queryParameters.forInternalRead().keySet()).build();
    }
