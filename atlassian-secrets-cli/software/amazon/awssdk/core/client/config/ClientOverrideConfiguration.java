...
implements ToCopyableBuilder<Builder, ClientOverrideConfiguration> {
    ...
    public String toString() {
        return ToString.builder("ClientOverrideConfiguration").add("headers", this.headers).add("retryPolicy", this.retryPolicy).add("apiCallTimeout", this.apiCallTimeout).add("apiCallAttemptTimeout", this.apiCallAttemptTimeout).add("executionInterceptors", this.executionInterceptors).add("advancedOptions", this.advancedOptions).add("profileFile", this.defaultProfileFile).add("profileName", this.defaultProfileName).add("scheduledExecutorService", this.scheduledExecutorService).add("compressionConfiguration", this.compressionConfiguration).build();
    }
    ...
    extends CopyableBuilder<Builder, ClientOverrideConfiguration> {
        ...
        default public Builder retryPolicy(Consumer<RetryPolicy.Builder> retryPolicy) {
            return this.retryPolicy(RetryPolicy.builder().applyMutation(retryPolicy).build());
        }
        ...
        default public Builder compressionConfiguration(Consumer<CompressionConfiguration.Builder> compressionConfiguration) {
            return this.compressionConfiguration((CompressionConfiguration)CompressionConfiguration.builder().applyMutation(compressionConfiguration).build());
        }
