...
implements SdkClientBuilder<B, C> {
    ...
    private SdkClientConfiguration mergeGlobalDefaults(SdkClientConfiguration configuration) {
        Supplier profileFileSupplier = Optional.ofNullable(configuration.option(SdkClientOption.PROFILE_FILE_SUPPLIER)).orElseGet(() -> ProfileFileSupplier.fixedProfileFile(ProfileFile.defaultProfileFile()));
    ...
    private SdkClientConfiguration addCompressionConfigGlobalDefaults(SdkClientConfiguration configuration) {
        Optional<Object> profileSetting;
        Profile profile2;
        Optional<Comparable<Boolean>> systemSetting;
        ...
        if (compressionEnabled == null) {
            ...
            if (systemSetting.isPresent()) {
                ...
                profile2 = configuration.option(SdkClientOption.PROFILE_FILE_SUPPLIER).get().profile(configuration.option(SdkClientOption.PROFILE_NAME)).orElse(null);
                if (profile2 != null && (profileSetting = profile2.booleanProperty("disable_request_compression")).isPresent()) {
        ...
        if (compressionThreshold == null) {
            ...
            if (systemSetting.isPresent()) {
                ...
                profile2 = configuration.option(SdkClientOption.PROFILE_FILE_SUPPLIER).get().profile(configuration.option(SdkClientOption.PROFILE_NAME)).orElse(null);
                if (profile2 != null && (profileSetting = profile2.property("request_min_compression_size_bytes")).isPresent()) {
    ...
    public final B addPlugin(SdkPlugin plugin) {
        this.plugins.add(Validate.paramNotNull(plugin, "plugin"));
        return this.thisBuilder();
    }
