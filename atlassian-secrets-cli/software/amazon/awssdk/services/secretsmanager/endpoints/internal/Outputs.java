...
public class Outputs {
    ...
    public static Outputs fromNode(JsonNode node) {
        ...
        if ((dualStackDnsSuffix = objNode.get(DUAL_STACK_DNS_SUFFIX)) != null) {
            b.dualStackDnsSuffix(dualStackDnsSuffix.asString());
        }
        if ((supportsFips = objNode.get(SUPPORTS_FIPS)) != null) {
            b.supportsFips(supportsFips.asBoolean());
        }
        if ((supportsDualStack = objNode.get(SUPPORTS_DUAL_STACK)) != null) {
