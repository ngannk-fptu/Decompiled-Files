...
implements SecretsManagerEndpointProvider {
    ...
    public CompletableFuture<Endpoint> resolveEndpoint(SecretsManagerEndpointParams endpointParams) {
        Validate.notNull(endpointParams.useDualStack(), "Parameter 'UseDualStack' must not be null", new Object[0]);
        Validate.notNull(endpointParams.useFips(), "Parameter 'UseFIPS' must not be null", new Object[0]);
