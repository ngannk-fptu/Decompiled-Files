...
extends SingleArgFn {
    ...
    public Value evalArg(Value arg) {
        ...
        return Value.fromRecord(MapUtils.of(NAME, Value.fromStr(matchedPartition.id()), DNS_SUFFIX, Value.fromStr(matchedOutputs.dnsSuffix()), DUAL_STACK_DNS_SUFFIX, Value.fromStr(matchedOutputs.dualStackDnsSuffix()), SUPPORTS_FIPS, Value.fromBool(matchedOutputs.supportsFips()), SUPPORTS_DUAL_STACK, Value.fromBool(matchedOutputs.supportsDualStack()), INFERRED, Value.fromBool(inferred)));
    }
