...
implements Into<Condition> {
    ...
    protected Expr expectOneArg() {
        ...
        throw RuleError.builder().cause(SourceException.builder().message("expected 1 argument but found " + argv.size()).build()).build();
    }
    ...
    protected Pair<Expr, Expr> expectTwoArgs() {
        ...
        throw RuleError.builder().cause(SourceException.builder().message("expected 2 arguments but found " + argv.size()).build()).build();
    }
    ...
    protected List<Expr> expectVariableArgs(int expectedNumberArgs) {
        ...
        throw RuleError.builder().cause(SourceException.builder().message(String.format("expected %d arguments but found %d", expectedNumberArgs, argv.size())).build()).build();
    }
