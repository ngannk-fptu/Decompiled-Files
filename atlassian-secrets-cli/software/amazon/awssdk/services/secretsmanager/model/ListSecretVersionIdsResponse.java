...
implements ToCopyableBuilder<Builder, ListSecretVersionIdsResponse> {
    private static final SdkField<List<SecretVersionsListEntry>> VERSIONS_FIELD = SdkField.builder(MarshallingType.LIST).memberName("Versions").getter(ListSecretVersionIdsResponse.getter(ListSecretVersionIdsResponse::versions)).setter(ListSecretVersionIdsResponse.setter(Builder::versions)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Versions").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder(MarshallingType.SDK_POJO).constructor(SecretVersionsListEntry::builder).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()).build()).build()).build();
    private static final SdkField<String> NEXT_TOKEN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("NextToken").getter(ListSecretVersionIdsResponse.getter(ListSecretVersionIdsResponse::nextToken)).setter(ListSecretVersionIdsResponse.setter(Builder::nextToken)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("NextToken").build()).build();
    private static final SdkField<String> ARN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ARN").getter(ListSecretVersionIdsResponse.getter(ListSecretVersionIdsResponse::arn)).setter(ListSecretVersionIdsResponse.setter(Builder::arn)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()).build();
    private static final SdkField<String> NAME_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Name").getter(ListSecretVersionIdsResponse.getter(ListSecretVersionIdsResponse::name)).setter(ListSecretVersionIdsResponse.setter(Builder::name)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Name").build()).build();
    ...
    public final String toString() {
        return ToString.builder("ListSecretVersionIdsResponse").add("Versions", this.hasVersions() ? this.versions() : null).add("NextToken", this.nextToken()).add("ARN", this.arn()).add("Name", this.name()).build();
    }
    ...
    implements Builder {
        ...
        public final Builder versions(Consumer<SecretVersionsListEntry.Builder> ... versions) {
            this.versions(Stream.of(versions).map(c -> (SecretVersionsListEntry)((SecretVersionsListEntry.Builder)SecretVersionsListEntry.builder().applyMutation(c)).build()).collect(Collectors.toList()));
            return this;
        }
