...
ToCopyableBuilder<Builder, ValidationErrorsEntry> {
    private static final SdkField<String> CHECK_NAME_FIELD = SdkField.builder(MarshallingType.STRING).memberName("CheckName").getter(ValidationErrorsEntry.getter(ValidationErrorsEntry::checkName)).setter(ValidationErrorsEntry.setter(Builder::checkName)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("CheckName").build()).build();
    private static final SdkField<String> ERROR_MESSAGE_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ErrorMessage").getter(ValidationErrorsEntry.getter(ValidationErrorsEntry::errorMessage)).setter(ValidationErrorsEntry.setter(Builder::errorMessage)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ErrorMessage").build()).build();
    ...
    public final String toString() {
        return ToString.builder("ValidationErrorsEntry").add("CheckName", this.checkName()).add("ErrorMessage", this.errorMessage()).build();
    }
