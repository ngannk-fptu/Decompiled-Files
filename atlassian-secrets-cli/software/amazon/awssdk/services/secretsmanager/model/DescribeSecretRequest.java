...
implements ToCopyableBuilder<Builder, DescribeSecretRequest> {
    private static final SdkField<String> SECRET_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("SecretId").getter(DescribeSecretRequest.getter(DescribeSecretRequest::secretId)).setter(DescribeSecretRequest.setter(Builder::secretId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretId").build()).build();
    ...
    public final String toString() {
        return ToString.builder("DescribeSecretRequest").add("SecretId", this.secretId()).build();
    }
