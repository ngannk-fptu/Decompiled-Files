...
implements ToCopyableBuilder<Builder, RemoveRegionsFromReplicationResponse> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ARN").getter(RemoveRegionsFromReplicationResponse.getter(RemoveRegionsFromReplicationResponse::arn)).setter(RemoveRegionsFromReplicationResponse.setter(Builder::arn)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()).build();
    private static final SdkField<List<ReplicationStatusType>> REPLICATION_STATUS_FIELD = SdkField.builder(MarshallingType.LIST).memberName("ReplicationStatus").getter(RemoveRegionsFromReplicationResponse.getter(RemoveRegionsFromReplicationResponse::replicationStatus)).setter(RemoveRegionsFromReplicationResponse.setter(Builder::replicationStatus)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ReplicationStatus").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder(MarshallingType.SDK_POJO).constructor(ReplicationStatusType::builder).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()).build()).build()).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        RemoveRegionsFromReplicationResponse other = (RemoveRegionsFromReplicationResponse)obj;
    ...
    public final String toString() {
        return ToString.builder("RemoveRegionsFromReplicationResponse").add("ARN", this.arn()).add("ReplicationStatus", this.hasReplicationStatus() ? this.replicationStatus() : null).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<RemoveRegionsFromReplicationResponse, T> g) {
        return obj -> g.apply((RemoveRegionsFromReplicationResponse)obj);
    }
