...
implements ToCopyableBuilder<Builder, DeleteSecretRequest> {
    private static final SdkField<String> SECRET_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("SecretId").getter(DeleteSecretRequest.getter(DeleteSecretRequest::secretId)).setter(DeleteSecretRequest.setter(Builder::secretId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretId").build()).build();
    private static final SdkField<Long> RECOVERY_WINDOW_IN_DAYS_FIELD = SdkField.builder(MarshallingType.LONG).memberName("RecoveryWindowInDays").getter(DeleteSecretRequest.getter(DeleteSecretRequest::recoveryWindowInDays)).setter(DeleteSecretRequest.setter(Builder::recoveryWindowInDays)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RecoveryWindowInDays").build()).build();
    private static final SdkField<Boolean> FORCE_DELETE_WITHOUT_RECOVERY_FIELD = SdkField.builder(MarshallingType.BOOLEAN).memberName("ForceDeleteWithoutRecovery").getter(DeleteSecretRequest.getter(DeleteSecretRequest::forceDeleteWithoutRecovery)).setter(DeleteSecretRequest.setter(Builder::forceDeleteWithoutRecovery)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ForceDeleteWithoutRecovery").build()).build();
    ...
    public final String toString() {
        return ToString.builder("DeleteSecretRequest").add("SecretId", this.secretId()).add("RecoveryWindowInDays", this.recoveryWindowInDays()).add("ForceDeleteWithoutRecovery", this.forceDeleteWithoutRecovery()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<DeleteSecretRequest, T> g) {
        return obj -> g.apply((DeleteSecretRequest)obj);
    }
