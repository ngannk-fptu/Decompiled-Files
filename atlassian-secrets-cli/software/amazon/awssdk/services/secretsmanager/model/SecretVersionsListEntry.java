...
ToCopyableBuilder<Builder, SecretVersionsListEntry> {
    private static final SdkField<String> VERSION_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("VersionId").getter(SecretVersionsListEntry.getter(SecretVersionsListEntry::versionId)).setter(SecretVersionsListEntry.setter(Builder::versionId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("VersionId").build()).build();
    private static final SdkField<List<String>> VERSION_STAGES_FIELD = SdkField.builder(MarshallingType.LIST).memberName("VersionStages").getter(SecretVersionsListEntry.getter(SecretVersionsListEntry::versionStages)).setter(SecretVersionsListEntry.setter(Builder::versionStages)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("VersionStages").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder(MarshallingType.STRING).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()).build()).build()).build();
    ...
    private static final SdkField<Instant> CREATED_DATE_FIELD = SdkField.builder(MarshallingType.INSTANT).memberName("CreatedDate").getter(SecretVersionsListEntry.getter(SecretVersionsListEntry::createdDate)).setter(SecretVersionsListEntry.setter(Builder::createdDate)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("CreatedDate").build()).build();
    private static final SdkField<List<String>> KMS_KEY_IDS_FIELD = SdkField.builder(MarshallingType.LIST).memberName("KmsKeyIds").getter(SecretVersionsListEntry.getter(SecretVersionsListEntry::kmsKeyIds)).setter(SecretVersionsListEntry.setter(Builder::kmsKeyIds)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("KmsKeyIds").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder(MarshallingType.STRING).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()).build()).build()).build();
    ...
    public final String toString() {
        return ToString.builder("SecretVersionsListEntry").add("VersionId", this.versionId()).add("VersionStages", this.hasVersionStages() ? this.versionStages() : null).add("LastAccessedDate", this.lastAccessedDate()).add("CreatedDate", this.createdDate()).add("KmsKeyIds", this.hasKmsKeyIds() ? this.kmsKeyIds() : null).build();
    }
