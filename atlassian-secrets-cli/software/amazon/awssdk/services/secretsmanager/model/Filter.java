...
ToCopyableBuilder<Builder, Filter> {
    private static final SdkField<String> KEY_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Key").getter(Filter.getter(Filter::keyAsString)).setter(Filter.setter(Builder::key)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Key").build()).build();
    ...
    public final String toString() {
        return ToString.builder("Filter").add("Key", this.keyAsString()).add("Values", this.hasValues() ? this.values() : null).build();
    }
