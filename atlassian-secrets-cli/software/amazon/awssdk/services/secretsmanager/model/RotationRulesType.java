...
ToCopyableBuilder<Builder, RotationRulesType> {
    private static final SdkField<Long> AUTOMATICALLY_AFTER_DAYS_FIELD = SdkField.builder(MarshallingType.LONG).memberName("AutomaticallyAfterDays").getter(RotationRulesType.getter(RotationRulesType::automaticallyAfterDays)).setter(RotationRulesType.setter(Builder::automaticallyAfterDays)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("AutomaticallyAfterDays").build()).build();
    private static final SdkField<String> DURATION_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Duration").getter(RotationRulesType.getter(RotationRulesType::duration)).setter(RotationRulesType.setter(Builder::duration)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Duration").build()).build();
    private static final SdkField<String> SCHEDULE_EXPRESSION_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ScheduleExpression").getter(RotationRulesType.getter(RotationRulesType::scheduleExpression)).setter(RotationRulesType.setter(Builder::scheduleExpression)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ScheduleExpression").build()).build();
    ...
    public final String toString() {
        return ToString.builder("RotationRulesType").add("AutomaticallyAfterDays", this.automaticallyAfterDays()).add("Duration", this.duration()).add("ScheduleExpression", this.scheduleExpression()).build();
    }
