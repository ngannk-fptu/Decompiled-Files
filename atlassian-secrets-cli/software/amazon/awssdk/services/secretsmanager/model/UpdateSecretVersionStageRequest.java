...
implements ToCopyableBuilder<Builder, UpdateSecretVersionStageRequest> {
    private static final SdkField<String> SECRET_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("SecretId").getter(UpdateSecretVersionStageRequest.getter(UpdateSecretVersionStageRequest::secretId)).setter(UpdateSecretVersionStageRequest.setter(Builder::secretId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretId").build()).build();
    private static final SdkField<String> VERSION_STAGE_FIELD = SdkField.builder(MarshallingType.STRING).memberName("VersionStage").getter(UpdateSecretVersionStageRequest.getter(UpdateSecretVersionStageRequest::versionStage)).setter(UpdateSecretVersionStageRequest.setter(Builder::versionStage)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("VersionStage").build()).build();
    private static final SdkField<String> REMOVE_FROM_VERSION_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("RemoveFromVersionId").getter(UpdateSecretVersionStageRequest.getter(UpdateSecretVersionStageRequest::removeFromVersionId)).setter(UpdateSecretVersionStageRequest.setter(Builder::removeFromVersionId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RemoveFromVersionId").build()).build();
    private static final SdkField<String> MOVE_TO_VERSION_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("MoveToVersionId").getter(UpdateSecretVersionStageRequest.getter(UpdateSecretVersionStageRequest::moveToVersionId)).setter(UpdateSecretVersionStageRequest.setter(Builder::moveToVersionId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("MoveToVersionId").build()).build();
    ...
    public final String toString() {
        return ToString.builder("UpdateSecretVersionStageRequest").add("SecretId", this.secretId()).add("VersionStage", this.versionStage()).add("RemoveFromVersionId", this.removeFromVersionId()).add("MoveToVersionId", this.moveToVersionId()).build();
    }
