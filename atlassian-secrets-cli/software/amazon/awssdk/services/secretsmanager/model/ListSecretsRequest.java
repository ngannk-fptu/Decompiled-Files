...
implements ToCopyableBuilder<Builder, ListSecretsRequest> {
    private static final SdkField<Boolean> INCLUDE_PLANNED_DELETION_FIELD = SdkField.builder(MarshallingType.BOOLEAN).memberName("IncludePlannedDeletion").getter(ListSecretsRequest.getter(ListSecretsRequest::includePlannedDeletion)).setter(ListSecretsRequest.setter(Builder::includePlannedDeletion)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("IncludePlannedDeletion").build()).build();
    private static final SdkField<Integer> MAX_RESULTS_FIELD = SdkField.builder(MarshallingType.INTEGER).memberName("MaxResults").getter(ListSecretsRequest.getter(ListSecretsRequest::maxResults)).setter(ListSecretsRequest.setter(Builder::maxResults)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("MaxResults").build()).build();
    private static final SdkField<String> NEXT_TOKEN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("NextToken").getter(ListSecretsRequest.getter(ListSecretsRequest::nextToken)).setter(ListSecretsRequest.setter(Builder::nextToken)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("NextToken").build()).build();
    private static final SdkField<List<Filter>> FILTERS_FIELD = SdkField.builder(MarshallingType.LIST).memberName("Filters").getter(ListSecretsRequest.getter(ListSecretsRequest::filters)).setter(ListSecretsRequest.setter(Builder::filters)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Filters").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder(MarshallingType.SDK_POJO).constructor(Filter::builder).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()).build()).build()).build();
    private static final SdkField<String> SORT_ORDER_FIELD = SdkField.builder(MarshallingType.STRING).memberName("SortOrder").getter(ListSecretsRequest.getter(ListSecretsRequest::sortOrderAsString)).setter(ListSecretsRequest.setter(Builder::sortOrder)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SortOrder").build()).build();
    ...
    public final String toString() {
        return ToString.builder("ListSecretsRequest").add("IncludePlannedDeletion", this.includePlannedDeletion()).add("MaxResults", this.maxResults()).add("NextToken", this.nextToken()).add("Filters", this.hasFilters() ? this.filters() : null).add("SortOrder", this.sortOrderAsString()).build();
    }
    ...
    implements Builder {
        ...
        public final Builder filters(Consumer<Filter.Builder> ... filters) {
            this.filters(Stream.of(filters).map(c -> (Filter)((Filter.Builder)Filter.builder().applyMutation(c)).build()).collect(Collectors.toList()));
            return this;
        }
