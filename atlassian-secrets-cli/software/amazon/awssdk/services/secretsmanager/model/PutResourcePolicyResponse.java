...
implements ToCopyableBuilder<Builder, PutResourcePolicyResponse> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ARN").getter(PutResourcePolicyResponse.getter(PutResourcePolicyResponse::arn)).setter(PutResourcePolicyResponse.setter(Builder::arn)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()).build();
    private static final SdkField<String> NAME_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Name").getter(PutResourcePolicyResponse.getter(PutResourcePolicyResponse::name)).setter(PutResourcePolicyResponse.setter(Builder::name)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Name").build()).build();
    ...
    public final String toString() {
        return ToString.builder("PutResourcePolicyResponse").add("ARN", this.arn()).add("Name", this.name()).build();
    }
