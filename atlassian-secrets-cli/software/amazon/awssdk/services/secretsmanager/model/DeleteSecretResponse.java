...
implements ToCopyableBuilder<Builder, DeleteSecretResponse> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ARN").getter(DeleteSecretResponse.getter(DeleteSecretResponse::arn)).setter(DeleteSecretResponse.setter(Builder::arn)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()).build();
    private static final SdkField<String> NAME_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Name").getter(DeleteSecretResponse.getter(DeleteSecretResponse::name)).setter(DeleteSecretResponse.setter(Builder::name)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Name").build()).build();
    private static final SdkField<Instant> DELETION_DATE_FIELD = SdkField.builder(MarshallingType.INSTANT).memberName("DeletionDate").getter(DeleteSecretResponse.getter(DeleteSecretResponse::deletionDate)).setter(DeleteSecretResponse.setter(Builder::deletionDate)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("DeletionDate").build()).build();
    ...
    public final String toString() {
        return ToString.builder("DeleteSecretResponse").add("ARN", this.arn()).add("Name", this.name()).add("DeletionDate", this.deletionDate()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<DeleteSecretResponse, T> g) {
        return obj -> g.apply((DeleteSecretResponse)obj);
    }
