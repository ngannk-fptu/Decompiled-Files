...
implements ToCopyableBuilder<Builder, CreateSecretResponse> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ARN").getter(CreateSecretResponse.getter(CreateSecretResponse::arn)).setter(CreateSecretResponse.setter(Builder::arn)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()).build();
    private static final SdkField<String> NAME_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Name").getter(CreateSecretResponse.getter(CreateSecretResponse::name)).setter(CreateSecretResponse.setter(Builder::name)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Name").build()).build();
    private static final SdkField<String> VERSION_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("VersionId").getter(CreateSecretResponse.getter(CreateSecretResponse::versionId)).setter(CreateSecretResponse.setter(Builder::versionId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("VersionId").build()).build();
    private static final SdkField<List<ReplicationStatusType>> REPLICATION_STATUS_FIELD = SdkField.builder(MarshallingType.LIST).memberName("ReplicationStatus").getter(CreateSecretResponse.getter(CreateSecretResponse::replicationStatus)).setter(CreateSecretResponse.setter(Builder::replicationStatus)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ReplicationStatus").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder(MarshallingType.SDK_POJO).constructor(ReplicationStatusType::builder).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()).build()).build()).build();
    ...
    public final String toString() {
        return ToString.builder("CreateSecretResponse").add("ARN", this.arn()).add("Name", this.name()).add("VersionId", this.versionId()).add("ReplicationStatus", this.hasReplicationStatus() ? this.replicationStatus() : null).build();
    }
