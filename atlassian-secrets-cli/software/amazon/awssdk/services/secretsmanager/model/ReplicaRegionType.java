...
ToCopyableBuilder<Builder, ReplicaRegionType> {
    private static final SdkField<String> REGION_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Region").getter(ReplicaRegionType.getter(ReplicaRegionType::region)).setter(ReplicaRegionType.setter(Builder::region)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Region").build()).build();
    private static final SdkField<String> KMS_KEY_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("KmsKeyId").getter(ReplicaRegionType.getter(ReplicaRegionType::kmsKeyId)).setter(ReplicaRegionType.setter(Builder::kmsKeyId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("KmsKeyId").build()).build();
    ...
    public final String toString() {
        return ToString.builder("ReplicaRegionType").add("Region", this.region()).add("KmsKeyId", this.kmsKeyId()).build();
    }
