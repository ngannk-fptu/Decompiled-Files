...
implements ToCopyableBuilder<Builder, UpdateSecretRequest> {
    private static final SdkField<String> SECRET_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("SecretId").getter(UpdateSecretRequest.getter(UpdateSecretRequest::secretId)).setter(UpdateSecretRequest.setter(Builder::secretId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretId").build()).build();
    private static final SdkField<String> CLIENT_REQUEST_TOKEN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ClientRequestToken").getter(UpdateSecretRequest.getter(UpdateSecretRequest::clientRequestToken)).setter(UpdateSecretRequest.setter(Builder::clientRequestToken)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ClientRequestToken").build(), DefaultValueTrait.idempotencyToken()).build();
    private static final SdkField<String> DESCRIPTION_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Description").getter(UpdateSecretRequest.getter(UpdateSecretRequest::description)).setter(UpdateSecretRequest.setter(Builder::description)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Description").build()).build();
    private static final SdkField<String> KMS_KEY_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("KmsKeyId").getter(UpdateSecretRequest.getter(UpdateSecretRequest::kmsKeyId)).setter(UpdateSecretRequest.setter(Builder::kmsKeyId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("KmsKeyId").build()).build();
    private static final SdkField<SdkBytes> SECRET_BINARY_FIELD = SdkField.builder(MarshallingType.SDK_BYTES).memberName("SecretBinary").getter(UpdateSecretRequest.getter(UpdateSecretRequest::secretBinary)).setter(UpdateSecretRequest.setter(Builder::secretBinary)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretBinary").build()).build();
    private static final SdkField<String> SECRET_STRING_FIELD = SdkField.builder(MarshallingType.STRING).memberName("SecretString").getter(UpdateSecretRequest.getter(UpdateSecretRequest::secretString)).setter(UpdateSecretRequest.setter(Builder::secretString)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretString").build()).build();
    ...
    public final String toString() {
        return ToString.builder("UpdateSecretRequest").add("SecretId", this.secretId()).add("ClientRequestToken", this.clientRequestToken()).add("Description", this.description()).add("KmsKeyId", this.kmsKeyId()).add("SecretBinary", this.secretBinary() == null ? null : "*** Sensitive Data Redacted ***").add("SecretString", this.secretString() == null ? null : "*** Sensitive Data Redacted ***").build();
    }
