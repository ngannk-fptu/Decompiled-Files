...
implements ToCopyableBuilder<Builder, GetSecretValueResponse> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ARN").getter(GetSecretValueResponse.getter(GetSecretValueResponse::arn)).setter(GetSecretValueResponse.setter(Builder::arn)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()).build();
    private static final SdkField<String> NAME_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Name").getter(GetSecretValueResponse.getter(GetSecretValueResponse::name)).setter(GetSecretValueResponse.setter(Builder::name)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Name").build()).build();
    private static final SdkField<String> VERSION_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("VersionId").getter(GetSecretValueResponse.getter(GetSecretValueResponse::versionId)).setter(GetSecretValueResponse.setter(Builder::versionId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("VersionId").build()).build();
    private static final SdkField<SdkBytes> SECRET_BINARY_FIELD = SdkField.builder(MarshallingType.SDK_BYTES).memberName("SecretBinary").getter(GetSecretValueResponse.getter(GetSecretValueResponse::secretBinary)).setter(GetSecretValueResponse.setter(Builder::secretBinary)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretBinary").build()).build();
    private static final SdkField<String> SECRET_STRING_FIELD = SdkField.builder(MarshallingType.STRING).memberName("SecretString").getter(GetSecretValueResponse.getter(GetSecretValueResponse::secretString)).setter(GetSecretValueResponse.setter(Builder::secretString)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretString").build()).build();
    private static final SdkField<List<String>> VERSION_STAGES_FIELD = SdkField.builder(MarshallingType.LIST).memberName("VersionStages").getter(GetSecretValueResponse.getter(GetSecretValueResponse::versionStages)).setter(GetSecretValueResponse.setter(Builder::versionStages)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("VersionStages").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder(MarshallingType.STRING).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()).build()).build()).build();
    private static final SdkField<Instant> CREATED_DATE_FIELD = SdkField.builder(MarshallingType.INSTANT).memberName("CreatedDate").getter(GetSecretValueResponse.getter(GetSecretValueResponse::createdDate)).setter(GetSecretValueResponse.setter(Builder::createdDate)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("CreatedDate").build()).build();
    ...
    public final String toString() {
        return ToString.builder("GetSecretValueResponse").add("ARN", this.arn()).add("Name", this.name()).add("VersionId", this.versionId()).add("SecretBinary", this.secretBinary() == null ? null : "*** Sensitive Data Redacted ***").add("SecretString", this.secretString() == null ? null : "*** Sensitive Data Redacted ***").add("VersionStages", this.hasVersionStages() ? this.versionStages() : null).add("CreatedDate", this.createdDate()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<GetSecretValueResponse, T> g) {
        return obj -> g.apply((GetSecretValueResponse)obj);
    }
