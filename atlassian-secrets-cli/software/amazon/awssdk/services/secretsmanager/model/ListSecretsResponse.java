...
implements ToCopyableBuilder<Builder, ListSecretsResponse> {
    private static final SdkField<List<SecretListEntry>> SECRET_LIST_FIELD = SdkField.builder(MarshallingType.LIST).memberName("SecretList").getter(ListSecretsResponse.getter(ListSecretsResponse::secretList)).setter(ListSecretsResponse.setter(Builder::secretList)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretList").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder(MarshallingType.SDK_POJO).constructor(SecretListEntry::builder).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()).build()).build()).build();
    private static final SdkField<String> NEXT_TOKEN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("NextToken").getter(ListSecretsResponse.getter(ListSecretsResponse::nextToken)).setter(ListSecretsResponse.setter(Builder::nextToken)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("NextToken").build()).build();
    ...
    public final String toString() {
        return ToString.builder("ListSecretsResponse").add("SecretList", this.hasSecretList() ? this.secretList() : null).add("NextToken", this.nextToken()).build();
    }
    ...
    implements Builder {
        ...
        public final Builder secretList(Consumer<SecretListEntry.Builder> ... secretList) {
            this.secretList(Stream.of(secretList).map(c -> (SecretListEntry)((SecretListEntry.Builder)SecretListEntry.builder().applyMutation(c)).build()).collect(Collectors.toList()));
            return this;
        }
