...
implements ToCopyableBuilder<Builder, CreateSecretRequest> {
    private static final SdkField<String> NAME_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Name").getter(CreateSecretRequest.getter(CreateSecretRequest::name)).setter(CreateSecretRequest.setter(Builder::name)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Name").build()).build();
    private static final SdkField<String> CLIENT_REQUEST_TOKEN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ClientRequestToken").getter(CreateSecretRequest.getter(CreateSecretRequest::clientRequestToken)).setter(CreateSecretRequest.setter(Builder::clientRequestToken)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ClientRequestToken").build(), DefaultValueTrait.idempotencyToken()).build();
    private static final SdkField<String> DESCRIPTION_FIELD = SdkField.builder(MarshallingType.STRING).memberName("Description").getter(CreateSecretRequest.getter(CreateSecretRequest::description)).setter(CreateSecretRequest.setter(Builder::description)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Description").build()).build();
    private static final SdkField<String> KMS_KEY_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("KmsKeyId").getter(CreateSecretRequest.getter(CreateSecretRequest::kmsKeyId)).setter(CreateSecretRequest.setter(Builder::kmsKeyId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("KmsKeyId").build()).build();
    private static final SdkField<SdkBytes> SECRET_BINARY_FIELD = SdkField.builder(MarshallingType.SDK_BYTES).memberName("SecretBinary").getter(CreateSecretRequest.getter(CreateSecretRequest::secretBinary)).setter(CreateSecretRequest.setter(Builder::secretBinary)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretBinary").build()).build();
    private static final SdkField<String> SECRET_STRING_FIELD = SdkField.builder(MarshallingType.STRING).memberName("SecretString").getter(CreateSecretRequest.getter(CreateSecretRequest::secretString)).setter(CreateSecretRequest.setter(Builder::secretString)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretString").build()).build();
    private static final SdkField<List<Tag>> TAGS_FIELD = SdkField.builder(MarshallingType.LIST).memberName("Tags").getter(CreateSecretRequest.getter(CreateSecretRequest::tags)).setter(CreateSecretRequest.setter(Builder::tags)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Tags").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder(MarshallingType.SDK_POJO).constructor(Tag::builder).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()).build()).build()).build();
    private static final SdkField<List<ReplicaRegionType>> ADD_REPLICA_REGIONS_FIELD = SdkField.builder(MarshallingType.LIST).memberName("AddReplicaRegions").getter(CreateSecretRequest.getter(CreateSecretRequest::addReplicaRegions)).setter(CreateSecretRequest.setter(Builder::addReplicaRegions)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("AddReplicaRegions").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder(MarshallingType.SDK_POJO).constructor(ReplicaRegionType::builder).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()).build()).build()).build();
    private static final SdkField<Boolean> FORCE_OVERWRITE_REPLICA_SECRET_FIELD = SdkField.builder(MarshallingType.BOOLEAN).memberName("ForceOverwriteReplicaSecret").getter(CreateSecretRequest.getter(CreateSecretRequest::forceOverwriteReplicaSecret)).setter(CreateSecretRequest.setter(Builder::forceOverwriteReplicaSecret)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ForceOverwriteReplicaSecret").build()).build();
    ...
    public final String toString() {
        return ToString.builder("CreateSecretRequest").add("Name", this.name()).add("ClientRequestToken", this.clientRequestToken()).add("Description", this.description()).add("KmsKeyId", this.kmsKeyId()).add("SecretBinary", this.secretBinary() == null ? null : "*** Sensitive Data Redacted ***").add("SecretString", this.secretString() == null ? null : "*** Sensitive Data Redacted ***").add("Tags", this.hasTags() ? this.tags() : null).add("AddReplicaRegions", this.hasAddReplicaRegions() ? this.addReplicaRegions() : null).add("ForceOverwriteReplicaSecret", this.forceOverwriteReplicaSecret()).build();
    }
