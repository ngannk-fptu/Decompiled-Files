...
implements ToCopyableBuilder<Builder, RestoreSecretResponse> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ARN").getter(RestoreSecretResponse.getter(RestoreSecretResponse::arn)).setter(RestoreSecretResponse.setter(Builder::arn)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()).build();
    ...
    public final String toString() {
        return ToString.builder("RestoreSecretResponse").add("ARN", this.arn()).add("Name", this.name()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<RestoreSecretResponse, T> g) {
        return obj -> g.apply((RestoreSecretResponse)obj);
    }
