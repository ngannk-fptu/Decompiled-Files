...
implements ToCopyableBuilder<Builder, DeleteResourcePolicyRequest> {
    private static final SdkField<String> SECRET_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("SecretId").getter(DeleteResourcePolicyRequest.getter(DeleteResourcePolicyRequest::secretId)).setter(DeleteResourcePolicyRequest.setter(Builder::secretId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretId").build()).build();
    ...
    public final String toString() {
        return ToString.builder("DeleteResourcePolicyRequest").add("SecretId", this.secretId()).build();
    }
