...
implements ToCopyableBuilder<Builder, RotateSecretRequest> {
    private static final SdkField<String> SECRET_ID_FIELD = SdkField.builder(MarshallingType.STRING).memberName("SecretId").getter(RotateSecretRequest.getter(RotateSecretRequest::secretId)).setter(RotateSecretRequest.setter(Builder::secretId)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretId").build()).build();
    private static final SdkField<String> CLIENT_REQUEST_TOKEN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ClientRequestToken").getter(RotateSecretRequest.getter(RotateSecretRequest::clientRequestToken)).setter(RotateSecretRequest.setter(Builder::clientRequestToken)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ClientRequestToken").build(), DefaultValueTrait.idempotencyToken()).build();
    private static final SdkField<String> ROTATION_LAMBDA_ARN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("RotationLambdaARN").getter(RotateSecretRequest.getter(RotateSecretRequest::rotationLambdaARN)).setter(RotateSecretRequest.setter(Builder::rotationLambdaARN)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RotationLambdaARN").build()).build();
    private static final SdkField<RotationRulesType> ROTATION_RULES_FIELD = SdkField.builder(MarshallingType.SDK_POJO).memberName("RotationRules").getter(RotateSecretRequest.getter(RotateSecretRequest::rotationRules)).setter(RotateSecretRequest.setter(Builder::rotationRules)).constructor(RotationRulesType::builder).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RotationRules").build()).build();
    private static final SdkField<Boolean> ROTATE_IMMEDIATELY_FIELD = SdkField.builder(MarshallingType.BOOLEAN).memberName("RotateImmediately").getter(RotateSecretRequest.getter(RotateSecretRequest::rotateImmediately)).setter(RotateSecretRequest.setter(Builder::rotateImmediately)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RotateImmediately").build()).build();
    ...
    public final String toString() {
        return ToString.builder("RotateSecretRequest").add("SecretId", this.secretId()).add("ClientRequestToken", this.clientRequestToken()).add("RotationLambdaARN", this.rotationLambdaARN()).add("RotationRules", this.rotationRules()).add("RotateImmediately", this.rotateImmediately()).build();
    }
