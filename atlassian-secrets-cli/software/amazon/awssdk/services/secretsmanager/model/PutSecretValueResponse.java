...
implements ToCopyableBuilder<Builder, PutSecretValueResponse> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ARN").getter(PutSecretValueResponse.getter(PutSecretValueResponse::arn)).setter(PutSecretValueResponse.setter(Builder::arn)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()).build();
    ...
    public final String toString() {
        return ToString.builder("PutSecretValueResponse").add("ARN", this.arn()).add("Name", this.name()).add("VersionId", this.versionId()).add("VersionStages", this.hasVersionStages() ? this.versionStages() : null).build();
    }
