...
implements ToCopyableBuilder<Builder, StopReplicationToReplicaRequest> {
    ...
    public final String toString() {
        return ToString.builder("StopReplicationToReplicaRequest").add("SecretId", this.secretId()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<StopReplicationToReplicaRequest, T> g) {
        return obj -> g.apply((StopReplicationToReplicaRequest)obj);
    }
