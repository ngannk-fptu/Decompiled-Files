...
implements ToCopyableBuilder<Builder, GetRandomPasswordResponse> {
    private static final SdkField<String> RANDOM_PASSWORD_FIELD = SdkField.builder(MarshallingType.STRING).memberName("RandomPassword").getter(GetRandomPasswordResponse.getter(GetRandomPasswordResponse::randomPassword)).setter(GetRandomPasswordResponse.setter(Builder::randomPassword)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RandomPassword").build()).build();
    ...
    public final String toString() {
        return ToString.builder("GetRandomPasswordResponse").add("RandomPassword", this.randomPassword() == null ? null : "*** Sensitive Data Redacted ***").build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<GetRandomPasswordResponse, T> g) {
        return obj -> g.apply((GetRandomPasswordResponse)obj);
    }
