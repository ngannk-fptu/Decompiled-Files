...
implements ToCopyableBuilder<Builder, GetRandomPasswordRequest> {
    private static final SdkField<Long> PASSWORD_LENGTH_FIELD = SdkField.builder(MarshallingType.LONG).memberName("PasswordLength").getter(GetRandomPasswordRequest.getter(GetRandomPasswordRequest::passwordLength)).setter(GetRandomPasswordRequest.setter(Builder::passwordLength)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("PasswordLength").build()).build();
    private static final SdkField<String> EXCLUDE_CHARACTERS_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ExcludeCharacters").getter(GetRandomPasswordRequest.getter(GetRandomPasswordRequest::excludeCharacters)).setter(GetRandomPasswordRequest.setter(Builder::excludeCharacters)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ExcludeCharacters").build()).build();
    private static final SdkField<Boolean> EXCLUDE_NUMBERS_FIELD = SdkField.builder(MarshallingType.BOOLEAN).memberName("ExcludeNumbers").getter(GetRandomPasswordRequest.getter(GetRandomPasswordRequest::excludeNumbers)).setter(GetRandomPasswordRequest.setter(Builder::excludeNumbers)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ExcludeNumbers").build()).build();
    private static final SdkField<Boolean> EXCLUDE_PUNCTUATION_FIELD = SdkField.builder(MarshallingType.BOOLEAN).memberName("ExcludePunctuation").getter(GetRandomPasswordRequest.getter(GetRandomPasswordRequest::excludePunctuation)).setter(GetRandomPasswordRequest.setter(Builder::excludePunctuation)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ExcludePunctuation").build()).build();
    private static final SdkField<Boolean> EXCLUDE_UPPERCASE_FIELD = SdkField.builder(MarshallingType.BOOLEAN).memberName("ExcludeUppercase").getter(GetRandomPasswordRequest.getter(GetRandomPasswordRequest::excludeUppercase)).setter(GetRandomPasswordRequest.setter(Builder::excludeUppercase)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ExcludeUppercase").build()).build();
    private static final SdkField<Boolean> EXCLUDE_LOWERCASE_FIELD = SdkField.builder(MarshallingType.BOOLEAN).memberName("ExcludeLowercase").getter(GetRandomPasswordRequest.getter(GetRandomPasswordRequest::excludeLowercase)).setter(GetRandomPasswordRequest.setter(Builder::excludeLowercase)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ExcludeLowercase").build()).build();
    private static final SdkField<Boolean> INCLUDE_SPACE_FIELD = SdkField.builder(MarshallingType.BOOLEAN).memberName("IncludeSpace").getter(GetRandomPasswordRequest.getter(GetRandomPasswordRequest::includeSpace)).setter(GetRandomPasswordRequest.setter(Builder::includeSpace)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("IncludeSpace").build()).build();
    private static final SdkField<Boolean> REQUIRE_EACH_INCLUDED_TYPE_FIELD = SdkField.builder(MarshallingType.BOOLEAN).memberName("RequireEachIncludedType").getter(GetRandomPasswordRequest.getter(GetRandomPasswordRequest::requireEachIncludedType)).setter(GetRandomPasswordRequest.setter(Builder::requireEachIncludedType)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RequireEachIncludedType").build()).build();
    ...
    public final String toString() {
        return ToString.builder("GetRandomPasswordRequest").add("PasswordLength", this.passwordLength()).add("ExcludeCharacters", this.excludeCharacters()).add("ExcludeNumbers", this.excludeNumbers()).add("ExcludePunctuation", this.excludePunctuation()).add("ExcludeUppercase", this.excludeUppercase()).add("ExcludeLowercase", this.excludeLowercase()).add("IncludeSpace", this.includeSpace()).add("RequireEachIncludedType", this.requireEachIncludedType()).build();
    }
