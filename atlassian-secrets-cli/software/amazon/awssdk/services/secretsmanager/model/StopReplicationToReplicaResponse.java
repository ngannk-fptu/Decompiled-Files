...
implements ToCopyableBuilder<Builder, StopReplicationToReplicaResponse> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder(MarshallingType.STRING).memberName("ARN").getter(StopReplicationToReplicaResponse.getter(StopReplicationToReplicaResponse::arn)).setter(StopReplicationToReplicaResponse.setter(Builder::arn)).traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        StopReplicationToReplicaResponse other = (StopReplicationToReplicaResponse)obj;
        return Objects.equals(this.arn(), other.arn());
    }

    public final String toString() {
        return ToString.builder("StopReplicationToReplicaResponse").add("ARN", this.arn()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<StopReplicationToReplicaResponse, T> g) {
        return obj -> g.apply((StopReplicationToReplicaResponse)obj);
    }
