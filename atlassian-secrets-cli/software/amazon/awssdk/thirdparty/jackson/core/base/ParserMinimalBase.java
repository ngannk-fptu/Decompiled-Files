...
import software.amazon.awssdk.thirdparty.jackson.core.io.JsonEOFException;
...
extends JsonParser {
        ...
        if (t != null) {
            switch (t.id()) {
                case 6: {
                    ...
                    this.streamReadConstraints().validateFPLength(str.length());
    ...
    protected void reportUnexpectedNumberChar(int ch, String comment) throws JsonParseException {
        this._reportUnexpectedNumberChar(ch, comment);
    }
    ...
    protected void _reportInputCoercion(String msg, JsonToken inputType, Class<?> targetType) throws InputCoercionException {
        throw new InputCoercionException((JsonParser)this, msg, inputType, targetType);
    }
