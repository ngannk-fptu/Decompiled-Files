...
import software.amazon.awssdk.thirdparty.jackson.core.io.doubleparser.BigSignificand;
...
class ParseDigitsTaskCharSequence {
    ...
    static BigInteger parseDigitsRecursive(CharSequence str, int from, int to, Map<Integer, BigInteger> powersOfTen) {
        ...
        BigInteger high = ParseDigitsTaskCharSequence.parseDigitsRecursive(str, from, mid, powersOfTen);
        BigInteger low = ParseDigitsTaskCharSequence.parseDigitsRecursive(str, mid, to, powersOfTen);
