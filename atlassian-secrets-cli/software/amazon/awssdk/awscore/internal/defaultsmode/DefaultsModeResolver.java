...
public final class DefaultsModeResolver {
    ...
    public DefaultsMode resolve() {
        return OptionalUtils.firstPresent(DefaultsModeResolver.fromSystemSettings(), new Supplier[]{() -> DefaultsModeResolver.fromProfileFile(this.profileFile, this.profileName)}).orElseGet(this::fromDefaultMode);
    }
