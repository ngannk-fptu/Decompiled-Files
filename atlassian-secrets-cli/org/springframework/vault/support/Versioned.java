...
public class Versioned<T> {
    ...
    public static <T> Versioned<T> create(@Nullable T secret, Metadata metadata) {
        Assert.notNull((Object)metadata, "Metadata must not be null");
    ...
    public static class Metadata {
        ...
        public static class MetadataBuilder {
            ...
            public MetadataBuilder createdAt(Instant createdAt) {
                Assert.notNull((Object)createdAt, "Created at must not be null");
                this.createdAt = createdAt;
                return this;
            }
            ...
            public Metadata build() {
                Assert.notNull((Object)this.createdAt, "CreatedAt must not be null");
                Assert.notNull((Object)this.version, "Version must not be null");
