...
AuthenticationStepsFactory {
    ...
    public AppRoleAuthentication(AppRoleAuthenticationOptions options, RestOperations restOperations) {
        Assert.notNull((Object)options, "AppRoleAuthenticationOptions must not be null");
    ...
    private String getRoleId(AppRoleAuthenticationOptions.RoleId roleId) throws VaultLoginException {
        ...
        if (roleId instanceof AppRoleTokens.Pull) {
            ...
            try {
                ResponseEntity<VaultResponse> entity = this.restOperations.exchange(AppRoleAuthentication.getRoleIdIdPath(this.options), HttpMethod.GET, AppRoleAuthentication.createHttpEntity(token), VaultResponse.class, new Object[0]);
        ...
        if (roleId instanceof AppRoleTokens.Wrapped) {
            ...
            try {
                ...
                ResponseEntity<VaultResponse> entity = this.restOperations.exchange(unwrappingEndpoints.getPath(), unwrappingEndpoints.getUnwrapRequestMethod(), AppRoleAuthentication.createHttpEntity(token), VaultResponse.class, new Object[0]);
    ...
    private String getSecretId(AppRoleAuthenticationOptions.SecretId secretId) throws VaultLoginException {
        ...
        if (secretId instanceof AppRoleTokens.Pull) {
            ...
            try {
                VaultResponse response = this.restOperations.postForObject(AppRoleAuthentication.getSecretIdPath(this.options), AppRoleAuthentication.createHttpEntity(token), VaultResponse.class, new Object[0]);
    ...
    private static HttpEntity<String> createHttpEntity(VaultToken token) {
        return new HttpEntity<Object>(null, AppRoleAuthentication.createHttpHeaders(token));
    }
    ...
    private static boolean hasSecretId(AppRoleAuthenticationOptions.SecretId secretId) {
        return !ClassUtils.isAssignableValue(AppRoleTokens.AbsentSecretId.class, secretId);
    }
