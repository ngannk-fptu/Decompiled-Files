...
public class AuthenticationSteps {
    ...
    public static AuthenticationSteps just(VaultToken token) {
        Assert.notNull((Object)token, "Vault token must not be null");
    ...
    public static class HttpRequest<T> {
        ...
        public String toString() {
            return String.format("%s %s AS %s", new Object[]{this.getMethod(), this.getUri() != null ? this.getUri() : this.getUriTemplate(), this.getResponseType()});
        }
    ...
    public static class HttpRequestBuilder {
        ...
        public HttpRequestBuilder with(HttpHeaders headers) {
            ...
            return new HttpRequestBuilder(this.method, this.uri, this.uriTemplate, this.urlVariables, new HttpEntity(headers));
        }
