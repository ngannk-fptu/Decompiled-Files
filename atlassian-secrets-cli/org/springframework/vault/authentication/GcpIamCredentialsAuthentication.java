...
implements ClientAuthentication {
    ...
    public GcpIamCredentialsAuthentication(GcpIamCredentialsAuthenticationOptions options, RestOperations restOperations, TransportChannelProvider transportChannelProvider) {
        ...
        Assert.notNull((Object)options, "GcpAuthenticationOptions must not be null");
        Assert.notNull((Object)restOperations, "RestOperations must not be null");
        Assert.notNull((Object)transportChannelProvider, "TransportChannelProvider must not be null");
