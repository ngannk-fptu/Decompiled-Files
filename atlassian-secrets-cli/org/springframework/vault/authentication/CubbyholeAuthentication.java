...
AuthenticationStepsFactory {
    ...
    private VaultResponse lookupToken(String url) {
        try {
            ...
            ResponseEntity<VaultResponse> entity = this.restOperations.exchange(url, unwrapMethod, requestEntity, VaultResponse.class, new Object[0]);
    ...
    private static HttpEntity<Object> getRequestEntity(CubbyholeAuthenticationOptions options) {
        return new HttpEntity<Object>(VaultHttpHeaders.from(options.getInitialToken()));
    }
