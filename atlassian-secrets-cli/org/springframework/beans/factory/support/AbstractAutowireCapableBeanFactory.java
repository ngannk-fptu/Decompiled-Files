...
implements AutowireCapableBeanFactory {
    ...
    protected Class<?> predictBeanType(String beanName, RootBeanDefinition mbd, Class<?> ... typesToMatch) {
        ...
        if (targetType != null && !mbd.isSynthetic() && this.hasInstantiationAwareBeanPostProcessors()) {
            ...
            for (BeanPostProcessor bp : this.getBeanPostProcessors()) {
                ...
                Class<?> predicted;
                if (!(bp instanceof SmartInstantiationAwareBeanPostProcessor) || (predicted = (ibp = (SmartInstantiationAwareBeanPostProcessor)bp).predictBeanType(targetType, beanName)) == null || matchingOnlyFactoryBean && !FactoryBean.class.isAssignableFrom(predicted)) continue;
                return predicted;
            }
        }
        return targetType;
        ...
        synchronized (object) {
            ...
            try {
                ...
                if (this.logger.isDebugEnabled()) {
                    this.logger.debug("Bean creation exception on singleton FactoryBean type check: " + ex);
                }
    ...
    protected void invokeInitMethods(String beanName, Object bean2, @Nullable RootBeanDefinition mbd) throws Throwable {
        ...
        if (!(mbd == null || bean2.getClass() == NullBean.class || !StringUtils.hasLength(initMethodName = mbd.getInitMethodName()) || isInitializingBean && "afterPropertiesSet".equals(initMethodName) || mbd.isExternallyManagedInitMethod(initMethodName))) {
    ...
    protected void invokeCustomInitMethod(String beanName, Object bean2, RootBeanDefinition mbd) throws Throwable {
        ...
        Method methodToInvoke = ClassUtils.getInterfaceMethodIfPossible((Method)initMethod);
        if (System.getSecurityManager() != null) {
            AccessController.doPrivileged(() -> {
