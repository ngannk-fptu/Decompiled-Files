...
implements ListableBeanFactory {
    ...
    public Object getBean(String name) throws BeansException {
        ...
        if (BeanFactoryUtils.isFactoryDereference(name) && !(bean2 instanceof FactoryBean)) {
            throw new BeanIsNotAFactoryException(beanName, bean2.getClass());
        }
        if (bean2 instanceof FactoryBean && !BeanFactoryUtils.isFactoryDereference(name)) {
            try {
                Object exposedObject = ((FactoryBean)bean2).getObject();
    ...
    public <T> T getBean(String name, @Nullable Class<T> requiredType) throws BeansException {
        Object bean2 = this.getBean(name);
    ...
    public boolean isSingleton(String name) throws NoSuchBeanDefinitionException {
        ...
        if (bean2 instanceof FactoryBean) {
            return ((FactoryBean)bean2).isSingleton();
        }
        return true;
    }
