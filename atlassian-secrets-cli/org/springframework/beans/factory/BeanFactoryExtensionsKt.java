...
public final class BeanFactoryExtensionsKt {
    ...
    @NotNull
    public static final /* synthetic */ <T> T getBean(@NotNull BeanFactory $this$getBean, Object ... args) {
        int $i$f$getBean = 0;
        Intrinsics.checkParameterIsNotNull((Object)$this$getBean, (String)"$this$getBean");
    ...
    public static final /* synthetic */ <T> ObjectProvider<T> getBeanProvider(@NotNull BeanFactory $this$getBeanProvider) {
        ...
        ObjectProvider objectProvider = $this$getBeanProvider.getBeanProvider(ResolvableType.forType(new ParameterizedTypeReference<T>(){}.getType()));
