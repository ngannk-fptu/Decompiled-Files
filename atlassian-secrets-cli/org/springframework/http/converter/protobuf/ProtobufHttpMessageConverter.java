...
extends AbstractHttpMessageConverter<Message> {
    ...
    ProtobufHttpMessageConverter(@Nullable ProtobufFormatSupport formatSupport, @Nullable ExtensionRegistryInitializer registryInitializer) {
    ...
    implements ProtobufFormatSupport {
        ...
        @Override
        public void merge(InputStream input, Charset charset, MediaType contentType, ExtensionRegistry extensionRegistry, Message.Builder builder) throws IOException {
        ...
        @Override
        public void print(Message message, OutputStream output, MediaType contentType, Charset charset) throws IOException {
            if (!contentType.isCompatibleWith(MediaType.APPLICATION_JSON)) {
                throw new IOException("protobuf-java-util does not support " + contentType + " format");
            }
