...
Serializable {
    ...
    public void setAccessControlRequestMethod(@Nullable HttpMethod requestMethod) {
        this.set(ACCESS_CONTROL_REQUEST_METHOD, requestMethod != null ? requestMethod.name() : null);
    }
    ...
    public void setCacheControl(CacheControl cacheControl) {
        this.set(CACHE_CONTROL, cacheControl.getHeaderValue());
    }
    ...
    public void setContentLanguage(@Nullable Locale locale) {
        this.set(CONTENT_LANGUAGE, locale != null ? locale.toLanguageTag() : null);
    }
    ...
    public void setLocation(@Nullable URI location) {
        this.set(LOCATION, location != null ? location.toASCIIString() : null);
    }
    ...
    public void setDate(String headerName, long date) {
        this.set(headerName, HttpHeaders.formatDate(date));
    }
    ...
    public void addAll(String key, List<? extends String> values) {
        List currentValues = this.headers.computeIfAbsent(key, k -> new LinkedList());
    ...
    public Map<String, String> toSingleValueMap() {
        ...
        this.headers.forEach((key, valueList) -> {
            String cfr_ignored_0 = (String)singleValueMap.put((String)key, (String)valueList.get(0));
        });
