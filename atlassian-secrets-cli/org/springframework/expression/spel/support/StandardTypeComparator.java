    ...
    public int compare(@Nullable Object left, @Nullable Object right) throws SpelEvaluationException {
        ...
        if (left instanceof Number && right instanceof Number) {
            ...
            if (leftNumber instanceof Long || rightNumber instanceof Long) {
                return StandardTypeComparator.compare(leftNumber.longValue(), rightNumber.longValue());
            }
            if (leftNumber instanceof Integer || rightNumber instanceof Integer) {
                return StandardTypeComparator.compare(leftNumber.intValue(), rightNumber.intValue());
            }
            if (leftNumber instanceof Short || rightNumber instanceof Short) {
                return StandardTypeComparator.compare(leftNumber.shortValue(), rightNumber.shortValue());
            }
            if (leftNumber instanceof Byte || rightNumber instanceof Byte) {
                return StandardTypeComparator.compare(leftNumber.byteValue(), rightNumber.byteValue());
            }
            return Double.compare(leftNumber.doubleValue(), rightNumber.doubleValue());
        }
        try {
