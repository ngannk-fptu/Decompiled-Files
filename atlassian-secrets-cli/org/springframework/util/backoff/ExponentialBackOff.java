...
implements BackOff {
    ...
    implements BackOffExecution {
        ...
        private long computeNextInterval() {
            ...
            this.currentInterval = this.currentInterval < 0L ? ((initialInterval = ExponentialBackOff.this.getInitialInterval()) < maxInterval ? initialInterval : maxInterval) : this.multiplyInterval(maxInterval);
            return this.currentInterval;
        }

        private long multiplyInterval(long maxInterval) {
            long i = this.currentInterval;
            return (i = (long)((double)i * ExponentialBackOff.this.getMultiplier())) > maxInterval ? maxInterval : i;
        }
