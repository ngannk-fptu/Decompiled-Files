...
public class MethodInvoker {
    ...
    public Object[] getArguments() {
        return this.arguments != null ? this.arguments : new Object[]{};
    }
    ...
    protected Method findMatchingMethod() {
        ...
        for (Method candidate : candidates) {
            int typeDiffWeight;
            Class<?>[] paramTypes;
            if (!candidate.getName().equals(targetMethod) || (paramTypes = candidate.getParameterTypes()).length != argCount || (typeDiffWeight = MethodInvoker.getTypeDifferenceWeight(paramTypes, arguments)) >= minTypeDiffWeight) continue;
