...
implements ConcurrentMap<K, V> {
    ...
    public V get(@Nullable Object key) {
        Entry<K, V> entry = this.getEntryIfAvailable(key);
    ...
    private abstract class Entries {
        ...
        public abstract void add(@Nullable V var1);
    }
    ...
    extends ReentrantLock {
         ...
         */
        @Nullable
        public <T> T doTask(final int hash, final @Nullable Object key, Task<T> task) {
