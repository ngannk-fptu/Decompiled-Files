...
public class UrlPathHelper {
    ...
    public String getPathWithinServletMapping(HttpServletRequest request) {
        ...
        String path = servletPath.contains(sanitizedPathWithinApp = this.getSanitizedPath(pathWithinApp)) ? this.getRemainingPath(sanitizedPathWithinApp, servletPath, false) : this.getRemainingPath(pathWithinApp, servletPath, false);
        if (path != null) {
            return path;
        }
