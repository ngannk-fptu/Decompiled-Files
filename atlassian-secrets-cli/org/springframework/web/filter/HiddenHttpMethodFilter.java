...
extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if ("POST".equals(request.getMethod()) && request.getAttribute("javax.servlet.error.exception") == null && StringUtils.hasLength(paramValue = request.getParameter(this.methodParam)) && ALLOWED_METHODS.contains(method = paramValue.toUpperCase(Locale.ENGLISH))) {
