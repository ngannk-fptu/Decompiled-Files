...
implements Serializable {
    ...
    public boolean matches(Method method, @Nullable Class<?> targetClass) {
        return targetClass != null && targetClass != method.getDeclaringClass() && this.matchesPattern(ClassUtils.getQualifiedMethodName(method, targetClass)) || this.matchesPattern(ClassUtils.getQualifiedMethodName(method, method.getDeclaringClass()));
    }
