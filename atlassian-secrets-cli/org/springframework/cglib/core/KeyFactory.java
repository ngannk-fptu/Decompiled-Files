...
public abstract class KeyFactory {
    ...
    public static KeyFactory create(ClassLoader loader, Class keyInterface, Customizer customizer2) {
        return KeyFactory.create(loader, keyInterface, customizer2, Collections.<KeyFactoryCustomizer>emptyList());
    }
        ...
        public void generateClass(ClassVisitor v) {
            ...
            for (int i2 = 0; i2 < parameterTypes.length; ++i2) {
                ...
                for (FieldTypeCustomizer customizer2 : fieldTypeCustomizers) {
                    fieldType = customizer2.getOutType(i2, fieldType);
                }
                ...
                e.load_arg(i2);
                for (FieldTypeCustomizer customizer2 : fieldTypeCustomizers) {
                    customizer2.customize(e, i2, parameterType);
                }
