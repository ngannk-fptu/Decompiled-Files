...
extends AbstractStringLayout {
    ...
    private String getId(StructuredDataId id) {
        ...
        int n = ein = id != null ? id.getEnterpriseNumber() : this.enterpriseNumber;
        if (ein < 0) {
