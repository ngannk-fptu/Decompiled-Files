    ...
    extends LoggerConfig {
        ...
        extends LoggerConfig.RootLogger.Builder<B> {
            ...
            public LoggerConfig build() {
                ...
                return new AsyncLoggerConfig("", container.refs, this.getFilter(), container.level, this.isAdditivity(), this.getProperties(), this.getConfig(), RootLogger.includeLocation(this.getIncludeLocation(), this.getConfig()));
            }
        }
    }
