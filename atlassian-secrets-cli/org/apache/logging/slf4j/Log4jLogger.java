...
Serializable {
    ...
    public boolean isTraceEnabled(Marker marker) {
        return this.logger.isEnabled(Level.TRACE, Log4jLogger.getMarker(marker), null);
    }

    @Override
    public void trace(Marker marker, String s) {
        this.logger.logIfEnabled(FQCN, Level.TRACE, Log4jLogger.getMarker(marker), s);
    }

    @Override
    public void trace(Marker marker, String s, Object o) {
        this.logger.logIfEnabled(FQCN, Level.TRACE, Log4jLogger.getMarker(marker), s, o);
    }

    @Override
    public void trace(Marker marker, String s, Object o, Object o1) {
        this.logger.logIfEnabled(FQCN, Level.TRACE, Log4jLogger.getMarker(marker), s, o, o1);
    }

    @Override
    public void trace(Marker marker, String s, Object ... objects) {
        this.logger.logIfEnabled(FQCN, Level.TRACE, Log4jLogger.getMarker(marker), s, objects);
    }

    @Override
    public void trace(Marker marker, String s, Throwable throwable) {
        this.logger.logIfEnabled(FQCN, Level.TRACE, Log4jLogger.getMarker(marker), s, throwable);
    }
    ...
    public boolean isDebugEnabled(Marker marker) {
        return this.logger.isEnabled(Level.DEBUG, Log4jLogger.getMarker(marker), null);
    }

    @Override
    public void debug(Marker marker, String s) {
        this.logger.logIfEnabled(FQCN, Level.DEBUG, Log4jLogger.getMarker(marker), s);
    }

    @Override
    public void debug(Marker marker, String s, Object o) {
        this.logger.logIfEnabled(FQCN, Level.DEBUG, Log4jLogger.getMarker(marker), s, o);
    }

    @Override
    public void debug(Marker marker, String s, Object o, Object o1) {
        this.logger.logIfEnabled(FQCN, Level.DEBUG, Log4jLogger.getMarker(marker), s, o, o1);
    }

    @Override
    public void debug(Marker marker, String s, Object ... objects) {
        this.logger.logIfEnabled(FQCN, Level.DEBUG, Log4jLogger.getMarker(marker), s, objects);
    }

    @Override
    public void debug(Marker marker, String s, Throwable throwable) {
        this.logger.logIfEnabled(FQCN, Level.DEBUG, Log4jLogger.getMarker(marker), s, throwable);
    }
    ...
    public boolean isInfoEnabled(Marker marker) {
        return this.logger.isEnabled(Level.INFO, Log4jLogger.getMarker(marker), null);
    }

    @Override
    public void info(Marker marker, String s) {
        this.logger.logIfEnabled(FQCN, Level.INFO, Log4jLogger.getMarker(marker), s);
    }

    @Override
    public void info(Marker marker, String s, Object o) {
        this.logger.logIfEnabled(FQCN, Level.INFO, Log4jLogger.getMarker(marker), s, o);
    }

    @Override
    public void info(Marker marker, String s, Object o, Object o1) {
        this.logger.logIfEnabled(FQCN, Level.INFO, Log4jLogger.getMarker(marker), s, o, o1);
    }

    @Override
    public void info(Marker marker, String s, Object ... objects) {
        this.logger.logIfEnabled(FQCN, Level.INFO, Log4jLogger.getMarker(marker), s, objects);
    }

    @Override
    public void info(Marker marker, String s, Throwable throwable) {
        this.logger.logIfEnabled(FQCN, Level.INFO, Log4jLogger.getMarker(marker), s, throwable);
    }
    ...
    public boolean isWarnEnabled(Marker marker) {
        return this.logger.isEnabled(Level.WARN, Log4jLogger.getMarker(marker), null);
    }

    @Override
    public void warn(Marker marker, String s) {
        this.logger.logIfEnabled(FQCN, Level.WARN, Log4jLogger.getMarker(marker), s);
    }

    @Override
    public void warn(Marker marker, String s, Object o) {
        this.logger.logIfEnabled(FQCN, Level.WARN, Log4jLogger.getMarker(marker), s, o);
    }

    @Override
    public void warn(Marker marker, String s, Object o, Object o1) {
        this.logger.logIfEnabled(FQCN, Level.WARN, Log4jLogger.getMarker(marker), s, o, o1);
    }

    @Override
    public void warn(Marker marker, String s, Object ... objects) {
        this.logger.logIfEnabled(FQCN, Level.WARN, Log4jLogger.getMarker(marker), s, objects);
    }

    @Override
    public void warn(Marker marker, String s, Throwable throwable) {
        this.logger.logIfEnabled(FQCN, Level.WARN, Log4jLogger.getMarker(marker), s, throwable);
    }
    ...
    public boolean isErrorEnabled(Marker marker) {
        return this.logger.isEnabled(Level.ERROR, Log4jLogger.getMarker(marker), null);
    }

    @Override
    public void error(Marker marker, String s) {
        this.logger.logIfEnabled(FQCN, Level.ERROR, Log4jLogger.getMarker(marker), s);
    }

    @Override
    public void error(Marker marker, String s, Object o) {
        this.logger.logIfEnabled(FQCN, Level.ERROR, Log4jLogger.getMarker(marker), s, o);
    }

    @Override
    public void error(Marker marker, String s, Object o, Object o1) {
        this.logger.logIfEnabled(FQCN, Level.ERROR, Log4jLogger.getMarker(marker), s, o, o1);
    }

    @Override
    public void error(Marker marker, String s, Object ... objects) {
        this.logger.logIfEnabled(FQCN, Level.ERROR, Log4jLogger.getMarker(marker), s, objects);
    }

    @Override
    public void error(Marker marker, String s, Throwable throwable) {
        this.logger.logIfEnabled(FQCN, Level.ERROR, Log4jLogger.getMarker(marker), s, throwable);
    }
    ...
    public void log(Marker marker, String fqcn, int level, String message, Object[] params, Throwable throwable) {
        ...
        if (!this.logger.isEnabled(log4jLevel, log4jMarker = Log4jLogger.getMarker(marker), message, params)) {
            return;
        }
