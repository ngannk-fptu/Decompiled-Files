...
public final class Scheme {
    ...
    public Scheme(String name, int port, SchemeSocketFactory factory) {
        Args.notNull((Object)name, (String)"Scheme name");
        Args.check((port > 0 && port <= 65535 ? 1 : 0) != 0, (String)"Port is invalid");
        Args.notNull((Object)factory, (String)"Socket factory");
    ...
    public int hashCode() {
        int hash = 17;
        hash = LangUtils.hashCode((int)hash, (int)this.defaultPort);
        hash = LangUtils.hashCode((int)hash, (Object)this.name);
        hash = LangUtils.hashCode((int)hash, (boolean)this.layered);
        return hash;
    }
}
