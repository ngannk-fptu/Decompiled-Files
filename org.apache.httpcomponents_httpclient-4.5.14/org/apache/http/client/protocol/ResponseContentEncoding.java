...
implements HttpResponseInterceptor {
    ...
    public ResponseContentEncoding(Lookup<InputStreamFactory> decoderRegistry, boolean ignoreUnknown) {
        this.decoderRegistry = decoderRegistry != null ? decoderRegistry : RegistryBuilder.create().register("gzip", (Object)GZIPInputStreamFactory.getInstance()).register("x-gzip", (Object)GZIPInputStreamFactory.getInstance()).register("deflate", (Object)DeflateInputStreamFactory.getInstance()).build();
