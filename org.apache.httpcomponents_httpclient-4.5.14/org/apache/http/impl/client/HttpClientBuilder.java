...
public class HttpClientBuilder {
    ...
    public CloseableHttpClient build() {
        ...
        if ((connManagerCopy = this.connManager) == null) {
            ...
            PoolingHttpClientConnectionManager poolingmgr = new PoolingHttpClientConnectionManager((Registry<ConnectionSocketFactory>)RegistryBuilder.create().register("http", (Object)PlainConnectionSocketFactory.getSocketFactory()).register("https", (Object)sslSocketFactoryCopy).build(), null, null, this.dnsResolver, this.connTimeToLive, this.connTimeToLiveTimeUnit != null ? this.connTimeToLiveTimeUnit : TimeUnit.MILLISECONDS);
        ...
        ClientExecChain execChain = this.createMainExec(requestExecCopy, connManagerCopy, (ConnectionReuseStrategy)reuseStrategyCopy, keepAliveStrategyCopy, (HttpProcessor)new ImmutableHttpProcessor(new HttpRequestInterceptor[]{new RequestTargetHost(), new RequestUserAgent(userAgentCopy)}), targetAuthStrategyCopy, proxyAuthStrategyCopy, userTokenHandlerCopy);
        ...
        if (httpprocessorCopy == null) {
            ...
            if (!this.contentCompressionDisabled) {
                if (this.contentDecoderMap != null) {
                    ...
                    b.add((HttpResponseInterceptor)new ResponseContentEncoding((Lookup<InputStreamFactory>)b2.build()));
                } else {
