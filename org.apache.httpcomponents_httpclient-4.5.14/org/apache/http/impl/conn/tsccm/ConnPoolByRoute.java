...
extends AbstractConnPool {
        ...
        try {
            ...
            while (entry == null) {
                ...
                if (this.log.isDebugEnabled()) {
                    this.log.debug((Object)("[" + route + "] total kept alive: " + this.freeConnections.size() + ", total issued: " + this.leasedConnections.size() + ", total allocated: " + this.numConnections + " out of " + this.maxTotalConnections));
                }
                ...
                if (this.log.isDebugEnabled()) {
                    this.log.debug((Object)("Available capacity: " + rospl.getCapacity() + " out of " + rospl.getMaxEntries() + " [" + route + "][" + state + "]"));
                }
                ...
                if (this.log.isDebugEnabled()) {
                    this.log.debug((Object)("Need to wait for connection [" + route + "][" + state + "]"));
                }
        ...
        try {
            ...
            if (reusable && rospl.getCapacity() >= 0) {
                if (this.log.isDebugEnabled()) {
                    ...
                    this.log.debug((Object)("Pooling connection [" + route + "][" + entry.getState() + "]; keep alive " + s));
                }
    ...
    public void closeIdleConnections(long idletime, TimeUnit timeUnit) {
        ...
        if (this.log.isDebugEnabled()) {
            this.log.debug((Object)("Closing connections idle longer than " + t + " " + (Object)((Object)timeUnit)));
        }
