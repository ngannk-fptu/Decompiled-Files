...
extends RFC2617Scheme {
    ...
    private Header createDigestHeader(Credentials credentials, HttpRequest request) throws AuthenticationException {
        ...
        if (algorithm.equalsIgnoreCase("MD5-sess")) {
            ...
            String checksum = DigestScheme.encode(digester.digest(EncodingUtils.getBytes((String)sb.toString(), (String)charset)));
            sb.setLength(0);
        ...
        String hasha1 = DigestScheme.encode(digester.digest(EncodingUtils.getBytes((String)this.a1, (String)charset)));
        if (qop == 2) {
            this.a2 = method + ':' + uri;
        } else if (qop == 1) {
        ...
        String hasha2 = DigestScheme.encode(digester.digest(EncodingUtils.getBytes((String)this.a2, (String)charset)));
        if (qop == 0) {
            sb.setLength(0);
        ...
        String digest = DigestScheme.encode(digester.digest(EncodingUtils.getAsciiBytes((String)digestValue)));
