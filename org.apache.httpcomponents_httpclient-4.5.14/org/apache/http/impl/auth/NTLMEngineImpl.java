...
implements NTLMEngine {
    ...
    extends NTLMMessage {
        ...
        Type2Message(String messageBody) throws NTLMEngineException {
            this(Base64.decodeBase64((byte[])messageBody.getBytes(DEFAULT_CHARSET)));
        }
    ...
    static class NTLMMessage {
        ...
        NTLMMessage(String messageBody, int expectedType) throws NTLMEngineException {
            this(Base64.decodeBase64((byte[])messageBody.getBytes(DEFAULT_CHARSET)), expectedType);
        }
        ...
        public String getResponse() {
            return new String(Base64.encodeBase64((byte[])this.getBytes()), Consts.ASCII);
        }
    ...
    protected static class CipherGen {
        ...
        public CipherGen(String domain, String user, String password, byte[] challenge, String target, byte[] targetInformation, byte[] clientChallenge, byte[] clientChallenge2, byte[] secondaryKey, byte[] timestamp) {
            this(RND_GEN, System.currentTimeMillis(), domain, user, password, challenge, target, targetInformation, clientChallenge, clientChallenge2, secondaryKey, timestamp);
        }
