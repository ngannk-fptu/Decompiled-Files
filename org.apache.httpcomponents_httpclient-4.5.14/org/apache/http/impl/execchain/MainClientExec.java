        ...
        try {
            ...
            while (true) {
                ...
                if (!request.containsHeader("Authorization")) {
                    ...
                    this.authenticator.generateAuthResponse(request, targetAuthState, (HttpContext)context);
                }
                if (!request.containsHeader("Proxy-Authorization") && !route.isTunnelled()) {
                    ...
                    this.authenticator.generateAuthResponse(request, proxyAuthState, (HttpContext)context);
                }
