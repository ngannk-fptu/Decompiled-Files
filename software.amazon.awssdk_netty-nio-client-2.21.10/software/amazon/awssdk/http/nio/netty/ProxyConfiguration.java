...
implements ToCopyableBuilder<Builder, ProxyConfiguration> {
    ...
    private ProxyConfiguration(BuilderImpl builder) {
        ...
        ProxyConfigProvider proxyConfigProvider = ProxyConfigProvider.fromSystemEnvironmentSettings((Boolean)builder.useSystemPropertyValues, (Boolean)builder.useEnvironmentVariablesValues, (String)builder.scheme);
    ...
    private static String resolvePassword(BuilderImpl builder, ProxyConfigProvider proxyConfigProvider) {
        if (!StringUtils.isEmpty((CharSequence)builder.password) || proxyConfigProvider == null) {
    ...
    private static String resolveUserName(BuilderImpl builder, ProxyConfigProvider proxyConfigProvider) {
        if (!StringUtils.isEmpty((CharSequence)builder.username) || proxyConfigProvider == null) {
