...
extends Http2ConnectionAdapter {
    ...
    public void onGoAwayReceived(int lastStreamId, long errorCode, ByteBuf debugData) {
        Http2MultiplexedChannelPool channelPool = (Http2MultiplexedChannelPool)this.parentChannel.attr(ChannelAttributeKey.HTTP2_MULTIPLEXED_CHANNEL_POOL).get();
        ...
        if (channelPool != null) {
            ...
            this.parentChannel.pipeline().fireExceptionCaught((Throwable)exception);
        }
    }
}
