...
public final class NettyRequestExecutor {
    ...
    public CompletableFuture<Void> execute() {
        ...
        this.acquireChannel((Promise<Channel>)channelFuture);
    ...
    private CompletableFuture<Void> createExecutionFuture(Promise<Channel> channelPromise) {
        ...
        future.whenComplete((r, t) -> {
            ...
            if (!channelPromise.tryFailure(t)) {
                ...
                try {
                    ch.eventLoop().submit(() -> {
                        Attribute executionIdKey = ch.attr(ChannelAttributeKey.EXECUTION_ID_KEY);
                        if (ch.attr(ChannelAttributeKey.IN_USE) != null && ((Boolean)ch.attr(ChannelAttributeKey.IN_USE).get()).booleanValue() && executionIdKey != null) {
    ...
    private void configureChannel() {
        ...
        this.channel.attr(ChannelAttributeKey.STREAMING_COMPLETE_KEY).set((Object)false);
