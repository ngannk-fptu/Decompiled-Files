...
implements ToCopyableBuilder<Builder, Http2Configuration> {
    ...
    implements Builder {
        ...
        public Builder maxStreams(Long maxStreams) {
            this.maxStreams = Validate.isPositiveOrNull((Long)maxStreams, (String)"maxStreams");
            return this;
        }
        ...
        public Builder initialWindowSize(Integer initialWindowSize) {
            this.initialWindowSize = Validate.isPositiveOrNull((Integer)initialWindowSize, (String)"initialWindowSize");
            return this;
        }
