...
public class ServiceLoader {
    ...
    public <T> List<T> loadServiceProviders(Class<T> iface) {
        ...
        tmp.addAll(this.loadDynamicServiceProviders(iface));
        tmp.addAll(this.loadStaticServiceProviders(iface));
        ArrayList providers = new ArrayList();
        HashSet<String> seen = new HashSet<String>();
        for (Object provider : tmp) {
            if (seen.contains(provider.getClass().getCanonicalName())) continue;
