...
public interface MimeTypesReaderMetKeys {
    ...
    public static final String INTERPRETED_ATTR = "interpreted";
    ...
    public static final String MATCH_MINSHOULDMATCH_ATTR = "minShouldMatch";
    public static final String NS_URI_ATTR = "namespaceURI";
    public static final String LOCAL_NAME_ATTR = "localName";
    public static final String TIKA_LINK_TAG = "tika:link";
    public static final String TIKA_UTI_TAG = "tika:uti";
}
