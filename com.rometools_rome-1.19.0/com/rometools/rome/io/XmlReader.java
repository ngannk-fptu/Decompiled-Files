...
import com.rometools.rome.io.XmlReaderException;
...
extends Reader {
    ...
    public XmlReader(URL url, Map<String, String> requestHeaders) throws IOException {
    ...
    public XmlReader(URLConnection conn, Map<String, String> requestHeaders) throws IOException {
    ...
    private String calculateRawEncoding(String bomEnc, String xmlGuessEnc, String xmlEnc, InputStream is) throws IOException {
        String encoding;
        if (bomEnc == null) {
            encoding = xmlGuessEnc == null || xmlEnc == null ? (this.defaultEncoding == null ? UTF_8 : this.defaultEncoding) : (xmlEnc.equals(UTF_16) && (xmlGuessEnc.equals(UTF_16BE) || xmlGuessEnc.equals(UTF_16LE)) ? xmlGuessEnc : xmlEnc);
