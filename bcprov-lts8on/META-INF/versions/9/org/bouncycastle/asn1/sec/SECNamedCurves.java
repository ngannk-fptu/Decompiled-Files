...
public class SECNamedCurves {
    static X9ECParametersHolder secp112r1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            ...
            return SECNamedCurves.configureCurve(new ECCurve.Fp(p, a, b, n, h, true));
        }
    ...
    static X9ECParametersHolder secp160k1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            ...
            return SECNamedCurves.configureCurveGLV(new ECCurve.Fp(p, a, b, n, h, true), glv);
        }
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger p = SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D");
            BigInteger a = ECConstants.ZERO;
    ...
    static X9ECParametersHolder secp224r1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger p = SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001");
    ...
    static X9ECParametersHolder secp256k1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger p = SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F");
            BigInteger a = ECConstants.ZERO;
            BigInteger b = BigInteger.valueOf(7L);
    ...
    static X9ECParametersHolder secp256r1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger p = SECNamedCurves.fromHex("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF");
    ...
    static X9ECParametersHolder secp384r1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger p = SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF");
    ...
    static X9ECParametersHolder secp521r1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger p = SECNamedCurves.fromHex("01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
    ...
    static X9ECParametersHolder sect113r1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            ...
            return SECNamedCurves.configureCurve(new ECCurve.F2m(m, k, a, b, n, h));
        }
    ...
    static X9ECParametersHolder sect131r1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            ...
            BigInteger h = BigInteger.valueOf(2L);
            return SECNamedCurves.configureCurve(new ECCurve.F2m(m, k1, k2, k3, a, b, n, h));
        }
    ...
    public static X9ECParameters getByOID(ASN1ObjectIdentifier oid) {
        X9ECParametersHolder holder = SECNamedCurves.getByOIDLazy(oid);
