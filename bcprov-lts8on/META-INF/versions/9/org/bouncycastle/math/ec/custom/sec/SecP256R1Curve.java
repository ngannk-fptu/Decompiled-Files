...
extends ECCurve.AbstractFp {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
        ...
        for (int i = 0; i < len; ++i) {
            ...
            Nat256.copy(((SecP256R1FieldElement)p.getRawYCoord()).x, 0, table, pos += 8);
            pos += 8;
        }
        return new AbstractECLookupTable(){
            ...
            private ECPoint createPoint(int[] x, int[] y) {
                return SecP256R1Curve.this.createRawPoint(new SecP256R1FieldElement(x), new SecP256R1FieldElement(y), SECP256R1_AFFINE_ZS);
            }
        };
    }
