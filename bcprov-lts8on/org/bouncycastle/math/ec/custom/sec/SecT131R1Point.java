...
extends ECPoint.AbstractF2m {
    SecT131R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y) {
        super(curve, x, y);
    }

    SecT131R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs) {
        super(curve, x, y, zs);
    }
    ...
    public ECPoint twice() {
        ...
        if (T.isZero()) {
            return new SecT131R1Point(curve, T, curve.getB().sqrt());
        }
    ...
    public ECPoint negate() {
        ...
        ECFieldElement L = this.y;
        ECFieldElement Z = this.zs[0];
        return new SecT131R1Point(this.curve, X, L.add(Z), new ECFieldElement[]{Z});
    }
}
