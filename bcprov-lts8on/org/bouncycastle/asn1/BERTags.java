...
public interface BERTags {
    ...
    public static final int UNRESTRICTED_STRING = 29;
    public static final int BMP_STRING = 30;
    public static final int DATE = 31;
    public static final int TIME_OF_DAY = 32;
    public static final int DATE_TIME = 33;
    public static final int DURATION = 34;
    public static final int OBJECT_IDENTIFIER_IRI = 35;
    public static final int RELATIVE_OID_IRI = 36;
