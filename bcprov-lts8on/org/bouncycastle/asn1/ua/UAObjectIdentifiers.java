...
public interface UAObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier alg_id = UaOid.branch("1");
    public static final ASN1ObjectIdentifier sym_id = alg_id.branch("1");
    public static final ASN1ObjectIdentifier hmac_gost3411_id = sym_id.branch("2");
    public static final ASN1ObjectIdentifier hash_id = alg_id.branch("2");
    public static final ASN1ObjectIdentifier gost3411_id = hash_id.branch("1");
}
