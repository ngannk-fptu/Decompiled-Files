...
extends BaseCipherSpi {
    ...
    private void initFromSpec(OAEPParameterSpec pSpec) throws NoSuchPaddingException {
        ...
        this.cipher = new OAEPEncoding(new ElGamalEngine(), digest, ((PSource.PSpecified)pSpec.getPSource()).getValue());
    ...
    protected int engineGetKeySize(Key key) {
        if (key instanceof ElGamalKey) {
            ElGamalKey k = (ElGamalKey)((Object)key);
    ...
    protected void engineInit(int opmode, Key key, AlgorithmParameterSpec params, SecureRandom random) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (params instanceof OAEPParameterSpec) {
            ...
            this.cipher = new OAEPEncoding(new ElGamalEngine(), digest, mgfDigest, ((PSource.PSpecified)spec.getPSource()).getValue());
        } else if (params != null) {
