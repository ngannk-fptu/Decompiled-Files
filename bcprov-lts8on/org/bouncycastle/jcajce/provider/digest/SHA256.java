...
public class SHA256 {
    ...
    implements Cloneable {
        ...
        public Object clone() throws CloneNotSupportedException {
            ...
            d.digest = SHA256Digest.newInstance(this.digest);
            return d;
        }
    }
    ...
    extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider provider) {
            ...
            this.addHMACAlgorithm(provider, "SHA256", PREFIX + "$HashMac", PREFIX + "$KeyGenerator");
            this.addHMACAlias(provider, "SHA256", PKCSObjectIdentifiers.id_hmacWithSHA256);
            this.addHMACAlias(provider, "SHA256", NISTObjectIdentifiers.id_sha256);
        }
    }
