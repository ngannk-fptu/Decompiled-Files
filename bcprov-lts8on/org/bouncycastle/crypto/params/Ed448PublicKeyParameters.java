...
extends AsymmetricKeyParameter {
    ...
    public Ed448PublicKeyParameters(byte[] buf, int off) {
        super(false);
        this.publicPoint = Ed448PublicKeyParameters.parse(buf, off);
    }
    ...
    public Ed448PublicKeyParameters(InputStream input) throws IOException {
        ...
        this.publicPoint = Ed448PublicKeyParameters.parse(data, 0);
    }
    ...
    public void encode(byte[] buf, int off) {
        Ed448.encodePublicPoint(this.publicPoint, buf, off);
    }
