...
extends HarakaBase {
    ...
    private int haraka256256(byte[] msg, byte[] out, int outOff) {
        ...
        s1[0] = Haraka256Digest.aesEnc(s1[0], RC[0]);
        s1[1] = Haraka256Digest.aesEnc(s1[1], RC[1]);
        s1[0] = Haraka256Digest.aesEnc(s1[0], RC[2]);
        s1[1] = Haraka256Digest.aesEnc(s1[1], RC[3]);
        this.mix256(s1, s2);
        s1[0] = Haraka256Digest.aesEnc(s2[0], RC[4]);
        s1[1] = Haraka256Digest.aesEnc(s2[1], RC[5]);
        s1[0] = Haraka256Digest.aesEnc(s1[0], RC[6]);
        s1[1] = Haraka256Digest.aesEnc(s1[1], RC[7]);
        this.mix256(s1, s2);
        s1[0] = Haraka256Digest.aesEnc(s2[0], RC[8]);
        s1[1] = Haraka256Digest.aesEnc(s2[1], RC[9]);
        s1[0] = Haraka256Digest.aesEnc(s1[0], RC[10]);
        s1[1] = Haraka256Digest.aesEnc(s1[1], RC[11]);
        this.mix256(s1, s2);
        s1[0] = Haraka256Digest.aesEnc(s2[0], RC[12]);
        s1[1] = Haraka256Digest.aesEnc(s2[1], RC[13]);
        s1[0] = Haraka256Digest.aesEnc(s1[0], RC[14]);
        s1[1] = Haraka256Digest.aesEnc(s1[1], RC[15]);
        this.mix256(s1, s2);
        s1[0] = Haraka256Digest.aesEnc(s2[0], RC[16]);
        s1[1] = Haraka256Digest.aesEnc(s2[1], RC[17]);
        s1[0] = Haraka256Digest.aesEnc(s1[0], RC[18]);
        s1[1] = Haraka256Digest.aesEnc(s1[1], RC[19]);
        this.mix256(s1, s2);
        s1[0] = Haraka256Digest.xor(s2[0], msg, 0);
        s1[1] = Haraka256Digest.xor(s2[1], msg, 16);
    ...
    public int doFinal(byte[] out, int outOff) {
        ...
        int rv = this.haraka256256(this.buffer, out, outOff);
        this.reset();
        return rv;
    }
