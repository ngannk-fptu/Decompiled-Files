...
implements HibernateContentQueryFactory {
    public Query getQuery(EntityManager entityManager, Object ... parameters) throws PersistenceException {
        ...
        Query query = entityManager.createQuery("from CustomContentEntityObject content where content.originalVersion is null and content.space.id = :spaceId and content.contentStatus = 'current' and content.id > :contentId order by content.creationDate asc");
