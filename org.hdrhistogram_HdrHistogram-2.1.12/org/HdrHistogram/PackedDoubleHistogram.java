...
extends DoubleHistogram {
    ...
    public static PackedDoubleHistogram decodeFromByteBuffer(ByteBuffer buffer, long minBarForHighestToLowestValueRatio) {
        try {
            ...
            PackedDoubleHistogram histogram = PackedDoubleHistogram.constructHistogramFromBuffer(cookie, buffer, PackedDoubleHistogram.class, PackedHistogram.class, minBarForHighestToLowestValueRatio);
            return histogram;
        }
