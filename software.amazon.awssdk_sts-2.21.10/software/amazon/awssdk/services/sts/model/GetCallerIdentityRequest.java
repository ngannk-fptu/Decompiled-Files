...
public final class GetCallerIdentityRequest
extends StsRequest
implements ToCopyableBuilder<Builder, GetCallerIdentityRequest> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));

    private GetCallerIdentityRequest(BuilderImpl builder) {
        super(builder);
    }
    ...
    public final String toString() {
        return ToString.builder((String)"GetCallerIdentityRequest").build();
    }
    ...
    implements Builder {
        ...
        private BuilderImpl(GetCallerIdentityRequest model) {
            super(model);
        }
    ...
    SdkPojo,
    CopyableBuilder<Builder, GetCallerIdentityRequest> {
