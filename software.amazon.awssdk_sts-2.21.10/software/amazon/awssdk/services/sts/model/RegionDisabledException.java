...
public final class RegionDisabledException
extends StsException
implements ToCopyableBuilder<Builder, RegionDisabledException> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));
    private static final long serialVersionUID = 1L;

    private RegionDisabledException(BuilderImpl builder) {
        super(builder);
    }
    ...
    implements Builder {
        ...
        private BuilderImpl(RegionDisabledException model) {
            super(model);
        }
        ...
        @Override
        public RegionDisabledException build() {
            return new RegionDisabledException(this);
        }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, RegionDisabledException>,
