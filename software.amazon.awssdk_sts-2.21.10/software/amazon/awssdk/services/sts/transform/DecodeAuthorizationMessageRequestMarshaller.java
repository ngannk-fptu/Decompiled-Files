...
implements Marshaller<DecodeAuthorizationMessageRequest> {
    ...
    public DecodeAuthorizationMessageRequestMarshaller(AwsQueryProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public SdkHttpFullRequest marshall(DecodeAuthorizationMessageRequest decodeAuthorizationMessageRequest) {
        Validate.paramNotNull((Object)((Object)decodeAuthorizationMessageRequest), (String)"decodeAuthorizationMessageRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)decodeAuthorizationMessageRequest);
        }
        catch (Exception e) {
