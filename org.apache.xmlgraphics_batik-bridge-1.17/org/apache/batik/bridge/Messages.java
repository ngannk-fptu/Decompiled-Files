...
public class Messages {
    ...
    protected static LocalizableSupport localizableSupport = new LocalizableSupport("org.apache.batik.bridge.resources.Messages", Messages.class.getClassLoader());
    ...
    public static String getMessage(String key) throws MissingResourceException {
        return Messages.formatMessage(key, null);
    }
}
