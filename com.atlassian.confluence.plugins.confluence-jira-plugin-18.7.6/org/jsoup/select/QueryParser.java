...
public class QueryParser {
    ...
    private void contains(boolean own) {
        ...
        this.evals.add(own ? new Evaluator.ContainsOwnText(searchText) : new Evaluator.ContainsText(searchText));
    }
    ...
    private void containsWholeText(boolean own) {
        ...
        String searchText = TokenQueue.unescape(this.tq.chompBalanced('(', ')'));
        Validate.notEmpty(searchText, query + "(text) query must not be empty");
        this.evals.add(own ? new Evaluator.ContainsWholeOwnText(searchText) : new Evaluator.ContainsWholeText(searchText));
    }
    ...
    private void matches(boolean own) {
        ...
        this.evals.add(own ? new Evaluator.MatchesOwn(Pattern.compile(regex)) : new Evaluator.Matches(Pattern.compile(regex)));
    }
    ...
    private void matchesWholeText(boolean own) {
        ...
        String regex = this.tq.chompBalanced('(', ')');
        Validate.notEmpty(regex, query + "(regex) query must not be empty");
        this.evals.add(own ? new Evaluator.MatchesWholeOwnText(Pattern.compile(regex)) : new Evaluator.MatchesWholeText(Pattern.compile(regex)));
    }
