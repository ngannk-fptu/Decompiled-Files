...
class TIFFFaxDecoder {
    ...
    private int nextNBits(int bitsToGet) {
        ...
        ++this.bytePointer;
        int i1 = (var2_4 & table1[bitsLeft]) << bitsToGet - bitsLeft;
        int i2 = (var3_5 & table2[bitsFromNextByte]) >>> 8 - bitsFromNextByte;
        int i3 = 0;
        if (bitsFromNext2NextByte != 0) {
            void var4_6;
            i2 <<= bitsFromNext2NextByte;
            i3 = (var4_6 & table2[bitsFromNext2NextByte]) >>> 8 - bitsFromNext2NextByte;
            i2 |= i3;
            ++this.bytePointer;
    ...
    private int nextLesserThan8Bits(int bitsToGet) {
        ...
        if (shift >= 0) {
            i1 = (var2_4 & table1[bitsLeft]) >>> shift;
