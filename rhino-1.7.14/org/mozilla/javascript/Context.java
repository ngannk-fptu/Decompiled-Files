...
implements Closeable {
    ...
    public static Object call(ContextFactory factory, Callable callable, Scriptable scope, Scriptable thisObj, Object[] args) {
        ...
        return Context.call(factory, cx -> callable.call(cx, scope, thisObj, args));
    }
    ...
    static EvaluatorException reportRuntimeError0(String messageId) {
        String msg = ScriptRuntime.getMessageById(messageId, new Object[0]);
        return Context.reportRuntimeError(msg);
    }
    ...
    public static Object javaToJS(Object value, Scriptable scope) {
        return Context.javaToJS(value, scope, null);
    }
    ...
    public void processMicrotasks() {
        Runnable head;
        do {
            if ((head = this.microtasks.poll()) == null) continue;
            head.run();
        } while (head != null);
    }
    ...
    protected Object compileImpl(Scriptable scope, String sourceString, String sourceName, int lineno, Object securityDomain, boolean returnFunction, Evaluator compiler, ErrorReporter compilationErrorReporter) throws IOException {
        Object bytecode;
        if (sourceName == null) {
    ...
    private ScriptNode parse(String sourceString, String sourceName, int lineno, CompilerEnvirons compilerEnv, ErrorReporter compilationErrorReporter, boolean returnFunction) throws IOException {
        ...
        if (returnFunction && (ast.getFirstChild() == null || ast.getFirstChild().getType() != 113)) {
