...
extends IdScriptableObject {
    ...
    Scriptable compile(Context cx, Scriptable scope, Object[] args) {
        if (args.length > 0 && args[0] instanceof NativeRegExp) {
            ...
            this.re = thatObj.re;
            this.setLastIndex(thatObj.lastIndex);
            return this;
        }
            ...
            block0 : switch (gData.regexp.source[src]) {
                case '\\': {
                    ...
                    switch (c) {
                        ...
                        case 'd': {
                            if (inRange) {
                                NativeRegExp.addCharacterToCharSet(charSet, '-');
                                inRange = false;
                            }
...
lbl48:
    ...
    public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
        ...
        switch (id) {
            ...
            case 8: {
                Scriptable scriptable = (Scriptable)NativeRegExp.realThis(thisObj, f).execSub(cx, scope, args, 1);
                return scriptable == null ? Integer.valueOf(-1) : scriptable.get("index", scriptable);
            }
        }
        throw new IllegalArgumentException(String.valueOf(id));
    }
