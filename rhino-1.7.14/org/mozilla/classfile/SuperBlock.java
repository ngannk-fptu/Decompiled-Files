...
final class SuperBlock {
    ...
    boolean merge(int[] locals, int localsTop, int[] stack, int stackTop, ConstantPool pool) {
        ...
        if (this.locals.length == localsTop && this.stack.length == stackTop) {
            boolean localsChanged = SuperBlock.mergeState(this.locals, locals, localsTop, pool);
            boolean stackChanged = SuperBlock.mergeState(this.stack, stack, stackTop, pool);
