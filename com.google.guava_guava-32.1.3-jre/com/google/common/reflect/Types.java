...
final class Types {
    ...
    Serializable {
        ...
        public String toString() {
            ...
            return builder.append(this.rawType.getName()).append('<').append(COMMA_JOINER.join(Iterables.transform(this.argumentsList, JavaVersion.CURRENT::typeName))).append('>').toString();
        }
    ...
    private static enum ClassOwnership {
        ...
        private static ClassOwnership detectJvmBehavior() {
            ...
            ParameterizedType parameterizedType = Objects.requireNonNull((ParameterizedType)subclass.getGenericSuperclass());
