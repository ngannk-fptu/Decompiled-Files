...
public final class MediaType {
    ...
    public static final MediaType JWT = MediaType.createConstant("application", "jwt");
    ...
    static MediaType createFontType(String subtype) {
        return MediaType.create(FONT_TYPE, subtype);
    }
    ...
    public static MediaType parse(String input) {
        ...
        try {
            ...
            MediaType.consumeSeparator(tokenizer, '/');
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            builder.append("; ");
            ListMultimap quotedParameters = Multimaps.transformValues(this.parameters, value -> TOKEN_MATCHER.matchesAllOf((CharSequence)value) && !value.isEmpty() ? value : MediaType.escapeAndQuote(value));
