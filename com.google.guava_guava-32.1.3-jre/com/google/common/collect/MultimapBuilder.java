...
public abstract class MultimapBuilder<K0, V0> {
    ...
    public static abstract class MultimapBuilderWithKeys<K0> {
        ...
        public ListMultimapBuilder<K0, @Nullable Object> arrayListValues(final int expectedValuesPerKey) {
        ...
        public SetMultimapBuilder<K0, @Nullable Object> linkedHashSetValues(final int expectedValuesPerKey) {
            CollectPreconditions.checkNonnegative(expectedValuesPerKey, "expectedValuesPerKey");
            return new SetMultimapBuilder<K0, Object>(){
