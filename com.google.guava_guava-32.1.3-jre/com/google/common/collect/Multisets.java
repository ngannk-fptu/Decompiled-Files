...
public final class Multisets {
    ...
    public static <E> Multiset<E> filter(Multiset<E> unfiltered, com.google.common.base.Predicate<? super E> predicate) {
                ...
                return new AbstractIterator<E>(){
                    ...
                    protected E computeNext() {
                        while (iterator1.hasNext()) {
                            Multiset.Entry entry1 = (Multiset.Entry)iterator1.next();
                            Object element = entry1.getElement();
                            if (entry1.getCount() <= multiset2.count(element)) continue;
                            return element;
                        }
    ...
    extends Sets.ImprovedAbstractSet<Multiset.Entry<E>> {
        ...
        public boolean remove(@CheckForNull Object object) {
            if (object instanceof Multiset.Entry) {
                ...
                if (entryCount != 0) {
                    Multiset<@Nullable E> multiset = this.multiset();
    ...
    extends ViewMultiset<E> {
        ...
        FilteredMultiset(Multiset<E> unfiltered, com.google.common.base.Predicate<? super E> predicate) {
        ...
        Set<Multiset.Entry<E>> createEntrySet() {
            return Sets.filter(this.unfiltered.entrySet(), new com.google.common.base.Predicate<Multiset.Entry<E>>(){
