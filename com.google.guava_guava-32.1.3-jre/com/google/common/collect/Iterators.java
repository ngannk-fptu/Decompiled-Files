...
public final class Iterators {
    ...
    public static boolean elementsEqual(Iterator<?> iterator1, Iterator<?> iterator2) {
        while (iterator1.hasNext()) {
            ...
            if (com.google.common.base.Objects.equal(o1, o2 = iterator2.next())) continue;
            return false;
        }
    ...
    private static <T> UnmodifiableIterator<List<@Nullable T>> partitionImpl(final Iterator<T> iterator, final int size, final boolean pad) {
        Preconditions.checkNotNull(iterator);
        ...
        return new UnmodifiableIterator<List<T>>(){
            ...
            public List<@Nullable T> next() {
                ...
                List<@Nullable Object> list = Collections.unmodifiableList(Arrays.asList(array));
                if (pad || count == size) {
                    return list;
                }
    ...
    public static <T> UnmodifiableIterator<T> singletonIterator(final @ParametricNullness T value) {
        return new UnmodifiableIterator<T>(){
            boolean done;
