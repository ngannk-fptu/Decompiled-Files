...
public class ExpressionState {
    ...
    public Object convertValue(Object value, TypeDescriptor targetTypeDescriptor) throws EvaluationException {
        Object result = this.relatedContext.getTypeConverter().convertValue(value, TypeDescriptor.forObject((Object)value), targetTypeDescriptor);
        if (result == null) {
    ...
    public Object convertValue(TypedValue value, TypeDescriptor targetTypeDescriptor) throws EvaluationException {
        ...
        return this.relatedContext.getTypeConverter().convertValue(val, TypeDescriptor.forObject((Object)val), targetTypeDescriptor);
    }
