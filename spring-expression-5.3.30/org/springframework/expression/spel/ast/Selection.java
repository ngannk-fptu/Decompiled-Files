...
extends SpelNodeImpl {
    ...
    protected ValueRef getValueRef(ExpressionState state) throws EvaluationException {
        ...
        if (operand instanceof Iterable || ObjectUtils.isArray((Object)operand)) {
            TypeDescriptor elementTypeDesc;
            List<Object> data = operand instanceof Iterable ? (List<Object>)operand : Arrays.asList(ObjectUtils.toObjectArray((Object)operand));
            ...
            if (typeDescriptor != null && (elementTypeDesc = typeDescriptor.getElementTypeDescriptor()) != null) {
                elementType = ClassUtils.resolvePrimitiveIfNecessary((Class)elementTypeDesc.getType());
            }
            Assert.state((elementType != null ? 1 : 0) != 0, (String)"Unresolvable element type");
