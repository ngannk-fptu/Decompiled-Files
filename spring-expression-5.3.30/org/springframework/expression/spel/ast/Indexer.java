...
extends SpelNodeImpl {
    ...
    implements ValueRef {
        ...
        public void setValue(@Nullable Object newValue) {
            ...
            if (this.collection instanceof List) {
                ...
                if (this.collectionEntryDescriptor.getElementTypeDescriptor() != null) {
                    newValue = this.typeConverter.convertValue(newValue, TypeDescriptor.forObject((Object)newValue), this.collectionEntryDescriptor.getElementTypeDescriptor());
                }
            } else {
        ...
        private Constructor<?> getDefaultConstructor(Class<?> type) {
            try {
                return ReflectionUtils.accessibleConstructor(type, (Class[])new Class[0]);
            }
            catch (Throwable ex) {
                return null;
            }
        ...
        public void setValue(@Nullable Object newValue) {
            ...
            try {
                if (Indexer.this.cachedWriteName != null && Indexer.this.cachedWriteName.equals(this.name) && Indexer.this.cachedWriteTargetType != null && Indexer.this.cachedWriteTargetType.equals(contextObjectClass)) {
                    ...
                    Assert.state((accessor != null ? 1 : 0) != 0, (String)"No cached write accessor");
    ...
    implements ValueRef {
        ...
        public void setValue(@Nullable Object newValue) {
            ...
            Assert.state((elementType != null ? 1 : 0) != 0, (String)"No element type");
