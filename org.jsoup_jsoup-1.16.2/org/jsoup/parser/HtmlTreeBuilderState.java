    ...
    InBody{
        ...
        private boolean inBodyStartTag(Token t, HtmlTreeBuilder tb) {
            ...
            switch (name = startTag.normalName()) {
                ...
                case "math": {
                    tb.reconstructFormattingElements();
                    tb.insertForeign(startTag, "http://www.w3.org/1998/Math/MathML");
                    break;
                }
                case "svg": {
                    tb.reconstructFormattingElements();
                    tb.insertForeign(startTag, "http://www.w3.org/2000/svg");
                    break;
                }
                case "h1": 
                case "h2": 
        ...
        boolean process(Token t, HtmlTreeBuilder tb) {
            switch (t.type) {
                ...
                case EndTag: {
                    ...
                    if (!(el = stack.get(i = stack.size() - 1)).normalName().equals(end.normalName)) {
                        tb.error(this);
                    }
                    while (i != 0) {
