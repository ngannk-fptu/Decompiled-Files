...
import com.atlassian.lucene36.search.PhraseQueue;
import com.atlassian.lucene36.search.PhraseScorer;
...
extends PhraseScorer {
    ...
    SloppyPhraseScorer(Weight weight, PhraseQuery.PostingsAndFreq[] postings, Similarity similarity, int slop, byte[] norms) throws IOException {
