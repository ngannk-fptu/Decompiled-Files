...
public final class IndexableBinaryStringTools {
    ...
    public static int getEncodedLength(ByteBuffer original) throws IllegalArgumentException {
        if (original.hasArray()) {
            return IndexableBinaryStringTools.getEncodedLength(original.array(), original.arrayOffset(), original.limit() - original.arrayOffset());
        }
    ...
    public static int getDecodedLength(CharBuffer encoded) throws IllegalArgumentException {
        if (encoded.hasArray()) {
            return IndexableBinaryStringTools.getDecodedLength(encoded.array(), encoded.arrayOffset(), encoded.limit() - encoded.arrayOffset());
        }
    ...
    public static void encode(ByteBuffer input, CharBuffer output) {
        ...
        int outputLength = IndexableBinaryStringTools.getEncodedLength(input.array(), inputOffset, inputLength);
        output.limit(outputLength + outputOffset);
        output.position(0);
        IndexableBinaryStringTools.encode(input.array(), inputOffset, inputLength, output.array(), outputOffset, outputLength);
    }
    ...
    public static void decode(CharBuffer input, ByteBuffer output) {
        ...
        int inputLength = input.limit() - inputOffset;
        int outputOffset = output.arrayOffset();
        int outputLength = IndexableBinaryStringTools.getDecodedLength(input.array(), inputOffset, inputLength);
        output.limit(outputLength + outputOffset);
        output.position(0);
        IndexableBinaryStringTools.decode(input.array(), inputOffset, inputLength, output.array(), outputOffset, outputLength);
    }
