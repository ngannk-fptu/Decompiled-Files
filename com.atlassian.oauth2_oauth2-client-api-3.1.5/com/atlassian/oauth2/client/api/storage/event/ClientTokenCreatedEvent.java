...
@EventName(value="plugins.oauth2.client.token.created")
public class ClientTokenCreatedEvent
implements ClientTokenEvent {
    private final String clientTokenId;

    public ClientTokenCreatedEvent(String clientTokenId) {
    ...
    public boolean equals(Object o) {
        ...
        ClientTokenCreatedEvent that = (ClientTokenCreatedEvent)o;
