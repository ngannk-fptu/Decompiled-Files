...
@EventName(value="plugins.oauth2.client.token.recoverable")
public class ClientTokenRecoverableEvent
implements ClientTokenEvent {
    private final String clientTokenId;

    public ClientTokenRecoverableEvent(String clientTokenId) {
    ...
    public boolean equals(Object o) {
        ...
        ClientTokenRecoverableEvent that = (ClientTokenRecoverableEvent)o;
