...
@EventName(value="plugins.oauth2.client.token.updated")
public class ClientTokenUpdatedEvent
implements ClientTokenEvent {
    private final String clientTokenId;

    public ClientTokenUpdatedEvent(String clientTokenId) {
    ...
    public boolean equals(Object o) {
        ...
        ClientTokenUpdatedEvent that = (ClientTokenUpdatedEvent)o;
