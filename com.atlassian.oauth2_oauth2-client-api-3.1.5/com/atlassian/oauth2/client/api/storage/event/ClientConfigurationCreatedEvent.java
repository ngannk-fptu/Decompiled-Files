...
@EventName(value="plugins.oauth2.client.configuration.created")
public class ClientConfigurationCreatedEvent {
    private final String clientConfigurationId;

    public ClientConfigurationCreatedEvent(String clientConfigurationId) {
    ...
    public boolean equals(Object o) {
        ...
        ClientConfigurationCreatedEvent that = (ClientConfigurationCreatedEvent)o;
