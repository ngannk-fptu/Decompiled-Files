...
@EventName(value="plugins.oauth2.client.configuration.updated")
public class ClientConfigurationUpdatedEvent {
    private final String clientConfigurationId;

    public ClientConfigurationUpdatedEvent(String clientConfigurationId) {
    ...
    public boolean equals(Object o) {
        ...
        ClientConfigurationUpdatedEvent that = (ClientConfigurationUpdatedEvent)o;
