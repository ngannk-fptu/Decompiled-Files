...
extends NumberFormat {
    ...
    public RuleBasedNumberFormat(ULocale locale, int format) {
        ...
        this.locale = locale;
        ICUResourceBundle bundle = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt63b/rbnf", locale);
    ...
    private void initCapitalizationContextInfo(ULocale theLocale) {
        ICUResourceBundle rb = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt63b", theLocale);
        try {
