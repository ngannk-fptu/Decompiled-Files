...
public interface UProperty {
    ...
    public static final int INDIC_POSITIONAL_CATEGORY = 4118;
    public static final int INDIC_SYLLABIC_CATEGORY = 4119;
    public static final int VERTICAL_ORIENTATION = 4120;
    @Deprecated
    public static final int INT_LIMIT = 4121;
    ...
    public static final int BIDI_PAIRED_BRACKET = 16397;
    @Deprecated
    public static final int STRING_LIMIT = 16398;
