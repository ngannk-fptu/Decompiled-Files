...
implements Modifier {
    ...
    public ConstantMultiFieldModifier(NumberStringBuilder prefix, NumberStringBuilder suffix, boolean overwrite, boolean strong, Modifier.Parameters parameters) {
