...
public class LocaleIDs {
    ...
    public static String getISO3Country(String country) {
        int offset = LocaleIDs.findIndex(_countries, country);
        if (offset >= 0) {
            return _countries3[offset];
        }
        offset = LocaleIDs.findIndex(_obsoleteCountries, country);
        if (offset >= 0) {
    ...
    public static String getISO3Language(String language) {
        int offset = LocaleIDs.findIndex(_languages, language);
        if (offset >= 0) {
            return _languages3[offset];
        }
        offset = LocaleIDs.findIndex(_obsoleteLanguages, language);
        if (offset >= 0) {
    ...
    public static String threeToTwoLetterLanguage(String lang) {
        int offset = LocaleIDs.findIndex(_languages3, lang);
        if (offset >= 0) {
            return _languages[offset];
        }
        offset = LocaleIDs.findIndex(_obsoleteLanguages3, lang);
        if (offset >= 0) {
    ...
    public static String threeToTwoLetterRegion(String region) {
        int offset = LocaleIDs.findIndex(_countries3, region);
        if (offset >= 0) {
            return _countries[offset];
        }
        offset = LocaleIDs.findIndex(_obsoleteCountries3, region);
        if (offset >= 0) {
    ...
    public static String getCurrentCountryID(String oldID) {
        int offset = LocaleIDs.findIndex(_deprecatedCountries, oldID);
        if (offset >= 0) {
    ...
    public static String getCurrentLanguageID(String oldID) {
        int offset = LocaleIDs.findIndex(_obsoleteLanguages, oldID);
        if (offset >= 0) {
