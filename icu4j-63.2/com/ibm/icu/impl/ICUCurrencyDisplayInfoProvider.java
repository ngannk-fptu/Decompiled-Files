...
implements CurrencyData.CurrencyDisplayInfoProvider {
    ...
    public CurrencyData.CurrencyDisplayInfo getInstance(ULocale locale, boolean withFallback) {
        ...
        if ((instance = this.currencyDisplayInfoCache) == null || !instance.locale.equals(locale) || instance.fallback != withFallback) {
            ...
            if (withFallback) {
                rb = ICUResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt63b/curr", locale, ICUResourceBundle.OpenType.LOCALE_DEFAULT_ROOT);
            } else {
                try {
                    rb = ICUResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt63b/curr", locale, ICUResourceBundle.OpenType.LOCALE_ONLY);
                }
