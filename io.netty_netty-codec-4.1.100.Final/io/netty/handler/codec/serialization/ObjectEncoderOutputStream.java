...
implements ObjectOutput {
    ...
    public ObjectEncoderOutputStream(OutputStream out, int estimatedLength) {
        ...
        ObjectUtil.checkPositiveOrZero((int)estimatedLength, (String)"estimatedLength");
    ...
    public void writeObject(Object obj) throws IOException {
        ...
        try {
            CompactObjectOutputStream oout = new CompactObjectOutputStream((OutputStream)new ByteBufOutputStream(buf));
            try {
