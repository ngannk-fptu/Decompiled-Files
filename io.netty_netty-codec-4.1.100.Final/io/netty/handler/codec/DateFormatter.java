...
public final class DateFormatter {
    ...
    public static Date parseHttpDate(CharSequence txt, int start, int end) {
        ...
        return DateFormatter.formatter().parse0((CharSequence)ObjectUtil.checkNotNull((Object)txt, (String)"txt"), start, end);
    }

    public static String format(Date date) {
        return DateFormatter.formatter().format0((Date)ObjectUtil.checkNotNull((Object)date, (String)"date"));
    }

    public static StringBuilder append(Date date, StringBuilder sb) {
        return DateFormatter.formatter().append0((Date)ObjectUtil.checkNotNull((Object)date, (String)"date"), (StringBuilder)ObjectUtil.checkNotNull((Object)sb, (String)"sb"));
    }
    ...
    private boolean tryParseMonth(CharSequence txt, int tokenStart, int tokenEnd) {
        ...
        char monthChar3 = AsciiString.toLowerCase((char)txt.charAt(tokenStart + 2));
