...
extends ZlibEncoder {
    ...
    public void close(final ChannelHandlerContext ctx, final ChannelPromise promise) {
        ...
        if (!f.isDone()) {
            ...
            f.addListener((GenericFutureListener)new ChannelFutureListener((Future)future, promise, ctx){
    ...
    private ChannelFuture finishEncode(ChannelHandlerContext ctx, ChannelPromise promise) {
        ...
        try {
            ...
            footer = this.z.next_out_index != 0 ? Unpooled.wrappedBuffer((byte[])out, (int)0, (int)this.z.next_out_index) : Unpooled.EMPTY_BUFFER;
        }
        finally {
            this.z.deflateEnd();
            this.z.next_in = null;
