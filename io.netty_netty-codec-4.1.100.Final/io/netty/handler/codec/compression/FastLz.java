...
final class FastLz {
    ...
    static int compress(ByteBuf input, int inOffset, int inLength, ByteBuf output, int outOffset, int proposedLevel) {
        ...
        if (inLength < 4) {
            if (inLength != 0) {
                output.setByte(outOffset + op++, (int)((byte)(inLength - 1)));
                ++ipBound;
                while (ip <= ipBound) {
        ...
        while (ip < ipLimit) {
            ...
            if (level == 2) {
                if (distance < 8191L) {
                    if (len < 7) {
                        output.setByte(outOffset + op++, (int)((byte)((long)(len << 5) + (distance >>> 8))));
                        ...
                        output.setByte(outOffset + op++, (int)((byte)len));
                        output.setByte(outOffset + op++, (int)((byte)(distance & 0xFFL)));
                    }
                } else if (len < 7) {
                    output.setByte(outOffset + op++, (int)((byte)((len << 5) + 31)));
                    output.setByte(outOffset + op++, -1);
                ...
                if (len < 7) {
                    ...
                    output.setByte(outOffset + op++, (int)((byte)(224L + (distance >>> 8))));
                    output.setByte(outOffset + op++, (int)((byte)(len - 7)));
                    output.setByte(outOffset + op++, (int)((byte)(distance & 0xFFL)));
                }
            }
        ...
        do {
            ...
            if (ctrl >= 32L) {
                ...
                if (ref == op) {
                    ...
                    int n = op++;
                    int n2 = --ref;
                    output.setByte(outOffset + n, (int)output.getByte(outOffset + n2));
                    int n3 = op++;
                    int n4 = ++ref;
                    output.setByte(outOffset + n3, (int)output.getByte(outOffset + n4));
                    int n5 = op++;
                    int n6 = ++ref;
                    ++ref;
                    output.setByte(outOffset + n5, (int)output.getByte(outOffset + n6));
                    while (len != 0L) {
                        output.setByte(outOffset + op++, (int)output.getByte(outOffset + ref++));
                        --len;
                    }
                }
            } else {
