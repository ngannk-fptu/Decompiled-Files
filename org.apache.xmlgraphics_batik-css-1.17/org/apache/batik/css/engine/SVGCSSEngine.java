...
extends CSSEngine {
    ...
    public static final ShorthandManager[] SVG_SHORTHAND_MANAGERS = new ShorthandManager[]{new FontShorthandManager(), new MarkerShorthandManager()};
    ...
    public SVGCSSEngine(Document doc, ParsedURL uri, ExtendedParser p, CSSContext ctx) {
        super(doc, uri, p, SVG_VALUE_MANAGERS, SVG_SHORTHAND_MANAGERS, null, null, "style", null, "class", true, null, ctx);
    ...
    public SVGCSSEngine(Document doc, ParsedURL uri, ExtendedParser p, ValueManager[] vms, ShorthandManager[] sms, CSSContext ctx) {
        super(doc, uri, p, SVGCSSEngine.mergeArrays(SVG_VALUE_MANAGERS, vms), SVGCSSEngine.mergeArrays(SVG_SHORTHAND_MANAGERS, sms), null, null, "style", null, "class", true, null, ctx);
        this.lineHeightIndex = this.fontSizeIndex;
    }
    ...
    protected SVGCSSEngine(Document doc, ParsedURL uri, ExtendedParser p, ValueManager[] vms, ShorthandManager[] sms, String[] pe, String sns, String sln, String cns, String cln, boolean hints, String hintsNS, CSSContext ctx) {
        super(doc, uri, p, SVGCSSEngine.mergeArrays(SVG_VALUE_MANAGERS, vms), SVGCSSEngine.mergeArrays(SVG_SHORTHAND_MANAGERS, sms), pe, sns, sln, cns, cln, hints, hintsNS, ctx);
        this.lineHeightIndex = this.fontSizeIndex;
    }
