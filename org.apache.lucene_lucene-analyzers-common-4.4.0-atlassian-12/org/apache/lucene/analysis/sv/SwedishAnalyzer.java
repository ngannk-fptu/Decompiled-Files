...
extends StopwordAnalyzerBase {
    ...
    protected Analyzer.TokenStreamComponents createComponents(String fieldName, Reader reader) {
        ...
        result = new SnowballFilter((TokenStream)result, new SwedishStemmer());
    ...
    private static class DefaultSetHolder {
        ...
        static {
            try {
                DEFAULT_STOP_SET = WordlistLoader.getSnowballWordSet(IOUtils.getDecodingReader(SnowballFilter.class, (String)SwedishAnalyzer.DEFAULT_STOPWORD_FILE, (Charset)IOUtils.CHARSET_UTF_8), Version.LUCENE_CURRENT);
            }
