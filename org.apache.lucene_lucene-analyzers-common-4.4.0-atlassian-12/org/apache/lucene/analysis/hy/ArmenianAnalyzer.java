...
extends StopwordAnalyzerBase {
    ...
    protected Analyzer.TokenStreamComponents createComponents(String fieldName, Reader reader) {
        ...
        result = new SnowballFilter((TokenStream)result, new ArmenianStemmer());
    ...
    private static class DefaultSetHolder {
        ...
        static {
            try {
                DEFAULT_STOP_SET = ArmenianAnalyzer.loadStopwordSet(false, ArmenianAnalyzer.class, ArmenianAnalyzer.DEFAULT_STOPWORD_FILE, "#");
            }
