...
extends StopwordAnalyzerBase {
    ...
    protected Analyzer.TokenStreamComponents createComponents(String fieldName, Reader reader) {
        ...
        result = this.matchVersion.onOrAfter(Version.LUCENE_36) ? new SpanishLightStemFilter((TokenStream)result) : new SnowballFilter((TokenStream)result, new SpanishStemmer());
    ...
    private static class DefaultSetHolder {
        ...
        static {
            try {
                DEFAULT_STOP_SET = WordlistLoader.getSnowballWordSet(IOUtils.getDecodingReader(SnowballFilter.class, (String)SpanishAnalyzer.DEFAULT_STOPWORD_FILE, (Charset)IOUtils.CHARSET_UTF_8), Version.LUCENE_CURRENT);
            }
