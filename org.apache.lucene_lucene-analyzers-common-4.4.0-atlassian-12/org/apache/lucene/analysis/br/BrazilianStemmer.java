...
public class BrazilianStemmer {
    ...
    private String changeTerm(String value) {
        ...
        for (int j = 0; j < value.length(); ++j) {
            r = value.charAt(j) == '\u00e1' || value.charAt(j) == '\u00e2' || value.charAt(j) == '\u00e3' ? r + "a" : (value.charAt(j) == '\u00e9' || value.charAt(j) == '\u00ea' ? r + "e" : (value.charAt(j) == '\u00ed' ? r + "i" : (value.charAt(j) == '\u00f3' || value.charAt(j) == '\u00f4' || value.charAt(j) == '\u00f5' ? r + "o" : (value.charAt(j) == '\u00fa' || value.charAt(j) == '\u00fc' ? r + "u" : (value.charAt(j) == '\u00e7' ? r + "c" : (value.charAt(j) == '\u00f1' ? r + "n" : r + value.charAt(j)))))));
        }
        return r;
    }
    ...
    private String removeSuffix(String value, String toRemove) {
        if (value == null || toRemove == null || !this.suffix(value, toRemove)) {
            return value;
        }
    ...
    private boolean suffixPreceded(String value, String suffix, String preceded) {
        if (value == null || suffix == null || preceded == null || !this.suffix(value, suffix)) {
            return false;
        }
