...
public final class FinnishAnalyzer
extends StopwordAnalyzerBase {
    ...
    protected Analyzer.TokenStreamComponents createComponents(String fieldName, Reader reader) {
        ...
        result = new SnowballFilter((TokenStream)result, new FinnishStemmer());
    ...
    private static class DefaultSetHolder {
        ...
        static {
            try {
                DEFAULT_STOP_SET = WordlistLoader.getSnowballWordSet(IOUtils.getDecodingReader(SnowballFilter.class, (String)FinnishAnalyzer.DEFAULT_STOPWORD_FILE, (Charset)IOUtils.CHARSET_UTF_8), Version.LUCENE_CURRENT);
            }
