...
public class DialectHelper {
    ...
    public static Pair<SQLTemplates.Builder, DialectProvider.SupportedDatabase> getSQLServerDBTemplate(@Nonnull DatabaseMetaData metaData) throws SQLException {
        ...
        if (currentSqlServerVersion >= 11) {
            return Pair.pair((Object)SQLServer2012Templates.builder().printSchema(), (Object)((Object)DialectProvider.SupportedDatabase.SQLSERVER));
        }
        if (currentSqlServerVersion >= 10) {
            return Pair.pair((Object)SQLServer2008Templates.builder().printSchema(), (Object)((Object)DialectProvider.SupportedDatabase.SQLSERVER));
        }
        if (currentSqlServerVersion >= 9) {
            return Pair.pair((Object)SQLServer2005Templates.builder().printSchema(), (Object)((Object)DialectProvider.SupportedDatabase.SQLSERVER));
        }
        return Pair.pair((Object)SQLServerTemplates.builder().printSchema(), (Object)((Object)DialectProvider.SupportedDatabase.SQLSERVER));
    }
}
