...
implements SchemaProvider {
    ...
    public Optional<String> getTableName(Connection connection, String logicalTableName) {
        Preconditions.checkArgument((!StringUtils.isEmpty((String)logicalTableName) ? 1 : 0) != 0, (Object)"Table name is required");
    ...
    public Optional<String> getColumnName(Connection connection, String logicalTableName, String logicalColumnName) {
        Preconditions.checkArgument((!StringUtils.isEmpty((String)logicalTableName) ? 1 : 0) != 0, (Object)"Table name is required");
        Preconditions.checkArgument((!StringUtils.isEmpty((String)logicalColumnName) ? 1 : 0) != 0, (Object)"Column name is required");
