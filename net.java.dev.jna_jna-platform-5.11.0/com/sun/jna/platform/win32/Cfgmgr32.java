...
extends Library {
    public static final Cfgmgr32 INSTANCE = (Cfgmgr32)Native.load((String)"Cfgmgr32", Cfgmgr32.class, (Map)W32APIOptions.DEFAULT_OPTIONS);
    ...
    public int CM_Get_DevNode_Registry_Property(int var1, int var2, IntByReference var3, Pointer var4, IntByReference var5, int var6);
}
