...
public interface WinRas {
    ...
    @Structure.FieldOrder(value={"addr"})
    ...
    @Structure.FieldOrder(value={"dwSize", "rasconnstate", "dwError", "szDeviceType", "szDeviceName", "szPhoneNumber", "localEndPoint", "remoteEndPoint", "rasconnsubstate"})
    ...
    @Structure.FieldOrder(value={"dwSize", "dwError", "szIpAddress", "szServerIpAddress", "dwOptions", "dwServerOptions"})
    ...
    @Structure.FieldOrder(value={"dwSize", "dwBytesXmited", "dwBytesRcved", "dwFramesXmited", "dwFramesRcved", "dwCrcErr", "dwTimeoutErr", "dwAlignmentErr", "dwHardwareOverrunErr", "dwFramingErr", "dwBufferOverrunErr", "dwCompressionRatioIn", "dwCompressionRatioOut", "dwBps", "dwConnectDuration"})
    ...
    @Structure.FieldOrder(value={"dwSize", "hrasconn", "szEntryName", "szDeviceType", "szDeviceName", "szPhonebook", "dwSubEntry", "guidEntry", "dwFlags", "luid", "guidCorrelationId"})
    ...
    @Structure.FieldOrder(value={"dwSize", "szEntryName", "szPhoneNumber", "szCallbackNumber", "szUserName", "szPassword", "szDomain"})
    ...
    @Structure.FieldOrder(value={"dwSize", "pbDevSpecificInfo"})
    ...
    extends Structure {
        ...
        public RASDEVSPECIFICINFO(byte[] data) {
            ...
            this.pbDevSpecificInfo.write(0L, data, 0, data.length);
    ...
    @Structure.FieldOrder(value={"dwSizeofEapInfo", "pbEapInfo"})
    ...
    extends Structure {
        ...
        public RASEAPINFO(byte[] data) {
            ...
            this.pbEapInfo.write(0L, data, 0, data.length);
