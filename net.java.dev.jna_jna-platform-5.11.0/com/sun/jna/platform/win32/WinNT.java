...
BaseTSD {
    ...
    public static final int MAXSHORT = Short.MAX_VALUE;
    ...
    public static final int MUTANT_ALL_ACCESS = 0x1F0001;
    ...
    public static final int FILE_SUPPORTS_HARD_LINKS = 0x400000;
    public static final int FILE_SUPPORTS_EXTENDED_ATTRIBUTES = 0x800000;
    public static final int FILE_SUPPORTS_OPEN_BY_FILE_ID = 0x1000000;
    public static final int FILE_SUPPORTS_USN_JOURNAL = 0x2000000;
    ...
    public static final int REG_LEGAL_CHANGE_FILTER = 0x1000000F;
    ...
    public static final int PROCESS_ALL_ACCESS = 0x1F1FFB;
    ...
    public static final int MEM_IMAGE = 0x1000000;
    ...
    @Structure.FieldOrder(value={"ReadOperationCount", "WriteOperationCount", "OtherOperationCount", "ReadTransferCount", "WriteTransferCount", "OtherTransferCount"})
    ...
    public static final class LocaleMacros {
        ...
        public static final WinDef.LCID MAKELCID(int lgid, int srtid) {
            return new WinDef.LCID(LocaleMacros._MAKELCID(lgid, srtid));
        }

        public static final WinDef.LCID MAKESORTLCID(int lgid, int srtid, int ver) {
            return new WinDef.LCID(LocaleMacros._MAKELCID(lgid, srtid) | ver << 20);
        }
    ...
    @Structure.FieldOrder(value={"Length", "ImpersonationLevel", "ContextTrackingMode", "EffectiveOnly"})
    ...
    @Structure.FieldOrder(value={"baseAddress", "allocationBase", "allocationProtect", "regionSize", "state", "protect", "type"})
    ...
    @Structure.FieldOrder(value={"Enable", "Spare", "BatteryLevel", "PowerPolicy", "MinSystemState"})
    ...
    @Structure.FieldOrder(value={"Granularity", "Capacity"})
    ...
    @Structure.FieldOrder(value={"level", "associativity", "lineSize", "size", "type"})
    ...
    @Structure.FieldOrder(value={"mask", "group", "reserved"})
    ...
    @Structure.FieldOrder(value={"maximumGroupCount", "activeGroupCount", "reserved", "groupInfo"})
    ...
    @Structure.FieldOrder(value={"level", "associativity", "lineSize", "cacheSize", "type", "reserved", "groupMask"})
    ...
    @Structure.FieldOrder(value={"nodeNumber", "reserved", "groupCount", "groupMasks"})
    ...
    extends SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX {
        ...
        public void read() {
            ...
            int actualGroupCount = Math.max(1, this.groupCount);
        ...
        protected List<Field> getFieldList() {
            ...
            while (fieldIterator.hasNext()) {
                ...
                if (!"groupMask".equals(field.getName())) continue;
    ...
    @Structure.FieldOrder(value={"flags", "efficiencyClass", "reserved", "groupCount", "groupMask"})
    ...
    @Structure.FieldOrder(value={"relationship", "size"})
    ...
    @Structure.FieldOrder(value={"processorMask", "relationship", "payload"})
    ...
    extends Structure {
        ...
        @Structure.FieldOrder(value={"nodeNumber"})
    ...
    @Structure.FieldOrder(value={"genericRead", "genericWrite", "genericExecute", "genericAll"})
    ...
    @Structure.FieldOrder(value={"Mask", "SidStart"})
    ...
    extends ACE_HEADER {
        ...
        public void write() {
            ...
            int sizeOfSID = this.AceSize - super.fieldOffset("SidStart");
            if (this.psid != null) {
                byte[] psidWrite = this.psid.getBytes();
                assert (psidWrite.length <= sizeOfSID);
                this.getPointer().write((long)offsetOfSID, psidWrite, 0, sizeOfSID);
            }
        }
        ...
        public void read() {
            ...
            int offsetOfSID = super.fieldOffset("SidStart");
            int sizeOfSID = this.AceSize - super.fieldOffset("SidStart");
            this.psid = sizeOfSID > 0 ? new PSID(this.getPointer().getByteArray((long)offsetOfSID, sizeOfSID)) : new PSID();
        }
    }

    @Structure.FieldOrder(value={"AceType", "AceFlags", "AceSize"})
    ...
    @Structure.FieldOrder(value={"Revision", "Sbz1", "Control", "Owner", "Group", "Sacl", "Dacl"})
    ...
    public static class PACLByReference
    extends ByReference {
    ...
    @Structure.FieldOrder(value={"AclRevision", "Sbz1", "AclSize", "AceCount", "Sbz2"})
    ...
    extends Structure {
        ...
        public ACL(int size) {
            this.useMemory((Pointer)new Memory((long)size));
        }
    ...
    extends Structure {
        ...
        public SECURITY_DESCRIPTOR(byte[] data) {
            this.data = data;
            this.useMemory((Pointer)new Memory((long)data.length));
        }
    ...
    @Structure.FieldOrder(value={"Length", "Reserved", "RecordNumber", "TimeGenerated", "TimeWritten", "EventID", "EventType", "NumStrings", "EventCategory", "ReservedFlags", "ClosingRecordNumber", "StringOffset", "UserSidLength", "UserSidOffset", "DataLength", "DataOffset"})
    ...
    @Structure.FieldOrder(value={"dwOSVersionInfoSize", "dwMajorVersion", "dwMinorVersion", "dwBuildNumber", "dwPlatformId", "szCSDVersion", "wServicePackMajor", "wServicePackMinor", "wSuiteMask", "wProductType", "wReserved"})
    ...
    extends Structure {
        ...
        public OSVERSIONINFOEX() {
            ...
            this.dwOSVersionInfoSize = new WinDef.DWORD(this.size());
        }
        ...
        public String getServicePack() {
            return Native.toString((char[])this.szCSDVersion);
        }
    ...
    @Structure.FieldOrder(value={"dwOSVersionInfoSize", "dwMajorVersion", "dwMinorVersion", "dwBuildNumber", "dwPlatformId", "szCSDVersion"})
    ...
    @Structure.FieldOrder(value={"PrivilegeCount", "Privileges"})
    ...
    extends Structure {
        ...
        public TOKEN_PRIVILEGES(Pointer p) {
            ...
            this.PrivilegeCount = new WinDef.DWORD(count);
    ...
    @Structure.FieldOrder(value={"GroupCount", "Group0"})
    ...
    @Structure.FieldOrder(value={"User"})
    ...
    @Structure.FieldOrder(value={"sid"})
    ...
    @Structure.FieldOrder(value={"Owner"})
    ...
    @Structure.FieldOrder(value={"Luid", "Attributes"})
