...
extends WinDef {
    public static final WinDef.HWND HWND_BROADCAST = new WinDef.HWND(Pointer.createConstant((int)65535));
    ...
    public static final int WS_EX_COMPOSITED = 0x20000000;
    ...
    public static final int EWX_HYBRID_SHUTDOWN = 0x400000;
    ...
    @Structure.FieldOrder(value={"hDevice", "dwType"})
    public static class RAWINPUTDEVICELIST
    extends Structure {
        ...
        public String toString() {
            return "hDevice=" + (Object)((Object)this.hDevice) + ", dwType=" + this.dwType;
        }
    }

    public static interface MONITORENUMPROC
    extends StdCallLibrary.StdCallCallback {
        public int apply(HMONITOR var1, WinDef.HDC var2, WinDef.RECT var3, WinDef.LPARAM var4);
    }

    @Structure.FieldOrder(value={"cbSize", "rcMonitor", "rcWork", "dwFlags", "szDevice"})
    ...
    @Structure.FieldOrder(value={"cbSize", "rcMonitor", "rcWork", "dwFlags"})
    ...
    public static interface WindowProc
    extends StdCallLibrary.StdCallCallback {
        public WinDef.LRESULT callback(WinDef.HWND var1, int var2, WinDef.WPARAM var3, WinDef.LPARAM var4);
    }

    @Structure.FieldOrder(value={"cbSize", "style", "lpfnWndProc", "cbClsExtra", "cbWndExtra", "hInstance", "hIcon", "hCursor", "hbrBackground", "lpszMenuName", "lpszClassName", "hIconSm"})
    ...
    @Structure.FieldOrder(value={"cbSize", "dwTime"})
    ...
    @Structure.FieldOrder(value={"dx", "dy", "mouseData", "dwFlags", "time", "dwExtraInfo"})
    ...
    @Structure.FieldOrder(value={"wVk", "wScan", "dwFlags", "time", "dwExtraInfo"})
    ...
    @Structure.FieldOrder(value={"type", "input"})
    ...
    extends Structure {
        ...
        public static class INPUT_UNION
        extends Union {
    ...
    @Structure.FieldOrder(value={"uMsg", "wParamL", "wParamH"})
    ...
    @Structure.FieldOrder(value={"vkCode", "scanCode", "flags", "time", "dwExtraInfo"})
    ...
    @Structure.FieldOrder(value={"pt", "mouseData", "flags", "time", "dwExtraInfo"})
    public static class MSLLHOOKSTRUCT
    extends Structure {
    ...
    @Structure.FieldOrder(value={"lParam", "wParam", "message", "hwnd"})
    public static class CWPSTRUCT
    extends Structure {
    ...
    public static interface HOOKPROC
    extends StdCallLibrary.StdCallCallback {
    }
    ...
    @Structure.FieldOrder(value={"BlendOp", "BlendFlags", "SourceConstantAlpha", "AlphaFormat"})
    ...
    @Structure.FieldOrder(value={"cx", "cy"})
    ...
    public static interface WinEventProc
    extends Callback {
        public void callback(WinNT.HANDLE var1, WinDef.DWORD var2, WinDef.HWND var3, WinDef.LONG var4, WinDef.LONG var5, WinDef.DWORD var6, WinDef.DWORD var7);
    }

    public static interface LowLevelKeyboardProc
    extends HOOKPROC {
        public WinDef.LRESULT callback(int var1, WinDef.WPARAM var2, KBDLLHOOKSTRUCT var3);
    }

    public static interface LowLevelMouseProc
    extends HOOKPROC {
        public WinDef.LRESULT callback(int var1, WinDef.WPARAM var2, MSLLHOOKSTRUCT var3);
    }

    public static interface WNDENUMPROC
    extends StdCallLibrary.StdCallCallback {
        public boolean callback(WinDef.HWND var1, Pointer var2);
    }

    @Structure.FieldOrder(value={"cbSize", "hWnd", "dwFlags", "uCount", "dwTimeout"})
    ...
    @Structure.FieldOrder(value={"dwData", "cbData", "lpData"})
    ...
    @Structure.FieldOrder(value={"hWnd", "message", "wParam", "lParam", "time", "pt"})
    ...
    @Structure.FieldOrder(value={"length", "flags", "showCmd", "ptMinPosition", "ptMaxPosition", "rcNormalPosition"})
    ...
    @Structure.FieldOrder(value={"cbSize", "rcWindow", "rcClient", "dwStyle", "dwExStyle", "dwWindowStatus", "cxWindowBorders", "cyWindowBorders", "atomWindowType", "wCreatorVersion"})
    ...
    @Structure.FieldOrder(value={"cbSize", "flags", "hwndActive", "hwndFocus", "hwndCapture", "hwndMenuOwner", "hwndMoveSize", "hwndCaret", "rcCaret"})
    ...
    public static class HDEVNOTIFY
