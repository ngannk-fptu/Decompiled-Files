...
extends StdCallLibrary {
    ...
    @Structure.FieldOrder(value={"cbSize", "hWnd", "uCallbackMessage", "uEdge", "rc", "lParam"})
    ...
    @Structure.FieldOrder(value={"hwnd", "wFunc", "pFrom", "pTo", "fFlags", "fAnyOperationsAborted", "pNameMappings", "lpszProgressTitle"})
