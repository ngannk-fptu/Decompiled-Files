...
extends Library {
    public static final X11 INSTANCE = (X11)Native.load((String)"X11", X11.class);
    ...
    public boolean XQueryExtension(Display var1, String var2, IntByReference var3, IntByReference var4, IntByReference var5);
    ...
    public int XSetWMProtocols(Display var1, Window var2, Atom[] var3, int var4);

    public int XGetWMProtocols(Display var1, Window var2, PointerByReference var3, IntByReference var4);
    ...
    public boolean XGetEventData(Display var1, XGenericEventCookie var2);

    public void XFreeEventData(Display var1, XGenericEventCookie var2);
    ...
    public int XGrabKeyboard(Display var1, Window var2, int var3, int var4, int var5, NativeLong var6);

    public int XUngrabKeyboard(Display var1, NativeLong var2);

    public int XFetchName(Display var1, Window var2, PointerByReference var3);
    ...
    @Structure.FieldOrder(value={"key_click_percent", "bell_percent", "bell_pitch", "bell_duration", "led_mask", "global_auto_repeat", "auto_repeats"})
    ...
    @Structure.FieldOrder(value={"key_click_percent", "bell_percent", "bell_pitch", "bell_duration", "led", "led_mode", "key", "auto_repeat_mode"})
    ...
    @Structure.FieldOrder(value={"max_keypermod", "modifiermap"})
    ...
    public static class XGenericEventCookie
    extends Structure {
        public int type;
    ...
    public static class XGenericEvent
    extends Structure {
        public int type;
        public NativeLong serial;
        public int send_event;
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "key_vector"})
    ...
    @Structure.FieldOrder(value={"type", "display", "serial", "error_code", "request_code", "minor_code", "resourceid"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "colormap", "c_new", "state"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "requestor", "selection", "target", "property", "time"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "owner", "requestor", "selection", "target", "property", "time"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "selection", "time"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "atom", "time", "state"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "parent", "window", "place"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "event", "window", "place"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "parent", "window", "x", "y", "width", "height", "border_width", "above", "detail", "value_mask"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "width", "height"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "event", "window", "x", "y"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "event", "window", "x", "y", "width", "height", "border_width", "above", "override_redirect"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "event", "window", "parent", "x", "y", "override_redirect"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "parent", "window"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "event", "window", "override_redirect"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "event", "window", "from_configure"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "event", "window"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "parent", "window", "x", "y", "width", "height", "border_width", "override_redirect"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "state"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "drawable", "major_code", "minor_code"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "drawable", "x", "y", "width", "height", "count", "major_code", "minor_code"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "x", "y", "width", "height", "count"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "mode", "detail"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "mode", "detail", "same_screen", "focus", "state"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "state", "is_hint", "same_screen"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "message_type", "format", "data"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "state", "button", "same_screen"})
    ...
    @Structure.FieldOrder(value={"type", "serial", "send_event", "display", "window"})
    ...
    @Structure.FieldOrder(value={"function", "plane_mask", "foreground", "background", "line_width", "line_style", "cap_style", "join_style", "fill_style", "fill_rule", "arc_mode", "tile", "stipple", "ts_x_origin", "ts_y_origin", "font", "subwindow_mode", "graphics_exposures", "clip_x_origin", "clip_y_origin", "clip_mask", "dash_offset", "dashes"})
    ...
    @Structure.FieldOrder(value={"background_pixmap", "background_pixel", "border_pixmap", "border_pixel", "bit_gravity", "win_gravity", "backing_store", "backing_planes", "backing_pixel", "save_under", "event_mask", "do_not_propagate_mask", "override_redirect", "colormap", "cursor"})
    ...
    @Structure.FieldOrder(value={"x", "y", "width", "height", "border_width", "depth", "visual", "root", "c_class", "bit_gravity", "win_gravity", "backing_store", "backing_planes", "backing_pixel", "save_under", "colormap", "map_installed", "map_state", "all_event_masks", "your_event_mask", "do_not_propagate_mask", "override_redirect", "screen"})
    ...
    @Structure.FieldOrder(value={"flags", "x", "y", "width", "height", "min_width", "min_height", "max_width", "max_height", "width_inc", "height_inc", "min_aspect", "max_aspect", "base_width", "base_height", "win_gravity"})
    ...
    @Structure.FieldOrder(value={"value", "encoding", "format", "nitems"})
    ...
    @Structure.FieldOrder(value={"flags", "input", "initial_state", "icon_pixmap", "icon_window", "icon_x", "icon_y", "icon_mask", "window_group"})
    ...
    @Structure.FieldOrder(value={"device_id", "num_classes", "classes"})
    ...
    @Structure.FieldOrder(value={"input_class", "event_type_base"})
    ...
    extends Library {
        public static final XTest INSTANCE = (XTest)Native.load((String)"Xtst", XTest.class);
    ...
    extends Library {
        public static final Xevie INSTANCE = (Xevie)Native.load((String)"Xevie", Xevie.class);
    ...
    extends Library {
        public static final Xrender INSTANCE = (Xrender)Native.load((String)"Xrender", Xrender.class);
        ...
        @Structure.FieldOrder(value={"id", "type", "depth", "direct", "colormap"})
        ...
        @Structure.FieldOrder(value={"red", "redMask", "green", "greenMask", "blue", "blueMask", "alpha", "alphaMask"})
    ...
    extends Library {
        public static final Xext INSTANCE = (Xext)Native.load((String)"Xext", Xext.class);
    ...
    extends ByReference {
        ...
        public Atom getValue() {
            NativeLong value = this.getPointer().getNativeLong(0L);
            return (Atom)((Object)new Atom().fromNative(value, null));
        }
    }
