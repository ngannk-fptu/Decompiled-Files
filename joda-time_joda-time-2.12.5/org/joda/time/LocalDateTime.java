...
Serializable {
    ...
    public int hashCode() {
        int n = 157;
        n = 23 * n + this.iChronology.year().get(this.iLocalMillis);
        n = 23 * n + this.iChronology.year().getType().hashCode();
        n = 23 * n + this.iChronology.monthOfYear().get(this.iLocalMillis);
        n = 23 * n + this.iChronology.monthOfYear().getType().hashCode();
        n = 23 * n + this.iChronology.dayOfMonth().get(this.iLocalMillis);
        n = 23 * n + this.iChronology.dayOfMonth().getType().hashCode();
        n = 23 * n + this.iChronology.millisOfDay().get(this.iLocalMillis);
        n = 23 * n + this.iChronology.millisOfDay().getType().hashCode();
