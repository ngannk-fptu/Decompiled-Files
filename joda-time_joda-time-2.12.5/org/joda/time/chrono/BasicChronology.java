...
extends AssembledChronology {
    ...
    public long getDateTimeMillis(int n, int n2, int n3, int n4, int n5, int n6, int n7) throws IllegalArgumentException {
        ...
        long l = (long)n4 * 3600000L + (long)n5 * 60000L + (long)n6 * 1000L + (long)n7;
    ...
    long getDateMidnightMillis(int n, int n2, int n3) {
        ...
        int n4 = this.getDaysInYearMonth(n, n2);
        if (n3 < 1 || n3 > n4) {
            throw new IllegalFieldValueException(DateTimeFieldType.dayOfMonth(), n3, 1, n4, "year: " + n + " month: " + n2);
        }
