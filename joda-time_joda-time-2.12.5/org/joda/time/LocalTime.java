...
Serializable {
    ...
    public int hashCode() {
        int n = 157;
        n = 23 * n + this.iChronology.hourOfDay().get(this.iLocalMillis);
        n = 23 * n + this.iChronology.hourOfDay().getType().hashCode();
        n = 23 * n + this.iChronology.minuteOfHour().get(this.iLocalMillis);
        n = 23 * n + this.iChronology.minuteOfHour().getType().hashCode();
        n = 23 * n + this.iChronology.secondOfMinute().get(this.iLocalMillis);
        n = 23 * n + this.iChronology.secondOfMinute().getType().hashCode();
        n = 23 * n + this.iChronology.millisOfSecond().get(this.iLocalMillis);
        n = 23 * n + this.iChronology.millisOfSecond().getType().hashCode();
