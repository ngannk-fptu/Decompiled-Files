...
implements ServletContainerInitializer {
    ...
    boolean isDisabledByConfiguration(ServletContext ctx) {
        ...
        if (OptionHelper.isNullOrEmpty(disableAttributeStr)) {
            disableAttributeStr = OptionHelper.getSystemProperty((String)"logbackDisableServletContainerInitializer");
        }
        if (OptionHelper.isNullOrEmpty((String)disableAttributeStr)) {
            disableAttributeStr = OptionHelper.getEnv((String)"logbackDisableServletContainerInitializer");
        }
