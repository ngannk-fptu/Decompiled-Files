...
extends LayoutBase<ILoggingEvent> {
    ...
    public String doLayout(ILoggingEvent event) {
        ...
        this.buf.append(Transform.escapeTags((String)event.getLoggerName()));
        this.buf.append("\"\r\n");
        ...
        this.buf.append(Transform.escapeTags((String)event.getThreadName()));
        this.buf.append("\">\r\n");
        this.buf.append("  <log4j:message>");
        this.buf.append(Transform.escapeTags((String)event.getFormattedMessage()));
        this.buf.append("</log4j:message>\r\n");
        ...
        if (this.locationInfo && (callerDataArray = event.getCallerData()) != null && callerDataArray.length > 0) {
            ...
            this.buf.append(Transform.escapeTags((String)immediateCallerData.getMethodName()));
            this.buf.append("\" file=\"");
            this.buf.append(Transform.escapeTags((String)immediateCallerData.getFileName()));
