...
extends AbstractHttpInvokerRequestExecutor {
    ...
    private static HttpClient createDefaultHttpClient() {
        Registry schemeRegistry = RegistryBuilder.create().register("http", (Object)PlainConnectionSocketFactory.getSocketFactory()).register("https", (Object)SSLConnectionSocketFactory.getSocketFactory()).build();
