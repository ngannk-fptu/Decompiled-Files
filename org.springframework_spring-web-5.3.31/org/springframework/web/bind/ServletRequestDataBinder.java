...
extends WebDataBinder {
    ...
    public void bind(ServletRequest request) {
        ...
        } else if (StringUtils.startsWithIgnoreCase((String)request.getContentType(), (String)"multipart/form-data") && (httpServletRequest = WebUtils.getNativeRequest(request, HttpServletRequest.class)) != null && HttpMethod.POST.matches(httpServletRequest.getMethod())) {
