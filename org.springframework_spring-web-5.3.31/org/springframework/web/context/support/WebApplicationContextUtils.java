...
public abstract class WebApplicationContextUtils {
    ...
    public static void registerWebApplicationScopes(ConfigurableListableBeanFactory beanFactory, @Nullable ServletContext sc) {
        ...
        beanFactory.registerScope("session", (Scope)new SessionScope());
        if (sc != null) {
        ...
        beanFactory.registerResolvableDependency(ServletResponse.class, (Object)new ResponseObjectFactory());
    ...
    public static void initServletPropertySources(MutablePropertySources sources, @Nullable ServletContext servletContext, @Nullable ServletConfig servletConfig) {
        Assert.notNull((Object)sources, (String)"'propertySources' must not be null");
        String name = "servletContextInitParams";
        if (servletContext != null && sources.get(name) instanceof PropertySource.StubPropertySource) {
            sources.replace(name, (PropertySource)new ServletContextPropertySource(name, servletContext));
        }
        name = "servletConfigInitParams";
        if (servletConfig != null && sources.get(name) instanceof PropertySource.StubPropertySource) {
            sources.replace(name, (PropertySource)new ServletConfigPropertySource(name, servletConfig));
        }
    }
