        ...
        try {
            ...
            for (Part part : parts) {
                ...
                if (filename != null) {
                    ...
                    files.add((Object)part.getName(), (Object)new StandardMultipartFile(part, filename));
                    continue;
                }
    ...
    Serializable {
        ...
        public void transferTo(File dest) throws IOException, IllegalStateException {
            ...
            if (dest.isAbsolute() && !dest.exists()) {
                FileCopyUtils.copy((InputStream)this.part.getInputStream(), (OutputStream)Files.newOutputStream(dest.toPath(), new OpenOption[0]));
            }
        }

        @Override
        public void transferTo(Path dest) throws IOException, IllegalStateException {
            FileCopyUtils.copy((InputStream)this.part.getInputStream(), (OutputStream)Files.newOutputStream(dest, new OpenOption[0]));
        }
    }
}
