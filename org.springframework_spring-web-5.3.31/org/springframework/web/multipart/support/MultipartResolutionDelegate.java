...
public final class MultipartResolutionDelegate {
    ...
    private static Class<?> getCollectionParameterType(MethodParameter methodParam) {
        ...
        if ((Collection.class == paramType || List.class.isAssignableFrom(paramType)) && (valueType = ResolvableType.forMethodParameter((MethodParameter)methodParam).asCollection().resolveGeneric(new int[0])) != null) {
            return valueType;
        }
        return null;
    }
