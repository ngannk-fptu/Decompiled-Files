...
implements HttpHandler {
    ...
    public void setCodecConfigurer(ServerCodecConfigurer codecConfigurer) {
        Assert.notNull((Object)codecConfigurer, (String)"ServerCodecConfigurer is required");
    ...
    public void setLocaleContextResolver(LocaleContextResolver resolver) {
        Assert.notNull((Object)resolver, (String)"LocaleContextResolver is required");
    ...
    public void setForwardedHeaderTransformer(ForwardedHeaderTransformer transformer) {
        Assert.notNull((Object)transformer, (String)"ForwardedHeaderTransformer is required");
    ...
    public Mono<Void> handle(ServerHttpRequest request, ServerHttpResponse response) {
        ...
        LogFormatUtils.traceDebug((Log)logger, traceOn -> exchange2.getLogPrefix() + this.formatRequest(exchange2.getRequest()) + (traceOn != false ? ", headers=" + this.formatHeaders(exchange2.getRequest().getHeaders()) : ""));
