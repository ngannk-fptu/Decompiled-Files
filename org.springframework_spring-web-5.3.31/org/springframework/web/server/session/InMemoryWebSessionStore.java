...
implements WebSessionStore {
    ...
    public Mono<WebSession> createWebSession() {
        ...
        return Mono.fromSupplier(() -> new InMemoryWebSession(now)).subscribeOn(Schedulers.boundedElastic()).publishOn(Schedulers.parallel());
    }
    ...
    public Mono<WebSession> updateLastAccessTime(WebSession session) {
        return Mono.fromSupplier(() -> {
            Assert.isInstanceOf(InMemoryWebSession.class, (Object)session);
        ...
        public Mono<Void> save() {
            ...
            if (this.isStarted()) {
                ...
                if (this.state.get().equals((Object)State.EXPIRED)) {
                    ...
                    return Mono.error((Throwable)new IllegalStateException("Session was invalidated"));
                }
            }
            return Mono.empty();
        }
