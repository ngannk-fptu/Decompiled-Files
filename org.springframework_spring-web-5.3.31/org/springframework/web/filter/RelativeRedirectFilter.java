...
extends OncePerRequestFilter {
    ...
    public void setRedirectStatus(HttpStatus status) {
        Assert.notNull((Object)((Object)status), (String)"Property 'redirectStatus' is required");
        Assert.isTrue((boolean)status.is3xxRedirection(), () -> "Not a redirect status code: " + (Object)((Object)status));
