...
CodecConfigurer.DefaultCodecConfig {
    ...
    protected void initObjectReaders() {
        ...
        if (jaxb2Present && !shouldIgnoreXml) {
            this.addCodec(this.objectReaders, new DecoderHttpMessageReader(this.jaxb2Decoder != null ? (Jaxb2XmlDecoder)this.jaxb2Decoder : new Jaxb2XmlDecoder()));
        }
    ...
    final List<HttpMessageWriter<?>> getBaseObjectWriters() {
        ...
        if (jaxb2Present && !shouldIgnoreXml) {
            this.addCodec(writers, new EncoderHttpMessageWriter(this.jaxb2Encoder != null ? (Jaxb2XmlEncoder)this.jaxb2Encoder : new Jaxb2XmlEncoder()));
        }
        return writers;
    }
    ...
    static {
        ...
        synchronossMultipartPresent = ClassUtils.isPresent((String)"org.synchronoss.cloud.nio.multipart.NioMultipartParser", (ClassLoader)classLoader);
