    ...
    extends HttpHeaders {
        ...
        public String getFirst(String headerName) {
            if (headerName.equalsIgnoreCase("Content-Type")) {
                ...
                return value != null ? value : ServletServerHttpResponse.this.servletResponse.getHeader(headerName);
            }
        ...
        public List<String> get(Object key) {
            Assert.isInstanceOf(String.class, (Object)key, (String)"Key must be a String-based header name");
            String headerName = (String)key;
            if (headerName.equalsIgnoreCase("Content-Type")) {
                return Collections.singletonList(this.getFirst(headerName));
            }
            Collection values1 = ServletServerHttpResponse.this.servletResponse.getHeaders(headerName);
            if (ServletServerHttpResponse.this.headersWritten) {
                return new ArrayList<String>(values1);
            }
            boolean isEmpty1 = CollectionUtils.isEmpty((Collection)values1);
            Object values2 = super.get(key);
            boolean isEmpty2 = CollectionUtils.isEmpty((Collection)values2);
