...
implements ServerHttpRequest.Builder {
    ...
    public DefaultServerHttpRequestBuilder(ServerHttpRequest original) {
        Assert.notNull((Object)original, (String)"ServerHttpRequest is required");
    ...
    public ServerHttpRequest.Builder path(String path) {
        Assert.isTrue((boolean)path.startsWith("/"), () -> "The path does not have a leading slash: " + path);
        this.uriPath = path;
        return this;
    }
    ...
    private URI getUriToUse() {
        ...
        if (StringUtils.hasLength((String)this.uriPath)) {
