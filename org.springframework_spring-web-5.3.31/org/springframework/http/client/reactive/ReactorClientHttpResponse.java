...
implements ClientHttpResponse {
    static final boolean reactorNettyRequestChannelOperationsIdPresent = ClassUtils.isPresent((String)"reactor.netty.ChannelOperationsId", (ClassLoader)ReactorClientHttpResponse.class.getClassLoader());
    ...
    public MultiValueMap<String, ResponseCookie> getCookies() {
        ...
        this.response.cookies().values().stream().flatMap(Collection::stream).forEach(arg_0 -> ReactorClientHttpResponse.lambda$getCookies$2((MultiValueMap)result, arg_0));
    ...
    private static /* synthetic */ void lambda$getCookies$2(MultiValueMap result, Cookie cookie) {
