...
extends AbstractClientHttpResponse {
    ...
    public Netty4ClientHttpResponse(ChannelHandlerContext context, FullHttpResponse nettyResponse) {
        Assert.notNull((Object)context, (String)"ChannelHandlerContext must not be null");
        Assert.notNull((Object)nettyResponse, (String)"FullHttpResponse must not be null");
