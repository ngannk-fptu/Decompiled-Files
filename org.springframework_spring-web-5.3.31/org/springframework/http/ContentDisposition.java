...
public final class ContentDisposition {
    ...
    public int hashCode() {
        ...
        result = 31 * result + ObjectUtils.nullSafeHashCode((Object)this.creationDate);
        result = 31 * result + ObjectUtils.nullSafeHashCode((Object)this.modificationDate);
        result = 31 * result + ObjectUtils.nullSafeHashCode((Object)this.readDate);
        return result;
    }
            ...
            if (eqIndex != -1) {
                ...
                if (attribute.equals("filename*")) {
                    ...
                    if (idx1 != -1 && idx2 != -1) {
                        ...
                        Assert.isTrue((StandardCharsets.UTF_8.equals(charset) || StandardCharsets.ISO_8859_1.equals(charset) ? 1 : 0) != 0, (String)"Charset must be UTF-8 or ISO-8859-1");
    ...
    private static String encodeFilename(String input, Charset charset) {
        ...
        Assert.notNull((Object)charset, (String)"'charset' must not be null");
        Assert.isTrue((!StandardCharsets.US_ASCII.equals(charset) ? 1 : 0) != 0, (String)"ASCII does not require encoding");
        Assert.isTrue((StandardCharsets.UTF_8.equals(charset) || StandardCharsets.ISO_8859_1.equals(charset) ? 1 : 0) != 0, (String)"Only UTF-8 and ISO-8859-1 are supported");
    ...
    implements Builder {
        ...
        public Builder filename(String filename) {
            Assert.hasText((String)filename, (String)"No filename");
            this.filename = filename;
            return this;
        }
