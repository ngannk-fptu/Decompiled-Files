...
implements Map<K, V> {
    ...
    public static <K, V> ImmutableMap<K, V> of(K k0, V v0, K k1, V v1) {
        ...
        ImmutableMap.putAndWarnDuplicateKeys(map, k0, v0);
        ImmutableMap.putAndWarnDuplicateKeys(map, k1, v1);
    ...
    public static <K, V> ImmutableMap<K, V> of(K k0, V v0, K k1, V v1, K k2, V v2) {
        ...
        ImmutableMap.putAndWarnDuplicateKeys(map, k0, v0);
        ImmutableMap.putAndWarnDuplicateKeys(map, k1, v1);
        ImmutableMap.putAndWarnDuplicateKeys(map, k2, v2);
        return new ImmutableMap(map);
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k0, V v0, K k1, V v1, K k2, V v2, K k3, V v3) {
        ...
        ImmutableMap.putAndWarnDuplicateKeys(map, k1, v1);
        ImmutableMap.putAndWarnDuplicateKeys(map, k2, v2);
        ImmutableMap.putAndWarnDuplicateKeys(map, k3, v3);
        return new ImmutableMap(map);
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k0, V v0, K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        ...
        ImmutableMap.putAndWarnDuplicateKeys(map, k2, v2);
        ImmutableMap.putAndWarnDuplicateKeys(map, k3, v3);
        ImmutableMap.putAndWarnDuplicateKeys(map, k4, v4);
        return new ImmutableMap(map);
    }
    ...
    public static class Builder<K, V> {
        ...
        public Builder<K, V> put(K key, V value) {
            ImmutableMap.putAndWarnDuplicateKeys(this.entries, key, value);
            return this;
        }

        public ImmutableMap<K, V> build() {
            HashMap<K, V> builtMap = new HashMap<K, V>(this.entries);
