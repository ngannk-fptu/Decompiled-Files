...
implements AuthCache {
        ...
        block19: {
            ...
            if (authScheme instanceof Serializable) {
                try {
                    ...
                    this.map.put(this.key(host.getSchemeName(), (NamedEndpoint)host, pathPrefix), buf.toByteArray());
                }
    ...
    public AuthScheme get(HttpHost host, String pathPrefix) {
        Args.notNull((Object)host, (String)"HTTP host");
        byte[] bytes = this.map.get(this.key(host.getSchemeName(), (NamedEndpoint)host, pathPrefix));
    ...
    public void remove(HttpHost host, String pathPrefix) {
        Args.notNull((Object)host, (String)"HTTP host");
        this.map.remove(this.key(host.getSchemeName(), (NamedEndpoint)host, pathPrefix));
    }
    ...
    static class Key {
        ...
        Key(String scheme, String host, int port, String pathPrefix) {
            Args.notBlank((CharSequence)scheme, (String)"Scheme");
            Args.notBlank((CharSequence)host, (String)"Scheme");
        ...
        public int hashCode() {
            ...
            hash = LangUtils.hashCode((int)hash, (Object)this.pathPrefix);
            return hash;
        }
