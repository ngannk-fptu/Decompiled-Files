...
implements AuthScheme {
    ...
    public void processChallenge(AuthChallenge authChallenge, HttpContext context) throws MalformedChallengeException {
        ...
        String string = this.challenge = authChallenge.getValue() != null ? authChallenge.getValue() : NO_TOKEN;
        if (this.state == State.UNINITIATED) {
            ...
            if (LOG.isDebugEnabled()) {
                ...
                LOG.debug("{} Authentication already attempted", (Object)exchangeId);
            }
    ...
    public boolean isResponseReady(HttpHost host, CredentialsProvider credentialsProvider, HttpContext context) throws AuthenticationException {
        Args.notNull((Object)host, (String)"Auth host");
        Args.notNull((Object)credentialsProvider, (String)"CredentialsProvider");
        ...
        switch (this.state) {
            ...
            case CHALLENGE_RECEIVED: {
                ...
                try {
                    ...
                    if (LOG.isDebugEnabled()) {
                        ...
                        LOG.debug("{} init {}", (Object)exchangeId, (Object)authServer);
                    }
                    this.token = this.generateToken(this.token, KERBEROS_SCHEME, authServer);
            ...
            case TOKEN_GENERATED: {
                ...
                if (LOG.isDebugEnabled()) {
                    clientContext = HttpClientContext.adapt(context);
                    exchangeId = clientContext.getExchangeId();
                    LOG.debug("{} Sending response '{}' back to the auth server", (Object)exchangeId, (Object)tokenstr);
                }
