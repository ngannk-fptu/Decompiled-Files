...
implements CredentialsStore {
    ...
    public Credentials getCredentials(AuthScope authScope, HttpContext context) {
        ...
        if (host != null) {
            ...
            if (systemcreds == null && (systemcreds = SystemDefaultCredentialsProvider.getProxyCredentials(URIScheme.HTTP.getId(), authScope)) == null) {
                systemcreds = SystemDefaultCredentialsProvider.getProxyCredentials(URIScheme.HTTPS.getId(), authScope);
            }
            if (systemcreds != null) {
