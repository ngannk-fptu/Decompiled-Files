            ...
            try {
                ...
                switch (statusCode) {
                    ...
                    case 302: {
                        ...
                        redirectBuilder = ClassicRequestBuilder.copy((ClassicHttpRequest)scope.originalRequest);
                        break;
                    }
                    case 303: {
                ...
                if (!Objects.equals(currentRoute.getTargetHost(), newTarget) && !Objects.equals(currentRoute, newRoute = this.routePlanner.determineRoute(newTarget, (HttpContext)context))) {
