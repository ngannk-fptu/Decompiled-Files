...
implements UserTokenHandler {
    ...
    public Object getUserToken(HttpRoute route, HttpRequest request, HttpContext context) {
        ...
        AuthExchange targetAuthExchange = clientContext.getAuthExchange(target = request != null ? new HttpHost(request.getScheme(), (NamedEndpoint)request.getAuthority()) : route.getTargetHost());
