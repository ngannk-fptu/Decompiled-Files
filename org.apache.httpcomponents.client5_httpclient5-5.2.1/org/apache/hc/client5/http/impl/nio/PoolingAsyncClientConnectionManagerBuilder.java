...
public class PoolingAsyncClientConnectionManagerBuilder {
    ...
    public PoolingAsyncClientConnectionManager build() {
        ...
        PoolingAsyncClientConnectionManager poolingmgr = new PoolingAsyncClientConnectionManager((Lookup<TlsStrategy>)RegistryBuilder.create().register(URIScheme.HTTPS.getId(), (Object)tlsStrategyCopy).build(), this.poolConcurrencyPolicy, this.poolReusePolicy, null, this.schemePortResolver, this.dnsResolver);
