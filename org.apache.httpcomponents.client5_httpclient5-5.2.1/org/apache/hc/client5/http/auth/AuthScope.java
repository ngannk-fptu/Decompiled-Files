...
public class AuthScope {
    ...
    public int match(AuthScope that) {
        int factor = 0;
        if (Objects.equals(this.toNullSafeLowerCase(this.schemeName), this.toNullSafeLowerCase(that.schemeName))) {
            ++factor;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AuthScope) {
            ...
            return Objects.equals(this.protocol, that.protocol) && Objects.equals(this.host, that.host) && this.port == that.port && Objects.equals(this.realm, that.realm) && Objects.equals(this.toNullSafeLowerCase(this.schemeName), this.toNullSafeLowerCase(that.schemeName));
        }
        return false;
    }
    ...
    public int hashCode() {
        int hash = 17;
        hash = LangUtils.hashCode((int)hash, (Object)this.protocol);
        ...
        hash = LangUtils.hashCode((int)hash, (Object)this.toNullSafeLowerCase(this.schemeName));
        return hash;
    }
