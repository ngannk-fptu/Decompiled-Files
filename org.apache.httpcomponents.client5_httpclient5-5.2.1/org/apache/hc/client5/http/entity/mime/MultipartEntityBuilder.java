...
public class MultipartEntityBuilder {
    ...
    public MultipartEntityBuilder setMimeSubtype(String subType) {
        Args.notBlank((CharSequence)subType, (String)"MIME subtype");
        this.contentType = ContentType.create((String)("multipart/" + subType));
        return this;
    }

    public MultipartEntityBuilder setContentType(ContentType contentType) {
        Args.notNull((Object)contentType, (String)"Content type");
    ...
    public MultipartEntityBuilder addPart(String name, ContentBody contentBody) {
        ...
        Args.notNull((Object)contentBody, (String)"Content body");
    ...
    MultipartFormEntity buildEntity() {
        ...
        NameValuePair[] params = paramsList.toArray(EMPTY_NAME_VALUE_ARRAY);
        if (this.contentType != null) {
            ...
            contentTypeCopy = formData ? ContentType.MULTIPART_FORM_DATA.withParameters(params) : ContentType.create((String)"multipart/mixed", (NameValuePair[])params);
        }
