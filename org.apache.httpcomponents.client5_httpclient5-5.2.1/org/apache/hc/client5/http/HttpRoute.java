...
Cloneable {
    ...
    private HttpRoute(HttpHost targetHost, InetAddress local, List<HttpHost> proxies, boolean secure, RouteInfo.TunnelType tunnelled, RouteInfo.LayerType layered) {
        Args.notNull((Object)targetHost, (String)"Target host");
        Args.notNegative((int)targetHost.getPort(), (String)"Target port");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HttpRoute) {
            ...
            return this.secure == that.secure && this.tunnelled == that.tunnelled && this.layered == that.layered && Objects.equals(this.targetHost, that.targetHost) && Objects.equals(this.localAddress, that.localAddress) && Objects.equals(this.proxyChain, that.proxyChain);
        }
        return false;
    }
