...
extends CharObjectHashMap<Long> {
    ...
    public Http2Settings copyFrom(Http2Settings settings) {
        this.clear();
        this.putAll((Map)((Object)settings));
        return this;
    }
    ...
    private static void verifyStandardSetting(int key, Long value) {
        ...
        switch (key) {
            case 1: {
                ...
                throw new IllegalArgumentException("Setting HEADER_TABLE_SIZE is invalid: " + value + ", expected [" + 0L + ", " + 0xFFFFFFFFL + ']');
            }
            case 2: {
            ...
            case 3: {
                if (value >= 0L && value <= 0xFFFFFFFFL) break;
                throw new IllegalArgumentException("Setting MAX_CONCURRENT_STREAMS is invalid: " + value + ", expected [" + 0L + ", " + 0xFFFFFFFFL + ']');
            }
            case 4: {
            ...
            case 5: {
                ...
                throw new IllegalArgumentException("Setting MAX_FRAME_SIZE is invalid: " + value + ", expected [" + 16384 + ", " + 0xFFFFFF + ']');
            }
            case 6: {
                if (value >= 0L && value <= 0xFFFFFFFFL) break;
                throw new IllegalArgumentException("Setting MAX_HEADER_LIST_SIZE is invalid: " + value + ", expected [" + 0L + ", " + 0xFFFFFFFFL + ']');
            }
            default: {
                if (value >= 0L && value <= 0xFFFFFFFFL) break;
