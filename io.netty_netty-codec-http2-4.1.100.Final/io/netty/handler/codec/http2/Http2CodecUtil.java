...
public final class Http2CodecUtil {
    ...
    private static final ByteBuf CONNECTION_PREFACE = Unpooled.unreleasableBuffer((ByteBuf)Unpooled.directBuffer((int)24).writeBytes("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n".getBytes(CharsetUtil.UTF_8))).asReadOnly();
    ...
    public static ByteBuf toByteBuf(ChannelHandlerContext ctx, Throwable cause) {
        ...
        return ByteBufUtil.writeUtf8((ByteBufAllocator)ctx.alloc(), (CharSequence)cause.getMessage());
    }
