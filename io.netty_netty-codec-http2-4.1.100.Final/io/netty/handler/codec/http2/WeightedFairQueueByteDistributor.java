...
implements StreamByteDistributor {
    ...
    public WeightedFairQueueByteDistributor(Http2Connection connection, int maxStateOnlySize) {
        ...
        connection.addListener(new Http2ConnectionAdapter(){
            ...
            public void onStreamRemoved(Http2Stream stream) {
                ...
                WeightedFairQueueByteDistributor.this.stateOnlyRemovalQueue.add((Object)state);
                WeightedFairQueueByteDistributor.this.stateOnlyMap.put(state.streamId, (Object)state);
            }
        });
    }
    ...
    private State state(int streamId) {
        ...
        return stream != null ? this.state(stream) : (State)this.stateOnlyMap.get(streamId);
    }
    ...
    implements PriorityQueueNode {
            ...
            if (this.children.remove(child.streamId) != null) {
                ...
                if (!child.children.isEmpty()) {
                    ...
                    do {
                        ...
                        dependency.weight = (short)Math.max(1L, (long)(dependency.weight * child.weight) / totalWeight);
        ...
        private IntObjectMap<State> removeAllChildrenExcept(State stateToRetain) {
            ...
            if (stateToRetain != null) {
                this.children.put(stateToRetain.streamId, (Object)stateToRetain);
            }
            return prevChildren;
        }
        ...
        void activeCountChangeForTree(int increment) {
            ...
            if (this.parent != null) {
                assert (this.activeCountForTree != increment || this.pseudoTimeQueueIndex == -1 || this.parent.pseudoTimeQueue.containsTyped((Object)this)) : "State[" + this.streamId + "].activeCountForTree changed from 0 to " + increment + " is in a pseudoTimeQueue, but not in parent[ " + this.parent.streamId + "]'s pseudoTimeQueue";
    ...
    Serializable {
        ...
        public int compare(State o1, State o2) {
            return MathUtil.compare((long)o1.pseudoTimeToWrite, (long)o2.pseudoTimeToWrite);
        }
    }
