    ...
    public StreamBufferingEncoder(Http2ConnectionEncoder delegate, int initialMaxConcurrentStreams) {
        ...
        this.connection().addListener(new Http2ConnectionAdapter(){
            ...
            public void onGoAwayReceived(int lastStreamId, long errorCode, ByteBuf debugData) {
                StreamBufferingEncoder.this.goAwayDetail = new GoAwayDetail(lastStreamId, errorCode, ByteBufUtil.getBytes((ByteBuf)debugData, (int)debugData.readerIndex(), (int)debugData.readableBytes(), (boolean)false));
