...
extends ChannelHandlerAdapter {
    ...
    public Http2FrameLogger(LogLevel level, String name) {
        this(Http2FrameLogger.checkAndConvertLevel(level), InternalLoggerFactory.getInstance((String)((String)ObjectUtil.checkNotNull((Object)name, (String)"name"))));
    }

    public Http2FrameLogger(LogLevel level, Class<?> clazz) {
        this(Http2FrameLogger.checkAndConvertLevel(level), InternalLoggerFactory.getInstance((Class)((Class)ObjectUtil.checkNotNull(clazz, (String)"clazz"))));
    }
