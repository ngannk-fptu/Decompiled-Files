...
final class HpackDecoder {
    ...
    HpackDecoder(long maxHeaderListSize, int maxHeaderTableSize) {
        this.maxHeaderListSize = ObjectUtil.checkPositive((long)maxHeaderListSize, (String)"maxHeaderListSize");
    ...
    private static HeaderType validateHeader(int streamId, AsciiString name, CharSequence value, HeaderType previousHeaderType) throws Http2Exception {
        if (Http2Headers.PseudoHeaderName.hasPseudoHeaderFormat((CharSequence)name)) {
            ...
            Http2Headers.PseudoHeaderName pseudoHeader = Http2Headers.PseudoHeaderName.getPseudoHeader((CharSequence)name);
        ...
        if (HttpHeaderValidationUtil.isTeNotTrailers((CharSequence)name, (CharSequence)value)) {
