...
implements Http2FrameReader {
    ...
    public Http2InboundFrameLogger(Http2FrameReader reader, Http2FrameLogger logger) {
        this.reader = (Http2FrameReader)ObjectUtil.checkNotNull((Object)reader, (String)"reader");
        this.logger = (Http2FrameLogger)((Object)ObjectUtil.checkNotNull((Object)((Object)logger), (String)"logger"));
    }
