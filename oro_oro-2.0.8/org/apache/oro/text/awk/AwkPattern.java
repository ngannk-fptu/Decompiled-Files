...
Serializable {
    ...
    AwkPattern(String string, SyntaxTree syntaxTree) {
        ...
        this._Dtrans.addElement(nArray);
        this._Dtrans.addElement(nArray);
        this._numStates = 1;
    ...
    void _createNewState(int n, int n2, int[] nArray) {
        ...
        if (!this._stateMap.containsKey(this._U)) {
            ...
            nArray[n2] = this._U.equals(this._emptySet) ? -1 : ((DFAState)this._stateMap.get((Object)this._U))._stateNumber;
        }
    }
