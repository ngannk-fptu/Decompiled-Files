...
public final class ProtocolUtils {
    ...
    public static SdkHttpFullRequest.Builder createSdkHttpRequest(OperationInfo operationInfo, URI endpoint) {
        ...
        return request.encodedPath(SdkHttpUtils.appendUri((String)request.encodedPath(), (String)ProtocolUtils.addStaticQueryParametersToRequest(request, operationInfo.requestUri())));
    }
