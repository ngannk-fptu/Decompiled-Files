...
@Provider
@Metadata(mv={1, 9, 0}, k=1, xi=48, d1={"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u00a2\u0006\u0002\u0010\u0004J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0006H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004\u00a2\u0006\u0002\n\u0000\u00a8\u0006\b"}, d2={"Lcom/addonengine/addons/analytics/rest/filter/UserHasPermissionToViewSpaceAnalyticsFilter;", "Lcom/addonengine/addons/analytics/rest/filter/PrerequestFilter;", "restrictionsService", "Lcom/addonengine/addons/analytics/service/RestrictionsService;", "(Lcom/addonengine/addons/analytics/service/RestrictionsService;)V", "filter", "Lcom/sun/jersey/spi/container/ContainerRequest;", "containerRequest", "analytics"})
public final class UserHasPermissionToViewSpaceAnalyticsFilter
extends PrerequestFilter {
    @NotNull
    private final RestrictionsService restrictionsService;

    public UserHasPermissionToViewSpaceAnalyticsFilter(@NotNull RestrictionsService restrictionsService) {
    ...
    public ContainerRequest filter(@NotNull ContainerRequest containerRequest) {
        ...
        String string2 = list != null ? (String)list.get(0) : null;
        Intrinsics.checkNotNull((Object)string2);
        String spaceKey = string2;
        if (this.restrictionsService.isUserAllowedToViewSpaceAnalytics(userKey, spaceKey)) {
            return containerRequest;
        }
        Response.ResponseBuilder response = Response.status((Response.Status)Response.Status.FORBIDDEN).type("application/json").entity((Object)new ErrorResponseDto(new ErrorDto("ViewAnalyticsRestricted", "The requesting user does not have permission to view analytics in this space.")));
