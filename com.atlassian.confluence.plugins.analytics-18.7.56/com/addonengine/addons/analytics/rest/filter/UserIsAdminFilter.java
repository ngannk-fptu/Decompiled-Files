...
extends PrerequestFilter {
    ...
    public ContainerRequest filter(@NotNull ContainerRequest containerRequest) {
        ...
        Response.ResponseBuilder response = Response.status((Response.Status)Response.Status.FORBIDDEN).type("application/json").entity((Object)new ErrorResponseDto(new ErrorDto("UserIsNotAdmin", "The requesting user must be a Confluence administrator.")));
