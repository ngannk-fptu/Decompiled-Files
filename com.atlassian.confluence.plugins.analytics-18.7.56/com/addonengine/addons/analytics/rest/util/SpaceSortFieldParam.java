...
extends CaseInsensitiveEnumParam<SpaceSortField> {
    ...
    public SpaceSortFieldParam(@NotNull String param) {
        ...
        this.value = SpaceSortField.valueOf(string);
    }

    @Override
    @NotNull
    public SpaceSortField getValue() {
        return this.value;
    }
}
