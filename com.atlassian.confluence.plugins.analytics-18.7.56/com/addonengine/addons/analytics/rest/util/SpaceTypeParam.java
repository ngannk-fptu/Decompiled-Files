...
@Metadata(mv={1, 9, 0}, k=1, xi=48, d1={"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\"\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u00a2\u0006\u0002\u0010\u0005R\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00020\u0007X\u0096\u0004\u00a2\u0006\b\n\u0000\u001a\u0004\b\b\u0010\t\u00a8\u0006\n"}, d2={"Lcom/addonengine/addons/analytics/rest/util/SpaceTypeParam;", "Lcom/addonengine/addons/analytics/rest/util/CommaSeparatedEnumParam;", "Lcom/addonengine/addons/analytics/service/model/SpaceType;", "param", "", "(Ljava/lang/String;)V", "value", "", "getValue", "()Ljava/util/Set;", "analytics"})
@SourceDebugExtension(value={"SMAP\nCustomParams.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CustomParams.kt\ncom/addonengine/addons/analytics/rest/util/SpaceTypeParam\n+ 2 CustomParams.kt\ncom/addonengine/addons/analytics/rest/util/CommaSeparatedEnumParam\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 4 CustomParams.kt\ncom/addonengine/addons/analytics/rest/util/CaseInsensitiveEnumParam\n*L\n1#1,83:1\n27#2:84\n28#2:90\n1549#3:85\n1620#3,2:86\n1622#3:89\n21#4:88\n*S KotlinDebug\n*F\n+ 1 CustomParams.kt\ncom/addonengine/addons/analytics/rest/util/SpaceTypeParam\n*L\n41#1:84\n41#1:90\n41#1:85\n41#1:86,2\n41#1:89\n41#1:88\n*E\n"})
public final class SpaceTypeParam
extends CommaSeparatedEnumParam<SpaceType> {
    @NotNull
    private final Set<SpaceType> value;

    /*
     * WARNING - void declaration
     */
    public SpaceTypeParam(@NotNull String param) {
        void $this$mapTo$iv$iv$iv;
        Intrinsics.checkNotNullParameter((Object)param, (String)"param");
        CommaSeparatedEnumParam commaSeparatedEnumParam = this;
        SpaceTypeParam spaceTypeParam = this;
        ...
        for (Object item$iv$iv$iv : $this$mapTo$iv$iv$iv) {
            ...
            collection.add(SpaceType.valueOf(string2));
        }
        List enumList$iv = (List)destination$iv$iv$iv;
        spaceTypeParam.value = CollectionsKt.toSet((Iterable)enumList$iv);
    }

    @Override
    @NotNull
    public Set<SpaceType> getValue() {
        return this.value;
    }
}
