...
@Metadata(mv={1, 9, 0}, k=1, xi=48, d1={"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\f\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\u0018\u0000 \u00072\u00020\u0001:\u0001\u0007B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u00a2\u0006\u0002\u0010\u0006\u00a8\u0006\b"}, d2={"Lcom/addonengine/addons/analytics/store/server/querydsl/template/ExtendedH2Template;", "Lcom/querydsl/sql/H2Templates;", "escape", "", "quote", "", "(CZ)V", "Companion", "analytics"})
public final class ExtendedH2Template
extends H2Templates {
    @NotNull
    public static final Companion Companion = new Companion(null);

    public ExtendedH2Template(char escape, boolean quote) {
        super(escape, quote);
        this.add(UnixSecondToUtcDatetime.INSTANCE, "dateadd('SECOND', {0} + {1}, DATE '1970-01-01')");
        this.add(UtcDatetimeToUnixSecond.INSTANCE, "(extract(epoch from {0}) - {1})");
        this.add((Operator)Ops.DateTimeOps.TRUNC_WEEK, "date_trunc('week', {0})");
        this.add(FastStringHash.INSTANCE, "{0}");
    }

    @Metadata(mv={1, 9, 0}, k=1, xi=48, d1={"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004\u00a8\u0006\u0005"}, d2={"Lcom/addonengine/addons/analytics/store/server/querydsl/template/ExtendedH2Template$Companion;", "", "()V", "builder", "Lcom/querydsl/sql/SQLTemplates$Builder;", "analytics"})
        ...
        public final SQLTemplates.Builder builder() {
            return new SQLTemplates.Builder(){
                ...
                protected SQLTemplates build(char escape, boolean quote) {
                    return (SQLTemplates)new ExtendedH2Template(escape, quote);
                }
            };
        }
