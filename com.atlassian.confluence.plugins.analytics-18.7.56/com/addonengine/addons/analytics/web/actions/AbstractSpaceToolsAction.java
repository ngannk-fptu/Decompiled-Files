...
extends SpaceAdminAction {
    ...
    public AbstractSpaceToolsAction(@NotNull ConnectHostContextBuilder connectHostContextBuilder, @NotNull LicenseContext licenseContext, @NotNull ConnectHostParams connectHostParams, @NotNull String titleKey, @NotNull String webItemKey, @NotNull UrlBuilder urlBuilder, @NotNull TimeZoneManager timeZoneManager) {
    ...
    @NotNull
    public final String getSpaceAdminWebItemKey() {
