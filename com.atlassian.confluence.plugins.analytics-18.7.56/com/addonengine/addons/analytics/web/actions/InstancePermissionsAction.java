...
extends AbstractAdminToolsAction {
    ...
    public InstancePermissionsAction(@NotNull ConnectHostContextBuilder connectHostContextBuilder, @NotNull LicenseContext licenseContext, @NotNull UrlBuilder urlBuilder, @NotNull UserManager userManager, @NotNull TimeZoneManager timeZoneManager) {
        ...
        super(connectHostContextBuilder, licenseContext, new ConnectHostParams("instance-permissions-page", "permissions", "/permissions/instance"), "com.addonengine.addons.analytics.admin.permissions.page.title", "instance-permissions-web-item", urlBuilder, userManager, timeZoneManager);
    }
}
