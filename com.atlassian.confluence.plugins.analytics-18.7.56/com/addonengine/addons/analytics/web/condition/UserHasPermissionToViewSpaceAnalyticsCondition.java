...
@Named
@Metadata(mv={1, 9, 0}, k=1, xi=48, d1={"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u00020\u0001B\u000f\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u00a2\u0006\u0002\u0010\u0004J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0014R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004\u00a2\u0006\u0002\n\u0000\u00a8\u0006\t"}, d2={"Lcom/addonengine/addons/analytics/web/condition/UserHasPermissionToViewSpaceAnalyticsCondition;", "Lcom/atlassian/confluence/plugin/descriptor/web/conditions/BaseConfluenceCondition;", "restrictionsService", "Lcom/addonengine/addons/analytics/service/RestrictionsService;", "(Lcom/addonengine/addons/analytics/service/RestrictionsService;)V", "shouldDisplay", "", "context", "Lcom/atlassian/confluence/plugin/descriptor/web/WebInterfaceContext;", "analytics"})
public final class UserHasPermissionToViewSpaceAnalyticsCondition
extends BaseConfluenceCondition {
    @NotNull
    private final RestrictionsService restrictionsService;

    @Inject
    public UserHasPermissionToViewSpaceAnalyticsCondition(@NotNull RestrictionsService restrictionsService) {
    ...
    protected boolean shouldDisplay(@NotNull WebInterfaceContext context) {
        ...
        String string = space != null ? space.getKey() : null;
        if (string == null) {
            return false;
        }
        String spaceKey = string;
        return this.restrictionsService.isUserAllowedToViewSpaceAnalytics((String)userKey, spaceKey);
    }
}
