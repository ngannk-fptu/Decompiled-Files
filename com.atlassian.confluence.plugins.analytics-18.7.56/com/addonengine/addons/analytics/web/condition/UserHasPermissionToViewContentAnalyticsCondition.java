...
extends BaseConfluenceCondition {
    ...
    protected boolean shouldDisplay(@NotNull WebInterfaceContext context) {
        ...
        long pageId = abstractPage.getId();
        return this.restrictionsService.isUserAllowedToViewContentAnalytics((String)userKey, pageId);
    }
}
