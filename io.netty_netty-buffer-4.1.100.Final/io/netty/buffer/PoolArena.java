...
implements PoolArenaMetric {
    ...
    extends PoolArena<ByteBuffer> {
        ...
        protected PoolChunk<ByteBuffer> newChunk(int pageSize, int maxPageIdx, int pageShifts, int chunkSize) {
            ...
            ByteBuffer memory = PlatformDependent.alignDirectBuffer((ByteBuffer)base, (int)this.directMemoryCacheAlignment);
        ...
        private static ByteBuffer allocateDirect(int capacity) {
            return PlatformDependent.useDirectBufferNoCleaner() ? PlatformDependent.allocateDirectNoCleaner((int)capacity) : ByteBuffer.allocateDirect(capacity);
        }
        ...
        protected void destroyChunk(PoolChunk<ByteBuffer> chunk) {
            if (PlatformDependent.useDirectBufferNoCleaner()) {
                ...
                PlatformDependent.freeDirectBuffer((ByteBuffer)((ByteBuffer)chunk.base));
            }
        }
