...
extends ByteBuf {
    ...
    public ByteBuf ensureWritable(int minWritableBytes) {
        this.ensureWritable0(ObjectUtil.checkPositiveOrZero((int)minWritableBytes, (String)"minWritableBytes"));
        return this;
    }
    ...
    public ByteBuf order(ByteOrder endianness) {
        ...
        ObjectUtil.checkNotNull((Object)endianness, (String)"endianness");
    ...
    protected final void checkReadableBytes(int minimumReadableBytes) {
        this.checkReadableBytes0(ObjectUtil.checkPositiveOrZero((int)minimumReadableBytes, (String)"minimumReadableBytes"));
    }
