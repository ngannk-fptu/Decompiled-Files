...
public final class ByteBufUtil {
    ...
    static byte[] threadLocalTempArray(int minLength) {
        return minLength <= 1024 ? (byte[])BYTE_ARRAYS.get() : PlatformDependent.allocateUninitializedArray((int)minLength);
    }
    ...
    private static int unsafeWriteUtf8(byte[] buffer, long memoryOffset, int writerIndex, CharSequence seq, int start, int end) {
        ...
        for (int i = start; i < end; ++i) {
            ...
            if (StringUtil.isSurrogate((char)c)) {
                ...
                PlatformDependent.putByte((Object)buffer, (long)writerOffset++, (byte)((byte)(0x80 | codePoint & 0x3F)));
                continue;
            }
            PlatformDependent.putByte((Object)buffer, (long)writerOffset++, (byte)((byte)(0xE0 | c >> 12)));
            PlatformDependent.putByte((Object)buffer, (long)writerOffset++, (byte)((byte)(0x80 | c >> 6 & 0x3F)));
            PlatformDependent.putByte((Object)buffer, (long)writerOffset++, (byte)((byte)(0x80 | c & 0x3F)));
        }
    ...
    public static void copy(AsciiString src, int srcIdx, ByteBuf dst, int dstIdx, int length) {
        ...
        ((ByteBuf)ObjectUtil.checkNotNull((Object)dst, (String)"dst")).setBytes(dstIdx, src.array(), srcIdx + src.arrayOffset(), length);
    }
    ...
    public static void copy(AsciiString src, int srcIdx, ByteBuf dst, int length) {
        ...
        ((ByteBuf)ObjectUtil.checkNotNull((Object)dst, (String)"dst")).writeBytes(src.array(), srcIdx + src.arrayOffset(), length);
    }
