...
class PWAW<K, V>
extends PWA<K, V> {
    protected static final long WRITE_TIME_OFFSET = UnsafeAccess.objectFieldOffset(PWAW.class, "writeTime");
    ...
    public Node<K, V> newNode(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        return new PWAW<K, V>(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
    }
