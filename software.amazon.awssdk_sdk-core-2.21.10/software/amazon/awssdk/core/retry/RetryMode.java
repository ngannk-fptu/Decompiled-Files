...
public enum RetryMode {
    ...
    public static class Resolver {
        ...
        public RetryMode resolve() {
            return OptionalUtils.firstPresent(Resolver.fromSystemSettings(), (Supplier[])new Supplier[]{() -> Resolver.fromProfileFile(this.profileFile, this.profileName)}).orElseGet(this::fromDefaultMode);
        }
        ...
        private static Optional<RetryMode> fromString(String string) {
            ...
            switch (StringUtils.lowerCase((String)string)) {
                case "legacy": {
