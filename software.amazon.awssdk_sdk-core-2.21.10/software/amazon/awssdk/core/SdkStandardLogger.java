...
public final class SdkStandardLogger {
    public static final Logger REQUEST_LOGGER = Logger.loggerFor((String)"software.amazon.awssdk.request");
    public static final Logger REQUEST_ID_LOGGER = Logger.loggerFor((String)"software.amazon.awssdk.requestId");
