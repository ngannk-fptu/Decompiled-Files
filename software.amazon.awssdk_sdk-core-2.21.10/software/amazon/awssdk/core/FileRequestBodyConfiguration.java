...
implements ToCopyableBuilder<Builder, FileRequestBodyConfiguration> {
    ...
    private FileRequestBodyConfiguration(DefaultBuilder builder) {
        this.path = (Path)Validate.notNull((Object)builder.path, (String)"path", (Object[])new Object[0]);
        this.chunkSizeInBytes = Validate.isPositiveOrNull((Integer)builder.chunkSizeInBytes, (String)"chunkSizeInBytes");
        this.position = Validate.isNotNegativeOrNull((Long)builder.position, (String)"position");
        this.numBytesToRead = Validate.isNotNegativeOrNull((Long)builder.numBytesToRead, (String)"numBytesToRead");
    }
