...
public final class FileAsyncRequestBodySplitHelper {
    ...
    public FileAsyncRequestBodySplitHelper(FileAsyncRequestBody asyncRequestBody, AsyncRequestBodySplitConfiguration splitConfiguration) {
        Validate.notNull((Object)asyncRequestBody, (String)"asyncRequestBody", (Object[])new Object[0]);
        Validate.notNull((Object)splitConfiguration, (String)"splitConfiguration", (Object[])new Object[0]);
        Validate.isTrue((boolean)asyncRequestBody.contentLength().isPresent(), (String)"Content length must be present", (Object[])new Object[]{asyncRequestBody});
    ...
    public SdkPublisher<AsyncRequestBody> split() {
        ...
        try {
            this.sendAsyncRequestBody((SimplePublisher<AsyncRequestBody>)simplePublisher);
        }
    ...
    private void doSendAsyncRequestBody(SimplePublisher<AsyncRequestBody> simplePublisher) {
        while (this.shouldSendMore()) {
            ...
            simplePublisher.send((Object)currentAsyncRequestBody);
    ...
    private void checkCompletion(SimplePublisher<AsyncRequestBody> simplePublisher, AsyncRequestBody currentAsyncRequestBody) {
        ...
        if (remaining == 0L) {
            ...
            this.isDone = true;
            simplePublisher.error((Throwable)SdkClientException.create("Unexpected error occurred. Remaining data is negative: " + remaining));
        }
    }
    ...
    implements AsyncRequestBody {
        ...
        public void subscribe(Subscriber<? super ByteBuffer> s) {
            this.fileAsyncRequestBody.doAfterOnComplete(() -> FileAsyncRequestBodySplitHelper.this.startNextRequestBody((SimplePublisher<AsyncRequestBody>)this.simplePublisher)).doAfterOnCancel(() -> FileAsyncRequestBodySplitHelper.this.startNextRequestBody((SimplePublisher<AsyncRequestBody>)this.simplePublisher)).subscribe(s);
        }
