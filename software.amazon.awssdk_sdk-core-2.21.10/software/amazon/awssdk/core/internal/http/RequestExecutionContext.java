...
public final class RequestExecutionContext {
    ...
    private RequestExecutionContext(Builder builder) {
        ...
        this.originalRequest = (SdkRequest)Validate.paramNotNull((Object)builder.originalRequest, (String)"originalRequest");
        this.executionContext = (ExecutionContext)Validate.paramNotNull((Object)builder.executionContext, (String)"executionContext");
    }
