...
public enum Algorithm {
    ...
    public static Algorithm fromValue(String value) {
        ...
        if (algorithm == null && (algorithm = VALUE_MAP.get(normalizedValue = StringUtils.upperCase((String)value))) == null) {
    ...
    static {
        VALUE_MAP = EnumUtils.uniqueIndex(Algorithm.class, a -> StringUtils.upperCase((String)a.value));
    }
}
