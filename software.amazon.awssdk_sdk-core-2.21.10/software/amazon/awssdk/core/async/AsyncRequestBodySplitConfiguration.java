...
implements ToCopyableBuilder<Builder, AsyncRequestBodySplitConfiguration> {
    ...
    private AsyncRequestBodySplitConfiguration(DefaultBuilder builder) {
        this.chunkSizeInBytes = Validate.isPositiveOrNull((Long)builder.chunkSizeInBytes, (String)"chunkSizeInBytes");
        this.bufferSizeInBytes = Validate.isPositiveOrNull((Long)builder.bufferSizeInBytes, (String)"bufferSizeInBytes");
    }
