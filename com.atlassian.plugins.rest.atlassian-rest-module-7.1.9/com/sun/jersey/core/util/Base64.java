...
public final class Base64 {
    ...
    public static boolean isBase64(byte octet) {
        return octet == 61 || base64Alphabet[(octet & 0xF) + (octet & 0xF0)] != -1;
    }
    ...
    public static byte[] encode(byte[] binaryData) {
        ...
        byte[] encodedData = fewerThan24bits != 0 ? new byte[(numberTriplets + 1) * 4] : new byte[numberTriplets * 4];
