...
AsyncClientHandler {
    ...
    public AsyncViewResource queryParams(MultivaluedMap<String, String> params) {
        ...
        for (Map.Entry e : params.entrySet()) {
            for (String value : (List)e.getValue()) {
                b.queryParam((String)e.getKey(), value);
            }
        }
        return new AsyncViewResource(this, b);
    }
    ...
    implements AsyncViewUniformInterface {
        ...
        private ClientRequest build(String method) {
            ClientRequestImpl ro = new ClientRequestImpl(AsyncViewResource.this.u, method, this.entity, this.metadata);
            this.entity = null;
            this.metadata = null;
            return ro;
        }
        ...
        private ClientRequest build(String method, Object e) {
            ClientRequestImpl ro = new ClientRequestImpl(AsyncViewResource.this.u, method, e, this.metadata);
            this.entity = null;
            this.metadata = null;
            return ro;
        }
