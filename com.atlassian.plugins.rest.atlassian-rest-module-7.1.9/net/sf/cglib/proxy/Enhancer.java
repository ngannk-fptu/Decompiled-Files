...
extends AbstractClassGenerator {
    ...
    private static final EnhancerKey KEY_FACTORY = (EnhancerKey)((Object)KeyFactory.create(class$net$sf$cglib$proxy$Enhancer$EnhancerKey == null ? (class$net$sf$cglib$proxy$Enhancer$EnhancerKey = Enhancer.class$("net.sf.cglib.proxy.Enhancer$EnhancerKey")) : class$net$sf$cglib$proxy$Enhancer$EnhancerKey));
    ...
    private static final Type CALLBACK_ARRAY = Type.getType(array$Lnet$sf$cglib$proxy$Callback == null ? (array$Lnet$sf$cglib$proxy$Callback = Enhancer.class$("[Lnet.sf.cglib.proxy.Callback;")) : array$Lnet$sf$cglib$proxy$Callback);
