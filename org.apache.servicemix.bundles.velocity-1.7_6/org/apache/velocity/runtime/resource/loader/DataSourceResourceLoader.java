...
extends ResourceLoader {
    ...
    public synchronized InputStream getResourceStream(String name) throws ResourceNotFoundException {
        ...
        block8: {
            ...
            ps = this.getStatement(conn, this.templateColumn, name);
            rs = ps.executeQuery();
    ...
    private long readLastModified(Resource resource, String operation) {
        ...
        try {
            conn = this.openDbConnection();
            ps = this.getStatement(conn, this.timestampColumn, name);
            rs = ps.executeQuery();
            if (!rs.next()) {
    ...
    private PreparedStatement getStatement(Connection conn, String columnNames, String templateName) throws SQLException {
