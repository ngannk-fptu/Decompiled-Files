    ...
    private void process(String xmlFile, Document projectDocument) throws BuildException {
        block27: {
            ...
            block26: {
                ...
                if (this.lastModifiedCheck && inFile.lastModified() <= outFile.lastModified() && this.styleSheetLastModified <= outFile.lastModified() && this.projectFileLastModified <= outFile.lastModified() && !this.userContextsModifed(outFile.lastModified())) break block26;
