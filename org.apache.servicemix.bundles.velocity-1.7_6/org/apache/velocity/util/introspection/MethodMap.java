...
public class MethodMap {
    ...
    private static int compare(Class[] c1, Class[] c2) {
        ...
        for (int i = 0; i < c1.length; ++i) {
            ...
            boolean bl = last = i == c1.length - 1;
            boolean bl2 = c1MoreSpecific || MethodMap.isStrictConvertible(c2[i], c1[i], last) || c2[i] == (class$java$lang$Object == null ? MethodMap.class$("java.lang.Object") : class$java$lang$Object) ? true : (c1MoreSpecific = false);
            c2MoreSpecific = c2MoreSpecific || MethodMap.isStrictConvertible(c1[i], c2[i], last) || c1[i] == (class$java$lang$Object == null ? MethodMap.class$("java.lang.Object") : class$java$lang$Object);
        }
        if (c1MoreSpecific) {
            if (c2MoreSpecific) {
