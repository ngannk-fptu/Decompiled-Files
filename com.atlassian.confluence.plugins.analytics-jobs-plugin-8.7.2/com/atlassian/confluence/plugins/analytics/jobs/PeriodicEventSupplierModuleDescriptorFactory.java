...
@Component
public class PeriodicEventSupplierModuleDescriptorFactory
extends SingleModuleDescriptorFactory<PeriodicEventSupplierModuleDescriptor> {
    @Autowired
    public PeriodicEventSupplierModuleDescriptorFactory(HostContainer hostContainer) {
        super(hostContainer, "periodic-analytics-event", PeriodicEventSupplierModuleDescriptor.class);
    }
}
