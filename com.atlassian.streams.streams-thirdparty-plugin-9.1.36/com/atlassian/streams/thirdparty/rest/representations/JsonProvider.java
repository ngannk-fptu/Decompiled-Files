...
@Provider
@Produces(value={"application/json", "application/vnd.atl.streams.thirdparty+json"})
@Consumes(value={"application/json", "application/vnd.atl.streams.thirdparty+json"})
...
MessageBodyWriter<Object> {
    ...
    public JsonProvider() {
        ...
        this.provider.configure(SerializationConfig.Feature.WRITE_DATES_AS_TIMESTAMPS, false);
