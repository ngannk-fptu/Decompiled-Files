...
public class SecretsManagerServiceClientConfigurationBuilder {
    ...
    implements BuilderInternal {
        ...
        public SecretsManagerAuthSchemeProvider authSchemeProvider() {
            ...
            return (SecretsManagerAuthSchemeProvider)Validate.isInstanceOf(SecretsManagerAuthSchemeProvider.class, (Object)result, (String)("Expected an instance of " + SecretsManagerAuthSchemeProvider.class.getSimpleName()), (Object[])new Object[0]);
        }
