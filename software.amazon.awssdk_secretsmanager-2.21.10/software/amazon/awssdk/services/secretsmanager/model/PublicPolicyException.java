...
public final class PublicPolicyException
extends SecretsManagerException
implements ToCopyableBuilder<Builder, PublicPolicyException> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));
    private static final long serialVersionUID = 1L;

    private PublicPolicyException(BuilderImpl builder) {
        super(builder);
    }
    ...
    implements Builder {
        ...
        private BuilderImpl(PublicPolicyException model) {
            super(model);
        }
        ...
        @Override
        public PublicPolicyException build() {
            return new PublicPolicyException(this);
        }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, PublicPolicyException>,
