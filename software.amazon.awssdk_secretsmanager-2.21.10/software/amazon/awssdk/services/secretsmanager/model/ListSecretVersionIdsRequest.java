...
implements ToCopyableBuilder<Builder, ListSecretVersionIdsRequest> {
    private static final SdkField<String> SECRET_ID_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("SecretId").getter(ListSecretVersionIdsRequest.getter(ListSecretVersionIdsRequest::secretId)).setter(ListSecretVersionIdsRequest.setter(Builder::secretId)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretId").build()}).build();
    private static final SdkField<Integer> MAX_RESULTS_FIELD = SdkField.builder((MarshallingType)MarshallingType.INTEGER).memberName("MaxResults").getter(ListSecretVersionIdsRequest.getter(ListSecretVersionIdsRequest::maxResults)).setter(ListSecretVersionIdsRequest.setter(Builder::maxResults)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("MaxResults").build()}).build();
    private static final SdkField<String> NEXT_TOKEN_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("NextToken").getter(ListSecretVersionIdsRequest.getter(ListSecretVersionIdsRequest::nextToken)).setter(ListSecretVersionIdsRequest.setter(Builder::nextToken)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("NextToken").build()}).build();
    private static final SdkField<Boolean> INCLUDE_DEPRECATED_FIELD = SdkField.builder((MarshallingType)MarshallingType.BOOLEAN).memberName("IncludeDeprecated").getter(ListSecretVersionIdsRequest.getter(ListSecretVersionIdsRequest::includeDeprecated)).setter(ListSecretVersionIdsRequest.setter(Builder::includeDeprecated)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("IncludeDeprecated").build()}).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        ListSecretVersionIdsRequest other = (ListSecretVersionIdsRequest)((Object)obj);
    ...
    public final String toString() {
        return ToString.builder((String)"ListSecretVersionIdsRequest").add("SecretId", (Object)this.secretId()).add("MaxResults", (Object)this.maxResults()).add("NextToken", (Object)this.nextToken()).add("IncludeDeprecated", (Object)this.includeDeprecated()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<ListSecretVersionIdsRequest, T> g) {
        return obj -> g.apply((ListSecretVersionIdsRequest)((Object)((Object)obj)));
    }
