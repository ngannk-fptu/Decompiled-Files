...
implements ToCopyableBuilder<Builder, ValidateResourcePolicyRequest> {
    private static final SdkField<String> SECRET_ID_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("SecretId").getter(ValidateResourcePolicyRequest.getter(ValidateResourcePolicyRequest::secretId)).setter(ValidateResourcePolicyRequest.setter(Builder::secretId)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretId").build()}).build();
    private static final SdkField<String> RESOURCE_POLICY_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("ResourcePolicy").getter(ValidateResourcePolicyRequest.getter(ValidateResourcePolicyRequest::resourcePolicy)).setter(ValidateResourcePolicyRequest.setter(Builder::resourcePolicy)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ResourcePolicy").build()}).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        ValidateResourcePolicyRequest other = (ValidateResourcePolicyRequest)((Object)obj);
        return Objects.equals(this.secretId(), other.secretId()) && Objects.equals(this.resourcePolicy(), other.resourcePolicy());
    }

    public final String toString() {
        return ToString.builder((String)"ValidateResourcePolicyRequest").add("SecretId", (Object)this.secretId()).add("ResourcePolicy", (Object)this.resourcePolicy()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<ValidateResourcePolicyRequest, T> g) {
        return obj -> g.apply((ValidateResourcePolicyRequest)((Object)((Object)obj)));
    }
