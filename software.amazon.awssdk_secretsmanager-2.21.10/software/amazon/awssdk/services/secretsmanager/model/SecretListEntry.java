...
ToCopyableBuilder<Builder, SecretListEntry> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("ARN").getter(SecretListEntry.getter(SecretListEntry::arn)).setter(SecretListEntry.setter(Builder::arn)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()}).build();
    private static final SdkField<String> NAME_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("Name").getter(SecretListEntry.getter(SecretListEntry::name)).setter(SecretListEntry.setter(Builder::name)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Name").build()}).build();
    private static final SdkField<String> DESCRIPTION_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("Description").getter(SecretListEntry.getter(SecretListEntry::description)).setter(SecretListEntry.setter(Builder::description)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Description").build()}).build();
    private static final SdkField<String> KMS_KEY_ID_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("KmsKeyId").getter(SecretListEntry.getter(SecretListEntry::kmsKeyId)).setter(SecretListEntry.setter(Builder::kmsKeyId)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("KmsKeyId").build()}).build();
    private static final SdkField<Boolean> ROTATION_ENABLED_FIELD = SdkField.builder((MarshallingType)MarshallingType.BOOLEAN).memberName("RotationEnabled").getter(SecretListEntry.getter(SecretListEntry::rotationEnabled)).setter(SecretListEntry.setter(Builder::rotationEnabled)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RotationEnabled").build()}).build();
    private static final SdkField<String> ROTATION_LAMBDA_ARN_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("RotationLambdaARN").getter(SecretListEntry.getter(SecretListEntry::rotationLambdaARN)).setter(SecretListEntry.setter(Builder::rotationLambdaARN)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RotationLambdaARN").build()}).build();
    private static final SdkField<RotationRulesType> ROTATION_RULES_FIELD = SdkField.builder((MarshallingType)MarshallingType.SDK_POJO).memberName("RotationRules").getter(SecretListEntry.getter(SecretListEntry::rotationRules)).setter(SecretListEntry.setter(Builder::rotationRules)).constructor(RotationRulesType::builder).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RotationRules").build()}).build();
    private static final SdkField<Instant> LAST_ROTATED_DATE_FIELD = SdkField.builder((MarshallingType)MarshallingType.INSTANT).memberName("LastRotatedDate").getter(SecretListEntry.getter(SecretListEntry::lastRotatedDate)).setter(SecretListEntry.setter(Builder::lastRotatedDate)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("LastRotatedDate").build()}).build();
    private static final SdkField<Instant> LAST_CHANGED_DATE_FIELD = SdkField.builder((MarshallingType)MarshallingType.INSTANT).memberName("LastChangedDate").getter(SecretListEntry.getter(SecretListEntry::lastChangedDate)).setter(SecretListEntry.setter(Builder::lastChangedDate)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("LastChangedDate").build()}).build();
    private static final SdkField<Instant> LAST_ACCESSED_DATE_FIELD = SdkField.builder((MarshallingType)MarshallingType.INSTANT).memberName("LastAccessedDate").getter(SecretListEntry.getter(SecretListEntry::lastAccessedDate)).setter(SecretListEntry.setter(Builder::lastAccessedDate)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("LastAccessedDate").build()}).build();
    private static final SdkField<Instant> DELETED_DATE_FIELD = SdkField.builder((MarshallingType)MarshallingType.INSTANT).memberName("DeletedDate").getter(SecretListEntry.getter(SecretListEntry::deletedDate)).setter(SecretListEntry.setter(Builder::deletedDate)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("DeletedDate").build()}).build();
    private static final SdkField<Instant> NEXT_ROTATION_DATE_FIELD = SdkField.builder((MarshallingType)MarshallingType.INSTANT).memberName("NextRotationDate").getter(SecretListEntry.getter(SecretListEntry::nextRotationDate)).setter(SecretListEntry.setter(Builder::nextRotationDate)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("NextRotationDate").build()}).build();
    private static final SdkField<List<Tag>> TAGS_FIELD = SdkField.builder((MarshallingType)MarshallingType.LIST).memberName("Tags").getter(SecretListEntry.getter(SecretListEntry::tags)).setter(SecretListEntry.setter(Builder::tags)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Tags").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder((MarshallingType)MarshallingType.SDK_POJO).constructor(Tag::builder).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()}).build()).build()}).build();
    private static final SdkField<Map<String, List<String>>> SECRET_VERSIONS_TO_STAGES_FIELD = SdkField.builder((MarshallingType)MarshallingType.MAP).memberName("SecretVersionsToStages").getter(SecretListEntry.getter(SecretListEntry::secretVersionsToStages)).setter(SecretListEntry.setter(Builder::secretVersionsToStages)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretVersionsToStages").build(), MapTrait.builder().keyLocationName("key").valueLocationName("value").valueFieldInfo(SdkField.builder((MarshallingType)MarshallingType.LIST).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("value").build(), ListTrait.builder().memberLocationName(null).memberFieldInfo(SdkField.builder((MarshallingType)MarshallingType.STRING).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("member").build()}).build()).build()}).build()).build()}).build();
    private static final SdkField<String> OWNING_SERVICE_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("OwningService").getter(SecretListEntry.getter(SecretListEntry::owningService)).setter(SecretListEntry.setter(Builder::owningService)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("OwningService").build()}).build();
    private static final SdkField<Instant> CREATED_DATE_FIELD = SdkField.builder((MarshallingType)MarshallingType.INSTANT).memberName("CreatedDate").getter(SecretListEntry.getter(SecretListEntry::createdDate)).setter(SecretListEntry.setter(Builder::createdDate)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("CreatedDate").build()}).build();
    private static final SdkField<String> PRIMARY_REGION_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("PrimaryRegion").getter(SecretListEntry.getter(SecretListEntry::primaryRegion)).setter(SecretListEntry.setter(Builder::primaryRegion)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("PrimaryRegion").build()}).build();
