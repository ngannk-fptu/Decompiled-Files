...
public final class TagResourceResponse
extends SecretsManagerResponse
implements ToCopyableBuilder<Builder, TagResourceResponse> {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return obj instanceof TagResourceResponse;
    }

    public final String toString() {
        return ToString.builder((String)"TagResourceResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, TagResourceResponse> {
    }
}
