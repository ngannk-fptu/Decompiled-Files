...
public final class DecryptionFailureException
extends SecretsManagerException
implements ToCopyableBuilder<Builder, DecryptionFailureException> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));
    private static final long serialVersionUID = 1L;

    private DecryptionFailureException(BuilderImpl builder) {
        super(builder);
    }
    ...
    implements Builder {
        ...
        private BuilderImpl(DecryptionFailureException model) {
            super(model);
        }
        ...
        @Override
        public DecryptionFailureException build() {
            return new DecryptionFailureException(this);
        }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, DecryptionFailureException>,
