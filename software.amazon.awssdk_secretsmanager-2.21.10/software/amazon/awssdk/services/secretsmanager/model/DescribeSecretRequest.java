...
implements ToCopyableBuilder<Builder, DescribeSecretRequest> {
    private static final SdkField<String> SECRET_ID_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("SecretId").getter(DescribeSecretRequest.getter(DescribeSecretRequest::secretId)).setter(DescribeSecretRequest.setter(Builder::secretId)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretId").build()}).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        DescribeSecretRequest other = (DescribeSecretRequest)((Object)obj);
        return Objects.equals(this.secretId(), other.secretId());
    }

    public final String toString() {
        return ToString.builder((String)"DescribeSecretRequest").add("SecretId", (Object)this.secretId()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<DescribeSecretRequest, T> g) {
        return obj -> g.apply((DescribeSecretRequest)((Object)((Object)obj)));
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, DescribeSecretRequest> {
