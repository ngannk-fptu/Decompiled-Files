...
public final class DeleteResourcePolicyRequest
extends SecretsManagerRequest
implements ToCopyableBuilder<Builder, DeleteResourcePolicyRequest> {
    private static final SdkField<String> SECRET_ID_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("SecretId").getter(DeleteResourcePolicyRequest.getter(DeleteResourcePolicyRequest::secretId)).setter(DeleteResourcePolicyRequest.setter(Builder::secretId)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretId").build()}).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        DeleteResourcePolicyRequest other = (DeleteResourcePolicyRequest)((Object)obj);
        return Objects.equals(this.secretId(), other.secretId());
    }

    public final String toString() {
        return ToString.builder((String)"DeleteResourcePolicyRequest").add("SecretId", (Object)this.secretId()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<DeleteResourcePolicyRequest, T> g) {
        return obj -> g.apply((DeleteResourcePolicyRequest)((Object)((Object)obj)));
    }
