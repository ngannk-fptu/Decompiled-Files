...
public final class ResourceExistsException
extends SecretsManagerException
implements ToCopyableBuilder<Builder, ResourceExistsException> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));
    private static final long serialVersionUID = 1L;

    private ResourceExistsException(BuilderImpl builder) {
        super(builder);
    }
    ...
    implements Builder {
        ...
        private BuilderImpl(ResourceExistsException model) {
            super(model);
        }
        ...
        @Override
        public ResourceExistsException build() {
            return new ResourceExistsException(this);
        }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, ResourceExistsException>,
