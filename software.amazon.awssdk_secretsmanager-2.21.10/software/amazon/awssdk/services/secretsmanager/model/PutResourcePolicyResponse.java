...
implements ToCopyableBuilder<Builder, PutResourcePolicyResponse> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("ARN").getter(PutResourcePolicyResponse.getter(PutResourcePolicyResponse::arn)).setter(PutResourcePolicyResponse.setter(Builder::arn)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()}).build();
    ...
    public final String toString() {
        return ToString.builder((String)"PutResourcePolicyResponse").add("ARN", (Object)this.arn()).add("Name", (Object)this.name()).build();
    }
