...
implements ToCopyableBuilder<Builder, RotateSecretResponse> {
    private static final SdkField<String> ARN_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("ARN").getter(RotateSecretResponse.getter(RotateSecretResponse::arn)).setter(RotateSecretResponse.setter(Builder::arn)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("ARN").build()}).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        RotateSecretResponse other = (RotateSecretResponse)((Object)obj);
    ...
    public final String toString() {
        return ToString.builder((String)"RotateSecretResponse").add("ARN", (Object)this.arn()).add("Name", (Object)this.name()).add("VersionId", (Object)this.versionId()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<RotateSecretResponse, T> g) {
        return obj -> g.apply((RotateSecretResponse)((Object)((Object)obj)));
    }
