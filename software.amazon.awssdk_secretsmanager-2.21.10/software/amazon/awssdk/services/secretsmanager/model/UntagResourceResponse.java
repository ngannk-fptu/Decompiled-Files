...
public final class UntagResourceResponse
extends SecretsManagerResponse
implements ToCopyableBuilder<Builder, UntagResourceResponse> {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return obj instanceof UntagResourceResponse;
    }

    public final String toString() {
        return ToString.builder((String)"UntagResourceResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, UntagResourceResponse> {
    }
}
