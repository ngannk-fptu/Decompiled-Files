...
implements Marshaller<GetRandomPasswordRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/").httpMethod(SdkHttpMethod.POST).hasExplicitPayloadMember(false).hasImplicitPayloadMembers(true).hasPayloadMembers(true).operationIdentifier("secretsmanager.GetRandomPassword").build();
    ...
    public SdkHttpFullRequest marshall(GetRandomPasswordRequest getRandomPasswordRequest) {
        ...
        try {
            ...
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)getRandomPasswordRequest);
        }
        catch (Exception e) {
