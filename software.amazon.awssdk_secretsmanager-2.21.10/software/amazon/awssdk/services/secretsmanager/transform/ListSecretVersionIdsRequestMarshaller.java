...
implements Marshaller<ListSecretVersionIdsRequest> {
    ...
    public SdkHttpFullRequest marshall(ListSecretVersionIdsRequest listSecretVersionIdsRequest) {
        Validate.paramNotNull((Object)((Object)listSecretVersionIdsRequest), (String)"listSecretVersionIdsRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)listSecretVersionIdsRequest);
        }
        catch (Exception e) {
