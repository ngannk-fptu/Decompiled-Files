...
implements Marshaller<RemoveRegionsFromReplicationRequest> {
    ...
    public SdkHttpFullRequest marshall(RemoveRegionsFromReplicationRequest removeRegionsFromReplicationRequest) {
        Validate.paramNotNull((Object)((Object)removeRegionsFromReplicationRequest), (String)"removeRegionsFromReplicationRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)removeRegionsFromReplicationRequest);
        }
        catch (Exception e) {
