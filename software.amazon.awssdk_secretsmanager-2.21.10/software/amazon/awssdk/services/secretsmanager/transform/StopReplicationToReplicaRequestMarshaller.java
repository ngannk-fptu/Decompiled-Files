...
implements Marshaller<StopReplicationToReplicaRequest> {
    ...
    public SdkHttpFullRequest marshall(StopReplicationToReplicaRequest stopReplicationToReplicaRequest) {
        Validate.paramNotNull((Object)((Object)stopReplicationToReplicaRequest), (String)"stopReplicationToReplicaRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)stopReplicationToReplicaRequest);
        }
        catch (Exception e) {
