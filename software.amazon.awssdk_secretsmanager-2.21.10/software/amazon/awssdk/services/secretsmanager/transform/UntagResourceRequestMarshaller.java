...
implements Marshaller<UntagResourceRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/").httpMethod(SdkHttpMethod.POST).hasExplicitPayloadMember(false).hasImplicitPayloadMembers(true).hasPayloadMembers(true).operationIdentifier("secretsmanager.UntagResource").build();
    ...
    public SdkHttpFullRequest marshall(UntagResourceRequest untagResourceRequest) {
        ...
        try {
            ...
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)untagResourceRequest);
        }
        catch (Exception e) {
