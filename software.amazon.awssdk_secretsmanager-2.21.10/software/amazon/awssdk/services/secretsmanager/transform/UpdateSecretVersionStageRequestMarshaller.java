...
implements Marshaller<UpdateSecretVersionStageRequest> {
    ...
    public SdkHttpFullRequest marshall(UpdateSecretVersionStageRequest updateSecretVersionStageRequest) {
        Validate.paramNotNull((Object)((Object)updateSecretVersionStageRequest), (String)"updateSecretVersionStageRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)updateSecretVersionStageRequest);
        }
        catch (Exception e) {
