...
implements Marshaller<ValidateResourcePolicyRequest> {
    ...
    public SdkHttpFullRequest marshall(ValidateResourcePolicyRequest validateResourcePolicyRequest) {
        Validate.paramNotNull((Object)((Object)validateResourcePolicyRequest), (String)"validateResourcePolicyRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)validateResourcePolicyRequest);
        }
        catch (Exception e) {
