...
implements Marshaller<ListSecretsRequest> {
    ...
    public SdkHttpFullRequest marshall(ListSecretsRequest listSecretsRequest) {
        Validate.paramNotNull((Object)((Object)listSecretsRequest), (String)"listSecretsRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)listSecretsRequest);
        }
        catch (Exception e) {
