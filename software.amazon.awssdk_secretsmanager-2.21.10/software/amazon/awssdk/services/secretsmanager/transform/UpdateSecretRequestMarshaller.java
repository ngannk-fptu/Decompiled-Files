...
implements Marshaller<UpdateSecretRequest> {
    ...
    public SdkHttpFullRequest marshall(UpdateSecretRequest updateSecretRequest) {
        Validate.paramNotNull((Object)((Object)updateSecretRequest), (String)"updateSecretRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)updateSecretRequest);
        }
        catch (Exception e) {
