...
@SdkPublicApi
public final class UsGovEast1
implements RegionMetadata {
    private static final String ID = "us-gov-east-1";
    private static final String DOMAIN = "amazonaws.com";
    private static final String DESCRIPTION = "AWS GovCloud (US-East)";
    private static final String PARTITION_ID = "aws-us-gov";
