...
@SdkPublicApi
public final class IdentityChimeServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "identity-chime";
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("us-east-1")).tags(EndpointTag.of("fips")).build(), (Object)"identity-chime-fips.us-east-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("us-east-1-fips")).build(), (Object)"identity-chime-fips.us-east-1.amazonaws.com").build();
