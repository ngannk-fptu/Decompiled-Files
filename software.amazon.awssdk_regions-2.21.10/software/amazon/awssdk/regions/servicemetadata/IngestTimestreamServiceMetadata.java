...
@SdkPublicApi
public final class IngestTimestreamServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "ingest.timestream";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-northeast-1"), Region.of("ap-southeast-2"), Region.of("eu-central-1"), Region.of("eu-west-1"), Region.of("us-east-1"), Region.of("us-east-2"), Region.of("us-west-2"), Region.of("us-gov-west-1"), Region.of("us-gov-west-1-fips")));
    ...
    private static final Map<ServiceEndpointKey, String> SIGNING_REGIONS_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("us-gov-west-1-fips")).build(), (Object)"us-gov-west-1").build();
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("us-gov-west-1")).tags(EndpointTag.of("fips")).build(), (Object)"ingest.timestream.us-gov-west-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("us-gov-west-1-fips")).build(), (Object)"ingest.timestream.us-gov-west-1.amazonaws.com").build();
