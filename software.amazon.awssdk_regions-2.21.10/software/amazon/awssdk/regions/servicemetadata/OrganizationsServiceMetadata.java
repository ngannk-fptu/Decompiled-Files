...
implements ServiceMetadata {
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), (Object)"organizations.us-east-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("aws-global")).tags(EndpointTag.of("fips")).build(), (Object)"organizations-fips.us-east-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("fips-aws-global")).build(), (Object)"organizations-fips.us-east-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("aws-cn-global")).build(), (Object)"organizations.cn-northwest-1.amazonaws.com.cn").put((Object)ServiceEndpointKey.builder().region(Region.of("aws-us-gov-global")).build(), (Object)"organizations.us-gov-west-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("aws-us-gov-global")).tags(EndpointTag.of("fips")).build(), (Object)"organizations.us-gov-west-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("fips-aws-us-gov-global")).build(), (Object)"organizations.us-gov-west-1.amazonaws.com").build();
