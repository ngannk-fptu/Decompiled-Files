...
@SdkPublicApi
public final class BedrockServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "bedrock";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-northeast-1"), Region.of("ap-southeast-1"), Region.of("eu-central-1"), Region.of("us-east-1"), Region.of("us-west-2")));
