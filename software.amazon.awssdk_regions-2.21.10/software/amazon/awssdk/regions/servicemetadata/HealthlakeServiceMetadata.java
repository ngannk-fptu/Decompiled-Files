...
@SdkPublicApi
public final class HealthlakeServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "healthlake";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-south-1"), Region.of("us-east-1"), Region.of("us-east-2"), Region.of("us-west-2")));
