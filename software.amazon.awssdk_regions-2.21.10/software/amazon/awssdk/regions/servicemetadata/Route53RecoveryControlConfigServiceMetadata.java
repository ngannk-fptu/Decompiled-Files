...
@SdkPublicApi
public final class Route53RecoveryControlConfigServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "route53-recovery-control-config";
    ...
    private static final Map<ServiceEndpointKey, String> SIGNING_REGIONS_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), (Object)"us-west-2").build();
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), (Object)"route53-recovery-control-config.us-west-2.amazonaws.com").build();
