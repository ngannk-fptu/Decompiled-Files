...
@SdkPublicApi
public final class IotroborunnerServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "iotroborunner";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("eu-central-1"), Region.of("us-east-1")));
