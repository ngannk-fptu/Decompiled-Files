...
@SdkPublicApi
public final class WafServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "waf";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("aws-global"), Region.of("aws-global-fips")));
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), (Object)"waf.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("aws-global")).tags(EndpointTag.of("fips")).build(), (Object)"waf-fips.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("aws-global-fips")).build(), (Object)"waf-fips.amazonaws.com").build();
