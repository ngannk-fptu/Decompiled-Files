...
@SdkPublicApi
public final class TnbServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "tnb";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-northeast-2"), Region.of("ap-southeast-2"), Region.of("ca-central-1"), Region.of("eu-central-1"), Region.of("eu-north-1"), Region.of("eu-south-2"), Region.of("eu-west-3"), Region.of("sa-east-1"), Region.of("us-east-1"), Region.of("us-west-2")));
