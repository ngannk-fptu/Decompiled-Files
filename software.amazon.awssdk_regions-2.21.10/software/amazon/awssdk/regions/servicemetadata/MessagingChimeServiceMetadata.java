...
@SdkPublicApi
public final class MessagingChimeServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "messaging-chime";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("eu-central-1"), Region.of("us-east-1"), Region.of("us-east-1-fips")));
    ...
    private static final Map<ServiceEndpointKey, String> SIGNING_REGIONS_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("us-east-1-fips")).build(), (Object)"us-east-1").build();
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("us-east-1")).tags(EndpointTag.of("fips")).build(), (Object)"messaging-chime-fips.us-east-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("us-east-1-fips")).build(), (Object)"messaging-chime-fips.us-east-1.amazonaws.com").build();
