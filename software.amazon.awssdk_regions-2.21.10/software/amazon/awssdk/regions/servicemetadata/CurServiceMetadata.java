...
@SdkPublicApi
public final class CurServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "cur";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("us-east-1"), Region.of("cn-northwest-1")));
