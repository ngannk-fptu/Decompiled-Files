...
implements ServiceMetadata {
    ...
    private static final Map<Pair<String, PartitionEndpointKey>, String> HOSTNAMES_BY_PARTITION = ImmutableMap.builder().put((Object)Pair.of((Object)"aws-us-gov", (Object)PartitionEndpointKey.builder().tags(EndpointTag.of("fips")).build()), (Object)"autoscaling.{region}.{dnsSuffix}").build();
