...
implements ServiceMetadata {
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("fips-us-gov-east-1")).build(), (Object)"servicequotas.us-gov-east-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("fips-us-gov-west-1")).build(), (Object)"servicequotas.us-gov-west-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("us-gov-east-1")).tags(EndpointTag.of("fips")).build(), (Object)"servicequotas.us-gov-east-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("us-gov-west-1")).tags(EndpointTag.of("fips")).build(), (Object)"servicequotas.us-gov-west-1.amazonaws.com").build();
    private static final Map<Pair<String, PartitionEndpointKey>, String> HOSTNAMES_BY_PARTITION = ImmutableMap.builder().put((Object)Pair.of((Object)"aws-us-gov", (Object)PartitionEndpointKey.builder().tags(EndpointTag.of("fips")).build()), (Object)"servicequotas.{region}.{dnsSuffix}").build();
