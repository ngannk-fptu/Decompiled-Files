...
@SdkPublicApi
public final class CeServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "ce";
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), (Object)"ce.us-east-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("aws-cn-global")).build(), (Object)"ce.cn-northwest-1.amazonaws.com.cn").build();
