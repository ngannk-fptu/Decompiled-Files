...
implements ServiceMetadata {
    ...
    private static final Map<ServiceEndpointKey, String> SIGNING_REGIONS_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), (Object)"us-east-1").put((Object)ServiceEndpointKey.builder().region(Region.of("cn-north-1")).build(), (Object)"cn-north-1").put((Object)ServiceEndpointKey.builder().region(Region.of("cn-northwest-1")).build(), (Object)"cn-northwest-1").build();
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("aws-global")).build(), (Object)"savingsplans.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("cn-north-1")).build(), (Object)"savingsplans.cn-north-1.amazonaws.com.cn").put((Object)ServiceEndpointKey.builder().region(Region.of("cn-northwest-1")).build(), (Object)"savingsplans.cn-northwest-1.amazonaws.com.cn").build();
