...
@SdkPublicApi
public final class ClouddirectoryServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "clouddirectory";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-southeast-1"), Region.of("ap-southeast-2"), Region.of("ca-central-1"), Region.of("eu-central-1"), Region.of("eu-west-1"), Region.of("eu-west-2"), Region.of("us-east-1"), Region.of("us-east-2"), Region.of("us-west-2"), Region.of("us-gov-west-1"), Region.of("us-gov-west-1-fips")));
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("us-gov-west-1")).tags(EndpointTag.of("fips")).build(), (Object)"clouddirectory.us-gov-west-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("us-gov-west-1-fips")).build(), (Object)"clouddirectory.us-gov-west-1.amazonaws.com").build();
