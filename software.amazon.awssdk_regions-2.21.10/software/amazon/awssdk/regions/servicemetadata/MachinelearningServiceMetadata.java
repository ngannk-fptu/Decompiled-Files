...
@SdkPublicApi
public final class MachinelearningServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "machinelearning";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("eu-west-1"), Region.of("us-east-1")));
