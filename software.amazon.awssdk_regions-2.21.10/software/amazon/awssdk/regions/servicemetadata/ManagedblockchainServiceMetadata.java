...
@SdkPublicApi
public final class ManagedblockchainServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "managedblockchain";
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("ap-northeast-1"), Region.of("ap-northeast-2"), Region.of("ap-southeast-1"), Region.of("eu-west-1"), Region.of("eu-west-2"), Region.of("us-east-1"), Region.of("us-gov-west-1")));
