...
@SdkPublicApi
public final class SsoServiceMetadata
implements ServiceMetadata {
    private static final String ENDPOINT_PREFIX = "sso";
    ...
    private static final Map<ServiceEndpointKey, String> HOSTNAMES_BY_REGION = ImmutableMap.builder().put((Object)ServiceEndpointKey.builder().region(Region.of("us-gov-east-1")).build(), (Object)"sso.us-gov-east-1.amazonaws.com").put((Object)ServiceEndpointKey.builder().region(Region.of("us-gov-west-1")).build(), (Object)"sso.us-gov-west-1.amazonaws.com").build();
