...
implements PartitionMetadata {
    private static final Map<PartitionEndpointKey, String> DNS_SUFFIXES = ImmutableMap.builder().put((Object)PartitionEndpointKey.builder().build(), (Object)"sc2s.sgov.gov").put((Object)PartitionEndpointKey.builder().tags(EndpointTag.of("fips")).build(), (Object)"sc2s.sgov.gov").build();
