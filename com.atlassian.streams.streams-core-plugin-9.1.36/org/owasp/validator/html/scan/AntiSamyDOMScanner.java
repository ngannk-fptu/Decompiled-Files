...
extends AbstractAntiSamyScanner {
    ...
    public CleanResults scan(String html) throws ScanException {
        ...
        try {
            ...
            balancer = blocksToIsolate.isEmpty() ? new CustomizableHTMLTagBalancer(AntiSamyDOMScanner.getDomParser().getHtmlConfiguration()) : new BlockIsolatingTagBalancer(blocksToIsolate, AntiSamyDOMScanner.getDomParser().getHtmlConfiguration());
            parser.setProperty("http://cyberneko.org/html/properties/filters", new XMLDocumentFilter[]{balancer});
