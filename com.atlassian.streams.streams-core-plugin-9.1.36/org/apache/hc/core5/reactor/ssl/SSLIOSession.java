...
implements IOSession {
    ...
    public SSLIOSession(NamedEndpoint targetEndpoint, final IOSession session, SSLMode sslMode, SSLContext sslContext, SSLBufferMode sslBufferMode, SSLSessionInitializer initializer, SSLSessionVerifier verifier, Callback<SSLIOSession> sessionStartCallback, Callback<SSLIOSession> sessionEndCallback, Timeout connectTimeout) {
        ...
        this.internalEventHandler = new IOEventHandler(){
            ...
            public void connected(IOSession protocolSession) throws IOException {
                if (SSLIOSession.this.handshakeStateRef.compareAndSet(TLSHandShakeState.READY, TLSHandShakeState.INITIALIZED)) {
                    SSLIOSession.this.initialize(protocolSession);
                }
            }
