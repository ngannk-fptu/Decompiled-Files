...
implements HttpClientConnectionManager {
    ...
    private void checkExpiry() {
        if (this.conn != null && System.currentTimeMillis() >= this.expiry) {
            if (LOG.isDebugEnabled()) {
                LOG.debug("{} Connection expired @ {}", (Object)this.id, (Object)new Date(this.expiry));
            }
    ...
    private void validate() {
        TimeValue validateAfterInactivitySnapshot = this.validateAfterInactivity;
        if (this.conn != null && TimeValue.isNonNegative(validateAfterInactivitySnapshot) && this.updated + validateAfterInactivitySnapshot.toMilliseconds() <= System.currentTimeMillis()) {
            boolean stale;
            try {
