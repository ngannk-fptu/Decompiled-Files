...
implements UserTokenHandler {
    ...
    public Object getUserToken(HttpRoute route, HttpContext context) {
        ...
        HttpRequest request = (clientContext = HttpClientContext.adapt(context)).getRequest();
        HttpHost target = request != null ? new HttpHost(request.getScheme(), request.getAuthority()) : route.getTargetHost();
