...
public final class ExceptionConst {
    ...
    private static final Class<?>[] EXCS_CLASS_AND_INTERFACE_RESOLUTION = new Class[]{NO_CLASS_DEF_FOUND_ERROR, CLASS_FORMAT_ERROR, VERIFY_ERROR, ABSTRACT_METHOD_ERROR, EXCEPTION_IN_INITIALIZER_ERROR, ILLEGAL_ACCESS_ERROR};
    private static final Class<?>[] EXCS_FIELD_AND_METHOD_RESOLUTION = new Class[]{NO_SUCH_FIELD_ERROR, ILLEGAL_ACCESS_ERROR, NO_SUCH_METHOD_ERROR};
    ...
    private static final Class<?>[] EXCS_ARRAY_EXCEPTION = new Class[]{NULL_POINTER_EXCEPTION, ARRAY_INDEX_OUT_OF_BOUNDS_EXCEPTION};

    public static Class<?>[] createExceptions(EXCS type, Class<?> ... extraClasses) {
        switch (type) {
            case EXCS_CLASS_AND_INTERFACE_RESOLUTION: {
                return ExceptionConst.mergeExceptions(EXCS_CLASS_AND_INTERFACE_RESOLUTION, extraClasses);
            }
            case EXCS_ARRAY_EXCEPTION: {
                return ExceptionConst.mergeExceptions(EXCS_ARRAY_EXCEPTION, extraClasses);
            }
            case EXCS_FIELD_AND_METHOD_RESOLUTION: {
                return ExceptionConst.mergeExceptions(EXCS_FIELD_AND_METHOD_RESOLUTION, extraClasses);
            }
            case EXCS_INTERFACE_METHOD_RESOLUTION: {
                return ExceptionConst.mergeExceptions(EXCS_INTERFACE_METHOD_RESOLUTION, extraClasses);
            }
            case EXCS_STRING_RESOLUTION: {
                return ExceptionConst.mergeExceptions(EXCS_STRING_RESOLUTION, extraClasses);
            }
        }
        throw new AssertionError((Object)("Cannot happen; unexpected enum value: " + (Object)((Object)type)));
    }

    private static Class<?>[] mergeExceptions(Class<?>[] input, Class<?> ... extraClasses) {
        return (Class[])ArrayUtils.addAll((Object[])input, (Object[])extraClasses);
    }

    public static enum EXCS {
