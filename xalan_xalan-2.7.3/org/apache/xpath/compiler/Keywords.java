...
public class Keywords {
    ...
    static {
        ...
        m_nodetypes.put(NODETYPE_COMMENT_STRING, new Integer(1030));
        m_nodetypes.put(NODETYPE_TEXT_STRING, new Integer(1031));
        m_nodetypes.put(NODETYPE_PI_STRING, new Integer(1032));
        m_nodetypes.put(NODETYPE_NODE_STRING, new Integer(1033));
        ...
        m_nodetests.put(NODETYPE_COMMENT_STRING, new Integer(1030));
        m_nodetests.put(NODETYPE_TEXT_STRING, new Integer(1031));
        m_nodetests.put(NODETYPE_PI_STRING, new Integer(1032));
        m_nodetests.put(NODETYPE_NODE_STRING, new Integer(1033));
    }
}
