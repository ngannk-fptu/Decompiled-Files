...
extends InstructionConstants {
    ...
    public static final String KEY_INDEX_ITERATOR_SIG = "Lorg/apache/xalan/xsltc/dom/KeyIndex$KeyIndexIterator;";
    ...
    public static final String ATTR_SET_SIG = "(Lorg/apache/xalan/xsltc/DOM;Lorg/apache/xml/dtm/DTMAxisIterator;" + TRANSLET_OUTPUT_SIG + ")V";
    public static final String GET_NODE_NAME_SIG = "(I)Ljava/lang/String;";
    public static final String CHARACTERSW_SIG = "(Ljava/lang/String;" + TRANSLET_OUTPUT_SIG + ")V";
    public static final String CHARACTERS_SIG = "(I" + TRANSLET_OUTPUT_SIG + ")V";
    ...
    public static final String PREFIX_URIS_ARRAY_SIG = "[Ljava/lang/String;";
    ...
    public static final String LOOKUP_STYLESHEET_QNAME_NS_SIG = "(Ljava/lang/String;I[I[I[Ljava/lang/String;Z)Ljava/lang/String;";
    public static final String EXPAND_STYLESHEET_QNAME_REF = "expandStylesheetQNameRef";
    public static final String EXPAND_STYLESHEET_QNAME_SIG = "(Ljava/lang/String;I[I[I[Ljava/lang/String;Z)Ljava/lang/String;";
