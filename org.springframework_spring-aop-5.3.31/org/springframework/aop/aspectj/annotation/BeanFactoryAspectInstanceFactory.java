...
Serializable {
    ...
    public BeanFactoryAspectInstanceFactory(BeanFactory beanFactory, String name, @Nullable Class<?> type) {
        ...
        if (type == null) {
            ...
            Assert.notNull((Object)resolvedType, (String)"Unresolvable bean type - explicitly specify the aspect class");
        }
    ...
    public int getOrder() {
        ...
        if (type != null) {
            ...
            return OrderUtils.getOrder((Class)type, (int)Integer.MAX_VALUE);
        }
