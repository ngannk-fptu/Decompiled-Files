...
extends AspectJAwareAdvisorAutoProxyCreator {
    ...
    public void setAspectJAdvisorFactory(AspectJAdvisorFactory aspectJAdvisorFactory) {
        Assert.notNull((Object)aspectJAdvisorFactory, (String)"AspectJAdvisorFactory must not be null");
    ...
    protected void initBeanFactory(ConfigurableListableBeanFactory beanFactory) {
        ...
        if (this.aspectJAdvisorFactory == null) {
            this.aspectJAdvisorFactory = new ReflectiveAspectJAdvisorFactory((BeanFactory)beanFactory);
        }
        this.aspectJAdvisorsBuilder = new BeanFactoryAspectJAdvisorsBuilderAdapter((ListableBeanFactory)beanFactory, this.aspectJAdvisorFactory);
    }
