...
AfterAdvice {
    ...
    public ThrowsAdviceInterceptor(Object throwsAdvice) {
        Method[] methods;
        Assert.notNull((Object)throwsAdvice, (String)"Advice must not be null");
        ...
        for (Method method : methods = throwsAdvice.getClass().getMethods()) {
            ...
            logger.debug((Object)("Found exception handler method on throws advice: " + method));
        }
    ...
    private Method getExceptionHandler(Throwable exception) {
        ...
        if (handler != null && logger.isTraceEnabled()) {
            logger.trace((Object)("Found handler for exception of type [" + exceptionClass.getName() + "]: " + handler));
        }
        return handler;
    }
