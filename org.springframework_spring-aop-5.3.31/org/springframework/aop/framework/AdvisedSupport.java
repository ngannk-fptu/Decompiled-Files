...
implements Advised {
    ...
    public void setAdvisorChainFactory(AdvisorChainFactory advisorChainFactory) {
        Assert.notNull((Object)advisorChainFactory, (String)"AdvisorChainFactory must not be null");
    ...
    public int indexOf(Advisor advisor) {
        Assert.notNull((Object)advisor, (String)"Advisor must not be null");
        return this.advisors.indexOf(advisor);
    }

    @Override
    public boolean replaceAdvisor(Advisor a, Advisor b) throws AopConfigException {
        Assert.notNull((Object)a, (String)"Advisor a must not be null");
        Assert.notNull((Object)b, (String)"Advisor b must not be null");
