...
implements BeanFactoryAware {
    ...
    protected AsyncTaskExecutor determineAsyncExecutor(Method method) {
        ...
        if (executor == null) {
            ...
            Executor targetExecutor = StringUtils.hasLength((String)qualifier) ? this.findQualifiedExecutor(this.beanFactory, qualifier) : (Executor)this.defaultExecutor.get();
