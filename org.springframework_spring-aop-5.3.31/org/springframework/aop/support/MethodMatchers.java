...
public abstract class MethodMatchers {
    ...
    public static boolean matches(MethodMatcher mm, Method method, Class<?> targetClass, boolean hasIntroductions) {
        Assert.notNull((Object)mm, (String)"MethodMatcher must not be null");
    ...
    Serializable {
        ...
        public IntersectionMethodMatcher(MethodMatcher mm1, MethodMatcher mm2) {
            Assert.notNull((Object)mm1, (String)"First MethodMatcher must not be null");
            Assert.notNull((Object)mm2, (String)"Second MethodMatcher must not be null");
            this.mm1 = mm1;
            this.mm2 = mm2;
        }
