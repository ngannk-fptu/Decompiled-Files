...
class WarningValue {
    ...
    protected void consumeWarnDate() {
        ...
        this.offs += m.end();
        this.warnDate = DateUtils.parseDate((String)this.src.substring(curr + 1, this.offs - 1));
    }
    ...
    public String toString() {
        if (this.warnDate != null) {
            return String.format("%d %s %s \"%s\"", this.warnCode, this.warnAgent, this.warnText, DateUtils.formatDate((Date)this.warnDate));
        }
