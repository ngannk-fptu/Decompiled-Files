...
extends AbstractSignaturePattern {
    ...
    public ISignaturePattern parameterizeWith(Map<String, UnresolvedType> typeVariableBindingMap, World world) {
        return new OrSignaturePattern(this.leftSp.parameterizeWith(typeVariableBindingMap, world), this.rightSp.parameterizeWith(typeVariableBindingMap, world));
    }
    ...
    public static ISignaturePattern readOrSignaturePattern(VersionedDataInputStream s, ISourceContext context) throws IOException {
        OrSignaturePattern ret = new OrSignaturePattern(OrSignaturePattern.readCompoundSignaturePattern(s, context), OrSignaturePattern.readCompoundSignaturePattern(s, context));
        s.readInt();
        s.readInt();
        return ret;
    }
