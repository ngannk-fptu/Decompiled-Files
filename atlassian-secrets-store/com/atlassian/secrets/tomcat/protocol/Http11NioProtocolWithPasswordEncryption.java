...
public class Http11NioProtocolWithPasswordEncryption
...
implements ProductTomcatProtocolWithPasswordEncryption {
    ...
    public void setTruststorePass(String truststorePassword) {
        this.passwordsToSet.add(new PasswordDataBean(truststorePassword, x$0 -> super.setTruststorePass(x$0), "TruststorePass"));
    }
