...
SdkAutoCloseable {
    ...
    public String toString() {
        return ToString.builder((String)"ProfileTokenProvider").add("profileName", (Object)this.profileName).build();
    }

    public void close() {
        IoUtils.closeIfCloseable((Object)this.tokenProvider, null);
    }
