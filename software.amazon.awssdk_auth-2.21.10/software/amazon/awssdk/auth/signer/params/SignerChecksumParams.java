...
public class SignerChecksumParams {
    ...
    private SignerChecksumParams(Builder builder) {
        Validate.notNull((Object)builder.algorithm, (String)"algorithm is null", (Object[])new Object[0]);
        Validate.notNull((Object)builder.checksumHeaderName, (String)"checksumHeaderName is null", (Object[])new Object[0]);
