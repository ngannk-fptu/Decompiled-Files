...
Serializable {
    ...
    public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea, ValueAxis domainAxis, ValueAxis rangeAxis, int rendererIndex, PlotRenderingInfo info) {
        ...
        Rectangle2D.Double displayArea = new Rectangle2D.Double((double)j2DX - this.displayWidth / 2.0, (double)j2DY - this.displayHeight / 2.0, this.displayWidth, this.displayHeight);
        AffineTransform savedTransform = g2.getTransform();
        Rectangle2D.Double drawArea = new Rectangle2D.Double(0.0, 0.0, this.displayWidth * this.drawScaleFactor, this.displayHeight * this.drawScaleFactor);
        g2.scale(1.0 / this.drawScaleFactor, 1.0 / this.drawScaleFactor);
        g2.translate(((double)j2DX - this.displayWidth / 2.0) * this.drawScaleFactor, ((double)j2DY - this.displayHeight / 2.0) * this.drawScaleFactor);
