...
Serializable {
    ...
    public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea, ValueAxis domainAxis, ValueAxis rangeAxis, int rendererIndex, PlotRenderingInfo info) {
        ...
        Rectangle2D.Double imageRect = new Rectangle2D.Double(0.0, 0.0, w, h);
        Point2D anchorPoint = RectangleAnchor.coordinates(imageRect, this.anchor);
        g2.drawImage(this.image, (int)(xx -= (float)anchorPoint.getX()), (int)(yy -= (float)anchorPoint.getY()), null);
