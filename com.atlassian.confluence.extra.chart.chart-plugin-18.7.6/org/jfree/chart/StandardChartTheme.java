...
Serializable {
    ...
    protected void applyToCategoryPlot(CategoryPlot plot) {
        ...
        if (plot instanceof CombinedDomainCategoryPlot) {
            ...
            iterator = cp.getSubplots().iterator();
            while (iterator.hasNext()) {
    ...
    protected void applyToXYPlot(XYPlot plot) {
        ...
        if (plot instanceof CombinedDomainXYPlot) {
            ...
            iterator = ((CombinedDomainXYPlot)cp).getSubplots().iterator();
            while (iterator.hasNext()) {
        ...
        if (plot instanceof CombinedRangeXYPlot) {
            ...
            iterator = ((CombinedRangeXYPlot)cp).getSubplots().iterator();
            while (iterator.hasNext()) {
                subplot = (XYPlot)iterator.next();
                if (subplot == null) continue;
                this.applyToPlot(subplot);
    ...
    public boolean equals(Object obj) {
        ...
        return PaintUtilities.equal(this.gridBandAlternatePaint, that.gridBandAlternatePaint);
    }
