...
Serializable {
    ...
    public LegendItem(String label, Paint paint) {
        this(label, null, null, null, (Shape)new Rectangle2D.Double(-4.0, -4.0, 8.0, 8.0), paint);
    }

    public LegendItem(String label, String description, String toolTipText, String urlText, Shape shape, Paint fillPaint) {
        this(label, description, toolTipText, urlText, true, shape, true, fillPaint, false, (Paint)Color.black, UNUSED_STROKE, false, UNUSED_SHAPE, UNUSED_STROKE, (Paint)Color.black);
    }
    ...
    public LegendItem(String label, String description, String toolTipText, String urlText, Shape shape, Paint fillPaint, Stroke outlineStroke, Paint outlinePaint) {
        this(label, description, toolTipText, urlText, true, shape, true, fillPaint, true, outlinePaint, outlineStroke, false, UNUSED_SHAPE, UNUSED_STROKE, (Paint)Color.black);
    }
    ...
    public LegendItem(String label, String description, String toolTipText, String urlText, Shape line, Stroke lineStroke, Paint linePaint) {
        this(label, description, toolTipText, urlText, false, UNUSED_SHAPE, false, (Paint)Color.black, false, (Paint)Color.black, UNUSED_STROKE, true, line, lineStroke, linePaint);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return PaintUtilities.equal(this.labelPaint, that.labelPaint);
    }
