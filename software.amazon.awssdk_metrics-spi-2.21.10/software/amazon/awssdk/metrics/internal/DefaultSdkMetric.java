...
implements SdkMetric<T> {
    ...
    private DefaultSdkMetric(String name, Class<T> clzz, MetricLevel level, Set<MetricCategory> categories) {
        super(clzz);
        this.name = (String)Validate.notBlank((CharSequence)name, (String)"name must not be blank", (Object[])new Object[0]);
        this.clzz = (Class)Validate.notNull(clzz, (String)"clzz must not be null", (Object[])new Object[0]);
        this.level = (MetricLevel)((Object)Validate.notNull((Object)((Object)level), (String)"level must not be null", (Object[])new Object[0]));
        Validate.notEmpty(categories, (String)"categories must not be empty", (Object[])new Object[0]);
    ...
    public String toString() {
        return ToString.builder((String)"DefaultMetric").add("name", (Object)this.name).add("categories", this.categories()).build();
    }
    ...
    public static <T> SdkMetric<T> create(String name, Class<T> clzz, MetricLevel level, Set<MetricCategory> categories) {
        Validate.noNullElements(categories, (String)"categories must not contain null elements", (Object[])new Object[0]);
