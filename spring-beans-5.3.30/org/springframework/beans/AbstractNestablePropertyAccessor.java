...
extends AbstractPropertyAccessor {
    ...
    public void setWrappedInstance(Object object, @Nullable String nestedPath, @Nullable Object rootObject) {
        this.wrappedObject = ObjectUtils.unwrapOptional((Object)object);
        Assert.notNull((Object)this.wrappedObject, (String)"Target object must not be null");
    ...
    public final Object getWrappedInstance() {
        Assert.state((this.wrappedObject != null ? 1 : 0) != 0, (String)"No wrapped object");
    ...
    public final Object getRootInstance() {
        Assert.state((this.rootObject != null ? 1 : 0) != 0, (String)"No root object");
    ...
    private void processKeyedProperty(PropertyTokenHolder tokens, PropertyValue pv) {
        ...
        Assert.state((tokens.keys != null ? 1 : 0) != 0, (String)"No token keys");
    ...
    private Object getPropertyHoldingValue(PropertyTokenHolder tokens) {
        ...
        try {
            ...
            throw new NotWritablePropertyException(this.getRootClass(), this.nestedPath + tokens.canonicalName, "Cannot access indexed value in property referenced in indexed property path '" + tokens.canonicalName + "'", (Throwable)((Object)ex));
        }
        if (propValue == null) {
        ...
        if (ph == null || !ph.isWritable()) {
            if (pv.isOptional()) {
                if (logger.isDebugEnabled()) {
                    logger.debug((Object)("Ignoring optional value for property '" + tokens.actualName + "' - property not found on bean class [" + this.getRootClass().getName() + "]"));
                }
                return;
            }
                    ...
                    block17: {
                        if (this.isExtractOldValueForEditor() && ph.isReadable()) {
                            try {
                                ...
                                logger.debug((Object)("Could not read previous value of property '" + this.nestedPath + tokens.canonicalName + "'"), (Throwable)ex);
                            }
                        }
                    }
    ...
    protected Object getPropertyValue(PropertyTokenHolder tokens) throws BeansException {
        ...
        try {
            ...
            if (tokens.keys != null) {
                ...
                for (int i = 0; i < tokens.keys.length; ++i) {
                    ...
                    if (value.getClass().isArray()) {
                        ...
                        TypeDescriptor typeDescriptor = TypeDescriptor.valueOf((Class)mapKeyType);
            ...
            throw new InvalidPropertyException(this.getRootClass(), this.nestedPath + propertyName, "Invalid index in property path '" + propertyName + "'", (Throwable)ex);
        }
        catch (InvocationTargetException ex) {
    ...
    private Object growArrayIfNecessary(Object array, int index, String name) {
        ...
        if (index >= length && index < this.autoGrowCollectionLimit) {
            ...
            Assert.state((defaultValue != null ? 1 : 0) != 0, (String)"Default value must not be null");
            return defaultValue;
        }
        return array;
    }
    ...
    private AbstractNestablePropertyAccessor getNestedPropertyAccessor(String nestedProperty) {
        ...
        if ((nestedPa = this.nestedPropertyAccessors.get(canonicalName)) == null || nestedPa.getWrappedInstance() != ObjectUtils.unwrapOptional((Object)value)) {
            if (logger.isTraceEnabled()) {
                logger.trace((Object)("Creating new nested " + this.getClass().getSimpleName() + " for property '" + canonicalName + "'"));
            }
            ...
            logger.trace((Object)("Using cached nested property accessor for property '" + canonicalName + "'"));
        }
        return nestedPa;
    }
    ...
    private Object newValue(Class<?> type, @Nullable TypeDescriptor desc, String name) {
        try {
            ...
            if (Collection.class.isAssignableFrom(type)) {
                ...
                return CollectionFactory.createCollection(type, (Class)(elementDesc != null ? elementDesc.getType() : null), (int)16);
            }
            if (Map.class.isAssignableFrom(type)) {
                TypeDescriptor keyDesc = desc != null ? desc.getMapKeyTypeDescriptor() : null;
                return CollectionFactory.createMap(type, (Class)(keyDesc != null ? keyDesc.getType() : null), (int)16);
            }
    ...
    public String toString() {
        ...
        return className + ": wrapping object [" + ObjectUtils.identityToString((Object)this.wrappedObject) + ']';
    }
