...
implements NamespaceHandlerResolver {
    ...
    public DefaultNamespaceHandlerResolver(@Nullable ClassLoader classLoader, String handlerMappingsLocation) {
        Assert.notNull((Object)handlerMappingsLocation, (String)"Handler mappings location must not be null");
    ...
    public NamespaceHandler resolve(String namespaceUri) {
        ...
        try {
            Class handlerClass = ClassUtils.forName((String)className, (ClassLoader)this.classLoader);
            ...
            synchronized (defaultNamespaceHandlerResolver) {
                ...
                if (handlerMappings == null) {
                    if (this.logger.isTraceEnabled()) {
                        this.logger.trace((Object)("Loading NamespaceHandler mappings from [" + this.handlerMappingsLocation + "]"));
                    }
                    try {
                        Properties mappings = PropertiesLoaderUtils.loadAllProperties((String)this.handlerMappingsLocation, (ClassLoader)this.classLoader);
                        if (this.logger.isTraceEnabled()) {
                            this.logger.trace((Object)("Loaded NamespaceHandler mappings: " + mappings));
                        }
