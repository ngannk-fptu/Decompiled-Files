            ...
            if (systemId != null) {
                ...
                if (resourceLocation != null) {
                    ...
                    try {
                        ...
                        if (logger.isTraceEnabled()) {
                            logger.trace((Object)("Found XML schema [" + systemId + "] in classpath: " + resourceLocation));
                        }
                        return source;
                    }
                    catch (FileNotFoundException ex) {
                        if (!logger.isDebugEnabled()) break block7;
                        logger.debug((Object)("Could not find XML schema [" + systemId + "]: " + resource), (Throwable)ex);
                    }
                }
            }
        }
    ...
    private Map<String, String> getSchemaMappings() {
        ...
        if (schemaMappings == null) {
            ...
            synchronized (pluggableSchemaResolver) {
                ...
                if (schemaMappings == null) {
                    if (logger.isTraceEnabled()) {
                        logger.trace((Object)("Loading schema mappings from [" + this.schemaMappingsLocation + "]"));
                    }
                    try {
                        Properties mappings = PropertiesLoaderUtils.loadAllProperties((String)this.schemaMappingsLocation, (ClassLoader)this.classLoader);
                        if (logger.isTraceEnabled()) {
                            logger.trace((Object)("Loaded schema mappings: " + mappings));
                        }
