...
extends SimpleInstantiationStrategy {
    ...
    implements MethodInterceptor {
        ...
        public Object intercept(Object obj, Method method, Object[] args, MethodProxy mp) throws Throwable {
            ...
            Assert.state((ro != null ? 1 : 0) != 0, (String)"ReplaceOverride not found");
    ...
    implements MethodInterceptor {
        ...
        public Object intercept(Object obj, Method method, Object[] args, MethodProxy mp) throws Throwable {
            ...
            Assert.state((lo != null ? 1 : 0) != 0, (String)"LookupOverride not found");
            Object object = argsToUse = args.length > 0 ? args : null;
            if (StringUtils.hasText((String)lo.getBeanName())) {
                Object bean = argsToUse != null ? this.owner.getBean(lo.getBeanName(), argsToUse) : this.owner.getBean(lo.getBeanName());
                return bean.equals(null) ? null : bean;
            }
            ResolvableType genericReturnType = ResolvableType.forMethodReturnType((Method)method);
    ...
    private static class CglibSubclassCreator {
        ...
        private Class<?> createEnhancedSubclass(RootBeanDefinition beanDefinition) {
            ...
            if (this.owner instanceof ConfigurableBeanFactory) {
                ...
                enhancer.setStrategy((GeneratorStrategy)new ClassLoaderAwareGeneratorStrategy(cl));
            }
