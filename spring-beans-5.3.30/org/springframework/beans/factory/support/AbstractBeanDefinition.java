...
Cloneable {
    ...
    public void overrideFrom(BeanDefinition other) {
        if (StringUtils.hasLength((String)other.getBeanClassName())) {
            this.setBeanClassName(other.getBeanClassName());
        }
        if (StringUtils.hasLength((String)other.getScope())) {
            this.setScope(other.getScope());
        }
        this.setAbstract(other.isAbstract());
        if (StringUtils.hasLength((String)other.getFactoryBeanName())) {
            this.setFactoryBeanName(other.getFactoryBeanName());
        }
        if (StringUtils.hasLength((String)other.getFactoryMethodName())) {
    ...
    public Class<?> resolveBeanClass(@Nullable ClassLoader classLoader) throws ClassNotFoundException {
        ...
        Class resolvedClass = ClassUtils.forName((String)className, (ClassLoader)classLoader);
    ...
    protected void prepareMethodOverride(MethodOverride mo) throws BeanDefinitionValidationException {
        int count = ClassUtils.getMethodCountForName(this.getBeanClass(), (String)mo.getMethodName());
        if (count == 0) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return ObjectUtils.nullSafeEquals((Object)this.getBeanClassName(), (Object)that.getBeanClassName()) && ObjectUtils.nullSafeEquals((Object)this.scope, (Object)that.scope) && this.abstractFlag == that.abstractFlag && this.lazyInit == that.lazyInit && this.autowireMode == that.autowireMode && this.dependencyCheck == that.dependencyCheck && Arrays.equals(this.dependsOn, that.dependsOn) && this.autowireCandidate == that.autowireCandidate && ObjectUtils.nullSafeEquals(this.qualifiers, that.qualifiers) && this.primary == that.primary && this.nonPublicAccessAllowed == that.nonPublicAccessAllowed && this.lenientConstructorResolution == that.lenientConstructorResolution && this.equalsConstructorArgumentValues(that) && this.equalsPropertyValues(that) && ObjectUtils.nullSafeEquals((Object)this.methodOverrides, (Object)that.methodOverrides) && ObjectUtils.nullSafeEquals((Object)this.factoryBeanName, (Object)that.factoryBeanName) && ObjectUtils.nullSafeEquals((Object)this.factoryMethodName, (Object)that.factoryMethodName) && ObjectUtils.nullSafeEquals((Object)this.initMethodName, (Object)that.initMethodName) && this.enforceInitMethod == that.enforceInitMethod && ObjectUtils.nullSafeEquals((Object)this.destroyMethodName, (Object)that.destroyMethodName) && this.enforceDestroyMethod == that.enforceDestroyMethod && this.synthetic == that.synthetic && this.role == that.role && super.equals(other);
    }
    ...
    private boolean equalsConstructorArgumentValues(AbstractBeanDefinition other) {
        ...
        return ObjectUtils.nullSafeEquals((Object)this.constructorArgumentValues, (Object)other.constructorArgumentValues);
    }
    ...
    private boolean equalsPropertyValues(AbstractBeanDefinition other) {
        ...
        return ObjectUtils.nullSafeEquals((Object)this.propertyValues, (Object)other.propertyValues);
    }
