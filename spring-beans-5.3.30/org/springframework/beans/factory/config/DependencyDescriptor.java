...
implements Serializable {
    ...
    public ResolvableType getResolvableType() {
        ...
        if (resolvableType == null) {
            this.resolvableType = resolvableType = this.field != null ? ResolvableType.forField((Field)this.field, (int)this.nestingLevel, this.containingClass) : ResolvableType.forMethodParameter((MethodParameter)this.obtainMethodParameter());
        }
