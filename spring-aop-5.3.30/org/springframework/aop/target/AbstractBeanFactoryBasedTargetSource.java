...
Serializable {
    ...
    public String getTargetBeanName() {
        Assert.state((this.targetBeanName != null ? 1 : 0) != 0, (String)"Target bean name not set");
    ...
    public int hashCode() {
        return this.getClass().hashCode() * 13 + ObjectUtils.nullSafeHashCode((Object)this.targetBeanName);
    }
