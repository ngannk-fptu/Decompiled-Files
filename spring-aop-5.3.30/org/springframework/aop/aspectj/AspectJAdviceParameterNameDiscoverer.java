...
implements ParameterNameDiscoverer {
    ...
    private void maybeBindAnnotationsFromPointcutExpression() {
        ...
        String[] tokens = StringUtils.tokenizeToStringArray((String)this.pointcutExpression, (String)" ");
    ...
    private void maybeExtractVariableNamesFromArgs(@Nullable String argsSpec, List<String> varNames) {
        ...
        String[] tokens = StringUtils.tokenizeToStringArray((String)argsSpec, (String)",");
        for (int i = 0; i < tokens.length; ++i) {
            tokens[i] = StringUtils.trimWhitespace((String)tokens[i]);
