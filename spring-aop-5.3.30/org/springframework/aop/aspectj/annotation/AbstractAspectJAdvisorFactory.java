...
implements AspectJAdvisorFactory {
    ...
    public void validate(Class<?> aspectClass) throws AopConfigException {
        ...
        if (superclass.getAnnotation(Aspect.class) != null && !Modifier.isAbstract(superclass.getModifiers())) {
            throw new AopConfigException("[" + aspectClass.getName() + "] cannot extend concrete aspect [" + superclass.getName() + "]");
        }
    ...
    private static <A extends Annotation> AspectJAnnotation<A> findAnnotation(Method method, Class<A> toLookFor) {
        Annotation result = AnnotationUtils.findAnnotation((Method)method, toLookFor);
        if (result != null) {
            return new AspectJAnnotation<Annotation>(result);
        }
        return null;
    }
    ...
    protected static class AspectJAnnotation<A extends Annotation> {
        ...
        public AspectJAnnotation(A annotation) {
            ...
            try {
                ...
                Object argNames = AnnotationUtils.getValue(annotation, (String)"argNames");
        ...
        private String resolveExpression(A annotation) {
            for (String attributeName : EXPRESSION_ATTRIBUTES) {
                String str;
                Object val = AnnotationUtils.getValue(annotation, (String)attributeName);
