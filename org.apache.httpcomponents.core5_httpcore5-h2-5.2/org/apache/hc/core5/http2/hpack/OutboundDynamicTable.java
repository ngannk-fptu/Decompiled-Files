...
final class OutboundDynamicTable {
    ...
    public Header getHeader(int index) {
        ...
        Args.check((index >= 1 ? 1 : 0) != 0, (String)"index %s cannot be less then 1", (Object)index);
        Args.check((index <= length ? 1 : 0) != 0, (String)"index %s cannot be greater then length %s ", (Object[])new Object[]{index, length});
