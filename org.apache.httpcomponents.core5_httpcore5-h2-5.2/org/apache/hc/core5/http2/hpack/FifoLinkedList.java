...
final class FifoLinkedList {
    ...
    public Header get(int index) {
        Args.check((index <= this.length ? 1 : 0) != 0, (String)"Length %s cannot be greater then index %s ", (Object[])new Object[]{this.length, index});
        Args.notNegative((int)index, (String)"index");
