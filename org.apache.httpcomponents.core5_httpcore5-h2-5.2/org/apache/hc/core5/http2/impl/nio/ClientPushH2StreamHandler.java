...
implements H2StreamHandler {
    ...
    public void consumePromise(List<Header> headers) throws HttpException, IOException {
        if (this.requestState == MessageState.HEADERS) {
            this.request = DefaultH2RequestConverter.INSTANCE.convert(headers);
            try {
                this.exchangeHandler = this.pushHandlerFactory != null ? (AsyncPushConsumer)this.pushHandlerFactory.create(this.request, (HttpContext)this.context) : null;
            }
    ...
    public void consumeHeader(List<Header> headers, boolean endStream) throws HttpException, IOException {
        if (this.responseState == MessageState.HEADERS) {
            Asserts.notNull((Object)this.request, (String)"Request");
            ...
            IncomingEntityDetails entityDetails = endStream ? null : new IncomingEntityDetails((MessageHeaders)this.request, -1L);
            ...
            this.exchangeHandler.consumePromise(this.request, response, (EntityDetails)entityDetails, (HttpContext)this.context);
            if (endStream) {
    ...
    public void updateInputCapacity() throws IOException {
        Asserts.notNull((Object)this.exchangeHandler, (String)"Exchange handler");
        this.exchangeHandler.updateCapacity((CapacityChannel)this.internalOutputChannel);
    }
