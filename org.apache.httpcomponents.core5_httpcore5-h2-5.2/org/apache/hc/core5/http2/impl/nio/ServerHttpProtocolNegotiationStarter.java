...
implements IOEventHandlerFactory {
    ...
    public HttpConnectionEventHandler createHandler(ProtocolIOSession ioSession, Object attachment) {
        ...
        ioSession.registerProtocol(ApplicationProtocol.HTTP_1_1.id, (ProtocolUpgradeHandler)new ServerHttp1UpgradeHandler(this.http1StreamHandlerFactory));
        ioSession.registerProtocol(ApplicationProtocol.HTTP_2.id, (ProtocolUpgradeHandler)new ServerH2UpgradeHandler(this.http2StreamHandlerFactory));
