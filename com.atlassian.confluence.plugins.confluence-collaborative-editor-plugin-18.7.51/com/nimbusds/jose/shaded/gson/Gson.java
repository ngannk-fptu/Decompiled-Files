...
public final class Gson {
    ...
    public <T> TypeAdapter<T> getAdapter(TypeToken<T> type) {
        ...
        try {
            ...
            for (TypeAdapterFactory factory : this.factories) {
                ...
                TypeAdapter<T> existingAdapter = this.typeTokenCache.putIfAbsent(type, candidate);
    ...
    public void toJson(Object src, Type typeOfSrc, JsonWriter writer) throws JsonIOException {
        ...
        try {
            ...
            AssertionError error = new AssertionError((Object)("AssertionError (GSON 2.10): " + ((Throwable)((Object)e)).getMessage()));
    ...
    public <T> T fromJson(JsonReader reader, TypeToken<T> typeOfT) throws JsonIOException, JsonSyntaxException {
        ...
        try {
            ...
            T t = object = typeAdapter.read(reader);
            return t;
        }
