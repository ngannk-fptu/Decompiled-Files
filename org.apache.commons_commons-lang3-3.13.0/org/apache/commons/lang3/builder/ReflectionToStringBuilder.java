...
extends ToStringBuilder {
    ...
    protected void appendFieldsIn(Class<?> clazz) {
        ...
        for (AccessibleObject field : fields) {
            ...
            Object fieldValue = Reflection.getUnchecked((Field)field, this.getObject());
    ...
    public ReflectionToStringBuilder setExcludeFieldNames(String ... excludeFieldNamesParam) {
        this.excludeFieldNames = excludeFieldNamesParam == null ? null : ArraySorter.sort(ReflectionToStringBuilder.toNoNullStringArray(excludeFieldNamesParam));
        return this;
    }
    ...
    public ReflectionToStringBuilder setIncludeFieldNames(String ... includeFieldNamesParam) {
        this.includeFieldNames = includeFieldNamesParam == null ? null : ArraySorter.sort(ReflectionToStringBuilder.toNoNullStringArray(includeFieldNamesParam));
        return this;
    }
