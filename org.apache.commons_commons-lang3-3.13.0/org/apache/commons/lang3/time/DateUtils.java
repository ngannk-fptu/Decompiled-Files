...
public class DateUtils {
    ...
    public static boolean isSameDay(Date date1, Date date2) {
        return DateUtils.isSameDay(DateUtils.toCalendar(date1), DateUtils.toCalendar(date2));
    }
    ...
    public static Date round(Date date, int field) {
        return DateUtils.modify(DateUtils.toCalendar(date), field, ModifyType.ROUND).getTime();
    }

    public static Calendar round(Calendar calendar, int field) {
        Objects.requireNonNull(calendar, "calendar");
        return DateUtils.modify((Calendar)calendar.clone(), field, ModifyType.ROUND);
    }
    ...
    public static Date truncate(Date date, int field) {
        return DateUtils.modify(DateUtils.toCalendar(date), field, ModifyType.TRUNCATE).getTime();
    }

    public static Calendar truncate(Calendar date, int field) {
        Objects.requireNonNull(date, "date");
        return DateUtils.modify((Calendar)date.clone(), field, ModifyType.TRUNCATE);
    }
    ...
    public static Date ceiling(Date date, int field) {
        return DateUtils.modify(DateUtils.toCalendar(date), field, ModifyType.CEILING).getTime();
    }

    public static Calendar ceiling(Calendar calendar, int field) {
        Objects.requireNonNull(calendar, "calendar");
        return DateUtils.modify((Calendar)calendar.clone(), field, ModifyType.CEILING);
    }
    ...
    public static Iterator<Calendar> iterator(Date focus, int rangeStyle) {
        return DateUtils.iterator(DateUtils.toCalendar(focus), rangeStyle);
    }
    ...
    public static Iterator<?> iterator(Object calendar, int rangeStyle) {
        ...
        if (calendar instanceof Calendar) {
            return DateUtils.iterator((Calendar)calendar, rangeStyle);
        }
