...
public class DateFormatUtils {
    ...
    public static String format(Calendar calendar, String pattern) {
        return DateFormatUtils.format(calendar, pattern, DateFormatUtils.getTimeZone(calendar), null);
    }

    public static String format(Calendar calendar, String pattern, Locale locale) {
        return DateFormatUtils.format(calendar, pattern, DateFormatUtils.getTimeZone(calendar), locale);
    }
