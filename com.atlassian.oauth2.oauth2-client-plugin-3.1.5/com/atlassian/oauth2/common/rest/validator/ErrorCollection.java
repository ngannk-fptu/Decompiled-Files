...
public final class ErrorCollection {
    ...
    private ErrorCollection(@Nonnull Iterable<String> errors, @Nonnull Map<String, List<String>> fieldErrors) {
        this.errors = ImmutableList.copyOf(errors);
        this.fieldErrors = ImmutableMap.copyOf((Map)Maps.transformValues((Map)Maps.filterValues(fieldErrors, list -> !CollectionUtils.isEmpty((Collection)list)), ImmutableList::copyOf));
    }
