...
implements ClockSkewAware {
    ...
    public void verify(SAML2AssertionDetails assertionDetails) throws BadSAML2AssertionException {
        ...
        Date now = new Date();
        if (!DateUtils.isAfter(assertionDetails.getExpirationTime(), now, this.maxClockSkewSeconds)) {
            throw EXPIRED_SAML2_ASSERTION_EXCEPTION;
        }
        if (assertionDetails.getNotBeforeTime() != null && !DateUtils.isBefore(assertionDetails.getNotBeforeTime(), now, this.maxClockSkewSeconds)) {
