...
extends CertPathValidatorSpi {
    ...
    public CertPathValidatorResult engineValidate(CertPath certPath, CertPathParameters params) throws CertPathValidatorException, InvalidAlgorithmParameterException {
        ...
        try {
            ...
            PKIXCertPathValidatorSpi.checkCertificate(trust.getTrustedCert());
        }
        ...
        ProvCrlRevocationChecker revocationChecker = paramsPKIX.isRevocationEnabled() ? new ProvCrlRevocationChecker(this.helper) : null;
        ...
        for (index = certs.size() - 1; index >= 0; --index) {
            ...
            try {
                PKIXCertPathValidatorSpi.checkCertificate(cert);
            }
            catch (AnnotatedException e) {
