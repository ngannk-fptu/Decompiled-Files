...
public class PublicKeyFactory {
    ...
    extends SubjectPublicKeyInfoConverter {
        ...
        AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo keyInfo, Object defaultParams) throws IOException {
            ...
            if (dstuParams.isNamedCurve()) {
                ...
                ECCurve.F2m curve = new ECCurve.F2m(field.getM(), field.getK1(), field.getK2(), field.getK3(), binary.getA(), b, null, null);
    ...
    extends SubjectPublicKeyInfoConverter {
        ...
        AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo keyInfo, Object defaultParams) {
            ...
            if (data[0] == 4 && data[1] == data.length - 2 && (data[2] == 2 || data[2] == 3) && (qLength = new X9IntegerConverter().getByteLength(dParams.getCurve())) >= data.length - 3) {
                try {
    ...
    extends SubjectPublicKeyInfoConverter {
        ...
        AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo keyInfo, Object defaultParams) {
            ...
            return new ECPublicKeyParameters(q, (ECDomainParameters)ecDomainParameters);
        }
    }
