...
implements BlockCipher {
    ...
    public DESEngine() {
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(this.getAlgorithmName(), 56));
    }
    ...
    public void init(boolean encrypting, CipherParameters params) {
        if (params instanceof KeyParameter) {
            ...
            CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(this.getAlgorithmName(), 56, params, Utils.getPurpose(this.forEncryption)));
            return;
        }
