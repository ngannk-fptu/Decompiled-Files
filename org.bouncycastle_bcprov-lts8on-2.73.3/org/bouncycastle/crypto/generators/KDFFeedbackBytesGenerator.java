...
implements MacDerivationFunction {
    ...
    public void init(DerivationParameters params) {
        ...
        this.maxSizeExcl = feedbackParams.useCounter() ? ((maxSize = TWO.pow(r).multiply(BigInteger.valueOf(this.h))).compareTo(INTEGER_MAX) == 1 ? Integer.MAX_VALUE : maxSize.intValue()) : Integer.MAX_VALUE;
