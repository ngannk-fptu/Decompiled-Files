...
extends DSABase {
    ...
    protected void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        AsymmetricKeyParameter param = ECUtils.generatePrivateKeyParameter(privateKey);
        this.digest.reset();
    ...
    public static class ecCVCDSA3_224
    extends SignatureSpi {
    ...
    public static class ecCVCDSA3_256
    extends SignatureSpi {
    ...
    public static class ecCVCDSA3_384
    extends SignatureSpi {
    ...
    public static class ecCVCDSA3_512
    extends SignatureSpi {
    ...
    public static class ecDSAShake128
    extends SignatureSpi {
    ...
    public static class ecDSAShake256
    extends SignatureSpi {
