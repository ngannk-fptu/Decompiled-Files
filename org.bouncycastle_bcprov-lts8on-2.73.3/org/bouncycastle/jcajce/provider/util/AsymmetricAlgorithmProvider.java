...
extends AlgorithmProvider {
    ...
    protected void addSignatureAlgorithm(ConfigurableProvider provider, String digest, String algorithm, String className) {
        this.addSignatureAlgorithm(provider, digest, algorithm, className, null);
    }
    ...
    protected void addSignatureAlgorithm(ConfigurableProvider provider, String digest, String algorithm, String className, ASN1ObjectIdentifier oid, Map<String, String> attributes) {
        String mainName = digest + "WITH" + algorithm;
        String jdk11Variation1 = digest + "with" + algorithm;
        String jdk11Variation2 = digest + "With" + algorithm;
        String alias = digest + "/" + algorithm;
    ...
    protected void addKeyPairGeneratorAlgorithm(ConfigurableProvider provider, String algorithm, String className, ASN1ObjectIdentifier oid) {
    ...
    protected void addKeyFactoryAlgorithm(ConfigurableProvider provider, String algorithm, String className, ASN1ObjectIdentifier oid, AsymmetricKeyInfoConverter keyInfoConverter) {
    ...
    protected void addKeyGeneratorAlgorithm(ConfigurableProvider provider, String algorithm, String className, ASN1ObjectIdentifier oid) {
    ...
    protected void addCipherAlgorithm(ConfigurableProvider provider, String algorithm, String className, ASN1ObjectIdentifier oid) {
