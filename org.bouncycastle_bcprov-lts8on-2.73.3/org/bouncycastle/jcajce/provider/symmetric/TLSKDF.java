...
public class TLSKDF {
    private static byte[] PRF_legacy(TLSKeyMaterialSpec parameters) {
        HMac md5Hmac = new HMac(DigestFactory.createMD5());
        HMac sha1HMac = new HMac(DigestFactory.createSHA1());
        ...
        TLSKDF.hmac_hash(md5Hmac, s1, labelSeed, b1);
        TLSKDF.hmac_hash(sha1HMac, s2, labelSeed, b2);
