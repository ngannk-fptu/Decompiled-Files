...
public class SHA512 {
    ...
    implements Cloneable {
        ...
        public Object clone() throws CloneNotSupportedException {
            ...
            d.digest = new SHA512tDigest((SHA512tDigest)this.digest);
            return d;
        }
    }
    ...
    extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider provider) {
            ...
            this.addHMACAlgorithm(provider, "SHA512", PREFIX + "$HashMac", PREFIX + "$KeyGenerator");
            this.addHMACAlias(provider, "SHA512", PKCSObjectIdentifiers.id_hmacWithSHA512);
            this.addHMACAlgorithm(provider, "SHA512/224", PREFIX + "$HashMacT224", PREFIX + "$KeyGeneratorT224");
            this.addHMACAlgorithm(provider, "SHA512/256", PREFIX + "$HashMacT256", PREFIX + "$KeyGeneratorT256");
        }
    }
}
