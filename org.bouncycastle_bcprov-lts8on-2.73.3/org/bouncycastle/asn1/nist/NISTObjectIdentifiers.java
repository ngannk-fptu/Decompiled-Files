...
public interface NISTObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_shake128_len = hashAlgs.branch("17");
    public static final ASN1ObjectIdentifier id_shake256_len = hashAlgs.branch("18");
    public static final ASN1ObjectIdentifier id_KmacWithSHAKE128 = hashAlgs.branch("19");
    ...
    public static final ASN1ObjectIdentifier id_aes128_GMAC = aes.branch("9");
    ...
    public static final ASN1ObjectIdentifier id_aes192_GMAC = aes.branch("29");
    ...
    public static final ASN1ObjectIdentifier id_aes256_GMAC = aes.branch("49");
    ...
    static {
        id_dsa_with_sha2 = sigAlgs = nistAlgorithm.branch("3");
        dsa_with_sha224 = sigAlgs.branch("1");
