...
public class TeleTrusTNamedCurves {
    static X9ECParametersHolder brainpoolP160r1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            BigInteger n = TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DF5991D45029409E60FC09");
            BigInteger h = BigInteger.valueOf(1L);
            return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620F"), TeleTrusTNamedCurves.fromHex("340E7BE2A280EB74E2BE61BADA745D97E8F7C300"), TeleTrusTNamedCurves.fromHex("1E589A8595423412134FAA2DBDEC95C8D8675E58"), n, h, true));
        }
    ...
    static X9ECParametersHolder brainpoolP160t1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            BigInteger n = TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DF5991D45029409E60FC09");
            BigInteger h = BigInteger.valueOf(1L);
            return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620F"), TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620C"), TeleTrusTNamedCurves.fromHex("7A556B6DAE535B7B51ED2C4D7DAA7A0B5C55F380"), n, h, true));
        }
    ...
    static X9ECParametersHolder brainpoolP192r1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger n = TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1");
            BigInteger h = BigInteger.valueOf(1L);
            return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297"), TeleTrusTNamedCurves.fromHex("6A91174076B1E0E19C39C031FE8685C1CAE040E5C69A28EF"), TeleTrusTNamedCurves.fromHex("469A28EF7C28CCA3DC721D044F4496BCCA7EF4146FBF25C9"), n, h, true));
        }
    ...
    static X9ECParametersHolder brainpoolP192t1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            BigInteger n = TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1");
            BigInteger h = BigInteger.valueOf(1L);
            return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297"), TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86294"), TeleTrusTNamedCurves.fromHex("13D56FFAEC78681E68F9DEB43B35BEC2FB68542E27897B79"), n, h, true));
        }
    ...
    static X9ECParametersHolder brainpoolP256r1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger n = TeleTrusTNamedCurves.fromHex("A9FB57DBA1EEA9BC3E660A909D838D718C397AA3B561A6F7901E0E82974856A7");
            BigInteger h = BigInteger.valueOf(1L);
            return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377"), TeleTrusTNamedCurves.fromHex("7D5A0975FC2C3057EEF67530417AFFE7FB8055C126DC5C6CE94A4B44F330B5D9"), TeleTrusTNamedCurves.fromHex("26DC5C6CE94A4B44F330B5D9BBD77CBF958416295CF7E1CE6BCCDC18FF8C07B6"), n, h, true));
        }
    ...
    static X9ECParametersHolder brainpoolP320r1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger n = TeleTrusTNamedCurves.fromHex("D35E472036BC4FB7E13C785ED201E065F98FCFA5B68F12A32D482EC7EE8658E98691555B44C59311");
            BigInteger h = BigInteger.valueOf(1L);
    ...
    static X9ECParametersHolder brainpoolP384r1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger n = TeleTrusTNamedCurves.fromHex("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B31F166E6CAC0425A7CF3AB6AF6B7FC3103B883202E9046565");
            BigInteger h = BigInteger.valueOf(1L);
    ...
    static X9ECParametersHolder brainpoolP512r1 = new X9ECParametersHolder(){
        ...
        @Override
        protected ECCurve createCurve() {
            BigInteger n = TeleTrusTNamedCurves.fromHex("AADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA70330870553E5C414CA92619418661197FAC10471DB1D381085DDADDB58796829CA90069");
            BigInteger h = BigInteger.valueOf(1L);
    ...
    public static X9ECParameters getByName(String name) {
        ...
        return oid == null ? null : TeleTrusTNamedCurves.getByOID(oid);
    }

    public static X9ECParametersHolder getByNameLazy(String name) {
        ASN1ObjectIdentifier oid = TeleTrusTNamedCurves.getOID(name);
        return oid == null ? null : TeleTrusTNamedCurves.getByOIDLazy(oid);
    }

    public static X9ECParameters getByOID(ASN1ObjectIdentifier oid) {
        X9ECParametersHolder holder = TeleTrusTNamedCurves.getByOIDLazy(oid);
    ...
    public static ASN1ObjectIdentifier getOID(short curvesize, boolean twisted) {
        return TeleTrusTNamedCurves.getOID("brainpoolP" + curvesize + (twisted ? "t" : "r") + "1");
    }
