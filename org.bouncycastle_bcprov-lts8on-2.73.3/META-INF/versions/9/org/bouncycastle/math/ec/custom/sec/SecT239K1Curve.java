...
extends ECCurve.AbstractF2m {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
        ...
        for (int i = 0; i < len; ++i) {
            ...
            Nat256.copy64(((SecT239FieldElement)p.getRawYCoord()).x, 0, table, pos += 4);
            pos += 4;
        }
        return new AbstractECLookupTable(){
            ...
            private ECPoint createPoint(long[] x, long[] y) {
                return SecT239K1Curve.this.createRawPoint(new SecT239FieldElement(x), new SecT239FieldElement(y), SECT239K1_AFFINE_ZS);
            }
        };
    }
}
