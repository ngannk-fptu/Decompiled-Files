...
public abstract class Nat224 {
    ...
    public static boolean diff(int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        boolean pos = Nat224.gte(x, xOff, y, yOff);
        if (pos) {
    ...
    public static int mulAddTo(int[] x, int[] y, int[] zz) {
        ...
        for (int i = 0; i < 7; ++i) {
            ...
            zz[i + 7] = (int)(zc += (c >>>= 32) + ((long)zz[i + 7] & 0xFFFFFFFFL));
            zc >>>= 32;
        }
        return (int)zc;
    }
    ...
    public static int mulAddTo(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        for (int i = 0; i < 7; ++i) {
            ...
            zz[zzOff + 7] = (int)(zc += (c >>>= 32) + ((long)zz[zzOff + 7] & 0xFFFFFFFFL));
            zc >>>= 32;
            ++zzOff;
        }
        return (int)zc;
    ...
    public static int mul33DWordAdd(int x, long y, int[] z, int zOff) {
        ...
        return (c >>>= 32) == 0L ? 0 : Nat.incAt(7, z, zOff, 4);
    }
    ...
    public static int mul33WordAdd(int x, int y, int[] z, int zOff) {
        ...
        return (c >>>= 32) == 0L ? 0 : Nat.incAt(7, z, zOff, 3);
    }
    ...
    public static void square(int[] x, int[] zz) {
        ...
        zz[6] = w << 1 | c;
        c = w >>> 31;
        zz_12 += (zz_11 += ((zz_10 += ((zz_9 += ((zz_8 += ((zz_7 += (zz_6 >>> 32) + x_6 * x_1) >>> 32) + x_6 * x_2) >>> 32) + x_6 * x_3) >>> 32) + x_6 * x_4) >>> 32) + x_6 * x_5) >>> 32;
        w = (int)zz_7;
        zz[7] = w << 1 | c;
        c = w >>> 31;
        w = (int)zz_8;
