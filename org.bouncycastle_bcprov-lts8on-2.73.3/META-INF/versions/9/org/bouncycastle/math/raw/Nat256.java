...
public abstract class Nat256 {
    ...
    public static int add(int[] x, int[] y, int[] z) {
        ...
        c >>>= 32;
        z[6] = (int)(c += ((long)x[6] & 0xFFFFFFFFL) + ((long)y[6] & 0xFFFFFFFFL));
        c >>>= 32;
        z[7] = (int)(c += ((long)x[7] & 0xFFFFFFFFL) + ((long)y[7] & 0xFFFFFFFFL));
        return (int)(c >>>= 32);
    }
    ...
    public static int add(int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        ...
        c >>>= 32;
        z[zOff + 6] = (int)(c += ((long)x[xOff + 6] & 0xFFFFFFFFL) + ((long)y[yOff + 6] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 7] = (int)(c += ((long)x[xOff + 7] & 0xFFFFFFFFL) + ((long)y[yOff + 7] & 0xFFFFFFFFL));
        return (int)(c >>>= 32);
    }
    ...
    public static int addBothTo(int[] x, int[] y, int[] z) {
        ...
        c >>>= 32;
        z[6] = (int)(c += ((long)x[6] & 0xFFFFFFFFL) + ((long)y[6] & 0xFFFFFFFFL) + ((long)z[6] & 0xFFFFFFFFL));
        c >>>= 32;
        z[7] = (int)(c += ((long)x[7] & 0xFFFFFFFFL) + ((long)y[7] & 0xFFFFFFFFL) + ((long)z[7] & 0xFFFFFFFFL));
        return (int)(c >>>= 32);
    }

    public static int addBothTo(int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        long c = 0L;
        z[zOff + 0] = (int)(c += ((long)x[xOff + 0] & 0xFFFFFFFFL) + ((long)y[yOff + 0] & 0xFFFFFFFFL) + ((long)z[zOff + 0] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 1] = (int)(c += ((long)x[xOff + 1] & 0xFFFFFFFFL) + ((long)y[yOff + 1] & 0xFFFFFFFFL) + ((long)z[zOff + 1] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 2] = (int)(c += ((long)x[xOff + 2] & 0xFFFFFFFFL) + ((long)y[yOff + 2] & 0xFFFFFFFFL) + ((long)z[zOff + 2] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 3] = (int)(c += ((long)x[xOff + 3] & 0xFFFFFFFFL) + ((long)y[yOff + 3] & 0xFFFFFFFFL) + ((long)z[zOff + 3] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 4] = (int)(c += ((long)x[xOff + 4] & 0xFFFFFFFFL) + ((long)y[yOff + 4] & 0xFFFFFFFFL) + ((long)z[zOff + 4] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 5] = (int)(c += ((long)x[xOff + 5] & 0xFFFFFFFFL) + ((long)y[yOff + 5] & 0xFFFFFFFFL) + ((long)z[zOff + 5] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 6] = (int)(c += ((long)x[xOff + 6] & 0xFFFFFFFFL) + ((long)y[yOff + 6] & 0xFFFFFFFFL) + ((long)z[zOff + 6] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 7] = (int)(c += ((long)x[xOff + 7] & 0xFFFFFFFFL) + ((long)y[yOff + 7] & 0xFFFFFFFFL) + ((long)z[zOff + 7] & 0xFFFFFFFFL));
        return (int)(c >>>= 32);
    }
    ...
    public static int addTo(int[] x, int[] z) {
        ...
        c >>>= 32;
        z[6] = (int)(c += ((long)x[6] & 0xFFFFFFFFL) + ((long)z[6] & 0xFFFFFFFFL));
        c >>>= 32;
        z[7] = (int)(c += ((long)x[7] & 0xFFFFFFFFL) + ((long)z[7] & 0xFFFFFFFFL));
        return (int)(c >>>= 32);
    }
    ...
    public static int addTo(int[] x, int xOff, int[] z, int zOff, int cIn) {
        ...
        c >>>= 32;
        z[zOff + 6] = (int)(c += ((long)x[xOff + 6] & 0xFFFFFFFFL) + ((long)z[zOff + 6] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 7] = (int)(c += ((long)x[xOff + 7] & 0xFFFFFFFFL) + ((long)z[zOff + 7] & 0xFFFFFFFFL));
        return (int)(c >>>= 32);
    }
    ...
    public static int addToEachOther(int[] u, int uOff, int[] v, int vOff) {
        ...
        v[vOff + 5] = (int)c;
        c >>>= 32;
        u[uOff + 6] = (int)(c += ((long)u[uOff + 6] & 0xFFFFFFFFL) + ((long)v[vOff + 6] & 0xFFFFFFFFL));
        v[vOff + 6] = (int)c;
        c >>>= 32;
        u[uOff + 7] = (int)(c += ((long)u[uOff + 7] & 0xFFFFFFFFL) + ((long)v[vOff + 7] & 0xFFFFFFFFL));
        v[vOff + 7] = (int)c;
        return (int)(c >>>= 32);
    }
    ...
    public static boolean diff(int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        boolean pos = Nat256.gte(x, xOff, y, yOff);
        if (pos) {
    ...
    public static void mul(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        long y_6 = (long)y[yOff + 6] & 0xFFFFFFFFL;
        long y_7 = (long)y[yOff + 7] & 0xFFFFFFFFL;
        long c = 0L;
        ...
        c >>>= 32;
        zz[zzOff + 6] = (int)(c += x_0 * y_6);
        c >>>= 32;
        zz[zzOff + 7] = (int)(c += x_0 * y_7);
        zz[zzOff + 8] = (int)(c >>>= 32);
        for (int i = 1; i < 8; ++i) {
            long c2 = 0L;
            ...
            c2 >>>= 32;
            zz[zzOff + 6] = (int)(c2 += x_i * y_6 + ((long)zz[zzOff + 6] & 0xFFFFFFFFL));
            c2 >>>= 32;
            zz[zzOff + 7] = (int)(c2 += x_i * y_7 + ((long)zz[zzOff + 7] & 0xFFFFFFFFL));
    ...
    public static void mul128(int[] x, int[] y128, int[] zz) {
        ...
        long c = 0L;
        long y_0 = (long)y128[0] & 0xFFFFFFFFL;
        zz[0] = (int)(c += y_0 * x_0);
        c >>>= 32;
        zz[1] = (int)(c += y_0 * x_1);
        c >>>= 32;
        ...
        for (int i = 1; i < 4; ++i) {
            long c2 = 0L;
            long y_i = (long)y128[i] & 0xFFFFFFFFL;
            zz[i + 0] = (int)(c2 += y_i * x_0 + ((long)zz[i + 0] & 0xFFFFFFFFL));
            c2 >>>= 32;
            zz[i + 1] = (int)(c2 += y_i * x_1 + ((long)zz[i + 1] & 0xFFFFFFFFL));
            c2 >>>= 32;
            zz[i + 2] = (int)(c2 += y_i * x_2 + ((long)zz[i + 2] & 0xFFFFFFFFL));
            c2 >>>= 32;
            zz[i + 3] = (int)(c2 += y_i * x_3 + ((long)zz[i + 3] & 0xFFFFFFFFL));
            c2 >>>= 32;
            zz[i + 4] = (int)(c2 += y_i * x_4 + ((long)zz[i + 4] & 0xFFFFFFFFL));
            c2 >>>= 32;
            zz[i + 5] = (int)(c2 += y_i * x_5 + ((long)zz[i + 5] & 0xFFFFFFFFL));
            c2 >>>= 32;
            zz[i + 6] = (int)(c2 += y_i * x_6 + ((long)zz[i + 6] & 0xFFFFFFFFL));
            c2 >>>= 32;
            zz[i + 7] = (int)(c2 += y_i * x_7 + ((long)zz[i + 7] & 0xFFFFFFFFL));
            zz[i + 8] = (int)(c2 >>>= 32);
        }
    }
    ...
    public static int mulAddTo(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            c >>>= 32;
            zz[zzOff + 6] = (int)(c += x_i * y_6 + ((long)zz[zzOff + 6] & 0xFFFFFFFFL));
            c >>>= 32;
            zz[zzOff + 7] = (int)(c += x_i * y_7 + ((long)zz[zzOff + 7] & 0xFFFFFFFFL));
            zz[zzOff + 8] = (int)(zc += (c >>>= 32) + ((long)zz[zzOff + 8] & 0xFFFFFFFFL));
            zc >>>= 32;
            ++zzOff;
        }
        return (int)zc;
    ...
    public static long mul33Add(int w, int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        ...
        c >>>= 32;
        long x6 = (long)x[xOff + 6] & 0xFFFFFFFFL;
        z[zOff + 6] = (int)(c += wVal * x6 + x5 + ((long)y[yOff + 6] & 0xFFFFFFFFL));
        c >>>= 32;
        long x7 = (long)x[xOff + 7] & 0xFFFFFFFFL;
        z[zOff + 7] = (int)(c += wVal * x7 + x6 + ((long)y[yOff + 7] & 0xFFFFFFFFL));
        c >>>= 32;
        return c += x7;
    }
    ...
    public static int mulByWord(int x, int[] z) {
        ...
        z[0] = (int)(c += xVal * ((long)z[0] & 0xFFFFFFFFL));
        c >>>= 32;
        z[1] = (int)(c += xVal * ((long)z[1] & 0xFFFFFFFFL));
        c >>>= 32;
        z[2] = (int)(c += xVal * ((long)z[2] & 0xFFFFFFFFL));
        c >>>= 32;
        z[3] = (int)(c += xVal * ((long)z[3] & 0xFFFFFFFFL));
        c >>>= 32;
        z[4] = (int)(c += xVal * ((long)z[4] & 0xFFFFFFFFL));
        c >>>= 32;
        z[5] = (int)(c += xVal * ((long)z[5] & 0xFFFFFFFFL));
        c >>>= 32;
        z[6] = (int)(c += xVal * ((long)z[6] & 0xFFFFFFFFL));
        c >>>= 32;
        z[7] = (int)(c += xVal * ((long)z[7] & 0xFFFFFFFFL));
        return (int)(c >>>= 32);
    }
    ...
    public static int mulByWordAddTo(int x, int[] y, int[] z) {
        long c = 0L;
        long xVal = (long)x & 0xFFFFFFFFL;
        z[0] = (int)(c += xVal * ((long)z[0] & 0xFFFFFFFFL) + ((long)y[0] & 0xFFFFFFFFL));
        c >>>= 32;
        z[1] = (int)(c += xVal * ((long)z[1] & 0xFFFFFFFFL) + ((long)y[1] & 0xFFFFFFFFL));
        c >>>= 32;
        z[2] = (int)(c += xVal * ((long)z[2] & 0xFFFFFFFFL) + ((long)y[2] & 0xFFFFFFFFL));
        c >>>= 32;
        z[3] = (int)(c += xVal * ((long)z[3] & 0xFFFFFFFFL) + ((long)y[3] & 0xFFFFFFFFL));
        c >>>= 32;
        z[4] = (int)(c += xVal * ((long)z[4] & 0xFFFFFFFFL) + ((long)y[4] & 0xFFFFFFFFL));
        c >>>= 32;
        z[5] = (int)(c += xVal * ((long)z[5] & 0xFFFFFFFFL) + ((long)y[5] & 0xFFFFFFFFL));
        c >>>= 32;
        z[6] = (int)(c += xVal * ((long)z[6] & 0xFFFFFFFFL) + ((long)y[6] & 0xFFFFFFFFL));
        c >>>= 32;
        z[7] = (int)(c += xVal * ((long)z[7] & 0xFFFFFFFFL) + ((long)y[7] & 0xFFFFFFFFL));
        return (int)(c >>>= 32);
    }
    ...
    public static int mulWordAddTo(int x, int[] y, int yOff, int[] z, int zOff) {
        long c = 0L;
        long xVal = (long)x & 0xFFFFFFFFL;
        z[zOff + 0] = (int)(c += xVal * ((long)y[yOff + 0] & 0xFFFFFFFFL) + ((long)z[zOff + 0] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 1] = (int)(c += xVal * ((long)y[yOff + 1] & 0xFFFFFFFFL) + ((long)z[zOff + 1] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 2] = (int)(c += xVal * ((long)y[yOff + 2] & 0xFFFFFFFFL) + ((long)z[zOff + 2] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 3] = (int)(c += xVal * ((long)y[yOff + 3] & 0xFFFFFFFFL) + ((long)z[zOff + 3] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 4] = (int)(c += xVal * ((long)y[yOff + 4] & 0xFFFFFFFFL) + ((long)z[zOff + 4] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 5] = (int)(c += xVal * ((long)y[yOff + 5] & 0xFFFFFFFFL) + ((long)z[zOff + 5] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 6] = (int)(c += xVal * ((long)y[yOff + 6] & 0xFFFFFFFFL) + ((long)z[zOff + 6] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 7] = (int)(c += xVal * ((long)y[yOff + 7] & 0xFFFFFFFFL) + ((long)z[zOff + 7] & 0xFFFFFFFFL));
        return (int)(c >>>= 32);
    }
    ...
    public static int mul33DWordAdd(int x, long y, int[] z, int zOff) {
        ...
        return (c >>>= 32) == 0L ? 0 : Nat.incAt(8, z, zOff, 4);
    }
    ...
    public static int mul33WordAdd(int x, int y, int[] z, int zOff) {
        ...
        return (c >>>= 32) == 0L ? 0 : Nat.incAt(8, z, zOff, 3);
    }
    ...
    public static void square(int[] x, int xOff, int[] zz, int zzOff) {
        ...
        zz_8 &= 0xFFFFFFFFL;
        zz_9 &= 0xFFFFFFFFL;
        long x_6 = (long)x[xOff + 6] & 0xFFFFFFFFL;
        long zz_11 = ((long)zz[zzOff + 11] & 0xFFFFFFFFL) + ((zz_10 += (zz_9 += ((zz_8 += ((zz_7 += ((zz_6 += (zz_5 >>> 32) + x_5 * x_1) >>> 32) + x_5 * x_2) >>> 32) + x_5 * x_3) >>> 32) + x_5 * x_4) >>> 32) >>> 32);
        zz_10 &= 0xFFFFFFFFL;
        long zz_12 = ((long)zz[zzOff + 12] & 0xFFFFFFFFL) + (zz_11 >>> 32);
        zz_11 &= 0xFFFFFFFFL;
        w = (int)(zz_6 += x_6 * x_0);
        zz[zzOff + 6] = w << 1 | c;
        c = w >>> 31;
        ...
        zz_10 &= 0xFFFFFFFFL;
        zz_11 &= 0xFFFFFFFFL;
        long x_7 = (long)x[xOff + 7] & 0xFFFFFFFFL;
        long zz_13 = ((long)zz[zzOff + 13] & 0xFFFFFFFFL) + ((zz_12 += (zz_11 += ((zz_10 += ((zz_9 += ((zz_8 += ((zz_7 += (zz_6 >>> 32) + x_6 * x_1) >>> 32) + x_6 * x_2) >>> 32) + x_6 * x_3) >>> 32) + x_6 * x_4) >>> 32) + x_6 * x_5) >>> 32) >>> 32);
        zz_12 &= 0xFFFFFFFFL;
        long zz_14 = ((long)zz[zzOff + 14] & 0xFFFFFFFFL) + (zz_13 >>> 32);
        zz_13 &= 0xFFFFFFFFL;
        w = (int)(zz_7 += x_7 * x_0);
        zz[zzOff + 7] = w << 1 | c;
        c = w >>> 31;
    ...
    public static int subBothFrom(int[] x, int[] y, int[] z) {
        ...
        c >>= 32;
        z[6] = (int)(c += ((long)z[6] & 0xFFFFFFFFL) - ((long)x[6] & 0xFFFFFFFFL) - ((long)y[6] & 0xFFFFFFFFL));
        c >>= 32;
        z[7] = (int)(c += ((long)z[7] & 0xFFFFFFFFL) - ((long)x[7] & 0xFFFFFFFFL) - ((long)y[7] & 0xFFFFFFFFL));
        return (int)(c >>= 32);
    }
    ...
    public static int subFrom(int[] x, int[] z) {
        ...
        c >>= 32;
        z[6] = (int)(c += ((long)z[6] & 0xFFFFFFFFL) - ((long)x[6] & 0xFFFFFFFFL));
        c >>= 32;
        z[7] = (int)(c += ((long)z[7] & 0xFFFFFFFFL) - ((long)x[7] & 0xFFFFFFFFL));
        return (int)(c >>= 32);
    }
    ...
    public static int subFrom(int[] x, int xOff, int[] z, int zOff) {
        ...
        c >>= 32;
        z[zOff + 6] = (int)(c += ((long)z[zOff + 6] & 0xFFFFFFFFL) - ((long)x[xOff + 6] & 0xFFFFFFFFL));
        c >>= 32;
        z[zOff + 7] = (int)(c += ((long)z[zOff + 7] & 0xFFFFFFFFL) - ((long)x[xOff + 7] & 0xFFFFFFFFL));
        return (int)(c >>= 32);
    }
