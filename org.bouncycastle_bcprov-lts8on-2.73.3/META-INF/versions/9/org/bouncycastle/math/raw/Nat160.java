...
public abstract class Nat160 {
    ...
    public static boolean diff(int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        boolean pos = Nat160.gte(x, xOff, y, yOff);
        if (pos) {
    ...
    public static int mulAddTo(int[] x, int[] y, int[] zz) {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            zz[i + 5] = (int)(zc += (c >>>= 32) + ((long)zz[i + 5] & 0xFFFFFFFFL));
            zc >>>= 32;
        }
        return (int)zc;
    }
    ...
    public static int mulAddTo(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            zz[zzOff + 5] = (int)(zc += (c >>>= 32) + ((long)zz[zzOff + 5] & 0xFFFFFFFFL));
            zc >>>= 32;
            ++zzOff;
        }
        return (int)zc;
    ...
    public static int mul33DWordAdd(int x, long y, int[] z, int zOff) {
        ...
        return (c >>>= 32) == 0L ? 0 : Nat.incAt(5, z, zOff, 4);
    }
    ...
    public static int mul33WordAdd(int x, int y, int[] z, int zOff) {
        ...
        return (c >>>= 32) == 0L ? 0 : Nat.incAt(5, z, zOff, 3);
    }
    ...
    public static int mulWordsAdd(int x, int y, int[] z, int zOff) {
        ...
        z[zOff + 0] = (int)(c += yVal * xVal + ((long)z[zOff + 0] & 0xFFFFFFFFL));
        c >>>= 32;
        z[zOff + 1] = (int)(c += (long)z[zOff + 1] & 0xFFFFFFFFL);
        return (c >>>= 32) == 0L ? 0 : Nat.incAt(5, z, zOff, 2);
    }
    ...
    public static void square(int[] x, int[] zz) {
        ...
        zz[4] = w << 1 | c;
        c = w >>> 31;
        zz_8 += (zz_7 += ((zz_6 += ((zz_5 += (zz_4 >>> 32) + x_4 * x_1) >>> 32) + x_4 * x_2) >>> 32) + x_4 * x_3) >>> 32;
        w = (int)zz_5;
        zz[5] = w << 1 | c;
        c = w >>> 31;
        w = (int)zz_6;
