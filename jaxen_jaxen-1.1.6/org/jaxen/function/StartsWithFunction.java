...
implements Function {
    public Object call(Context context, List args) throws FunctionCallException {
        if (args.size() == 2) {
            return StartsWithFunction.evaluate(args.get(0), args.get(1), context.getNavigator());
        }
    ...
    public static Boolean evaluate(Object strArg, Object matchArg, Navigator nav) {
        ...
        return str.startsWith(match = StringFunction.evaluate(matchArg, nav)) ? Boolean.TRUE : Boolean.FALSE;
    }
}
