...
extends Closeable {
    ...
    public <T> void addMessageHandler(Class<T> var1, MessageHandler.Partial<T> var2) throws IllegalStateException;

    public <T> void addMessageHandler(Class<T> var1, MessageHandler.Whole<T> var2) throws IllegalStateException;
}
