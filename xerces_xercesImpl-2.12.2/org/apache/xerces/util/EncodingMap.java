...
public class EncodingMap {
    ...
    public static void putIANA2JavaMapping(String string, String string2) {
        fIANA2JavaMap.put(string, string2);
    }

    public static String getIANA2JavaMapping(String string) {
        return (String)fIANA2JavaMap.get(string);
    }

    public static String removeIANA2JavaMapping(String string) {
        return (String)fIANA2JavaMap.remove(string);
    }

    public static void putJava2IANAMapping(String string, String string2) {
        fJava2IANAMap.put(string, string2);
    }

    public static String getJava2IANAMapping(String string) {
        return (String)fJava2IANAMap.get(string);
    }

    public static String removeJava2IANAMapping(String string) {
        return (String)fJava2IANAMap.remove(string);
    }
