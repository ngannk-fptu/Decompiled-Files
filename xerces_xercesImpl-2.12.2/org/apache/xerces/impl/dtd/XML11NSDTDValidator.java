...
extends XML11DTDValidator {
    ...
    protected final void startNamespaceScope(QName qName, XMLAttributes xMLAttributes, Augmentations augmentations) throws XNIException {
        ...
        String string4 = qName.prefix != null ? qName.prefix : XMLSymbols.EMPTY_STRING;
        qName.uri = this.fNamespaceContext.getURI(string4);
        ...
        for (int i = 0; i < n - 1; ++i) {
            ...
            String string5 = xMLAttributes.getLocalName(i);
            for (int j = i + 1; j < n; ++j) {
                String string6 = xMLAttributes.getLocalName(j);
                String string7 = xMLAttributes.getURI(j);
                if (string5 != string6 || string != string7) continue;
                this.fErrorReporter.reportError("http://www.w3.org/TR/1999/REC-xml-names-19990114", "AttributeNSNotUnique", new Object[]{qName.rawname, string5, string}, (short)2);
            }
        }
    }
