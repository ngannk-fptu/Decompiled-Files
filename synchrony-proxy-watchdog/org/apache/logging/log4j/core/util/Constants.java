...
public final class Constants {
    ...
    public static final int INITIAL_REUSABLE_MESSAGE_SIZE = Constants.size("log4j.initialReusableMsgSize", 128);
    public static final int MAX_REUSABLE_MESSAGE_SIZE = Constants.size("log4j.maxReusableMsgSize", 518);
    public static final int ENCODER_CHAR_BUFFER_SIZE = Constants.size("log4j.encoder.charBufferSize", 2048);
    public static final int ENCODER_BYTE_BUFFER_SIZE = Constants.size("log4j.encoder.byteBufferSize", 8192);
