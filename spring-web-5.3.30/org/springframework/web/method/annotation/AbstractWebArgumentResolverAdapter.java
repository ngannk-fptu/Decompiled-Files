...
implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        try {
            ...
            return ClassUtils.isAssignableValue((Class)parameter.getParameterType(), (Object)result);
        }
        catch (Exception ex) {
            if (this.logger.isDebugEnabled()) {
                this.logger.debug((Object)("Error in checking support for parameter [" + parameter + "]: " + ex.getMessage()));
            }
            return false;
        }
    }
    ...
    public Object resolveArgument(MethodParameter parameter, @Nullable ModelAndViewContainer mavContainer, NativeWebRequest webRequest, @Nullable WebDataBinderFactory binderFactory) throws Exception {
        ...
        Object result = this.adaptee.resolveArgument(parameter, webRequest);
        if (result == WebArgumentResolver.UNRESOLVED || !ClassUtils.isAssignableValue((Class)paramType, (Object)result)) {
