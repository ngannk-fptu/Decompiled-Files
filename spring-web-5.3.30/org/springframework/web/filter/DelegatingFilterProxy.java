...
extends GenericFilterBean {
    ...
    public DelegatingFilterProxy(Filter delegate) {
        Assert.notNull((Object)delegate, (String)"Delegate Filter must not be null");
    ...
    protected WebApplicationContext findWebApplicationContext() {
        if (this.webApplicationContext != null) {
            ...
            if (this.webApplicationContext instanceof ConfigurableApplicationContext && !(cac = (ConfigurableApplicationContext)this.webApplicationContext).isActive()) {
                cac.refresh();
            }
    ...
    protected Filter initDelegate(WebApplicationContext wac) throws ServletException {
        ...
        Assert.state((targetBeanName != null ? 1 : 0) != 0, (String)"No target bean name set");
