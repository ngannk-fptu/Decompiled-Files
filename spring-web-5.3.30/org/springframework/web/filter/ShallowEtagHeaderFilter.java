...
extends OncePerRequestFilter {
    ...
    private void updateResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Assert.notNull((Object)((Object)wrapper), (String)"ContentCachingResponseWrapper not found");
    ...
    protected String generateETagHeaderValue(InputStream inputStream, boolean isWeak) throws IOException {
        ...
        builder.append("\"0");
        DigestUtils.appendMd5DigestAsHex((InputStream)inputStream, (StringBuilder)builder);
        builder.append('\"');
        return builder.toString();
    }

    public static void disableContentCaching(ServletRequest request) {
        Assert.notNull((Object)request, (String)"ServletRequest must not be null");
    ...
    extends ContentCachingResponseWrapper {
        ...
        private boolean hasETag() {
            return StringUtils.hasText((String)this.getHeader("ETag"));
        }
    }
}
