...
Cloneable {
    ...
    public static UriComponentsBuilder fromUriString(String uri) {
        ...
        if (matcher.matches()) {
            ...
            if (opaque) {
                ...
                if (StringUtils.hasLength((String)scheme) && scheme.startsWith("http") && !StringUtils.hasLength((String)host)) {
    ...
    public static UriComponentsBuilder fromHttpUrl(String httpUrl) {
        Assert.notNull((Object)httpUrl, (String)"HTTP URL must not be null");
    ...
    public static UriComponentsBuilder fromOriginHeader(String origin) {
        ...
        if (matcher.matches()) {
            ...
            String host = matcher.group(6);
            String port = matcher.group(8);
            if (StringUtils.hasLength((String)scheme)) {
                builder.scheme(scheme);
            }
            builder.host(host);
            if (StringUtils.hasLength((String)port)) {
    ...
    public UriComponentsBuilder uri(URI uri) {
        ...
        if (uri.isOpaque()) {
            ...
            if (StringUtils.hasLength((String)uri.getRawPath())) {
                this.pathBuilder = new CompositePathComponentBuilder();
                this.pathBuilder.addPath(uri.getRawPath());
            }
            if (StringUtils.hasLength((String)uri.getRawQuery())) {
    ...
    public UriComponentsBuilder port(int port) {
        Assert.isTrue((port >= -1 ? 1 : 0) != 0, (String)"Port must be >= -1");
    ...
    public UriComponentsBuilder query(@Nullable String query) {
        if (query != null) {
            ...
            while (matcher.find()) {
                ...
                this.queryParam(name, value != null ? value : (StringUtils.hasLength((String)eq) ? "" : null));
            }
            this.resetSchemeSpecificPart();
        } else {
            this.queryParams.clear();
    ...
    public UriComponentsBuilder queryParam(String name, Object ... values) {
        ...
        if (!ObjectUtils.isEmpty((Object[])values)) {
            for (Object value : values) {
                ...
                this.queryParams.add((Object)name, (Object)valueAsString);
            }
        } else {
            this.queryParams.add((Object)name, null);
        }
        this.resetSchemeSpecificPart();
        return this;
    }
    ...
    public UriComponentsBuilder fragment(@Nullable String fragment) {
        if (fragment != null) {
            Assert.hasLength((String)fragment, (String)"Fragment must not be empty");
        ...
        try {
            ...
            if (StringUtils.hasText((String)forwardedHeader)) {
                ...
                if (StringUtils.hasText((String)protocolHeader)) {
                    this.scheme(StringUtils.tokenizeToStringArray((String)protocolHeader, (String)",")[0]);
                    this.port(null);
                } else if (this.isForwardedSslOn(headers)) {
                    this.scheme("https");
                    this.port(null);
                ...
                if (StringUtils.hasText((String)hostHeader)) {
                    this.adaptForwardedHost(StringUtils.tokenizeToStringArray((String)hostHeader, (String)",")[0]);
                }
                if (StringUtils.hasText((String)(portHeader = headers.getFirst("X-Forwarded-Port")))) {
                    this.port(Integer.parseInt(StringUtils.tokenizeToStringArray((String)portHeader, (String)",")[0]));
                }
            }
        }
        catch (NumberFormatException ex) {
    ...
    implements PathComponentBuilder {
        ...
        public void append(String ... pathSegments) {
            for (String pathSegment : pathSegments) {
                if (!StringUtils.hasText((String)pathSegment)) continue;
