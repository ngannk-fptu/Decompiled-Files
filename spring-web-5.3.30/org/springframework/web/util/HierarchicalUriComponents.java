...
extends UriComponents {
    ...
    private static final MultiValueMap<String, String> EMPTY_QUERY_PARAMS = CollectionUtils.unmodifiableMultiValueMap((MultiValueMap)new LinkedMultiValueMap());
    ...
    private MultiValueMap<String, String> encodeQueryParams(BiFunction<String, Type, String> encoder) {
        ...
        this.queryParams.forEach((arg_0, arg_1) -> HierarchicalUriComponents.lambda$encodeQueryParams$3(encoder, (MultiValueMap)result, arg_0, arg_1));
    ...
    static String encodeUriComponent(String source, Charset charset, Type type) {
        ...
        return StreamUtils.copyToString((ByteArrayOutputStream)baos, (Charset)charset);
    }
    ...
    protected HierarchicalUriComponents expandInternal(UriComponents.UriTemplateVariables uriVariables) {
        Assert.state((!this.encodeState.equals((Object)EncodeState.FULLY_ENCODED) ? 1 : 0) != 0, (String)"URI components already encoded, and could not possibly contain '{' or '}'.");
    ...
    private MultiValueMap<String, String> expandQueryParams(UriComponents.UriTemplateVariables variables) {
        ...
        this.queryParams.forEach((arg_0, arg_1) -> this.lambda$expandQueryParams$5(queryVariables, (MultiValueMap)result, arg_0, arg_1));
        return CollectionUtils.unmodifiableMultiValueMap((MultiValueMap)result);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return ObjectUtils.nullSafeEquals((Object)this.getScheme(), (Object)otherComp.getScheme()) && ObjectUtils.nullSafeEquals((Object)this.getUserInfo(), (Object)otherComp.getUserInfo()) && ObjectUtils.nullSafeEquals((Object)this.getHost(), (Object)otherComp.getHost()) && this.getPort() == otherComp.getPort() && this.path.equals(otherComp.path) && this.queryParams.equals(otherComp.queryParams) && ObjectUtils.nullSafeEquals((Object)this.getFragment(), (Object)otherComp.getFragment());
    }
    ...
    private /* synthetic */ void lambda$expandQueryParams$5(UriComponents.UriTemplateVariables queryVariables, MultiValueMap result, String key, List values) {
        ...
        result.put((Object)name, expandedValues);
    }

    private static /* synthetic */ void lambda$encodeQueryParams$3(BiFunction encoder, MultiValueMap result, String key, List values) {
        ...
        result.put((Object)name, encodedValues);
    }
    ...
    implements PathComponent {
        ...
        @Override
        public List<String> getPathSegments() {
            String[] segments = StringUtils.tokenizeToStringArray((String)this.getPath(), (String)PATH_DELIMITER_STRING);
