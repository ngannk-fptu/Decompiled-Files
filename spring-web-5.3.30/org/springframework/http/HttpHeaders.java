...
Serializable {
    ...
    public List<Locale.LanguageRange> getAcceptLanguage() {
        ...
        return StringUtils.hasText((String)value) ? Locale.LanguageRange.parse(value) : Collections.emptyList();
    }
    ...
    public List<Locale> getAcceptLanguageAsLocales() {
        ...
        return ranges.stream().map(range -> Locale.forLanguageTag(range.getRange())).filter(locale -> StringUtils.hasText((String)locale.getDisplayName())).collect(Collectors.toList());
    }
    ...
    public List<String> getValuesAsList(String headerName) {
        ...
        if (values != null) {
            ...
            while (iterator.hasNext()) {
                ...
                Collections.addAll(result, StringUtils.tokenizeToStringArray((String)value, (String)","));
            }
            return result;
        }
        return Collections.emptyList();
