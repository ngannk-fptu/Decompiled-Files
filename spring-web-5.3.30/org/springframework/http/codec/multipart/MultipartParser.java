...
extends BaseSubscriber<DataBuffer> {
    ...
    implements State {
        ...
        public void onComplete() {
            if (MultipartParser.this.changeState(this, DisposedState.INSTANCE, null)) {
                MultipartParser.this.emitError((Throwable)new DecodingException("Could not find end of body"));
            }
        }
    ...
    implements State {
        private final DataBufferUtils.Matcher endHeaders = DataBufferUtils.matcher((byte[])MultipartUtils.concat(MultipartParser.access$500(), MultipartParser.access$500()));
