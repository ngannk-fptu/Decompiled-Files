...
extends HttpCookie {
    ...
    private ResponseCookie(String name, String value, Duration maxAge, @Nullable String domain, @Nullable String path, boolean secure, boolean httpOnly, @Nullable String sameSite) {
        super(name, value);
        Assert.notNull((Object)maxAge, (String)"Max age must not be null");
        this.maxAge = maxAge;
        this.domain = domain;
        this.path = path;
        this.secure = secure;
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.getName().equalsIgnoreCase(otherCookie.getName()) && ObjectUtils.nullSafeEquals((Object)this.path, (Object)otherCookie.getPath()) && ObjectUtils.nullSafeEquals((Object)this.domain, (Object)otherCookie.getDomain());
    }
    ...
    private static ResponseCookieBuilder from(final String name, final String value, final boolean lenient) {
        return new ResponseCookieBuilder(){
            ...
            private String initDomain(@Nullable String domain) {
                String str;
                if (lenient && StringUtils.hasLength((String)domain) && (str = domain.trim()).startsWith("\"") && str.endsWith("\"") && str.substring(1, str.length() - 1).trim().isEmpty()) {
                    return null;
                }
                return domain;
            }
    ...
    private static class Rfc6265Utils {
        ...
        public static void validateDomain(@Nullable String domain) {
            if (!StringUtils.hasLength((String)domain)) {
                return;
            }
