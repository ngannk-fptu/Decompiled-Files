...
extends AbstractHttpMessageConverter<Message> {
    ...
    ProtobufHttpMessageConverter(@Nullable ProtobufFormatSupport formatSupport, @Nullable ExtensionRegistry extensionRegistry) {
        ...
        this.protobufFormatSupport = formatSupport != null ? formatSupport : (ClassUtils.isPresent((String)"com.googlecode.protobuf.format.FormatFactory", (ClassLoader)this.getClass().getClassLoader()) ? new ProtobufJavaFormatSupport() : (ClassUtils.isPresent((String)"com.google.protobuf.util.JsonFormat", (ClassLoader)this.getClass().getClassLoader()) ? new ProtobufJavaUtilSupport(null, null) : null));
