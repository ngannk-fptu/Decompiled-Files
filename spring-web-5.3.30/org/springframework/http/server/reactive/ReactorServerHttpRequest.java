...
extends AbstractServerHttpRequest {
    static final boolean reactorNettyRequestChannelOperationsIdPresent = ClassUtils.isPresent((String)"reactor.netty.ChannelOperationsId", (ClassLoader)ReactorServerHttpRequest.class.getClassLoader());
