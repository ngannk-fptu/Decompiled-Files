...
implements KeyboardEvent {
    ...
    public boolean getCtrlKey() {
        return this.modifierKeys.contains(KEY_CONTROL);
    }

    public boolean getShiftKey() {
        return this.modifierKeys.contains(KEY_SHIFT);
    }

    public boolean getAltKey() {
        return this.modifierKeys.contains(KEY_ALT);
    }

    public boolean getMetaKey() {
        return this.modifierKeys.contains(KEY_META);
    }
