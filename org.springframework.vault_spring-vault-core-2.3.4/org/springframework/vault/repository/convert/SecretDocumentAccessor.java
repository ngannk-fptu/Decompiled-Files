...
class SecretDocumentAccessor {
    ...
    SecretDocumentAccessor(SecretDocument document) {
        Assert.notNull((Object)document, (String)"SecretDocument must not be null");
    ...
    void put(VaultPersistentProperty prop, @Nullable Object value) {
        Assert.notNull((Object)((Object)prop), (String)"VaultPersistentProperty must not be null");
    ...
    boolean hasValue(VaultPersistentProperty property) {
        ...
        if (property.isIdProperty()) {
            return StringUtils.hasText((String)this.document.getId());
        }
        String fieldName = property.getName();
        if (!fieldName.contains(".")) {
