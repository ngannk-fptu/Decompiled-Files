...
public interface PDF {
    ...
    public static final String PDF_PREFLIGHT_PREFIX = "pdf-preflight:";
    ...
    public static final Property PREFLIGHT_IS_VALID = Property.internalBoolean("pdf-preflight:isValid");
    public static final Property PREFLIGHT_PARSE_EXCEPTION = Property.internalText("pdf-preflight:parseException");
    public static final Property PREFLIGHT_VALIDATION_ERRORS = Property.internalTextBag("pdf-preflight:validationErrors");
    public static final Property PREFLIGHT_SPECIFICATION = Property.internalText("pdf-preflight:specification");
    public static final Property PREFLIGHT_TRAILER_COUNT = Property.internalInteger("pdf-preflight:trailerCount");
    public static final Property PREFLIGHT_XREF_TYPE = Property.internalText("pdf-preflight:xrefType");
    public static final Property PREFLIGHT_ICC_PROFILE = Property.internalText("pdf-preflight:iccProfile");
    public static final Property PREFLIGHT_IS_LINEARIZED = Property.internalBoolean("pdf-preflight:isLinearized");
    public static final Property PREFLIGHT_INCREMENTAL_UPDATES = Property.internalBoolean("pdf-preflight:hasIncrementalUpdates");
}
