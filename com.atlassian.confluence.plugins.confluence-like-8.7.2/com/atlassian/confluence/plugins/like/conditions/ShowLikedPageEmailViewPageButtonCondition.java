...
public class ShowLikedPageEmailViewPageButtonCondition
extends AbstractNotificationCondition {
    protected boolean shouldDisplay(NotificationContext context) {
        return context.getEvent() instanceof LikeCreatedEvent && context.getContent() instanceof AbstractPage && !context.getRecipient().getName().equals(context.getContent().getCreatorName()) && "page".equals(((AbstractPage)context.getContent()).getType());
    }
}
