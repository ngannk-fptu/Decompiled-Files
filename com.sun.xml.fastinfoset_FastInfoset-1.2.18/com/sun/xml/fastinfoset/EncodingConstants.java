...
public final class EncodingConstants {
    ...
    public static final long OCTET_STRING_MAXIMUM_LENGTH = 0x100000000L;
    ...
    public static final int INTEGER_MAXIMUM_SIZE = 0x100000;
    public static final int INTEGER_2ND_BIT_SMALL_LIMIT = 64;
    public static final int INTEGER_2ND_BIT_MEDIUM_LIMIT = 8256;
    public static final int INTEGER_2ND_BIT_LARGE_LIMIT = 0x100000;
    ...
    private static void initiateXMLDeclarationValues() {
        ...
        try {
            EncodingConstants.XML_DECLARATION_VALUES[0] = "<?xml encoding='finf'?>".getBytes("UTF-8");
            EncodingConstants.XML_DECLARATION_VALUES[1] = "<?xml version='1.0' encoding='finf'?>".getBytes("UTF-8");
            EncodingConstants.XML_DECLARATION_VALUES[2] = "<?xml version='1.1' encoding='finf'?>".getBytes("UTF-8");
            EncodingConstants.XML_DECLARATION_VALUES[3] = "<?xml encoding='finf' standalone='no'?>".getBytes("UTF-8");
            EncodingConstants.XML_DECLARATION_VALUES[4] = "<?xml encoding='finf' standalone='yes'?>".getBytes("UTF-8");
            EncodingConstants.XML_DECLARATION_VALUES[5] = "<?xml version='1.0' encoding='finf' standalone='no'?>".getBytes("UTF-8");
            EncodingConstants.XML_DECLARATION_VALUES[6] = "<?xml version='1.1' encoding='finf' standalone='no'?>".getBytes("UTF-8");
            EncodingConstants.XML_DECLARATION_VALUES[7] = "<?xml version='1.0' encoding='finf' standalone='yes'?>".getBytes("UTF-8");
            EncodingConstants.XML_DECLARATION_VALUES[8] = "<?xml version='1.1' encoding='finf' standalone='yes'?>".getBytes("UTF-8");
        }
    ...
    static {
        EncodingConstants.initiateXMLDeclarationValues();
        XML_NAMESPACE_PREFIX_LENGTH = XML_NAMESPACE_PREFIX.length();
        XML_NAMESPACE_NAME_LENGTH = XML_NAMESPACE_NAME.length();
        XMLNS_NAMESPACE_PREFIX_LENGTH = XMLNS_NAMESPACE_PREFIX.length();
        XMLNS_NAMESPACE_NAME_LENGTH = XMLNS_NAMESPACE_NAME.length();
        DEFAULT_NAMESPACE_DECLARATION = new QualifiedName("", XMLNS_NAMESPACE_NAME, XMLNS_NAMESPACE_PREFIX, XMLNS_NAMESPACE_PREFIX);
        ...
        INTEGER_2ND_BIT_VALUES = new int[]{64, 8256, 0x100000, 64, 96, -1};
