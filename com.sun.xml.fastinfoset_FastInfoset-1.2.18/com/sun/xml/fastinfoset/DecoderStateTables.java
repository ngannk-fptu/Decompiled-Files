...
public class DecoderStateTables {
    ...
    private static final int[][] DII_RANGES = new int[][]{{31, 0}, {39, 2}, {48, 3}, {55, 255}, {56, 4}, {59, 255}, {60, 5}, {61, 5}, {62, 255}, {63, 5}, {95, 1}, {103, 2}, {112, 3}, {119, 255}, {120, 4}, {123, 255}, {124, 5}, {125, 5}, {126, 255}, {127, 5}, {195, 255}, {199, 20}, {224, 255}, {225, 19}, {226, 18}, {239, 255}, {240, 22}, {254, 255}, {255, 23}};
    private static final int[] EII = new int[256];
    private static final int[][] EII_RANGES = new int[][]{{31, 0}, {39, 2}, {48, 3}, {55, 255}, {56, 4}, {59, 255}, {60, 5}, {61, 5}, {62, 255}, {63, 5}, {95, 1}, {103, 2}, {112, 3}, {119, 255}, {120, 4}, {123, 255}, {124, 5}, {125, 5}, {126, 255}, {127, 5}, {129, 6}, {130, 7}, {131, 8}, {133, 9}, {134, 10}, {135, 11}, {139, 12}, {143, 13}, {145, 6}, {146, 7}, {147, 8}, {149, 9}, {150, 10}, {151, 11}, {155, 12}, {159, 13}, {175, 14}, {179, 15}, {183, 16}, {184, 17}, {199, 255}, {203, 21}, {224, 255}, {225, 19}, {226, 18}, {239, 255}, {240, 22}, {254, 255}, {255, 23}};
    ...
    private static final int[][] AII_RANGES = new int[][]{{63, 0}, {95, 1}, {111, 2}, {119, 255}, {121, 3}, {122, 255}, {123, 3}, {239, 255}, {240, 4}, {254, 255}, {255, 5}};
    ...
    private static final int[][] NISTRING_RANGES = new int[][]{{7, 0}, {8, 1}, {11, 255}, {12, 2}, {15, 255}, {23, 3}, {24, 4}, {27, 255}, {28, 5}, {31, 255}, {47, 6}, {63, 7}, {71, 0}, {72, 1}, {75, 255}, {76, 2}, {79, 255}, {87, 3}, {88, 4}, {91, 255}, {92, 5}, {95, 255}, {111, 6}, {127, 7}, {191, 8}, {223, 9}, {239, 10}, {254, 255}, {255, 11}};
    ...
    private static final int[][] ISTRING_RANGES = new int[][]{{63, 0}, {64, 1}, {95, 255}, {96, 2}, {127, 255}, {191, 3}, {223, 4}, {239, 5}, {255, 255}};
    ...
    private static final int[][] ISTRING_PREFIX_NAMESPACE_RANGES = new int[][]{{1, 0}, {2, 6}, {3, 0}, {4, 7}, {27, 0}, {28, 8}, {34, 0}, {35, 9}, {63, 0}, {64, 1}, {95, 255}, {96, 2}, {127, 255}, {128, 10}, {191, 3}, {223, 4}, {239, 5}, {255, 255}};
    ...
    private static final int[][] UTF8_NCNAME_RANGES = new int[][]{{44, 255}, {46, 1}, {47, 255}, {57, 1}, {64, 255}, {90, 0}, {94, 255}, {95, 0}, {96, 255}, {122, 0}, {127, 255}, {193, 255}, {223, 2}, {239, 3}, {247, 4}, {255, 255}};
    static final int UTF8_ONE_BYTE = 1;
    private static final int[] UTF8 = new int[256];
    private static final int[][] UTF8_RANGES = new int[][]{{8, 255}, {10, 1}, {12, 255}, {13, 1}, {31, 255}, {127, 1}, {193, 255}, {223, 2}, {239, 3}, {247, 4}, {255, 255}};
    ...
    static {
        DecoderStateTables.constructTable(DII, DII_RANGES);
        DecoderStateTables.constructTable(EII, EII_RANGES);
        DecoderStateTables.constructTable(AII, AII_RANGES);
        DecoderStateTables.constructTable(NISTRING, NISTRING_RANGES);
        DecoderStateTables.constructTable(ISTRING, ISTRING_RANGES);
        DecoderStateTables.constructTable(ISTRING_PREFIX_NAMESPACE, ISTRING_PREFIX_NAMESPACE_RANGES);
        DecoderStateTables.constructTable(UTF8_NCNAME, UTF8_NCNAME_RANGES);
        DecoderStateTables.constructTable(UTF8, UTF8_RANGES);
    }
}
