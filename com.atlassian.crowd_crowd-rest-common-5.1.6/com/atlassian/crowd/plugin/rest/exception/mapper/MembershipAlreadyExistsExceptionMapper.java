...
implements ExceptionMapper<MembershipAlreadyExistsException> {
    public Response toResponse(MembershipAlreadyExistsException exception) {
        return Response.status((Response.Status)Response.Status.CONFLICT).entity((Object)ErrorEntity.of((Exception)exception)).build();
    }
}
