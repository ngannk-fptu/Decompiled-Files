...
@Provider
public class AliasAlreadyInUseRuntimeExceptionMapper
implements ExceptionMapper<AliasAlreadyInUseRuntimeException> {
    public Response toResponse(AliasAlreadyInUseRuntimeException exception) {
