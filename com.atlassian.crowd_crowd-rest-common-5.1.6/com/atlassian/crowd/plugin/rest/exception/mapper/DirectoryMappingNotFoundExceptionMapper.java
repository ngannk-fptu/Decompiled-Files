...
@Provider
public class DirectoryMappingNotFoundExceptionMapper
implements ExceptionMapper<DirectoryMappingNotFoundException> {
    public Response toResponse(DirectoryMappingNotFoundException e) {
        ErrorEntity errorEntity = new ErrorEntity(ErrorEntity.ErrorReason.of((Throwable)e), e.getMessage());
