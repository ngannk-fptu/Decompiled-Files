...
extends ContextAwareBase {
    ...
    private String[] enabledProtocols(String[] supportedProtocols, String[] defaultProtocols) {
        if (this.enabledProtocols == null) {
            this.enabledProtocols = OptionHelper.isNullOrEmpty(this.getIncludedProtocols()) && OptionHelper.isNullOrEmpty(this.getExcludedProtocols()) ? Arrays.copyOf(defaultProtocols, defaultProtocols.length) : this.includedStrings(supportedProtocols, this.getIncludedProtocols(), this.getExcludedProtocols());
    ...
    private String[] enabledCipherSuites(String[] supportedCipherSuites, String[] defaultCipherSuites) {
        if (this.enabledCipherSuites == null) {
            this.enabledCipherSuites = OptionHelper.isNullOrEmpty(this.getIncludedCipherSuites()) && OptionHelper.isNullOrEmpty(this.getExcludedCipherSuites()) ? Arrays.copyOf(defaultCipherSuites, defaultCipherSuites.length) : this.includedStrings(supportedCipherSuites, this.getIncludedCipherSuites(), this.getExcludedCipherSuites());
