...
public class UriComponent {
    ...
    private static void decodeQueryParam(MultivaluedMap<String, String> params, String param, boolean decodeNames, boolean decodeValues) {
        try {
            ...
            if (equals > 0) {
                params.add((Object)(decodeNames ? URLDecoder.decode(param.substring(0, equals), "UTF-8") : param.substring(0, equals)), (Object)(decodeValues ? URLDecoder.decode(param.substring(equals + 1), "UTF-8") : param.substring(equals + 1)));
    ...
    private static void decodeMatrixParam(MultivaluedMap<String, String> params, String param, boolean decode) {
        int equals = param.indexOf(61);
        if (equals > 0) {
            params.add((Object)UriComponent.decode(param.substring(0, equals), Type.MATRIX_PARAM), (Object)(decode ? UriComponent.decode(param.substring(equals + 1), Type.MATRIX_PARAM) : param.substring(equals + 1)));
        } else if (equals != 0 && param.length() > 0) {
            params.add((Object)UriComponent.decode(param, Type.MATRIX_PARAM), (Object)"");
        }
    }
