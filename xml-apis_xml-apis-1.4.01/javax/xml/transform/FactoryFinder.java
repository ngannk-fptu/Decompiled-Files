        ...
        try {
            ...
            if (classLoader == null) {
                ...
                try {
                    ...
                    if (bl) {
                        classLoader = (class$javax$xml$transform$FactoryFinder == null ? (class$javax$xml$transform$FactoryFinder = FactoryFinder.class$("javax.xml.transform.FactoryFinder")) : class$javax$xml$transform$FactoryFinder).getClassLoader();
