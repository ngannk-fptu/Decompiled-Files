...
public final class HikariProxyConnection
...
Connection {
    ...
    @Override
    public boolean setShardingKeyIfValid(ShardingKey shardingKey, ShardingKey shardingKey2, int n) throws SQLException {
        try {
            return this.delegate.setShardingKeyIfValid(shardingKey, shardingKey2, n);
        }
        catch (SQLException sQLException) {
            throw this.checkException(sQLException);
        }
    ...
    public boolean setShardingKeyIfValid(ShardingKey shardingKey, int n) throws SQLException {
        try {
            return this.delegate.setShardingKeyIfValid(shardingKey, n);
        }
        catch (SQLException sQLException) {
            throw this.checkException(sQLException);
        }
    ...
    protected HikariProxyConnection(PoolEntry poolEntry, Connection connection, FastList fastList, ProxyLeakTask proxyLeakTask, boolean bl, boolean bl2) {
        super(poolEntry, connection, fastList, proxyLeakTask, bl, bl2);
    }
}
