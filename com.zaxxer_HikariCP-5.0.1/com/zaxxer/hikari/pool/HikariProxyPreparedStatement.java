...
public final class HikariProxyPreparedStatement
...
PreparedStatement {
    ...
    public String enquoteLiteral(String string) throws SQLException {
        try {
            return ((PreparedStatement)this.delegate).enquoteLiteral(string);
        }
        catch (SQLException sQLException) {
            throw this.checkException(sQLException);
        }
    ...
    public String enquoteIdentifier(String string, boolean bl) throws SQLException {
        try {
            return ((PreparedStatement)this.delegate).enquoteIdentifier(string, bl);
        }
        catch (SQLException sQLException) {
            throw this.checkException(sQLException);
        }
    ...
    public boolean isSimpleIdentifier(String string) throws SQLException {
        try {
            return ((PreparedStatement)this.delegate).isSimpleIdentifier(string);
        }
        catch (SQLException sQLException) {
            throw this.checkException(sQLException);
        }
    ...
    public String enquoteNCharLiteral(String string) throws SQLException {
        try {
            return ((PreparedStatement)this.delegate).enquoteNCharLiteral(string);
        }
        catch (SQLException sQLException) {
            throw this.checkException(sQLException);
        }
