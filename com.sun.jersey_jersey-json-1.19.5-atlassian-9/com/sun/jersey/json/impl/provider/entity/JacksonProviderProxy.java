...
MessageBodyWriter<Object> {
    ...
    public void setProviders(Providers p) {
        new ComponentInjector((InjectableProviderContext)new ProvidersInjectableProviderContext(p), JacksonJsonProvider.class).inject((Object)this.pojoProvider);
        new ComponentInjector((InjectableProviderContext)new ProvidersInjectableProviderContext(p), JacksonJaxbJsonProvider.class).inject((Object)this.jaxbProvider);
    }
