...
extends UnknownAttachmentTransformerBase {
    ...
    protected XMLEventReader createXmlEventReader(Reader input) throws XMLStreamException {
        return this.xmlEventReaderFactory.createEditorXmlEventReader(input);
    }
