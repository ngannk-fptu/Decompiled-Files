...
public class TitleTextFieldHandler
...
EqualityFieldHandler<String, V2SearchQueryWrapper> {
    ...
    public V2SearchQueryWrapper build(TextExpressionData expressionData, String value) {
        ...
        return V2FieldHandlerHelper.wrapV2Search((SearchQuery)BooleanQuery.orQuery((SearchQuery[])new SearchQuery[]{new TextFieldQuery("content-name-unstemmed", value, BooleanOperator.AND), new TextFieldQuery(SearchFieldNames.TITLE, value, BooleanOperator.AND)}), (ExpressionData)expressionData);
    }
    ...
    public V2SearchQueryWrapper build(SetExpressionData expressionData, Iterable<String> values) {
        ...
        SearchQuery query = V2FieldHandlerHelper.joinSingleValueSearchQueries(values, this::createEqualityQuery);
    ...
    private TextFieldQuery createEqualityQuery(String value) {
        return new TextFieldQuery(SearchFieldNames.CONTENT_NAME_UNTOKENIZED, "\"" + value + "\"", BooleanOperator.AND);
    }
}
