...
public class MentionFieldHandler
extends AbstractUserFieldHandler {
    private static final String FIELD_NAME = "mention";
    private final UserAccessor userAccessor;

    public MentionFieldHandler(UserSubFieldFactory subFieldFactory, @Nullable UserAccessor userAccessor) {
    ...
    public SearchQuery createUserQuery(UserKey key, String username) {
        if (username != null) {
            return new MentionQuery(username);
        }
        return new MentionQuery(this.userAccessor, key);
    }
