...
public final class TemplateConstants {
    ...
    public static final int DYNAMIC_CONFIG_TEMPLATE_ID = 30;
    public static final int FLAKE_ID_GENERATOR_TEMPLATE_ID = 31;
    public static final int PN_COUNTER_ID_GENERATOR_TEMPLATE_ID = 32;
    public static final int CP_GROUP_TEMPLATE_ID = 33;
    public static final int CP_SESSION_TEMPLATE_ID = 34;
    public static final int CP_ATOMIC_LONG_TEMPLATE_ID = 35;
    public static final int CP_ATOMIC_REF_TEMPLATE_ID = 36;
    public static final int CP_COUNT_DOWN_LATCH_TEMPLATE_ID = 37;
    public static final int CP_FENCED_LOCK_TEMPLATE_ID = 38;
    public static final int CP_SEMAPHORE_TEMPLATE_ID = 39;
