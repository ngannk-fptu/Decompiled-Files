...
extends DefaultMapQueryMessageTask<MapValuesWithPredicateCodec.RequestParameters> {
    ...
    protected Object reduce(Collection<QueryResultRow> result) {
        ...
        LocalMapStatsUtil.incrementOtherOperationsCount((MapService)this.getService("hz:impl:mapService"), ((MapValuesWithPredicateCodec.RequestParameters)this.parameters).name);
        return values;
    }

    @Override
    protected Predicate getPredicate() {
        return (Predicate)this.serializationService.toObject(((MapValuesWithPredicateCodec.RequestParameters)this.parameters).predicate);
    }
    ...
    protected ClientMessage encodeResponse(Object response) {
        return MapValuesWithPredicateCodec.encodeResponse((List)response);
    }

    @Override
    public Object[] getParameters() {
        return new Object[]{((MapValuesWithPredicateCodec.RequestParameters)this.parameters).predicate};
    }

    @Override
    public String getDistributedObjectName() {
        return ((MapValuesWithPredicateCodec.RequestParameters)this.parameters).name;
    }
