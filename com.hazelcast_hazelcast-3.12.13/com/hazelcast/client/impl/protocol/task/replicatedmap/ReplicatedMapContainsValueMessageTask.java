...
extends AbstractPartitionMessageTask<ReplicatedMapContainsValueCodec.RequestParameters> {
    ...
    protected Operation prepareOperation() {
        return new ContainsValueOperation(((ReplicatedMapContainsValueCodec.RequestParameters)this.parameters).name, ((ReplicatedMapContainsValueCodec.RequestParameters)this.parameters).value);
    }
    ...
    public Permission getRequiredPermission() {
        return new ReplicatedMapPermission(((ReplicatedMapContainsValueCodec.RequestParameters)this.parameters).name, "read");
    }

    @Override
    public String getDistributedObjectName() {
        return ((ReplicatedMapContainsValueCodec.RequestParameters)this.parameters).name;
    }
    ...
    public Object[] getParameters() {
        return new Object[]{((ReplicatedMapContainsValueCodec.RequestParameters)this.parameters).value};
    }
}
