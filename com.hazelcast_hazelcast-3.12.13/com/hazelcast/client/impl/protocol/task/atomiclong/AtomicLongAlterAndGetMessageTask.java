...
extends AbstractPartitionMessageTask<AtomicLongAlterAndGetCodec.RequestParameters> {
    ...
    protected Operation prepareOperation() {
        IFunction function = (IFunction)this.serializationService.toObject(((AtomicLongAlterAndGetCodec.RequestParameters)this.parameters).function);
        return new AlterAndGetOperation(((AtomicLongAlterAndGetCodec.RequestParameters)this.parameters).name, function);
    }
    ...
    public Permission getRequiredPermission() {
        return new AtomicLongPermission(((AtomicLongAlterAndGetCodec.RequestParameters)this.parameters).name, "modify");
    }

    @Override
    public String getDistributedObjectName() {
        return ((AtomicLongAlterAndGetCodec.RequestParameters)this.parameters).name;
    }
    ...
    public Object[] getParameters() {
        return new Object[]{((AtomicLongAlterAndGetCodec.RequestParameters)this.parameters).function};
    }
}
