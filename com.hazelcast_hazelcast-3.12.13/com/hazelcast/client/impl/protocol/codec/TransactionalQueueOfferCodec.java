...
public final class TransactionalQueueOfferCodec {
    public static final TransactionalQueueMessageType REQUEST_TYPE = TransactionalQueueMessageType.TRANSACTIONALQUEUE_OFFER;
    public static final int RESPONSE_TYPE = 101;

    public static ClientMessage encodeRequest(String name, String txnId, long threadId, Data item, long timeout) {
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, String txnId, long threadId, Data item, long timeout) {
            int dataSize = ClientMessage.HEADER_SIZE;
