...
public final class AtomicLongGetAndIncrementCodec {
    public static final AtomicLongMessageType REQUEST_TYPE = AtomicLongMessageType.ATOMICLONG_GETANDINCREMENT;
    ...
    public static ClientMessage encodeRequest(String name) {
        ...
        clientMessage.setOperationName("AtomicLong.getAndIncrement");
