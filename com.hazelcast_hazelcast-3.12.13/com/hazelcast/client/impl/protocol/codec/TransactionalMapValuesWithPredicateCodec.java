...
public final class TransactionalMapValuesWithPredicateCodec {
    public static final TransactionalMapMessageType REQUEST_TYPE = TransactionalMapMessageType.TRANSACTIONALMAP_VALUESWITHPREDICATE;
    public static final int RESPONSE_TYPE = 106;

    public static ClientMessage encodeRequest(String name, String txnId, long threadId, Data predicate) {
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, String txnId, long threadId, Data predicate) {
            int dataSize = ClientMessage.HEADER_SIZE;
