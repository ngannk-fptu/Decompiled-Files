...
public final class MapRemoveInterceptorCodec {
    public static final MapMessageType REQUEST_TYPE = MapMessageType.MAP_REMOVEINTERCEPTOR;
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        String id = null;
        parameters.id = id = clientMessage.getStringUtf8();
        return parameters;
    }
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, String id) {
            ...
            return dataSize += ParameterUtil.calculateDataSize(id);
        }
    }
}
