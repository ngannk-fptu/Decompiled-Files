...
public final class CPCountDownLatchTrySetCountCodec {
    public static final CPCountDownLatchMessageType REQUEST_TYPE = CPCountDownLatchMessageType.CPCOUNTDOWNLATCH_TRYSETCOUNT;
    public static final int RESPONSE_TYPE = 101;

    public static ClientMessage encodeRequest(RaftGroupId groupId, String name, int count) {
        int requiredDataSize = RequestParameters.calculateDataSize(groupId, name, count);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(RaftGroupId groupId, String name, int count) {
            int dataSize = ClientMessage.HEADER_SIZE;
