...
public final class ScheduledExecutorCancelFromAddressCodec {
    public static final ScheduledExecutorMessageType REQUEST_TYPE = ScheduledExecutorMessageType.SCHEDULEDEXECUTOR_CANCELFROMADDRESS;
    public static final int RESPONSE_TYPE = 101;

    public static ClientMessage encodeRequest(String schedulerName, String taskName, Address address, boolean mayInterruptIfRunning) {
        int requiredDataSize = RequestParameters.calculateDataSize(schedulerName, taskName, address, mayInterruptIfRunning);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String schedulerName, String taskName, Address address, boolean mayInterruptIfRunning) {
            int dataSize = ClientMessage.HEADER_SIZE;
