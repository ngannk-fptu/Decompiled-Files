...
public final class AtomicLongAlterAndGetCodec {
    public static final AtomicLongMessageType REQUEST_TYPE = AtomicLongMessageType.ATOMICLONG_ALTERANDGET;
    ...
    public static ClientMessage encodeRequest(String name, Data function) {
        ...
        clientMessage.setOperationName("AtomicLong.alterAndGet");
