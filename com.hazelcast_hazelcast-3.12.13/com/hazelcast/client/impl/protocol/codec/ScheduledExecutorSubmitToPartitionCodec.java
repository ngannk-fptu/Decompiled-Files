...
public final class ScheduledExecutorSubmitToPartitionCodec {
    public static final ScheduledExecutorMessageType REQUEST_TYPE = ScheduledExecutorMessageType.SCHEDULEDEXECUTOR_SUBMITTOPARTITION;
    public static final int RESPONSE_TYPE = 100;

    public static ClientMessage encodeRequest(String schedulerName, byte type, String taskName, Data task, long initialDelayInMillis, long periodInMillis) {
        int requiredDataSize = RequestParameters.calculateDataSize(schedulerName, type, taskName, task, initialDelayInMillis, periodInMillis);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String schedulerName, byte type, String taskName, Data task, long initialDelayInMillis, long periodInMillis) {
            int dataSize = ClientMessage.HEADER_SIZE;
