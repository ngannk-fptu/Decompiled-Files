...
public final class MapReplaceIfSameCodec {
    ...
    public static ClientMessage encodeRequest(String name, Data key, Data testValue, Data value, long threadId) {
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        Data testValue = null;
        parameters.testValue = testValue = clientMessage.getData();
        Data value = null;
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data key, Data testValue, Data value, long threadId) {
            int dataSize = ClientMessage.HEADER_SIZE;
