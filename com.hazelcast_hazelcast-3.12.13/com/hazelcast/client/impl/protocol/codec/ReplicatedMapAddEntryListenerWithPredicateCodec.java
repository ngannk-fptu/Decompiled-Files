...
public final class ReplicatedMapAddEntryListenerWithPredicateCodec {
    public static final ReplicatedMapMessageType REQUEST_TYPE = ReplicatedMapMessageType.REPLICATEDMAP_ADDENTRYLISTENERWITHPREDICATE;
    public static final int RESPONSE_TYPE = 104;

    public static ClientMessage encodeRequest(String name, Data predicate, boolean localOnly) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, predicate, localOnly);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data predicate, boolean localOnly) {
            int dataSize = ClientMessage.HEADER_SIZE;
