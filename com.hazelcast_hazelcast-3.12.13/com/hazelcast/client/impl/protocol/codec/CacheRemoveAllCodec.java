...
public final class CacheRemoveAllCodec {
    public static final CacheMessageType REQUEST_TYPE = CacheMessageType.CACHE_REMOVEALL;
    public static final int RESPONSE_TYPE = 100;

    public static ClientMessage encodeRequest(String name, int completionId) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, completionId);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, int completionId) {
            int dataSize = ClientMessage.HEADER_SIZE;
