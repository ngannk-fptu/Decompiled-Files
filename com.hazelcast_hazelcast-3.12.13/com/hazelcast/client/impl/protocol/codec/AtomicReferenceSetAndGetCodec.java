...
public final class AtomicReferenceSetAndGetCodec {
    public static final AtomicReferenceMessageType REQUEST_TYPE = AtomicReferenceMessageType.ATOMICREFERENCE_SETANDGET;
    ...
    public static ClientMessage encodeRequest(String name, Data newValue) {
        ...
        clientMessage.setOperationName("AtomicReference.setAndGet");
