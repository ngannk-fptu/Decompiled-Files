...
public final class CPAtomicRefGetCodec {
    public static final CPAtomicRefMessageType REQUEST_TYPE = CPAtomicRefMessageType.CPATOMICREF_GET;
    ...
    public static ClientMessage encodeRequest(RaftGroupId groupId, String name) {
        ...
        clientMessage.setOperationName("CPAtomicRef.get");
