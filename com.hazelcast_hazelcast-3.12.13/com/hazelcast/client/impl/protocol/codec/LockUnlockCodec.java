...
public final class LockUnlockCodec {
    public static final LockMessageType REQUEST_TYPE = LockMessageType.LOCK_UNLOCK;
    ...
    public static ClientMessage encodeRequest(String name, long threadId) {
        ...
        clientMessage.setOperationName("Lock.unlock");
    ...
    public static ClientMessage encodeRequest(String name, long threadId, long referenceId) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, threadId, referenceId);
        ClientMessage clientMessage = ClientMessage.createForEncode(requiredDataSize);
        clientMessage.setMessageType(REQUEST_TYPE.id());
        clientMessage.setRetryable(true);
        clientMessage.setAcquiresResource(false);
