...
public final class MapSetTtlCodec {
    public static final MapMessageType REQUEST_TYPE = MapMessageType.MAP_SETTTL;
    public static final int RESPONSE_TYPE = 101;

    public static ClientMessage encodeRequest(String name, Data key, long ttl) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, key, ttl);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data key, long ttl) {
            int dataSize = ClientMessage.HEADER_SIZE;
