...
public final class ReplicatedMapRemoveEntryListenerCodec {
    public static final ReplicatedMapMessageType REQUEST_TYPE = ReplicatedMapMessageType.REPLICATEDMAP_REMOVEENTRYLISTENER;
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        parameters.registrationId = registrationId = clientMessage.getStringUtf8();
        return parameters;
    }
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, String registrationId) {
            ...
            return dataSize += ParameterUtil.calculateDataSize(registrationId);
        }
    }
}
