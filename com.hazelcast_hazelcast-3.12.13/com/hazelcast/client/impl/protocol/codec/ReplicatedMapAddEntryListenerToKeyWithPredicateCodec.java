...
public final class ReplicatedMapAddEntryListenerToKeyWithPredicateCodec {
    ...
    public static ClientMessage encodeRequest(String name, Data key, Data predicate, boolean localOnly) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, key, predicate, localOnly);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data key, Data predicate, boolean localOnly) {
            int dataSize = ClientMessage.HEADER_SIZE;
