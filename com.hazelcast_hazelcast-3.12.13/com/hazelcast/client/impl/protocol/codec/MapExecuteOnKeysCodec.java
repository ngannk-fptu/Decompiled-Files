...
public final class MapExecuteOnKeysCodec {
    ...
    public static ClientMessage encodeRequest(String name, Data entryProcessor, Collection<Data> keys) {
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data entryProcessor, Collection<Data> keys) {
            int dataSize = ClientMessage.HEADER_SIZE;
