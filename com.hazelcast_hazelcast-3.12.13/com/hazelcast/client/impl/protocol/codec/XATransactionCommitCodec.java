...
public final class XATransactionCommitCodec {
    public static final XATransactionMessageType REQUEST_TYPE = XATransactionMessageType.XATRANSACTION_COMMIT;
    public static final int RESPONSE_TYPE = 100;

    public static ClientMessage encodeRequest(String transactionId, boolean onePhase) {
        int requiredDataSize = RequestParameters.calculateDataSize(transactionId, onePhase);
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        parameters.onePhase = onePhase = clientMessage.getBoolean();
        return parameters;
    }
