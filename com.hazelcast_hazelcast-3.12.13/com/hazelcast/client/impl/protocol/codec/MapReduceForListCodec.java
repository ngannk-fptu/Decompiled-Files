...
public final class MapReduceForListCodec {
    ...
    public static ClientMessage encodeRequest(String name, String jobId, Data predicate, Data mapper, Data combinerFactory, Data reducerFactory, String listName, int chunkSize, Collection<Data> keys, String topologyChangedStrategy) {
        boolean reducerFactory_isNull;
        boolean combinerFactory_isNull;
        boolean predicate_isNull;
        int requiredDataSize = RequestParameters.calculateDataSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, listName, chunkSize, keys, topologyChangedStrategy);
        ClientMessage clientMessage = ClientMessage.createForEncode(requiredDataSize);
        clientMessage.setMessageType(REQUEST_TYPE.id());
        clientMessage.setRetryable(false);
        clientMessage.setAcquiresResource(false);
        clientMessage.setOperationName("MapReduce.forList");
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        parameters.listName = listName = clientMessage.getStringUtf8();
        int chunkSize = 0;
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, String jobId, Data predicate, Data mapper, Data combinerFactory, Data reducerFactory, String listName, int chunkSize, Collection<Data> keys, String topologyChangedStrategy) {
            int dataSize = ClientMessage.HEADER_SIZE;
            ...
            dataSize += ParameterUtil.calculateDataSize(listName);
            dataSize += 4;
            ++dataSize;
            if (keys != null) {
                dataSize += 4;
