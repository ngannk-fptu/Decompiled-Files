...
public final class SemaphoreDrainPermitsCodec {
    public static final SemaphoreMessageType REQUEST_TYPE = SemaphoreMessageType.SEMAPHORE_DRAINPERMITS;
    ...
    public static ClientMessage encodeRequest(String name) {
        ...
        clientMessage.setOperationName("Semaphore.drainPermits");
