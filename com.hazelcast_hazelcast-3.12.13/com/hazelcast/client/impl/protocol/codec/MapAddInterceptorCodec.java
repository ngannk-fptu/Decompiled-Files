...
public final class MapAddInterceptorCodec {
    public static final MapMessageType REQUEST_TYPE = MapMessageType.MAP_ADDINTERCEPTOR;
    public static final int RESPONSE_TYPE = 104;

    public static ClientMessage encodeRequest(String name, Data interceptor) {
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        Data interceptor = null;
        parameters.interceptor = interceptor = clientMessage.getData();
        return parameters;
    }
    ...
    public static class RequestParameters {
        ...
        public String name;
        public Data interceptor;

        public static int calculateDataSize(String name, Data interceptor) {
            int dataSize = ClientMessage.HEADER_SIZE;
            dataSize += ParameterUtil.calculateDataSize(name);
            return dataSize += ParameterUtil.calculateDataSize(interceptor);
        }
    }
}
