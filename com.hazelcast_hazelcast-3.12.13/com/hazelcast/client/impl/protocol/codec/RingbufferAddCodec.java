...
public final class RingbufferAddCodec {
    public static final RingbufferMessageType REQUEST_TYPE = RingbufferMessageType.RINGBUFFER_ADD;
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, int overflowPolicy, Data value) {
            int dataSize = ClientMessage.HEADER_SIZE;
