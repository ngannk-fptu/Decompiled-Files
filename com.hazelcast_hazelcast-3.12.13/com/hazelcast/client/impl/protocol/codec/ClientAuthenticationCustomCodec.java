...
public final class ClientAuthenticationCustomCodec {
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(Data credentials, String uuid, String ownerUuid, boolean isOwnerConnection, String clientType, byte serializationVersion, String clientHazelcastVersion) {
            int dataSize = ClientMessage.HEADER_SIZE;
            dataSize += ParameterUtil.calculateDataSize(credentials);
            ++dataSize;
            if (uuid != null) {
        ...
        public static int calculateDataSize(Data credentials, String uuid, String ownerUuid, boolean isOwnerConnection, String clientType, byte serializationVersion, String clientHazelcastVersion, String clientName, Collection<String> labels, Integer partitionCount, String clusterId) {
            int dataSize = ClientMessage.HEADER_SIZE;
            dataSize += ParameterUtil.calculateDataSize(credentials);
            ++dataSize;
            if (uuid != null) {
