...
public final class MapAddEntryListenerToKeyWithPredicateCodec {
    public static final MapMessageType REQUEST_TYPE = MapMessageType.MAP_ADDENTRYLISTENERTOKEYWITHPREDICATE;
    public static final int RESPONSE_TYPE = 104;

    public static ClientMessage encodeRequest(String name, Data key, Data predicate, boolean includeValue, int listenerFlags, boolean localOnly) {
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data key, Data predicate, boolean includeValue, int listenerFlags, boolean localOnly) {
            int dataSize = ClientMessage.HEADER_SIZE;
