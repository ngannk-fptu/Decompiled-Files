...
public final class CPAtomicRefContainsCodec {
    public static final CPAtomicRefMessageType REQUEST_TYPE = CPAtomicRefMessageType.CPATOMICREF_CONTAINS;
    public static final int RESPONSE_TYPE = 101;

    public static ClientMessage encodeRequest(RaftGroupId groupId, String name, Data value) {
        int requiredDataSize = RequestParameters.calculateDataSize(groupId, name, value);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(RaftGroupId groupId, String name, Data value) {
            int dataSize = ClientMessage.HEADER_SIZE;
