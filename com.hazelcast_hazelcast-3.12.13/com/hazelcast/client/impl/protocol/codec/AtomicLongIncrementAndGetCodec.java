...
public final class AtomicLongIncrementAndGetCodec {
    public static final AtomicLongMessageType REQUEST_TYPE = AtomicLongMessageType.ATOMICLONG_INCREMENTANDGET;
    ...
    public static ClientMessage encodeRequest(String name) {
        ...
        clientMessage.setOperationName("AtomicLong.incrementAndGet");
