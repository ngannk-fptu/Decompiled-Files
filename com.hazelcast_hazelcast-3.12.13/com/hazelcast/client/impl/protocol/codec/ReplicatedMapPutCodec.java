...
public final class ReplicatedMapPutCodec {
    public static final ReplicatedMapMessageType REQUEST_TYPE = ReplicatedMapMessageType.REPLICATEDMAP_PUT;
    public static final int RESPONSE_TYPE = 105;

    public static ClientMessage encodeRequest(String name, Data key, Data value, long ttl) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, key, value, ttl);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data key, Data value, long ttl) {
            int dataSize = ClientMessage.HEADER_SIZE;
