...
public final class MapAggregateCodec {
    public static final MapMessageType REQUEST_TYPE = MapMessageType.MAP_AGGREGATE;
    public static final int RESPONSE_TYPE = 105;

    public static ClientMessage encodeRequest(String name, Data aggregator) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, aggregator);
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        parameters.aggregator = aggregator = clientMessage.getData();
        return parameters;
    }
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data aggregator) {
            int dataSize = ClientMessage.HEADER_SIZE;
            dataSize += ParameterUtil.calculateDataSize(name);
            return dataSize += ParameterUtil.calculateDataSize(aggregator);
        }
    }
}
