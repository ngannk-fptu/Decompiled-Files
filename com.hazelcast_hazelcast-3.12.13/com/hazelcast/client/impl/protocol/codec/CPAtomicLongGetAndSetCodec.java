...
public final class CPAtomicLongGetAndSetCodec {
    ...
    public static ClientMessage encodeRequest(RaftGroupId groupId, String name, long newValue) {
        int requiredDataSize = RequestParameters.calculateDataSize(groupId, name, newValue);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(RaftGroupId groupId, String name, long newValue) {
            int dataSize = ClientMessage.HEADER_SIZE;
