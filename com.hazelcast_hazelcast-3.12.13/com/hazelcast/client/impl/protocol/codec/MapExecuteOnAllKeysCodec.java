...
public final class MapExecuteOnAllKeysCodec {
    public static final MapMessageType REQUEST_TYPE = MapMessageType.MAP_EXECUTEONALLKEYS;
    public static final int RESPONSE_TYPE = 117;

    public static ClientMessage encodeRequest(String name, Data entryProcessor) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, entryProcessor);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data entryProcessor) {
            int dataSize = ClientMessage.HEADER_SIZE;
            dataSize += ParameterUtil.calculateDataSize(name);
            return dataSize += ParameterUtil.calculateDataSize(entryProcessor);
        }
    }
}
