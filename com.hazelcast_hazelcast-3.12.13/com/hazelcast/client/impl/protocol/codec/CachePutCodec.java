...
public final class CachePutCodec {
    ...
    public static ClientMessage encodeRequest(String name, Data key, Data value, Data expiryPolicy, boolean get, int completionId) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, key, value, expiryPolicy, get, completionId);
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        boolean get = false;
        parameters.get = get = clientMessage.getBoolean();
        int completionId = 0;
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data key, Data value, Data expiryPolicy, boolean get, int completionId) {
            int dataSize = ClientMessage.HEADER_SIZE;
