...
public final class MultiMapAddEntryListenerToKeyCodec {
    public static final MultiMapMessageType REQUEST_TYPE = MultiMapMessageType.MULTIMAP_ADDENTRYLISTENERTOKEY;
    public static final int RESPONSE_TYPE = 104;

    public static ClientMessage encodeRequest(String name, Data key, boolean includeValue, boolean localOnly) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, key, includeValue, localOnly);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data key, boolean includeValue, boolean localOnly) {
            int dataSize = ClientMessage.HEADER_SIZE;
