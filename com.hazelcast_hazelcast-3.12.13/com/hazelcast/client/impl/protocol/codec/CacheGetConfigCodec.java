...
public final class CacheGetConfigCodec {
    public static final CacheMessageType REQUEST_TYPE = CacheMessageType.CACHE_GETCONFIG;
    public static final int RESPONSE_TYPE = 105;

    public static ClientMessage encodeRequest(String name, String simpleName) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, simpleName);
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        parameters.simpleName = simpleName = clientMessage.getStringUtf8();
        return parameters;
    }
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, String simpleName) {
            int dataSize = ClientMessage.HEADER_SIZE;
            dataSize += ParameterUtil.calculateDataSize(name);
            return dataSize += ParameterUtil.calculateDataSize(simpleName);
        }
    }
}
