...
public final class TransactionalMapContainsValueCodec {
    public static final TransactionalMapMessageType REQUEST_TYPE = TransactionalMapMessageType.TRANSACTIONALMAP_CONTAINSVALUE;
    public static final int RESPONSE_TYPE = 101;

    public static ClientMessage encodeRequest(String name, String txnId, long threadId, Data value) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, txnId, threadId, value);
        ClientMessage clientMessage = ClientMessage.createForEncode(requiredDataSize);
        clientMessage.setMessageType(REQUEST_TYPE.id());
        clientMessage.setRetryable(false);
        clientMessage.setAcquiresResource(false);
        clientMessage.setOperationName("TransactionalMap.containsValue");
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, String txnId, long threadId, Data value) {
            int dataSize = ClientMessage.HEADER_SIZE;
