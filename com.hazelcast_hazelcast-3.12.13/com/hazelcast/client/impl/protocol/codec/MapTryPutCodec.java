...
public final class MapTryPutCodec {
    public static final MapMessageType REQUEST_TYPE = MapMessageType.MAP_TRYPUT;
    public static final int RESPONSE_TYPE = 101;

    public static ClientMessage encodeRequest(String name, Data key, Data value, long threadId, long timeout) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, key, value, threadId, timeout);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, Data key, Data value, long threadId, long timeout) {
            int dataSize = ClientMessage.HEADER_SIZE;
