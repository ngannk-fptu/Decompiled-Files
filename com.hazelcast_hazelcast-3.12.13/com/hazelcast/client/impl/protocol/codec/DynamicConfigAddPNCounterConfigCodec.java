...
public final class DynamicConfigAddPNCounterConfigCodec {
    public static final DynamicConfigMessageType REQUEST_TYPE = DynamicConfigMessageType.DYNAMICCONFIG_ADDPNCOUNTERCONFIG;
    public static final int RESPONSE_TYPE = 100;

    public static ClientMessage encodeRequest(String name, int replicaCount, boolean statisticsEnabled, String quorumName) {
        int requiredDataSize = RequestParameters.calculateDataSize(name, replicaCount, statisticsEnabled, quorumName);
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, int replicaCount, boolean statisticsEnabled, String quorumName) {
            int dataSize = ClientMessage.HEADER_SIZE;
