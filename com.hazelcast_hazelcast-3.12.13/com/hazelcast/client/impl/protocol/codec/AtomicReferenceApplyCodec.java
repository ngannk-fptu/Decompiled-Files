...
public final class AtomicReferenceApplyCodec {
    public static final AtomicReferenceMessageType REQUEST_TYPE = AtomicReferenceMessageType.ATOMICREFERENCE_APPLY;
    ...
    public static ClientMessage encodeRequest(String name, Data function) {
        ...
        clientMessage.setOperationName("AtomicReference.apply");
