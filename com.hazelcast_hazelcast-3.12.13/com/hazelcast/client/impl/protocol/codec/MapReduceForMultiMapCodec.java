...
public final class MapReduceForMultiMapCodec {
    public static final MapReduceMessageType REQUEST_TYPE = MapReduceMessageType.MAPREDUCE_FORMULTIMAP;
    public static final int RESPONSE_TYPE = 117;

    public static ClientMessage encodeRequest(String name, String jobId, Data predicate, Data mapper, Data combinerFactory, Data reducerFactory, String multiMapName, int chunkSize, Collection<Data> keys, String topologyChangedStrategy) {
        boolean reducerFactory_isNull;
        boolean combinerFactory_isNull;
        boolean predicate_isNull;
        int requiredDataSize = RequestParameters.calculateDataSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, multiMapName, chunkSize, keys, topologyChangedStrategy);
        ClientMessage clientMessage = ClientMessage.createForEncode(requiredDataSize);
        clientMessage.setMessageType(REQUEST_TYPE.id());
        clientMessage.setRetryable(false);
        clientMessage.setAcquiresResource(false);
        clientMessage.setOperationName("MapReduce.forMultiMap");
        ...
        clientMessage.set(multiMapName);
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        String multiMapName = null;
        parameters.multiMapName = multiMapName = clientMessage.getStringUtf8();
        int chunkSize = 0;
    ...
    public static class RequestParameters {
        ...
        public static int calculateDataSize(String name, String jobId, Data predicate, Data mapper, Data combinerFactory, Data reducerFactory, String multiMapName, int chunkSize, Collection<Data> keys, String topologyChangedStrategy) {
            int dataSize = ClientMessage.HEADER_SIZE;
            ...
            dataSize += ParameterUtil.calculateDataSize(multiMapName);
            dataSize += 4;
            ++dataSize;
            if (keys != null) {
                dataSize += 4;
