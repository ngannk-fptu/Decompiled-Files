...
implements Map<Integer, V> {
    ...
    public String toString() {
        ...
        sb.append('{');
        for (Map.Entry<Integer, V> entry : this.entrySet()) {
    ...
    implements Iterator<T> {
        ...
        protected AbstractIterator() {
            ...
            int i = Int2ObjectHashMap.this.capacity;
            if (null != this.values[Int2ObjectHashMap.this.capacity - 1]) {
                int size = Int2ObjectHashMap.this.capacity;
                for (i = 0; i < size && null != this.values[i]; ++i) {
                }
            }
            this.stopCounter = i;
            this.posCounter = i + Int2ObjectHashMap.this.capacity;
        }

        protected int getPosition() {
            return this.posCounter & Int2ObjectHashMap.this.mask;
        }

        @Override
        public boolean hasNext() {
            for (int i = this.posCounter - 1; i >= this.stopCounter; --i) {
                int index = i & Int2ObjectHashMap.this.mask;
