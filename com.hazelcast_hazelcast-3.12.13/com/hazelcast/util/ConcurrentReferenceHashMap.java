...
Serializable {
    ...
    public ConcurrentReferenceHashMap(ReferenceType keyType, ReferenceType valueType) {
        this(16, 0.75f, 16, keyType, valueType, null);
    }
    ...
    public V applyIfPresent(K key, IBiFunction<? super K, ? super V, ? extends V> remappingFunction) {
        ...
        return this.segmentFor(hash).applyIfPresent((K)key, hash, (IBiFunction<? super K, ? extends V, ? extends V>)remappingFunction);
    }
    ...
    implements Serializable {
        ...
        @SuppressFBWarnings(value={"SE_TRANSIENT_FIELD_NOT_RESTORED"}, justification="I trust Doug Lea's technical decision")
