...
public class GetRoundMessageTask
extends AbstractCPMessageTask<CPCountDownLatchGetRoundCodec.RequestParameters> {
    ...
    protected void processMessage() {
        this.query(((CPCountDownLatchGetRoundCodec.RequestParameters)this.parameters).groupId, new GetRoundOp(((CPCountDownLatchGetRoundCodec.RequestParameters)this.parameters).name), QueryPolicy.LINEARIZABLE);
    }
