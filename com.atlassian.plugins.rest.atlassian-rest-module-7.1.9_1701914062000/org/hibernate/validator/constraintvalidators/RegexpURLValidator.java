...
public class RegexpURLValidator
implements ConstraintValidator<URL, CharSequence> {
    ...
    public boolean isValid(CharSequence value, ConstraintValidatorContext constraintValidatorContext) {
        ...
        ValueHolder values = this.parseUrl(value.toString());
        if (values == null) {
            return false;
        }
        ...
        if (this.protocol != null && this.protocol.length() > 0 && !this.protocol.equals(values.getProtocol())) {
            return false;
        }
        if (this.host != null && this.host.length() > 0 && !this.host.equals(values.getHost())) {
            return false;
        }
        return this.port == -1 || values.getPort() == this.port;
    }
