...
extends ClientFilter {
    ...
    public LoggingFilter(Logger logger2, int maxEntitySize) {
        this(logger2, null, maxEntitySize);
    }
    ...
    private LoggingFilter(Logger logger2, PrintStream loggingStream) {
        this(logger2, loggingStream, 10240);
    }

    private LoggingFilter(Logger logger2, PrintStream loggingStream, int maxEntitySize) {
