...
AsyncUniformInterface {
    ...
    implements AsyncUniformInterface {
        ...
        private ClientRequest build(String method) {
            ClientRequestImpl ro = new ClientRequestImpl(AsyncWebResource.this.u, method, this.entity, this.metadata);
            this.entity = null;
            this.metadata = null;
            return ro;
        }
        ...
        private ClientRequest build(String method, Object e) {
            ClientRequestImpl ro = new ClientRequestImpl(AsyncWebResource.this.u, method, e, this.metadata);
            this.entity = null;
            this.metadata = null;
            return ro;
        }
