...
public abstract class BeanCopier {
    private static final BeanCopierKey KEY_FACTORY = (BeanCopierKey)((Object)KeyFactory.create(class$net$sf$cglib$beans$BeanCopier$BeanCopierKey == null ? (class$net$sf$cglib$beans$BeanCopier$BeanCopierKey = BeanCopier.class$("net.sf.cglib.beans.BeanCopier$BeanCopierKey")) : class$net$sf$cglib$beans$BeanCopier$BeanCopierKey));
    ...
    extends AbstractClassGenerator {
        private static final AbstractClassGenerator.Source SOURCE = new AbstractClassGenerator.Source((class$net$sf$cglib$beans$BeanCopier == null ? (class$net$sf$cglib$beans$BeanCopier = BeanCopier.class$("net.sf.cglib.beans.BeanCopier")) : class$net$sf$cglib$beans$BeanCopier).getName());
