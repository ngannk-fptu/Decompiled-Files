...
public class EmitUtils {
    ...
    private static Class remapComponentType(Class componentType) {
        if (componentType.equals(class$org$objectweb$asm$Type == null ? (class$org$objectweb$asm$Type = EmitUtils.class$("org.objectweb.asm.Type")) : class$org$objectweb$asm$Type)) {
