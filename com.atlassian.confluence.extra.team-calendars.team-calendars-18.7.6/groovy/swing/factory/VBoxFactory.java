...
extends ComponentFactory {
    ...
    public VBoxFactory() {
        MetaClass metaClass;
        CallSite[] callSiteArray = VBoxFactory.$getCallSiteArray();
        super(null);
    ...
    protected /* synthetic */ MetaClass $getStaticMetaClass() {
        if (this.getClass() != VBoxFactory.class) {
    ...
    private static /* synthetic */ void $createCallSiteArray_1(String[] stringArray) {
        ...
        stringArray[1] = "createVerticalBox";
    }

    private static /* synthetic */ CallSiteArray $createCallSiteArray() {
        String[] stringArray = new String[2];
        VBoxFactory.$createCallSiteArray_1(stringArray);
        return new CallSiteArray(VBoxFactory.class, stringArray);
    }

    private static /* synthetic */ CallSite[] $getCallSiteArray() {
        CallSiteArray callSiteArray;
        if ($callSiteArray == null || (callSiteArray = (CallSiteArray)$callSiteArray.get()) == null) {
            callSiteArray = VBoxFactory.$createCallSiteArray();
