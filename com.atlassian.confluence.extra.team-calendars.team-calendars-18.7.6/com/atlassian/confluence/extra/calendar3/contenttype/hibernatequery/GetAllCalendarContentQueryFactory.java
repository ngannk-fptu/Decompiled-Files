...
public class GetAllCalendarContentQueryFactory
implements HibernateContentQueryFactory {
    public Query getQuery(EntityManager entityManager, Object ... parameters) throws PersistenceException {
        Query query = entityManager.createQuery("from CustomContentEntityObject content where content.originalVersion is null and content.pluginModuleKey = :pluginModuleKey");
