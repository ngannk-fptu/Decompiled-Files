...
public class SubCalendarUpdated
extends BaseSubCalendarEvent<PersistedSubCalendar> {
    public SubCalendarUpdated(Object eventSource, ConfluenceUser trigger, PersistedSubCalendar subCalendar) {
        super(eventSource, trigger, subCalendar);
    }

    @EventName
    public String calculateEventName() {
        return "teamcalendars.subcalendar.update." + ((PersistedSubCalendar)this.getSubCalendar()).getType();
    }
}
