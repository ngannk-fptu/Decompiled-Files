...
@EventName(value="teamcalendars.reminder.action.on")
public class RemindingOnByAction
extends BaseSubCalendarEvent<PersistedSubCalendar> {
    private String userKey;

    public RemindingOnByAction(Object eventSource, ConfluenceUser trigger, PersistedSubCalendar subCalendar) {
