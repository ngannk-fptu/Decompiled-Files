...
@EventName(value="teamcalendars.reminder.action.off")
public class RemindingOffByAction
extends BaseSubCalendarEvent<PersistedSubCalendar> {
    private String userKey;

    public RemindingOffByAction(Object eventSource, ConfluenceUser trigger, PersistedSubCalendar subCalendar) {
