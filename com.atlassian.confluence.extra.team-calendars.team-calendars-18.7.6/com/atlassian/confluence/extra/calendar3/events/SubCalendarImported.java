...
public class SubCalendarImported
extends CalendarEvent {
    private final boolean isOnSpace;

    public SubCalendarImported(Object eventSource, ConfluenceUser trigger, boolean isOnSpace) {
    ...
    public String calculateEventName() {
        return this.isOnSpace ? "teamcalendars.subcalendar.created.by.import.spaceCalendars" : "teamcalendars.subcalendar.created.by.import.myCalendars";
    }
}
