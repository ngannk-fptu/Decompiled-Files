...
@EventName(value="teamcalendars.reminder.email.on")
public class RemindingOnByEmail
extends BaseSubCalendarEvent<PersistedSubCalendar> {
    private String userKey;

    public RemindingOnByEmail(Object eventSource, ConfluenceUser trigger, PersistedSubCalendar subCalendar) {
