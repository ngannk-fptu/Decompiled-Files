...
@Component
public class WhatFieldValidator
extends AbstractEventValidator {
    @Autowired
    public WhatFieldValidator(@ComponentImport LocaleManager localeManager, @ComponentImport I18NBeanFactory i18NBeanFactory) {
    ...
    public boolean isValid(UpdateEventParam param, Map<String, List<String>> fieldErrors) throws WebApplicationException {
        ...
        if (StringUtils.isBlank(what)) {
            this.addFieldError(fieldErrors, "what", this.getText("calendar3.error.blank"));
        }
        return true;
    }
}
