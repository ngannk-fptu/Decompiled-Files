...
public class RemoveDuplicatedExcludeDateUpgradeTask
implements ActiveObjectsUpgradeTask {
    private static final Logger LOGGER = LoggerFactory.getLogger(RemoveDuplicatedExcludeDateUpgradeTask.class);

    public ModelVersion getModelVersion() {
        return ModelVersion.valueOf((String)CalendarModelVersion.CALENDAR_MODEL_VERSION_18);
    }
    ...
    public void upgrade(ModelVersion modelVersion, ActiveObjects activeObjects) {
        ...
        LOGGER.info("====================Finish Upgrade Task RemoveDuplicatedExcludeDateUpgradeTask==============================");
    }
}
