...
StringDecoder {
    ...
    public static final byte[] encodeQuotedPrintable(BitSet printable, byte[] bytes, boolean strict) {
        ...
        if (strict) {
            ...
            int b = QuotedPrintableCodec.getUnsignedOctet(bytesLength - 3, bytes);
            ...
            int n = bytesLength - 2;
            while (var8_12 < bytesLength) {
                b = QuotedPrintableCodec.getUnsignedOctet((int)var8_12, bytes);
                encode = !printable.get(b) || var8_12 > bytesLength - 2 && QuotedPrintableCodec.isWhitespace(b);
