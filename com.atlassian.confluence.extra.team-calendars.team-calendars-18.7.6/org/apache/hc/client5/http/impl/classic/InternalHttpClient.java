...
implements Configurable {
    ...
    protected CloseableHttpResponse doExecute(HttpHost target, ClassicHttpRequest request, HttpContext context) throws IOException {
        ...
        try {
            ...
            HttpRoute route = this.determineRoute(target != null ? target : RoutingSupport.determineHost(request), localcontext);
            ...
            ClassicHttpResponse response = this.execChain.execute(ClassicRequestBuilder.copy(request).build(), scope);
