...
extends ModalCloseable {
    ...
    default public void upgrade(AsyncConnectionEndpoint endpoint, Object attachment, HttpContext context, FutureCallback<AsyncConnectionEndpoint> callback) {
        this.upgrade(endpoint, attachment, context);
        if (callback != null) {
