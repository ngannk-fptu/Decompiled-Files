...
public class DoubleArrayPutAtMetaMethod
extends ArrayPutAtMetaMethod {
    ...
    public Object invoke(Object object, Object[] args) {
        ...
        int index = DoubleArrayPutAtMetaMethod.normaliseIndex((Integer)args[0], objects.length);
    ...
    extends PojoMetaMethodSite {
        ...
        public Object call(Object receiver, Object[] args) throws Throwable {
            if (receiver instanceof double[] && args[0] instanceof Integer && args[1] instanceof Double && this.checkPojoMetaClass()) {
                double[] objects = (double[])receiver;
                objects[ArrayMetaMethod.normaliseIndex((int)((Integer)args[0]).intValue(), (int)objects.length)] = (Double)args[1];
                return null;
            }
        ...
        public Object call(Object receiver, Object arg1, Object arg2) throws Throwable {
            block3: {
                if (this.checkPojoMetaClass()) {
                    try {
                        double[] objects = (double[])receiver;
                        objects[ArrayMetaMethod.normaliseIndex((int)((Integer)arg1).intValue(), (int)objects.length)] = (Double)arg2;
                        return null;
                    }
                    catch (ClassCastException e) {
                        if (!(receiver instanceof double[]) || !(arg1 instanceof Integer)) break block3;
                        throw e;
                    }
                }
            }
