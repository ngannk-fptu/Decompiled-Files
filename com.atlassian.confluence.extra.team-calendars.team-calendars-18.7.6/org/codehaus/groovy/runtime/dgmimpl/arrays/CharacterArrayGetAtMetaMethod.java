...
public class CharacterArrayGetAtMetaMethod
extends ArrayGetAtMetaMethod {
    ...
    public Object invoke(Object object, Object[] args) {
        ...
        return Character.valueOf(objects[CharacterArrayGetAtMetaMethod.normaliseIndex((Integer)args[0], objects.length)]);
    }
    ...
    extends PojoMetaMethodSite {
        ...
        public Object call(Object receiver, Object arg) throws Throwable {
            if (receiver instanceof char[] && arg instanceof Integer && this.checkPojoMetaClass()) {
                ...
                return Character.valueOf(objects[ArrayMetaMethod.normaliseIndex((Integer)arg, objects.length)]);
            }
