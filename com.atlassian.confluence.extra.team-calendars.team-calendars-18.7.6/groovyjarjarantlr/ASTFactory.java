...
public class ASTFactory {
    ...
    public Class getASTNodeType(int n) {
        ...
        return class$antlr$CommonAST == null ? (class$antlr$CommonAST = ASTFactory.class$("groovyjarjarantlr.CommonAST")) : class$antlr$CommonAST;
    }
    ...
    protected AST createUsingCtor(Token token, String string) {
        ...
        try {
            clazz = Utils.loadClass(string);
            Class[] classArray = new Class[]{class$antlr$Token == null ? (class$antlr$Token = ASTFactory.class$("groovyjarjarantlr.Token")) : class$antlr$Token};
            try {
