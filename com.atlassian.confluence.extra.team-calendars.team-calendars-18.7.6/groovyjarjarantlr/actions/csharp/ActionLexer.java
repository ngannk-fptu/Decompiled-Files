...
import groovyjarjarantlr.actions.csharp.ActionLexerTokenTypes;
...
TokenStream {
    ...
    protected final void mAST_ITEM(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (this.LA(1) == '#' && this.LA(2) == '(') {
            ...
            } else if (string.equals("define") || string.equals("undef") || string.equals("if") || string.equals("elif") || string.equals("else") || string.equals("endif") || string.equals("line") || string.equals("error") || string.equals("warning") || string.equals("region") || string.equals("endregion")) {
                this.text.setLength(n);
    ...
    protected final void mTEXT_ITEM(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (this.LA(1) == '$' && this.LA(2) == 'F' && this.LA(3) == 'O') {
            ...
            token2 = this._returnToken;
            this.match(')');
            String string = "text.Append(" + token2.getText() + ")";
            this.text.setLength(n);
            this.text.append(string);
            ...
            if (this.LA(1) == 'T' && this.LA(2) == 'e') {
                ...
                token3 = this._returnToken;
                this.match(')');
                String string = "text.Length = _begin; text.Append(" + token3.getText() + ")";
                this.text.setLength(n);
                this.text.append(string);
    ...
    protected final void mAST_CONSTRUCTOR(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        this.match(']');
        this.text.setLength(n);
        String string = this.generator.processStringForASTConstructor(token3.getText());
        if (token2 != null) {
    ...
    private static final long[] mk_tokenSet_3() {
        long[] lArray = new long[]{4294977024L, 576460745995190270L, 0L, 0L, 0L};
        return lArray;
    }
    ...
    private static final long[] mk_tokenSet_22() {
        long[] lArray = new long[]{288084781055354368L, 576460746666278910L, 0L, 0L, 0L};
        return lArray;
    }
