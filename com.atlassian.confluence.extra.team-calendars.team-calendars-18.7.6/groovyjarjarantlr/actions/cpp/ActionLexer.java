...
import groovyjarjarantlr.actions.cpp.ActionLexerTokenTypes;
...
TokenStream {
    ...
    public static final BitSet _tokenSet_26 = new BitSet(ActionLexer.mk_tokenSet_26());
    ...
    protected final void mAST_ITEM(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (this.LA(1) == '#' && this.LA(2) == '(') {
            ...
            String string2 = this.generator.mapTreeId(token3.getText(), this.transInfo);
            if (string2 != null && !string.equals(string2)) {
                this.text.setLength(n);
                this.text.append(string2);
            } else if (string.equals("if") || string.equals("define") || string.equals("ifdef") || string.equals("ifndef") || string.equals("else") || string.equals("elif") || string.equals("endif") || string.equals("warning") || string.equals("error") || string.equals("ident") || string.equals("pragma") || string.equals("include")) {
                this.text.setLength(n);
    ...
    protected final void mTEXT_ITEM(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (this.LA(1) == '$' && this.LA(2) == 'F' && this.LA(3) == 'O') {
            ...
            token2 = this._returnToken;
            this.match(')');
            String string = "text += " + token2.getText();
            this.text.setLength(n);
            this.text.append(string);
            ...
            if (this.LA(1) == 'T' && this.LA(2) == 'e') {
                ...
                token3 = this._returnToken;
                this.match(')');
                String string = "{ text.erase(_begin); text += " + token3.getText() + "; }";
                this.text.setLength(n);
                this.text.append(string);
            ...
            if (this.LA(1) != '$' || this.LA(2) != 'g') throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
            this.match("$getText");
            this.text.setLength(n);
    ...
    protected final void mTREE(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        this.text.setLength(n3);
        token2 = this._returnToken;
        vector.appendElement(this.generator.processStringForASTConstructor(token2.getText()));
        switch (this.LA(1)) {
            case '\t': 
            case '\n': 
            case '\r': 
        ...
        block16: while (this.LA(1) == ',') {
            ...
            this.text.setLength(n3);
            token3 = this._returnToken;
            vector.appendElement(this.generator.processStringForASTConstructor(token3.getText()));
            switch (this.LA(1)) {
                case '\t': 
                case '\n': 
                case '\r': 
    ...
    protected final void mID(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        block13: while (_tokenSet_9.member(this.LA(1))) {
            switch (this.LA(1)) {
                case 'a': 
                case 'b': 
                case 'c': 
    ...
    protected final void mAST_CONSTRUCTOR(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        this.match(']');
        this.text.setLength(n3);
        String string = this.generator.processStringForASTConstructor(token2.getText());
        if (token3 != null) {
            string = string + "," + token3.getText();
        }
        this.text.setLength(n);
    ...
    protected final void mTEXT_ARG(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        int n3 = 0;
        while (true) {
            if (_tokenSet_10.member(this.LA(1)) && this.LA(2) >= '\u0003' && this.LA(2) <= '\u00ff') {
    ...
    protected final void mTREE_ELEMENT(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        switch (this.LA(1)) {
            ...
            default: {
                ...
                if (this.LA(1) == '#' && _tokenSet_12.member(this.LA(2))) {
                    String string;
                    int n5 = this.text.length();
                    this.match('#');
                    this.text.setLength(n5);
                    ...
                    token2 = this._returnToken;
                    if (bl2 || (string = this.generator.mapTreeId(token2.getText(), null)) == null) break;
                    this.text.setLength(n);
                    this.text.append(string);
                    break;
                }
        ...
        block0 : switch (this.LA(1)) {
            ...
            case '<': {
                switch (this.LA(1)) {
                    case '<': {
                        this.match('<');
                        while (_tokenSet_14.member(this.LA(1))) {
                            this.matchNot('>');
                        }
                        this.match('>');
                        break;
                ...
                this.match('(');
                if (_tokenSet_4.member(this.LA(1)) && _tokenSet_15.member(this.LA(2)) && this.LA(3) >= '\u0003' && this.LA(3) <= '\u00ff') {
                    n = this.text.length();
                    this.mWS(false);
                    this.text.setLength(n);
                } else if (!_tokenSet_15.member(this.LA(1)) || this.LA(2) < '\u0003' || this.LA(2) > '\u00ff') {
                    throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
                }
                switch (this.LA(1)) {
                    case '\"': 
            ...
            default: {
                ...
                if (_tokenSet_16.member(this.LA(1))) {
                    ...
                    if (_tokenSet_18.member(this.LA(1))) break;
                    throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
                }
                throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
            }
    ...
    protected final void mAST_CTOR_ELEMENT(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (this.LA(1) == '\"' && this.LA(2) >= '\u0003' && this.LA(2) <= '\u00ff' && this.LA(3) >= '\u0003' && this.LA(3) <= '\u00ff') {
            this.mSTRING(false);
        } else if (_tokenSet_19.member(this.LA(1)) && this.LA(2) >= '\u0003' && this.LA(2) <= '\u00ff') {
    ...
    protected final void mARG(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        switch (this.LA(1)) {
            ...
            default: {
                if (_tokenSet_19.member(this.LA(1)) && this.LA(2) >= '\u0003' && this.LA(2) <= '\u00ff' && this.LA(3) >= '\u0003' && this.LA(3) <= '\u00ff') {
                    this.mTREE_ELEMENT(false);
                    break;
                }
                if (this.LA(1) == '\"' && this.LA(2) >= '\u0003' && this.LA(2) <= '\u00ff' && this.LA(3) >= '\u0003' && this.LA(3) <= '\u00ff') {
        ...
        while (_tokenSet_20.member(this.LA(1)) && _tokenSet_21.member(this.LA(2)) && this.LA(3) >= '\u0003' && this.LA(3) <= '\u00ff') {
            switch (this.LA(1)) {
                case '\t': 
                case '\n': 
                case '\r': 
        ...
        block0 : switch (this.LA(1)) {
            case '(': {
                ...
                if (_tokenSet_4.member(this.LA(1)) && _tokenSet_23.member(this.LA(2)) && this.LA(3) >= '\u0003' && this.LA(3) <= '\u00ff') {
                    ...
                    this.mWS(false);
                    this.text.setLength(n);
                } else if (!_tokenSet_23.member(this.LA(1)) || this.LA(2) < '\u0003' || this.LA(2) > '\u00ff') {
                    throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
                }
                while (_tokenSet_24.member(this.LA(1)) && this.LA(2) >= '\u0003' && this.LA(2) <= '\u00ff' && this.LA(3) >= '\u0003' && this.LA(3) <= '\u00ff') {
            ...
            case '[': {
                ...
                while (true) {
                    if (this.LA(1) == '[') {
                        this.match('[');
                        if (_tokenSet_4.member(this.LA(1)) && _tokenSet_24.member(this.LA(2)) && this.LA(3) >= '\u0003' && this.LA(3) <= '\u00ff') {
                            n = this.text.length();
                            this.mWS(false);
                            this.text.setLength(n);
                        } else if (!_tokenSet_24.member(this.LA(1)) || this.LA(2) < '\u0003' || this.LA(2) > '\u00ff' || this.LA(3) < '\u0003' || this.LA(3) > '\u00ff') {
                            throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
                        }
                        this.mTEXT_ARG(false);
                        switch (this.LA(1)) {
            ...
            default: {
                ...
                if (_tokenSet_11.member(this.LA(1))) break;
                throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
            }
        }
        if (bl && token == null && n3 != -1) {
    ...
    protected final void mINT_OR_FLOAT(boolean bl) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        int n3 = 0;
        while (true) {
            if (this.LA(1) < '0' || this.LA(1) > '9' || !_tokenSet_25.member(this.LA(2))) {
                if (n3 >= 1) break;
                throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
            }
            this.mDIGIT(false);
    ...
    private static final long[] mk_tokenSet_3() {
        long[] lArray = new long[]{288230380446688768L, 576460745995190270L, 0L, 0L, 0L};
        return lArray;
    }
    ...
    private static final long[] mk_tokenSet_6() {
        long[] lArray = new long[]{576189812881499648L, 576460745995190270L, 0L, 0L, 0L};
        return lArray;
    }
    ...
    private static final long[] mk_tokenSet_9() {
        long[] lArray = new long[]{0x7FF000000000000L, 576460745995190270L, 0L, 0L, 0L};
        return lArray;
    }

    private static final long[] mk_tokenSet_10() {
        long[] lArray = new long[]{576188709074894848L, 576460745995190270L, 0L, 0L, 0L};
        return lArray;
    }

    private static final long[] mk_tokenSet_11() {
        long[] lArray = new long[]{576208504579171840L, 576460746532061182L, 0L, 0L, 0L};
        return lArray;
    }

    private static final long[] mk_tokenSet_12() {
        long[] lArray = new long[]{0x400000000000000L, 576460745995190270L, 0L, 0L, 0L};
        return lArray;
    }

    private static final long[] mk_tokenSet_13() {
        long[] lArray = new long[]{3747275269732312576L, 0x28000000L, 0L, 0L, 0L};
        return lArray;
    }

    private static final long[] mk_tokenSet_14() {
        long[] lArray = new long[8];
        lArray[0] = -4611686018427387912L;
        for (int i = 1; i <= 3; ++i) {
            lArray[i] = -1L;
        }
        return lArray;
    ...
    private static final long[] mk_tokenSet_15() {
        long[] lArray = new long[]{576183181451994624L, 576460746129407998L, 0L, 0L, 0L};
        return lArray;
    }
    ...
    private static final long[] mk_tokenSet_19() {
        long[] lArray = new long[]{288231527202947072L, 576460746129407998L, 0L, 0L, 0L};
        return lArray;
    }
    ...
    private static final long[] mk_tokenSet_21() {
        long[] lArray = new long[]{576370098428716544L, 576460746129407998L, 0L, 0L, 0L};
        return lArray;
    }

    private static final long[] mk_tokenSet_22() {
        long[] lArray = new long[]{576315157207066112L, 576460746666278910L, 0L, 0L, 0L};
        return lArray;
    }

    private static final long[] mk_tokenSet_23() {
        long[] lArray = new long[]{576190912393127424L, 576460745995190270L, 0L, 0L, 0L};
        return lArray;
    }

    private static final long[] mk_tokenSet_24() {
        long[] lArray = new long[]{576188713369871872L, 576460745995190270L, 0L, 0L, 0L};
        return lArray;
    }

    private static final long[] mk_tokenSet_25() {
        long[] lArray = new long[]{576459193230304768L, 576460746532061182L, 0L, 0L, 0L};
        return lArray;
    }

    private static final long[] mk_tokenSet_26() {
        long[] lArray = new long[]{576388824486127104L, 576460746532061182L, 0L, 0L, 0L};
        return lArray;
    }
}
