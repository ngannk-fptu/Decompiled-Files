...
import groovyjarjarantlr.build.StreamScarfer;
import java.io.File;
...
public class Tool {
    ...
    public static void main(String[] stringArray) {
        ...
        String string = "groovyjarjarantlr.build.ANTLR";
    ...
    public void perform(String string, String string2) {
        ...
        try {
            ...
            try {
                if (!string.startsWith("groovyjarjarantlr.build.")) {
                    clazz = Utils.loadClass("groovyjarjarantlr.build." + string);
                }
        ...
        try {
            method = clazz.getMethod(string2, class$antlr$build$Tool == null ? (class$antlr$build$Tool = Tool.class$("groovyjarjarantlr.build.Tool")) : class$antlr$build$Tool);
