...
extends Property {
    ...
    implements PropertyFactory<Impp> {
        ...
        @Override
        public Impp createProperty(List<Parameter> params, String value) throws URISyntaxException {
            return new Impp(params, value);
        }

        @Override
        public Impp createProperty(Group group, List<Parameter> params, String value) throws URISyntaxException, ParseException {
            return null;
        }
    }
}
