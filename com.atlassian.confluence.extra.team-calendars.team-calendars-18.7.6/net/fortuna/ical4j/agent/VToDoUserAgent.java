...
public class VToDoUserAgent
extends AbstractUserAgent<VToDo> {
    ...
    public Calendar add(VToDo component) {
        Calendar add = this.wrap(Method.ADD, new VToDo[]{component});
        add.validate();
        return add;
    }
    ...
    public Calendar refresh(VToDo component) {
        Calendar refresh = this.wrap(Method.REFRESH, new VToDo[]{component});
        refresh.validate();
        return refresh;
    }
