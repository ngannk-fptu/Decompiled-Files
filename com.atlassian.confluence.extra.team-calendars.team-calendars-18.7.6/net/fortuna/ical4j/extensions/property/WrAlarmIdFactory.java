...
import net.fortuna.ical4j.extensions.property.WrAlarmId;
...
public class WrAlarmIdFactory
extends AbstractPropertyFactory {
    private static /* synthetic */ ClassInfo $staticClassInfo;
    public static transient /* synthetic */ boolean __$stMC;
    private static /* synthetic */ SoftReference $callSiteArray;

    public WrAlarmIdFactory() {
        CallSite[] callSiteArray = WrAlarmIdFactory.$getCallSiteArray();
    }

    @Override
    public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
        CallSite[] callSiteArray = WrAlarmIdFactory.$getCallSiteArray();
        WrAlarmId instance = null;
        if (DefaultTypeTransformation.booleanUnbox(callSiteArray[0].call(FactoryBuilderSupport.class, value, name, WrAlarmId.class))) {
            WrAlarmId wrAlarmId;
            instance = wrAlarmId = (WrAlarmId)ScriptBytecodeAdapter.castToType(value, WrAlarmId.class);
        } else {
            ...
            if (ScriptBytecodeAdapter.compareNotEqual(instanceValue, null)) {
                ...
                instance = (WrAlarmId)ScriptBytecodeAdapter.castToType(object, WrAlarmId.class);
            } else {
                Object object = ScriptBytecodeAdapter.invokeMethodOnSuperN(AbstractPropertyFactory.class, this, "newInstance", new Object[]{builder, name, value, attributes});
                instance = (WrAlarmId)ScriptBytecodeAdapter.castToType(object, WrAlarmId.class);
            }
    ...
    protected Object newInstance(ParameterList parameters, String value) {
        CallSite[] callSiteArray = WrAlarmIdFactory.$getCallSiteArray();
        return callSiteArray[3].callConstructor(WrAlarmId.class, parameters, value);
    }

    @Override
    protected /* synthetic */ MetaClass $getStaticMetaClass() {
        if (this.getClass() != WrAlarmIdFactory.class) {
    ...
    private static /* synthetic */ CallSiteArray $createCallSiteArray() {
        ...
        WrAlarmIdFactory.$createCallSiteArray_1(stringArray);
        return new CallSiteArray(WrAlarmIdFactory.class, stringArray);
    }

    private static /* synthetic */ CallSite[] $getCallSiteArray() {
        CallSiteArray callSiteArray;
        if ($callSiteArray == null || (callSiteArray = (CallSiteArray)$callSiteArray.get()) == null) {
            callSiteArray = WrAlarmIdFactory.$createCallSiteArray();
