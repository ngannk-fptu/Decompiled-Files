...
ParsingErrorMsgs {
    ...
    protected void _reportProblem(XMLReporter rep, String probType, String msg, Location loc) throws XMLStreamException {
        ...
        this._reportProblem(rep, new XMLValidationProblem((Location)loc, msg, 2, probType));
    }

    protected void _reportProblem(XMLReporter rep, XMLValidationProblem prob) throws XMLStreamException {
        if (rep != null) {
            Object loc = prob.getLocation();
            if (loc == null) {
                loc = this.getLastCharLocation();
                prob.setLocation((Location)loc);
            }
            ...
            if (rep instanceof XMLReporter2) {
                ...
                rep.report(prob.getMessage(), prob.getType(), prob, (Location)loc);
            }
        }
    }
    ...
    public void reportValidationProblem(String msg, int severity) throws XMLStreamException {
        this.reportValidationProblem(new XMLValidationProblem((Location)((Object)this.getLastCharLocation()), msg, severity));
    }

    @Override
    public void reportValidationProblem(String msg) throws XMLStreamException {
        this.reportValidationProblem(new XMLValidationProblem((Location)((Object)this.getLastCharLocation()), msg, 2));
    }
    ...
    protected WstxException constructWfcException(String msg) {
        return new WstxParsingException(msg, (Location)((Object)this.getLastCharLocation()));
    }
    ...
    protected WstxException constructNullCharException() {
        return new WstxUnexpectedCharException("Illegal character (NULL, unicode 0) encountered: not valid in any content", (Location)((Object)this.getLastCharLocation()), '\u0000');
    }
    ...
    protected void throwUnexpectedChar(int i, String msg) throws WstxException {
        ...
        throw new WstxUnexpectedCharException(excMsg, (Location)((Object)this.getLastCharLocation()), c);
    }
    ...
    protected WstxException throwInvalidSpace(int i, boolean deferErrors) throws WstxException {
        ...
        if (c == '\u0000') {
            ...
            ex = new WstxUnexpectedCharException(msg, (Location)((Object)this.getLastCharLocation()), c);
        }
        if (!deferErrors) {
            throw ex;
        }
    ...
    protected void throwUnexpectedEOF(String msg) throws WstxException {
        throw new WstxEOFException("Unexpected EOF" + (msg == null ? "" : msg), (Location)((Object)this.getLastCharLocation()));
    }

    protected void throwUnexpectedEOB(String msg) throws WstxException {
        throw new WstxEOFException("Unexpected end of input block" + (msg == null ? "" : msg), (Location)((Object)this.getLastCharLocation()));
    }
    ...
    private EntityDecl expandUnresolvedEntity(String id) throws XMLStreamException {
        ...
        if (resolver != null) {
            ...
            try {
                ...
                if (this.mCfgTreatCharRefsAsEntities) {
                    return new IntEntity((Location)((Object)WstxInputLocation.getEmptyLocation()), newInput.getEntityId(), newInput.getSource(), new char[0], (Location)((Object)WstxInputLocation.getEmptyLocation()));
                }
            }
            catch (IOException ioe) {
                throw this.constructFromIOE(ioe);
