...
implements StartElement {
    ...
    public void writeUsing(XMLStreamWriter2 w) throws XMLStreamException {
        ...
        this.outputNsAndAttr((XMLStreamWriter)w);
    }
    ...
    public int hashCode() {
        ...
        hash = BaseStartElement.addHash(this.getNamespaces(), (int)hash);
        hash = BaseStartElement.addHash(this.getAttributes(), (int)hash);
        return hash;
    }
}
