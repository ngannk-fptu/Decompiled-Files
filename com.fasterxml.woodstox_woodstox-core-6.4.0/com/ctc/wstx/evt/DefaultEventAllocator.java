        ...
        switch (r.getEventType()) {
            ...
            case 1: {
                ...
                if (r instanceof StreamReaderImpl) {
                    StreamReaderImpl sr = (StreamReaderImpl)((Object)r);
                ...
                if ((attrCount = r.getAttributeCount()) < 1) {
                    ...
                    for (int i = 0; i < attrCount; ++i) {
                        ...
                        attrs.put(aname, (Attribute)new AttributeEventImpl(loc, aname, r.getAttributeValue(i), r.isAttributeSpecified(i)));
                    }
                }
                ...
                if (nsCount < 1) {
                    ...
                    for (int i = 0; i < nsCount; ++i) {
                        ns.add((Namespace)NamespaceEventImpl.constructNamespace((Location)loc, (String)r.getNamespacePrefix(i), (String)r.getNamespaceURI(i)));
                    }
                }
            ...
            case 9: {
                if (r instanceof StreamReaderImpl) {
                    EntityDecl ed = ((StreamReaderImpl)((Object)r)).getCurrentEntityDecl();
                    if (ed == null) {
