...
extends RangeFacet {
    ...
    protected MinInclusiveFacet(String nsUri, String typeName, XSDatatypeImpl baseType, Object limit, boolean _isFixed) throws DatatypeException {
        super(nsUri, typeName, baseType, "minInclusive", limit, _isFixed);
    }
