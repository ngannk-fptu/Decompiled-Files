...
extends DOMWrappingWriter {
    ...
    public void setPrefix(String prefix, String uri) throws XMLStreamException {
        ...
        if (prefix.equals("xml")) {
            if (!uri.equals("http://www.w3.org/XML/1998/namespace")) {
                WstxDOMWrappingWriter.throwOutputError((String)ErrorConsts.ERR_NS_REDECL_XML, (Object)uri);
            }
        } else {
            if (prefix.equals("xmlns")) {
                if (!uri.equals("http://www.w3.org/2000/xmlns/")) {
                    WstxDOMWrappingWriter.throwOutputError((String)ErrorConsts.ERR_NS_REDECL_XMLNS, (Object)uri);
                }
                return;
            }
            if (uri.equals("http://www.w3.org/XML/1998/namespace")) {
                WstxDOMWrappingWriter.throwOutputError((String)ErrorConsts.ERR_NS_REDECL_XML_URI, (Object)prefix);
            } else if (uri.equals("http://www.w3.org/2000/xmlns/")) {
                WstxDOMWrappingWriter.throwOutputError((String)ErrorConsts.ERR_NS_REDECL_XMLNS_URI, (Object)prefix);
            }
        }
    ...
    public void writeNamespace(String prefix, String nsURI) throws XMLStreamException {
        ...
        if (!this.mNsAware) {
            WstxDOMWrappingWriter.throwOutputError((String)"Can not write namespaces with non-namespace writer.");
        }
    ...
    protected void createStartElem(String nsURI, String prefix, String localName, boolean isEmpty) throws XMLStreamException {
        ...
        if (!this.mNsAware) {
            if (nsURI != null && nsURI.length() > 0) {
                WstxDOMWrappingWriter.throwOutputError((String)"Can not specify non-empty uri/prefix in non-namespace mode");
            }
            ...
            if (prefix == null && nsURI != null && nsURI.length() > 0) {
                String string = prefix = this.mSuggestedPrefixes == null ? null : this.mSuggestedPrefixes.get(nsURI);
                if (prefix == null) {
                    WstxDOMWrappingWriter.throwOutputError((String)("Can not find prefix for namespace \"" + nsURI + "\""));
                }
            }
            if (prefix != null && prefix.length() != 0) {
    ...
    protected final String generateElemPrefix(String suggPrefix, String nsURI, DOMOutputElement elem) throws XMLStreamException {
        ...
        if (suggPrefix == null) {
            if (this.mSuggestedDefNs != null && this.mSuggestedDefNs.equals(nsURI)) {
                ...
                String string = suggPrefix = this.mSuggestedPrefixes == null ? null : this.mSuggestedPrefixes.get(nsURI);
                if (suggPrefix == null) {
