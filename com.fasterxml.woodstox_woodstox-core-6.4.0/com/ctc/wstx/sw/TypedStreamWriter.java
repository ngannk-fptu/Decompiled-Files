...
extends BaseStreamWriter {
    ...
    public void writeBoolean(boolean value) throws XMLStreamException {
        this.writeTypedElement((AsciiValueEncoder)this.valueEncoderFactory().getEncoder(value));
    }
    ...
    public void writeInteger(BigInteger value) throws XMLStreamException {
        this.writeTypedElement((AsciiValueEncoder)this.valueEncoderFactory().getScalarEncoder(value.toString()));
    }
    ...
    public final void writeIntArray(int[] value, int from, int length) throws XMLStreamException {
        this.writeTypedElement((AsciiValueEncoder)this.valueEncoderFactory().getEncoder(value, from, length));
    }
    ...
    public void writeBinary(byte[] value, int from, int length) throws XMLStreamException {
        ...
        this.writeTypedElement((AsciiValueEncoder)this.valueEncoderFactory().getEncoder(v, value, from, length));
    }
    ...
    public void writeBooleanAttribute(String prefix, String nsURI, String localName, boolean value) throws XMLStreamException {
        this.writeTypedAttribute(prefix, nsURI, localName, (AsciiValueEncoder)this.valueEncoderFactory().getEncoder(value));
    }
    ...
    public void writeIntegerAttribute(String prefix, String nsURI, String localName, BigInteger value) throws XMLStreamException {
        this.writeTypedAttribute(prefix, nsURI, localName, (AsciiValueEncoder)this.valueEncoderFactory().getScalarEncoder(value.toString()));
    }
    ...
    public void writeIntArrayAttribute(String prefix, String nsURI, String localName, int[] value) throws XMLStreamException {
        this.writeTypedAttribute(prefix, nsURI, localName, (AsciiValueEncoder)this.valueEncoderFactory().getEncoder(value, 0, value.length));
    }
    ...
    public void writeBinaryAttribute(String prefix, String nsURI, String localName, byte[] value) throws XMLStreamException {
        Base64Variant v = Base64Variants.getDefaultVariant();
        this.writeTypedAttribute(prefix, nsURI, localName, (AsciiValueEncoder)this.valueEncoderFactory().getEncoder(v, value, 0, value.length));
    }
