...
OutputConfigFlags {
            ...
            switch (sr.getEventType()) {
                ...
                case 1: {
                    if (sr instanceof StreamReaderImpl) {
                        ...
                        super.copyStartElement((XMLStreamReader)sr);
                    }
                    return;
                }
                case 2: {
                ...
                case 4: {
                    if (this.mValidator != null) {
                        this.writeCharacters(sr.getText());
                    } else {
                        this.mAnyOutput = true;
                        if (this.mStartElementOpen) {
                            this.closeStartElement(this.mEmptyElement);
    ...
    public XMLValidator validateAgainst(XMLValidationSchema schema) throws XMLStreamException {
        XMLValidator vld = schema.createValidator((ValidationContext)this);
        if (this.mValidator == null) {
