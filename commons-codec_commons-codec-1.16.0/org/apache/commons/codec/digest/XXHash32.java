...
implements Checksum {
    ...
    public long getValue() {
        int idx;
        int hash = this.stateUpdated ? Integer.rotateLeft(this.state[0], 1) + Integer.rotateLeft(this.state[1], 7) + Integer.rotateLeft(this.state[2], 12) + Integer.rotateLeft(this.state[3], 18) : this.state[2] + 374761393;
        hash += this.totalLen;
