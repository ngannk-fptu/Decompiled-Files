...
public class StringUtils {
    ...
    public static String join(Object[] array, String delimiter) {
        return array != null ? StringUtils.join(array, StringUtils.toStringOrEmpty(delimiter), 0, array.length) : null;
    }
    ...
    public static String[] stripAll(String[] strs, String stripChars) {
        ...
        Arrays.setAll(newArr, i -> StringUtils.strip(strs[i], stripChars));
        return newArr;
    }
