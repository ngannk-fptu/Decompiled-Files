...
public interface TarConstants {
    ...
    public static final long MAXID = 0x1FFFFFL;
    public static final int CHKSUMLEN = 8;
    public static final int CHKSUM_OFFSET = 148;
    public static final int SIZELEN = 12;
    public static final long MAXSIZE = 0x1FFFFFFFFL;
    ...
    public static final int SPARSE_OFFSET_LEN = 12;
    public static final int SPARSE_NUMBYTES_LEN = 12;
    public static final int SPARSE_HEADERS_IN_OLDGNU_HEADER = 4;
    public static final int SPARSE_HEADERS_IN_EXTENSION_HEADER = 21;
