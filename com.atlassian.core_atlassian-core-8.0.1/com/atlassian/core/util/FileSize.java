...
public class FileSize {
    ...
    public static double convertBytesToMB(long filesizeBytes) {
        return (float)filesizeBytes / 1048576.0f;
    }

    public static long convertMBToBytes(double filesizeMB) {
        return Math.round(filesizeMB * 1048576.0);
    }
}
