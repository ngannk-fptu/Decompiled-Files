...
implements Cloneable {
    ...
    public B channel(Class<? extends C> channelClass) {
        return this.channelFactory(new ReflectiveChannelFactory((Class)ObjectUtil.checkNotNull(channelClass, (String)"channelClass")));
    }
    ...
    public B localAddress(String inetHost, int inetPort) {
        return this.localAddress(SocketUtils.socketAddress((String)inetHost, (int)inetPort));
    }
    ...
    public ChannelFuture bind(String inetHost, int inetPort) {
        return this.bind(SocketUtils.socketAddress((String)inetHost, (int)inetPort));
    }
    ...
    public ChannelFuture bind(SocketAddress localAddress) {
        this.validate();
        return this.doBind((SocketAddress)ObjectUtil.checkNotNull((Object)localAddress, (String)"localAddress"));
    }
