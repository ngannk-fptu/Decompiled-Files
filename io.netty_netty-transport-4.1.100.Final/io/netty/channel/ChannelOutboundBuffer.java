...
public final class ChannelOutboundBuffer {
    ...
    private static void safeSuccess(ChannelPromise promise) {
        PromiseNotificationUtil.trySuccess((Promise)promise, null, (InternalLogger)(promise instanceof VoidChannelPromise ? null : logger));
    }

    private static void safeFail(ChannelPromise promise, Throwable cause) {
        PromiseNotificationUtil.tryFailure((Promise)promise, (Throwable)cause, (InternalLogger)(promise instanceof VoidChannelPromise ? null : logger));
    }
