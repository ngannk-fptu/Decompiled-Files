...
implements ChannelPool {
    ...
    public SimpleChannelPool(Bootstrap bootstrap, final ChannelPoolHandler handler, ChannelHealthChecker healthCheck, boolean releaseHealthCheck, boolean lastRecentUsed) {
        ...
        this.healthCheck = (ChannelHealthChecker)ObjectUtil.checkNotNull((Object)healthCheck, (String)"healthCheck");
            ...
            if (ch == null) {
                ...
                if (f.isDone()) {
                    ...
                    f.addListener(new ChannelFutureListener(){
                        ...
                        public void operationComplete(ChannelFuture future) throws Exception {
                            SimpleChannelPool.this.notifyConnect(future, (Promise<Channel>)promise);
                        }
                    });
                }
            } else {
                ...
                if (loop.inEventLoop()) {
                    ...
                    loop.execute(new Runnable(){
                        ...
                        @Override
                        public void run() {
                            SimpleChannelPool.this.doHealthCheck(ch, (Promise<Channel>)promise);
                        }
                    });
                }
            }
        ...
        if (f.isDone()) {
            ...
            f.addListener((GenericFutureListener)new FutureListener<Boolean>(){
                ...
                public void operationComplete(Future<Boolean> future) throws Exception {
                    SimpleChannelPool.this.releaseAndOfferIfHealthy(channel, (Promise<Void>)promise, (Future<Boolean>)f);
                }
            });
        }
    }
