...
implements ChannelConfig {
    ...
    protected <T> void validate(ChannelOption<T> option, T value) {
        ((ChannelOption)((Object)ObjectUtil.checkNotNull(option, (String)"option"))).validate(value);
    }
    ...
    public ChannelConfig setRecvByteBufAllocator(RecvByteBufAllocator allocator) {
        this.rcvBufAllocator = (RecvByteBufAllocator)ObjectUtil.checkNotNull((Object)allocator, (String)"allocator");
        return this;
    }
    ...
    public ChannelConfig setWriteBufferWaterMark(WriteBufferWaterMark writeBufferWaterMark) {
        this.writeBufferWaterMark = (WriteBufferWaterMark)ObjectUtil.checkNotNull((Object)writeBufferWaterMark, (String)"writeBufferWaterMark");
        return this;
    }
    ...
    public ChannelConfig setMessageSizeEstimator(MessageSizeEstimator estimator) {
        this.msgSizeEstimator = (MessageSizeEstimator)ObjectUtil.checkNotNull((Object)estimator, (String)"estimator");
        return this;
    }
