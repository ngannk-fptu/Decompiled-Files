...
extends SingleThreadEventLoop {
    ...
    NioEventLoop(NioEventLoopGroup parent, Executor executor, SelectorProvider selectorProvider, SelectStrategy strategy, RejectedExecutionHandler rejectedExecutionHandler, EventLoopTaskQueueFactory taskQueueFactory, EventLoopTaskQueueFactory tailTaskQueueFactory) {
        ...
        this.provider = (SelectorProvider)ObjectUtil.checkNotNull((Object)selectorProvider, (String)"selectorProvider");
                ...
                try {
                    ...
                    if (PlatformDependent.javaVersion() >= 9 && PlatformDependent.hasUnsafe()) {
                        ...
                        if (selectedKeysFieldOffset != -1L && publicSelectedKeysFieldOffset != -1L) {
                            PlatformDependent.putObject((Object)unwrappedSelector, (long)selectedKeysFieldOffset, (Object)selectedKeySet);
                            PlatformDependent.putObject((Object)unwrappedSelector, (long)publicSelectedKeysFieldOffset, (Object)selectedKeySet);
                            return null;
                        }
                    }
    ...
    public Iterator<Channel> registeredChannelsIterator() {
        ...
        return new Iterator<Channel>(){
            ...
            boolean isDone;
            {
                this.selectionKeyIterator = ((Set)ObjectUtil.checkNotNull((Object)keys, (String)"selectionKeys")).iterator();
            }
    ...
    private int select(long deadlineNanos) throws IOException {
        ...
        long timeoutMillis = NioEventLoop.deadlineToDelayNanos((long)(deadlineNanos + 995000L)) / 1000000L;
