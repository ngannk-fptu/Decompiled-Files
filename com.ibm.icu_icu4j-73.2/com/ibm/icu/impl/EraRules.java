...
public class EraRules {
    ...
    public static EraRules getInstance(CalType calType, boolean includeTentativeEra) {
        UResourceBundle supplementalDataRes = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", "supplementalData", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
