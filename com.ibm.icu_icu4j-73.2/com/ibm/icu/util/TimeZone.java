...
Freezable<TimeZone> {
    ...
    public static TimeZone forULocaleOrDefault(ULocale locale) {
        ...
        return tz == null ? TimeZone.getDefault() : TimeZone.getTimeZone(tz);
    }
    ...
    public static String getWindowsID(String id) {
        ...
        UResourceBundle top = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", "windowsZones", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
