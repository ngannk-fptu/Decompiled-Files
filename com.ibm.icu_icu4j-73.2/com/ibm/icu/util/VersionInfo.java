...
implements Comparable<VersionInfo> {
    ...
    static String getTZDataVersion() {
        ...
        synchronized (VersionInfo.class) {
            if (TZDATA_VERSION != null) return TZDATA_VERSION;
            UResourceBundle tzbundle = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", "zoneinfo64");
    ...
    static {
        ...
        ICU_DATA_VERSION = ICU_VERSION = VersionInfo.getInstance(73, 2, 0, 0);
