...
public final class LocaleData {
    ...
    public static final LocaleData getInstance(ULocale locale) {
        ...
        ld.bundle = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", locale);
        ld.langBundle = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b/lang", locale);
    ...
    private static UResourceBundle measurementTypeBundleForLocale(ULocale locale, String measurementType) {
        ...
        try {
            UResourceBundle rb = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", "supplementalData", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
    ...
    public static VersionInfo getCLDRVersion() {
        if (gCLDRVersion == null) {
            UResourceBundle supplementalDataBundle = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt73b", "supplementalData", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
