...
extends Calendar {
    ...
    private static long startOfYear(int year) {
        ...
        if (day == CalendarCache.EMPTY) {
            int months = (int)HebrewCalendar.floorDivide(235L * (long)year - 234L, 19L);
    ...
    protected void handleComputeFields(int julianDay) {
        ...
        long m = HebrewCalendar.floorDivide(d * 25920L, 765433L);
        int year = (int)(HebrewCalendar.floorDivide(19L * m + 234L, 235L) + 1L);
