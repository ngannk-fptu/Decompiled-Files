...
public final class UScript {
    ...
    public static final int getScript(int codepoint) {
        if (codepoint >= 0 & codepoint <= 0x10FFFF) {
            int scriptX = UCharacterProperty.INSTANCE.getAdditional(codepoint, 0) & 0xF000FF;
    ...
    public static final boolean hasScript(int c, int sc) {
        int scriptX = UCharacterProperty.INSTANCE.getAdditional(c, 0) & 0xF000FF;
        int codeOrIndex = UCharacterProperty.mergeScriptCodeOrIndex(scriptX);
        if (scriptX < 0x400000) {
