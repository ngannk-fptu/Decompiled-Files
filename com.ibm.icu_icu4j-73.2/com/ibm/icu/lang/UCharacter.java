...
UCharacterEnums.ECharacterDirection {
    ...
    public static boolean isUnicodeIdentifierPart(int ch) {
        return UCharacter.hasBinaryProperty(ch, 15);
    }

    public static boolean isUnicodeIdentifierStart(int ch) {
        return UCharacter.hasBinaryProperty(ch, 16);
    }
    ...
    public static int getCodePoint(int lead, int trail) {
        if (UCharacter.isHighSurrogate(lead) && UCharacter.isLowSurrogate(trail)) {
    ...
    public static String toUpperCase(String str) {
        return CaseMapImpl.toUpper(UCharacter.getDefaultCaseLocale(), 0, str);
    }

    public static String toLowerCase(String str) {
        return CaseMapImpl.toLower(UCharacter.getDefaultCaseLocale(), 0, str);
    }
    ...
    public static String toUpperCase(Locale locale, String str) {
        return CaseMapImpl.toUpper(UCharacter.getCaseLocale(locale), 0, str);
    }
    ...
    public static String toLowerCase(Locale locale, String str) {
        return CaseMapImpl.toLower(UCharacter.getCaseLocale(locale), 0, str);
    }
    ...
    public static String toTitleCase(ULocale locale, String str, BreakIterator titleIter, int options) {
        ...
        return CaseMapImpl.toTitle(UCharacter.getCaseLocale(locale), options, titleIter, str);
    }
    ...
    public static boolean hasBinaryProperty(CharSequence s, int property) {
        ...
        int length = s.length();
        if (length == 1) {
            return UCharacter.hasBinaryProperty(s.charAt(0), property);
        }
        if (length == 2 && Character.charCount(c = Character.codePointAt(s, 0)) == length) {
            return UCharacter.hasBinaryProperty(c, property);
        }
    ...
    public static boolean isHighSurrogate(int codePoint) {
        return (codePoint & 0xFFFFFC00) == 55296;
    }

    public static boolean isLowSurrogate(int codePoint) {
        return (codePoint & 0xFFFFFC00) == 56320;
    }
    ...
    extends Character.Subset {
        ...
        public static final int ARABIC_EXTENDED_C_ID = 321;
        public static final int CJK_UNIFIED_IDEOGRAPHS_EXTENSION_H_ID = 322;
        public static final int CYRILLIC_EXTENDED_D_ID = 323;
        public static final int DEVANAGARI_EXTENDED_A_ID = 324;
        public static final int KAKTOVIK_NUMERALS_ID = 325;
        public static final int KAWI_ID = 326;
        public static final int NAG_MUNDARI_ID = 327;
        @Deprecated
        public static final int COUNT = 328;
        private static final UnicodeBlock[] BLOCKS_ = new UnicodeBlock[328];
        ...
        static {
            ...
            ARABIC_EXTENDED_B = new UnicodeBlock("ARABIC_EXTENDED_B", 309);
            CYPRO_MINOAN = new UnicodeBlock("CYPRO_MINOAN", 310);
            ETHIOPIC_EXTENDED_B = new UnicodeBlock("ETHIOPIC_EXTENDED_B", 311);
            KANA_EXTENDED_B = new UnicodeBlock("KANA_EXTENDED_B", 312);
            LATIN_EXTENDED_F = new UnicodeBlock("LATIN_EXTENDED_F", 313);
            LATIN_EXTENDED_G = new UnicodeBlock("LATIN_EXTENDED_G", 314);
            OLD_UYGHUR = new UnicodeBlock("OLD_UYGHUR", 315);
            TANGSA = new UnicodeBlock("TANGSA", 316);
            TOTO = new UnicodeBlock("TOTO", 317);
            UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED_A = new UnicodeBlock("UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED_A", 318);
            VITHKUQI = new UnicodeBlock("VITHKUQI", 319);
            ZNAMENNY_MUSICAL_NOTATION = new UnicodeBlock("ZNAMENNY_MUSICAL_NOTATION", 320);
            ARABIC_EXTENDED_C = new UnicodeBlock("ARABIC_EXTENDED_C", 321);
            CJK_UNIFIED_IDEOGRAPHS_EXTENSION_H = new UnicodeBlock("CJK_UNIFIED_IDEOGRAPHS_EXTENSION_H", 322);
            CYRILLIC_EXTENDED_D = new UnicodeBlock("CYRILLIC_EXTENDED_D", 323);
            DEVANAGARI_EXTENDED_A = new UnicodeBlock("DEVANAGARI_EXTENDED_A", 324);
            KAKTOVIK_NUMERALS = new UnicodeBlock("KAKTOVIK_NUMERALS", 325);
            KAWI = new UnicodeBlock("KAWI", 326);
            NAG_MUNDARI = new UnicodeBlock("NAG_MUNDARI", 327);
            INVALID_CODE = new UnicodeBlock("INVALID_CODE", -1);
            for (int blockId = 0; blockId < 328; ++blockId) {
