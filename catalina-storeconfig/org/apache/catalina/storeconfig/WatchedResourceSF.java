...
public class WatchedResourceSF
extends StoreFactoryBase {
    ...
    public void store(PrintWriter aWriter, int indent, Object aElement) throws Exception {
        if (aElement instanceof StandardContext) {
            StoreDescription elementDesc = this.getRegistry().findDescription(aElement.getClass().getName() + ".[WatchedResource]");
            String[] resources = ((StandardContext)aElement).findWatchedResources();
            if (elementDesc != null) {
            ...
            log.warn((Object)sm.getString("storeFactory.noDescriptor", new Object[]{aElement.getClass(), "WatchedResource"}));
        }
    }
}
