...
Serializable {
    ...
    public void marshall(Class parentType, QName elementType, ExtensibilityElement extension, PrintWriter pw, Definition def, ExtensionRegistry extReg) throws WSDLException {
        ...
        if (soapBody != null) {
            String tagName = DOMUtils.getQualifiedValue("http://schemas.xmlsoap.org/wsdl/soap12/", "body", def);
            ...
            DOMUtils.printAttribute("encodingStyle", soapBody.getEncodingStyle(), pw);
