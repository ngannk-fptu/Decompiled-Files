...
extends com.sun.jna.platform.win32.PowrProf {
    ...
    @Structure.FieldOrder(value={"Day", "Month", "Year"})
    public static class BATTERY_MANUFACTURE_DATE
    extends Structure {
        public byte Day;
        public byte Month;
        public short Year;
    ...
    @Structure.FieldOrder(value={"PowerState", "Capacity", "Voltage", "Rate"})
    ...
    public static class BATTERY_WAIT_STATUS
    extends Structure {
    ...
    @Structure.FieldOrder(value={"BatteryTag", "InformationLevel", "AtRate"})
