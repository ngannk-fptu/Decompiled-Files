...
extends AbstractOSFileStore {
    ...
    public MacOSFileStore(String name, String volume, String label, String mount, String options, String uuid, String logicalVolume, String description, String fsType, long freeSpace, long usableSpace, long totalSpace, long freeInodes, long totalInodes) {
    ...
    public boolean updateAttributes() {
        for (OSFileStore fileStore : MacFileSystem.getFileStoreMatching(this.getName())) {
