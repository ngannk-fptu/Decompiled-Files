...
extends SOAPElement {
    ...
    public SOAPFault addFault(QName var1, String var2, Locale var3) throws SOAPException;

    public SOAPFault addFault(Name var1, String var2) throws SOAPException;

    public SOAPFault addFault(QName var1, String var2) throws SOAPException;
    ...
    public SOAPBodyElement addBodyElement(QName var1) throws SOAPException;
