...
implements Opcodes {
    ...
    public CompiledExpression compile(SpelNodeImpl expression) {
        if (expression.isCompilable()) {
            ...
            if ((clazz = this.createExpressionClass(expression)) != null) {
                try {
                    return (CompiledExpression)ReflectionUtils.accessibleConstructor(clazz, (Class[])new Class[0]).newInstance(new Object[0]);
                }
                catch (Throwable ex) {
    ...
    private Class<? extends CompiledExpression> createExpressionClass(SpelNodeImpl expressionToCompile) {
        ...
        return this.loadClass(StringUtils.replace((String)className, (String)"/", (String)"."), data);
    }
