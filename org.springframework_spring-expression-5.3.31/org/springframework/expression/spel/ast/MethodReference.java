...
extends SpelNodeImpl {
    ...
    public void generateCode(MethodVisitor mv, CodeFlow cf) {
        ...
        if (Modifier.isPublic(method.getDeclaringClass().getModifiers())) {
            ...
            Assert.state((publicDeclaringClass != null ? 1 : 0) != 0, (String)"No public declaring class");
    ...
    private static class CachedMethodExecutor {
        ...
        public boolean isSuitable(Object value, @Nullable TypeDescriptor target, List<TypeDescriptor> argumentTypes) {
            return (this.staticClass == null || this.staticClass == value) && ObjectUtils.nullSafeEquals((Object)this.target, (Object)target) && this.argumentTypes.equals(argumentTypes);
        }
