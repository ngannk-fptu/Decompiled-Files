...
implements PropertyAccessor {
    ...
    public boolean canRead(EvaluationContext context, @Nullable Object target, String name) throws AccessException {
        ...
        if (method != null) {
            ...
            method = ClassUtils.getInterfaceMethodIfPossible((Method)method, type);
    ...
    public void write(EvaluationContext context, @Nullable Object target, String name, @Nullable Object newValue) throws AccessException {
        ...
        if (typeDescriptor != null) {
            try {
                possiblyConvertedNewValue = context.getTypeConverter().convertValue(newValue, TypeDescriptor.forObject((Object)newValue), typeDescriptor);
            }
    ...
    protected String[] getPropertyMethodSuffixes(String propertyName) {
        ...
        return new String[]{suffix, StringUtils.capitalize((String)suffix)};
    }
    ...
    implements CompilablePropertyAccessor {
        ...
        public boolean canRead(EvaluationContext context, @Nullable Object target, String name) throws AccessException {
            ...
            if (this.member instanceof Method) {
                ...
                getterName = "is" + StringUtils.capitalize((String)name);
                if (getterName.equals(method.getName())) {
                    return true;
                }
            }
