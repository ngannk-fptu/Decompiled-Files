...
implements HttpAsyncClient {
    ...
    private void doExecute() {
        InternalRequestExecutor handler = new InternalRequestExecutor(this.log, new HttpAsyncRequestExecutor());
        try {
            DefaultHttpClientIODispatch<InternalRequestExecutor> ioEventDispatch = new DefaultHttpClientIODispatch<InternalRequestExecutor>(handler, this.getParams());
