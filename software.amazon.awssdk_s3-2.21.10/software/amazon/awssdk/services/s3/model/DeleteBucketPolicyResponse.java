...
public final class DeleteBucketPolicyResponse
extends S3Response
implements ToCopyableBuilder<Builder, DeleteBucketPolicyResponse> {
    ...
    public final String toString() {
        return ToString.builder((String)"DeleteBucketPolicyResponse").build();
    }
    ...
    implements Builder {
        ...
        private BuilderImpl(DeleteBucketPolicyResponse model) {
            super(model);
        }
    ...
    SdkPojo,
    CopyableBuilder<Builder, DeleteBucketPolicyResponse> {
    }
}
