...
public final class PutBucketOwnershipControlsResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutBucketOwnershipControlsResponse> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));

    private PutBucketOwnershipControlsResponse(BuilderImpl builder) {
        super(builder);
    }
    ...
    public final String toString() {
        return ToString.builder((String)"PutBucketOwnershipControlsResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutBucketOwnershipControlsResponse> {
    }
}
