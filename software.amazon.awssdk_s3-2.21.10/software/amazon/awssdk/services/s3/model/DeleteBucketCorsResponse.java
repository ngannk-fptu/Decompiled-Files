...
public final class DeleteBucketCorsResponse
extends S3Response
implements ToCopyableBuilder<Builder, DeleteBucketCorsResponse> {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return obj instanceof DeleteBucketCorsResponse;
    }

    public final String toString() {
        return ToString.builder((String)"DeleteBucketCorsResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, DeleteBucketCorsResponse> {
    }
}
