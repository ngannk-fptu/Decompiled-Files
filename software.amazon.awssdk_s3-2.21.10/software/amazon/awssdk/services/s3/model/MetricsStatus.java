...
public enum MetricsStatus {
    ...
    private static final Map<String, MetricsStatus> VALUE_MAP;
    ...
    public static Set<MetricsStatus> knownValues() {
        EnumSet<MetricsStatus> knownValues = EnumSet.allOf(MetricsStatus.class);
        knownValues.remove((Object)UNKNOWN_TO_SDK_VERSION);
        return knownValues;
    }

    static {
        VALUE_MAP = EnumUtils.uniqueIndex(MetricsStatus.class, MetricsStatus::toString);
    }
}
