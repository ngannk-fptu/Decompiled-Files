...
public enum FilterRuleName {
    ...
    private static final Map<String, FilterRuleName> VALUE_MAP;
    ...
    public static Set<FilterRuleName> knownValues() {
        EnumSet<FilterRuleName> knownValues = EnumSet.allOf(FilterRuleName.class);
        knownValues.remove((Object)UNKNOWN_TO_SDK_VERSION);
        return knownValues;
    }

    static {
        VALUE_MAP = EnumUtils.uniqueIndex(FilterRuleName.class, FilterRuleName::toString);
    }
}
