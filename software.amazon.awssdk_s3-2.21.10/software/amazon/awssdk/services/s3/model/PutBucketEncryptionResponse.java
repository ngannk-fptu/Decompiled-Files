...
public final class PutBucketEncryptionResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutBucketEncryptionResponse> {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return obj instanceof PutBucketEncryptionResponse;
    }

    public final String toString() {
        return ToString.builder((String)"PutBucketEncryptionResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutBucketEncryptionResponse> {
    }
}
