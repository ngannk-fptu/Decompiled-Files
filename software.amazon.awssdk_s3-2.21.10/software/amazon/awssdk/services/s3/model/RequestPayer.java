...
public enum RequestPayer {
    ...
    private static final Map<String, RequestPayer> VALUE_MAP;
    ...
    public static Set<RequestPayer> knownValues() {
        EnumSet<RequestPayer> knownValues = EnumSet.allOf(RequestPayer.class);
        knownValues.remove((Object)UNKNOWN_TO_SDK_VERSION);
        return knownValues;
    }

    static {
        VALUE_MAP = EnumUtils.uniqueIndex(RequestPayer.class, RequestPayer::toString);
    }
}
