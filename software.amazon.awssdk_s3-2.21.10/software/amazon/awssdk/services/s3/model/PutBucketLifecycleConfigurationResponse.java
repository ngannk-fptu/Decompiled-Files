...
public final class PutBucketLifecycleConfigurationResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutBucketLifecycleConfigurationResponse> {
    ...
    public final String toString() {
        return ToString.builder((String)"PutBucketLifecycleConfigurationResponse").build();
    }
