...
public final class NoSuchBucketException
extends S3Exception
implements ToCopyableBuilder<Builder, NoSuchBucketException> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));
    private static final long serialVersionUID = 1L;

    private NoSuchBucketException(BuilderImpl builder) {
        super(builder);
    }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, NoSuchBucketException>,
    S3Exception.Builder {
        @Override
