...
public final class PutBucketWebsiteResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutBucketWebsiteResponse> {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return obj instanceof PutBucketWebsiteResponse;
    }

    public final String toString() {
        return ToString.builder((String)"PutBucketWebsiteResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutBucketWebsiteResponse> {
    }
}
