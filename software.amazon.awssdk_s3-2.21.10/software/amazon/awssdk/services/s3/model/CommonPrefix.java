...
ToCopyableBuilder<Builder, CommonPrefix> {
    ...
    public final String toString() {
        return ToString.builder((String)"CommonPrefix").add("Prefix", (Object)this.prefix()).build();
    }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, CommonPrefix> {
