...
public final class GetBucketRequestPaymentResponse
extends S3Response
implements ToCopyableBuilder<Builder, GetBucketRequestPaymentResponse> {
    private static final SdkField<String> PAYER_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("Payer").getter(GetBucketRequestPaymentResponse.getter(GetBucketRequestPaymentResponse::payerAsString)).setter(GetBucketRequestPaymentResponse.setter(Builder::payer)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Payer").unmarshallLocationName("Payer").build()}).build();
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketRequestPaymentResponse, T> g) {
        return obj -> g.apply((GetBucketRequestPaymentResponse)((Object)((Object)obj)));
    }
