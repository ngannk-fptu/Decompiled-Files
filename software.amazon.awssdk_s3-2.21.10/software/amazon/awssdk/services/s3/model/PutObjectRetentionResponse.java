...
public final class PutObjectRetentionResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutObjectRetentionResponse> {
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("RequestCharged").getter(PutObjectRetentionResponse.getter(PutObjectRetentionResponse::requestChargedAsString)).setter(PutObjectRetentionResponse.setter(Builder::requestCharged)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-request-charged").unmarshallLocationName("x-amz-request-charged").build()}).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        PutObjectRetentionResponse other = (PutObjectRetentionResponse)((Object)obj);
        return Objects.equals(this.requestChargedAsString(), other.requestChargedAsString());
    }

    public final String toString() {
        return ToString.builder((String)"PutObjectRetentionResponse").add("RequestCharged", (Object)this.requestChargedAsString()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<PutObjectRetentionResponse, T> g) {
        return obj -> g.apply((PutObjectRetentionResponse)((Object)((Object)obj)));
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutObjectRetentionResponse> {
