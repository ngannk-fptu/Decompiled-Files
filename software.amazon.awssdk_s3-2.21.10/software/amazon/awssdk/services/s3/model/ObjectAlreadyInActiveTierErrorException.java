...
public final class ObjectAlreadyInActiveTierErrorException
extends S3Exception
implements ToCopyableBuilder<Builder, ObjectAlreadyInActiveTierErrorException> {
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, ObjectAlreadyInActiveTierErrorException>,
    S3Exception.Builder {
        @Override
