...
public final class BucketAlreadyOwnedByYouException
extends S3Exception
implements ToCopyableBuilder<Builder, BucketAlreadyOwnedByYouException> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));
    private static final long serialVersionUID = 1L;

    private BucketAlreadyOwnedByYouException(BuilderImpl builder) {
        super(builder);
    }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, BucketAlreadyOwnedByYouException>,
    S3Exception.Builder {
        @Override
