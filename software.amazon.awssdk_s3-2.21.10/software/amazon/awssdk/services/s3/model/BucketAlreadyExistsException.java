...
public final class BucketAlreadyExistsException
extends S3Exception
implements ToCopyableBuilder<Builder, BucketAlreadyExistsException> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));
    private static final long serialVersionUID = 1L;

    private BucketAlreadyExistsException(BuilderImpl builder) {
        super(builder);
    }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, BucketAlreadyExistsException>,
    S3Exception.Builder {
        @Override
