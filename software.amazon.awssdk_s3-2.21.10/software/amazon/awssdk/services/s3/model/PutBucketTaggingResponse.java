...
public final class PutBucketTaggingResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutBucketTaggingResponse> {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return obj instanceof PutBucketTaggingResponse;
    }

    public final String toString() {
        return ToString.builder((String)"PutBucketTaggingResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutBucketTaggingResponse> {
    }
}
