...
implements SdkPojo,
Serializable,
ToCopyableBuilder<Builder, ContinuationEvent>,
SelectObjectContentEventStream {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return obj instanceof ContinuationEvent;
    }

    public final String toString() {
        return ToString.builder((String)"ContinuationEvent").build();
    }
    ...
    public final ContinuationEvent copy(Consumer<? super Builder> modifier) {
        return (ContinuationEvent)super.copy(modifier);
    }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, ContinuationEvent> {
    }
}
