...
public final class DeleteBucketResponse
extends S3Response
implements ToCopyableBuilder<Builder, DeleteBucketResponse> {
    ...
    public final String toString() {
        return ToString.builder((String)"DeleteBucketResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, DeleteBucketResponse> {
    }
}
