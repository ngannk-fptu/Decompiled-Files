...
public final class PutBucketReplicationResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutBucketReplicationResponse> {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return obj instanceof PutBucketReplicationResponse;
    }

    public final String toString() {
        return ToString.builder((String)"PutBucketReplicationResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutBucketReplicationResponse> {
    }
}
