...
public final class PutBucketRequestPaymentResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutBucketRequestPaymentResponse> {
    ...
    public final String toString() {
        return ToString.builder((String)"PutBucketRequestPaymentResponse").build();
    }
    ...
    implements Builder {
        ...
        private BuilderImpl(PutBucketRequestPaymentResponse model) {
            super(model);
        }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutBucketRequestPaymentResponse> {
    }
}
