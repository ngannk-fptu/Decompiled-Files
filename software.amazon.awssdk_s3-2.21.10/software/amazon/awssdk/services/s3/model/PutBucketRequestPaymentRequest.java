...
public final class PutBucketRequestPaymentRequest
extends S3Request
implements ToCopyableBuilder<Builder, PutBucketRequestPaymentRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("Bucket").getter(PutBucketRequestPaymentRequest.getter(PutBucketRequestPaymentRequest::bucket)).setter(PutBucketRequestPaymentRequest.setter(Builder::bucket)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PATH).locationName("Bucket").unmarshallLocationName("Bucket").build(), RequiredTrait.create()}).build();
    private static final SdkField<String> CONTENT_MD5_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("ContentMD5").getter(PutBucketRequestPaymentRequest.getter(PutBucketRequestPaymentRequest::contentMD5)).setter(PutBucketRequestPaymentRequest.setter(Builder::contentMD5)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("Content-MD5").unmarshallLocationName("Content-MD5").build()}).build();
    private static final SdkField<String> CHECKSUM_ALGORITHM_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("ChecksumAlgorithm").getter(PutBucketRequestPaymentRequest.getter(PutBucketRequestPaymentRequest::checksumAlgorithmAsString)).setter(PutBucketRequestPaymentRequest.setter(Builder::checksumAlgorithm)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-sdk-checksum-algorithm").unmarshallLocationName("x-amz-sdk-checksum-algorithm").build()}).build();
    private static final SdkField<RequestPaymentConfiguration> REQUEST_PAYMENT_CONFIGURATION_FIELD = SdkField.builder((MarshallingType)MarshallingType.SDK_POJO).memberName("RequestPaymentConfiguration").getter(PutBucketRequestPaymentRequest.getter(PutBucketRequestPaymentRequest::requestPaymentConfiguration)).setter(PutBucketRequestPaymentRequest.setter(Builder::requestPaymentConfiguration)).constructor(RequestPaymentConfiguration::builder).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RequestPaymentConfiguration").unmarshallLocationName("RequestPaymentConfiguration").build(), PayloadTrait.create(), RequiredTrait.create()}).build();
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("ExpectedBucketOwner").getter(PutBucketRequestPaymentRequest.getter(PutBucketRequestPaymentRequest::expectedBucketOwner)).setter(PutBucketRequestPaymentRequest.setter(Builder::expectedBucketOwner)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-expected-bucket-owner").unmarshallLocationName("x-amz-expected-bucket-owner").build()}).build();
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUCKET_FIELD, CONTENT_MD5_FIELD, CHECKSUM_ALGORITHM_FIELD, REQUEST_PAYMENT_CONFIGURATION_FIELD, EXPECTED_BUCKET_OWNER_FIELD));
    ...
    public final RequestPaymentConfiguration requestPaymentConfiguration() {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return Objects.equals(this.bucket(), other.bucket()) && Objects.equals(this.contentMD5(), other.contentMD5()) && Objects.equals(this.checksumAlgorithmAsString(), other.checksumAlgorithmAsString()) && Objects.equals(this.requestPaymentConfiguration(), other.requestPaymentConfiguration()) && Objects.equals(this.expectedBucketOwner(), other.expectedBucketOwner());
    }

    public final String toString() {
        return ToString.builder((String)"PutBucketRequestPaymentRequest").add("Bucket", (Object)this.bucket()).add("ContentMD5", (Object)this.contentMD5()).add("ChecksumAlgorithm", (Object)this.checksumAlgorithmAsString()).add("RequestPaymentConfiguration", (Object)this.requestPaymentConfiguration()).add("ExpectedBucketOwner", (Object)this.expectedBucketOwner()).build();
    }
    ...
    public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
        switch (fieldName) {
            ...
            case "RequestPaymentConfiguration": {
                return Optional.ofNullable(clazz.cast(this.requestPaymentConfiguration()));
            }
    ...
    private static <T> Function<Object, T> getter(Function<PutBucketRequestPaymentRequest, T> g) {
        return obj -> g.apply((PutBucketRequestPaymentRequest)((Object)((Object)obj)));
    }
    ...
    CopyableBuilder<Builder, PutBucketRequestPaymentRequest> {
        ...
        default public Builder requestPaymentConfiguration(Consumer<RequestPaymentConfiguration.Builder> requestPaymentConfiguration) {
            return this.requestPaymentConfiguration((RequestPaymentConfiguration)((RequestPaymentConfiguration.Builder)RequestPaymentConfiguration.builder().applyMutation(requestPaymentConfiguration)).build());
        }
