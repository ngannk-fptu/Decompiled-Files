...
extends S3Response
implements ToCopyableBuilder<Builder, AbortMultipartUploadResponse> {
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("RequestCharged").getter(AbortMultipartUploadResponse.getter(AbortMultipartUploadResponse::requestChargedAsString)).setter(AbortMultipartUploadResponse.setter(Builder::requestCharged)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-request-charged").unmarshallLocationName("x-amz-request-charged").build()}).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        AbortMultipartUploadResponse other = (AbortMultipartUploadResponse)((Object)obj);
        return Objects.equals(this.requestChargedAsString(), other.requestChargedAsString());
    }

    public final String toString() {
        return ToString.builder((String)"AbortMultipartUploadResponse").add("RequestCharged", (Object)this.requestChargedAsString()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<AbortMultipartUploadResponse, T> g) {
        return obj -> g.apply((AbortMultipartUploadResponse)((Object)((Object)obj)));
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, AbortMultipartUploadResponse> {
