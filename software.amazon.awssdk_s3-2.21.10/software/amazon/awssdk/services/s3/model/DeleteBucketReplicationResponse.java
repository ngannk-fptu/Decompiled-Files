...
public final class DeleteBucketReplicationResponse
extends S3Response
implements ToCopyableBuilder<Builder, DeleteBucketReplicationResponse> {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return obj instanceof DeleteBucketReplicationResponse;
    }

    public final String toString() {
        return ToString.builder((String)"DeleteBucketReplicationResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, DeleteBucketReplicationResponse> {
    }
}
