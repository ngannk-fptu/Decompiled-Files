...
ToCopyableBuilder<Builder, AnalyticsAndOperator> {
    ...
    private AnalyticsAndOperator(BuilderImpl builder) {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        if (!(obj instanceof AnalyticsAndOperator)) {
            return false;
        }
    ...
    public final String toString() {
        return ToString.builder((String)"AnalyticsAndOperator").add("Prefix", (Object)this.prefix()).add("Tags", this.hasTags() ? this.tags() : null).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<AnalyticsAndOperator, T> g) {
        return obj -> g.apply((AnalyticsAndOperator)obj);
    }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, AnalyticsAndOperator> {
