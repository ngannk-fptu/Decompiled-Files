...
ToCopyableBuilder<Builder, Stats> {
    private static final SdkField<Long> BYTES_SCANNED_FIELD = SdkField.builder((MarshallingType)MarshallingType.LONG).memberName("BytesScanned").getter(Stats.getter(Stats::bytesScanned)).setter(Stats.setter(Builder::bytesScanned)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("BytesScanned").unmarshallLocationName("BytesScanned").build()}).build();
    private static final SdkField<Long> BYTES_PROCESSED_FIELD = SdkField.builder((MarshallingType)MarshallingType.LONG).memberName("BytesProcessed").getter(Stats.getter(Stats::bytesProcessed)).setter(Stats.setter(Builder::bytesProcessed)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("BytesProcessed").unmarshallLocationName("BytesProcessed").build()}).build();
    private static final SdkField<Long> BYTES_RETURNED_FIELD = SdkField.builder((MarshallingType)MarshallingType.LONG).memberName("BytesReturned").getter(Stats.getter(Stats::bytesReturned)).setter(Stats.setter(Builder::bytesReturned)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("BytesReturned").unmarshallLocationName("BytesReturned").build()}).build();
    ...
    public final String toString() {
        return ToString.builder((String)"Stats").add("BytesScanned", (Object)this.bytesScanned()).add("BytesProcessed", (Object)this.bytesProcessed()).add("BytesReturned", (Object)this.bytesReturned()).build();
    }
