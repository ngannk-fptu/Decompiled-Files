...
public final class PutBucketCorsResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutBucketCorsResponse> {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return obj instanceof PutBucketCorsResponse;
    }

    public final String toString() {
        return ToString.builder((String)"PutBucketCorsResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutBucketCorsResponse> {
    }
}
