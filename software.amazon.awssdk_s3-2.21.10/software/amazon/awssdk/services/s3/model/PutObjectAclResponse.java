...
public final class PutObjectAclResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutObjectAclResponse> {
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("RequestCharged").getter(PutObjectAclResponse.getter(PutObjectAclResponse::requestChargedAsString)).setter(PutObjectAclResponse.setter(Builder::requestCharged)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-request-charged").unmarshallLocationName("x-amz-request-charged").build()}).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        if (!(obj instanceof PutObjectAclResponse)) {
            return false;
        }
        PutObjectAclResponse other = (PutObjectAclResponse)((Object)obj);
        return Objects.equals(this.requestChargedAsString(), other.requestChargedAsString());
    }

    public final String toString() {
        return ToString.builder((String)"PutObjectAclResponse").add("RequestCharged", (Object)this.requestChargedAsString()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<PutObjectAclResponse, T> g) {
        return obj -> g.apply((PutObjectAclResponse)((Object)((Object)obj)));
    }
    ...
    implements Builder {
        ...
        private BuilderImpl(PutObjectAclResponse model) {
            super(model);
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutObjectAclResponse> {
