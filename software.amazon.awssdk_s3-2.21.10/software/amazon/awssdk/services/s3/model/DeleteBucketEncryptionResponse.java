...
public final class DeleteBucketEncryptionResponse
extends S3Response
implements ToCopyableBuilder<Builder, DeleteBucketEncryptionResponse> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));

    private DeleteBucketEncryptionResponse(BuilderImpl builder) {
        super(builder);
    }
    ...
    public final String toString() {
        return ToString.builder((String)"DeleteBucketEncryptionResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, DeleteBucketEncryptionResponse> {
    }
}
