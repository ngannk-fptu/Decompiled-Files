...
ToCopyableBuilder<Builder, Grant> {
    private static final SdkField<Grantee> GRANTEE_FIELD = SdkField.builder((MarshallingType)MarshallingType.SDK_POJO).memberName("Grantee").getter(Grant.getter(Grant::grantee)).setter(Grant.setter(Builder::grantee)).constructor(Grantee::builder).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Grantee").unmarshallLocationName("Grantee").build(), XmlAttributesTrait.create((Pair[])new Pair[]{Pair.of((Object)"xmlns:xsi", (Object)XmlAttributesTrait.AttributeAccessors.builder().attributeGetter(ignore -> "http://www.w3.org/2001/XMLSchema-instance").build()), Pair.of((Object)"xsi:type", (Object)XmlAttributesTrait.AttributeAccessors.builder().attributeGetter(t -> ((Grantee)t).typeAsString()).build())})}).build();
    private static final SdkField<String> PERMISSION_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("Permission").getter(Grant.getter(Grant::permissionAsString)).setter(Grant.setter(Builder::permission)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Permission").unmarshallLocationName("Permission").build()}).build();
