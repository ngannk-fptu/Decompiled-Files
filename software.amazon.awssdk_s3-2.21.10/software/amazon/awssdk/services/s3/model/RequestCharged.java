...
public enum RequestCharged {
    ...
    private static final Map<String, RequestCharged> VALUE_MAP;
    ...
    public static Set<RequestCharged> knownValues() {
        EnumSet<RequestCharged> knownValues = EnumSet.allOf(RequestCharged.class);
        knownValues.remove((Object)UNKNOWN_TO_SDK_VERSION);
        return knownValues;
    }

    static {
        VALUE_MAP = EnumUtils.uniqueIndex(RequestCharged.class, RequestCharged::toString);
    }
}
