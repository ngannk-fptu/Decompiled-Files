...
public final class ObjectNotInActiveTierErrorException
extends S3Exception
implements ToCopyableBuilder<Builder, ObjectNotInActiveTierErrorException> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));
    private static final long serialVersionUID = 1L;

    private ObjectNotInActiveTierErrorException(BuilderImpl builder) {
        super(builder);
    }
    ...
    extends SdkPojo,
    CopyableBuilder<Builder, ObjectNotInActiveTierErrorException>,
    S3Exception.Builder {
        @Override
