...
extends S3Response
implements ToCopyableBuilder<Builder, GetPublicAccessBlockResponse> {
    private static final SdkField<PublicAccessBlockConfiguration> PUBLIC_ACCESS_BLOCK_CONFIGURATION_FIELD = SdkField.builder((MarshallingType)MarshallingType.SDK_POJO).memberName("PublicAccessBlockConfiguration").getter(GetPublicAccessBlockResponse.getter(GetPublicAccessBlockResponse::publicAccessBlockConfiguration)).setter(GetPublicAccessBlockResponse.setter(Builder::publicAccessBlockConfiguration)).constructor(PublicAccessBlockConfiguration::builder).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("PublicAccessBlockConfiguration").unmarshallLocationName("PublicAccessBlockConfiguration").build(), PayloadTrait.create()}).build();
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        GetPublicAccessBlockResponse other = (GetPublicAccessBlockResponse)((Object)obj);
        return Objects.equals(this.publicAccessBlockConfiguration(), other.publicAccessBlockConfiguration());
    }

    public final String toString() {
        return ToString.builder((String)"GetPublicAccessBlockResponse").add("PublicAccessBlockConfiguration", (Object)this.publicAccessBlockConfiguration()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<GetPublicAccessBlockResponse, T> g) {
        return obj -> g.apply((GetPublicAccessBlockResponse)((Object)((Object)obj)));
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, GetPublicAccessBlockResponse> {
