...
public final class DeleteBucketAnalyticsConfigurationResponse
extends S3Response
implements ToCopyableBuilder<Builder, DeleteBucketAnalyticsConfigurationResponse> {
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(new SdkField[0]));

    private DeleteBucketAnalyticsConfigurationResponse(BuilderImpl builder) {
        super(builder);
    }
    ...
    public final String toString() {
        return ToString.builder((String)"DeleteBucketAnalyticsConfigurationResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, DeleteBucketAnalyticsConfigurationResponse> {
    }
}
