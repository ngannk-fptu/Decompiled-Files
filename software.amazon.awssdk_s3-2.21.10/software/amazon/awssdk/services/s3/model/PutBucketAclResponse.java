...
public final class PutBucketAclResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutBucketAclResponse> {
    ...
    public final String toString() {
        return ToString.builder((String)"PutBucketAclResponse").build();
    }
    ...
    implements Builder {
        ...
        private BuilderImpl(PutBucketAclResponse model) {
            super(model);
        }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutBucketAclResponse> {
    }
}
