...
public final class PutBucketWebsiteRequest
extends S3Request
implements ToCopyableBuilder<Builder, PutBucketWebsiteRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("Bucket").getter(PutBucketWebsiteRequest.getter(PutBucketWebsiteRequest::bucket)).setter(PutBucketWebsiteRequest.setter(Builder::bucket)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PATH).locationName("Bucket").unmarshallLocationName("Bucket").build(), RequiredTrait.create()}).build();
    private static final SdkField<String> CONTENT_MD5_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("ContentMD5").getter(PutBucketWebsiteRequest.getter(PutBucketWebsiteRequest::contentMD5)).setter(PutBucketWebsiteRequest.setter(Builder::contentMD5)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("Content-MD5").unmarshallLocationName("Content-MD5").build()}).build();
    private static final SdkField<String> CHECKSUM_ALGORITHM_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("ChecksumAlgorithm").getter(PutBucketWebsiteRequest.getter(PutBucketWebsiteRequest::checksumAlgorithmAsString)).setter(PutBucketWebsiteRequest.setter(Builder::checksumAlgorithm)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-sdk-checksum-algorithm").unmarshallLocationName("x-amz-sdk-checksum-algorithm").build()}).build();
    private static final SdkField<WebsiteConfiguration> WEBSITE_CONFIGURATION_FIELD = SdkField.builder((MarshallingType)MarshallingType.SDK_POJO).memberName("WebsiteConfiguration").getter(PutBucketWebsiteRequest.getter(PutBucketWebsiteRequest::websiteConfiguration)).setter(PutBucketWebsiteRequest.setter(Builder::websiteConfiguration)).constructor(WebsiteConfiguration::builder).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("WebsiteConfiguration").unmarshallLocationName("WebsiteConfiguration").build(), PayloadTrait.create(), RequiredTrait.create()}).build();
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("ExpectedBucketOwner").getter(PutBucketWebsiteRequest.getter(PutBucketWebsiteRequest::expectedBucketOwner)).setter(PutBucketWebsiteRequest.setter(Builder::expectedBucketOwner)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-expected-bucket-owner").unmarshallLocationName("x-amz-expected-bucket-owner").build()}).build();
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUCKET_FIELD, CONTENT_MD5_FIELD, CHECKSUM_ALGORITHM_FIELD, WEBSITE_CONFIGURATION_FIELD, EXPECTED_BUCKET_OWNER_FIELD));
    ...
    public final int hashCode() {
        ...
        hashCode = 31 * hashCode + Objects.hashCode(this.websiteConfiguration());
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        PutBucketWebsiteRequest other = (PutBucketWebsiteRequest)((Object)obj);
        return Objects.equals(this.bucket(), other.bucket()) && Objects.equals(this.contentMD5(), other.contentMD5()) && Objects.equals(this.checksumAlgorithmAsString(), other.checksumAlgorithmAsString()) && Objects.equals(this.websiteConfiguration(), other.websiteConfiguration()) && Objects.equals(this.expectedBucketOwner(), other.expectedBucketOwner());
    }

    public final String toString() {
        return ToString.builder((String)"PutBucketWebsiteRequest").add("Bucket", (Object)this.bucket()).add("ContentMD5", (Object)this.contentMD5()).add("ChecksumAlgorithm", (Object)this.checksumAlgorithmAsString()).add("WebsiteConfiguration", (Object)this.websiteConfiguration()).add("ExpectedBucketOwner", (Object)this.expectedBucketOwner()).build();
    }
    ...
    public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
        switch (fieldName) {
            ...
            case "WebsiteConfiguration": {
                return Optional.ofNullable(clazz.cast(this.websiteConfiguration()));
            }
    ...
    private static <T> Function<Object, T> getter(Function<PutBucketWebsiteRequest, T> g) {
        return obj -> g.apply((PutBucketWebsiteRequest)((Object)((Object)obj)));
    }
    ...
    implements Builder {
        ...
        public final WebsiteConfiguration.Builder getWebsiteConfiguration() {
            return this.websiteConfiguration != null ? this.websiteConfiguration.toBuilder() : null;
        }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutBucketWebsiteRequest> {
        ...
        default public Builder websiteConfiguration(Consumer<WebsiteConfiguration.Builder> websiteConfiguration) {
            return this.websiteConfiguration((WebsiteConfiguration)((WebsiteConfiguration.Builder)WebsiteConfiguration.builder().applyMutation(websiteConfiguration)).build());
        }
