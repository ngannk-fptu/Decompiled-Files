...
implements ToCopyableBuilder<Builder, RestoreObjectResponse> {
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("RequestCharged").getter(RestoreObjectResponse.getter(RestoreObjectResponse::requestChargedAsString)).setter(RestoreObjectResponse.setter(Builder::requestCharged)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-request-charged").unmarshallLocationName("x-amz-request-charged").build()}).build();
    private static final SdkField<String> RESTORE_OUTPUT_PATH_FIELD = SdkField.builder((MarshallingType)MarshallingType.STRING).memberName("RestoreOutputPath").getter(RestoreObjectResponse.getter(RestoreObjectResponse::restoreOutputPath)).setter(RestoreObjectResponse.setter(Builder::restoreOutputPath)).traits(new Trait[]{LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-restore-output-path").unmarshallLocationName("x-amz-restore-output-path").build()}).build();
