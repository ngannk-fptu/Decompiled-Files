...
public final class PutBucketVersioningResponse
extends S3Response
implements ToCopyableBuilder<Builder, PutBucketVersioningResponse> {
    ...
    public final String toString() {
        return ToString.builder((String)"PutBucketVersioningResponse").build();
    }
    ...
    SdkPojo,
    CopyableBuilder<Builder, PutBucketVersioningResponse> {
    }
}
