...
@SdkInternalApi
public class S3ServiceClientConfigurationBuilder {
    ...
    implements BuilderInternal {
        ...
        public S3AuthSchemeProvider authSchemeProvider() {
            ...
            return (S3AuthSchemeProvider)Validate.isInstanceOf(S3AuthSchemeProvider.class, (Object)result, (String)("Expected an instance of " + S3AuthSchemeProvider.class.getSimpleName()), (Object[])new Object[0]);
        }
    ...
    extends S3ServiceClientConfiguration.Builder {
        public SdkClientConfiguration buildSdkClientConfiguration();
    }
}
