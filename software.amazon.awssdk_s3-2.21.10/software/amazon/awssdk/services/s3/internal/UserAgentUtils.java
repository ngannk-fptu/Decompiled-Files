...
public class UserAgentUtils {
    ...
    public static <T extends S3Request> T applyUserAgentInfo(T request, Consumer<AwsRequestOverrideConfiguration.Builder> userAgentApplier) {
    ...
    public static <T extends S3Request> T applyPaginatorUserAgent(T request) {
