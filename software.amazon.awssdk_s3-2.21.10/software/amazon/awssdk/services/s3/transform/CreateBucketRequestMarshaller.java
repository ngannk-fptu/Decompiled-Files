...
implements Marshaller<CreateBucketRequest> {
    ...
    public SdkHttpFullRequest marshall(CreateBucketRequest createBucketRequest) {
        Validate.paramNotNull((Object)((Object)createBucketRequest), (String)"createBucketRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)createBucketRequest);
        }
        catch (Exception e) {
