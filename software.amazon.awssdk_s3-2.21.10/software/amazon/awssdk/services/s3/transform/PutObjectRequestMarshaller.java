...
implements Marshaller<PutObjectRequest> {
    ...
    public PutObjectRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
    ...
    public SdkHttpFullRequest marshall(PutObjectRequest putObjectRequest) {
        ...
        try {
            ...
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)putObjectRequest);
        }
        catch (Exception e) {
