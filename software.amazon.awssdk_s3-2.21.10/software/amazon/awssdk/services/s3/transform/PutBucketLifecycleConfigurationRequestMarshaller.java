...
implements Marshaller<PutBucketLifecycleConfigurationRequest> {
    ...
    public PutBucketLifecycleConfigurationRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public SdkHttpFullRequest marshall(PutBucketLifecycleConfigurationRequest putBucketLifecycleConfigurationRequest) {
        Validate.paramNotNull((Object)((Object)putBucketLifecycleConfigurationRequest), (String)"putBucketLifecycleConfigurationRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)putBucketLifecycleConfigurationRequest);
        }
        catch (Exception e) {
