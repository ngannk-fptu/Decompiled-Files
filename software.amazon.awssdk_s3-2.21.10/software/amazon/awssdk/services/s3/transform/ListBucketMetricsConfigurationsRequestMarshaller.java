...
implements Marshaller<ListBucketMetricsConfigurationsRequest> {
    ...
    public SdkHttpFullRequest marshall(ListBucketMetricsConfigurationsRequest listBucketMetricsConfigurationsRequest) {
        Validate.paramNotNull((Object)((Object)listBucketMetricsConfigurationsRequest), (String)"listBucketMetricsConfigurationsRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)listBucketMetricsConfigurationsRequest);
        }
        catch (Exception e) {
