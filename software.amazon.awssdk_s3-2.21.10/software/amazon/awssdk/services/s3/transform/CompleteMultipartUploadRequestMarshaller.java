...
implements Marshaller<CompleteMultipartUploadRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Key+}").httpMethod(SdkHttpMethod.POST).hasExplicitPayloadMember(true).hasPayloadMembers(true).putAdditionalMetadata(AwsXmlProtocolFactory.ROOT_MARSHALL_LOCATION_ATTRIBUTE, null).putAdditionalMetadata(AwsXmlProtocolFactory.XML_NAMESPACE_ATTRIBUTE, (Object)"http://s3.amazonaws.com/doc/2006-03-01/").build();
    ...
    public SdkHttpFullRequest marshall(CompleteMultipartUploadRequest completeMultipartUploadRequest) {
        ...
        try {
            ...
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)completeMultipartUploadRequest);
        }
        catch (Exception e) {
