...
implements Marshaller<PutBucketLoggingRequest> {
    ...
    public SdkHttpFullRequest marshall(PutBucketLoggingRequest putBucketLoggingRequest) {
        Validate.paramNotNull((Object)((Object)putBucketLoggingRequest), (String)"putBucketLoggingRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)putBucketLoggingRequest);
        }
        catch (Exception e) {
