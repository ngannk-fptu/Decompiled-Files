...
@SdkInternalApi
public class DeleteBucketOwnershipControlsRequestMarshaller
implements Marshaller<DeleteBucketOwnershipControlsRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("?ownershipControls").httpMethod(SdkHttpMethod.DELETE).hasExplicitPayloadMember(false).hasPayloadMembers(false).putAdditionalMetadata(AwsXmlProtocolFactory.ROOT_MARSHALL_LOCATION_ATTRIBUTE, null).putAdditionalMetadata(AwsXmlProtocolFactory.XML_NAMESPACE_ATTRIBUTE, null).build();
    ...
    public SdkHttpFullRequest marshall(DeleteBucketOwnershipControlsRequest deleteBucketOwnershipControlsRequest) {
        Validate.paramNotNull((Object)((Object)deleteBucketOwnershipControlsRequest), (String)"deleteBucketOwnershipControlsRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)deleteBucketOwnershipControlsRequest);
        }
        catch (Exception e) {
