...
implements Marshaller<GetBucketIntelligentTieringConfigurationRequest> {
    ...
    public SdkHttpFullRequest marshall(GetBucketIntelligentTieringConfigurationRequest getBucketIntelligentTieringConfigurationRequest) {
        Validate.paramNotNull((Object)((Object)getBucketIntelligentTieringConfigurationRequest), (String)"getBucketIntelligentTieringConfigurationRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)getBucketIntelligentTieringConfigurationRequest);
        }
        catch (Exception e) {
