...
implements Marshaller<PutObjectRetentionRequest> {
    ...
    public SdkHttpFullRequest marshall(PutObjectRetentionRequest putObjectRetentionRequest) {
        Validate.paramNotNull((Object)((Object)putObjectRetentionRequest), (String)"putObjectRetentionRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)putObjectRetentionRequest);
        }
        catch (Exception e) {
