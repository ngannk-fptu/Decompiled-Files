...
implements Marshaller<UploadPartCopyRequest> {
    ...
    public UploadPartCopyRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public SdkHttpFullRequest marshall(UploadPartCopyRequest uploadPartCopyRequest) {
        Validate.paramNotNull((Object)((Object)uploadPartCopyRequest), (String)"uploadPartCopyRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)uploadPartCopyRequest);
        }
        catch (Exception e) {
