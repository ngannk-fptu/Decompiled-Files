...
implements Marshaller<PutBucketIntelligentTieringConfigurationRequest> {
    ...
    public SdkHttpFullRequest marshall(PutBucketIntelligentTieringConfigurationRequest putBucketIntelligentTieringConfigurationRequest) {
        Validate.paramNotNull((Object)((Object)putBucketIntelligentTieringConfigurationRequest), (String)"putBucketIntelligentTieringConfigurationRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)putBucketIntelligentTieringConfigurationRequest);
        }
        catch (Exception e) {
