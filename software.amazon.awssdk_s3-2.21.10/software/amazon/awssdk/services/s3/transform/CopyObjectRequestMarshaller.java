...
implements Marshaller<CopyObjectRequest> {
    ...
    public SdkHttpFullRequest marshall(CopyObjectRequest copyObjectRequest) {
        Validate.paramNotNull((Object)((Object)copyObjectRequest), (String)"copyObjectRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)copyObjectRequest);
        }
        catch (Exception e) {
