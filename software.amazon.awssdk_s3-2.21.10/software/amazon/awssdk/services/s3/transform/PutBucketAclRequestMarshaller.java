...
implements Marshaller<PutBucketAclRequest> {
    ...
    public PutBucketAclRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public SdkHttpFullRequest marshall(PutBucketAclRequest putBucketAclRequest) {
        Validate.paramNotNull((Object)((Object)putBucketAclRequest), (String)"putBucketAclRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)putBucketAclRequest);
        }
        catch (Exception e) {
