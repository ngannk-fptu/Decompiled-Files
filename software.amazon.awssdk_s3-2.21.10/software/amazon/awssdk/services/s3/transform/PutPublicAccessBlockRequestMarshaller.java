...
implements Marshaller<PutPublicAccessBlockRequest> {
    ...
    public PutPublicAccessBlockRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public SdkHttpFullRequest marshall(PutPublicAccessBlockRequest putPublicAccessBlockRequest) {
        Validate.paramNotNull((Object)((Object)putPublicAccessBlockRequest), (String)"putPublicAccessBlockRequest");
        try {
            ProtocolMarshaller protocolMarshaller = this.protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING);
            return (SdkHttpFullRequest)protocolMarshaller.marshall((SdkPojo)putPublicAccessBlockRequest);
        }
        catch (Exception e) {
