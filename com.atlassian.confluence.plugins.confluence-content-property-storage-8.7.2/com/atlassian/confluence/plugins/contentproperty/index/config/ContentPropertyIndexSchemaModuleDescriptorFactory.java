...
@Component
public class ContentPropertyIndexSchemaModuleDescriptorFactory
extends SingleModuleDescriptorFactory<ContentPropertyIndexSchemaModuleDescriptor> {
    @Autowired
    public ContentPropertyIndexSchemaModuleDescriptorFactory(HostContainer hostContainer) {
        super(hostContainer, "content-property-index-schema", ContentPropertyIndexSchemaModuleDescriptor.class);
    }
}
