...
implements XmlPullParser {
    ...
    public String nextText() throws XmlPullParserException, IOException {
        ...
        if (eventType == 4) {
            ...
            eventType = this.next();
            if (eventType != 3) {
                throw new XmlPullParserException("TEXT must be immediately followed by END_TAG and not " + TYPES[this.getEventType()], this, null);
            }
            return result;
        }
        if (eventType == 3) {
    ...
    public int nextTag() throws XmlPullParserException, IOException {
        ...
        if (this.eventType != 2 && this.eventType != 3) {
            throw new XmlPullParserException("expected START_TAG or END_TAG not " + TYPES[this.getEventType()], this, null);
        }
        return this.eventType;
    }
    ...
    private char[] parseEntityRef() throws XmlPullParserException, IOException {
        ...
        if (ch == '#') {
            ...
            if (noUnicode4) {
                ...
                if (i > 65535) {
                    throw new XmlPullParserException("Unicode character reference (with " + (isHex ? "hex" : "decimal") + " value " + sb.toString() + ") is not supported in this runtime", this, null);
                }
