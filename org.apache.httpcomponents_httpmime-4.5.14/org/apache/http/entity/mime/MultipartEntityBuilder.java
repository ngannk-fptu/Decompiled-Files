...
public class MultipartEntityBuilder {
    ...
    MultipartFormEntity buildEntity() {
        ...
        ContentType contentTypeCopy = this.contentType != null ? this.contentType.withParameters(params) : ContentType.create((String)"multipart/form-data", (NameValuePair[])params);
