...
implements DebuggingParser {
    ...
    protected void setupDebugging(TokenStream tokenStream, TokenBuffer tokenBuffer) {
        ...
        try {
            ...
            Class clazz = Utils.loadClass("antlr.parseview.ParseView");
            Constructor constructor = clazz.getConstructor(class$antlr$debug$LLkDebuggingParser == null ? (class$antlr$debug$LLkDebuggingParser = LLkDebuggingParser.class$("antlr.debug.LLkDebuggingParser")) : class$antlr$debug$LLkDebuggingParser, class$antlr$TokenStream == null ? (class$antlr$TokenStream = LLkDebuggingParser.class$("antlr.TokenStream")) : class$antlr$TokenStream, class$antlr$TokenBuffer == null ? (class$antlr$TokenBuffer = LLkDebuggingParser.class$("antlr.TokenBuffer")) : class$antlr$TokenBuffer);
