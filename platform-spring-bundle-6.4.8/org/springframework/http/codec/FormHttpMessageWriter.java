...
implements HttpMessageWriter<MultiValueMap<String, String>> {
    ...
    private void logFormData(MultiValueMap<String, String> form, Map<String, Object> hints) {
        LogFormatUtils.traceDebug(this.logger, traceOn -> Hints.getLogPrefix(hints) + "Writing " + (this.isEnableLoggingRequestDetails() ? LogFormatUtils.formatValue(form, traceOn == false) : "form fields " + form.keySet() + " (content masked)"));
    }
