...
DisposableBean {
    ...
    public void setShutdownQuietPeriod(Duration shutdownQuietPeriod) {
        Assert.notNull((Object)shutdownQuietPeriod, "shutdownQuietPeriod should not be null");
        this.shutdownQuietPeriod = shutdownQuietPeriod;
    }

    public void setShutdownTimeout(Duration shutdownTimeout) {
        Assert.notNull((Object)shutdownTimeout, "shutdownTimeout should not be null");
    ...
    public void destroy() {
        if (this.useGlobalResources) {
            ...
            try {
                LoopResources resources2 = this.loopResources;
                if (resources2 != null && this.manageLoopResources) {
                    resources2.disposeLater(this.shutdownQuietPeriod, this.shutdownTimeout).block();
                }
            }
