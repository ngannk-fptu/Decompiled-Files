...
extends HttpEntity<T> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return ObjectUtils.nullSafeEquals((Object)this.method, (Object)otherEntity.method) && ObjectUtils.nullSafeEquals(this.url, otherEntity.url);
    }
    ...
    extends RequestEntity<T> {
        ...
        UriTemplateRequestEntity(@Nullable T body2, @Nullable MultiValueMap<String, String> headers, @Nullable HttpMethod method, @Nullable Type type, String uriTemplate, @Nullable Object[] uriVarsArray, @Nullable Map<String, ?> uriVarsMap) {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return ObjectUtils.nullSafeEquals(this.uriTemplate, otherEntity.uriTemplate) && ObjectUtils.nullSafeEquals(this.uriVarsArray, otherEntity.uriVarsArray) && ObjectUtils.nullSafeEquals(this.uriVarsMap, otherEntity.uriVarsMap);
        }
