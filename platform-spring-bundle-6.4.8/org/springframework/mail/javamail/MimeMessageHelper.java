...
public class MimeMessageHelper {
    ...
    public void setFrom(InternetAddress from) throws MessagingException {
        Assert.notNull((Object)from, "From address must not be null");
    ...
    public void setReplyTo(InternetAddress replyTo) throws MessagingException {
        Assert.notNull((Object)replyTo, "Reply-to address must not be null");
    ...
    public void setTo(InternetAddress to) throws MessagingException {
        Assert.notNull((Object)to, "To address must not be null");
        this.validateAddress(to);
        this.mimeMessage.setRecipient(Message.RecipientType.TO, (Address)to);
    }

    public void setTo(InternetAddress[] to) throws MessagingException {
        Assert.notNull((Object)to, "To address array must not be null");
    ...
    public void setTo(String[] to) throws MessagingException {
        ...
        for (int i2 = 0; i2 < to.length; ++i2) {
            addresses[i2] = this.parseAddress(to[i2]);
        }
    ...
    public void setCc(InternetAddress cc) throws MessagingException {
        Assert.notNull((Object)cc, "Cc address must not be null");
        this.validateAddress(cc);
        this.mimeMessage.setRecipient(Message.RecipientType.CC, (Address)cc);
    }

    public void setCc(InternetAddress[] cc) throws MessagingException {
        Assert.notNull((Object)cc, "Cc address array must not be null");
    ...
    public void setCc(String[] cc) throws MessagingException {
        ...
        for (int i2 = 0; i2 < cc.length; ++i2) {
            addresses[i2] = this.parseAddress(cc[i2]);
        }
    ...
    public void setBcc(InternetAddress bcc) throws MessagingException {
        Assert.notNull((Object)bcc, "Bcc address must not be null");
        this.validateAddress(bcc);
        this.mimeMessage.setRecipient(Message.RecipientType.BCC, (Address)bcc);
    }

    public void setBcc(InternetAddress[] bcc) throws MessagingException {
        Assert.notNull((Object)bcc, "Bcc address array must not be null");
    ...
    public void setBcc(String[] bcc) throws MessagingException {
        ...
        for (int i2 = 0; i2 < bcc.length; ++i2) {
            addresses[i2] = this.parseAddress(bcc[i2]);
        }
    ...
    public void setSentDate(Date sentDate) throws MessagingException {
        Assert.notNull((Object)sentDate, "Sent date must not be null");
        this.mimeMessage.setSentDate(sentDate);
    }

    public void setSubject(String subject) throws MessagingException {
        Assert.notNull((Object)subject, "Subject must not be null");
    ...
    public void setText(String plainText, String htmlText) throws MessagingException {
        Assert.notNull((Object)plainText, "Plain text must not be null");
        Assert.notNull((Object)htmlText, "HTML text must not be null");
    ...
    private MimeBodyPart getMainPart() throws MessagingException {
        ...
        for (int i2 = 0; i2 < mimeMultipart.getCount(); ++i2) {
            BodyPart bp = mimeMultipart.getBodyPart(i2);
    ...
    public void addInline(String contentId, DataSource dataSource) throws MessagingException {
        Assert.notNull((Object)contentId, "Content ID must not be null");
    ...
    public void addAttachment(String attachmentFilename, DataSource dataSource) throws MessagingException {
        Assert.notNull((Object)attachmentFilename, "Attachment filename must not be null");
        Assert.notNull((Object)dataSource, "DataSource must not be null");
        try {
            MimeBodyPart mimeBodyPart = new MimeBodyPart();
