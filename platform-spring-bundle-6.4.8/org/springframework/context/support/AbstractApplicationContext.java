...
implements ConfigurableApplicationContext {
    ...
    public void setApplicationStartup(ApplicationStartup applicationStartup) {
        Assert.notNull((Object)applicationStartup, "ApplicationStartup must not be null");
        ...
        synchronized (object) {
            ...
            try {
                ...
                if (this.logger.isWarnEnabled()) {
                    this.logger.warn((Object)("Exception encountered during context initialization - cancelling refresh attempt: " + ex));
                }
                this.destroyBeans();
