...
implements BeanDefinitionParser {
    ...
    private void parseAspect(Element aspectElement, ParserContext parserContext) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < declareParents.size(); ++i2) {
                Element declareParentsElement = declareParents.get(i2);
            ...
            for (int i3 = 0; i3 < nodeList.getLength(); ++i3) {
                ...
                AbstractBeanDefinition advisorDefinition = this.parseAdvice(aspectName, i3, aspectElement, (Element)node, parserContext, beanDefinitions, beanReferences);
