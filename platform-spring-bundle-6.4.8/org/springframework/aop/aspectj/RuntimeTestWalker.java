...
class RuntimeTestWalker {
    ...
    extends TestVisitorAdapter {
        ...
        @Override
        public void visit(Instanceof i2) {
            ReflectionVar v = (ReflectionVar)i2.getVar();
    ...
    extends TestVisitorAdapter {
        ...
        public void visit(Instanceof i2) {
            ...
            int varType = this.getVarType((ReflectionVar)i2.getVar());
            if (varType != this.matchVarType) {
                return;
            }
            Class typeClass = null;
            ResolvedType type = (ResolvedType)i2.getType();
