        ...
        if (value instanceof Collection || value instanceof Object[] && !(value instanceof Resource[])) {
            ...
            for (Object e : input) {
                if (e instanceof String) {
                    ...
                    try {
                        Resource[] resources2 = this.resourcePatternResolver.getResources(pattern);
                        Collections.addAll(merged, resources2);
                    }
                    catch (IOException ex) {
                        if (!logger.isDebugEnabled()) continue;
                        logger.debug((Object)("Could not retrieve resources for pattern '" + pattern + "'"), (Throwable)ex);
                    }
                    continue;
                }
