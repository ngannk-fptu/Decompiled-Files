...
implements ConfigurableEnvironment {
    ...
    public void setActiveProfiles(String ... profiles) {
        ...
        if (this.logger.isDebugEnabled()) {
            this.logger.debug((Object)("Activating profiles " + Arrays.toString(profiles)));
        }
        Set<String> set = this.activeProfiles;
        synchronized (set) {
    ...
    public void addActiveProfile(String profile2) {
        if (this.logger.isDebugEnabled()) {
            this.logger.debug((Object)("Activating profile '" + profile2 + "'"));
        }
        this.validateProfile(profile2);
                ...
                protected String getSystemAttribute(String attributeName) {
                    try {
                        ...
                        if (AbstractEnvironment.this.logger.isInfoEnabled()) {
                            AbstractEnvironment.this.logger.info((Object)("Caught AccessControlException when accessing system property '" + attributeName + "'; its value will be returned [null]. Reason: " + ex.getMessage()));
                        }
                        return null;
                    }
                }
            ...
            return new ReadOnlySystemAttributesMap(){
                ...
                protected String getSystemAttribute(String attributeName) {
                    try {
                        ...
                        if (AbstractEnvironment.this.logger.isInfoEnabled()) {
                            AbstractEnvironment.this.logger.info((Object)("Caught AccessControlException when accessing system environment variable '" + attributeName + "'; its value will be returned [null]. Reason: " + ex.getMessage()));
                        }
                        return null;
                    }
                }
