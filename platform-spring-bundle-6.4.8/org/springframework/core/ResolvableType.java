...
implements Serializable {
        ...
        if (checkGenerics) {
            ...
            if (ourGenerics.length > 0) {
                ...
                for (int i2 = 0; i2 < ourGenerics.length; ++i2) {
                    if (ourGenerics[i2].isAssignableFrom(typeGenerics[i2], matchedBefore)) continue;
                    return false;
                }
            }
        }
    ...
    public ResolvableType[] getInterfaces() {
        ...
        if (interfaces == null) {
            ...
            for (int i2 = 0; i2 < genericIfcs.length; ++i2) {
                interfaces[i2] = ResolvableType.forType(genericIfcs[i2], this);
            }
        ...
        if (resolved != null) {
            ...
            try {
                for (Type genericInterface : resolved.getGenericInterfaces()) {
                    if (!(genericInterface instanceof Class) || ((Class)genericInterface).getTypeParameters().length <= 0) continue;
                    return true;
                }
            }
            ...
            if ((superclass = resolved.getSuperclass()) != null && superclass != Object.class) {
    ...
    public ResolvableType getNested(int nestingLevel, @Nullable Map<Integer, Integer> typeIndexesPerLevel) {
        ...
        for (int i2 = 2; i2 <= nestingLevel; ++i2) {
            ...
            Integer index = typeIndexesPerLevel != null ? typeIndexesPerLevel.get(i2) : null;
    ...
    public static ResolvableType forClassWithGenerics(Class<?> clazz, ResolvableType ... generics) {
        ...
        for (int i2 = 0; i2 < generics.length; ++i2) {
            ResolvableType generic = generics[i2];
    ...
    private static class WildcardBounds {
        ...
        public static WildcardBounds get(ResolvableType type) {
            ...
            for (int i2 = 0; i2 < bounds.length; ++i2) {
                resolvableBounds[i2] = ResolvableType.forType(bounds[i2], type.variableResolver);
            }
