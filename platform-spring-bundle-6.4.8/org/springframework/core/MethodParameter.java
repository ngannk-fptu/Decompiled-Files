...
public class MethodParameter {
    ...
    public Class<?> getNestedParameterType() {
        if (this.nestingLevel > 1) {
            ...
            for (int i2 = 2; i2 <= this.nestingLevel; ++i2) {
                ...
                Integer index = this.getTypeIndexForLevel(i2);
    ...
    protected static int findParameterIndex(Parameter parameter) {
        ...
        for (i2 = 0; i2 < allParams.length; ++i2) {
            if (parameter != allParams[i2]) continue;
            return i2;
        }
        for (i2 = 0; i2 < allParams.length; ++i2) {
            if (!parameter.equals(allParams[i2])) continue;
            return i2;
        }
        ...
        public static boolean isOptional(MethodParameter param) {
            ...
            if (function != null) {
                ...
                for (KParameter kParameter : function.getParameters()) {
                    if (!predicate.test(kParameter) || index != i2++) continue;
