    ...
    protected Class<?> resolveProxyClass(String[] interfaces) throws IOException, ClassNotFoundException {
        ...
        if (this.classLoader != null) {
            ...
            for (int i2 = 0; i2 < interfaces.length; ++i2) {
                try {
                    resolvedInterfaces[i2] = ClassUtils.forName(interfaces[i2], this.classLoader);
                    continue;
                }
                catch (ClassNotFoundException ex) {
                    resolvedInterfaces[i2] = this.resolveFallbackIfPossible(interfaces[i2], ex);
                }
            }
            try {
        ...
        try {
            ...
            for (int i3 = 0; i3 < interfaces.length; ++i3) {
                resolvedInterfaces[i3] = this.resolveFallbackIfPossible(interfaces[i3], ex);
            }
