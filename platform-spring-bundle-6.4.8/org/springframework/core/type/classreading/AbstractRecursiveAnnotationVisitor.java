...
extends AnnotationVisitor {
    ...
    protected Object getEnumValue(String asmTypeDescriptor, String attributeValue) {
        ...
        try {
            ...
            this.logger.debug((Object)"Failed to classload enum type while reading annotation metadata", ex);
        }
        catch (IllegalAccessException | AccessControlException ex) {
            this.logger.debug((Object)"Could not access enum value while reading annotation metadata", (Throwable)ex);
        }
        return valueToUse;
    }
}
