    ...
    public static <T> Map<Method, T> selectMethods(Class<?> targetType, MetadataLookup<T> metadataLookup) {
        ...
        for (Class clazz : handlerTypes) {
            ...
            ReflectionUtils.doWithMethods(clazz, method -> {
                ...
                if (result != null && ((bridgedMethod = BridgeMethodResolver.findBridgedMethod(specificMethod)) == specificMethod || bridgedMethod == method || metadataLookup.inspect(bridgedMethod) == null)) {
