...
public final class BridgeMethodResolver {
    ...
    public static Method findBridgedMethod(Method bridgeMethod) {
        ...
        if (bridgedMethod == null) {
            ...
            ReflectionUtils.MethodFilter filter2 = candidateMethod -> BridgeMethodResolver.isBridgedCandidateFor(candidateMethod, bridgeMethod);
            ReflectionUtils.doWithMethods(bridgeMethod.getDeclaringClass(), candidateMethods::add, filter2);
    ...
    private static boolean isResolvedTypeMatch(Method genericMethod, Method candidateMethod, Class<?> declaringClass) {
        ...
        for (int i2 = 0; i2 < candidateParameters.length; ++i2) {
            ResolvableType genericParameter = ResolvableType.forMethodParameter(genericMethod, i2, declaringClass);
            Class<?> candidateParameter = candidateParameters[i2];
