...
EnvironmentCapable {
    ...
    @Override
    public int loadBeanDefinitions(Resource ... resources2) throws BeanDefinitionStoreException {
        Assert.notNull((Object)resources2, "Resource array must not be null");
        int count = 0;
    ...
    public int loadBeanDefinitions(String location, @Nullable Set<Resource> actualResources) throws BeanDefinitionStoreException {
        ...
        if (resourceLoader instanceof ResourcePatternResolver) {
            try {
                Resource[] resources2 = ((ResourcePatternResolver)resourceLoader).getResources(location);
                int count = this.loadBeanDefinitions(resources2);
                if (actualResources != null) {
                    Collections.addAll(actualResources, resources2);
                }
