...
Serializable {
    ...
    public DisposableBeanAdapter(Object bean2, String beanName, RootBeanDefinition beanDefinition, List<DestructionAwareBeanPostProcessor> postProcessors, @Nullable AccessControlContext acc) {
        ...
        if (!(destroyMethodName == null || this.invokeDisposableBean && DESTROY_METHOD_NAME.equals(destroyMethodName) || beanDefinition.hasAnyExternallyManagedDestroyMethod(destroyMethodName))) {
            boolean bl = this.invokeAutoCloseable = bean2 instanceof AutoCloseable && CLOSE_METHOD_NAME.equals(destroyMethodName);
    ...
    public DisposableBeanAdapter(Object bean2, List<DestructionAwareBeanPostProcessor> postProcessors, AccessControlContext acc) {
        Assert.notNull(bean2, "Disposable bean must not be null");
        this.bean = bean2;
    ...
    private DisposableBeanAdapter(Object bean2, String beanName, boolean nonPublicAccessAllowed, boolean invokeDisposableBean, boolean invokeAutoCloseable, @Nullable String destroyMethodName, @Nullable List<DestructionAwareBeanPostProcessor> postProcessors) {
        this.bean = bean2;
        this.beanName = beanName;
    ...
    public static boolean hasDestroyMethod(Object bean2, RootBeanDefinition beanDefinition) {
        return bean2 instanceof DisposableBean || DisposableBeanAdapter.inferDestroyMethodIfNecessary(bean2, beanDefinition) != null;
    }
    ...
    private static String inferDestroyMethodIfNecessary(Object bean2, RootBeanDefinition beanDefinition) {
        ...
        if (destroyMethodName == null) {
            ...
            boolean autoCloseable = bean2 instanceof AutoCloseable;
