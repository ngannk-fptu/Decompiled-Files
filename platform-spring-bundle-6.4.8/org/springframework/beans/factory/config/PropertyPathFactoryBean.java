...
BeanFactoryAware {
    ...
    public void setBeanFactory(BeanFactory beanFactory) {
        ...
        if (this.targetBeanWrapper == null && this.beanFactory.isSingleton(this.targetBeanName)) {
            Object bean2 = this.beanFactory.getBean(this.targetBeanName);
            this.targetBeanWrapper = PropertyAccessorFactory.forBeanPropertyAccess(bean2);
    ...
    public Object getObject() throws BeansException {
        ...
        if (target != null) {
            ...
            Object bean2 = this.beanFactory.getBean(this.targetBeanName);
            target = PropertyAccessorFactory.forBeanPropertyAccess(bean2);
        }
