...
implements GroovyObject {
    ...
    public int loadBeanDefinitions(EncodedResource encodedResource) throws BeanDefinitionStoreException {
        ...
        binding.setVariable("beans", (Object)beans2);
    ...
    protected List<Object> resolveConstructorArguments(Object[] args, int start, int end) {
        ...
        for (int i2 = 0; i2 < constructorArgs.length; ++i2) {
            ...
            if (constructorArgs[i2] instanceof List) {
                constructorArgs[i2] = this.manageListIfNecessary((List)constructorArgs[i2]);
                continue;
            }
            if (!(constructorArgs[i2] instanceof Map)) continue;
            constructorArgs[i2] = this.manageMapIfNecessary((Map)constructorArgs[i2]);
        }
