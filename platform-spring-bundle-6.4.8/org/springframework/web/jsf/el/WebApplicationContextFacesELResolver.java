        ...
        if (base != null) {
            if (base instanceof WebApplicationContext) {
                ...
                if (this.logger.isTraceEnabled()) {
                    this.logger.trace((Object)("Attempting to resolve property '" + beanName + "' in root WebApplicationContext"));
                }
                if (wac.containsBean(beanName)) {
                    if (this.logger.isDebugEnabled()) {
                        this.logger.debug((Object)("Successfully resolved property '" + beanName + "' in root WebApplicationContext"));
                    }
    ...
    public Class<?> getType(ELContext elContext, @Nullable Object base, Object property) throws ELException {
        if (base != null) {
            if (base instanceof WebApplicationContext) {
                ...
                String beanName = property.toString();
                if (this.logger.isDebugEnabled()) {
                    this.logger.debug((Object)("Attempting to resolve property '" + beanName + "' in root WebApplicationContext"));
                }
                if (wac.containsBean(beanName)) {
                    if (this.logger.isDebugEnabled()) {
                        this.logger.debug((Object)("Successfully resolved property '" + beanName + "' in root WebApplicationContext"));
