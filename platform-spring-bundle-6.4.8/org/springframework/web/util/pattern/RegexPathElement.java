...
extends PathElement {
    ...
    public Pattern buildPattern(char[] regex, char[] completePattern) {
        ...
        return Pattern.compile(patternBuilder.toString(), 0x20 | (this.caseSensitive ? 0 : 2));
    }
    ...
    public boolean matches(int pathIndex, PathPattern.MatchingContext matchingContext) {
        ...
        if (matches && matchingContext.extractingVariables) {
            ...
            for (int i2 = 1; i2 <= matcher.groupCount(); ++i2) {
                ...
                matchingContext.set(name, value, i2 == this.variableNames.size() ? ((PathContainer.PathSegment)matchingContext.pathElements.get(pathIndex)).parameters() : NO_PARAMETERS);
            }
        }
        return matches;
    }
