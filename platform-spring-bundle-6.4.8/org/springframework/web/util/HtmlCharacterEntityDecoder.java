...
class HtmlCharacterEntityDecoder {
    ...
    private void findNextPotentialReference(int startPosition) {
        ...
        do {
            ...
            boolean bl = isPotentialReference = this.nextPotentialReferencePosition != -1 && this.nextSemicolonPosition != -1 && this.nextSemicolonPosition - this.nextPotentialReferencePosition < 10;
