...
public abstract class WebUtils {
    ...
    public static boolean isSameOrigin(HttpRequest request) {
        ...
        return ObjectUtils.nullSafeEquals(scheme, originUrl.getScheme()) && ObjectUtils.nullSafeEquals(host, originUrl.getHost()) && WebUtils.getPort(scheme, port) == WebUtils.getPort(originUrl.getScheme(), originUrl.getPort());
    }
