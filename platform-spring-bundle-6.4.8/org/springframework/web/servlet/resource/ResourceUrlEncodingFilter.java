    ...
    extends HttpServletRequestWrapper {
        ...
        private void initLookupPath(ResourceUrlProvider urlProvider) {
            ...
            if (this.indexLookupPath == null) {
                ...
                if (StringUtils.matchesCharacter(lookupPath, '/') && !StringUtils.matchesCharacter(requestUri, '/') && requestUri.equals(contextPath = pathHelper.getContextPath((HttpServletRequest)this))) {
