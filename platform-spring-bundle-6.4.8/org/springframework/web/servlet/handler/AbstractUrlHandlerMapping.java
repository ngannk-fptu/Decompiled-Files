...
implements MatchableHandlerMapping {
    ...
    protected Object lookupHandler(String lookupPath, HttpServletRequest request) throws Exception {
        ...
        if (bestMatch != null) {
            ...
            for (String matchingPattern : matchingPatterns) {
                ...
                Map<String, String> vars = this.getPathMatcher().extractUriTemplateVariables(matchingPattern, lookupPath);
    ...
    public RequestMatchResult match(HttpServletRequest request, String pattern) {
        Assert.isNull((Object)this.getPatternParser(), "This HandlerMapping uses PathPatterns.");
