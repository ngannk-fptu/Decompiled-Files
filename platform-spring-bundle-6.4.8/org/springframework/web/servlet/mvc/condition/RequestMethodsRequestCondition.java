...
extends AbstractRequestCondition<RequestMethodsRequestCondition> {
    ...
    private RequestMethodsRequestCondition matchRequestMethod(String httpMethodValue) {
        try {
            ...
            if (requestMethod.equals((Object)RequestMethod.HEAD) && this.getMethods().contains((Object)RequestMethod.GET)) {
    ...
    public int compareTo(RequestMethodsRequestCondition other, HttpServletRequest request) {
        ...
        if (this.methods.size() == 1) {
            if (this.methods.contains((Object)RequestMethod.HEAD) && other.methods.contains((Object)RequestMethod.GET)) {
                return -1;
            }
            if (this.methods.contains((Object)RequestMethod.GET) && other.methods.contains((Object)RequestMethod.HEAD)) {
                return 1;
            }
        }
        return 0;
