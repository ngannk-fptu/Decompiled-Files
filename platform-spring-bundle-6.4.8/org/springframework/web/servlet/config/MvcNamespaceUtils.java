...
public abstract class MvcNamespaceUtils {
    ...
    private static void registerLocaleResolver(ParserContext context, @Nullable Object source) {
        if (!MvcNamespaceUtils.containsBeanInHierarchy(context, "localeResolver")) {
            ...
            beanDef.setSource(source);
            beanDef.setRole(2);
            context.getRegistry().registerBeanDefinition("localeResolver", beanDef);
            context.registerComponent(new BeanComponentDefinition(beanDef, "localeResolver"));
        }
    }
    ...
    private static void registerThemeResolver(ParserContext context, @Nullable Object source) {
        if (!MvcNamespaceUtils.containsBeanInHierarchy(context, "themeResolver")) {
            ...
            beanDef.setSource(source);
            beanDef.setRole(2);
            context.getRegistry().registerBeanDefinition("themeResolver", beanDef);
            context.registerComponent(new BeanComponentDefinition(beanDef, "themeResolver"));
        }
    }
    ...
    private static void registerViewNameTranslator(ParserContext context, @Nullable Object source) {
        if (!MvcNamespaceUtils.containsBeanInHierarchy(context, "viewNameTranslator")) {
            ...
            beanDef.setSource(source);
            beanDef.setRole(2);
            context.getRegistry().registerBeanDefinition("viewNameTranslator", beanDef);
            context.registerComponent(new BeanComponentDefinition(beanDef, "viewNameTranslator"));
        }
    }
    ...
    private static void registerFlashMapManager(ParserContext context, @Nullable Object source) {
        if (!MvcNamespaceUtils.containsBeanInHierarchy(context, "flashMapManager")) {
            ...
            beanDef.setSource(source);
            beanDef.setRole(2);
            context.getRegistry().registerBeanDefinition("flashMapManager", beanDef);
            context.registerComponent(new BeanComponentDefinition(beanDef, "flashMapManager"));
        }
    }
    ...
    private static boolean containsBeanInHierarchy(ParserContext context, String beanName) {
        ...
        return registry instanceof BeanFactory ? ((BeanFactory)((Object)registry)).containsBean(beanName) : registry.containsBeanDefinition(beanName);
    }
}
