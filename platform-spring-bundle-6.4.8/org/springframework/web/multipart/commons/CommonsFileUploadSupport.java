...
public abstract class CommonsFileUploadSupport {
    ...
    protected MultipartParsingResult parseFileItems(List<FileItem> fileItems, String encoding) {
        ...
        for (FileItem fileItem : fileItems) {
            ...
            LogFormatUtils.traceDebug(this.logger, traceOn -> "Part '" + file.getName() + "', size " + file.getSize() + " bytes, filename='" + file.getOriginalFilename() + "'" + (traceOn != false ? ", storage=" + file.getStorageDescription() : ""));
        }
    ...
    protected void cleanupFileItems(MultiValueMap<String, MultipartFile> multipartFiles) {
        for (List files : multipartFiles.values()) {
            for (MultipartFile file : files) {
                ...
                LogFormatUtils.traceDebug(this.logger, traceOn -> "Cleaning up part '" + cmf.getName() + "', filename '" + cmf.getOriginalFilename() + "'" + (traceOn != false ? ", stored " + cmf.getStorageDescription() : ""));
            }
        }
    }
