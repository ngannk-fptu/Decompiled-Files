...
public class MethodInvoker {
    ...
    public void prepare() throws ClassNotFoundException, NoSuchMethodException {
        block6: {
            ...
            for (int i2 = 0; i2 < arguments.length; ++i2) {
                argTypes[i2] = arguments[i2] != null ? arguments[i2].getClass() : Object.class;
            }
            try {
                ...
                if (this.methodObject != null) break block6;
                throw ex;
            }
        }
    }
    ...
    public static int getTypeDifferenceWeight(Class<?>[] paramTypes, Object[] args) {
        ...
        for (int i2 = 0; i2 < paramTypes.length; ++i2) {
            if (!ClassUtils.isAssignableValue(paramTypes[i2], args[i2])) {
                return Integer.MAX_VALUE;
            }
            if (args[i2] == null) continue;
            Class<?> paramType = paramTypes[i2];
            Class<?> superClass = args[i2].getClass().getSuperclass();
