...
public abstract class StringUtils {
    ...
    public static boolean substringMatch(CharSequence str, int index, CharSequence substring) {
        ...
        for (int i2 = 0; i2 < substring.length(); ++i2) {
            if (str.charAt(index + i2) == substring.charAt(i2)) continue;
            return false;
        }
        return true;
    }
    ...
    public static String[] delimitedListToStringArray(@Nullable String str, @Nullable String delimiter, @Nullable String charsToDelete) {
        ...
        if (delimiter.isEmpty()) {
            for (int i2 = 0; i2 < str.length(); ++i2) {
                result.add(StringUtils.deleteAny(str.substring(i2, i2 + 1), charsToDelete));
            }
        } else {
            int delPos;
            int pos = 0;
    ...
    public static String truncate(CharSequence charSequence) {
        return StringUtils.truncate(charSequence, 100);
    }
