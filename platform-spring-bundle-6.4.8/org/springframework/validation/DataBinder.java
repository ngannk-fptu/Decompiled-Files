...
TypeConverter {
    ...
    public void setDisallowedFields(String ... disallowedFields) {
        if (disallowedFields == null) {
            ...
            for (int i2 = 0; i2 < fieldPatterns.length; ++i2) {
                fieldPatterns[i2] = PropertyAccessorUtils.canonicalPropertyName(disallowedFields[i2]).toLowerCase();
            }
    ...
    protected boolean isAllowed(String field) {
        ...
        return !(!ObjectUtils.isEmpty(allowed) && !PatternMatchUtils.simpleMatch((String[])allowed, field) || !ObjectUtils.isEmpty(disallowed) && PatternMatchUtils.simpleMatch((String[])disallowed, field.toLowerCase()));
    }
