...
extends RemoteExporter {
    ...
    protected Object invoke(RemoteInvocation invocation, Object targetObject) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        if (this.logger.isTraceEnabled()) {
            this.logger.trace((Object)("Executing " + invocation));
        }
        try {
            ...
            if (this.logger.isDebugEnabled()) {
                this.logger.debug((Object)("Could not find target method for " + invocation), (Throwable)ex);
            }
            throw ex;
        }
        catch (IllegalAccessException ex) {
            if (this.logger.isDebugEnabled()) {
                this.logger.debug((Object)("Could not access target method for " + invocation), (Throwable)ex);
            }
            throw ex;
        }
        catch (InvocationTargetException ex) {
            if (this.logger.isDebugEnabled()) {
                this.logger.debug((Object)("Target method failed for " + invocation), ex.getTargetException());
            }
            throw ex;
        }
    }
