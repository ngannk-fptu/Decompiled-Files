...
implements Cloneable {
    ...
    public MulticastDelegate remove(Object target) {
        for (int i2 = this.targets.length - 1; i2 >= 0; --i2) {
            if (!this.targets[i2].equals(target)) continue;
            MulticastDelegate copy = this.newInstance();
            copy.targets = new Object[this.targets.length - 1];
            System.arraycopy(this.targets, 0, copy.targets, 0, i2);
            System.arraycopy(this.targets, i2 + 1, copy.targets, i2, this.targets.length - i2 - 1);
            return copy;
        }
        return this;
    }
