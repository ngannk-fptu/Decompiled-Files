...
public class ReflectUtils {
    ...
    public static Method[] getPropertyMethods(PropertyDescriptor[] properties, boolean read, boolean write) {
        ...
        for (int i2 = 0; i2 < properties.length; ++i2) {
            PropertyDescriptor pd = properties[i2];
            if (read) {
    ...
    public static Class defineClass(String className, byte[] b, ClassLoader loader) throws Exception {
        return ReflectUtils.defineClass(className, b, loader, null, null);
    }
    ...
    public static Class defineClass(String className, byte[] b, ClassLoader loader, ProtectionDomain protectionDomain) throws Exception {
        return ReflectUtils.defineClass(className, b, loader, protectionDomain, null);
    }
    ...
    public static Class defineClass(String className, byte[] b, final ClassLoader loader, ProtectionDomain protectionDomain, final Class<?> contextClass) throws Exception {
        ...
        if (contextClass != null && contextClass.getClassLoader() == loader && privateLookupInMethod != null && lookupDefineClassMethod != null) {
            try {
                lookup = (MethodHandles.Lookup)privateLookupInMethod.invoke(null, contextClass, MethodHandles.lookup());
                c = (Class)lookupDefineClassMethod.invoke((Object)lookup, new Object[]{b});
            }
        ...
        if (c == null) {
            ...
            try {
                ...
                c = (Class)publicDefineClass.invoke((Object)loader, className, b, protectionDomain);
            }
            catch (InvocationTargetException ex) {
            ...
            if (c == null && classLoaderDefineClassMethod != null) {
                ...
                try {
                    ...
                    c = (Class)classLoaderDefineClassMethod.invoke((Object)loader, args);
                }
                catch (InvocationTargetException ex) {
                    throw new CodeGenerationException(ex.getTargetException());
                }
    ...
    public static Method[] findMethods(String[] namesAndDescriptors, Method[] methods) {
        ...
        for (int i3 = 0; i3 < result.length; ++i3) {
            result[i3] = (Method)map.get(namesAndDescriptors[i3 * 2] + namesAndDescriptors[i3 * 2 + 1]);
            if (result[i3] != null) continue;
        }
        return result;
    }
