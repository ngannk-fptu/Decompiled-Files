...
public abstract class Mixin {
    ...
    public static Mixin createBean(Object[] beans2) {
        return Mixin.createBean(null, beans2);
    }

    public static Mixin createBean(ClassLoader loader, Object[] beans2) {
        Generator gen = new Generator();
        gen.setStyle(1);
        gen.setDelegates(beans2);
            ...
            switch (this.style) {
                ...
                case 2: {
                    ...
                    for (int i2 = 0; i2 < this.classes.length; ++i2) {
                        if (this.classes[i2].isAssignableFrom(temp[i2])) continue;
                        throw new IllegalStateException("Specified class " + this.classes[i2] + " is incompatible with delegate class " + temp[i2] + " (index " + i2 + ")");
                    }
                    break;
                }
            }
