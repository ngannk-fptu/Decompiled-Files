...
extends Operator {
    ...
    public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
        ...
        if (leftOperand instanceof String) {
            String leftString = (String)leftOperand;
            this.checkStringLength(leftString);
            String rightString = rightOperand == null ? "null" : OpPlus.convertTypedValueToString(operandTwoValue, state);
            this.checkStringLength(rightString);
            return this.concatenate(leftString, rightString);
        }
        if (rightOperand instanceof String) {
            String rightString = (String)rightOperand;
            this.checkStringLength(rightString);
            String leftString = leftOperand == null ? "null" : OpPlus.convertTypedValueToString(operandOneValue, state);
            this.checkStringLength(leftString);
            return this.concatenate(leftString, rightString);
        }
