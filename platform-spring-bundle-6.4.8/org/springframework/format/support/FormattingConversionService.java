...
EmbeddedValueResolverAware {
    ...
    private static <T> Class<?> getFieldType(T instance, Class<T> genericInterface) {
        ...
        Assert.notNull(fieldType, () -> "Unable to extract the parameterized field type from " + ClassUtils.getShortName(genericInterface) + " [" + instance.getClass().getName() + "]; does the class parameterize the <T> generic type?");
        return fieldType;
    }
