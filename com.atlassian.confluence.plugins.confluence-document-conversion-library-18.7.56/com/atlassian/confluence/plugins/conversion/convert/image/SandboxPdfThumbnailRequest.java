...
public class SandboxPdfThumbnailRequest {
    ...
    public SandboxPdfThumbnailRequest(File inputFile, FileFormat inFileFormat, File tempFile, File convertedFile, int pageNumber, int width, int height) {
    ...
    public boolean equals(Object o) {
        ...
        SandboxPdfThumbnailRequest that = (SandboxPdfThumbnailRequest)o;
    ...
    public int hashCode() {
        return Objects.hash(this.inputFile, this.inFileFormat, this.tempFile, this.convertedFile, this.pageNumber, this.width, this.height);
    }

    static final class Serializer
    implements SandboxSerializer<SandboxPdfThumbnailRequest> {
        static final Serializer instance = new Serializer();

        private Serializer() {
        }

        public byte[] serialize(SandboxPdfThumbnailRequest sandboxThumbnailRequest) {
        ...
        public SandboxPdfThumbnailRequest deserialize(byte[] bytes) {
            List fields = (List)SandboxSerializers.compositeByteArraySerializer().deserialize(bytes);
            return new SandboxPdfThumbnailRequest(new File((String)SandboxSerializers.stringSerializer().deserialize((byte[])fields.get(0))), FileFormat.valueOf((String)((String)SandboxSerializers.stringSerializer().deserialize((byte[])fields.get(1)))), new File((String)SandboxSerializers.stringSerializer().deserialize((byte[])fields.get(2))), new File((String)SandboxSerializers.stringSerializer().deserialize((byte[])fields.get(3))), (Integer)SandboxSerializers.intSerializer().deserialize((byte[])fields.get(4)), (Integer)SandboxSerializers.intSerializer().deserialize((byte[])fields.get(5)), (Integer)SandboxSerializers.intSerializer().deserialize((byte[])fields.get(6)));
        }
    }
}
