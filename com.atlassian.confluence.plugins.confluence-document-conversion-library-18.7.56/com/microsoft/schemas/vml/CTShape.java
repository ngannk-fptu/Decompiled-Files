...
extends XmlObject {
    public static final DocumentFactory<CTShape> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctshape5cb5type");
    ...
    public CTEquationXml getEquationxmlArray(int var1);

    public int sizeOfEquationxmlArray();

    public void setEquationxmlArray(CTEquationXml[] var1);

    public void setEquationxmlArray(int var1, CTEquationXml var2);

    public CTEquationXml insertNewEquationxml(int var1);

    public CTEquationXml addNewEquationxml();

    public void removeEquationxml(int var1);
    ...
    public void setEquationxml2(String var1);

    public void xsetEquationxml2(XmlString var1);
