...
public interface CTLine
extends XmlObject {
    public static final DocumentFactory<CTLine> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctline50f2type");
    ...
    public void xsetFrom(XmlString var1);
    ...
    public void xsetTo(XmlString var1);
