...
public interface CTRoundRect
extends XmlObject {
    public static final DocumentFactory<CTRoundRect> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctroundrectc466type");
    ...
    public void setArcsize(String var1);

    public void xsetArcsize(XmlString var1);
