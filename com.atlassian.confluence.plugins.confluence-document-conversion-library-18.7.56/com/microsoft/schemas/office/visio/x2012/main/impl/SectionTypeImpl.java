...
implements SectionType {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.microsoft.com/office/visio/2012/main", "Cell"), new QName("http://schemas.microsoft.com/office/visio/2012/main", "Trigger"), new QName("http://schemas.microsoft.com/office/visio/2012/main", "Row"), new QName("", "N"), new QName("", "Del"), new QName("", "IX")};
    ...
    public List<RowType> getRowList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<RowType>(this::getRowArray, this::setRowArray, this::insertNewRow, this::removeRow, this::sizeOfRowArray);
        }
    }

    @Override
    public RowType[] getRowArray() {
        return (RowType[])this.getXmlObjectArray(PROPERTY_QNAME[2], new RowType[0]);
    }
    ...
    public RowType getRowArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            RowType target = null;
            target = (RowType)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], i));
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
    ...
    public void setRowArray(RowType[] rowArray) {
        this.check_orphaned();
        this.arraySetterHelper(rowArray, PROPERTY_QNAME[2]);
    }

    @Override
    public void setRowArray(int i, RowType row) {
        this.generatedSetterHelperImpl(row, PROPERTY_QNAME[2], i, (short)2);
    }
    ...
    public RowType insertNewRow(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            RowType target = null;
            target = (RowType)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[2], i));
            return target;
        }
    }
    ...
    public RowType addNewRow() {
        ...
        synchronized (object) {
            this.check_orphaned();
            RowType target = null;
            target = (RowType)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
