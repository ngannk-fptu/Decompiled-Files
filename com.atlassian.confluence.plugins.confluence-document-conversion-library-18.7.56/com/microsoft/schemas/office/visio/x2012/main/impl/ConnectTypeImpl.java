...
implements ConnectType {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "FromSheet"), new QName("", "FromCell"), new QName("", "FromPart"), new QName("", "ToSheet"), new QName("", "ToCell"), new QName("", "ToPart")};
    ...
    public XmlInt xgetFromPart() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlInt target = null;
            target = (XmlInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
    ...
    public void xsetFromPart(XmlInt fromPart) {
        ...
        synchronized (object) {
            ...
            target = (XmlInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[2]));
            if (target == null) {
                target = (XmlInt)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[2]));
            }
            target.set(fromPart);
        }
    }
