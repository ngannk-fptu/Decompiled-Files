...
public class CTSlideTimingImpl
extends XmlComplexContentImpl
implements CTSlideTiming {
    private static final long serialVersionUID = 1L;
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "tnLst"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "bldLst"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "extLst")};
    ...
    public CTTimeNodeList getTnLst() {
        ...
        synchronized (object) {
            ...
            target = (CTTimeNodeList)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setTnLst(CTTimeNodeList tnLst) {
        this.generatedSetterHelperImpl(tnLst, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTTimeNodeList addNewTnLst() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTimeNodeList target = null;
            target = (CTTimeNodeList)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public CTBuildList getBldLst() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBuildList target = null;
            target = (CTBuildList)this.get_store().find_element_user(PROPERTY_QNAME[1], 0);
            return target == null ? null : target;
        }
    }
    ...
    public void setBldLst(CTBuildList bldLst) {
        this.generatedSetterHelperImpl((XmlObject)bldLst, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTBuildList addNewBldLst() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBuildList target = null;
            target = (CTBuildList)this.get_store().add_element_user(PROPERTY_QNAME[1]);
            return target;
        }
    }
