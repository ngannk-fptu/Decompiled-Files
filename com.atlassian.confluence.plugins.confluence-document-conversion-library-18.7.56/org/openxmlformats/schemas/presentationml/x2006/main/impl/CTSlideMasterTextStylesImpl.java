...
implements CTSlideMasterTextStyles {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "titleStyle"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "bodyStyle"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "otherStyle"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "extLst")};
    ...
    public CTTextListStyle getTitleStyle() {
        ...
        synchronized (object) {
            ...
            target = (CTTextListStyle)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setTitleStyle(CTTextListStyle titleStyle) {
        this.generatedSetterHelperImpl(titleStyle, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTTextListStyle addNewTitleStyle() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTextListStyle target = null;
            target = (CTTextListStyle)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void setBodyStyle(CTTextListStyle bodyStyle) {
        this.generatedSetterHelperImpl(bodyStyle, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTTextListStyle getOtherStyle() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTextListStyle target = null;
            target = (CTTextListStyle)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setOtherStyle(CTTextListStyle otherStyle) {
        this.generatedSetterHelperImpl(otherStyle, PROPERTY_QNAME[2], 0, (short)1);
    }
    ...
    public CTTextListStyle addNewOtherStyle() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTextListStyle target = null;
            target = (CTTextListStyle)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
