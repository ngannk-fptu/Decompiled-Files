...
implements CTCommentAuthor {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "extLst"), new QName("", "id"), new QName("", "name"), new QName("", "initials"), new QName("", "lastIdx"), new QName("", "clrIdx")};
    ...
    public STName xgetName() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STName target = null;
            target = (STName)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
    ...
    public void xsetName(STName name) {
        ...
        synchronized (object) {
            ...
            target = (STName)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[2]));
            if (target == null) {
                target = (STName)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[2]));
            }
            target.set(name);
        }
    }
    ...
    public STName xgetInitials() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STName target = null;
            target = (STName)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            return target;
        }
    }
    ...
    public void xsetInitials(STName initials) {
        ...
        synchronized (object) {
            ...
            target = (STName)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            if (target == null) {
                target = (STName)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[3]));
            }
            target.set(initials);
        }
    }
