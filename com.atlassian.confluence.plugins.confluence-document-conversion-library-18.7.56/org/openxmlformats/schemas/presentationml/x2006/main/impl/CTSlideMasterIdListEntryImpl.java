...
implements CTSlideMasterIdListEntry {
    ...
    public STSlideMasterId xgetId() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSlideMasterId target = null;
            target = (STSlideMasterId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
    ...
    public void xsetId(STSlideMasterId id) {
        ...
        synchronized (object) {
            ...
            target = (STSlideMasterId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[1]));
            if (target == null) {
                target = (STSlideMasterId)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[1]));
            }
            target.set(id);
        }
    }
