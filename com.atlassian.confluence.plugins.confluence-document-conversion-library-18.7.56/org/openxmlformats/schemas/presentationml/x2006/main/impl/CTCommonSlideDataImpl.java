...
implements CTCommonSlideData {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "bg"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "spTree"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "custDataLst"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "controls"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "extLst"), new QName("", "name")};
    ...
    public CTBackground getBg() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBackground target = null;
            target = (CTBackground)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setBg(CTBackground bg) {
        this.generatedSetterHelperImpl(bg, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTBackground addNewBg() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBackground target = null;
            target = (CTBackground)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public CTGroupShape getSpTree() {
        ...
        synchronized (object) {
            ...
            target = (CTGroupShape)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setSpTree(CTGroupShape spTree) {
        this.generatedSetterHelperImpl(spTree, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTGroupShape addNewSpTree() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTGroupShape target = null;
            target = (CTGroupShape)((Object)this.get_store().add_element_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
    ...
    public CTCustomerDataList getCustDataLst() {
        ...
        synchronized (object) {
            ...
            target = (CTCustomerDataList)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setCustDataLst(CTCustomerDataList custDataLst) {
        this.generatedSetterHelperImpl(custDataLst, PROPERTY_QNAME[2], 0, (short)1);
    }
    ...
    public CTCustomerDataList addNewCustDataLst() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTCustomerDataList target = null;
            target = (CTCustomerDataList)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
    ...
    public CTControlList getControls() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTControlList target = null;
            target = (CTControlList)this.get_store().find_element_user(PROPERTY_QNAME[3], 0);
            return target == null ? null : target;
        }
    }
    ...
    public void setControls(CTControlList controls) {
        this.generatedSetterHelperImpl((XmlObject)controls, PROPERTY_QNAME[3], 0, (short)1);
    }
    ...
    public CTControlList addNewControls() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTControlList target = null;
            target = (CTControlList)this.get_store().add_element_user(PROPERTY_QNAME[3]);
            return target;
        }
    }
