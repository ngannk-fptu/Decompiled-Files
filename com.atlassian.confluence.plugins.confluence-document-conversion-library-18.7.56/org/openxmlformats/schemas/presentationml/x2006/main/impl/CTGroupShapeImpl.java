...
implements CTGroupShape {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "nvGrpSpPr"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "grpSpPr"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "sp"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "grpSp"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "graphicFrame"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "cxnSp"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "pic"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "contentPart"), new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "extLst")};
    ...
    public CTRel[] getContentPartArray() {
        return (CTRel[])this.getXmlObjectArray(PROPERTY_QNAME[7], new CTRel[0]);
    }
    ...
    public CTRel getContentPartArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTRel target = null;
            target = (CTRel)((Object)this.get_store().find_element_user(PROPERTY_QNAME[7], i));
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
    ...
    public void setContentPartArray(CTRel[] contentPartArray) {
        this.check_orphaned();
        this.arraySetterHelper(contentPartArray, PROPERTY_QNAME[7]);
    }

    @Override
    public void setContentPartArray(int i, CTRel contentPart) {
        this.generatedSetterHelperImpl(contentPart, PROPERTY_QNAME[7], i, (short)2);
    }
    ...
    public CTRel insertNewContentPart(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTRel target = null;
            target = (CTRel)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[7], i));
            return target;
        }
    }
    ...
    public CTRel addNewContentPart() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTRel target = null;
            target = (CTRel)((Object)this.get_store().add_element_user(PROPERTY_QNAME[7]));
            return target;
        }
    }
    ...
    public CTExtensionListModify getExtLst() {
        ...
        synchronized (object) {
            ...
            target = (CTExtensionListModify)this.get_store().find_element_user(PROPERTY_QNAME[8], 0);
            return target == null ? null : target;
        }
    }
    ...
    public void setExtLst(CTExtensionListModify extLst) {
        this.generatedSetterHelperImpl((XmlObject)extLst, PROPERTY_QNAME[8], 0, (short)1);
    }
    ...
    public CTExtensionListModify addNewExtLst() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTExtensionListModify target = null;
            target = (CTExtensionListModify)this.get_store().add_element_user(PROPERTY_QNAME[8]);
            return target;
        }
    }
