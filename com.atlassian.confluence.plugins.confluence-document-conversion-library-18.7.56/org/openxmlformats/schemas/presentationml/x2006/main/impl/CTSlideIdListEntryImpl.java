...
implements CTSlideIdListEntry {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/presentationml/2006/main", "extLst"), new QName("", "id"), new QName("http://schemas.openxmlformats.org/officeDocument/2006/relationships", "id")};
    ...
    public STSlideId xgetId() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSlideId target = null;
            target = (STSlideId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
    ...
    public void xsetId(STSlideId id) {
        ...
        synchronized (object) {
            ...
            target = (STSlideId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[1]));
            if (target == null) {
                target = (STSlideId)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[1]));
            }
            target.set(id);
        }
    }
