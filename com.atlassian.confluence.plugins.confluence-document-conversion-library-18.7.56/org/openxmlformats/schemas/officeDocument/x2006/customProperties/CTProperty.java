...
extends XmlObject {
    public static final DocumentFactory<CTProperty> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctproperty5ffatype");
    ...
    public void xsetFmtid(STGuid var1);
