...
implements CTD {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/officeDocument/2006/math", "dPr"), new QName("http://schemas.openxmlformats.org/officeDocument/2006/math", "e")};
    ...
    public CTDPr getDPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTDPr target = null;
            target = (CTDPr)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setDPr(CTDPr dPr) {
        this.generatedSetterHelperImpl(dPr, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTDPr addNewDPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTDPr target = null;
            target = (CTDPr)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public CTOMathArg[] getEArray() {
        return (CTOMathArg[])this.getXmlObjectArray(PROPERTY_QNAME[1], new CTOMathArg[0]);
    }
    ...
    public CTOMathArg getEArray(int i) {
        ...
        synchronized (object) {
            ...
            target = (CTOMathArg)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], i));
            if (target == null) {
    ...
    public void setEArray(CTOMathArg[] eArray) {
        this.check_orphaned();
        this.arraySetterHelper(eArray, PROPERTY_QNAME[1]);
    }

    @Override
    public void setEArray(int i, CTOMathArg e) {
        this.generatedSetterHelperImpl(e, PROPERTY_QNAME[1], i, (short)2);
    }
    ...
    public CTOMathArg insertNewE(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTOMathArg target = null;
            target = (CTOMathArg)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[1], i));
            return target;
        }
    }
