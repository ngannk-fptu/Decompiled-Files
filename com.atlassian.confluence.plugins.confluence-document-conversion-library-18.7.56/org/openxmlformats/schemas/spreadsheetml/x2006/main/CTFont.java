...
extends XmlObject {
    public static final DocumentFactory<CTFont> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctfont14d8type");
    ...
    public CTFontFamily getFamilyArray(int var1);

    public int sizeOfFamilyArray();

    public void setFamilyArray(CTFontFamily[] var1);

    public void setFamilyArray(int var1, CTFontFamily var2);

    public CTFontFamily insertNewFamily(int var1);
