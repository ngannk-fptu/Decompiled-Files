...
implements CTFills {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "fill"), new QName("", "count")};
    ...
    public CTFill[] getFillArray() {
        return (CTFill[])this.getXmlObjectArray(PROPERTY_QNAME[0], new CTFill[0]);
    }
    ...
    public CTFill getFillArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTFill target = null;
            target = (CTFill)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], i));
            if (target == null) {
    ...
    public void setFillArray(CTFill[] fillArray) {
        this.check_orphaned();
        this.arraySetterHelper(fillArray, PROPERTY_QNAME[0]);
    }

    @Override
    public void setFillArray(int i, CTFill fill) {
        this.generatedSetterHelperImpl(fill, PROPERTY_QNAME[0], i, (short)2);
    }
    ...
    public CTFill insertNewFill(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTFill target = null;
            target = (CTFill)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[0], i));
            return target;
        }
    }
