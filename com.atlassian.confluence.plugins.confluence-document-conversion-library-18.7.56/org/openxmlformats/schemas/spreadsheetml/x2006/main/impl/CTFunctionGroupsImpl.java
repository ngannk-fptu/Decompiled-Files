...
public class CTFunctionGroupsImpl
extends XmlComplexContentImpl
implements CTFunctionGroups {
    private static final long serialVersionUID = 1L;
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "functionGroup"), new QName("", "builtInGroupCount")};
    ...
    public List<CTFunctionGroup> getFunctionGroupList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTFunctionGroup>(this::getFunctionGroupArray, this::setFunctionGroupArray, this::insertNewFunctionGroup, this::removeFunctionGroup, this::sizeOfFunctionGroupArray);
        }
    }

    @Override
    public CTFunctionGroup[] getFunctionGroupArray() {
        return (CTFunctionGroup[])this.getXmlObjectArray(PROPERTY_QNAME[0], (XmlObject[])new CTFunctionGroup[0]);
    }
    ...
    public CTFunctionGroup getFunctionGroupArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTFunctionGroup target = null;
            target = (CTFunctionGroup)this.get_store().find_element_user(PROPERTY_QNAME[0], i);
            if (target == null) {
    ...
    public void setFunctionGroupArray(CTFunctionGroup[] functionGroupArray) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])functionGroupArray, PROPERTY_QNAME[0]);
    }

    @Override
    public void setFunctionGroupArray(int i, CTFunctionGroup functionGroup) {
        this.generatedSetterHelperImpl((XmlObject)functionGroup, PROPERTY_QNAME[0], i, (short)2);
    }
    ...
    public CTFunctionGroup insertNewFunctionGroup(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTFunctionGroup target = null;
            target = (CTFunctionGroup)this.get_store().insert_element_user(PROPERTY_QNAME[0], i);
            return target;
        }
    }
    ...
    public CTFunctionGroup addNewFunctionGroup() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTFunctionGroup target = null;
            target = (CTFunctionGroup)this.get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
