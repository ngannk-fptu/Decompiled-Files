...
public class CTXmlPrImpl
extends XmlComplexContentImpl
implements CTXmlPr {
    private static final long serialVersionUID = 1L;
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "mapId"), new QName("", "xpath"), new QName("", "xmlDataType")};
    ...
    public STXstring xgetXpath() {
        ...
        synchronized (object) {
            ...
            target = (STXstring)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
    ...
    public void xsetXpath(STXstring xpath) {
        ...
        synchronized (object) {
            ...
            target = (STXstring)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[2]));
            if (target == null) {
                target = (STXstring)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[2]));
            }
            target.set(xpath);
        }
    }
    ...
    public STXmlDataType xgetXmlDataType() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STXmlDataType target = null;
            target = (STXmlDataType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            return target;
        }
    }
    ...
    public void xsetXmlDataType(STXmlDataType xmlDataType) {
        ...
        synchronized (object) {
            ...
            target = (STXmlDataType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            if (target == null) {
                target = (STXmlDataType)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[3]));
            }
