...
implements CTHyperlink {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "ref"), new QName("http://schemas.openxmlformats.org/officeDocument/2006/relationships", "id"), new QName("", "location"), new QName("", "tooltip"), new QName("", "display")};
