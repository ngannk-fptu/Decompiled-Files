...
implements CTNumFmt {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "numFmtId"), new QName("", "formatCode")};
    ...
    public STNumFmtId xgetNumFmtId() {
        ...
        synchronized (object) {
            ...
            target = (STNumFmtId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetNumFmtId(STNumFmtId numFmtId) {
        ...
        synchronized (object) {
            ...
            target = (STNumFmtId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STNumFmtId)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(numFmtId);
        }
    }
