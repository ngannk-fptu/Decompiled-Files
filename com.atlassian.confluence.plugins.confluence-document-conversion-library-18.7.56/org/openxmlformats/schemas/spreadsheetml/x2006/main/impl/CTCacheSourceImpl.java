...
implements CTCacheSource {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "worksheetSource"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "consolidation"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "type"), new QName("", "connectionId")};
    ...
    public CTWorksheetSource getWorksheetSource() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTWorksheetSource target = null;
            target = (CTWorksheetSource)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setWorksheetSource(CTWorksheetSource worksheetSource) {
        this.generatedSetterHelperImpl(worksheetSource, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTWorksheetSource addNewWorksheetSource() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTWorksheetSource target = null;
            target = (CTWorksheetSource)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public CTConsolidation getConsolidation() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTConsolidation target = null;
            target = (CTConsolidation)this.get_store().find_element_user(PROPERTY_QNAME[1], 0);
            return target == null ? null : target;
        }
    }
    ...
    public void setConsolidation(CTConsolidation consolidation) {
        this.generatedSetterHelperImpl((XmlObject)consolidation, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTConsolidation addNewConsolidation() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTConsolidation target = null;
            target = (CTConsolidation)this.get_store().add_element_user(PROPERTY_QNAME[1]);
            return target;
        }
    }
    ...
    public STSourceType.Enum getType() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STSourceType.Enum)target.getEnumValue();
        }
    }
    ...
    public STSourceType xgetType() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSourceType target = null;
            target = (STSourceType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            return target;
        }
    }
    ...
    public void xsetType(STSourceType type) {
        ...
        synchronized (object) {
            ...
            target = (STSourceType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            if (target == null) {
                target = (STSourceType)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[3]));
            }
            target.set(type);
        }
    }
