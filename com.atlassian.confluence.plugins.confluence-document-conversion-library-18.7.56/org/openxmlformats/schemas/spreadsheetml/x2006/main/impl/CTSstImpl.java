...
implements CTSst {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "si"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "count"), new QName("", "uniqueCount")};
    ...
    public List<CTRst> getSiList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTRst>(this::getSiArray, this::setSiArray, this::insertNewSi, this::removeSi, this::sizeOfSiArray);
        }
    }

    @Override
    public CTRst[] getSiArray() {
        return (CTRst[])this.getXmlObjectArray(PROPERTY_QNAME[0], new CTRst[0]);
    }
    ...
    public CTRst getSiArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTRst target = null;
            target = (CTRst)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], i));
            if (target == null) {
    ...
    public void setSiArray(CTRst[] siArray) {
        this.check_orphaned();
        this.arraySetterHelper(siArray, PROPERTY_QNAME[0]);
    }

    @Override
    public void setSiArray(int i, CTRst si) {
        this.generatedSetterHelperImpl(si, PROPERTY_QNAME[0], i, (short)2);
    }
    ...
    public CTRst insertNewSi(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTRst target = null;
            target = (CTRst)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[0], i));
            return target;
        }
    }
