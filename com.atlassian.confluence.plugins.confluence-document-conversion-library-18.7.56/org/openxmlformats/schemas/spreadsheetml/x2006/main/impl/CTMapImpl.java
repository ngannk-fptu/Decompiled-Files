...
implements CTMap {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "DataBinding"), new QName("", "ID"), new QName("", "Name"), new QName("", "RootElement"), new QName("", "SchemaID"), new QName("", "ShowImportExportValidationErrors"), new QName("", "AutoFit"), new QName("", "Append"), new QName("", "PreserveSortAFLayout"), new QName("", "PreserveFormat")};
    ...
    public CTDataBinding getDataBinding() {
        ...
        synchronized (object) {
            ...
            target = (CTDataBinding)this.get_store().find_element_user(PROPERTY_QNAME[0], 0);
    ...
    public void setDataBinding(CTDataBinding dataBinding) {
        this.generatedSetterHelperImpl((XmlObject)dataBinding, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTDataBinding addNewDataBinding() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTDataBinding target = null;
            target = (CTDataBinding)this.get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
