...
implements CTCfvo {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "type"), new QName("", "val"), new QName("", "gte")};
    ...
    public STCfvoType.Enum getType() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STCfvoType.Enum)target.getEnumValue();
        }
    }
    ...
    public STCfvoType xgetType() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STCfvoType target = null;
            target = (STCfvoType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
    ...
    public void xsetType(STCfvoType type) {
        ...
        synchronized (object) {
            ...
            target = (STCfvoType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[1]));
            if (target == null) {
                target = (STCfvoType)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[1]));
            }
            target.set(type);
        }
    }
