...
implements CTSheetView {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "pane"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "selection"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "pivotSelection"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "windowProtection"), new QName("", "showFormulas"), new QName("", "showGridLines"), new QName("", "showRowColHeaders"), new QName("", "showZeros"), new QName("", "rightToLeft"), new QName("", "tabSelected"), new QName("", "showRuler"), new QName("", "showOutlineSymbols"), new QName("", "defaultGridColor"), new QName("", "showWhiteSpace"), new QName("", "view"), new QName("", "topLeftCell"), new QName("", "colorId"), new QName("", "zoomScale"), new QName("", "zoomScaleNormal"), new QName("", "zoomScaleSheetLayoutView"), new QName("", "zoomScalePageLayoutView"), new QName("", "workbookViewId")};
    ...
    public List<CTSelection> getSelectionList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTSelection>(this::getSelectionArray, this::setSelectionArray, this::insertNewSelection, this::removeSelection, this::sizeOfSelectionArray);
        }
    }

    @Override
    public CTSelection[] getSelectionArray() {
        return (CTSelection[])this.getXmlObjectArray(PROPERTY_QNAME[1], new CTSelection[0]);
    }
    ...
    public CTSelection getSelectionArray(int i) {
        ...
        synchronized (object) {
            ...
            target = (CTSelection)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], i));
            if (target == null) {
    ...
    public void setSelectionArray(CTSelection[] selectionArray) {
        this.check_orphaned();
        this.arraySetterHelper(selectionArray, PROPERTY_QNAME[1]);
    }

    @Override
    public void setSelectionArray(int i, CTSelection selection) {
        this.generatedSetterHelperImpl(selection, PROPERTY_QNAME[1], i, (short)2);
    }
    ...
    public CTSelection insertNewSelection(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSelection target = null;
            target = (CTSelection)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[1], i));
            return target;
        }
    }
    ...
    public List<CTPivotSelection> getPivotSelectionList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTPivotSelection>(this::getPivotSelectionArray, this::setPivotSelectionArray, this::insertNewPivotSelection, this::removePivotSelection, this::sizeOfPivotSelectionArray);
        }
    }

    @Override
    public CTPivotSelection[] getPivotSelectionArray() {
        return (CTPivotSelection[])this.getXmlObjectArray(PROPERTY_QNAME[2], (XmlObject[])new CTPivotSelection[0]);
    }
    ...
    public CTPivotSelection getPivotSelectionArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTPivotSelection target = null;
            target = (CTPivotSelection)this.get_store().find_element_user(PROPERTY_QNAME[2], i);
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
    ...
    public void setPivotSelectionArray(CTPivotSelection[] pivotSelectionArray) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])pivotSelectionArray, PROPERTY_QNAME[2]);
    }

    @Override
    public void setPivotSelectionArray(int i, CTPivotSelection pivotSelection) {
        this.generatedSetterHelperImpl((XmlObject)pivotSelection, PROPERTY_QNAME[2], i, (short)2);
    }
    ...
    public CTPivotSelection insertNewPivotSelection(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTPivotSelection target = null;
            target = (CTPivotSelection)this.get_store().insert_element_user(PROPERTY_QNAME[2], i);
            return target;
        }
    }
    ...
    public CTPivotSelection addNewPivotSelection() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTPivotSelection target = null;
            target = (CTPivotSelection)this.get_store().add_element_user(PROPERTY_QNAME[2]);
            return target;
        }
    }
    ...
    public STSheetViewType xgetView() {
        ...
        synchronized (object) {
            ...
            target = (STSheetViewType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[15]));
            if (target == null) {
                target = (STSheetViewType)this.get_default_attribute_value(PROPERTY_QNAME[15]);
            }
            return target;
        }
    }
    ...
    public void xsetView(STSheetViewType view) {
        ...
        synchronized (object) {
            ...
            target = (STSheetViewType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[15]));
            if (target == null) {
                target = (STSheetViewType)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[15]));
            }
            target.set(view);
        }
    }
    ...
    public STCellRef xgetTopLeftCell() {
        ...
        synchronized (object) {
            ...
            target = (STCellRef)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[16]));
            return target;
        }
    }
    ...
    public void xsetTopLeftCell(STCellRef topLeftCell) {
        ...
        synchronized (object) {
            ...
            target = (STCellRef)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[16]));
            if (target == null) {
                target = (STCellRef)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[16]));
            }
    ...
    public XmlUnsignedInt xgetZoomScale() {
        ...
        synchronized (object) {
            ...
            if (target == null) {
                target = (XmlUnsignedInt)this.get_default_attribute_value(PROPERTY_QNAME[18]);
            }
            return target;
        }
    }
    ...
    public XmlUnsignedInt xgetZoomScaleSheetLayoutView() {
        ...
        synchronized (object) {
            ...
            if (target == null) {
                target = (XmlUnsignedInt)this.get_default_attribute_value(PROPERTY_QNAME[20]);
            }
            return target;
        }
    }
    ...
    public XmlUnsignedInt xgetZoomScalePageLayoutView() {
        ...
        synchronized (object) {
            ...
            if (target == null) {
                target = (XmlUnsignedInt)this.get_default_attribute_value(PROPERTY_QNAME[21]);
            }
            return target;
        }
    }
    ...
    public XmlUnsignedInt xgetWorkbookViewId() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlUnsignedInt target = null;
            target = (XmlUnsignedInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[22]));
            return target;
        }
    }
    ...
    public void xsetWorkbookViewId(XmlUnsignedInt workbookViewId) {
        ...
        synchronized (object) {
            ...
            target = (XmlUnsignedInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[22]));
            if (target == null) {
                target = (XmlUnsignedInt)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[22]));
            }
