...
implements CTWorksheetSource {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "ref"), new QName("", "name"), new QName("", "sheet"), new QName("http://schemas.openxmlformats.org/officeDocument/2006/relationships", "id")};
