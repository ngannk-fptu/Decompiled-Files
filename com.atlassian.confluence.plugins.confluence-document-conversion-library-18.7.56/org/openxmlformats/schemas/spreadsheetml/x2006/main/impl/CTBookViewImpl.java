...
implements CTBookView {
    ...
    public STVisibility.Enum getVisibility() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STVisibility.Enum)target.getEnumValue();
        }
    }
    ...
    public STVisibility xgetVisibility() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STVisibility target = null;
            target = (STVisibility)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[1]));
            if (target == null) {
                target = (STVisibility)this.get_default_attribute_value(PROPERTY_QNAME[1]);
            }
            return target;
        }
    }
    ...
    public void xsetVisibility(STVisibility visibility) {
        ...
        synchronized (object) {
            ...
            target = (STVisibility)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[1]));
            if (target == null) {
                target = (STVisibility)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[1]));
            }
    ...
    public XmlInt xgetXWindow() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlInt target = null;
            target = (XmlInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[6]));
            return target;
        }
    }
    ...
    public void xsetXWindow(XmlInt xWindow) {
        ...
        synchronized (object) {
            ...
            target = (XmlInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[6]));
            if (target == null) {
                target = (XmlInt)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[6]));
            }
            target.set(xWindow);
        }
    }
