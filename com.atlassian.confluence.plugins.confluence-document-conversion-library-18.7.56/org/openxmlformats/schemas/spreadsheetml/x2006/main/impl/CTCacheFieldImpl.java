...
implements CTCacheField {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "sharedItems"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "fieldGroup"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "mpMap"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "name"), new QName("", "caption"), new QName("", "propertyName"), new QName("", "serverField"), new QName("", "uniqueList"), new QName("", "numFmtId"), new QName("", "formula"), new QName("", "sqlType"), new QName("", "hierarchy"), new QName("", "level"), new QName("", "databaseField"), new QName("", "mappingCount"), new QName("", "memberPropertyField")};
    ...
    public CTSharedItems getSharedItems() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSharedItems target = null;
            target = (CTSharedItems)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setSharedItems(CTSharedItems sharedItems) {
        this.generatedSetterHelperImpl(sharedItems, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTSharedItems addNewSharedItems() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSharedItems target = null;
            target = (CTSharedItems)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public CTFieldGroup getFieldGroup() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTFieldGroup target = null;
            target = (CTFieldGroup)this.get_store().find_element_user(PROPERTY_QNAME[1], 0);
            return target == null ? null : target;
        }
    }
    ...
    public void setFieldGroup(CTFieldGroup fieldGroup) {
        this.generatedSetterHelperImpl((XmlObject)fieldGroup, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTFieldGroup addNewFieldGroup() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTFieldGroup target = null;
            target = (CTFieldGroup)this.get_store().add_element_user(PROPERTY_QNAME[1]);
            return target;
        }
    }
    ...
    public List<CTX> getMpMapList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTX>(this::getMpMapArray, this::setMpMapArray, this::insertNewMpMap, this::removeMpMap, this::sizeOfMpMapArray);
        }
    }

    @Override
    public CTX[] getMpMapArray() {
        return (CTX[])this.getXmlObjectArray(PROPERTY_QNAME[2], (XmlObject[])new CTX[0]);
    }
    ...
    public CTX getMpMapArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTX target = null;
            target = (CTX)this.get_store().find_element_user(PROPERTY_QNAME[2], i);
            if (target == null) {
    ...
    public void setMpMapArray(CTX[] mpMapArray) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])mpMapArray, PROPERTY_QNAME[2]);
    }

    @Override
    public void setMpMapArray(int i, CTX mpMap) {
        this.generatedSetterHelperImpl((XmlObject)mpMap, PROPERTY_QNAME[2], i, (short)2);
    }
    ...
    public CTX insertNewMpMap(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTX target = null;
            target = (CTX)this.get_store().insert_element_user(PROPERTY_QNAME[2], i);
            return target;
        }
    }
    ...
    public CTX addNewMpMap() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTX target = null;
            target = (CTX)this.get_store().add_element_user(PROPERTY_QNAME[2]);
            return target;
        }
    }
    ...
    public STNumFmtId xgetNumFmtId() {
        ...
        synchronized (object) {
            ...
            target = (STNumFmtId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[9]));
            return target;
        }
    }
    ...
    public void xsetNumFmtId(STNumFmtId numFmtId) {
        ...
        synchronized (object) {
            ...
            target = (STNumFmtId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[9]));
            if (target == null) {
                target = (STNumFmtId)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[9]));
            }
            target.set(numFmtId);
        }
    }
    ...
    public XmlInt xgetSqlType() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlInt target = null;
            target = (XmlInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[11]));
            if (target == null) {
                target = (XmlInt)this.get_default_attribute_value(PROPERTY_QNAME[11]);
            }
            return target;
        }
    }
    ...
    public void xsetSqlType(XmlInt sqlType) {
        ...
        synchronized (object) {
            ...
            target = (XmlInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[11]));
            if (target == null) {
                target = (XmlInt)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[11]));
            }
            target.set(sqlType);
        }
    }
    ...
    public XmlInt xgetHierarchy() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlInt target = null;
            target = (XmlInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[12]));
            if (target == null) {
                target = (XmlInt)this.get_default_attribute_value(PROPERTY_QNAME[12]);
            }
            return target;
        }
    }
    ...
    public void xsetHierarchy(XmlInt hierarchy) {
        ...
        synchronized (object) {
            ...
            target = (XmlInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[12]));
            if (target == null) {
                target = (XmlInt)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[12]));
            }
    ...
    public XmlUnsignedInt xgetLevel() {
        ...
        synchronized (object) {
            ...
            if (target == null) {
                target = (XmlUnsignedInt)this.get_default_attribute_value(PROPERTY_QNAME[13]);
            }
            return target;
        }
    }
