...
public class CTCustomPropertyImpl
extends XmlComplexContentImpl
implements CTCustomProperty {
    private static final long serialVersionUID = 1L;
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "name"), new QName("http://schemas.openxmlformats.org/officeDocument/2006/relationships", "id")};

    public CTCustomPropertyImpl(SchemaType sType) {
        super(sType);
    }
