...
implements CTFont {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "name"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "charset"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "family"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "b"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "i"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "strike"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "outline"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "shadow"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "condense"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extend"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "color"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "sz"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "u"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "vertAlign"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "scheme")};
    ...
    public List<CTFontName> getNameList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTFontName>(this::getNameArray, this::setNameArray, this::insertNewName, this::removeName, this::sizeOfNameArray);
        }
    }
    ...
    public List<CTFontFamily> getFamilyList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTFontFamily>(this::getFamilyArray, this::setFamilyArray, this::insertNewFamily, this::removeFamily, this::sizeOfFamilyArray);
        }
    }

    @Override
    public CTFontFamily[] getFamilyArray() {
        return (CTFontFamily[])this.getXmlObjectArray(PROPERTY_QNAME[2], new CTFontFamily[0]);
    }
    ...
    public CTFontFamily getFamilyArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTFontFamily target = null;
            target = (CTFontFamily)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], i));
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
    ...
    public CTFontFamily insertNewFamily(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTFontFamily target = null;
            target = (CTFontFamily)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[2], i));
            return target;
        }
    }
    ...
    public CTFontFamily addNewFamily() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTFontFamily target = null;
            target = (CTFontFamily)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
