...
implements CTIgnoredError {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "sqref"), new QName("", "evalError"), new QName("", "twoDigitTextYear"), new QName("", "numberStoredAsText"), new QName("", "formula"), new QName("", "formulaRange"), new QName("", "unlockedFormula"), new QName("", "emptyCellReference"), new QName("", "listDataValidation"), new QName("", "calculatedColumn")};
    ...
    public STSqref xgetSqref() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSqref target = null;
            target = (STSqref)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetSqref(STSqref sqref) {
        ...
        synchronized (object) {
            ...
            target = (STSqref)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STSqref)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(sqref);
        }
    }
