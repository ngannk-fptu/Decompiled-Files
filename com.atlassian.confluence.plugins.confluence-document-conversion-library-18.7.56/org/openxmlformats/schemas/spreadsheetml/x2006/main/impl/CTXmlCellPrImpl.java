...
implements CTXmlCellPr {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "xmlPr"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "id"), new QName("", "uniqueName")};
    ...
    public CTXmlPr getXmlPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTXmlPr target = null;
            target = (CTXmlPr)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setXmlPr(CTXmlPr xmlPr) {
        this.generatedSetterHelperImpl(xmlPr, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTXmlPr addNewXmlPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTXmlPr target = null;
            target = (CTXmlPr)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
