...
implements CTCalcCell {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "r"), new QName("", "ref"), new QName("", "i"), new QName("", "s"), new QName("", "l"), new QName("", "t"), new QName("", "a")};
    ...
    public XmlInt xgetI() {
        ...
        synchronized (object) {
            ...
            if (target == null) {
                target = (XmlInt)this.get_default_attribute_value(PROPERTY_QNAME[2]);
            }
            return target;
        }
    }
