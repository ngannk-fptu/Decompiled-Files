...
implements CTTableStyles {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "tableStyle"), new QName("", "count"), new QName("", "defaultTableStyle"), new QName("", "defaultPivotStyle")};
    ...
    public List<CTTableStyle> getTableStyleList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTTableStyle>(this::getTableStyleArray, this::setTableStyleArray, this::insertNewTableStyle, this::removeTableStyle, this::sizeOfTableStyleArray);
        }
    }
    ...
    public void setTableStyleArray(CTTableStyle[] tableStyleArray) {
        this.check_orphaned();
        this.arraySetterHelper(tableStyleArray, PROPERTY_QNAME[0]);
    }

    @Override
    public void setTableStyleArray(int i, CTTableStyle tableStyle) {
        this.generatedSetterHelperImpl(tableStyle, PROPERTY_QNAME[0], i, (short)2);
    }
