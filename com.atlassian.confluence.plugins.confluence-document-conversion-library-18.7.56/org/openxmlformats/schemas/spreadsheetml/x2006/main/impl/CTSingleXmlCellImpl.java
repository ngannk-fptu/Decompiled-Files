...
implements CTSingleXmlCell {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "xmlCellPr"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "id"), new QName("", "r"), new QName("", "connectionId")};
    ...
    public CTXmlCellPr getXmlCellPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTXmlCellPr target = null;
            target = (CTXmlCellPr)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setXmlCellPr(CTXmlCellPr xmlCellPr) {
        this.generatedSetterHelperImpl(xmlCellPr, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTXmlCellPr addNewXmlCellPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTXmlCellPr target = null;
            target = (CTXmlCellPr)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public STCellRef xgetR() {
        ...
        synchronized (object) {
            ...
            target = (STCellRef)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            return target;
        }
    }
    ...
    public void xsetR(STCellRef r) {
        ...
        synchronized (object) {
            ...
            target = (STCellRef)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            if (target == null) {
                target = (STCellRef)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[3]));
            }
            target.set(r);
        }
    }
