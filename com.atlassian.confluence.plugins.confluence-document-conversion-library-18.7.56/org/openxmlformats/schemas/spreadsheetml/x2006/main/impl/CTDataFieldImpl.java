...
implements CTDataField {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "name"), new QName("", "fld"), new QName("", "subtotal"), new QName("", "showDataAs"), new QName("", "baseField"), new QName("", "baseItem"), new QName("", "numFmtId")};
    ...
    public STDataConsolidateFunction.Enum getSubtotal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STDataConsolidateFunction.Enum)target.getEnumValue();
        }
    }
    ...
    public STDataConsolidateFunction xgetSubtotal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STDataConsolidateFunction target = null;
            target = (STDataConsolidateFunction)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            if (target == null) {
                target = (STDataConsolidateFunction)this.get_default_attribute_value(PROPERTY_QNAME[3]);
            }
            return target;
        }
    }
    ...
    public void xsetSubtotal(STDataConsolidateFunction subtotal) {
        ...
        synchronized (object) {
            ...
            target = (STDataConsolidateFunction)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            if (target == null) {
                target = (STDataConsolidateFunction)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[3]));
            }
            target.set(subtotal);
        }
    }
    ...
    public STShowDataAs.Enum getShowDataAs() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STShowDataAs.Enum)target.getEnumValue();
        }
    }
    ...
    public STShowDataAs xgetShowDataAs() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STShowDataAs target = null;
            target = (STShowDataAs)this.get_store().find_attribute_user(PROPERTY_QNAME[4]);
            if (target == null) {
                target = (STShowDataAs)this.get_default_attribute_value(PROPERTY_QNAME[4]);
            }
            return target;
        }
    }
    ...
    public void xsetShowDataAs(STShowDataAs showDataAs) {
        ...
        synchronized (object) {
            ...
            target = (STShowDataAs)this.get_store().find_attribute_user(PROPERTY_QNAME[4]);
            if (target == null) {
                target = (STShowDataAs)this.get_store().add_attribute_user(PROPERTY_QNAME[4]);
            }
            target.set((XmlObject)showDataAs);
        }
    }
    ...
    public XmlInt xgetBaseField() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlInt target = null;
            target = (XmlInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[5]));
            if (target == null) {
                target = (XmlInt)this.get_default_attribute_value(PROPERTY_QNAME[5]);
            }
            return target;
        }
    }
    ...
    public void xsetBaseField(XmlInt baseField) {
        ...
        synchronized (object) {
            ...
            target = (XmlInt)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[5]));
            if (target == null) {
                target = (XmlInt)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[5]));
            }
    ...
    public STNumFmtId xgetNumFmtId() {
        ...
        synchronized (object) {
            ...
            target = (STNumFmtId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[7]));
            return target;
        }
    }
    ...
    public void xsetNumFmtId(STNumFmtId numFmtId) {
        ...
        synchronized (object) {
            ...
            target = (STNumFmtId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[7]));
            if (target == null) {
                target = (STNumFmtId)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[7]));
            }
            target.set(numFmtId);
        }
    }
