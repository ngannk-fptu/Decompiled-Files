...
implements CTBorders {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "border"), new QName("", "count")};
    ...
    public List<CTBorder> getBorderList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTBorder>(this::getBorderArray, this::setBorderArray, this::insertNewBorder, this::removeBorder, this::sizeOfBorderArray);
        }
    }

    @Override
    public CTBorder[] getBorderArray() {
        return (CTBorder[])this.getXmlObjectArray(PROPERTY_QNAME[0], new CTBorder[0]);
    }
    ...
    public CTBorder getBorderArray(int i) {
        ...
        synchronized (object) {
            ...
            target = (CTBorder)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], i));
            if (target == null) {
    ...
    public void setBorderArray(CTBorder[] borderArray) {
        this.check_orphaned();
        this.arraySetterHelper(borderArray, PROPERTY_QNAME[0]);
    }

    @Override
    public void setBorderArray(int i, CTBorder border) {
        this.generatedSetterHelperImpl(border, PROPERTY_QNAME[0], i, (short)2);
    }
    ...
    public CTBorder insertNewBorder(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBorder target = null;
            target = (CTBorder)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[0], i));
            return target;
        }
    }
