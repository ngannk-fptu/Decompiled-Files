...
public class CTWebPublishingImpl
extends XmlComplexContentImpl
implements CTWebPublishing {
    private static final long serialVersionUID = 1L;
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "css"), new QName("", "thicket"), new QName("", "longFileNames"), new QName("", "vml"), new QName("", "allowPng"), new QName("", "targetScreenSize"), new QName("", "dpi"), new QName("", "codePage"), new QName("", "characterSet")};
    ...
    public STTargetScreenSize.Enum getTargetScreenSize() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STTargetScreenSize.Enum)target.getEnumValue();
        }
    }
    ...
    public STTargetScreenSize xgetTargetScreenSize() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STTargetScreenSize target = null;
            target = (STTargetScreenSize)this.get_store().find_attribute_user(PROPERTY_QNAME[5]);
            if (target == null) {
                target = (STTargetScreenSize)this.get_default_attribute_value(PROPERTY_QNAME[5]);
            }
            return target;
        }
    }
    ...
    public void xsetTargetScreenSize(STTargetScreenSize targetScreenSize) {
        ...
        synchronized (object) {
            ...
            target = (STTargetScreenSize)this.get_store().find_attribute_user(PROPERTY_QNAME[5]);
            if (target == null) {
                target = (STTargetScreenSize)this.get_store().add_attribute_user(PROPERTY_QNAME[5]);
            }
