...
implements CTExternalBook {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "sheetNames"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "definedNames"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "sheetDataSet"), new QName("http://schemas.openxmlformats.org/officeDocument/2006/relationships", "id")};
    ...
    public CTExternalSheetNames getSheetNames() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTExternalSheetNames target = null;
            target = (CTExternalSheetNames)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setSheetNames(CTExternalSheetNames sheetNames) {
        this.generatedSetterHelperImpl(sheetNames, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTExternalSheetNames addNewSheetNames() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTExternalSheetNames target = null;
            target = (CTExternalSheetNames)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public CTExternalDefinedNames getDefinedNames() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTExternalDefinedNames target = null;
            target = (CTExternalDefinedNames)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setDefinedNames(CTExternalDefinedNames definedNames) {
        this.generatedSetterHelperImpl(definedNames, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTExternalDefinedNames addNewDefinedNames() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTExternalDefinedNames target = null;
            target = (CTExternalDefinedNames)((Object)this.get_store().add_element_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
    ...
    public CTExternalSheetDataSet getSheetDataSet() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTExternalSheetDataSet target = null;
            target = (CTExternalSheetDataSet)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setSheetDataSet(CTExternalSheetDataSet sheetDataSet) {
        this.generatedSetterHelperImpl(sheetDataSet, PROPERTY_QNAME[2], 0, (short)1);
    }
    ...
    public CTExternalSheetDataSet addNewSheetDataSet() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTExternalSheetDataSet target = null;
            target = (CTExternalSheetDataSet)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
