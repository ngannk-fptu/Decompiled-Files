...
implements CTExternalLink {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "externalBook"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "ddeLink"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "oleLink"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst")};
    ...
    public CTExternalBook getExternalBook() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTExternalBook target = null;
            target = (CTExternalBook)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setExternalBook(CTExternalBook externalBook) {
        this.generatedSetterHelperImpl(externalBook, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTExternalBook addNewExternalBook() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTExternalBook target = null;
            target = (CTExternalBook)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public CTDdeLink getDdeLink() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTDdeLink target = null;
            target = (CTDdeLink)this.get_store().find_element_user(PROPERTY_QNAME[1], 0);
            return target == null ? null : target;
        }
    }
    ...
    public void setDdeLink(CTDdeLink ddeLink) {
        this.generatedSetterHelperImpl((XmlObject)ddeLink, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTDdeLink addNewDdeLink() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTDdeLink target = null;
            target = (CTDdeLink)this.get_store().add_element_user(PROPERTY_QNAME[1]);
            return target;
        }
    }
    ...
    public CTOleLink getOleLink() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTOleLink target = null;
            target = (CTOleLink)this.get_store().find_element_user(PROPERTY_QNAME[2], 0);
            return target == null ? null : target;
        }
    }
    ...
    public void setOleLink(CTOleLink oleLink) {
        this.generatedSetterHelperImpl((XmlObject)oleLink, PROPERTY_QNAME[2], 0, (short)1);
    }
    ...
    public CTOleLink addNewOleLink() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTOleLink target = null;
            target = (CTOleLink)this.get_store().add_element_user(PROPERTY_QNAME[2]);
            return target;
        }
    }
