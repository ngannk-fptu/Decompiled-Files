...
implements CTOleObject {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "objectPr"), new QName("", "progId"), new QName("", "dvAspect"), new QName("", "link"), new QName("", "oleUpdate"), new QName("", "autoLoad"), new QName("", "shapeId"), new QName("http://schemas.openxmlformats.org/officeDocument/2006/relationships", "id")};
    ...
    public CTObjectPr getObjectPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTObjectPr target = null;
            target = (CTObjectPr)this.get_store().find_element_user(PROPERTY_QNAME[0], 0);
    ...
    public void setObjectPr(CTObjectPr objectPr) {
        this.generatedSetterHelperImpl((XmlObject)objectPr, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTObjectPr addNewObjectPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTObjectPr target = null;
            target = (CTObjectPr)this.get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
    ...
    public STDvAspect.Enum getDvAspect() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STDvAspect.Enum)target.getEnumValue();
        }
    }
    ...
    public STDvAspect xgetDvAspect() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STDvAspect target = null;
            target = (STDvAspect)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[2]));
            if (target == null) {
                target = (STDvAspect)this.get_default_attribute_value(PROPERTY_QNAME[2]);
            }
            return target;
        }
    }
    ...
    public void xsetDvAspect(STDvAspect dvAspect) {
        ...
        synchronized (object) {
            ...
            target = (STDvAspect)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[2]));
            if (target == null) {
                target = (STDvAspect)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[2]));
            }
            target.set(dvAspect);
        }
    }
    ...
    public STOleUpdate.Enum getOleUpdate() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STOleUpdate.Enum)target.getEnumValue();
        }
    }
    ...
    public STOleUpdate xgetOleUpdate() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STOleUpdate target = null;
            target = (STOleUpdate)this.get_store().find_attribute_user(PROPERTY_QNAME[4]);
            return target;
        }
    }
    ...
    public void xsetOleUpdate(STOleUpdate oleUpdate) {
        ...
        synchronized (object) {
            ...
            target = (STOleUpdate)this.get_store().find_attribute_user(PROPERTY_QNAME[4]);
            if (target == null) {
                target = (STOleUpdate)this.get_store().add_attribute_user(PROPERTY_QNAME[4]);
            }
            target.set((XmlObject)oleUpdate);
        }
    }
    ...
    public STRelationshipId xgetId() {
        ...
        synchronized (object) {
            ...
            target = (STRelationshipId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[7]));
            return target;
        }
    }
    ...
    public void xsetId(STRelationshipId id) {
        ...
        synchronized (object) {
            ...
            target = (STRelationshipId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[7]));
            if (target == null) {
                target = (STRelationshipId)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[7]));
            }
            target.set(id);
        }
    }
