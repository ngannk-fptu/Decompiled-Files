...
implements CTXmlColumnPr {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "mapId"), new QName("", "xpath"), new QName("", "denormalized"), new QName("", "xmlDataType")};
    ...
    public STXmlDataType xgetXmlDataType() {
        ...
        synchronized (object) {
            ...
            target = (STXmlDataType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[4]));
            return target;
        }
    }
    ...
    public void xsetXmlDataType(STXmlDataType xmlDataType) {
        ...
        synchronized (object) {
            ...
            target = (STXmlDataType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[4]));
            if (target == null) {
                target = (STXmlDataType)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[4]));
            }
