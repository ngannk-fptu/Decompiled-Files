...
implements CTTableStyle {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "tableStyleElement"), new QName("", "name"), new QName("", "pivot"), new QName("", "table"), new QName("", "count")};
    ...
    public List<CTTableStyleElement> getTableStyleElementList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTTableStyleElement>(this::getTableStyleElementArray, this::setTableStyleElementArray, this::insertNewTableStyleElement, this::removeTableStyleElement, this::sizeOfTableStyleElementArray);
        }
    }

    @Override
    public CTTableStyleElement[] getTableStyleElementArray() {
        return (CTTableStyleElement[])this.getXmlObjectArray(PROPERTY_QNAME[0], new CTTableStyleElement[0]);
    }
    ...
    public CTTableStyleElement getTableStyleElementArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTableStyleElement target = null;
            target = (CTTableStyleElement)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], i));
            if (target == null) {
    ...
    public void setTableStyleElementArray(CTTableStyleElement[] tableStyleElementArray) {
        this.check_orphaned();
        this.arraySetterHelper(tableStyleElementArray, PROPERTY_QNAME[0]);
    }

    @Override
    public void setTableStyleElementArray(int i, CTTableStyleElement tableStyleElement) {
        this.generatedSetterHelperImpl(tableStyleElement, PROPERTY_QNAME[0], i, (short)2);
    }
    ...
    public CTTableStyleElement insertNewTableStyleElement(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTableStyleElement target = null;
            target = (CTTableStyleElement)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[0], i));
            return target;
        }
    }
    ...
    public CTTableStyleElement addNewTableStyleElement() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTableStyleElement target = null;
            target = (CTTableStyleElement)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
