...
public class CTPivotCacheImpl
extends XmlComplexContentImpl
implements CTPivotCache {
    private static final long serialVersionUID = 1L;
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "cacheId"), new QName("http://schemas.openxmlformats.org/officeDocument/2006/relationships", "id")};

    public CTPivotCacheImpl(SchemaType sType) {
        super(sType);
    }
