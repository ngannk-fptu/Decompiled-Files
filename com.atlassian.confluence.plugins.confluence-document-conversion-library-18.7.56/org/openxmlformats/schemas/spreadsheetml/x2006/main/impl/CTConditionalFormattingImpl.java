...
implements CTConditionalFormatting {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "cfRule"), new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "extLst"), new QName("", "pivot"), new QName("", "sqref")};
    ...
    public List<CTCfRule> getCfRuleList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTCfRule>(this::getCfRuleArray, this::setCfRuleArray, this::insertNewCfRule, this::removeCfRule, this::sizeOfCfRuleArray);
        }
    }

    @Override
    public CTCfRule[] getCfRuleArray() {
        return (CTCfRule[])this.getXmlObjectArray(PROPERTY_QNAME[0], new CTCfRule[0]);
    }
    ...
    public CTCfRule getCfRuleArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTCfRule target = null;
            target = (CTCfRule)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], i));
            if (target == null) {
    ...
    public void setCfRuleArray(CTCfRule[] cfRuleArray) {
        this.check_orphaned();
        this.arraySetterHelper(cfRuleArray, PROPERTY_QNAME[0]);
    }

    @Override
    public void setCfRuleArray(int i, CTCfRule cfRule) {
        this.generatedSetterHelperImpl(cfRule, PROPERTY_QNAME[0], i, (short)2);
    }
    ...
    public CTCfRule insertNewCfRule(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTCfRule target = null;
            target = (CTCfRule)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[0], i));
            return target;
        }
    }
    ...
    public CTCfRule addNewCfRule() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTCfRule target = null;
            target = (CTCfRule)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
