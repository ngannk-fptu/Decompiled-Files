...
implements CTTableStyleInfo {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "name"), new QName("", "showFirstColumn"), new QName("", "showLastColumn"), new QName("", "showRowStripes"), new QName("", "showColumnStripes")};
