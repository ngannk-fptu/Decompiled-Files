...
implements CTCalcPr {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("", "calcId"), new QName("", "calcMode"), new QName("", "fullCalcOnLoad"), new QName("", "refMode"), new QName("", "iterate"), new QName("", "iterateCount"), new QName("", "iterateDelta"), new QName("", "fullPrecision"), new QName("", "calcCompleted"), new QName("", "calcOnSave"), new QName("", "concurrentCalc"), new QName("", "concurrentManualCount"), new QName("", "forceFullCalc")};
    ...
    public STCalcMode.Enum getCalcMode() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STCalcMode.Enum)target.getEnumValue();
        }
    }
    ...
    public STCalcMode xgetCalcMode() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STCalcMode target = null;
            target = (STCalcMode)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[1]));
            if (target == null) {
                target = (STCalcMode)this.get_default_attribute_value(PROPERTY_QNAME[1]);
            }
            return target;
        }
    }
    ...
    public void xsetCalcMode(STCalcMode calcMode) {
        ...
        synchronized (object) {
            ...
            target = (STCalcMode)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[1]));
            if (target == null) {
                target = (STCalcMode)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[1]));
            }
            target.set(calcMode);
        }
    }
    ...
    public STRefMode.Enum getRefMode() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STRefMode.Enum)target.getEnumValue();
        }
    }
    ...
    public STRefMode xgetRefMode() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STRefMode target = null;
            target = (STRefMode)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            if (target == null) {
                target = (STRefMode)this.get_default_attribute_value(PROPERTY_QNAME[3]);
            }
            return target;
        }
    }
    ...
    public void xsetRefMode(STRefMode refMode) {
        ...
        synchronized (object) {
            ...
            target = (STRefMode)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            if (target == null) {
                target = (STRefMode)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[3]));
            }
            target.set(refMode);
        }
    }
    ...
    public XmlDouble xgetIterateDelta() {
        ...
        synchronized (object) {
            ...
            if (target == null) {
                target = (XmlDouble)this.get_default_attribute_value(PROPERTY_QNAME[6]);
            }
            return target;
        }
    }
