...
extends CTTrackChange {
    public static final DocumentFactory<CTComment> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctcomment6a93type");
    ...
    public void xsetInitials(STString var1);
