...
extends XmlObject {
    public static final DocumentFactory<CTP> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctpa1e2type");
    ...
    public void setRsidP(byte[] var1);

    public void xsetRsidP(STLongHexNumber var1);
    ...
    public void setRsidRDefault(byte[] var1);

    public void xsetRsidRDefault(STLongHexNumber var1);
