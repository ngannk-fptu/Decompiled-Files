...
public interface STTblOverlap
extends XmlString {
    public static final SimpleTypeFactory<STTblOverlap> Factory = new SimpleTypeFactory(TypeSystemHolder.typeSystem, "sttbloverlapb50ftype");
