...
public interface CTSdtContentCell
extends XmlObject {
    public static final DocumentFactory<CTSdtContentCell> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctsdtcontentcellb170type");
