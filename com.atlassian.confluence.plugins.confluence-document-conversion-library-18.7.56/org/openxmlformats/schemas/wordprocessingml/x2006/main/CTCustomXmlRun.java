...
public interface CTCustomXmlRun
extends XmlObject {
    public static final DocumentFactory<CTCustomXmlRun> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctcustomxmlrun1ac3type");
    ...
    public void setCustomXmlPr(CTCustomXmlPr var1);
    ...
    public void setElement(String var1);

    public void xsetElement(STXmlName var1);
}
