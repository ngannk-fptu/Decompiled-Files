...
public interface CTDirContentRun
extends XmlObject {
    public static final DocumentFactory<CTDirContentRun> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctdircontentrun2173type");
    ...
    public void setVal(STDirection.Enum var1);

    public void xsetVal(STDirection var1);
