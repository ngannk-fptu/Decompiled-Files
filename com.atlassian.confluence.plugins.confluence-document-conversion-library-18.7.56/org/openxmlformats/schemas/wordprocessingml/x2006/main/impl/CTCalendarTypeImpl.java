...
public class CTCalendarTypeImpl
extends XmlComplexContentImpl
implements CTCalendarType {
    ...
    public STCalendarType.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STCalendarType.Enum)target.getEnumValue();
        }
    }
    ...
    public STCalendarType xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STCalendarType target = null;
            target = (STCalendarType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STCalendarType val) {
        ...
        synchronized (object) {
            ...
            target = (STCalendarType)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STCalendarType)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
