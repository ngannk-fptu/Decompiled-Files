...
public class CTNumRestartImpl
extends XmlComplexContentImpl
implements CTNumRestart {
    ...
    public STRestartNumber.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STRestartNumber.Enum)target.getEnumValue();
        }
    }
    ...
    public STRestartNumber xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STRestartNumber target = null;
            target = (STRestartNumber)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STRestartNumber val) {
        ...
        synchronized (object) {
            ...
            target = (STRestartNumber)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STRestartNumber)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
