...
implements CTTblPrEx {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "tblPrExChange")};
    ...
    public CTTblPrExChange getTblPrExChange() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTblPrExChange target = null;
            target = (CTTblPrExChange)this.get_store().find_element_user(PROPERTY_QNAME[0], 0);
    ...
    public void setTblPrExChange(CTTblPrExChange tblPrExChange) {
        this.generatedSetterHelperImpl((XmlObject)tblPrExChange, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTTblPrExChange addNewTblPrExChange() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTblPrExChange target = null;
            target = (CTTblPrExChange)this.get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
