...
implements CTHighlight {
    ...
    public STHighlightColor.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STHighlightColor.Enum)target.getEnumValue();
        }
    }
    ...
    public STHighlightColor xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STHighlightColor target = null;
            target = (STHighlightColor)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STHighlightColor val) {
        ...
        synchronized (object) {
            ...
            target = (STHighlightColor)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STHighlightColor)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
