...
implements CTBody {
    ...
    public CTBodyImpl(SchemaType sType) {
        super(sType);
    }
    ...
    public CTSectPr getSectPr() {
        ...
        synchronized (object) {
            ...
            target = (CTSectPr)((Object)this.get_store().find_element_user(PROPERTY_QNAME[30], 0));
    ...
    public void setSectPr(CTSectPr sectPr) {
        this.generatedSetterHelperImpl(sectPr, PROPERTY_QNAME[30], 0, (short)1);
    }
    ...
    public CTSectPr addNewSectPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSectPr target = null;
            target = (CTSectPr)((Object)this.get_store().add_element_user(PROPERTY_QNAME[30]));
            return target;
        }
    }
