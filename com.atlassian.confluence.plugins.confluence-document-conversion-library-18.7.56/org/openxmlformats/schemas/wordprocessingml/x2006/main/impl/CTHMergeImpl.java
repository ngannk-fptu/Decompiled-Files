...
implements CTHMerge {
    ...
    public CTHMergeImpl(SchemaType sType) {
        super(sType);
    }
    ...
    public STMerge.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STMerge.Enum)target.getEnumValue();
        }
    }
    ...
    public STMerge xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STMerge target = null;
            target = (STMerge)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STMerge val) {
        ...
        synchronized (object) {
            ...
            target = (STMerge)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STMerge)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
