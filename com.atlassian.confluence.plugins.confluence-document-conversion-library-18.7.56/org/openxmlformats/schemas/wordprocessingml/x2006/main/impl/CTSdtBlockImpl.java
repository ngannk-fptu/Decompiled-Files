...
implements CTSdtBlock {
    ...
    public CTSdtContentBlock getSdtContent() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSdtContentBlock target = null;
            target = (CTSdtContentBlock)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], 0));
            return target == null ? null : target;
        }
    }
    ...
    public CTSdtContentBlock addNewSdtContent() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSdtContentBlock target = null;
            target = (CTSdtContentBlock)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
