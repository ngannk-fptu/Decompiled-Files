...
public class CTJcTableImpl
extends XmlComplexContentImpl
implements CTJcTable {
    ...
    public STJcTable.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STJcTable.Enum)target.getEnumValue();
        }
    }
    ...
    public STJcTable xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STJcTable target = null;
            target = (STJcTable)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STJcTable val) {
        ...
        synchronized (object) {
            ...
            target = (STJcTable)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STJcTable)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
