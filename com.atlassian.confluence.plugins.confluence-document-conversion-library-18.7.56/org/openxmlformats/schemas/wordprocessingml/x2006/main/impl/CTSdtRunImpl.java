...
implements CTSdtRun {
    ...
    public CTSdtContentRun getSdtContent() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSdtContentRun target = null;
            target = (CTSdtContentRun)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], 0));
            return target == null ? null : target;
        }
    }
    ...
    public CTSdtContentRun addNewSdtContent() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSdtContentRun target = null;
            target = (CTSdtContentRun)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
