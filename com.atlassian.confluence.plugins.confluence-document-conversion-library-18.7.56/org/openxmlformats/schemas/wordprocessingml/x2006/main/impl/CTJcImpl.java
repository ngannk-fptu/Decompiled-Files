...
implements CTJc {
    ...
    public STJc.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STJc.Enum)target.getEnumValue();
        }
    }
    ...
    public STJc xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STJc target = null;
            target = (STJc)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STJc val) {
        ...
        synchronized (object) {
            ...
            target = (STJc)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STJc)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
