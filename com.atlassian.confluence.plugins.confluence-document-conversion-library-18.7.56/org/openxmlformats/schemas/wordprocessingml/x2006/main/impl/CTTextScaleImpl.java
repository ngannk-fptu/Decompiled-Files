...
public class CTTextScaleImpl
extends XmlComplexContentImpl
implements CTTextScale {
    ...
    public STTextScale xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STTextScale target = null;
            target = (STTextScale)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STTextScale val) {
        ...
        synchronized (object) {
            ...
            target = (STTextScale)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STTextScale)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
