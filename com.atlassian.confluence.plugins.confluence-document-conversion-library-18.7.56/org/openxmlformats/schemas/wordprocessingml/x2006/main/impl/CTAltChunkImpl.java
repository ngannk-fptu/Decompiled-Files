...
public class CTAltChunkImpl
extends XmlComplexContentImpl
implements CTAltChunk {
    private static final long serialVersionUID = 1L;
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "altChunkPr"), new QName("http://schemas.openxmlformats.org/officeDocument/2006/relationships", "id")};
    ...
    public CTAltChunkPr getAltChunkPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTAltChunkPr target = null;
            target = (CTAltChunkPr)this.get_store().find_element_user(PROPERTY_QNAME[0], 0);
    ...
    public void setAltChunkPr(CTAltChunkPr altChunkPr) {
        this.generatedSetterHelperImpl((XmlObject)altChunkPr, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTAltChunkPr addNewAltChunkPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTAltChunkPr target = null;
            target = (CTAltChunkPr)this.get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
