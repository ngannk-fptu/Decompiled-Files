...
implements CTHpsMeasure {
    ...
    public STHpsMeasure xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STHpsMeasure target = null;
            target = (STHpsMeasure)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STHpsMeasure val) {
        ...
        synchronized (object) {
            ...
            target = (STHpsMeasure)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STHpsMeasure)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
