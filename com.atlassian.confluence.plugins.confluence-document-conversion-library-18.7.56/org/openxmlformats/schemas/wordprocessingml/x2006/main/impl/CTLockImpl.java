...
implements CTLock {
    ...
    public STLock.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STLock.Enum)target.getEnumValue();
        }
    }
    ...
    public STLock xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STLock target = null;
            target = (STLock)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
     ...
     */
    @Override
    public void setVal(STLock.Enum val) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue target = null;
     ...
     */
    @Override
    public void xsetVal(STLock val) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            STLock target = null;
            target = (STLock)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STLock)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
