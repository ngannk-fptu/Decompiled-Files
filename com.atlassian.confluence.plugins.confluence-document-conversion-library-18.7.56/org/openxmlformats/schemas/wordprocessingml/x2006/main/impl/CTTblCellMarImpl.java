...
implements CTTblCellMar {
    ...
    public CTTblCellMarImpl(SchemaType sType) {
        super(sType);
    }
    ...
    public CTTblWidth getEnd() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTblWidth target = null;
            target = (CTTblWidth)((Object)this.get_store().find_element_user(PROPERTY_QNAME[4], 0));
            return target == null ? null : target;
        }
    }
    ...
    public CTTblWidth getRight() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTblWidth target = null;
            target = (CTTblWidth)((Object)this.get_store().find_element_user(PROPERTY_QNAME[5], 0));
            return target == null ? null : target;
        }
    }
