...
implements CTUnderline {
    ...
    public STUnderline.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STUnderline.Enum)target.getEnumValue();
        }
    }
    ...
    public STUnderline xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STUnderline target = null;
            target = (STUnderline)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STUnderline val) {
        ...
        synchronized (object) {
            ...
            target = (STUnderline)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STUnderline)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
