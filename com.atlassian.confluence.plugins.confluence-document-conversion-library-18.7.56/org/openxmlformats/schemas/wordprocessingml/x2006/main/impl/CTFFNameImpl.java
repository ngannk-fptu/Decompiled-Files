...
implements CTFFName {
    ...
    public STFFName xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STFFName target = null;
            target = (STFFName)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STFFName val) {
        ...
        synchronized (object) {
            ...
            target = (STFFName)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STFFName)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
