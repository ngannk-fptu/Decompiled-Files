...
implements CTTextAlignment {
    ...
    public STTextAlignment.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STTextAlignment.Enum)target.getEnumValue();
        }
    }
    ...
    public STTextAlignment xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STTextAlignment target = null;
            target = (STTextAlignment)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STTextAlignment val) {
        ...
        synchronized (object) {
            ...
            target = (STTextAlignment)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STTextAlignment)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
