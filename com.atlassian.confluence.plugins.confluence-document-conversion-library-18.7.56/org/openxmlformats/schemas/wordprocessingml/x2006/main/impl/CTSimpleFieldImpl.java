...
implements CTSimpleField {
    ...
    public STOnOff xgetFldLock() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STOnOff target = null;
            target = (STOnOff)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[36]));
            return target;
        }
    }
    ...
    public void xsetFldLock(STOnOff fldLock) {
        ...
        synchronized (object) {
            ...
            target = (STOnOff)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[36]));
            if (target == null) {
                target = (STOnOff)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[36]));
            }
            target.set(fldLock);
        }
    }
