...
implements HdrDocument {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "hdr")};
    ...
    public void setHdr(CTHdrFtr hdr) {
        this.generatedSetterHelperImpl(hdr, PROPERTY_QNAME[0], 0, (short)1);
    }
