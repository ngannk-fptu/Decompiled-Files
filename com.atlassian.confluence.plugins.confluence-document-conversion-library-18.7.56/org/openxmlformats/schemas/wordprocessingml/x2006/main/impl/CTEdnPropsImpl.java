...
public class CTEdnPropsImpl
extends XmlComplexContentImpl
implements CTEdnProps {
    ...
    public CTEdnPos getPos() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTEdnPos target = null;
            target = (CTEdnPos)this.get_store().find_element_user(PROPERTY_QNAME[0], 0);
    ...
    public void setPos(CTEdnPos pos) {
        this.generatedSetterHelperImpl((XmlObject)pos, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTEdnPos addNewPos() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTEdnPos target = null;
            target = (CTEdnPos)this.get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
    ...
    public void setNumStart(CTDecimalNumber numStart) {
        this.generatedSetterHelperImpl(numStart, PROPERTY_QNAME[2], 0, (short)1);
    }
    ...
    public CTNumRestart getNumRestart() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTNumRestart target = null;
            target = (CTNumRestart)((Object)this.get_store().find_element_user(PROPERTY_QNAME[3], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setNumRestart(CTNumRestart numRestart) {
        this.generatedSetterHelperImpl(numRestart, PROPERTY_QNAME[3], 0, (short)1);
    }
    ...
    public CTNumRestart addNewNumRestart() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTNumRestart target = null;
            target = (CTNumRestart)((Object)this.get_store().add_element_user(PROPERTY_QNAME[3]));
            return target;
        }
    }
