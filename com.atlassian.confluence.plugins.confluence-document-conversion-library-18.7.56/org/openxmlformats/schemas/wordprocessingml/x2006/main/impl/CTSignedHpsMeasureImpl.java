...
implements CTSignedHpsMeasure {
    ...
    public STSignedHpsMeasure xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSignedHpsMeasure target = null;
            target = (STSignedHpsMeasure)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public void xsetVal(STSignedHpsMeasure val) {
        ...
        synchronized (object) {
            ...
            target = (STSignedHpsMeasure)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STSignedHpsMeasure)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
