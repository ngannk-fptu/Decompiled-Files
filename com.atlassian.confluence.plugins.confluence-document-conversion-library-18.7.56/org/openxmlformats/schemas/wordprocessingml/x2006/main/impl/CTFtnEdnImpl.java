...
implements CTFtnEdn {
    ...
    public STFtnEdn.Enum getType() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STFtnEdn.Enum)target.getEnumValue();
        }
    }
    ...
    public STFtnEdn xgetType() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STFtnEdn target = null;
            target = (STFtnEdn)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[30]));
            return target;
        }
    }
    ...
    public void xsetType(STFtnEdn type) {
        ...
        synchronized (object) {
            ...
            target = (STFtnEdn)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[30]));
            if (target == null) {
                target = (STFtnEdn)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[30]));
            }
            target.set(type);
        }
    }
    ...
    public STDecimalNumber xgetId() {
        ...
        synchronized (object) {
            ...
            target = (STDecimalNumber)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[31]));
            return target;
        }
    }
    ...
    public void xsetId(STDecimalNumber id) {
        ...
        synchronized (object) {
            ...
            target = (STDecimalNumber)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[31]));
            if (target == null) {
                target = (STDecimalNumber)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[31]));
            }
            target.set(id);
        }
    }
