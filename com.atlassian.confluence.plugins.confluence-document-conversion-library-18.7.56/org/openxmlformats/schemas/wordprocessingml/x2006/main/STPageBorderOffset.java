...
public interface STPageBorderOffset
extends XmlString {
    public static final SimpleTypeFactory<STPageBorderOffset> Factory = new SimpleTypeFactory(TypeSystemHolder.typeSystem, "stpageborderoffset518atype");
