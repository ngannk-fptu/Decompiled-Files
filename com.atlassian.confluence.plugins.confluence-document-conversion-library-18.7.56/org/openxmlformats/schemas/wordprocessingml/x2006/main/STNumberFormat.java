...
public interface STNumberFormat
extends XmlString {
    public static final SimpleTypeFactory<STNumberFormat> Factory = new SimpleTypeFactory(TypeSystemHolder.typeSystem, "stnumberformat0fb8type");
    ...
    public static final Enum BAHT_TEXT = Enum.forString("bahtText");
    public static final Enum DOLLAR_TEXT = Enum.forString("dollarText");
