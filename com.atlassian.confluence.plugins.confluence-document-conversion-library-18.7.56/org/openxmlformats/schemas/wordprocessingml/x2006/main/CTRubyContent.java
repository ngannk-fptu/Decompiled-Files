...
public interface CTRubyContent
extends XmlObject {
    public static final DocumentFactory<CTRubyContent> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctrubycontent1d33type");
