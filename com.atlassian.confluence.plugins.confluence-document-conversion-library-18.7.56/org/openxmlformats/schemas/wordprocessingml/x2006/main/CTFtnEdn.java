...
public interface CTFtnEdn
extends XmlObject {
    public static final DocumentFactory<CTFtnEdn> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctftnedncad9type");
    ...
    public void setType(STFtnEdn.Enum var1);

    public void xsetType(STFtnEdn var1);
