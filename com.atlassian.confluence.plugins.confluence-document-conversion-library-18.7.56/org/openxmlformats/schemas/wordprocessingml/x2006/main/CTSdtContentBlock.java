...
public interface CTSdtContentBlock
extends XmlObject {
    public static final DocumentFactory<CTSdtContentBlock> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctsdtcontentblockb37btype");
