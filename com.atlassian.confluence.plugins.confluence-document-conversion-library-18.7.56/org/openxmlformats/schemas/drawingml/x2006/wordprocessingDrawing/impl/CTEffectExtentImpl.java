...
public class CTEffectExtentImpl
extends XmlComplexContentImpl
implements CTEffectExtent {
    ...
    public STCoordinate xgetB() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STCoordinate target = null;
            target = (STCoordinate)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            return target;
        }
    }
    ...
    public void xsetB(STCoordinate b) {
        ...
        synchronized (object) {
            ...
            target = (STCoordinate)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            if (target == null) {
                target = (STCoordinate)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[3]));
            }
            target.set(b);
        }
    }
