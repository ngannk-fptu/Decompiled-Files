...
public interface STLayoutMode
extends XmlString {
    public static final SimpleTypeFactory<STLayoutMode> Factory = new SimpleTypeFactory(TypeSystemHolder.typeSystem, "stlayoutmode19dftype");
