...
implements CTMarker {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "symbol"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "size"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "spPr"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "extLst")};
    ...
    public CTMarkerStyle getSymbol() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTMarkerStyle target = null;
            target = (CTMarkerStyle)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setSymbol(CTMarkerStyle symbol) {
        this.generatedSetterHelperImpl(symbol, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTMarkerStyle addNewSymbol() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTMarkerStyle target = null;
            target = (CTMarkerStyle)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public CTMarkerSize getSize() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTMarkerSize target = null;
            target = (CTMarkerSize)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setSize(CTMarkerSize size) {
        this.generatedSetterHelperImpl(size, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTMarkerSize addNewSize() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTMarkerSize target = null;
            target = (CTMarkerSize)((Object)this.get_store().add_element_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
