...
implements CTOverlap {
    ...
    public STOverlap xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STOverlap target = null;
            target = (STOverlap)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STOverlap)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
    ...
    public void xsetVal(STOverlap val) {
        ...
        synchronized (object) {
            ...
            target = (STOverlap)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STOverlap)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
