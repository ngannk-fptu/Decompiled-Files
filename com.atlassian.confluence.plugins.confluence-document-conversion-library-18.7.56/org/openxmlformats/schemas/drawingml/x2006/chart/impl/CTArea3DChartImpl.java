...
implements CTArea3DChart {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "grouping"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "varyColors"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "ser"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "dLbls"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "dropLines"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "gapDepth"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "axId"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "extLst")};

    public CTArea3DChartImpl(SchemaType sType) {
        super(sType);
    }
    ...
    public CTGrouping getGrouping() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTGrouping target = null;
            target = (CTGrouping)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setGrouping(CTGrouping grouping) {
        this.generatedSetterHelperImpl(grouping, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTGrouping addNewGrouping() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTGrouping target = null;
            target = (CTGrouping)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public List<CTAreaSer> getSerList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTAreaSer>(this::getSerArray, this::setSerArray, this::insertNewSer, this::removeSer, this::sizeOfSerArray);
        }
    }

    @Override
    public CTAreaSer[] getSerArray() {
        return (CTAreaSer[])this.getXmlObjectArray(PROPERTY_QNAME[2], new CTAreaSer[0]);
    }
    ...
    public CTAreaSer getSerArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTAreaSer target = null;
            target = (CTAreaSer)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], i));
            if (target == null) {
    ...
    public CTAreaSer insertNewSer(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTAreaSer target = null;
            target = (CTAreaSer)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[2], i));
            return target;
        }
    }
    ...
    public CTAreaSer addNewSer() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTAreaSer target = null;
            target = (CTAreaSer)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
    ...
    public void setDropLines(CTChartLines dropLines) {
        this.generatedSetterHelperImpl(dropLines, PROPERTY_QNAME[4], 0, (short)1);
    }
    ...
    public void setGapDepth(CTGapAmount gapDepth) {
        this.generatedSetterHelperImpl(gapDepth, PROPERTY_QNAME[5], 0, (short)1);
    }
    ...
    public CTUnsignedInt[] getAxIdArray() {
        return (CTUnsignedInt[])this.getXmlObjectArray(PROPERTY_QNAME[6], new CTUnsignedInt[0]);
    }
    ...
    public CTUnsignedInt getAxIdArray(int i) {
        ...
        synchronized (object) {
            ...
            target = (CTUnsignedInt)((Object)this.get_store().find_element_user(PROPERTY_QNAME[6], i));
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
    ...
    public void setAxIdArray(CTUnsignedInt[] axIdArray) {
        this.check_orphaned();
        this.arraySetterHelper(axIdArray, PROPERTY_QNAME[6]);
    }

    @Override
    public void setAxIdArray(int i, CTUnsignedInt axId) {
        this.generatedSetterHelperImpl(axId, PROPERTY_QNAME[6], i, (short)2);
    }
    ...
    public CTUnsignedInt insertNewAxId(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTUnsignedInt target = null;
            target = (CTUnsignedInt)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[6], i));
            return target;
        }
    }
    ...
    public CTUnsignedInt addNewAxId() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTUnsignedInt target = null;
            target = (CTUnsignedInt)((Object)this.get_store().add_element_user(PROPERTY_QNAME[6]));
            return target;
        }
    }
