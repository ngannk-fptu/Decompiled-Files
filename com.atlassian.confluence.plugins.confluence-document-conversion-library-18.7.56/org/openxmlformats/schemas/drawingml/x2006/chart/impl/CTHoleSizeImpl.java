...
public class CTHoleSizeImpl
extends XmlComplexContentImpl
implements CTHoleSize {
    ...
    public STHoleSize xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STHoleSize target = null;
            target = (STHoleSize)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STHoleSize)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
    ...
    public void xsetVal(STHoleSize val) {
        ...
        synchronized (object) {
            ...
            target = (STHoleSize)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STHoleSize)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
