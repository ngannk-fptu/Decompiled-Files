...
implements CTBarGrouping {
    ...
    public STBarGrouping.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STBarGrouping.Enum)target.getEnumValue();
        }
    }
    ...
    public STBarGrouping xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STBarGrouping target = null;
            target = (STBarGrouping)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STBarGrouping)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
    ...
    public void xsetVal(STBarGrouping val) {
        ...
        synchronized (object) {
            ...
            target = (STBarGrouping)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STBarGrouping)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
