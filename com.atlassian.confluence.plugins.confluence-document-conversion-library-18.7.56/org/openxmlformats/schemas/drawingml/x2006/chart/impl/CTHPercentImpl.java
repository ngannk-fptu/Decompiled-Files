...
implements CTHPercent {
    ...
    public STHPercent xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STHPercent target = null;
            target = (STHPercent)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STHPercent)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
    ...
    public void xsetVal(STHPercent val) {
        ...
        synchronized (object) {
            ...
            target = (STHPercent)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STHPercent)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
