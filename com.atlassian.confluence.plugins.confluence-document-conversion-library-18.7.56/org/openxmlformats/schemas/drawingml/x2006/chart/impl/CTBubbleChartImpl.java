...
public class CTBubbleChartImpl
extends XmlComplexContentImpl
implements CTBubbleChart {
    private static final long serialVersionUID = 1L;
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "varyColors"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "ser"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "dLbls"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "bubble3D"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "bubbleScale"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "showNegBubbles"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "sizeRepresents"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "axId"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "extLst")};
    ...
    public List<CTBubbleSer> getSerList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTBubbleSer>(this::getSerArray, this::setSerArray, this::insertNewSer, this::removeSer, this::sizeOfSerArray);
        }
    }

    @Override
    public CTBubbleSer[] getSerArray() {
        return (CTBubbleSer[])this.getXmlObjectArray(PROPERTY_QNAME[1], new CTBubbleSer[0]);
    }
    ...
    public CTBubbleSer getSerArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBubbleSer target = null;
            target = (CTBubbleSer)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], i));
            if (target == null) {
    ...
    public CTBubbleSer insertNewSer(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBubbleSer target = null;
            target = (CTBubbleSer)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[1], i));
            return target;
        }
    }
    ...
    public CTBubbleSer addNewSer() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBubbleSer target = null;
            target = (CTBubbleSer)((Object)this.get_store().add_element_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
    ...
    public void setBubble3D(CTBoolean bubble3D) {
        this.generatedSetterHelperImpl(bubble3D, PROPERTY_QNAME[3], 0, (short)1);
    }
    ...
    public CTBubbleScale getBubbleScale() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBubbleScale target = null;
            target = (CTBubbleScale)this.get_store().find_element_user(PROPERTY_QNAME[4], 0);
            return target == null ? null : target;
        }
    }
    ...
    public void setBubbleScale(CTBubbleScale bubbleScale) {
        this.generatedSetterHelperImpl((XmlObject)bubbleScale, PROPERTY_QNAME[4], 0, (short)1);
    }
    ...
    public CTBubbleScale addNewBubbleScale() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBubbleScale target = null;
            target = (CTBubbleScale)this.get_store().add_element_user(PROPERTY_QNAME[4]);
            return target;
        }
    }
    ...
    public CTBoolean getShowNegBubbles() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBoolean target = null;
            target = (CTBoolean)((Object)this.get_store().find_element_user(PROPERTY_QNAME[5], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setShowNegBubbles(CTBoolean showNegBubbles) {
        this.generatedSetterHelperImpl(showNegBubbles, PROPERTY_QNAME[5], 0, (short)1);
    }
    ...
    public CTBoolean addNewShowNegBubbles() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBoolean target = null;
            target = (CTBoolean)((Object)this.get_store().add_element_user(PROPERTY_QNAME[5]));
            return target;
        }
    }
    ...
    public CTSizeRepresents getSizeRepresents() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSizeRepresents target = null;
            target = (CTSizeRepresents)this.get_store().find_element_user(PROPERTY_QNAME[6], 0);
            return target == null ? null : target;
        }
    }
    ...
    public void setSizeRepresents(CTSizeRepresents sizeRepresents) {
        this.generatedSetterHelperImpl((XmlObject)sizeRepresents, PROPERTY_QNAME[6], 0, (short)1);
    }
    ...
    public CTSizeRepresents addNewSizeRepresents() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSizeRepresents target = null;
            target = (CTSizeRepresents)this.get_store().add_element_user(PROPERTY_QNAME[6]);
            return target;
        }
    }
    ...
    public CTUnsignedInt[] getAxIdArray() {
        return (CTUnsignedInt[])this.getXmlObjectArray(PROPERTY_QNAME[7], new CTUnsignedInt[0]);
    }
    ...
    public CTUnsignedInt getAxIdArray(int i) {
        ...
        synchronized (object) {
            ...
            target = (CTUnsignedInt)((Object)this.get_store().find_element_user(PROPERTY_QNAME[7], i));
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
    ...
    public void setAxIdArray(CTUnsignedInt[] axIdArray) {
        this.check_orphaned();
        this.arraySetterHelper(axIdArray, PROPERTY_QNAME[7]);
    }

    @Override
    public void setAxIdArray(int i, CTUnsignedInt axId) {
        this.generatedSetterHelperImpl(axId, PROPERTY_QNAME[7], i, (short)2);
    }
    ...
    public CTUnsignedInt insertNewAxId(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTUnsignedInt target = null;
            target = (CTUnsignedInt)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[7], i));
            return target;
        }
    }
    ...
    public CTUnsignedInt addNewAxId() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTUnsignedInt target = null;
            target = (CTUnsignedInt)((Object)this.get_store().add_element_user(PROPERTY_QNAME[7]));
            return target;
        }
    }
