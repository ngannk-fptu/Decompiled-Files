...
implements CTLine3DChart {
    ...
    public List<CTLineSer> getSerList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTLineSer>(this::getSerArray, this::setSerArray, this::insertNewSer, this::removeSer, this::sizeOfSerArray);
        }
    }

    @Override
    public CTLineSer[] getSerArray() {
        return (CTLineSer[])this.getXmlObjectArray(PROPERTY_QNAME[2], new CTLineSer[0]);
    }
    ...
    public CTLineSer getSerArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTLineSer target = null;
            target = (CTLineSer)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], i));
            if (target == null) {
    ...
    public CTLineSer insertNewSer(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTLineSer target = null;
            target = (CTLineSer)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[2], i));
            return target;
        }
    }
    ...
    public CTLineSer addNewSer() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTLineSer target = null;
            target = (CTLineSer)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
