...
implements CTRadarStyle {
    ...
    public STRadarStyle.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STRadarStyle.Enum)target.getEnumValue();
        }
    }
    ...
    public STRadarStyle xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STRadarStyle target = null;
            target = (STRadarStyle)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STRadarStyle)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
    ...
    public void xsetVal(STRadarStyle val) {
        ...
        synchronized (object) {
            ...
            target = (STRadarStyle)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STRadarStyle)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
