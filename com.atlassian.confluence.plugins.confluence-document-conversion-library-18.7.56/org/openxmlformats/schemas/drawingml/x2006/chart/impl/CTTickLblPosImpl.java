...
implements CTTickLblPos {
    ...
    public STTickLblPos.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STTickLblPos.Enum)target.getEnumValue();
        }
    }
    ...
    public STTickLblPos xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STTickLblPos target = null;
            target = (STTickLblPos)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STTickLblPos)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
    ...
    public void xsetVal(STTickLblPos val) {
        ...
        synchronized (object) {
            ...
            target = (STTickLblPos)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STTickLblPos)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
