...
implements CTStrRef {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "f"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "strCache"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "extLst")};

    public CTStrRefImpl(SchemaType sType) {
        super(sType);
    }
    ...
    public CTStrData getStrCache() {
        ...
        synchronized (object) {
            ...
            target = (CTStrData)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], 0));
    ...
    @Override
    public void setStrCache(CTStrData strCache) {
        this.generatedSetterHelperImpl(strCache, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTStrData addNewStrCache() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTStrData target = null;
            target = (CTStrData)((Object)this.get_store().add_element_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
