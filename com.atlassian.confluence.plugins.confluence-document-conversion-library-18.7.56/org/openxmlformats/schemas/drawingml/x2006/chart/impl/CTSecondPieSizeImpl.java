...
public class CTSecondPieSizeImpl
extends XmlComplexContentImpl
implements CTSecondPieSize {
    ...
    public STSecondPieSize xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSecondPieSize target = null;
            target = (STSecondPieSize)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STSecondPieSize)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
    ...
    public void xsetVal(STSecondPieSize val) {
        ...
        synchronized (object) {
            ...
            target = (STSecondPieSize)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STSecondPieSize)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
