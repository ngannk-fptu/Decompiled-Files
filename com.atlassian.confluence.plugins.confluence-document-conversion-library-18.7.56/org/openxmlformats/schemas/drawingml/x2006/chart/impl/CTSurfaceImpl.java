...
implements CTSurface {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "thickness"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "spPr"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "pictureOptions"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "extLst")};
    ...
    public CTThickness getThickness() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTThickness target = null;
            target = (CTThickness)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setThickness(CTThickness thickness) {
        this.generatedSetterHelperImpl(thickness, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTThickness addNewThickness() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTThickness target = null;
            target = (CTThickness)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public CTPictureOptions getPictureOptions() {
        ...
        synchronized (object) {
            ...
            target = (CTPictureOptions)this.get_store().find_element_user(PROPERTY_QNAME[2], 0);
            return target == null ? null : target;
        }
    }
    ...
    public void setPictureOptions(CTPictureOptions pictureOptions) {
        this.generatedSetterHelperImpl((XmlObject)pictureOptions, PROPERTY_QNAME[2], 0, (short)1);
    }
    ...
    public CTPictureOptions addNewPictureOptions() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTPictureOptions target = null;
            target = (CTPictureOptions)this.get_store().add_element_user(PROPERTY_QNAME[2]);
            return target;
        }
    }
