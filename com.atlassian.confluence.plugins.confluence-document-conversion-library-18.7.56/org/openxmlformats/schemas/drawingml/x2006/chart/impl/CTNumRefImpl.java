...
implements CTNumRef {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "f"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "numCache"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "extLst")};

    public CTNumRefImpl(SchemaType sType) {
        super(sType);
    }
    ...
    public CTNumData getNumCache() {
        ...
        synchronized (object) {
            ...
            target = (CTNumData)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], 0));
    ...
    @Override
    public void setNumCache(CTNumData numCache) {
        this.generatedSetterHelperImpl(numCache, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTNumData addNewNumCache() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTNumData target = null;
            target = (CTNumData)((Object)this.get_store().add_element_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
