...
implements CTGapAmount {
    ...
    public CTGapAmountImpl(SchemaType sType) {
        super(sType);
    }
    ...
    public STGapAmount xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STGapAmount target = null;
            target = (STGapAmount)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STGapAmount)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
     ...
     */
    @Override
    public void xsetVal(STGapAmount val) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            STGapAmount target = null;
            target = (STGapAmount)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STGapAmount)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
