...
implements CTScatterChart {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "scatterStyle"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "varyColors"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "ser"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "dLbls"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "axId"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "extLst")};
    ...
    public CTScatterStyle getScatterStyle() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTScatterStyle target = null;
            target = (CTScatterStyle)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setScatterStyle(CTScatterStyle scatterStyle) {
        this.generatedSetterHelperImpl(scatterStyle, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTScatterStyle addNewScatterStyle() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTScatterStyle target = null;
            target = (CTScatterStyle)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
    ...
    public List<CTScatterSer> getSerList() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return new JavaListXmlObject<CTScatterSer>(this::getSerArray, this::setSerArray, this::insertNewSer, this::removeSer, this::sizeOfSerArray);
        }
    }

    @Override
    public CTScatterSer[] getSerArray() {
        return (CTScatterSer[])this.getXmlObjectArray(PROPERTY_QNAME[2], new CTScatterSer[0]);
    }
    ...
    public CTScatterSer getSerArray(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTScatterSer target = null;
            target = (CTScatterSer)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], i));
            if (target == null) {
    ...
    public CTScatterSer insertNewSer(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTScatterSer target = null;
            target = (CTScatterSer)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[2], i));
            return target;
        }
    }
    ...
    public CTScatterSer addNewSer() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTScatterSer target = null;
            target = (CTScatterSer)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
