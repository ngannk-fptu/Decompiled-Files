...
implements CTBarChart {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "barDir"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "grouping"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "varyColors"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "ser"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "dLbls"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "gapWidth"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "overlap"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "serLines"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "axId"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "extLst")};
    ...
    public CTOverlap getOverlap() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTOverlap target = null;
            target = (CTOverlap)((Object)this.get_store().find_element_user(PROPERTY_QNAME[6], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setOverlap(CTOverlap overlap) {
        this.generatedSetterHelperImpl(overlap, PROPERTY_QNAME[6], 0, (short)1);
    }
    ...
    public CTOverlap addNewOverlap() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTOverlap target = null;
            target = (CTOverlap)((Object)this.get_store().add_element_user(PROPERTY_QNAME[6]));
            return target;
        }
    }
    ...
    public CTChartLines[] getSerLinesArray() {
        return (CTChartLines[])this.getXmlObjectArray(PROPERTY_QNAME[7], new CTChartLines[0]);
    }
    ...
    public CTChartLines getSerLinesArray(int i) {
        ...
        synchronized (object) {
            ...
            target = (CTChartLines)((Object)this.get_store().find_element_user(PROPERTY_QNAME[7], i));
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
    ...
    public void setSerLinesArray(CTChartLines[] serLinesArray) {
        this.check_orphaned();
        this.arraySetterHelper(serLinesArray, PROPERTY_QNAME[7]);
    }

    @Override
    public void setSerLinesArray(int i, CTChartLines serLines) {
        this.generatedSetterHelperImpl(serLines, PROPERTY_QNAME[7], i, (short)2);
    }
    ...
    public CTChartLines insertNewSerLines(int i) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTChartLines target = null;
            target = (CTChartLines)((Object)this.get_store().insert_element_user(PROPERTY_QNAME[7], i));
            return target;
        }
    }
    ...
    public CTChartLines addNewSerLines() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTChartLines target = null;
            target = (CTChartLines)((Object)this.get_store().add_element_user(PROPERTY_QNAME[7]));
            return target;
        }
    }
