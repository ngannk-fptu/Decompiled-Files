...
implements CTTx {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "strRef"), new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "rich")};
    ...
    public CTTextBody getRich() {
        ...
        synchronized (object) {
            ...
            target = (CTTextBody)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setRich(CTTextBody rich) {
        this.generatedSetterHelperImpl(rich, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTTextBody addNewRich() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTextBody target = null;
            target = (CTTextBody)((Object)this.get_store().add_element_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
