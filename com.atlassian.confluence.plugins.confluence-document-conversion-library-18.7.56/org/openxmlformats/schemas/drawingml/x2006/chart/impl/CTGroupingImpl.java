...
implements CTGrouping {
    ...
    public STGrouping.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STGrouping.Enum)target.getEnumValue();
        }
    }
    ...
    public STGrouping xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STGrouping target = null;
            target = (STGrouping)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STGrouping)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
    ...
    public void xsetVal(STGrouping val) {
        ...
        synchronized (object) {
            ...
            target = (STGrouping)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STGrouping)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
