...
implements CTLayoutTarget {
    ...
    public STLayoutTarget.Enum getVal() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STLayoutTarget.Enum)target.getEnumValue();
        }
    }
    ...
    public STLayoutTarget xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STLayoutTarget target = null;
            target = (STLayoutTarget)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STLayoutTarget)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
    ...
    public void xsetVal(STLayoutTarget val) {
        ...
        synchronized (object) {
            ...
            target = (STLayoutTarget)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STLayoutTarget)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
