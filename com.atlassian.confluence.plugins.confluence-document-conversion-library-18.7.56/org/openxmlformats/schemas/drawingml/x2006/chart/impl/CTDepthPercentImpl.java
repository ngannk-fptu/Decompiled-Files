...
implements CTDepthPercent {
    ...
    public CTDepthPercentImpl(SchemaType sType) {
        super(sType);
    }
    ...
    public STDepthPercent xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STDepthPercent target = null;
            target = (STDepthPercent)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STDepthPercent)this.get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
     ...
     */
    @Override
    public void xsetVal(STDepthPercent val) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            STDepthPercent target = null;
            target = (STDepthPercent)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[0]));
            if (target == null) {
                target = (STDepthPercent)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[0]));
            }
            target.set(val);
        }
    }
