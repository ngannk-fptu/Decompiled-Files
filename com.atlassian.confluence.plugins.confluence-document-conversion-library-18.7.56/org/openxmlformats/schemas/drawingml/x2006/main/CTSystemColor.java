...
public interface CTSystemColor
extends XmlObject {
    public static final DocumentFactory<CTSystemColor> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctsystemcolor4525type");
    ...
    public void setVal(STSystemColorVal.Enum var1);

    public void xsetVal(STSystemColorVal var1);
    ...
    public void setLastClr(byte[] var1);

    public void xsetLastClr(STHexColorRGB var1);
