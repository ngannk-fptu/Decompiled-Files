...
public interface CTStyleMatrixReference
extends XmlObject {
    public static final DocumentFactory<CTStyleMatrixReference> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctstylematrixreference6ef4type");
    ...
    public void xsetIdx(STStyleMatrixColumnIndex var1);
}
