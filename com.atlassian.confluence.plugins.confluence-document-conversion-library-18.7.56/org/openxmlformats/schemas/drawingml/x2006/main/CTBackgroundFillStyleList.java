...
public interface CTBackgroundFillStyleList
extends XmlObject {
    public static final DocumentFactory<CTBackgroundFillStyleList> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctbackgroundfillstylelist13cftype");
