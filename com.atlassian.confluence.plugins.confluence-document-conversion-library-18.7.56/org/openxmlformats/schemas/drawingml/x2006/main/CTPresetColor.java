...
public interface CTPresetColor
extends XmlObject {
    public static final DocumentFactory<CTPresetColor> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctpresetcolora675type");
    ...
    public void setVal(STPresetColorVal.Enum var1);

    public void xsetVal(STPresetColorVal var1);
}
