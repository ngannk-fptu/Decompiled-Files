...
public interface CTSRgbColor
extends XmlObject {
    public static final DocumentFactory<CTSRgbColor> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "ctsrgbcolor5bdatype");
    ...
    public void xsetVal(STHexColorRGB var1);
}
