...
implements CTNonVisualConnectorProperties {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "cxnSpLocks"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "stCxn"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "endCxn"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "extLst")};
    ...
    public CTConnectorLocking getCxnSpLocks() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTConnectorLocking target = null;
            target = (CTConnectorLocking)this.get_store().find_element_user(PROPERTY_QNAME[0], 0);
    ...
    public void setCxnSpLocks(CTConnectorLocking cxnSpLocks) {
        this.generatedSetterHelperImpl((XmlObject)cxnSpLocks, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTConnectorLocking addNewCxnSpLocks() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTConnectorLocking target = null;
            target = (CTConnectorLocking)this.get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
    ...
    public CTConnection getStCxn() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTConnection target = null;
            target = (CTConnection)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setStCxn(CTConnection stCxn) {
        this.generatedSetterHelperImpl(stCxn, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTConnection addNewStCxn() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTConnection target = null;
            target = (CTConnection)((Object)this.get_store().add_element_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
    ...
    public CTConnection getEndCxn() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTConnection target = null;
            target = (CTConnection)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setEndCxn(CTConnection endCxn) {
        this.generatedSetterHelperImpl(endCxn, PROPERTY_QNAME[2], 0, (short)1);
    }
    ...
    public CTConnection addNewEndCxn() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTConnection target = null;
            target = (CTConnection)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
