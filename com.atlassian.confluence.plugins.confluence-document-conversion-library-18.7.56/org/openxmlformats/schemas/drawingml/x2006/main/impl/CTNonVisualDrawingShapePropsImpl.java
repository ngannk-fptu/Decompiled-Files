...
implements CTNonVisualDrawingShapeProps {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "spLocks"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "extLst"), new QName("", "txBox")};
    ...
    public CTShapeLocking getSpLocks() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTShapeLocking target = null;
            target = (CTShapeLocking)this.get_store().find_element_user(PROPERTY_QNAME[0], 0);
    ...
    public void setSpLocks(CTShapeLocking spLocks) {
        this.generatedSetterHelperImpl((XmlObject)spLocks, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTShapeLocking addNewSpLocks() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTShapeLocking target = null;
            target = (CTShapeLocking)this.get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
