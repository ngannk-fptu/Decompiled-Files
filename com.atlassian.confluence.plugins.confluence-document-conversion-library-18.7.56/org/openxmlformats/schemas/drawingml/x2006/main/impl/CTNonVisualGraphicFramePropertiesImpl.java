...
implements CTNonVisualGraphicFrameProperties {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "graphicFrameLocks"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "extLst")};
    ...
    public CTGraphicalObjectFrameLocking getGraphicFrameLocks() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTGraphicalObjectFrameLocking target = null;
            target = (CTGraphicalObjectFrameLocking)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setGraphicFrameLocks(CTGraphicalObjectFrameLocking graphicFrameLocks) {
        this.generatedSetterHelperImpl(graphicFrameLocks, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTGraphicalObjectFrameLocking addNewGraphicFrameLocks() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTGraphicalObjectFrameLocking target = null;
            target = (CTGraphicalObjectFrameLocking)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
