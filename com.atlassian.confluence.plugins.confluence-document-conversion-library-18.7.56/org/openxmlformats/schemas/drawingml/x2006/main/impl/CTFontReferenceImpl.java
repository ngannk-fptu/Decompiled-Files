...
public class CTFontReferenceImpl
extends XmlComplexContentImpl
implements CTFontReference {
    ...
    public CTFontReferenceImpl(SchemaType sType) {
        super(sType);
    }
    ...
    public STFontCollectionIndex.Enum getIdx() {
        ...
        synchronized (object) {
            ...
            return target == null ? null : (STFontCollectionIndex.Enum)target.getEnumValue();
        }
    }
    ...
    public STFontCollectionIndex xgetIdx() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STFontCollectionIndex target = null;
            target = (STFontCollectionIndex)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[6]));
            return target;
        }
    }
     ...
     */
    @Override
    public void setIdx(STFontCollectionIndex.Enum idx) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue target = null;
     ...
     */
    @Override
    public void xsetIdx(STFontCollectionIndex idx) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            STFontCollectionIndex target = null;
            target = (STFontCollectionIndex)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[6]));
            if (target == null) {
                target = (STFontCollectionIndex)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[6]));
            }
            target.set(idx);
        }
    }
