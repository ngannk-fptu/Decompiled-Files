...
implements CTBlipFillProperties {
    ...
    public CTRelativeRect getSrcRect() {
        ...
        synchronized (object) {
            ...
            target = (CTRelativeRect)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setSrcRect(CTRelativeRect srcRect) {
        this.generatedSetterHelperImpl(srcRect, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTRelativeRect addNewSrcRect() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTRelativeRect target = null;
            target = (CTRelativeRect)((Object)this.get_store().add_element_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
    ...
    public CTTileInfoProperties getTile() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTileInfoProperties target = null;
            target = (CTTileInfoProperties)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setTile(CTTileInfoProperties tile) {
        this.generatedSetterHelperImpl(tile, PROPERTY_QNAME[2], 0, (short)1);
    }
    ...
    public CTTileInfoProperties addNewTile() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTTileInfoProperties target = null;
            target = (CTTileInfoProperties)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
    ...
    public CTStretchInfoProperties getStretch() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTStretchInfoProperties target = null;
            target = (CTStretchInfoProperties)((Object)this.get_store().find_element_user(PROPERTY_QNAME[3], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setStretch(CTStretchInfoProperties stretch) {
        this.generatedSetterHelperImpl(stretch, PROPERTY_QNAME[3], 0, (short)1);
    }
    ...
    public CTStretchInfoProperties addNewStretch() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTStretchInfoProperties target = null;
            target = (CTStretchInfoProperties)((Object)this.get_store().add_element_user(PROPERTY_QNAME[3]));
            return target;
        }
    }
