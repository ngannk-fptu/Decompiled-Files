...
implements CTGroupTransform2D {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "off"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "ext"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "chOff"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "chExt"), new QName("", "rot"), new QName("", "flipH"), new QName("", "flipV")};

    public CTGroupTransform2DImpl(SchemaType sType) {
        super(sType);
    }
    ...
    public CTPoint2D getChOff() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTPoint2D target = null;
            target = (CTPoint2D)((Object)this.get_store().find_element_user(PROPERTY_QNAME[2], 0));
            return target == null ? null : target;
        }
    }
    ...
    @Override
    public void setChOff(CTPoint2D chOff) {
        this.generatedSetterHelperImpl(chOff, PROPERTY_QNAME[2], 0, (short)1);
    }
    ...
    public CTPoint2D addNewChOff() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTPoint2D target = null;
            target = (CTPoint2D)((Object)this.get_store().add_element_user(PROPERTY_QNAME[2]));
            return target;
        }
    }
    ...
    @Override
    public void setChExt(CTPositiveSize2D chExt) {
        this.generatedSetterHelperImpl(chExt, PROPERTY_QNAME[3], 0, (short)1);
    }
    ...
    public STAngle xgetRot() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STAngle target = null;
            target = (STAngle)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[4]));
            if (target == null) {
                target = (STAngle)this.get_default_attribute_value(PROPERTY_QNAME[4]);
            }
            return target;
        }
    }
    ...
    public void xsetRot(STAngle rot) {
        ...
        synchronized (object) {
            ...
            target = (STAngle)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[4]));
            if (target == null) {
                target = (STAngle)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[4]));
            }
            target.set(rot);
        }
    }
