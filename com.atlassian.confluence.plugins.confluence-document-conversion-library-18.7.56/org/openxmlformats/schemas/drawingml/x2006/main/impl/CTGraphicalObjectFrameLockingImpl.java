...
implements CTGraphicalObjectFrameLocking {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "extLst"), new QName("", "noGrp"), new QName("", "noDrilldown"), new QName("", "noSelect"), new QName("", "noChangeAspect"), new QName("", "noMove"), new QName("", "noResize")};
