...
implements CTTransform2D {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "off"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "ext"), new QName("", "rot"), new QName("", "flipH"), new QName("", "flipV")};
    ...
    public void setOff(CTPoint2D off) {
        this.generatedSetterHelperImpl(off, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public STAngle xgetRot() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STAngle target = null;
            target = (STAngle)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[2]));
            if (target == null) {
                target = (STAngle)this.get_default_attribute_value(PROPERTY_QNAME[2]);
            }
            return target;
        }
    }
    ...
    public void xsetRot(STAngle rot) {
        ...
        synchronized (object) {
            ...
            target = (STAngle)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[2]));
            if (target == null) {
                target = (STAngle)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[2]));
            }
            target.set(rot);
        }
    }
