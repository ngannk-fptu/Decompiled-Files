...
implements CTNonVisualDrawingProps {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "hlinkClick"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "hlinkHover"), new QName("http://schemas.openxmlformats.org/drawingml/2006/main", "extLst"), new QName("", "id"), new QName("", "name"), new QName("", "descr"), new QName("", "hidden"), new QName("", "title")};
    ...
    public CTHyperlink getHlinkClick() {
        ...
        synchronized (object) {
            ...
            target = (CTHyperlink)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public void setHlinkClick(CTHyperlink hlinkClick) {
        this.generatedSetterHelperImpl(hlinkClick, PROPERTY_QNAME[0], 0, (short)1);
    }
    ...
    public CTHyperlink getHlinkHover() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTHyperlink target = null;
            target = (CTHyperlink)((Object)this.get_store().find_element_user(PROPERTY_QNAME[1], 0));
            return target == null ? null : target;
        }
    }
    ...
    public void setHlinkHover(CTHyperlink hlinkHover) {
        this.generatedSetterHelperImpl(hlinkHover, PROPERTY_QNAME[1], 0, (short)1);
    }
    ...
    public CTHyperlink addNewHlinkHover() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTHyperlink target = null;
            target = (CTHyperlink)((Object)this.get_store().add_element_user(PROPERTY_QNAME[1]));
            return target;
        }
    }
    ...
    public STDrawingElementId xgetId() {
        ...
        synchronized (object) {
            ...
            target = (STDrawingElementId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            return target;
        }
    }
    ...
    public void xsetId(STDrawingElementId id) {
        ...
        synchronized (object) {
            ...
            target = (STDrawingElementId)((Object)this.get_store().find_attribute_user(PROPERTY_QNAME[3]));
            if (target == null) {
                target = (STDrawingElementId)((Object)this.get_store().add_attribute_user(PROPERTY_QNAME[3]));
            }
            target.set(id);
        }
    }
    ...
    public XmlString xgetTitle() {
        ...
        synchronized (object) {
            ...
            if (target == null) {
                target = (XmlString)this.get_default_attribute_value(PROPERTY_QNAME[7]);
            }
            return target;
        }
    }
