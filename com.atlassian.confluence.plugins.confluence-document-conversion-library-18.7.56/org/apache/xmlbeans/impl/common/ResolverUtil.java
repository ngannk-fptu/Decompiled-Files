...
public class ResolverUtil {
    ...
    public static EntityResolver resolverForCatalog(String catalogFile) {
        ...
        try {
            ...
            Constructor<?> cstrCm = cmClass.getDeclaredConstructor(new Class[0]);
    ...
    static {
        try {
            ...
            if (erClassName != null) {
                Object o = Class.forName(erClassName).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
