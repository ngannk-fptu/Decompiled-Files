...
implements MinInclusiveDocument {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://www.w3.org/2001/XMLSchema", "minInclusive")};
    ...
    public void setMinInclusive(Facet minInclusive) {
        this.generatedSetterHelperImpl(minInclusive, PROPERTY_QNAME[0], 0, (short)1);
    }
