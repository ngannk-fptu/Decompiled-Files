...
implements MaxLengthDocument {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://www.w3.org/2001/XMLSchema", "maxLength")};
    ...
    public void setMaxLength(NumFacet maxLength) {
        this.generatedSetterHelperImpl(maxLength, PROPERTY_QNAME[0], 0, (short)1);
    }
