...
implements GroupDocument {
    ...
    private static final QName[] PROPERTY_QNAME = new QName[]{new QName("http://www.w3.org/2001/XMLSchema", "group")};
    ...
    public NamedGroup getGroup() {
        ...
        synchronized (object) {
            ...
            target = (NamedGroup)((Object)this.get_store().find_element_user(PROPERTY_QNAME[0], 0));
    ...
    public NamedGroup addNewGroup() {
        ...
        synchronized (object) {
            this.check_orphaned();
            NamedGroup target = null;
            target = (NamedGroup)((Object)this.get_store().add_element_user(PROPERTY_QNAME[0]));
            return target;
        }
    }
}
