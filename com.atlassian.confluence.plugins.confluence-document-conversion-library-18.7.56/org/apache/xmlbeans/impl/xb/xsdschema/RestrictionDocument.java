...
extends XmlObject {
    public static final DocumentFactory<RestrictionDocument> Factory = new DocumentFactory(TypeSystemHolder.typeSystem, "restriction0049doctype");
    ...
    extends Annotated {
        public static final ElementFactory<Restriction> Factory = new ElementFactory(TypeSystemHolder.typeSystem, "restrictionad11elemtype");
        public static final SchemaType type = Factory.getType();
