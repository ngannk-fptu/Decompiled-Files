...
implements SchemaTypeSystem {
    ...
    private final Map<QName, SchemaType> _typeMap = new HashMap<QName, SchemaType>();
    private final SchemaTypeImpl[] _typeArray = new SchemaTypeImpl[50];
    private final Map<String, SchemaType> _handlesToObjects = new HashMap<String, SchemaType>();
    private final Map<SchemaType, String> _objectsToHandles = new HashMap<SchemaType, String>();
    private final Map<String, SchemaType> _typesByClassname = new HashMap<String, SchemaType>();
