...
implements SchemaTypeSystem {
    ...
    private Map<QName, SchemaType> _typeMap = new HashMap<QName, SchemaType>();
    private SchemaTypeImpl[] _typeArray = new SchemaTypeImpl[47];
    private Map<String, SchemaType> _handlesToObjects = new HashMap<String, SchemaType>();
    private Map<SchemaType, String> _objectsToHandles = new HashMap<SchemaType, String>();
    private Map<String, SchemaType> _typesByClassname = new HashMap<String, SchemaType>();
