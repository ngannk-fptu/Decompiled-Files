...
implements FreeRefFunction {
    ...
    public ValueEval evaluate(int srcRowIndex, int srcColumnIndex, ValueEval arg1) {
        try {
            Double probability = NormSInv.evaluateValue(arg1, srcRowIndex, srcColumnIndex);
            if (probability == null) {
            ...
            return new NumberEval(NormInv.inverse(probability, 0.0, 1.0));
        }
