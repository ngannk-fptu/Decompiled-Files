...
implements FreeRefFunction {
    ...
    public ValueEval evaluate(int srcRowIndex, int srcColumnIndex, ValueEval arg1, ValueEval arg2) {
        try {
            Double number1 = TDist2t.evaluateValue(arg1, srcRowIndex, srcColumnIndex);
            if (number1 == null) {
            ...
            Double number2 = TDist2t.evaluateValue(arg2, srcRowIndex, srcColumnIndex);
            if (number2 == null) {
                return ErrorEval.VALUE_INVALID;
            }
