...
public enum PresetColor {
    ...
    private static final HashMap<STPresetColorVal.Enum, PresetColor> reverse;

    private PresetColor(STPresetColorVal.Enum color) {
    ...
    static {
        reverse = new HashMap();
        for (PresetColor value : PresetColor.values()) {
