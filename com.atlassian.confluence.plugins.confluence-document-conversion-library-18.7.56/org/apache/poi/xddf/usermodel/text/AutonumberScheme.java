...
public enum AutonumberScheme {
    ...
    private static final HashMap<STTextAutonumberScheme.Enum, AutonumberScheme> reverse;

    private AutonumberScheme(STTextAutonumberScheme.Enum scheme) {
    ...
    static {
        reverse = new HashMap();
        for (AutonumberScheme value : AutonumberScheme.values()) {
