...
public enum PresetPattern {
    ...
    private static final HashMap<STPresetPatternVal.Enum, PresetPattern> reverse;

    private PresetPattern(STPresetPatternVal.Enum pattern) {
    ...
    static {
        reverse = new HashMap();
        for (PresetPattern value : PresetPattern.values()) {
