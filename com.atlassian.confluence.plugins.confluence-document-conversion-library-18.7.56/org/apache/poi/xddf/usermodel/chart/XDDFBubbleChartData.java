...
extends XDDFChartData {
    ...
    public XDDFBubbleChartData(XDDFChart parent, CTBubbleChart chart, XDDFChartAxis category, XDDFValueAxis values) {
        super(parent);
        this.chart = chart;
        ...
        this.defineAxes(categories, mapValues);
    }

    @Internal
    protected XDDFBubbleChartData(XDDFChart parent, CTBubbleChart chart, Map<Long, XDDFChartAxis> categories, Map<Long, XDDFValueAxis> values) {
        super(parent);
        this.chart = chart;
        for (CTBubbleSer series : chart.getSerList()) {
            this.series.add(new Series(series, series.getXVal(), series.getYVal()));
    ...
    extends XDDFChartData.Series {
        ...
        public void setBubbleSizes(XDDFNumericalDataSource<?> values) {
            ...
            CTNumData cache = this.retrieveNumCache(bubbleSizes, values);
