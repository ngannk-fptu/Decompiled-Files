...
public class XDDFArea3DChartData
extends XDDFChartData {
    private CTArea3DChart chart;

    @Internal
    protected XDDFArea3DChartData(XDDFChart parent, CTArea3DChart chart, Map<Long, XDDFChartAxis> categories, Map<Long, XDDFValueAxis> values) {
        super(parent);
        this.chart = chart;
