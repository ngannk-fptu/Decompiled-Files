...
public class XDDFLineChartData
extends XDDFChartData {
    private CTLineChart chart;

    @Internal
    protected XDDFLineChartData(XDDFChart parent, CTLineChart chart, Map<Long, XDDFChartAxis> categories, Map<Long, XDDFValueAxis> values) {
        super(parent);
        this.chart = chart;
