...
implements Serializable {
    ...
    protected String _locateTypeId(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        ctxt.reportWrongTokenException(this.baseType(), JsonToken.VALUE_STRING, "need JSON String, Number of Boolean that contains type id (for subtype of %s)", this.baseTypeName());
        return null;
    }
