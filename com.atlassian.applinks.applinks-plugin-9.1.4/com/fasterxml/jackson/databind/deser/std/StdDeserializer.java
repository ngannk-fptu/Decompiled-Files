...
ValueInstantiator.Gettable {
    ...
    protected final String _parseString(JsonParser p, DeserializationContext ctxt, NullValueProvider nullProvider) throws IOException {
        ...
        switch (p.currentTokenId()) {
            ...
            case 7: {
                act = this._checkIntToStringCoercion(p, ctxt, this._valueClass);
                break;
            }
            case 8: {
                act = this._checkFloatToStringCoercion(p, ctxt, this._valueClass);
                break;
            }
            case 9: 
            case 10: {
                act = this._checkBooleanToStringCoercion(p, ctxt, this._valueClass);
            }
        }
        if (act == CoercionAction.AsNull) {
        ...
        return (String)ctxt.handleUnexpectedToken(this.getValueType(ctxt), p);
    }
