...
implements Serializable {
    ...
    public void setValue(Object pojo, Object value) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException("Failed to setValue() with method " + this.getFullName() + ": " + ClassUtil.exceptionMessage(e), e);
        }
    }
    ...
    public Object getValue(Object pojo) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException("Failed to getValue() with method " + this.getFullName() + ": " + ClassUtil.exceptionMessage(e), e);
        }
    }
