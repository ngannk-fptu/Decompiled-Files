...
extends AccessorNamingStrategy {
    ...
    public String findNameForIsGetter(AnnotatedMethod am, String name) {
        if (this._isGetterPrefix != null) {
            ...
            if ((this._isGettersNonBoolean || rt == Boolean.class || rt == Boolean.TYPE) && name.startsWith(this._isGetterPrefix)) {
    ...
    extends DefaultAccessorNamingStrategy {
        ...
        public RecordNaming(MapperConfig<?> config, AnnotatedClass forClass) {
            ...
            this._fieldNames = recordFieldNames == null ? Collections.emptySet() : new HashSet<String>(Arrays.asList(recordFieldNames));
        }
