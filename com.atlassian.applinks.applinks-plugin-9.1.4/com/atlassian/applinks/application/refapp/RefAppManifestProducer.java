...
public class RefAppManifestProducer
extends AppLinksManifestProducer {
    public RefAppManifestProducer(RequestFactory requestFactory, AppLinksManifestDownloader downloader, WebResourceManager webResourceManager, AppLinkPluginUtil appLinkPluginUtil) {
