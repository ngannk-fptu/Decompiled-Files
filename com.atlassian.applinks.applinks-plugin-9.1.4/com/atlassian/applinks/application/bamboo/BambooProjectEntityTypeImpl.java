 ...
 *  com.atlassian.applinks.api.application.bamboo.BambooProjectEntityType
...
implements BambooProjectEntityType,
NonAppLinksEntityType,
BuiltinApplinksType {
    private static final TypeId TYPE_ID = new TypeId("bamboo.project");

    public BambooProjectEntityTypeImpl(AppLinkPluginUtil pluginUtil, WebResourceUrlProvider webResourceUrlProvider) {
    ...
    public URI getDisplayUrl(ApplicationLink link, String entityKey) {
        Assertions.isTrue((String)String.format("Application link %s is not of type %s", link.getId(), this.getApplicationType().getName()), (boolean)(link.getType() instanceof BambooApplicationType));
