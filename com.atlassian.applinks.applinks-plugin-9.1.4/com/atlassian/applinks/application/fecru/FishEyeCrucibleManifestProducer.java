...
public class FishEyeCrucibleManifestProducer
extends AppLinksManifestProducer {
    public FishEyeCrucibleManifestProducer(RequestFactory requestFactory, AppLinksManifestDownloader downloader, WebResourceManager webResourceManager, AppLinkPluginUtil appLinkPluginUtil) {
    ...
    protected Set<Class<? extends AuthenticationProvider>> getSupportedInboundAuthenticationTypes() {
        return ImmutableSet.of(BasicAuthenticationProvider.class, TrustedAppsAuthenticationProvider.class);
    }
