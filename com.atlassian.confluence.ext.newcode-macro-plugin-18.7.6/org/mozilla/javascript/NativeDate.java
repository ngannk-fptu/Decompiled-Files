...
extends IdScriptableObject {
    ...
    public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
        ...
        switch (id) {
            ...
            case 47: {
                ...
                if (tv instanceof Number && (Double.isNaN(d = ((Number)tv).doubleValue()) || Double.isInfinite(d))) {
                    return null;
                }
        ...
        NativeDate realThis = NativeDate.ensureType(thisObj, NativeDate.class, f);
        ...
        switch (id) {
            ...
            case 45: {
                ...
                if (Double.isNaN(year) || Double.isInfinite(year)) {
                    ...
                    t = Double.isNaN(t) ? 0.0 : NativeDate.LocalTime(t);
            ...
            case 46: {
                ...
                String msg = ScriptRuntime.getMessageById("msg.invalid.date", new Object[0]);
    ...
    private static int YearFromTime(double t) {
        ...
        if (t2 > t) {
            y -= 1.0;
        } else if (t2 + 8.64E7 * NativeDate.DaysInYear(y) <= t) {
            y += 1.0;
        }
        return (int)y;
    }
    ...
    private static double DaysInYear(double year) {
        ...
        return NativeDate.IsLeapYear((int)year) ? 366.0 : 365.0;
    }
        ...
        block13: while (i < limit) {
            ...
            if ('0' <= c && c <= '9') {
                ...
                if (prevc == '+' || prevc == '-') {
                    ...
                    if (c > ' ' && c != ',' && c != '/' && i < limit) return Double.NaN;
                    year = n < 100 ? n + 1900 : n;
                } else if (c == ':') {
                    if (hour < 0) {
                        hour = n;
                    } else {
                        if (min >= 0) return Double.NaN;
                        min = n;
                    }
                } else if (c == '/') {
                    if (mon < 0) {
