...
implements GuiCallback {
    ...
    protected void showFileWindow(String sourceUrl, int lineNumber) {
        JInternalFrame f;
        FileWindow w = sourceUrl != null ? this.getFileWindow(sourceUrl) : ((f = this.getSelectedFrame()) != null && f instanceof FileWindow ? (FileWindow)f : this.currentWindow);
