        ...
        block12: while (this.pos < this.length) {
            ...
            switch (c) {
                ...
                case 'u': {
                    ...
                    int code = JsonParser.fromHex(this.src.charAt(this.pos + 0)) << 12 | JsonParser.fromHex(this.src.charAt(this.pos + 1)) << 8 | JsonParser.fromHex(this.src.charAt(this.pos + 2)) << 4 | JsonParser.fromHex(this.src.charAt(this.pos + 3));
                    if (code < 0) {
