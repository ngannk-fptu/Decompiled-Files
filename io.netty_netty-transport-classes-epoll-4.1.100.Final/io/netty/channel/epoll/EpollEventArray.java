...
public final class EpollEventArray {
    ...
    EpollEventArray(int length) {
        ...
        this.length = length;
        this.memory = Buffer.allocateDirectWithNativeOrder((int)EpollEventArray.calculateBufferCapacity(length));
    ...
    private int getInt(int index, int offset) {
        if (PlatformDependent.hasUnsafe()) {
            ...
            return PlatformDependent.getInt((long)(this.memoryAddress + n + (long)offset));
        }
