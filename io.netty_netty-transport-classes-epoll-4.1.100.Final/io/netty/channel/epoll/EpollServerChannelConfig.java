...
implements ServerSocketChannelConfig {
    ...
    EpollServerChannelConfig(AbstractEpollChannel channel) {
        super((Channel)channel, (RecvByteBufAllocator)new ServerChannelRecvByteBufAllocator());
    }
    ...
    public EpollServerChannelConfig setTcpFastopen(int pendingFastOpenRequestsThreshold) {
        this.pendingFastOpenRequestsThreshold = ObjectUtil.checkPositiveOrZero((int)pendingFastOpenRequestsThreshold, (String)"pendingFastOpenRequestsThreshold");
        return this;
    }
