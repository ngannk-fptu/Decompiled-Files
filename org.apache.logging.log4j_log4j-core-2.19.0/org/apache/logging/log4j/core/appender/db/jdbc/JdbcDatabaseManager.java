...
extends AbstractDatabaseManager {
    ...
    private boolean commitAndCloseAll() {
        if (this.connection != null || this.statement != null) {
            try {
                ...
                Object actual = cause == null ? e : cause;
                JdbcDatabaseManager.logger().debug("{} committing and closing connection: {}", actual, (Object)actual.getClass().getSimpleName(), (Object)e.toString(), (Object)e);
            }
        }
    ...
    protected void writeThrough(LogEvent event, Serializable serializable) {
        ...
        try {
            ...
            this.reconnectOn((Exception)((Object)e));
            try {
                this.writeInternal(event, serializable);
            }
            finally {
    ...
    private static final class ResultSetColumnMetaData {
        ...
        public String truncate(String string) {
            return this.precision > 0 ? Strings.left((String)string, (int)this.precision) : string;
        }
    }
