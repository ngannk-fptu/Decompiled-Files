...
extends AbstractManager {
    ...
    static {
        ...
        SHUTDOWN_HOOK = enableShutdownHook && LogManager.getFactory() instanceof ShutdownCallbackRegistry ? ((ShutdownCallbackRegistry)LogManager.getFactory()).addShutdownCallback(() -> ((ZMQ.Context)CONTEXT).close()) : null;
    }
