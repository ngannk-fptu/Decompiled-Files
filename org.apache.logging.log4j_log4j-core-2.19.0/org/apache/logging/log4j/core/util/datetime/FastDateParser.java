...
Serializable {
    ...
    private static final Comparator<String> LONGER_FIRST_LOWERCASE = (left, right) -> right.compareTo((String)left);
        ...
        TimeZoneStrategy(Locale locale) {
            ...
            for (String[] zoneNames : zones) {
                ...
                for (int i = 1; i < zoneNames.length; ++i) {
                    ...
                    if (zoneNames[i] == null || !sorted.add(key = zoneNames[i].toLowerCase(locale))) continue;
    ...
    extends Strategy {
        ...
        boolean parse(FastDateParser parser, Calendar calendar, String source, ParsePosition pos, int maxWidth) {
            ...
            int value = Integers.parseInt(source.substring(pos.getIndex(), idx));
            pos.setIndex(idx);
