...
public final class Configurator {
    ...
    public static LoggerContext initialize(String name, ClassLoader loader, List<URI> configLocations, Object externalContext) {
        try {
            ...
            LOGGER.error("There was a problem initializing the LoggerContext [{}] using configurations at [{}].", (Object)name, configLocations, (Object)ex);
            return null;
        }
    }
    ...
    public static Logger setLevel(Logger logger, Level level) {
        Configurator.setLevel(LoggerContext.getContext(StackLocatorUtil.getCallerClassLoader((int)2), false, null), logger.getName(), level);
        return logger;
    }

    public static void setLevel(Class<?> clazz, Level level) {
        Configurator.setLevel(LoggerContext.getContext(StackLocatorUtil.getCallerClassLoader((int)2), false, null), clazz.getName(), level);
    }
    ...
    public static void setLevel(String loggerName, Level level) {
        Configurator.setLevel(LoggerContext.getContext(StackLocatorUtil.getCallerClassLoader((int)2), false, null), loggerName, level);
    }

    public static void setLevel(String loggerName, String level) {
        Configurator.setLevel(LoggerContext.getContext(StackLocatorUtil.getCallerClassLoader((int)2), false, null), loggerName, Level.toLevel((String)level));
    }
