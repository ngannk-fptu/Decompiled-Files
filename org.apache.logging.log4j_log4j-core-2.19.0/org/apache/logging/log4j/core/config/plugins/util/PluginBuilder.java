...
implements Builder<Object> {
    ...
    public Object build() {
        ...
        try {
            ...
            LOGGER.error("Unable to invoke factory method in {} for element {}: {}", this.clazz, (Object)this.node.getName(), (Object)(t instanceof InvocationTargetException ? ((InvocationTargetException)t).getCause() : t).toString(), (Object)t);
            return null;
        }
    }
