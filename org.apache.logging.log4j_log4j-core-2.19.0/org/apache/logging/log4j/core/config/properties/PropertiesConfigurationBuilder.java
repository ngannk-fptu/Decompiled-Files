...
implements Builder<PropertiesConfiguration> {
    ...
    public PropertiesConfiguration build() {
        ...
        Properties properties = PropertiesUtil.extractSubset((Properties)this.rootProperties, (String)"customLevel");
        ...
        if ((loggerProp = this.rootProperties.getProperty("loggers")) != null) {
            ...
            Map map2 = PropertiesUtil.partitionOnCommonPrefixes((Properties)PropertiesUtil.extractSubset((Properties)this.rootProperties, (String)"logger"), (boolean)true);
        ...
        Properties properties2 = PropertiesUtil.extractSubset((Properties)this.rootProperties, (String)"rootLogger");
        if (string4 != null) {
