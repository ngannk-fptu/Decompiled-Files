...
implements ReadOnlyAuthorizationServerEndpointMetadata {
    ...
    public JSONObject toJSONObject() {
        ...
        if (this.getAuthorizationEndpointURI() != null) {
            o.put("authorization_endpoint", this.getAuthorizationEndpointURI().toString());
        }
        if (this.getTokenEndpointURI() != null) {
            o.put("token_endpoint", this.getTokenEndpointURI().toString());
        }
        if (this.getRegistrationEndpointURI() != null) {
            o.put("registration_endpoint", this.getRegistrationEndpointURI().toString());
        }
        if (this.getIntrospectionEndpointURI() != null) {
            o.put("introspection_endpoint", this.getIntrospectionEndpointURI().toString());
        }
        if (this.getRevocationEndpointURI() != null) {
            o.put("revocation_endpoint", this.getRevocationEndpointURI().toString());
        }
        if (this.getRequestObjectEndpoint() != null) {
            o.put("request_object_endpoint", this.getRequestObjectEndpoint().toString());
        }
        if (this.getPushedAuthorizationRequestEndpointURI() != null) {
            o.put("pushed_authorization_request_endpoint", this.getPushedAuthorizationRequestEndpointURI().toString());
        }
        if (this.getDeviceAuthorizationEndpointURI() != null) {
            o.put("device_authorization_endpoint", this.getDeviceAuthorizationEndpointURI().toString());
        }
        if (this.getBackChannelAuthenticationEndpointURI() != null) {
            o.put("backchannel_authentication_endpoint", this.getBackChannelAuthenticationEndpointURI().toString());
        }
        return o;
    }
