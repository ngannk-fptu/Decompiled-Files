...
implements SuccessResponse {
    ...
    public JSONObject toJSONObject() {
        ...
        jsonObject.put((Object)"iss", (Object)this.iss.getValue());
        jsonObject.put((Object)"aud", (Object)this.aud.getValue());
        jsonObject.put((Object)"request_uri", (Object)this.requestURI.toString());
        jsonObject.put((Object)"exp", (Object)DateUtils.toSecondsSinceEpoch((Date)this.exp));
        return jsonObject;
    }
    ...
    public static RequestObjectPOSTSuccessResponse parse(JSONObject jsonObject) throws ParseException {
        return new RequestObjectPOSTSuccessResponse(new Issuer(JSONObjectUtils.getString(jsonObject, "iss")), new Audience(JSONObjectUtils.getString(jsonObject, "aud")), JSONObjectUtils.getURI(jsonObject, "request_uri"), DateUtils.fromSecondsSinceEpoch((long)JSONObjectUtils.getLong(jsonObject, "exp")));
    }
