...
extends CommonClaimsSet {
    ...
    public JWKSet getJWKSet() {
        ...
        try {
            return JWKSet.parse((Map)jwkSetJSONObject);
        }
    ...
    public boolean hasMetadata() {
        ...
        if (metadataObject.get((Object)FederationMetadataType.OPENID_RELYING_PARTY.getValue()) != null) {
            return true;
        }
        if (metadataObject.get((Object)FederationMetadataType.OPENID_PROVIDER.getValue()) != null) {
            return true;
        }
        if (metadataObject.get((Object)FederationMetadataType.OAUTH_AUTHORIZATION_SERVER.getValue()) != null) {
            return true;
        }
        if (metadataObject.get((Object)FederationMetadataType.OAUTH_CLIENT.getValue()) != null) {
            return true;
        }
        if (metadataObject.get((Object)FederationMetadataType.OAUTH_RESOURCE.getValue()) != null) {
            return true;
        }
        return metadataObject.get((Object)FederationMetadataType.FEDERATION_ENTITY.getValue()) != null;
    }
    ...
    public void setMetadata(FederationMetadataType type, JSONObject metadata) {
        ...
        o.put((Object)type.getValue(), (Object)metadata);
    ...
    public void setMetadataPolicy(FederationMetadataType type, MetadataPolicy metadataPolicy) {
        ...
        if (metadataPolicy != null) {
            o.put((Object)type.getValue(), (Object)metadataPolicy.toJSONObject());
        } else {
            o.remove((Object)type.getValue());
        }
        if (o.isEmpty()) {
            o = null;
        }
