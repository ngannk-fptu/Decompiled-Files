...
implements JSONAware {
    ...
    public Entry get(String claimName) {
        return this.get(claimName, null);
    }
    ...
    public Entry get(String claimName, LangTag langTag) {
        for (Entry en : this.getEntries()) {
            ...
            if (!claimName.equals(en.getClaimName()) || langTag == null || !langTag.equals((Object)en.getLangTag())) continue;
            return en;
        }
        return null;
    }
    ...
    public ClaimsSetRequest delete(String claimName, LangTag langTag) {
        ...
        for (Entry en : this.getEntries()) {
            if (claimName.equals(en.getClaimName()) && langTag == null && en.getLangTag() == null || claimName.equals(en.getClaimName()) && langTag != null && langTag.equals((Object)en.getLangTag())) continue;
    ...
    public JSONObject toJSONObject() {
        ...
        for (Entry entry : this.entries) {
            ...
            o.put((Object)jsonObjectEntry.getKey(), (Object)jsonObjectEntry.getValue());
        }
        return o;
    }
    ...
    public static class Entry {
        ...
        public Map.Entry<String, JSONObject> toJSONObjectEntry() {
            ...
            if (this.getRawValue() != null) {
                ...
                entrySpec.put((Object)"value", this.getRawValue());
            }
            if (this.getValuesAsRawList() != null) {
                entrySpec = new JSONObject();
                entrySpec.put((Object)"values", this.getValuesAsRawList());
            }
            ...
            if (this.getPurpose() != null) {
                ...
                entrySpec.put((Object)"purpose", (Object)this.getPurpose());
            }
        ...
        public static Entry parse(Map.Entry<String, JSONObject> jsonObjectEntry) throws ParseException {
            ...
            if (spec.containsKey((Object)"essential") && (isEssential = JSONObjectUtils.getBoolean(spec, "essential"))) {
                requirement = ClaimRequirement.ESSENTIAL;
            }
            String purpose = JSONObjectUtils.getString(spec, "purpose", null);
            if (spec.get((Object)"value") != null) {
                Object expectedValue = spec.get((Object)"value");
            ...
            if (spec.get((Object)"values") != null) {
