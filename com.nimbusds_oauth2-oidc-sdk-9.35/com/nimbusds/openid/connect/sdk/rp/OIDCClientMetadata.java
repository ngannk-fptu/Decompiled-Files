...
extends ClientMetadata {
    ...
    public OIDCClientMetadata(OIDCClientMetadata metadata) {
        ...
        this.attachmentDigestAlg = metadata.getAttachmentDigestAlg();
    }
    ...
    public void setAttachmentDigestAlg(HashAlgorithm hashAlg) {
        this.attachmentDigestAlg = hashAlg;
    }
    ...
    public JSONObject toJSONObject(boolean includeCustomFields) {
        ...
        if (this.defaultACRs != null) {
            ...
            for (ACR acr : this.defaultACRs) {
                acrList.add((Object)acr.getValue());
            }
        ...
        if (this.attachmentDigestAlg != null) {
            o.put((Object)"digest_algorithm", (Object)this.attachmentDigestAlg.getValue());
        }
        return o;
    }
    ...
    public static OIDCClientMetadata parse(JSONObject jsonObject) throws ParseException {
        ...
        try {
            ...
            if (jsonObject.get((Object)"frontchannel_logout_uri") != null) {
                ...
                oidcFields.remove((Object)"frontchannel_logout_uri");
                if (jsonObject.get((Object)"frontchannel_logout_session_required") != null) {
                    ...
                    oidcFields.remove((Object)"frontchannel_logout_session_required");
                }
            }
            if (jsonObject.get((Object)"backchannel_logout_uri") != null) {
                ...
                oidcFields.remove((Object)"backchannel_logout_uri");
                if (jsonObject.get((Object)"backchannel_logout_session_required") != null) {
                    ...
                    oidcFields.remove((Object)"backchannel_logout_session_required");
                }
            }
            if (jsonObject.get((Object)"digest_algorithm") != null) {
                metadata.setAttachmentDigestAlg(new HashAlgorithm(JSONObjectUtils.getString(jsonObject, "digest_algorithm")));
                oidcFields.remove((Object)"digest_algorithm");
            }
        }
