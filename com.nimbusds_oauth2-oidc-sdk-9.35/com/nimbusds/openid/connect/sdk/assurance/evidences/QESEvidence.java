...
extends IdentityEvidence {
    ...
    public JSONObject toJSONObject() {
        ...
        if (this.getQESIssuer() != null) {
            o.put((Object)"issuer", (Object)this.getQESIssuer().getValue());
        }
        if (this.getQESSerialNumberString() != null) {
            o.put((Object)"serial_number", (Object)this.getQESSerialNumberString());
        }
        if (this.getQESCreationTime() != null) {
            o.put((Object)"created_at", (Object)this.getQESCreationTime().toISO8601String());
        }
        return o;
    }
