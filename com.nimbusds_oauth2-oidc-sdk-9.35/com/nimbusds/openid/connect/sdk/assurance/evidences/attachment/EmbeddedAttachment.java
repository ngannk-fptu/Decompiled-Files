...
extends Attachment {
    ...
    public JSONObject toJSONObject() {
        ...
        o.put((Object)"content_type", (Object)this.getContent().getType().toString());
        o.put((Object)"content", (Object)this.getContent().getBase64().toString());
        return o;
    }
    ...
    public static EmbeddedAttachment parse(JSONObject jsonObject) throws ParseException {
        ContentType type;
        try {
            type = ContentType.parse((String)JSONObjectUtils.getString(jsonObject, "content_type"));
        }
        catch (java.text.ParseException e) {
            throw new ParseException("Invalid content_type: " + e.getMessage(), e);
        }
        Base64 base64 = Base64.from((String)JSONObjectUtils.getString(jsonObject, "content"));
