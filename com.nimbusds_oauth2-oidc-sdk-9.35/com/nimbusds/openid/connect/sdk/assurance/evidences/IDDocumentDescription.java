...
implements JSONAware {
    ...
    public JSONObject toJSONObject() {
        ...
        if (this.getNumber() != null) {
            o.put((Object)"number", (Object)this.getNumber());
        }
        JSONObject issuerObject = new JSONObject();
        if (this.getIssuerName() != null) {
            issuerObject.put((Object)"name", (Object)this.getIssuerName());
        }
        if (this.getIssuerCountry() != null) {
            issuerObject.put((Object)"country", (Object)this.getIssuerCountry().getValue());
        }
        if (!issuerObject.isEmpty()) {
            o.put((Object)"issuer", (Object)issuerObject);
        }
    ...
    public static IDDocumentDescription parse(JSONObject jsonObject) throws ParseException {
        ...
        if (issuerObject != null) {
            ...
            if (issuerObject.get((Object)"country") != null) {
