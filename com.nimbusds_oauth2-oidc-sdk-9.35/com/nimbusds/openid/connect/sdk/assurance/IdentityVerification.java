...
implements JSONAware {
    ...
    public JSONObject toJSONObject() {
        ...
        if (this.getAssuranceLevel() != null) {
            o.put((Object)"assurance_level", (Object)this.getAssuranceLevel().getValue());
        }
        if (this.getAssuranceProcess() != null) {
            o.put((Object)"assurance_process", (Object)this.getAssuranceProcess().toJSONObject());
        }
        ...
        if (this.getVerificationProcess() != null) {
            o.put((Object)"verification_process", (Object)this.getVerificationProcess().getValue());
        }
