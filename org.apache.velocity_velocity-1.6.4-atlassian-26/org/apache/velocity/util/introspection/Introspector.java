...
extends IntrospectorBase {
    public Introspector(Log log, RuntimeServices runtimeServices) {
        super(log, runtimeServices);
    }

    public Introspector(RuntimeLogger logger, RuntimeServices runtimeServices) {
        this(new RuntimeLoggerLog(logger), runtimeServices);
    }
