...
public interface RuntimeConstants {
    ...
    public static final String INTROSPECTOR_ALLOWLIST_CLASSES = "introspector.allowlist.classes";
    public static final String INTROSPECTOR_CACHE_CLASS = "introspector.cache.classes";
