...
extends RuntimeLogger {
    ...
    public boolean evaluate(Context var1, Writer var2, String var3, String var4) throws IOException;

    public boolean evaluate(Context var1, Writer var2, String var3, Reader var4) throws IOException;

    public boolean invokeVelocimacro(String var1, String var2, String[] var3, Context var4, Writer var5) throws IOException;

    public Template getTemplate(String var1) throws ResourceNotFoundException, ParseErrorException, Exception;

    public Template getTemplate(String var1, String var2) throws ResourceNotFoundException, ParseErrorException, Exception;

    public ContentResource getContent(String var1) throws ResourceNotFoundException, ParseErrorException, Exception;

    public ContentResource getContent(String var1, String var2) throws ResourceNotFoundException, ParseErrorException, Exception;
