...
implements CharStream {
    ...
    private final void FillBuff() throws IOException {
        ...
        try {
            if (this.streamClosed) {
                throw new StackTracelessIOException();
            }
    ...
    public VelocityCharStream(Reader dstream, int startline, int startcolumn, int buffersize) {
        ...
        this.bufsize = this.nextBufExpand = buffersize;
        this.available = this.nextBufExpand;
    ...
    private static class StackTracelessIOException
    extends IOException {
        private StackTracelessIOException() {
        }
