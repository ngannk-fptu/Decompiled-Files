...
public class JCEMapper {
    ...
    public static void registerDefaultAlgorithms() {
        ...
        algorithmsMap.put("http://www.w3.org/2007/05/xmldsig-more#rsa-pss", new Algorithm("RSA", "RSASSA-PSS", "Signature"));
        ...
        algorithmsMap.put("http://www.w3.org/2021/04/xmldsig-more#eddsa-ed25519", new Algorithm("Ed25519", "Ed25519", "Signature"));
        algorithmsMap.put("http://www.w3.org/2021/04/xmldsig-more#eddsa-ed448", new Algorithm("Ed448", "Ed448", "Signature"));
    ...
    public static String translateURItoJCEID(String algorithmURI) {
        Algorithm algorithm = JCEMapper.getAlgorithm(algorithmURI);
        if (algorithm != null) {
    ...
    private static Algorithm getAlgorithm(String algorithmURI) {
        LOG.debug("Request for URI {}", (Object)algorithmURI);
    ...
    public static class Algorithm {
        ...
        public Algorithm(Element el) {
            ...
            this.jceProvider = el.getAttributeNS(null, "JCEProvider");
            this.keyLength = el.hasAttribute("KeyLength") ? Integer.parseInt(el.getAttributeNS(null, "KeyLength")) : 0;
            this.ivLength = el.hasAttribute("IVLength") ? Integer.parseInt(el.getAttributeNS(null, "IVLength")) : 0;
        }
