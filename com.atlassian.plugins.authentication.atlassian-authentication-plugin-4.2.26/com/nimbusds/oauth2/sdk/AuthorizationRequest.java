...
extends AbstractRequest {
    ...
    public Map<String, List<String>> toParameters() {
        ...
        if (this.resources != null) {
            LinkedList<String> resourceValues = new LinkedList<String>();
            for (URI resourceURI : this.resources) {
        ...
        if (vList != null) {
            ...
            for (String uriValue : vList) {
                ...
                try {
                    ...
                    throw new ParseException(errMsg, OAuth2Error.INVALID_RESOURCE.setDescription(errMsg), clientID, redirectURI, ResponseMode.resolve(rm, rt), state, e);
                }
                if (!ResourceUtils.isValidResourceURI(resourceURI)) {
                    throw new ParseException(errMsg, OAuth2Error.INVALID_RESOURCE.setDescription(errMsg), clientID, redirectURI, ResponseMode.resolve(rm, rt), state, null);
                }
