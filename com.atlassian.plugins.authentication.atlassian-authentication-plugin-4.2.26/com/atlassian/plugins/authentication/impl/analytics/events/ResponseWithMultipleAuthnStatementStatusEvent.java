...
public class ResponseWithMultipleAuthnStatementStatusEvent
extends AbstractCompatibilityModeStatusEvent {
    ...
    public ResponseWithMultipleAuthnStatementStatusEvent(String nodeId, TrackingCompatibilityModeResponseHandler.CompatibilityModeResponseData compatibilityModeResponseData) {
        super(nodeId);
    ...
    public String getEventName() {
        String bucket = this.resolveBucket(this.compatibilityModeResponseData.getAmountOfResponsesWithMultipleAuthnStatements());
        return "plugins.authentication.status.saml.compat.authnstatements.multiple." + bucket;
    }
}
