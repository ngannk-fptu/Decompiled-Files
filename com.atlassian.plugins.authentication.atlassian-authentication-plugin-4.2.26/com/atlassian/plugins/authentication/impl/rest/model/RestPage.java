...
public class RestPage<T> {
    ...
    public <E> RestPage(RestPage<? extends E> page, Function<E, ? extends T> restTransform) {
        this((List<T>)ImmutableList.copyOf((Iterable)Iterables.transform(page.getResults(), restTransform)), page.getSize(), page.getStart(), page.getLimit(), page.isLastPage());
    }
    ...
    public String toString() {
        return MoreObjects.toStringHelper((Object)this).add(VALUES_PROPERTY, this.results).add(SIZE_PROPERTY, this.size).add(START_PROPERTY, this.start).add(LIMIT_PROPERTY, this.limit).add(LAST_PAGE_PROPERTY, this.isLastPage).toString();
    }
}
