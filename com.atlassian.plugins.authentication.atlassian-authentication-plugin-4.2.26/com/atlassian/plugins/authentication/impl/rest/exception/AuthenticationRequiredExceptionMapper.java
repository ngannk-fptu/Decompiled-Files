...
implements ExceptionMapper<AuthenticationRequiredException> {
    ...
    public Response toResponse(AuthenticationRequiredException exception) {
        return Response.status((Response.Status)Response.Status.UNAUTHORIZED).entity((Object)new ErrorEntity(this.i18nResolver.getText("authentication.config.save.fail.needs.authentication"))).type("application/json").build();
    }
}
