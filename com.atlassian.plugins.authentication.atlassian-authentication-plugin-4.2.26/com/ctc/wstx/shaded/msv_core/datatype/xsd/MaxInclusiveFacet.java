...
extends RangeFacet {
    ...
    protected MaxInclusiveFacet(String nsUri, String typeName, XSDatatypeImpl baseType, Object limit, boolean _isFixed) throws DatatypeException {
        super(nsUri, typeName, baseType, "maxInclusive", limit, _isFixed);
    }
