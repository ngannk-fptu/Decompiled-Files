...
implements InputConfigFlags {
    ...
    protected int mMaxDtdDepth = 500;
    ...
    private ReaderConfig(ReaderConfig base, boolean j2meSubset, SymbolTable symbols, int configFlags, int configFlagMods, int inputBufLen, int minTextSegmentLen) {
        ...
        if (base != null) {
            ...
            this.mMaxDtdDepth = base.mMaxDtdDepth;
        }
        if ((ref = mRecyclerRef.get()) != null) {
    ...
    public ReaderConfig createNonShared(SymbolTable sym) {
        ...
        rc.mMaxDtdDepth = this.mMaxDtdDepth;
    ...
    public boolean willProcessSecurely() {
        return this._hasConfigFlag(0x2000000);
    }
    ...
    public boolean willAllowXml11EscapedCharsInXml10() {
        return this._hasConfigFlag(0x1000000);
    }
    ...
    public Map<String, EntityDecl> getCustomInternalEntities() {
        ...
        for (Map.Entry me : custEnt.entrySet()) {
            m.put((String)me.getKey(), (EntityDecl)me.getValue());
        }
        return m;
    }
    ...
    public boolean isCoalescingExplicitlyDisabled() {
        return !this._hasConfigFlag(2) && (this.mConfigFlagMods & 2) != 0;
    }
    ...
    public void doProcessSecurely(boolean value) {
        this.setConfigFlag(0x2000000, value);
        if (value) {
            this.doSupportExternalEntities(false);
        }
    }
    ...
    public void doAllowXml11EscapedCharsInXml10(boolean state) {
        this.setConfigFlag(0x1000000, state);
    }
    ...
    public void setMaxDtdDepth(int value) {
        this.mMaxDtdDepth = value;
    }

    public void setCustomInternalEntities(Map<String, ?> m) {
        Map<String, IntEntity> entMap;
        if (m == null || m.size() < 1) {
    ...
    public Object getProperty(int id) {
        switch (id) {
            ...
            case 47: {
                return this.willAllowXml11EscapedCharsInXml10() ? Boolean.TRUE : Boolean.FALSE;
            }
            case 40: {
                return this.willNormalizeLFs() ? Boolean.TRUE : Boolean.FALSE;
            }
            case 50: {
                return this.getInputBufferLength();
            }
            case 60: {
                return this.getMaxAttributesPerElement();
            }
            case 65: {
                return this.getMaxAttributeSize();
            }
            case 61: {
                return this.getMaxChildrenPerElement();
            }
            case 63: {
                return this.getMaxElementDepth();
            }
            case 62: {
            ...
            case 68: {
                return this.getMaxEntityDepth();
            }
            case 67: {
                return this.getMaxEntityCount();
            }
            case 69: {
                return this.getMaxDtdDepth();
            }
            case 52: {
                return this.getShortestReportedTextSegment();
            }
            case 53: {
    ...
    public boolean setProperty(String propName, int id, Object value) {
        switch (id) {
            ...
            case 30: {
                this.doProcessSecurely(ArgUtil.convertToBoolean(propName, value));
                break;
            }
            case 42: {
            ...
            case 47: {
                this.doAllowXml11EscapedCharsInXml10(ArgUtil.convertToBoolean(propName, value));
                break;
            }
            case 40: {
            ...
            case 69: {
                this.setMaxDtdDepth(ArgUtil.convertToInt(propName, value, 1));
                break;
            }
            case 52: {
    ...
    static {
        ...
        sProperties.put("javax.xml.stream.isNamespaceAware", 2);
        ...
        sProperties.put("javax.xml.stream.reporter", 8);
        sProperties.put("javax.xml.stream.resolver", 9);
        sProperties.put("org.codehaus.stax2.internNames", 21);
        sProperties.put("org.codehaus.stax2.internNsUris", 20);
        sProperties.put("http://java.sun.com/xml/stream/properties/report-cdata-event", 22);
        sProperties.put("org.codehaus.stax2.reportPrologWhitespace", 23);
        sProperties.put("org.codehaus.stax2.preserveLocation", 24);
        sProperties.put("org.codehaus.stax2.closeInputSource", 25);
        sProperties.put("org.codehaus.stax2.supportXmlId", 26);
        ...
        sProperties.put("com.ctc.wstx.cacheDTDs", 42);
        sProperties.put("com.ctc.wstx.cacheDTDsByPublicId", 43);
        sProperties.put("com.ctc.wstx.lazyParsing", 44);
        sProperties.put("com.ctc.wstx.treatCharRefsAsEnts", 46);
        sProperties.put("com.ctc.wstx.allowXml11EscapedCharsInXml10", 47);
        sProperties.put("com.ctc.wstx.normalizeLFs", 40);
        sProperties.put("com.ctc.wstx.inputBufferLength", 50);
        sProperties.put("com.ctc.wstx.minTextSegment", 52);
        sProperties.put("com.ctc.wstx.maxAttributesPerElement", 60);
        sProperties.put("com.ctc.wstx.maxAttributeSize", 65);
        sProperties.put("com.ctc.wstx.maxChildrenPerElement", 61);
        sProperties.put("com.ctc.wstx.maxTextLength", 66);
        sProperties.put("com.ctc.wstx.maxElementCount", 62);
        sProperties.put("com.ctc.wstx.maxElementDepth", 63);
        sProperties.put("com.ctc.wstx.maxEntityDepth", 68);
        sProperties.put("com.ctc.wstx.maxEntityCount", 67);
        sProperties.put("com.ctc.wstx.maxDtdDepth", 69);
        sProperties.put("com.ctc.wstx.maxCharacters", 64);
        sProperties.put("com.ctc.wstx.customInternalEntities", 53);
        sProperties.put("com.ctc.wstx.dtdResolver", 54);
        sProperties.put("com.ctc.wstx.entityResolver", 55);
        sProperties.put("com.ctc.wstx.undeclaredEntityResolver", 56);
        sProperties.put("com.ctc.wstx.baseURL", 57);
        sProperties.put("com.ctc.wstx.fragmentMode", 58);
