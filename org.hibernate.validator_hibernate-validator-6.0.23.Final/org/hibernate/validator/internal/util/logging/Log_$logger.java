...
Serializable {
    ...
    public final void ignoringXmlConfiguration() {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.ignoringXmlConfiguration$str(), new Object[0]);
    }
    ...
    public final void usingConstraintValidatorFactory(Class<? extends ConstraintValidatorFactory> constraintValidatorFactoryClass) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.usingConstraintValidatorFactory$str(), (Object)new ClassObjectFormatter(constraintValidatorFactoryClass));
    }
    ...
    public final void usingMessageInterpolator(Class<? extends MessageInterpolator> messageInterpolatorClass) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.usingMessageInterpolator$str(), (Object)new ClassObjectFormatter(messageInterpolatorClass));
    }
    ...
    public final void usingTraversableResolver(Class<? extends TraversableResolver> traversableResolverClass) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.usingTraversableResolver$str(), (Object)new ClassObjectFormatter(traversableResolverClass));
    }
    ...
    public final void usingValidationProvider(Class<? extends ValidationProvider<?>> validationProviderClass) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.usingValidationProvider$str(), (Object)new ClassObjectFormatter(validationProviderClass));
    }
    ...
    public final void parsingXMLFile(String fileName) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.parsingXMLFile$str(), (Object)fileName);
    }
    ...
    public final void unableToCloseInputStream() {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.unableToCloseInputStream$str(), new Object[0]);
    }
    ...
    public final void unableToCloseXMLFileInputStream(String fileName) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.unableToCloseXMLFileInputStream$str(), (Object)fileName);
    }
    ...
    public final void unableToCreateSchema(String fileName, String message) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.unableToCreateSchema$str(), (Object)fileName, (Object)message);
    }
    ...
    public final void usingParameterNameProvider(Class<? extends ParameterNameProvider> parameterNameProviderClass) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.usingParameterNameProvider$str(), (Object)new ClassObjectFormatter(parameterNameProviderClass));
    }
    ...
    public final void warnElIsUnsupported(String expression) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.warnElIsUnsupported$str(), (Object)expression);
    }
    ...
    public final void unknownJvmVersion(String vmVersionStr) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.unknownJvmVersion$str(), (Object)vmVersionStr);
    }
    ...
    public final void usingClockProvider(Class<? extends ClockProvider> clockProviderClass) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.usingClockProvider$str(), (Object)new ClassObjectFormatter(clockProviderClass));
    }
    ...
    public final void addingValueExtractor(Class<? extends ValueExtractor<?>> valueExtractorClass) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.addingValueExtractor$str(), (Object)new ClassObjectFormatter(valueExtractorClass));
    }
    ...
    public final void usingScriptEvaluatorFactory(Class<? extends ScriptEvaluatorFactory> scriptEvaluatorFactoryClass) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.usingScriptEvaluatorFactory$str(), (Object)new ClassObjectFormatter(scriptEvaluatorFactoryClass));
    }
    ...
    public final void logValidatorFactoryScopedConfiguration(Class<?> configuredClass, String configuredElement) {
        this.log.logf(FQCN, Logger.Level.DEBUG, null, this.logValidatorFactoryScopedConfiguration$str(), (Object)new ClassObjectFormatter(configuredClass), (Object)configuredElement);
    }
    ...
    public final void logTemporalValidationTolerance(Duration tolerance) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.logTemporalValidationTolerance$str(), (Object)new DurationFormatter(tolerance));
    }
    ...
    public final void logConstraintValidatorPayload(Object payload) {
        this.log.logf(FQCN, Logger.Level.DEBUG, null, this.logConstraintValidatorPayload$str(), payload);
    }
    ...
    public final void logUnableToLoadOrInstantiateJPAAwareResolver(String traversableResolverClassName) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.logUnableToLoadOrInstantiateJPAAwareResolver$str(), (Object)traversableResolverClassName);
    }
