...
implements EntityManagerMessageLogger,
CoreMessageLogger,
BasicLogger,
Serializable {
    ...
    public EntityManagerMessageLogger_$logger(Logger log) {
        super(log);
    }
    ...
    @Override
    public final void boundEjb3ConfigurationToJndiName(String name) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.boundEjb3ConfigurationToJndiName$str(), (Object)name);
    }

    protected String boundEjb3ConfigurationToJndiName$str() {
        return "HHH015001: Bound Ejb3Configuration to JNDI name: %s";
    }

    @Override
    public final void ejb3ConfigurationName(String name) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.ejb3ConfigurationName$str(), (Object)name);
    }

    protected String ejb3ConfigurationName$str() {
        return "HHH015002: Ejb3Configuration name: %s";
    }

    @Override
    public final void ejb3ConfigurationRenamedFromName(String name) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.ejb3ConfigurationRenamedFromName$str(), (Object)name);
    }

    protected String ejb3ConfigurationRenamedFromName$str() {
        return "HHH015003: An Ejb3Configuration was renamed from name: %s";
    }

    @Override
    public final void ejb3ConfigurationUnboundFromName(String name) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.ejb3ConfigurationUnboundFromName$str(), (Object)name);
    }

    protected String ejb3ConfigurationUnboundFromName$str() {
        return "HHH015004: An Ejb3Configuration was unbound from name: %s";
    }

    @Override
    public final void explodedJarDoesNotExist(URL jarUrl) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.explodedJarDoesNotExist$str(), (Object)jarUrl);
    }

    protected String explodedJarDoesNotExist$str() {
        return "HHH015005: Exploded jar file does not exist (ignored): %s";
    }

    @Override
    public final void explodedJarNotDirectory(URL jarUrl) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.explodedJarNotDirectory$str(), (Object)jarUrl);
    }

    protected String explodedJarNotDirectory$str() {
        return "HHH015006: Exploded jar file not a directory (ignored): %s";
    }

    @Override
    public final void illegalArgumentOnStaticMetamodelFieldInjection(String name, String name2, String name3, String name4) {
        this.log.logf(FQCN, Logger.Level.ERROR, null, this.illegalArgumentOnStaticMetamodelFieldInjection$str(), new Object[]{name, name2, name3, name4});
    }

    protected String illegalArgumentOnStaticMetamodelFieldInjection$str() {
        return "HHH015007: Illegal argument on static metamodel field injection : %s#%s; expected type :  %s; encountered type : %s";
    }

    @Override
    public final void malformedUrl(URL jarUrl, URISyntaxException e) {
        this.log.logf(FQCN, Logger.Level.ERROR, (Throwable)e, this.malformedUrl$str(), (Object)jarUrl);
    }

    protected String malformedUrl$str() {
        return "HHH015008: Malformed URL: %s";
    }

    @Override
    public final void malformedUrlWarning(URL jarUrl, URISyntaxException e) {
        this.log.logf(FQCN, Logger.Level.WARN, (Throwable)e, this.malformedUrlWarning$str(), (Object)jarUrl);
    }

    protected String malformedUrlWarning$str() {
        return "HHH015009: Malformed URL: %s";
    }

    @Override
    public final void unableToFindFile(URL jarUrl, Exception e) {
        this.log.logf(FQCN, Logger.Level.WARN, (Throwable)e, this.unableToFindFile$str(), (Object)jarUrl);
    }

    protected String unableToFindFile$str() {
        return "HHH015010: Unable to find file (ignored): %s";
    }

    @Override
    public final void unableToLocateStaticMetamodelField(String name, String name2) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.unableToLocateStaticMetamodelField$str(), (Object)name, (Object)name2);
    }

    protected String unableToLocateStaticMetamodelField$str() {
        return "HHH015011: Unable to locate static metamodel field : %s#%s; this may or may not indicate a problem with the static metamodel";
    }

    @Override
    public final void usingProvidedDataSource() {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.usingProvidedDataSource$str(), new Object[0]);
    }

    protected String usingProvidedDataSource$str() {
        return "HHH015012: Using provided datasource";
    }

    @Override
    public final void ignoringEntityNotFound(String entityName, String identifier) {
        this.log.logf(FQCN, Logger.Level.DEBUG, null, this.ignoringEntityNotFound$str(), (Object)entityName, (Object)identifier);
    }

    protected String ignoringEntityNotFound$str() {
        return "HHH015013: Returning null (as required by JPA spec) rather than throwing EntityNotFoundException, as the entity (type=%s, id=%s) does not exist";
    }

    @Override
    public final void deprecatedJpaPositionalParameterAccess(Integer jpaPositionalParameter) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.deprecatedJpaPositionalParameterAccess$str(), (Object)jpaPositionalParameter);
    }

    protected String deprecatedJpaPositionalParameterAccess$str() {
        return "HHH015014: DEPRECATION - attempt to refer to JPA positional parameter [?%1$s] using String name [\"%1$s\"] rather than int position [%1$s] (generally in Query#setParameter, Query#getParameter or Query#getParameterValue calls).  Hibernate previously allowed such usage, but it is considered deprecated.";
    }

    @Override
    public final void unusedMappedSuperclass(String name) {
        this.log.logf(FQCN, Logger.Level.INFO, null, this.unusedMappedSuperclass$str(), (Object)name);
    }

    protected String unusedMappedSuperclass$str() {
        return "HHH015015: Encountered a MappedSuperclass [%s] not used in any entity hierarchy";
    }

    @Override
    public final void deprecatedPersistenceProvider(String deprecated, String replacement) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.deprecatedPersistenceProvider$str(), (Object)deprecated, (Object)replacement);
    }

    protected String deprecatedPersistenceProvider$str() {
        return "HHH015016: Encountered a deprecated javax.persistence.spi.PersistenceProvider [%s]; [%s] will be used instead.";
    }

    @Override
    public final void deprecatedInstrumentationProperty() {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.deprecatedInstrumentationProperty$str(), new Object[0]);
    }

    protected String deprecatedInstrumentationProperty$str() {
        return "HHH015017: 'hibernate.ejb.use_class_enhancer' property is deprecated. Use 'hibernate.enhance.enable[...]' properties instead to enable each individual feature.";
    }

    @Override
    public final void duplicatedPersistenceUnitName(String name) {
        this.log.logf(FQCN, Logger.Level.WARN, null, this.duplicatedPersistenceUnitName$str(), (Object)name);
    }

    protected String duplicatedPersistenceUnitName$str() {
        return "HHH015018: Encountered multiple persistence-unit stanzas defining same name [%s]; persistence-unit names must be unique";
    }
    ...
    public final HibernateException usingStoppedClassLoaderService() {
        ...
        EntityManagerMessageLogger_$logger._copyStackTraceMinusOne((Throwable)((Object)result));
        return result;
    }
