...
class SingularAttributeSourceEmbeddedImpl
extends AbstractSingularAttributeSourceEmbeddedImpl {
    ...
    public SingularAttributeSourceEmbeddedImpl(MappingDocument sourceMappingDocument, AttributeSourceContainer parentContainer, final JaxbHbmCompositeAttributeType jaxbComponentElement, NaturalIdMutability naturalIdMutability, String logicalTableName) {
    ...
    public SingularAttributeSourceEmbeddedImpl(MappingDocument mappingDocument, AttributeSourceContainer parentContainer, final JaxbHbmNestedCompositeElementType attributeJaxbMapping, NaturalIdMutability naturalIdMutability, String logicalTableName) {
    ...
    public SingularAttributeSourceEmbeddedImpl(MappingDocument sourceMappingDocument, AttributeSourceContainer parentContainer, final JaxbHbmDynamicComponentType jaxbDynamicEmbeddedMapping, NaturalIdMutability naturalIdMutability, String logicalTableName) {
        super(sourceMappingDocument, parentContainer, new EmbeddedAttributeMapping(){
            private final EmbeddableMapping embeddableMapping = new EmbeddableMapping(){
    ...
    public ToolingHintContext getToolingHintContext() {
        return this.getEmbeddableSource().getToolingHintContext();
    }
}
