...
@XmlType(name="attributes", namespace="http://xmlns.jcp.org/xml/ns/persistence/orm", propOrder={"description", "id", "embeddedId", "basic", "version", "manyToOne", "oneToMany", "oneToOne", "manyToMany", "elementCollection", "embedded", "_transient"})
...
AttributesContainer {
    ...
    public List<JaxbVersion> getVersion() {
        if (this.version == null) {
            this.version = new ArrayList<JaxbVersion>();
        }
        return this.version;
    }
