...
@XmlType(name="JoinedSubclassEntityType", namespace="http://www.hibernate.org/xsd/orm/hbm", propOrder={"tuplizer", "subselect", "synchronize", "comment", "key", "attributes", "joinedSubclass", "loader", "sqlInsert", "sqlUpdate", "sqlDelete", "fetchProfile", "resultset", "query", "sqlQuery"})
