...
Serializable {
    ...
    public ObjectWriter with(DatatypeFeature feature) {
        return this._new(this, (SerializationConfig)this._config.with(feature));
    }

    public ObjectWriter withFeatures(DatatypeFeature ... features) {
        return this._new(this, (SerializationConfig)this._config.withFeatures(features));
    }

    public ObjectWriter without(DatatypeFeature feature) {
        return this._new(this, (SerializationConfig)this._config.without(feature));
    }

    public ObjectWriter withoutFeatures(DatatypeFeature ... features) {
        return this._new(this, (SerializationConfig)this._config.withoutFeatures(features));
    }
