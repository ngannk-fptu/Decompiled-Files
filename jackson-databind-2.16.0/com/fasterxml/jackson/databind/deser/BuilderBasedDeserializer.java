    ...
    protected Object _deserializeUsingPropertyBased(JsonParser p, DeserializationContext ctxt) throws IOException {
                    ...
                    if (creatorProp != null) {
                        if (activeView != null && !creatorProp.visibleInView(activeView)) {
                            ...
                            if (builder2.getClass() != this._beanType.getRawClass()) {
                                return this.handlePolymorphic(p, ctxt, p.streamReadConstraints(), builder2, unknown);
                            }
                            if (unknown != null) {
        ...
        if (unknown != null) {
            if (builder.getClass() != this._beanType.getRawClass()) {
                return this.handlePolymorphic(null, ctxt, p.streamReadConstraints(), builder, unknown);
            }
                ...
                if (!buffer.readIdProperty(propName) || creatorProp != null) {
                    if (creatorProp != null) {
                        if (buffer.assignParameter(creatorProp, creatorProp.deserialize(p, ctxt))) {
                            ...
                            if (builder.getClass() != this._beanType.getRawClass()) {
                                return this.handlePolymorphic(p, ctxt, p.streamReadConstraints(), builder, tokens);
                            }
                            return this.deserializeWithUnwrapped(p, ctxt, builder, tokens);
                        }
                    } else {
