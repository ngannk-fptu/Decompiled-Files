...
public class CreatorCollector {
    ...
    public ValueInstantiator constructValueInstantiator(DeserializationContext ctxt) throws JsonMappingException {
        ...
        JavaType delegateType = this._computeDelegateType(ctxt, this._creators[8], this._delegateArgs);
        JavaType arrayDelegateType = this._computeDelegateType(ctxt, this._creators[10], this._arrayDelegateArgs);
