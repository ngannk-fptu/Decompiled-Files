...
public class ZstdBufferDecompressingStream
implements Closeable {
    ...
    public synchronized ZstdBufferDecompressingStream setDict(byte[] byArray) throws IOException {
    ...
    public ZstdBufferDecompressingStream setLongMax(int n) throws IOException {
