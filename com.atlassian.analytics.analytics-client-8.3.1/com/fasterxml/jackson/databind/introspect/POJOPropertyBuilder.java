...
implements Comparable<POJOPropertyBuilder> {
    ...
    protected PropertyMetadata _getSetterInfo(PropertyMetadata metadata, AnnotatedMember primary) {
        ...
        if (primary != null) {
            if (this._annotationIntrospector != null) {
                Boolean b;
                if (acc != null && (b = this._annotationIntrospector.findMergeInfo(primary)) != null) {
                    needMerge = false;
                    if (b.booleanValue()) {
                        metadata = metadata.withMergeInfo(PropertyMetadata.MergeInfo.createForPropertyOverride(acc));
                    }
                }
                if ((setterInfo = this._annotationIntrospector.findSetterInfo(primary)) != null) {
    ...
    protected AnnotatedMethod _selectSetterFromMultiple(Linked<AnnotatedMethod> curr, Linked<AnnotatedMethod> next) {
        ArrayList<AnnotatedMethod> conflicts = new ArrayList<AnnotatedMethod>();
    ...
    protected AnnotatedMethod _selectSetter(AnnotatedMethod currM, AnnotatedMethod nextM) {
        ...
        if (currClass != (nextClass = nextM.getDeclaringClass())) {
        ...
        if ((priNext = this._setterPriority(nextM)) != (priCurr = this._setterPriority(currM))) {
            if (priNext < priCurr) {
                return nextM;
            }
            return currM;
