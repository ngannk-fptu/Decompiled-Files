...
Cloneable {
    ...
    public void setPolicyNames(Collection<String> policyNames) {
        ...
        this.policyNames = new SdkInternalList<String>(policyNames);
    }

    public ListKeyPoliciesResult withPolicyNames(String ... policyNames) {
        if (this.policyNames == null) {
            this.setPolicyNames(new SdkInternalList<String>(policyNames.length));
        }
    ...
    public ListKeyPoliciesResult withPolicyNames(Collection<String> policyNames) {
        this.setPolicyNames(policyNames);
        return this;
    }
    ...
    public String toString() {
        ...
        if (this.getPolicyNames() != null) {
            sb.append("PolicyNames: ").append(this.getPolicyNames()).append(",");
        }
