...
PrivateIonDatagram {
    ...
    @Override
    public boolean add(IonValue child) throws ContainedValueException, NullPointerException {
    ...
    public ListIterator<IonValue> listIterator(int index) {
        IonContainerLite.SequenceContentIterator iterator = new IonContainerLite.SequenceContentIterator(this, index, this.isReadOnly());
        return iterator;
    }
    ...
    public IonValue systemGet(int index) throws IndexOutOfBoundsException {
        ListIterator<IonValue> iterator = this.systemIterator();
        IonValue value = null;
        if (index < 0) {
