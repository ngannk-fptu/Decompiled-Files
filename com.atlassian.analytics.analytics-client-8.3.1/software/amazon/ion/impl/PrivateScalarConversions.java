...
public class PrivateScalarConversions {
    ...
    public static String get_value_type_name(int value_type) {
        switch (value_type) {
            ...
            case 9: 
            case 10: {
                return PrivateScalarConversions.getValueTypeName(value_type) + "_value";
            }
        }
        return "<unrecognized conversion value type: " + Integer.toString(value_type) + ">";
    }
    ...
    public static final String getAllValueTypeNames(int value_type) {
        ...
        for (int ii = 0; ii < 32; ++ii) {
            if ((value_type & bit) != 0) {
                sb.append(PrivateScalarConversions.getValueTypeName(bit));
                sb.append(' ');
            }
            bit <<= 1;
        }
    ...
    protected static final int getConversionFnid(int authoritative_type, int new_type) {
        ...
        String message = "can't convert from " + PrivateScalarConversions.getValueTypeName(authoritative_type) + " to " + PrivateScalarConversions.getValueTypeName(new_type);
    ...
    public static final class ValueVariant {
        ...
        public final void setAuthoritativeType(int value_type) {
            ...
            if (!this.hasValueOfType(value_type)) {
                String message = "you must set the " + PrivateScalarConversions.getValueTypeName(value_type) + " value before you can set the authoritative type to " + PrivateScalarConversions.getValueTypeName(value_type);
        ...
        public final int get_conversion_fnid(int new_type) {
            return PrivateScalarConversions.getConversionFnid(this._authoritative_type_idx, new_type);
        }
        ...
        private final void fn_from_date_to_timestamp() {
            this._timestamp_value = Timestamp.forMillis(this._date_value.getTime(), null);
            this.add_value_type(10);
        }
    }
