...
@EventName(value="data-pipeline.export.full.triggered.started")
public class FullExportTriggeredStartedAnalyticEvent
extends AnalyticEvent {
    private final long exportTimespanInDays;

    public FullExportTriggeredStartedAnalyticEvent(@Nonnull String pluginVersion, long exportTimespanInDays) {
        super(pluginVersion);
