...
@EventName(value="data-pipeline.export.full.triggered.not.started")
public class FullExportTriggeredNotStartedAnalyticEvent
extends AnalyticEvent {
    private final long exportTimespanInDays;

    public FullExportTriggeredNotStartedAnalyticEvent(@Nonnull String pluginVersion, long exportTimespanInDays) {
        super(pluginVersion);
