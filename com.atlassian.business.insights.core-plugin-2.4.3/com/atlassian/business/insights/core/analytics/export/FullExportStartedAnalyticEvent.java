...
@EventName(value="data-pipeline.export.full.started")
public class FullExportStartedAnalyticEvent
extends AnalyticEvent {
    private final long exportTimespanInDays;

    public FullExportStartedAnalyticEvent(@Nonnull String pluginVersion, long exportTimespanInDays) {
        super(pluginVersion);
