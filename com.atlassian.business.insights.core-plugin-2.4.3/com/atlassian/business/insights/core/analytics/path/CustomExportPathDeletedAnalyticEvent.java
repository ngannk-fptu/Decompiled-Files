...
@EventName(value="data-pipeline.custom.export.path.deleted")
public class CustomExportPathDeletedAnalyticEvent
extends CustomExportPathAnalyticEvent {
    public CustomExportPathDeletedAnalyticEvent(@Nonnull String pluginVersion) {
        super(pluginVersion);
    }
}
