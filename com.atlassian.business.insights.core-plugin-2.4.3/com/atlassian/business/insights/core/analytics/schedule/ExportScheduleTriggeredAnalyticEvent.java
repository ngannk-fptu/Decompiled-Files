...
@EventName(value="data-pipeline.export.schedule.triggered")
public class ExportScheduleTriggeredAnalyticEvent
extends ExportScheduleAnalyticEvent {
    public ExportScheduleTriggeredAnalyticEvent(@Nonnull String pluginVersion, @Nonnull ScheduleConfig scheduleConfig) {
