...
@EventName(value="data-pipeline.export.schedule.update.triggered")
public class ExportScheduleUpdateTriggeredAnalyticEvent
extends ExportScheduleAnalyticEvent {
    public ExportScheduleUpdateTriggeredAnalyticEvent(@Nonnull String pluginVersion, @Nonnull ScheduleConfig scheduleConfig) {
