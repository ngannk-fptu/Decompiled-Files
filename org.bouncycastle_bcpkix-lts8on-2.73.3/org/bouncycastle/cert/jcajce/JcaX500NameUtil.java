...
public class JcaX500NameUtil {
    public static X500Name getIssuer(X509Certificate certificate) {
        if (certificate instanceof BCX509Certificate) {
            return JcaX500NameUtil.notNull(((BCX509Certificate)certificate).getIssuerX500Name());
        }
    ...
    public static X500Name getIssuer(X500NameStyle style, X509Certificate certificate) {
        if (certificate instanceof BCX509Certificate) {
            return X500Name.getInstance((X500NameStyle)style, (Object)JcaX500NameUtil.notNull(((BCX509Certificate)certificate).getIssuerX500Name()));
        }
    ...
    public static X500Name getSubject(X509Certificate certificate) {
        if (certificate instanceof BCX509Certificate) {
            return JcaX500NameUtil.notNull(((BCX509Certificate)certificate).getSubjectX500Name());
        }
    ...
    public static X500Name getSubject(X500NameStyle style, X509Certificate certificate) {
        if (certificate instanceof BCX509Certificate) {
            return X500Name.getInstance((X500NameStyle)style, (Object)JcaX500NameUtil.notNull(((BCX509Certificate)certificate).getSubjectX500Name()));
        }
    ...
    public static X500Name getX500Name(X500Principal principal) {
        return X500Name.getInstance((Object)JcaX500NameUtil.getEncoded(principal));
    }

    public static X500Name getX500Name(X500NameStyle style, X500Principal principal) {
        return X500Name.getInstance((X500NameStyle)style, (Object)JcaX500NameUtil.getEncoded(principal));
    }
