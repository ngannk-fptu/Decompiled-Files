...
class MSOutlookKeyIdCalculator {
    ...
    extends GeneralDigest {
        ...
        public int doFinal(byte[] out, int outOff) {
            this.finish();
            Pack.intToBigEndian((int)this.H1, (byte[])out, (int)outOff);
            Pack.intToBigEndian((int)this.H2, (byte[])out, (int)(outOff + 4));
            Pack.intToBigEndian((int)this.H3, (byte[])out, (int)(outOff + 8));
            Pack.intToBigEndian((int)this.H4, (byte[])out, (int)(outOff + 12));
            Pack.intToBigEndian((int)this.H5, (byte[])out, (int)(outOff + 16));
            this.reset();
            return 20;
        }
