...
abstract class EACHelper {
    ...
    public Signature getSignature(ASN1ObjectIdentifier oid) throws NoSuchProviderException, NoSuchAlgorithmException {
        return this.createSignature((String)sigNames.get(oid));
    }
