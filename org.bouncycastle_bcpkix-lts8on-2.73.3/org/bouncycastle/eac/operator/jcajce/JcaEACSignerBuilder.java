...
public class JcaEACSignerBuilder {
    ...
    private static byte[] reencode(byte[] rawSign) {
        ASN1Sequence sData = ASN1Sequence.getInstance((Object)rawSign);
        BigInteger r = ASN1Integer.getInstance((Object)sData.getObjectAt(0)).getValue();
        BigInteger s = ASN1Integer.getInstance((Object)sData.getObjectAt(1)).getValue();
