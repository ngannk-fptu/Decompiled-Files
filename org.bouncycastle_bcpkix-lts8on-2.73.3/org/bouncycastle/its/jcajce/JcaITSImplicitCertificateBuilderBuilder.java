...
public class JcaITSImplicitCertificateBuilderBuilder {
    ...
    public ITSImplicitCertificateBuilder build(ITSCertificate issuer, ToBeSignedCertificate.Builder tbsCertificate) throws OperatorCreationException {
        return new ITSImplicitCertificateBuilder(issuer, this.digestCalculatorProviderBuilder.build(), tbsCertificate);
    }
}
