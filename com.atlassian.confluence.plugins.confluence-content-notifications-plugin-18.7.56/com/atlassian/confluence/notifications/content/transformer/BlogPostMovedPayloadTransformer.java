...
public class BlogPostMovedPayloadTransformer
extends PayloadTransformerTemplate<BlogPostMovedEvent, ContentMovedPayload> {
    protected Maybe<ContentMovedPayload> checkedCreate(BlogPostMovedEvent blogPostMovedEvent) {
