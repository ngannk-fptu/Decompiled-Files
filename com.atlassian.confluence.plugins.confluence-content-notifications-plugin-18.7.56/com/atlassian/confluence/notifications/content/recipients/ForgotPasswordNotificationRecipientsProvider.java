...
public class ForgotPasswordNotificationRecipientsProvider
extends NonUserBasedRecipientsProviderTemplate<ForgotPasswordPayload> {
    ...
    protected Iterable<NotificationAddress> computeNonUserBasedRecipients(Notification<ForgotPasswordPayload> notification) {
        ConfluenceUser user = this.userAccessor.getExistingUserByKey(new UserKey((String)((ForgotPasswordPayload)notification.getPayload()).getOriginatingUserKey().get()));
