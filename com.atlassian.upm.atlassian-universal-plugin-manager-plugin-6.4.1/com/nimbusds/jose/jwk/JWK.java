...
Serializable {
    ...
    public JSONObject toJSONObject() {
        ...
        if (this.use != null) {
            o.put((Object)"use", (Object)this.use.identifier());
        }
        if (this.ops != null) {
            stringValues = new JSONArray();
            for (KeyOperation op : this.ops) {
                stringValues.add((Object)op.identifier());
            }
            o.put((Object)"key_ops", (Object)stringValues);
        }
        if (this.alg != null) {
        ...
        if (this.x5c != null) {
            ...
            for (Base64 base64 : this.x5c) {
                stringValues.add((Object)base64.toString());
            }
            o.put((Object)"x5c", (Object)stringValues);
        }
        return o;
    }
