...
public class JOSEMatcher {
    ...
    public boolean matches(JOSEObject joseObject) {
        ...
        return this.kids == null || this.kids.contains(kid = joseObject instanceof JWSObject ? ((JWSObject)joseObject).getHeader().getKeyID() : (joseObject instanceof JWEObject ? ((JWEObject)joseObject).getHeader().getKeyID() : null));
    }
