...
implements Version {
    ...
    public int compareTo(Version version) {
        ...
        if (StringUtils.isEmpty((CharSequence)this.getQualifier()) && StringUtils.isNotEmpty((CharSequence)otherQualifier)) {
            return VersionImpl.compareQualifierWithBlankQualifier(otherQualifier, false);
        }
        if (StringUtils.isNotEmpty((CharSequence)this.getQualifier()) && StringUtils.isEmpty((CharSequence)otherQualifier)) {
    ...
    private static int compareQualifierWithBlankQualifier(String qualifier, boolean thisQualifier) {
        if (StringUtils.isNumeric((CharSequence)qualifier)) {
