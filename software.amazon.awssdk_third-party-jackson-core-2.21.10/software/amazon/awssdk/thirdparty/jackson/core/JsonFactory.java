...
import software.amazon.awssdk.thirdparty.jackson.core.FormatFeature;
import software.amazon.awssdk.thirdparty.jackson.core.FormatSchema;
import software.amazon.awssdk.thirdparty.jackson.core.JsonEncoding;
import software.amazon.awssdk.thirdparty.jackson.core.JsonFactoryBuilder;
...
import software.amazon.awssdk.thirdparty.jackson.core.TokenStreamFactory;
...
import software.amazon.awssdk.thirdparty.jackson.core.format.InputAccessor;
import software.amazon.awssdk.thirdparty.jackson.core.format.MatchStrength;
...
import software.amazon.awssdk.thirdparty.jackson.core.io.InputDecorator;
import software.amazon.awssdk.thirdparty.jackson.core.io.OutputDecorator;
import software.amazon.awssdk.thirdparty.jackson.core.io.SerializedString;
import software.amazon.awssdk.thirdparty.jackson.core.io.UTF8Writer;
import software.amazon.awssdk.thirdparty.jackson.core.json.ByteSourceJsonBootstrapper;
import software.amazon.awssdk.thirdparty.jackson.core.json.PackageVersion;
import software.amazon.awssdk.thirdparty.jackson.core.json.ReaderBasedJsonParser;
import software.amazon.awssdk.thirdparty.jackson.core.json.UTF8DataInputJsonParser;
import software.amazon.awssdk.thirdparty.jackson.core.json.UTF8JsonGenerator;
import software.amazon.awssdk.thirdparty.jackson.core.json.WriterBasedJsonGenerator;
import software.amazon.awssdk.thirdparty.jackson.core.json.async.NonBlockingByteBufferJsonParser;
import software.amazon.awssdk.thirdparty.jackson.core.json.async.NonBlockingJsonParser;
...
import software.amazon.awssdk.thirdparty.jackson.core.util.BufferRecyclers;
...
Serializable {
    ...
    protected JsonFactory(JsonFactory src, ObjectCodec codec) {
        ...
        this._streamReadConstraints = src._streamReadConstraints == null ? StreamReadConstraints.defaults() : src._streamReadConstraints;
    ...
    public JsonFactory(JsonFactoryBuilder b) {
        ...
        this._streamReadConstraints = b._streamReadConstraints == null ? StreamReadConstraints.defaults() : b._streamReadConstraints;
    ...
    protected IOContext _createContext(ContentReference contentRef, boolean resourceManaged) {
        ...
        return new IOContext(this._streamReadConstraints, this._getBufferRecycler(), contentRef, resourceManaged);
    }

    @Deprecated
    protected IOContext _createContext(Object rawContentRef, boolean resourceManaged) {
        return new IOContext(this._streamReadConstraints, this._getBufferRecycler(), this._createContentReference(rawContentRef), resourceManaged);
    }

    protected IOContext _createNonBlockingContext(Object srcRef) {
        return new IOContext(this._streamReadConstraints, this._getBufferRecycler(), this._createContentReference(srcRef), false);
    }
