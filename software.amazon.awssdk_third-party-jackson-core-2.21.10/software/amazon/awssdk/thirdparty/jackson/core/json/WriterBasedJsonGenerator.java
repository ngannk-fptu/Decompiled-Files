...
import software.amazon.awssdk.thirdparty.jackson.core.JsonGenerationException;
...
import software.amazon.awssdk.thirdparty.jackson.core.io.NumberOutput;
import software.amazon.awssdk.thirdparty.jackson.core.json.JsonGeneratorImpl;
import software.amazon.awssdk.thirdparty.jackson.core.json.JsonWriteContext;
...
extends JsonGeneratorImpl {
    ...
    public void writeRaw(String text, int offset, int len) throws IOException {
        ...
        if (room >= len) {
            ...
            this.writeRawLong(text.substring(offset, offset + len));
        }
    }
    ...
    private void _prependOrWriteCharacterEscape(char ch, int escCode) throws IOException, JsonGenerationException {
        ...
        if (escCode != -2) {
            char[] HEX_CHARS = this.getHexChars();
