...
import software.amazon.awssdk.thirdparty.jackson.core.io.MergedStream;
import software.amazon.awssdk.thirdparty.jackson.core.io.UTF32Reader;
import software.amazon.awssdk.thirdparty.jackson.core.json.ReaderBasedJsonParser;
import software.amazon.awssdk.thirdparty.jackson.core.json.UTF8StreamJsonParser;
...
public final class ByteSourceJsonBootstrapper {
    ...
    public JsonParser constructParser(int parserFeatures, ObjectCodec codec, ByteQuadsCanonicalizer rootByteSymbols, CharsToNameCanonicalizer rootCharSymbols, int factoryFeatures) throws IOException {
        ...
        JsonEncoding enc = JsonFactory.Feature.CHARSET_DETECTION.enabledIn(factoryFeatures) ? this.detectEncoding() : JsonEncoding.UTF8;
