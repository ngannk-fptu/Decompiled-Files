...
import software.amazon.awssdk.thirdparty.jackson.core.json.async.NonBlockingJsonParserBase;
...
extends NonBlockingJsonParserBase {
        ...
        while (true) {
            ...
            if (codes[ch] == 0) {
                ...
                if (qlen >= quads.length) {
                    this._quadBuffer = quads = NonBlockingUtf8JsonParserBase.growArrayBy(quads, quads.length);
                }
                quads[qlen++] = currQuad;
                currQuad = ch;
                currQuadBytes = 1;
    ...
    protected final JsonToken _finishFieldWithEscape() throws IOException {
        ...
        if (this._quadLength >= this._quadBuffer.length) {
            this._quadBuffer = NonBlockingUtf8JsonParserBase.growArrayBy(this._quadBuffer, 32);
        }
