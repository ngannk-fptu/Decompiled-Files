...
Parallelizable {
    ...
    implements Runnable {
        ...
        public void run() {
            ...
            while (this.length > 0L) {
                ...
                iterator.setInt(IntNTTConvolutionStepStrategy.this.modMultiply(value, value));
                iterator.next();
                --this.length;
            }
        }
    ...
    implements Runnable {
        ...
        public void run() {
            ...
            while (this.length > 0L) {
                dest.setInt(IntNTTConvolutionStepStrategy.this.modMultiply(dest.getInt(), src.getInt()));
                dest.next();
                src.next();
                --this.length;
            }
