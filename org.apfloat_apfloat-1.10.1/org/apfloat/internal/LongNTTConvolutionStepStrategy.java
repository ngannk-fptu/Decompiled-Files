...
Parallelizable {
    ...
    implements Runnable {
        ...
        public void run() {
            ...
            while (this.length > 0L) {
                ...
                iterator.setLong(LongNTTConvolutionStepStrategy.this.modMultiply(value, value));
                iterator.next();
                --this.length;
            }
        }
    ...
    implements Runnable {
        ...
        public void run() {
            ...
            while (this.length > 0L) {
                dest.setLong(LongNTTConvolutionStepStrategy.this.modMultiply(dest.getLong(), src.getLong()));
                dest.next();
                src.next();
                --this.length;
            }
