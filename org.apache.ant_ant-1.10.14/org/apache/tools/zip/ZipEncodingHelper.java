...
import org.apache.tools.zip.FallbackZipEncoding;
import org.apache.tools.zip.NioZipEncoding;
import org.apache.tools.zip.Simple8BitZipEncoding;
...
public abstract class ZipEncodingHelper {
    ...
    static ByteBuffer growBuffer(ByteBuffer b, int newCapacity) {
        ZipEncodingHelper.prepareBufferForRead(b);
        int c2 = b.capacity() * 2;
    ...
    static {
        HashMap<String, SimpleEncodingHolder> se = new HashMap<String, SimpleEncodingHolder>();
