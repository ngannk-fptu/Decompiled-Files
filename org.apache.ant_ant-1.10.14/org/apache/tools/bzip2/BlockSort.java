                            ...
                            if (block[i1 + 2] == block[i2 + 2]) {
                                if (block[i1 + 3] == block[i2 + 3]) {
                                    if (block[i1 + 4] == block[i2 + 4]) {
                                        ...
                                        if ((block[i1 + 5] & 0xFF) > (block[i2 + 5] & 0xFF)) continue;
                                        break;
                                    }
                                    if ((block[i1 + 4] & 0xFF) > (block[i2 + 4] & 0xFF)) continue;
                                    break;
                                }
                                if ((block[i1 + 3] & 0xFF) > (block[i2 + 3] & 0xFF)) continue;
                                break;
                            }
                            if ((block[i1 + 2] & 0xFF) > (block[i2 + 2] & 0xFF)) continue;
                            break;
                        }
