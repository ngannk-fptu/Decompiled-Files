...
implements Serializable {
    ...
    public static EmbeddedDocumentExtractor getEmbeddedDocumentExtractor(ParseContext context) {
        ...
        ParsingEmbeddedDocumentExtractor ex = new ParsingEmbeddedDocumentExtractor(context);
    ...
    public String getExtension(TikaInputStream is, Metadata metadata) {
        ...
        if (mimeType == null) {
            try {
                MediaType mediaType = this.getDetector().detect((InputStream)((Object)is), metadata);
