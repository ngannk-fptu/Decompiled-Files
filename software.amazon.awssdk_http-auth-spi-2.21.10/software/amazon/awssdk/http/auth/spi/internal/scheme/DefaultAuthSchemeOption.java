...
implements AuthSchemeOption {
    ...
    DefaultAuthSchemeOption(BuilderImpl builder) {
        this.schemeId = (String)Validate.paramNotBlank((CharSequence)builder.schemeId, (String)"schemeId");
    ...
    public String toString() {
        return ToString.builder((String)"AuthSchemeOption").add("schemeId", (Object)this.schemeId).add("identityProperties", this.identityProperties).add("signerProperties", this.signerProperties).build();
    }
