...
implements BaseSignRequest<PayloadT, IdentityT> {
    ...
    protected DefaultBaseSignRequest(BuilderImpl<?, PayloadT, IdentityT> builder) {
        this.request = (SdkHttpRequest)Validate.paramNotNull((Object)((BuilderImpl)builder).request, (String)"request");
        this.payload = ((BuilderImpl)builder).payload;
        this.identity = (Identity)Validate.paramNotNull((Object)((BuilderImpl)builder).identity, (String)"identity");
