...
implements AsyncSignRequest<IdentityT> {
    ...
    public String toString() {
        return ToString.builder((String)"AsyncSignRequest").add("request", (Object)this.request).add("identity", (Object)this.identity).add("properties", (Object)this.properties).build();
    }
