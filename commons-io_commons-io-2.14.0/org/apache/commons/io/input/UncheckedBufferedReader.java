...
extends BufferedReader {
    ...
    extends AbstractStreamBuilder<UncheckedBufferedReader, Builder> {
        @Override
        public UncheckedBufferedReader get() {
            return Uncheck.get(() -> new UncheckedBufferedReader(this.checkOrigin().getReader(this.getCharset()), this.getBufferSize()));
        }
    }
}
