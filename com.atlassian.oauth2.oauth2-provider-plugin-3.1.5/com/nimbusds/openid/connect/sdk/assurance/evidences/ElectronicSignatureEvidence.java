...
extends IdentityEvidence {
    ...
    public JSONObject toJSONObject() {
        ...
        o.put("signature_type", this.getSignatureType().getValue());
        if (this.getIssuer() != null) {
            o.put("issuer", this.getIssuer().getValue());
        }
        if (this.getCertificateSerialNumber() != null) {
            o.put("serial_number", this.getCertificateSerialNumber().getValue());
        }
        if (this.getCreationTime() != null) {
            o.put("created_at", this.getCreationTime().toISO8601String());
        }
        return o;
    }
