...
public class ClientMetadata {
    ...
    public JSONObject toJSONObject(boolean includeCustomFields) {
        ...
        if (this.redirectURIs != null) {
            o.put("redirect_uris", URIUtils.toStringList(this.redirectURIs));
        }
        if (this.scope != null) {
        ...
        if (this.jwkSet != null) {
            o.put("jwks", JSONObjectUtils.toJSONObject(this.jwkSet.toPublicJWKSet()));
        }
        if (this.requestObjectURIs != null) {
            o.put("request_uris", URIUtils.toStringList(this.requestObjectURIs));
        }
