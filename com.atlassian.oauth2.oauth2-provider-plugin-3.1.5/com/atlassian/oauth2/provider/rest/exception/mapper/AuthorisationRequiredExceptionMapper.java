...
@Provider
@Singleton
public class AuthorisationRequiredExceptionMapper
extends AbstractExceptionMapper<AuthenticationRequiredException> {
    private final I18nResolver i18nResolver;

    public AuthorisationRequiredExceptionMapper(I18nResolver i18nResolver) {
