...
extends OperationDescriptorImpl {
    private static final String[][] resources = new String[][]{{"GlobalName", "DivideIntoConst"}, {"LocalName", "DivideIntoConst"}, {"Vendor", "com.sun.media.jai"}, {"Description", JaiI18N.getString("DivideIntoConstDescriptor0")}, {"DocURL", "http://java.sun.com/products/java-media/jai/forDevelopers/jai-apidocs/javax/media/jai/operator/DivideIntoConstDescriptor.html"}, {"Version", JaiI18N.getString("DescriptorVersion")}, {"arg0Desc", JaiI18N.getString("DivideIntoConstDescriptor1")}};
    private static final Class[] paramClasses = new Class[]{array$D == null ? (array$D = DivideIntoConstDescriptor.class$("[D")) : array$D};
    ...
    protected boolean validateParameters(ParameterBlock args, StringBuffer message) {
        ...
        if (length < 1) {
            message.append(this.getName() + " " + JaiI18N.getString("DivideIntoConstDescriptor2"));
            return false;
        }
        return true;
    }
    ...
    public static RenderedOp create(RenderedImage source0, double[] constants, RenderingHints hints) {
        ParameterBlockJAI pb = new ParameterBlockJAI("DivideIntoConst", "rendered");
    ...
    public static RenderableOp createRenderable(RenderableImage source0, double[] constants, RenderingHints hints) {
        ParameterBlockJAI pb = new ParameterBlockJAI("DivideIntoConst", "renderable");
        pb.setSource("source0", source0);
        pb.setParameter("constants", constants);
