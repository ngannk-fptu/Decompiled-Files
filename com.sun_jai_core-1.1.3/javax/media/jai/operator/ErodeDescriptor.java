...
extends OperationDescriptorImpl {
    ...
    private static final Class[] paramClasses = new Class[]{class$javax$media$jai$KernelJAI == null ? (class$javax$media$jai$KernelJAI = ErodeDescriptor.class$("javax.media.jai.KernelJAI")) : class$javax$media$jai$KernelJAI};
