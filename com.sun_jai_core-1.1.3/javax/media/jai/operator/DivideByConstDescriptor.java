...
extends OperationDescriptorImpl {
    ...
    private static final Class[] paramClasses = new Class[]{array$D == null ? (array$D = DivideByConstDescriptor.class$("[D")) : array$D};
    ...
    protected boolean validateParameters(ParameterBlock args, StringBuffer message) {
        ...
        if (length < 1) {
            message.append(this.getName() + " " + JaiI18N.getString("DivideByConstDescriptor2"));
            return false;
        }
        return true;
    }
