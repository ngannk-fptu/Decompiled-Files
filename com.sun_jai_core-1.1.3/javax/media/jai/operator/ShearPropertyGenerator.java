...
extends PropertyGeneratorImpl {
    ...
    public ShearPropertyGenerator() {
        super(new String[]{"ROI"}, new Class[]{class$javax$media$jai$ROI == null ? (class$javax$media$jai$ROI = ShearPropertyGenerator.class$("javax.media.jai.ROI")) : class$javax$media$jai$ROI}, new Class[]{class$javax$media$jai$RenderedOp == null ? (class$javax$media$jai$RenderedOp = ShearPropertyGenerator.class$("javax.media.jai.RenderedOp")) : class$javax$media$jai$RenderedOp});
    }
    ...
    public Object getProperty(String name, Object opNode) {
        ...
        if (opNode instanceof RenderedOp && name.equalsIgnoreCase("roi")) {
            ...
            AffineTransform transform = new AffineTransform(1.0, shearDir == ShearDescriptor.SHEAR_VERTICAL ? (double)sv : 0.0, shearDir == ShearDescriptor.SHEAR_HORIZONTAL ? (double)sv : 0.0, 1.0, shearDir == ShearDescriptor.SHEAR_HORIZONTAL ? (double)tx : 0.0, shearDir == ShearDescriptor.SHEAR_VERTICAL ? (double)ty : 0.0);
