            ...
            for (int x = dst_min_x; x < dst_max_x; ++x) {
                if ((float)s_ix >= src_rect_x1 + 1.0f && (float)s_ix < src_rect_x2 - 2.0f && (float)s_iy >= src_rect_y1 + 1.0f && (float)s_iy < src_rect_y2 - 2.0f) {
                    for (int k2 = 0; k2 < dst_num_bands; ++k2) {
                        ...
                        float s0 = (float)s00 + (float)(s10 - s00) * float_fracx;
                        float s1 = (float)s01 + (float)(s11 - s01) * float_fracx;
                        float s_ = (float)s0_ + (float)(s1_ - s0_) * float_fracx;
                        float s2 = (float)s02 + (float)(s12 - s02) * float_fracx;
                        float q_ = (float)(s1_ + s__) + (float)(s2_ + s0_ - (s1_ + s__)) * float_fracx;
                        float q0 = (float)(s10 + s_0) + (float)(s20 + s00 - (s10 + s_0)) * float_fracx;
                        float q1 = (float)(s11 + s_1) + (float)(s21 + s01 - (s11 + s_1)) * float_fracx;
                        float q2 = (float)(s12 + s_2) + (float)(s22 + s02 - (s12 + s_2)) * float_fracx;
                        q_ = s_ - q_ / 2.0f;
                        q0 = s0 - q0 / 2.0f;
                        q1 = s1 - q1 / 2.0f;
                        q2 = s2 - q2 / 2.0f;
                        float s = (s0 += q0 * frac_xx) + ((s1 += q1 * frac_xx) - s0) * float_fracy;
                        float q = s1 + (s_ += q_ * frac_xx) + ((s2 += q2 * frac_xx) + s0 - (s1 + s_)) * float_fracy;
                        int result = (s += (q = s - q / 2.0f) * frac_yy) < 0.5f ? 0 : (s > 254.5f ? 255 : (int)(s + 0.5f));
            ...
            for (int x = dst_min_x; x < dst_max_x; ++x) {
                if ((float)s_ix >= src_rect_x1 + 1.0f && (float)s_ix < src_rect_x2 - 2.0f && (float)s_iy >= src_rect_y1 + 1.0f && (float)s_iy < src_rect_y2 - 2.0f) {
                    for (int k2 = 0; k2 < dst_num_bands; ++k2) {
                        ...
                        float s = (s0 += q0 * frac_xx) + ((s1 += q1 * frac_xx) - s0) * float_fracy;
                        float q = s1 + (s_ += q_ * frac_xx) + ((s2 += q2 * frac_xx) + s0 - (s1 + s_)) * float_fracy;
                        int result = (s += (q = s - q / 2.0f) * frac_yy) < -2.14748365E9f ? Integer.MIN_VALUE : (s > 2.14748365E9f ? Integer.MAX_VALUE : ((double)s > 0.0 ? (int)(s + 0.5f) : (int)(s - 0.5f)));
            ...
            for (int x = dst_min_x; x < dst_max_x; ++x) {
                if ((float)s_ix >= src_rect_x1 + 1.0f && (float)s_ix < src_rect_x2 - 2.0f && (float)s_iy >= src_rect_y1 + 1.0f && (float)s_iy < src_rect_y2 - 2.0f) {
                    for (int k2 = 0; k2 < dst_num_bands; ++k2) {
                        ...
                        float s = (s0 += q0 * frac_xx) + ((s1 += q1 * frac_xx) - s0) * float_fracy;
                        float q = s1 + (s_ += q_ * frac_xx) + ((s2 += q2 * frac_xx) + s0 - (s1 + s_)) * float_fracy;
                        int result = (s += (q = s - q / 2.0f) * frac_yy) < -32768.0f ? Short.MIN_VALUE : (s > 32767.0f ? Short.MAX_VALUE : ((double)s > 0.0 ? (int)((short)(s + 0.5f)) : (int)((short)(s - 0.5f))));
                        dstDataArrays[k2][dstPixelOffset + dstBandOffsets[k2]] = result;
                    }
                } else if (this.setBackground) {
                    for (int k = 0; k < dst_num_bands; ++k) {
            ...
            for (int x = dst_min_x; x < dst_max_x; ++x) {
                if ((float)s_ix >= src_rect_x1 + 1.0f && (float)s_ix < src_rect_x2 - 2.0f && (float)s_iy >= src_rect_y1 + 1.0f && (float)s_iy < src_rect_y2 - 2.0f) {
                    for (int k2 = 0; k2 < dst_num_bands; ++k2) {
                        ...
                        float s = (s0 += q0 * frac_xx) + ((s1 += q1 * frac_xx) - s0) * float_fracy;
                        float q = s1 + (s_ += q_ * frac_xx) + ((s2 += q2 * frac_xx) + s0 - (s1 + s_)) * float_fracy;
                        int result = (double)(s += (q = s - q / 2.0f) * frac_yy) < 0.0 ? 0 : (s > 65535.0f ? 65535 : (int)(s + 0.5f));
            ...
            for (int x = dst_min_x; x < dst_max_x; ++x) {
                if ((float)s_ix >= src_rect_x1 + 1.0f && (float)s_ix < src_rect_x2 - 2.0f && (float)s_iy >= src_rect_y1 + 1.0f && (float)s_iy < src_rect_y2 - 2.0f) {
                    for (int k2 = 0; k2 < dst_num_bands; ++k2) {
                        ...
                        float q = s1 + (s_ += q_ * frac_xx) + ((s2 += q2 * frac_xx) + s0 - (s1 + s_)) * float_fracy;
                        q = s - q / 2.0f;
                        dstDataArrays[k2][dstPixelOffset + dstBandOffsets[k2]] = s += q * frac_yy;
                    }
                } else if (this.setBackground) {
                    for (int k = 0; k < dst_num_bands; ++k) {
            ...
            for (int x = dst_min_x; x < dst_max_x; ++x) {
                if ((float)s_ix >= src_rect_x1 + 1.0f && (float)s_ix < src_rect_x2 - 2.0f && (float)s_iy >= src_rect_y1 + 1.0f && (float)s_iy < src_rect_y2 - 2.0f) {
                    for (int k2 = 0; k2 < dst_num_bands; ++k2) {
                        ...
                        double frac_xx = float_fracx * (1.0 - float_fracx);
                        double frac_yy = float_fracx * (1.0 - float_fracy);
                        ...
                        q1 = s1 - q1 / 2.0;
                        q2 = s2 - q2 / 2.0;
                        double s = (s0 += q0 * frac_xx) + ((s1 += q1 * frac_xx) - s0) * float_fracy;
                        double q = s1 + (s_ += q_ * frac_xx) + ((s2 += q2 * frac_xx) + s0 - (s1 + s_)) * float_fracy;
                        q = s - q / 2.0;
                        dstDataArrays[k2][dstPixelOffset + dstBandOffsets[k2]] = s += q * frac_yy;
                    }
                } else if (this.setBackground) {
