...
final class MlibOrOpImage
extends PointOpImage {
    public MlibOrOpImage(RenderedImage source1, RenderedImage source2, Map config, ImageLayout layout) {
        ...
        switch (dstAccessor.getDataType()) {
            ...
            case 3: {
                ...
                for (int i = 0; i < dstML.length; ++i) {
                    Image.Or((mediaLibImage)dstML[i], (mediaLibImage)srcML1[i], (mediaLibImage)srcML2[i]);
                }
                break;
            }
            default: {
