        ...
        switch (dstMA.getDataType()) {
            ...
            case 3: {
                for (int i = 0; i < dstMLI.length; ++i) {
                    Image.Max((mediaLibImage)dstMLI[i], (mediaLibImage)srcMLI1[i], (mediaLibImage)srcMLI2[i]);
                }
                break;
            }
            case 4: 
            case 5: {
                for (int i = 0; i < dstMLI.length; ++i) {
                    Image.Max_Fp((mediaLibImage)dstMLI[i], (mediaLibImage)srcMLI1[i], (mediaLibImage)srcMLI2[i]);
                }
                break;
            }
        }
