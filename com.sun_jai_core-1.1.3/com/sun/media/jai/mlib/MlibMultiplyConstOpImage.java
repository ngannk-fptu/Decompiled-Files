        ...
        switch (dstAccessor.getDataType()) {
            ...
            case 3: {
                for (int i = 0; i < dstML.length; ++i) {
                    ...
                    Image.ConstMul((mediaLibImage)dstML[i], (mediaLibImage)srcML[i], (double[])mlconstants);
                }
                break;
            }
            case 4: 
            case 5: {
                for (int i = 0; i < dstML.length; ++i) {
                    double[] mlconstants = dstAccessor.getDoubleParameters(i, this.constants);
                    Image.ConstMul_Fp((mediaLibImage)dstML[i], (mediaLibImage)srcML[i], (double[])mlconstants);
                }
                break;
            }
            default: {
