        ...
        switch (dstAccessor.getDataType()) {
            ...
            case 3: {
                ...
                for (i = 0; i < dstML.length; ++i) {
                    ...
                    Image.ConstSub((mediaLibImage)dstML[i], (mediaLibImage)srcML[i], (int[])mlconstants);
                }
                break;
            }
            case 4: 
            case 5: {
                for (int i = 0; i < dstML.length; ++i) {
                    ...
                    Image.ConstSub_Fp((mediaLibImage)dstML[i], (mediaLibImage)srcML[i], (double[])mlconstants);
                }
                break;
            }
            default: {
