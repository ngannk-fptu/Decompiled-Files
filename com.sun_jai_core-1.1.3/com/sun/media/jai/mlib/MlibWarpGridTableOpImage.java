    ...
    protected void computeRect(Raster[] sources, WritableRaster dest, Rectangle destRect) {
        ...
        switch (dstMA.getDataType()) {
            ...
            case 3: {
                ...
                if (this.setBackground) {
                    for (int i = 0; i < dstMLI.length; ++i) {
                        Image.GridWarpTable2((mediaLibImage)dstMLI[i], (mediaLibImage)srcMLI[i], (float[])this.xWarpPos, (float[])this.yWarpPos, (double)source.getMinX(), (double)source.getMinY(), (int)(this.xStart - destRect.x), (int)this.xStep, (int)this.xNumCells, (int)(this.yStart - destRect.y), (int)this.yStep, (int)this.yNumCells, (mediaLibImageInterpTable)this.mlibInterpTableI, (int)0, (int[])this.intBackgroundValues);
                    }
                } else {
                    for (int i = 0; i < dstMLI.length; ++i) {
                        Image.GridWarpTable((mediaLibImage)dstMLI[i], (mediaLibImage)srcMLI[i], (float[])this.xWarpPos, (float[])this.yWarpPos, (double)source.getMinX(), (double)source.getMinY(), (int)(this.xStart - destRect.x), (int)this.xStep, (int)this.xNumCells, (int)(this.yStart - destRect.y), (int)this.yStep, (int)this.yNumCells, (mediaLibImageInterpTable)this.mlibInterpTableI, (int)0);
            ...
            case 4: {
                ...
                if (this.setBackground) {
                    for (int i = 0; i < dstMLI.length; ++i) {
                        Image.GridWarpTable2_Fp((mediaLibImage)dstMLI[i], (mediaLibImage)srcMLI[i], (float[])this.xWarpPos, (float[])this.yWarpPos, (double)source.getMinX(), (double)source.getMinY(), (int)(this.xStart - destRect.x), (int)this.xStep, (int)this.xNumCells, (int)(this.yStart - destRect.y), (int)this.yStep, (int)this.yNumCells, (mediaLibImageInterpTable)this.mlibInterpTableF, (int)0, (double[])this.backgroundValues);
                    }
                } else {
                    for (int i = 0; i < dstMLI.length; ++i) {
                        Image.GridWarpTable_Fp((mediaLibImage)dstMLI[i], (mediaLibImage)srcMLI[i], (float[])this.xWarpPos, (float[])this.yWarpPos, (double)source.getMinX(), (double)source.getMinY(), (int)(this.xStart - destRect.x), (int)this.xStep, (int)this.xNumCells, (int)(this.yStart - destRect.y), (int)this.yStep, (int)this.yNumCells, (mediaLibImageInterpTable)this.mlibInterpTableF, (int)0);
                    }
                }
                break;
            }
            case 5: {
                ...
                if (this.setBackground) {
                    for (int i = 0; i < dstMLI.length; ++i) {
                        Image.GridWarpTable2_Fp((mediaLibImage)dstMLI[i], (mediaLibImage)srcMLI[i], (float[])this.xWarpPos, (float[])this.yWarpPos, (double)source.getMinX(), (double)source.getMinY(), (int)(this.xStart - destRect.x), (int)this.xStep, (int)this.xNumCells, (int)(this.yStart - destRect.y), (int)this.yStep, (int)this.yNumCells, (mediaLibImageInterpTable)this.mlibInterpTableD, (int)0, (double[])this.backgroundValues);
                    }
                } else {
                    for (int i = 0; i < dstMLI.length; ++i) {
                        Image.GridWarpTable_Fp((mediaLibImage)dstMLI[i], (mediaLibImage)srcMLI[i], (float[])this.xWarpPos, (float[])this.yWarpPos, (double)source.getMinX(), (double)source.getMinY(), (int)(this.xStart - destRect.x), (int)this.xStep, (int)this.xNumCells, (int)(this.yStart - destRect.y), (int)this.yStep, (int)this.yNumCells, (mediaLibImageInterpTable)this.mlibInterpTableD, (int)0);
                    }
                }
                break;
            }
