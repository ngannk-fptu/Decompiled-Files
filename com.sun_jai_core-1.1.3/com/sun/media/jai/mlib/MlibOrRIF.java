...
import com.sun.media.jai.mlib.MlibOrOpImage;
...
implements RenderedImageFactory {
    public RenderedImage create(ParameterBlock args, RenderingHints hints) {
        ...
        return new MlibOrOpImage(args.getRenderedSource(0), args.getRenderedSource(1), (Map)hints, layout);
    }
}
