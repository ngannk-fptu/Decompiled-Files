...
import com.sun.media.jai.mlib.MlibAndOpImage;
...
implements RenderedImageFactory {
    public RenderedImage create(ParameterBlock args, RenderingHints hints) {
        ...
        return new MlibAndOpImage(args.getRenderedSource(0), args.getRenderedSource(1), (Map)hints, layout);
    }
}
