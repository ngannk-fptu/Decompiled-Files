...
final class MlibMultiplyOpImage
        ...
        switch (dstAccessor.getDataType()) {
            ...
            case 3: {
                for (int i = 0; i < dstML.length; ++i) {
                    Image.MulShift((mediaLibImage)dstML[i], (mediaLibImage)srcML1[i], (mediaLibImage)srcML2[i], (int)0);
                }
                break;
            }
            case 4: 
            case 5: {
                for (int i = 0; i < dstML.length; ++i) {
                    Image.Mul_Fp((mediaLibImage)dstML[i], (mediaLibImage)srcML1[i], (mediaLibImage)srcML2[i]);
                }
                break;
            }
            default: {
