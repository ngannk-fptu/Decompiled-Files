        ...
        switch (dstAccessor.getDataType()) {
            ...
            case 3: {
                ...
                if (this.setBackground) {
                    Image.Affine2((mediaLibImage)dstML[0], (mediaLibImage)srcML[0], (double[])medialib_tr, (int)1, (int)0, (int[])this.intBackgroundValues);
                } else {
                    Image.Affine((mediaLibImage)dstML[0], (mediaLibImage)srcML[0], (double[])medialib_tr, (int)1, (int)0);
                }
            ...
            case 5: {
                ...
                mediaLibImage[] dstML = dstAccessor.getMediaLibImages();
                if (this.setBackground) {
                    Image.Affine2_Fp((mediaLibImage)dstML[0], (mediaLibImage)srcML[0], (double[])medialib_tr, (int)1, (int)0, (double[])this.backgroundValues);
                    break;
                }
                Image.Affine_Fp((mediaLibImage)dstML[0], (mediaLibImage)srcML[0], (double[])medialib_tr, (int)1, (int)0);
                break;
            }
            default: {
