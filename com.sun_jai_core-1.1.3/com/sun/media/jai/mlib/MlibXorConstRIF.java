...
import com.sun.media.jai.mlib.MlibXorConstOpImage;
...
implements RenderedImageFactory {
    public RenderedImage create(ParameterBlock args, RenderingHints hints) {
        ...
        return new MlibXorConstOpImage(args.getRenderedSource(0), hints, layout, (int[])args.getObjectParameter(0));
    }
}
