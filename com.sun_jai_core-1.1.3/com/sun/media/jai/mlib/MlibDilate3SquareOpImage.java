...
final class MlibDilate3SquareOpImage
extends AreaOpImage {
    ...
    public MlibDilate3SquareOpImage(RenderedImage source, BorderExtender extender, Map config, ImageLayout layout) {
        super(source, layout, MlibDilate3SquareOpImage.configHelper(config), true, extender, 1, 1, 1, 1);
    }
    ...
    protected void computeRect(Raster[] sources, WritableRaster dest, Rectangle destRect) {
        ...
        block4: for (int i = 0; i < dstML.length; ++i) {
            switch (dstAccessor.getDataType()) {
                ...
                case 2: 
                case 3: {
                    Image.Dilate8((mediaLibImage)dstML[i], (mediaLibImage)srcML[i]);
                    continue block4;
                }
                case 4: 
                case 5: {
                    Image.Dilate8_Fp((mediaLibImage)dstML[i], (mediaLibImage)srcML[i]);
                    continue block4;
                }
                default: {
