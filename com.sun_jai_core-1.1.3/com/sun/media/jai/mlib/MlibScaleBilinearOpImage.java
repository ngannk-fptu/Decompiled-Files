...
final class MlibScaleBilinearOpImage
        ...
        switch (dstAccessor.getDataType()) {
            ...
            case 3: {
                ...
                for (int i = 0; i < dstML.length; ++i) {
                    Image.ZoomTranslate((mediaLibImage)dstML[i], (mediaLibImage)srcML[i], (double)mlibScaleX, (double)mlibScaleY, (double)tx, (double)ty, (int)1, (int)0);
            ...
            case 5: {
                ...
                mediaLibImage[] dstML = dstAccessor.getMediaLibImages();
                for (int i = 0; i < dstML.length; ++i) {
                    Image.ZoomTranslate_Fp((mediaLibImage)dstML[i], (mediaLibImage)srcML[i], (double)mlibScaleX, (double)mlibScaleY, (double)tx, (double)ty, (int)1, (int)0);
                }
                break;
            }
            default: {
