...
Serializable {
    ...
    public int hashCode() {
        return this._artifactId.hashCode() ^ this._groupId.hashCode() ^ this._snapshotInfo.hashCode() + this._majorVersion - this._minorVersion + this._patchLevel;
    }
    ...
    public boolean equals(Object o) {
        ...
        return other._majorVersion == this._majorVersion && other._minorVersion == this._minorVersion && other._patchLevel == this._patchLevel && other._snapshotInfo.equals(this._snapshotInfo) && other._artifactId.equals(this._artifactId) && other._groupId.equals(this._groupId);
    }
    ...
    public int compareTo(Version other) {
        ...
        if (diff == 0 && (diff = this._artifactId.compareTo(other._artifactId)) == 0 && (diff = this._majorVersion - other._majorVersion) == 0 && (diff = this._minorVersion - other._minorVersion) == 0 && (diff = this._patchLevel - other._patchLevel) == 0) {
            diff = this.isSnapshot() ? (other.isSnapshot() ? this._snapshotInfo.compareTo(other._snapshotInfo) : -1) : (other.isSnapshot() ? 1 : 0);
        }
        return diff;
    }
}
