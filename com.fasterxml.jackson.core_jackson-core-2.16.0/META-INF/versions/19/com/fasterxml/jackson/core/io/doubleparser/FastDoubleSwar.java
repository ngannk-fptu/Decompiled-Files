...
class FastDoubleSwar {
    ...
    public static long tryToParseEightHexDigitsUtf16(long first, long second) {
        long highBytes = (first | second) & 0xFF80FF80FF80FF80L;
        if (highBytes != 0L) {
            return -1L;
        }
        long utf8Bytes = Long.compress((long)first, (long)0xFF00FF00FF00FFL) << 32 | Long.compress((long)second, (long)0xFF00FF00FF00FFL);
    ...
    public static long tryToParseEightHexDigitsUtf8(long chunk) {
        ...
        return Long.compress((long)v, (long)0xF0F0F0F0F0F0F0FL);
    }
